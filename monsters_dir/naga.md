...
**Init** +5; **Senses** darkvision 60 ft., detect thoughts; [Perception](../skill_dir/perception#_perception) +19
...
3rd (5/day)—_ [displacement](../spell_dir/displacement#_displacement), [lightning bolt](../spell_dir/lightningBolt#_lightning-bolt) _(DC 16)

2nd (7/day)—_ [cat's grace](../spell_dir/catSGrace#_cat-s-grace), [invisibility](../spell_dir/invisibility#_invisibility), [scorching ray](../spell_dir/scorchingRay#_scorching-ray)_

1st (7/day)—_ [expeditious retreat](../spell_dir/expeditiousRetreat#_expeditious-retreat), [magic missile](../spell_dir/magicMissile#_magic-missile), [ray of enfeeblement](../spell_dir/rayOfEnfeeblement#_ray-of-enfeeblement) _(DC 14), _ [shield](../spell_dir/shield#_shield), [silent image](../spell_dir/silentImage#_silent-image)_

0 (at will)—_ [daze](../spell_dir/daze#_daze), [detect magic](../spell_dir/detectMagic#_detect-magic), [light](../spell_dir/light#_light), [mage hand](../spell_dir/mageHand#_mage-hand), [open/close](../spell_dir/openClose#_open-close), [ray of frost](../spell_dir/rayOfFrost#_ray-of-frost), [read magic](../spell_dir/readMagic#_read-magic)_
...
**Skills** [Bluff](../skill_dir/bluff#_bluff) +13, [Diplomacy](../skill_dir/diplomacy#_diplomacy) +9, [Disguise](../skill_dir/disguise#_disguise) +9, [Escape Artist](../skill_dir/escapeArtist#_escape-artist) +13, [Intimidate](../skill_dir/intimidate#_intimidate) +12, [Knowledge](../skill_dir/knowledge#_knowledge) (arcana) +13, [Perception](../skill_dir/perception#_perception) +19, [Sense Motive](../skill_dir/senseMotive#_sense-motive) +10, [Spellcraft](../skill_dir/spellcraft#_spellcraft) +12, [Stealth](../skill_dir/stealth#_stealth) +18
...
**Detect Thoughts (Su)** A dark naga can continuously use _ [detect thoughts](../spell_dir/detectThoughts#_detect-thoughts) _as per the spell (caster level 9th; Will DC 18 negates). The save DC is Charisma-based.

**Guarded Thoughts (Ex)** Dark nagas are immune to any form of mind reading, such as that granted by _ [detect thoughts](../spell_dir/detectThoughts#_detect-thoughts)_. This ability also grants a +2 racial bonus on all saves against charm effects.
...
4th (5/day)—_ [divine power](../spell_dir/divinePower#_divine-power), [greater invisibility](../spell_dir/invisibility#_invisibility-greater)_

3rd (7/day)—_ [cure serious wounds](../spell_dir/cureSeriousWounds#_cure-serious-wounds), [dispel magic](../spell_dir/dispelMagic#_dispel-magic), [lightning bolt](../spell_dir/lightningBolt#_lightning-bolt) _(DC 17)

2nd (7/day)—_ [detect thoughts](../spell_dir/detectThoughts#_detect-thoughts) _(DC 16), _ [lesser restoration](../spell_dir/restoration#_restoration-lesser), [see invisibility](../spell_dir/seeInvisibility#_see-invisibility), [scorching ray](../spell_dir/scorchingRay#_scorching-ray)_

1st (7/day)—_ [cure light wounds](../spell_dir/cureLightWounds#_cure-light-wounds), [divine favor](../spell_dir/divineFavor#_divine-favor), [expeditious retreat](../spell_dir/expeditiousRetreat#_expeditious-retreat), [mage armor](../spell_dir/mageArmor#_mage-armor), [magic missile](../spell_dir/magicMissile#_magic-missile)_

0 (at will)—_ [daze](../spell_dir/daze#_daze) _(DC 14), _ [detect magic](../spell_dir/detectMagic#_detect-magic), [light](../spell_dir/light#_light), [mage hand](../spell_dir/mageHand#_mage-hand), [open/close](../spell_dir/openClose#_open-close), [ray of frost](../spell_dir/rayOfFrost#_ray-of-frost), [read magic](../spell_dir/readMagic#_read-magic), [stabilize](../spell_dir/stabilize#_stabilize)_
...
**Skills** [Bluff](../skill_dir/bluff#_bluff) +16, [Diplomacy](../skill_dir/diplomacy#_diplomacy) +16, [Knowledge](../skill_dir/knowledge#_knowledge) (arcana) +18, [Perception](../skill_dir/perception#_perception) +23, [Sense Motive](../skill_dir/senseMotive#_sense-motive) +20, [Spellcraft](../skill_dir/spellcraft#_spellcraft) +18, [Stealth](../skill_dir/stealth#_stealth) +17
...
**Poison (Ex)** Bite—injury or spit—contact; _save_ Fort DC 21; _frequency_ 1/round for 6 rounds; _effect_ 1d4 Con [damage](universalMonsterRules#_ability-damage-and-drain); _cure_ 2 consecutive saves. The save DC is Constitution-based.
...
**Init** +5; **Senses** darkvision 60 ft.; [Perception](../skill_dir/perception#_perception) +22
...
3rd (5/day)—_ [displacement](../spell_dir/displacement#_displacement), [fireball](../spell_dir/fireball#_fireball)_ (DC 16)

2nd (7/day)—_ [cat's grace](../spell_dir/catSGrace#_cat-s-grace), [invisibility](../spell_dir/invisibility#_invisibility), [summon swarm](../spell_dir/summonSwarm#_summon-swarm)_

1st (7/day)—_ [charm person](../spell_dir/charmPerson#_charm-person) _(DC 14), _ [cure light wounds](../spell_dir/cureLightWounds#_cure-light-wounds), [divine favor](../spell_dir/divineFavor#_divine-favor), [magic missile](../spell_dir/magicMissile#_magic-missile), [shield of faith](../spell_dir/shieldOfFaith#_shield-of-faith)_

0 (at will)—_ [bleed](../spell_dir/bleed#_bleed), [daze](../spell_dir/daze#_daze) _(DC 13), _ [detect magic](../spell_dir/detectMagic#_detect-magic), [mage hand](../spell_dir/mageHand#_mage-hand), [open/close](../spell_dir/openClose#_open-close), [ray of frost](../spell_dir/rayOfFrost#_ray-of-frost), [read magic](../spell_dir/readMagic#_read-magic)_
...
**Feats** [Ability Focus](monsterFeats#_ability-focus) (charming gaze), [Combat Casting](../feats#_combat-casting), [Eschew Materials](../feats#_eschew-materials)B, [Lightning Reflexes](../feats#_lightning-reflexes), [Skill Focus](../feats#_skill-focus) ( [Perception](../skill_dir/perception#_perception)), [Stealthy](../feats#_stealthy)

**Skills** [Bluff](../skill_dir/bluff#_bluff) +13, [Escape Artist](../skill_dir/escapeArtist#_escape-artist) +13, [Intimidate](../skill_dir/intimidate#_intimidate) +9, [Knowledge](../skill_dir/knowledge#_knowledge) (arcana) +14, [Perception](../skill_dir/perception#_perception) +22, [Spellcraft](../skill_dir/spellcraft#_spellcraft) +11, [Stealth](../skill_dir/stealth#_stealth) +15, [Swim](../skill_dir/swim#_swim) +12
...
**Charming Gaze (Su)** As _ [charm person](../spell_dir/charmPerson#_charm-person), _30 feet, Will DC 20 negates. The save DC is Charisma-based.

**Poison (Ex)** Bite—injury; _save_ Fort DC 20; _frequency_ 1/round for 6 rounds; _effect_ 1d4 Con [damage](universalMonsterRules#_ability-damage-and-drain); _cure_ 1 save.

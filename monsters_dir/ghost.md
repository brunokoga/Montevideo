...
_Telekinesis (Su)_: The ghost's death involved great physical trauma. The ghost can use _ [telekinesis](../spell_dir/telekinesis#_telekinesis) _as a standard action once every 1d4 rounds (caster level 12th or equal to the ghost's HD, whichever is higher).

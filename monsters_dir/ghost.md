...
**Init** +5; **Senses** darkvision 60 ft.; [Perception](../skills/perception#_perception) +18
...
**Skills** [Fly](../skills/fly#_fly) +9, [Knowledge](../skills/knowledge#_knowledge) (history) +10, [Knowledge](../skills/knowledge#_knowledge) (nobility) +10, [Perception](../skills/perception#_perception) +18, [Sense Motive](../skills/senseMotive#_sense-motive) +10, [Stealth](../skills/stealth#_stealth) +9; **Racial Modifiers** +8 [Perception](../skills/perception#_perception), +8 [Stealth](../skills/stealth#_stealth)
...
**Armor Class** : A ghost gains a deflection bonus equal to its Charisma modifier. It loses the base creature's natural armor bonus, as well as all armor and shield bonuses not from force effects or _ [ghost touch](../magicItems/weapons#_weapons-ghost-touch) _items.
...
**Melee and Ranged Attacks** : A ghost loses all of the base creature's attacks. If it could wield weapons in life, it can wield _ [ghost touch](../magicItems/weapons#_weapons-ghost-touch) weapons_ as a ghost.

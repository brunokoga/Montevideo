...
N Medium [monstrous humanoid](creatureTypes.md#_monstrous-humanoid) (shapechanger)
...
At will—_ [detect thoughts](../spells/detectThoughts.md#_detect-thoughts)_ (DC 13)
...
**Feats** [Dodge](../feats.md#_dodge), [Great Fortitude](../feats.md#_great-fortitude)

**Skills** [Bluff](../skills/bluff.md#_bluff) +9 (+13 while using change shape ability), [Diplomacy](../skills/diplomacy.md#_diplomacy) +4, [Disguise](../skills/disguise.md#_disguise) +9 (+29 while using change shape ability), [Perception](../skills/perception.md#_perception) +9, [Sense Motive](../skills/senseMotive.md#_sense-motive) +6, [Stealth](../skills/stealth.md#_stealth) +5; **Racial Modifiers** +4 [Bluff](../skills/bluff.md#_bluff), +4 [Disguise](../skills/disguise.md#_disguise)

**Languages** Common

**SQ** [change shape](universalMonsterRules.md#_change-shape) (_ [alter self](../spells/alterSelf.md#_alter-self)_), mimicry, perfect copy

...
**Speak with Reptiles (Sp)** A young or older black dragon gains the constant spell-like ability to speak with reptiles. This functions as _ [speak with animals](../spells/speakWithAnimals.md#_speak-with-animals),_ but only with reptilian animals.
...
0 (at will)—_ [dancing lights](../spells/dancingLights.md#_dancing-lights), [detect magic](../spells/detectMagic.md#_detect-magic), [mending](../spells/mending.md#_mending), [message](../spells/message.md#_message), [read magic](../spells/readMagic.md#_read-magic)_
...
1st (7/day)—_ [alarm](../spells/alarm.md#_alarm)_, _ [mage armor](../spells/mageArmor.md#_mage-armor), [shield](../spells/shield.md#_shield), [true strike](../spells/trueStrike.md#_true-strike)_
...
At will—_ [ghost sound](../spells/ghostSound.md#_ghost-sound) _(DC 15), _ [hallucinatory terrain](../spells/hallucinatoryTerrain.md#_hallucinatory-terrain) _(DC 19), _ [minor image](../spells/minorImage.md#_minor-image) _(DC 17), _ [veil](../spells/veil.md#_veil), [ventriloquism](../spells/ventriloquism.md#_ventriloquism)_ (DC 16)
...
2nd (5/day)—_ [alter self](../spells/alterSelf.md#_alter-self), [mirror image](../spells/mirrorImage.md#_mirror-image)_
...
0 (at will)—_ [arcane mark](../spells/arcaneMark.md#_arcane-mark), [bleed](../spells/bleed.md#_bleed), [light](../spells/light.md#_light), [mage hand](../spells/mageHand.md#_mage-hand), [mending](../spells/mending.md#_mending), [message](../spells/message.md#_message), [open/close](../spells/openClose.md#_open-close), [prestidigitation](../spells/prestidigitation.md#_prestidigitation), [read magic](../spells/readMagic.md#_read-magic)_
...
**Skills** [Fly](../skills/fly.md#_fly) +16, [Intimidate](../skills/intimidate.md#_intimidate) +27, [Knowledge](../skills/knowledge.md#_knowledge) (arcane) +27, [Knowledge](../skills/knowledge.md#_knowledge) (history) +27, [Perception](../skills/perception.md#_perception) +32, [Sense Motive](../skills/senseMotive.md#_sense-motive) +32, [Spellcraft](../skills/spellcraft.md#_spellcraft) +27, [Stealth](../skills/stealth.md#_stealth) +16, [Swim](../skills/swim.md#_swim) +43
...
1st (8/day)—_ [alarm](../spells/alarm.md#_alarm), [charm person](../spells/charmPerson.md#_charm-person) _(DC 18), _ [protection from evil](../spells/protectionFromEvil.md#_protection-from-evil), [shield](../spells/shield.md#_shield), [ventriloquism](../spells/ventriloquism.md#_ventriloquism)_
...
**Repulsion Breath (Su)** Instead of a line of electricity, a bronze dragon can breathe a cone of _ [repulsion](../spells/repulsion.md#_repulsion) _gas. Targets must make a Will save or be compelled to do nothing but move away from the dragon for 1d6 rounds plus 1 round per age category. This is a mind-affecting compulsion effect.

**Spell-Like Abilities (Sp)** A bronze dragon gains the following spell-like abilities, usable at will upon reaching the listed age category. Very young—_ [speak with animals](../spells/speakWithAnimals.md#_speak-with-animals)_; Juvenile—_ [create food and water](../spells/createFoodAndWater.md#_create-food-and-water)_; Adult—_ [fog cloud](../spells/fogCloud.md)_; Old—_ [detect thoughts](../spells/detectThoughts.md#_detect-thoughts)_; Ancient—_ [control water](../spells/controlWater.md#_control-water)_; Great wyrm—_ [control weather](../spells/controlWeather.md#_control-weather)_.
...
**Vortex (Ex)** Once per day, an ancient or older bronze dragon can create a vortex as a standard action, just like an [elder water elemental](elemental.md#_elemental-water). A bronze dragon can maintain this vortex for 1 round per age category.
...
| Juvenile | Wave mastery, _ [create food and water](../spells/createFoodAndWater.md#_create-food-and-water)_ | 3rd |
| Young adult | DR 5/magic, spell resistance | 5th |
| Adult | frightful presence, _ [fog cloud](../spells/fogCloud.md)_ | 7th |
| Mature adult | DR 10/magic | 9th |
| Old | Electricity aura, _ [detect thoughts](../spells/detectThoughts.md#_detect-thoughts)_ | 11th |
| Very old | DR 15/magic | 13th |
| Ancient | Vortex, _ [control water](../spells/controlWater.md#_control-water)_ | 15th |
| Wyrm | DR 20/magic | 17th |
| Great wyrm | Tidal wave, _ [control weather](../spells/controlWeather.md#_control-weather)_ | 19th |

**Young Bronze Dragon CR 9**

**XP 6,400**

LG Large [dragon](creatureTypes.md#_dragon) ( [water](creatureTypes.md#_water-subtype))

**Init** +1; **Senses** dragon senses; [Perception](../skills/perception.md#_perception) +20
...
1st (4/day)—_ [alarm](../spells/alarm.md#_alarm), [obscuring mist](../spells/obscuringMist.md#_obscuring-mist)_

0 (at will)—_ [detect magic](../spells/detectMagic.md#_detect-magic), [light](../spells/light.md#_light), [message](../spells/message.md#_message), [resistance](../spells/resistance.md#_resistance)_
...
**Feats** [Alertness](../feats.md#_alertness), [Flyby Attack](monsterFeats.md#_flyby-attack), [Multiattack](monsterFeats.md#_multiattack), [Power Attack](../feats.md#_power-attack), [Vital Strike](../feats.md#_vital-strike)

**Skills** [Diplomacy](../skills/diplomacy.md#_diplomacy) +16, [Fly](../skills/fly.md#_fly) +8, [Intimidate](../skills/intimidate.md#_intimidate) +16, Knowl. (arcana) +16, Percep. +20, S. Motive +20, [Spellcraft](../skills/spellcraft.md#_spellcraft) +16, [Stealth](../skills/stealth.md#_stealth) +10, [Swim](../skills/swim.md#_swim) +26

**Languages** Aquan, Common, Draconic, Elven

**SQ** [change shape](universalMonsterRules.md#_change-shape), water breathing

**Adult Bronze Dragon CR 13**

**XP 25,600**

LG Huge [dragon](creatureTypes.md#_dragon) ( [water](creatureTypes.md#_water-subtype))

**Init** +0; **Senses** dragon senses; [Perception](../skills/perception.md#_perception) +28
...
At will—_ [create food and water](../spells/createFoodAndWater.md#_create-food-and-water), [fog cloud](../spells/fogCloud.md), [speak with animals](../spells/speakWithAnimals.md#_speak-with-animals)_

**Spells Known** (CL 7th)

3rd (5/day)—_ [dispel magic](../spells/dispelMagic.md#_dispel-magic), [slow](../spells/slow.md#_slow) _(DC 18)

2nd (7/day)—_ [blur](../spells/blur.md#_blur)_, _ [gust of wind](../spells/gustOfWind.md#_gust-of-wind), [mirror image](../spells/mirrorImage.md#_mirror-image)_

1st (8/day)—_ [alarm](../spells/alarm.md#_alarm), [mage armor](../spells/mageArmor.md#_mage-armor), [obscuring mist](../spells/obscuringMist.md#_obscuring-mist), [shield](../spells/shield.md#_shield), [true strike](../spells/trueStrike.md#_true-strike)_

0 (at will)—_ [detect magic](../spells/detectMagic.md#_detect-magic), [light](../spells/light.md#_light), [message](../spells/message.md#_message), [resistance](../spells/resistance.md#_resistance)_, 2 more
...
**Feats** [Alertness](../feats.md#_alertness), [Cleave](../feats.md#_cleave), [Flyby Attack](monsterFeats.md#_flyby-attack), [Hover](monsterFeats.md#_hover), [Improved Vital Strike](../feats.md#_improved-vital-strike), [Multiattack](monsterFeats.md#_multiattack), [Power Attack](../feats.md#_power-attack), [Vital Strike](../feats.md#_vital-strike)

**Skills** [Diplomacy](../skills/diplomacy.md#_diplomacy) +24, [Fly](../skills/fly.md#_fly) +11, Handle Animals +21, [Intimidate](../skills/intimidate.md#_intimidate) +24, [Knowledge](../skills/knowledge.md#_knowledge) (arcana, geography) +24, [Perception](../skills/perception.md#_perception) +28, [Sense Motive](../skills/senseMotive.md#_sense-motive) +28, [Spellcraft](../skills/spellcraft.md#_spellcraft) +24, [Stealth](../skills/stealth.md#_stealth) +11, [Swim](../skills/swim.md#_swim) +35

**Languages** Aquan, Common, Draconic, Elven, Gnome, 2 more

**SQ** [change shape](universalMonsterRules.md#_change-shape), water breathing, wave mastery

**Ancient Bronze Dragon CR 18**

**XP 153,600**

LG Gargantuan [dragon](creatureTypes.md#_dragon) ( [water](creatureTypes.md#_water-subtype))

**Init** +3; **Senses** dragon senses; [Perception](../skills/perception.md#_perception) +38
...
At will—_ [control water](../spells/controlWater.md#_control-water), [create food and water](../spells/createFoodAndWater.md#_create-food-and-water), [detect thoughts](../spells/detectThoughts.md#_detect-thoughts)_ (DC 19), _ [fog cloud](../spells/fogCloud.md), [speak with animals](../spells/speakWithAnimals.md#_speak-with-animals)_

**Spells Known** (CL 15th)

7th (5/day)—_ [spell turning](../spells/spellTurning.md#_spell-turning), [statue](../spells/statue.md#_statue)_

6th (7/day)—_ [greater dispel magic](../spells/dispelMagic.md#_dispel-magic-greater), [mass suggestion](../spells/suggestion.md#_suggestion-mass) _(DC 23), _ [mislead](../spells/mislead.md#_mislead)_

5th (7/day)—_ [dismissal](../spells/dismissal.md#_dismissal), [interposing hand](../spells/interposingHand.md#_interposing-hand), [mind fog](../spells/mindFog.md#_mind-fog), [teleport](../spells/teleport.md#_teleport)_

4th (7/day)—_ [dimension door](../spells/dimensionDoor.md#_dimension-door), [ice storm](../spells/iceStorm.md#_ice-storm), [solid fog](../spells/solidFog.md#_solid-fog)_, _ [stoneskin](../spells/stoneskin.md#_stoneskin)_

3rd (7/day)—_ [dispel magic](../spells/dispelMagic.md#_dispel-magic), [heroism](../spells/heroism.md#_heroism), [slow](../spells/slow.md#_slow) _(DC 20), _ [suggestion](../spells/suggestion.md#_suggestion)_

2nd (8/day)—_ [blur](../spells/blur.md#_blur)_, _ [gust of wind](../spells/gustOfWind.md#_gust-of-wind), [invisibility](../spells/invisibility.md#_invisibility), [mirror image](../spells/mirrorImage.md#_mirror-image), [web](../spells/web.md#_web)_
...
**Feats** [Alertness](../feats.md#_alertness), [Cleave](../feats.md#_cleave), [Flyby Attack](monsterFeats.md#_flyby-attack), [Great Cleave](../feats.md#_great-cleave), [Hover](monsterFeats.md#_hover), [Improved Critical](../feats.md#_improved-critical) (bite, claw), [Improved Initiative](../feats.md#_improved-initiative), [Improved Vital Strike](../feats.md#_improved-vital-strike), [Multiattack](monsterFeats.md#_multiattack), [Power Attack](../feats.md#_power-attack), [Vital Strike](../feats.md#_vital-strike)

**Skills** [Diplomacy](../skills/diplomacy.md#_diplomacy) +34, [Fly](../skills/fly.md#_fly) +10, Handle Animals +31, [Heal](../skills/heal.md#_heal) +34, [Intimidate](../skills/intimidate.md#_intimidate) +34, [Knowledge](../skills/knowledge.md#_knowledge) (arcana, geography, history) +34, Percep. +38, S. Motive +38, [Spellcraft](../skills/spellcraft.md#_spellcraft) +34, [Stealth](../skills/stealth.md#_stealth) +14, [Swim](../skills/swim.md#_swim) +47
...
CG [dragon](creatureTypes.md#_dragon) ( [earth](creatureTypes.md#_earth-subtype))
...
**[Climb](../skills/climb.md#_climb) Stone (Ex)** A copper dragon can climb on stone surfaces as though using the _ [spider climb](../spells/spiderClimb.md#_spider-climb) _spell.

**Deadly Joke (Sp)** Once per day, as a standard action, a great wyrm copper dragon can tell a joke that kills. This affects one target, and functions as _ [power word kill](../spells/powerWordKill.md#_power-word-kill)_. This is a language-dependent sonic effect.

**Mass Laughter (Sp)** An ancient copper dragon can tell a fantastic joke once per day as a standard action. All creatures within 10 feet per age category must make a Will save or laugh for 1 round per age category, as if affected by _ [hideous laughter](../spells/hideousLaughter.md#_hideous-laughter)_. The save DC is Charisma-based. This is equal to a 6th-level spell.

**Slow Aura**  **(Su)** An old or older copper dragon is surrounded by an aura of slowness. All creatures within 5 feet of the dragon must make a Will save or be affected as per _ [slow](../spells/slow.md#_slow)_ for 1 round. An ancient dragon's aura extends to 10 feet. For great wyrm copper dragons, those opponents that fail their saves are slowed for 1d4 rounds. The DC of this save is equal to the dragon's breath weapon. A copper dragon can suppress or activate this aura at will as a free action.

**Slow Breath (Su)** Instead of a line of acid, a copper dragon can breathe a cone of slowing gas. Those in the cone must make a Fortitude save or be slowed (as per the spell _ [slow](../spells/slow.md#_slow)_) for 1d6 rounds plus 1 round per age category of the dragon.

**Spell-Like Abilities (Sp)** A copper dragon gains the following spell-like abilities, usable at will upon reaching the listed age category. Very young—_ [grease](../spells/grease.md#_grease)_; Juvenile—_ [hideous laughter](../spells/hideousLaughter.md#_hideous-laughter)_; Adult—_ [stone shape](../spells/stoneShape.md#_stone-shape)_; Old—_ [transmute rock to mud](../spells/transmuteRockToMud.md#_transmute-rock-to-mud)/mud to rock_; Ancient—_ [wall of stone](../spells/wallOfStone.md#_wall-of-stone)_; Great wyrm—_ [move earth](../spells/moveEarth.md#_move-earth)_.

**Trap Master**  **(Ex)** A juvenile or older copper dragon receives a +1 bonus per age categroy on [Craft](../skills/craft.md#_craft) (traps) and [Perception](../skills/perception.md#_perception) checks made to locate a trap. Upon becoming a mature adult, he can also use [Disable Device](../skills/disableDevice.md#_disable-device) to disarm magic traps as if he had the rogue's Trapfinding class feature.

**Uncanny [Dodge](../feats.md#_dodge) (Ex)** A young or older copper dragon is always looking out for an ambush. He can never be caught flat-footed. This ability functions like the rogue ability of the same name.
...
| Juvenile | Trap master, _ [hideous laughter](../spells/hideousLaughter.md#_hideous-laughter)_ | 3rd |
| Young adult | DR 5/magic, spell resistance | 5th |
| Adult | Frightful presence, _ [stone shape](../spells/stoneShape.md#_stone-shape)_ | 7th |
| Mature adult | DR 10/magic | 9th |
| Old | Slow aura, _transmute rock/mud_ | 11th |
| Very old | DR 15/magic | 13th |
| Ancient | Mass laughter, _ [wall of stone](../spells/wallOfStone.md#_wall-of-stone)_ | 15th |
| Wyrm | DR 20/magic | 17th |
| Great wyrm | Deadly joke, _ [move earth](../spells/moveEarth.md#_move-earth)_ | 19th |

**Young Copper Dragon CR 8**

**XP 4,800**

CG Medium [dragon](creatureTypes.md#_dragon) ( [earth](creatureTypes.md#_earth-subtype))

**Init** +6; **Senses** [Perception](../skills/perception.md#_perception) +14
...
At will—_ [grease](../spells/grease.md#_grease) _(DC 13)

**Spells Known** (CL 1st)

1st (4/day)—_ [alarm](../spells/alarm.md#_alarm), [silent image](../spells/silentImage.md#_silent-image) _(DC 13)

0 (at will)—_ [detect magic](../spells/detectMagic.md#_detect-magic), [ghost sound](../spells/ghostSound.md#_ghost-sound) _(DC 12)_, [light](../spells/light.md#_light), [message](../spells/message.md#_message)_
...
**Feats** [Combat Expertise](../feats.md#_combat-expertise), [Improved Critical](../feats.md#_improved-critical) (bite), [Improved Initiative](../feats.md#_improved-initiative), [Improved Trip](../feats.md#_improved-trip), [Power Attack](../feats.md#_power-attack)

**Skills** [Bluff](../skills/bluff.md#_bluff) +14, [Craft](../skills/craft.md#_craft) (trap) +14, [Fly](../skills/fly.md#_fly) +14, [Perception](../skills/perception.md#_perception) +14, [Perform](../skills/perform.md#_perform) (comedy) +11, S. Motive +14, [Stealth](../skills/stealth.md#_stealth) +14, [Use Magic Device](../skills/useMagicDevice.md#_use-magic-device) +14
...
CG Large [dragon](creatureTypes.md#_dragon) ( [earth](creatureTypes.md#_earth-subtype))

**Init** +5; **Senses** [Perception](../skills/perception.md#_perception) +22
...
At will—_ [grease](../spells/grease.md#_grease)_ (DC 15), _ [hideous laughter](../spells/hideousLaughter.md#_hideous-laughter)_ (DC 16), _ [stone shape](../spells/stoneShape.md#_stone-shape)_

**Spells Known** (CL 7th)

3rd (5/day)—_ [dispel magic](../spells/dispelMagic.md#_dispel-magic), [major image](../spells/majorImage.md#_major-image) _(DC 17)

2nd (7/day)—_ [glitterdust](../spells/glitterdust.md#_glitterdust) _(DC 16), _ [invisibility](../spells/invisibility.md#_invisibility), [phantom trap](../spells/phantomTrap.md#_phantom-trap)_

1st (7/day)—_ [alarm](../spells/alarm.md#_alarm), [identify](../spells/identify.md#_identify), [magic missile](../spells/magicMissile.md#_magic-missile), [shield](../spells/shield.md#_shield), [silent image](../spells/silentImage.md#_silent-image) _(DC 15)

0 (at will)—_ [detect magic](../spells/detectMagic.md#_detect-magic), [ghost sound](../spells/ghostSound.md#_ghost-sound) _(DC 14)_, [light](../spells/light.md#_light), [message](../spells/message.md#_message), [open/close](../spells/openClose.md#_open-close), [prestidigitation](../spells/prestidigitation.md#_prestidigitation), [read magic](../spells/readMagic.md#_read-magic)_
...
**Feats** [Combat Expertise](../feats.md#_combat-expertise), [Greater Trip](../feats.md#_greater-trip), Improved Critcal (bite, claw), [Improved Initiative](../feats.md#_improved-initiative), [Improved Trip](../feats.md#_improved-trip), [Power Attack](../feats.md#_power-attack), [Vital Strike](../feats.md#_vital-strike)

**Skills** [Bluff](../skills/bluff.md#_bluff) +22, [Craft](../skills/craft.md#_craft) (traps) +28, [Diplomacy](../skills/diplomacy.md#_diplomacy) +22, [Fly](../skills/fly.md#_fly) +13, [Perception](../skills/perception.md#_perception) +22, [Perform](../skills/perform.md#_perform) (comedy) +19, [Sense Motive](../skills/senseMotive.md#_sense-motive) +22, [Spellcraft](../skills/spellcraft.md#_spellcraft) +22, [Stealth](../skills/stealth.md#_stealth) +15, [Use Magic Device](../skills/useMagicDevice.md#_use-magic-device) +22
...
CG Huge [dragon](creatureTypes.md#_dragon) ( [earth](creatureTypes.md#_earth-subtype))

**Init** +4; **Senses** dragon senses; [Perception](../skills/perception.md#_perception) +32
...
At will—_ [grease](../spells/grease.md#_grease)_ (DC 17), _ [hideous laughter](../spells/hideousLaughter.md#_hideous-laughter)_ (DC 18), _ [stone shape](../spells/stoneShape.md#_stone-shape), [transmute mud to rock](../spells/transmuteMudToRock.md#_transmute-mud-to-rock), [transmute rock to mud](../spells/transmuteRockToMud.md#_transmute-rock-to-mud),_ _ [wall of stone](../spells/wallOfStone.md#_wall-of-stone)_

**Spells Known** (CL 15th)

7th (4/day)—_ [reverse gravity](../spells/reverseGravity.md#_reverse-gravity), [teleport object](../spells/teleportObject.md#_teleport-object) _(DC 23)

6th (7/day)—_ [antimagic field](../spells/antimagicField.md#_antimagic-field), [mislead](../spells/mislead.md#_mislead), [programmed image](../spells/programmedImage.md#_programmed-image) _(DC 23)

5th (7/day)—_ [mind fog](../spells/mindFog.md#_mind-fog)_ (DC 21), _ [polymorph](../spells/polymorph.md#_polymorph), [sending](../spells/sending.md#_sending)_, _ [teleport](../spells/teleport.md#_teleport)_

4th (7/day)—_ [confusion](../spells/confusion.md#_confusion)_, _ [rainbow pattern](../spells/rainbowPattern.md#_rainbow-pattern), [stone shape](../spells/stoneShape.md#_stone-shape)_, _ [stoneskin](../spells/stoneskin.md#_stoneskin)_

3rd (7/day)—_ [dispel magic](../spells/dispelMagic.md#_dispel-magic), [haste](../spells/haste.md#_haste), [suggestion](../spells/suggestion.md#_suggestion) _(DC 19), _ [tongues](../spells/tongues.md#_tongues)_

2nd (7/day)—_ [glitterdust](../spells/glitterdust.md#_glitterdust) _(DC 18), _ [invisibility](../spells/invisibility.md#_invisibility), [phantom trap](../spells/phantomTrap.md#_phantom-trap), [pyrotechnics](../spells/pyrotechnics.md#_pyrotechnics), [see invisibility](../spells/seeInvisibility.md#_see-invisibility)_

1st (8/day)—_ [expeditious retreat](../spells/expeditiousRetreat.md#_expeditious-retreat), [magic aura](../spells/magicAura.md#_magic-aura), [obscuring mist](../spells/obscuringMist.md#_obscuring-mist), [shield](../spells/shield.md#_shield), [silent image](../spells/silentImage.md#_silent-image) _(DC 18)

0 (at will)—_ [dancing lights](../spells/dancingLights.md#_dancing-lights), [detect magic](../spells/detectMagic.md#_detect-magic), [ghost sound](../spells/ghostSound.md#_ghost-sound) _(DC 17)_, [light](../spells/light.md#_light), [mage hand](../spells/mageHand.md#_mage-hand), [message](../spells/message.md#_message), [open/close](../spells/openClose.md#_open-close), [prestidigitation](../spells/prestidigitation.md#_prestidigitation), [read magic](../spells/readMagic.md#_read-magic)_
...
**Feats** [Combat Expertise](../feats.md#_combat-expertise), [Greater Trip](../feats.md#_greater-trip), Imp. Critical (bite, claw), [Improved Disarm](../feats.md#_improved-disarm), Imp. Initiative, Imp. Trip, [Improved Vital Strike](../feats.md#_improved-vital-strike), [Power Attack](../feats.md#_power-attack), [Quicken Spell](../feats.md#_quicken-spell), [Spell Focus](../feats.md#_spell-focus) (illusion), [Vital Strike](../feats.md#_vital-strike)

**Skills** [Bluff](../skills/bluff.md#_bluff) +32, [Craft](../skills/craft.md#_craft) (traps) +42, [Diplomacy](../skills/diplomacy.md#_diplomacy) +32, [Fly](../skills/fly.md#_fly) +18, [Knowledge](../skills/knowledge.md#_knowledge) (geography) +32, [Knowledge](../skills/knowledge.md#_knowledge) (history) +32, [Perception](../skills/perception.md#_perception) +32, [Perform](../skills/perform.md#_perform) (comedy) +29, [Sense Motive](../skills/senseMotive.md#_sense-motive) +32, [Spellcraft](../skills/spellcraft.md#_spellcraft) +32, [Stealth](../skills/stealth.md#_stealth) +18, [Use Magic Device](../skills/useMagicDevice.md#_use-magic-device) +32
...
LG [dragon](creatureTypes.md#_dragon) ( [fire](creatureTypes.md#_fire-subtype))
...
**Change Shape (Su)** A very young or older gold dragon can assume any animal or humanoid form three times per day as if using _ [polymorph](../spells/polymorph.md#_polymorph)_.

**Detect Gems (Sp)** A young or older gold dragon can detect gems three times per day. This functions as _ [locate object](../spells/locateObject.md#_locate-object)_, but can only be used to locate gemstones.

**Divine Aid (Sp)** Once a week, a great wyrm gold dragon can call upon celestial powers for aid. This functions as a _ [miracle](../spells/miracle.md#_miracle)_.
...
**Spell-Like Abilities (Sp)** A gold dragon gains the following spell-like abilities upon reaching the listed age category. Its caster level for these effects is equal to its Hit Dice, and any save DCs are Charisma-based. A gold dragon can use these abilities at will. Very young—_ [detect evil](../spells/detectEvil.md#_detect-evil)_; Juvenile—_ [bless](../spells/bless.md#_bless)_; Adult—_ [daylight](../spells/daylight.md#_daylight)_; Old—_ [geas/quest](../spells/geasQuest.md#_geas-quest)_; Ancient—_ [sunburst](../spells/sunburst.md#_sunburst)_; Great wyrm—_ [foresight](../spells/foresight.md#_foresight)_.
...
| Very young | Change shape, _ [detect evil](../spells/detectEvil.md#_detect-evil)_ | — |
| Young | Fast flight, detect gems | 1st |
| Juvenile | _Bless_ | 3rd |
| Young adult | DR 5/magic, spell resistance | 5th |
| Adult | Frightful presence, luck, _ [daylight](../spells/daylight.md#_daylight)_ | 7th |
| Mature adult | DR 10/magic | 9th |
| Old | Fire aura, _ [geas/quest](../spells/geasQuest.md#_geas-quest)_ | 11th |
| Very old | DR 15/magic | 13th |
| Ancient | _Sunburst_ | 15th |
| Wyrm | DR 20/magic | 17th |
| Great wyrm | Divine aid, _ [foresight](../spells/foresight.md#_foresight)_ | 19th |

**Young Gold Dragon CR 11**

**XP 12,800**

LG Large [dragon](creatureTypes.md#_dragon) ( [fire](creatureTypes.md#_fire-subtype))

**Init** +1; **Senses** dragon senses [Perception](../skills/perception.md#_perception) +22
...
1st (4/day)—_ [mage armor](../spells/mageArmor.md#_mage-armor), [shield](../spells/shield.md#_shield)_

0 (at will)—_ [detect magic](../spells/detectMagic.md#_detect-magic), [light](../spells/light.md#_light), [mending](../spells/mending.md#_mending), [stabilize](../spells/stabilize.md#_stabilize)_
...
**Feats** [Alertness](../feats.md#_alertness), [Improved Critical](../feats.md#_improved-critical) (claw), [Iron Will](../feats.md#_iron-will), [Multiattack](monsterFeats.md#_multiattack), [Power Attack](../feats.md#_power-attack), [Vital Strike](../feats.md#_vital-strike)

**Skills** [Diplomacy](../skills/diplomacy.md#_diplomacy) +18, [Fly](../skills/fly.md#_fly) +10, [Heal](../skills/heal.md#_heal) +18, [Knowledge](../skills/knowledge.md#_knowledge) (local, religion) +18, [Perception](../skills/perception.md#_perception) +22, [Sense Motive](../skills/senseMotive.md#_sense-motive) +22, [Spellcraft](../skills/spellcraft.md#_spellcraft) +18, [Swim](../skills/swim.md#_swim) +30

**Languages** Common, Draconic, Elven, Halfling

**SQ** [change shape](universalMonsterRules.md#_change-shape), detect gems, fast flight

**Adult Gold Dragon CR 15**

**XP 51,200**

LG Huge [dragon](creatureTypes.md#_dragon) ( [fire](creatureTypes.md#_fire-subtype))

**Init** +0; **Senses** dragon senses; [Perception](../skills/perception.md#_perception) +30
...
At will—_ [bless](../spells/bless.md#_bless), [daylight](../spells/daylight.md#_daylight), [detect evil](../spells/detectEvil.md#_detect-evil)_

**Spells Known** (CL 7th)

3rd (5/day)—_ [dispel magic](../spells/dispelMagic.md#_dispel-magic), [prayer](../spells/prayer.md#_prayer)_

2nd (7/day)—_ [aid](../spells/aid.md#_aid), [cure moderate wounds](../spells/cureModerateWounds.md#_cure-moderate-wounds) _(DC 17)_, [resist energy](../spells/resistEnergy.md#_resist-energy)_

1st (7/day)—_ [alarm](../spells/alarm.md#_alarm), [divine favor](../spells/divineFavor.md#_divine-favor), [mage armor](../spells/mageArmor.md#_mage-armor), [shield](../spells/shield.md#_shield), [shield of faith](../spells/shieldOfFaith.md#_shield-of-faith)_

0 (at will)—_ [detect magic](../spells/detectMagic.md#_detect-magic), [light](../spells/light.md#_light), [mending](../spells/mending.md#_mending), [stabilize](../spells/stabilize.md#_stabilize)_, 3 more
...
**Feats** [Alertness](../feats.md#_alertness), [Critical Focus](../feats.md#_critical-focus), [Extend Spell](../feats.md#_extend-spell), [Improved Critical](../feats.md#_improved-critical) (bite, claw), [Iron Will](../feats.md#_iron-will), [Multiattack](monsterFeats.md#_multiattack), [Power Attack](../feats.md#_power-attack), [Vital Strike](../feats.md#_vital-strike)

**Skills** [Diplomacy](../skills/diplomacy.md#_diplomacy) +26, [Fly](../skills/fly.md#_fly) +13, [Heal](../skills/heal.md#_heal) +26, [Knowledge](../skills/knowledge.md#_knowledge) (arcana, local, nobility, religion) +26, [Perception](../skills/perception.md#_perception) +30, [Sense Motive](../skills/senseMotive.md#_sense-motive) +30, [Spellcraft](../skills/spellcraft.md#_spellcraft) +26, [Swim](../skills/swim.md#_swim) +39

**Languages** Celestial, Common, Draconic, 3 more

**SQ** [change shape](universalMonsterRules.md#_change-shape), detect gems, fast flight, luck

**Ancient Gold Dragon CR 20**

**XP 307,200**

LG Gargantuan [dragon](creatureTypes.md#_dragon) ( [fire](creatureTypes.md#_fire-subtype))

**Init** –1; **Senses** dragon senses; [Perception](../skills/perception.md#_perception) +40
...
At will—_ [bless](../spells/bless.md#_bless), [daylight](../spells/daylight.md#_daylight), [detect evil](../spells/detectEvil.md#_detect-evil), [geas/quest](../spells/geasQuest.md#_geas-quest), [sunburst](../spells/sunburst.md#_sunburst)_ (DC 25)

**Spells Known** (CL 15th)

7th (5/day)—_ [greater teleport](../spells/teleport.md#_teleport-greater),_ _ [resurrection](../spells/resurrection.md#_resurrection)_

6th (7/day)—_ [antimagic field](../spells/antimagicField.md#_antimagic-field), [greater dispel magic](../spells/dispelMagic.md#_dispel-magic-greater), [heal](../spells/heal.md#_heal)_

5th (7/day)—_ [dispel evil](../spells/dispelEvil.md#_dispel-evil), [plane shift](../spells/planeShift.md#_plane-shift), [teleport](../spells/teleport.md#_teleport), [true seeing](../spells/trueSeeing.md#_true-seeing)_

4th (7/day)—_ [divination](../spells/divination.md#_divination), [restoration](../spells/restoration.md#_restoration), [spell immunity](../spells/spellImmunity.md#_spell-immunity), [stoneskin](../spells/stoneskin.md#_stoneskin)_

3rd (7/day)—_ [dispel magic](../spells/dispelMagic.md#_dispel-magic), [haste](../spells/haste.md#_haste), [invisibility purge](../spells/invisibilityPurge.md#_invisibility-purge), [prayer](../spells/prayer.md#_prayer)_

2nd (8/day)—_ [aid](../spells/aid.md#_aid), [cure moderate wounds](../spells/cureModerateWounds.md#_cure-moderate-wounds), [lesser restoration](../spells/restoration.md#_restoration-lesser), [resist energy](../spells/resistEnergy.md#_resist-energy), [silence](../spells/silence.md#_silence)_

1st (8/day)—_ [alarm](../spells/alarm.md#_alarm), [divine favor](../spells/divineFavor.md#_divine-favor), [mage armor](../spells/mageArmor.md#_mage-armor), [shield](../spells/shield.md#_shield), [shield of faith](../spells/shieldOfFaith.md#_shield-of-faith)_

0 (at will)—_ [detect magic](../spells/detectMagic.md#_detect-magic), [light](../spells/light.md#_light), [mending](../spells/mending.md#_mending), [stabilize](../spells/stabilize.md#_stabilize)_, 6 more
...
**Feats** [Alertness](../feats.md#_alertness), [Critical Focus](../feats.md#_critical-focus), [Extend Spell](../feats.md#_extend-spell), [Improved Critical](../feats.md#_improved-critical) (bite, claw, wing, tail), [Iron Will](../feats.md#_iron-will), [Multiattack](monsterFeats.md#_multiattack), [Power Attack](../feats.md#_power-attack), [Quicken Spell](../feats.md#_quicken-spell), [Staggering Critical](../feats.md#_staggering-critical), [Vital Strike](../feats.md#_vital-strike)

**Skills** [Diplomacy](../skills/diplomacy.md#_diplomacy) +36, [Fly](../skills/fly.md#_fly) +13, [Heal](../skills/heal.md#_heal) +36, [Knowledge](../skills/knowledge.md#_knowledge) (arcana, history, local, nobility, planes, religion) +36, [Perception](../skills/perception.md#_perception) +40, [Sense Motive](../skills/senseMotive.md#_sense-motive) +40, [Spellcraft](../skills/spellcraft.md#_spellcraft) +36, [Swim](../skills/swim.md#_swim) +51
...
LG [dragon](creatureTypes.md#_dragon) ( [cold](creatureTypes.md#_cold-subtype))
...
**Change Shape (Su)** A silver dragon can assume any animal or humanoid form three times per day as if using _ [polymorph](../spells/polymorph.md#_polymorph)_.
...
**Reflective Scales (Su)** Any spell that targets an ancient or older silver dragon but fails to penetrate the silver dragon's spell resistance might be reflected. If the caster level check to penetrate the dragon's spell resistance is failed by 5 or more, the spell is reflected. If the check fails by 4 or less, the spell is merely wasted. This otherwise functions as _ [spell turning](../spells/spellTurning.md#_spell-turning)_.

**Spell-Like Abilities (Sp)** A silver dragon gains the following spell-like abilities, usable at will upon reaching the listed age category. Very young—_ [detect evil](../spells/detectEvil.md#_detect-evil)_; Juvenile—_ [feather fall](../spells/featherFall.md#_feather-fall)_; Adult—_ [fog cloud](../spells/fogCloud.md)_; Old—_ [control winds](../spells/controlWinds.md#_control-winds)_; Ancient—_ [control weather](../spells/controlWeather.md#_control-weather)_; Great wyrm—_ [reverse gravity](../spells/reverseGravity.md#_reverse-gravity)_.
...
| Very young | Cloudwalking, _ [detect evil](../spells/detectEvil.md#_detect-evil)_ | — |
| Young | Graceful flight | 1st |
| Juvenile | Fog vision, _ [feather fall](../spells/featherFall.md#_feather-fall)_ | 3rd |
| Young adult | DR 5/magic, spell resistance | 5th |
| Adult | Frightful presence, _ [fog cloud](../spells/fogCloud.md)_ | 7th |
| Mature adult | DR 10/magic | 9th |
| Old | Cold aura, _ [control winds](../spells/controlWinds.md#_control-winds)_ | 11th |
| Very old | DR 15/magic | 13th |
| Ancient | Reflective scales, _ [control weather](../spells/controlWeather.md#_control-weather)_ | 15th |
| Wyrm | DR 20/magic | 17th |
| Great wyrm | True courage, _ [reverse gravity](../spells/reverseGravity.md#_reverse-gravity)_ | 19th |

**Young Silver Dragon CR 10**

**XP 9,600**

LG Large [dragon](creatureTypes.md#_dragon) ( [cold](creatureTypes.md#_cold-subtype))

**Init** +5; **Senses** dragon senses; [Perception](../skills/perception.md#_perception) +17
...
1st (4/day)—_ [alarm](../spells/alarm.md#_alarm), [true strike](../spells/trueStrike.md#_true-strike)_

0 (at will)—_ [detect magic](../spells/detectMagic.md#_detect-magic), [light](../spells/light.md#_light), [message](../spells/message.md#_message), [read magic](../spells/readMagic.md#_read-magic)_
...
**Feats** [Hover](monsterFeats.md#_hover), [Improved Initiative](../feats.md#_improved-initiative), [Iron Will](../feats.md#_iron-will), [Multiattack](monsterFeats.md#_multiattack), [Power Attack](../feats.md#_power-attack), [Weapon Focus](../feats.md#_weapon-focus) (bite)

**Skills** [Acrobatics](../skills/acrobatics.md#_acrobatics) +12, [Diplomacy](../skills/diplomacy.md#_diplomacy) +17, [Fly](../skills/fly.md#_fly) +13, [Heal](../skills/heal.md#_heal) +17, [Intimidate](../skills/intimidate.md#_intimidate) +17, Know. (local) +17, [Perception](../skills/perception.md#_perception) +17, S. Motive +17, [Spellcraft](../skills/spellcraft.md#_spellcraft) +17

**Languages** Auran, Common, Draconic, Giant

**SQ** [change shape](universalMonsterRules.md#_change-shape)

**Adult Silver Dragon CR 14**

**XP 38,400**

LG Huge [dragon](creatureTypes.md#_dragon) ( [cold](creatureTypes.md#_cold-subtype))

**Init** +4; **Senses** dragon senses, fog vision; [Perception](../skills/perception.md#_perception) +25
...
At will—_ [detect evil](../spells/detectEvil.md#_detect-evil), [feather fall](../spells/featherFall.md#_feather-fall), [fog cloud](../spells/fogCloud.md)_

**Spells Known** (CL 7th)

3rd (5/day)—_ [dispel magic](../spells/dispelMagic.md#_dispel-magic), [wind wall](../spells/windWall.md#_wind-wall)_

2nd (7/day)—_ [augury](../spells/augury.md#_augury), [cure moderate wounds](../spells/cureModerateWounds.md#_cure-moderate-wounds), [web](../spells/web.md#_web)_ (DC 17)

1st (7/day)—_ [alarm](../spells/alarm.md#_alarm)_, _ [bless](../spells/bless.md#_bless), [divine favor](../spells/divineFavor.md#_divine-favor), [shield](../spells/shield.md#_shield), [true strike](../spells/trueStrike.md#_true-strike)_

0 (at will)—_ [detect magic](../spells/detectMagic.md#_detect-magic), [flare](../spells/flare.md#_flare)_, _ [light](../spells/light.md#_light), [message](../spells/message.md#_message), [prestidigitation](../spells/prestidigitation.md#_prestidigitation), [read magic](../spells/readMagic.md#_read-magic), [stabilize](../spells/stabilize.md#_stabilize)_
...
**Feats** [Flyby Attack](monsterFeats.md#_flyby-attack), [Hover](monsterFeats.md#_hover), [Improved Initiative](../feats.md#_improved-initiative), [Iron Will](../feats.md#_iron-will), Lighting Reflexes, [Multiattack](monsterFeats.md#_multiattack), [Power Attack](../feats.md#_power-attack), [Vital Strike](../feats.md#_vital-strike), [Weapon Focus](../feats.md#_weapon-focus) (bite)

**Skills** [Acrobatics](../skills/acrobatics.md#_acrobatics) +17, [Diplomacy](../skills/diplomacy.md#_diplomacy) +25, [Fly](../skills/fly.md#_fly) +16, [Heal](../skills/heal.md#_heal) +25, [Intimidate](../skills/intimidate.md#_intimidate) +25, [Knowledge](../skills/knowledge.md#_knowledge) (arcana, local, nobility) +25, [Perception](../skills/perception.md#_perception) +25, [Sense Motive](../skills/senseMotive.md#_sense-motive) +25, [Spellcraft](../skills/spellcraft.md#_spellcraft) +25
...
LG Gargantuan [dragon](creatureTypes.md#_dragon) ( [cold](creatureTypes.md#_cold-subtype))

**Init** +3; **Senses** dragon senses, fog vision; [Perception](../skills/perception.md#_perception) +35
...
At will—_ [control weather](../spells/controlWeather.md#_control-weather), [control winds](../spells/controlWinds.md#_control-winds), [detect evil](../spells/detectEvil.md#_detect-evil), [feather fall](../spells/featherFall.md#_feather-fall), [fog cloud](../spells/fogCloud.md)_

**Spells Known** (CL 15th)

7th (5/day)—_ [holy word](../spells/holyWord.md#_holy-word) _(DC 24), _ [repulsion](../spells/repulsion.md#_repulsion) _(DC 24)

6th (7/day)—_ [banishment](../spells/banishment.md#_banishment) _(DC 23), _ [greater dispel magic](../spells/dispelMagic.md#_dispel-magic-greater), [heal](../spells/heal.md#_heal)_

5th (7/day)—_ [break enchantment](../spells/breakEnchantment.md#_break-enchantment), [flame strike](../spells/flameStrike.md#_flame-strike) _(DC 22)_, [plane shift](../spells/planeShift.md#_plane-shift), [wall of force](../spells/wallOfForce.md#_wall-of-force)_

4th (7/day)—_ [dimension door](../spells/dimensionDoor.md#_dimension-door), [freedom of movement](../spells/freedomOfMovement.md#_freedom-of-movement), [restoration](../spells/restoration.md#_restoration), [solid fog](../spells/solidFog.md#_solid-fog)_

3rd (7/day)—_ [cure serious wounds](../spells/cureSeriousWounds.md#_cure-serious-wounds), [dispel magic](../spells/dispelMagic.md#_dispel-magic), [hold person](../spells/holdPerson.md#_hold-person) _(DC 20), _ [wind wall](../spells/windWall.md#_wind-wall)_

2nd (8/day)—_ [augury](../spells/augury.md#_augury), [calm emotions](../spells/calmEmotions.md#_calm-emotions) _(DC 19), _ [cure moderate wounds](../spells/cureModerateWounds.md#_cure-moderate-wounds), [invisibility](../spells/invisibility.md#_invisibility), [web](../spells/web.md#_web)_

1st (8/day)—_ [bless](../spells/bless.md#_bless), [divine favor](../spells/divineFavor.md#_divine-favor), [protection from evil](../spells/protectionFromEvil.md#_protection-from-evil), [shield](../spells/shield.md#_shield), [true strike](../spells/trueStrike.md#_true-strike)_

0 (at will)—_ [detect magic](../spells/detectMagic.md#_detect-magic), [flare](../spells/flare.md#_flare) _(DC 17), _ [light](../spells/light.md#_light), [message](../spells/message.md#_message), [prestidigitation](../spells/prestidigitation.md#_prestidigitation), [read magic](../spells/readMagic.md#_read-magic), [stabilize](../spells/stabilize.md#_stabilize), [resistance](../spells/resistance.md#_resistance), [virtue](../spells/virtue.md#_virtue)_
...
**Feats** [Critical Focus](../feats.md#_critical-focus), [Flyby Attack](monsterFeats.md#_flyby-attack), [Hover](monsterFeats.md#_hover), [Improved Critical](../feats.md#_improved-critical) (bite), [Improved Initiative](../feats.md#_improved-initiative), [Iron Will](../feats.md#_iron-will), Lighting Reflexes, [Multiattack](monsterFeats.md#_multiattack), [Power Attack](../feats.md#_power-attack), [Quicken Spell](../feats.md#_quicken-spell), [Skill Focus](../feats.md#_skill-focus) ( [Fly](../skills/fly.md#_fly)), [Vital Strike](../feats.md#_vital-strike), [Weapon Focus](../feats.md#_weapon-focus) (bite)

**Skills** [Acrobatics](../skills/acrobatics.md#_acrobatics) +24, [Diplomacy](../skills/diplomacy.md#_diplomacy) +35, [Fly](../skills/fly.md#_fly) +21, [Heal](../skills/heal.md#_heal) +35, [Intimidate](../skills/intimidate.md#_intimidate) +35, [Knowledge](../skills/knowledge.md#_knowledge) (arcana, history, local, nobility, planes) +35, [Perception](../skills/perception.md#_perception) +35, [Sense Motive](../skills/senseMotive.md#_sense-motive) +35, [Spellcraft](../skills/spellcraft.md#_spellcraft) +35

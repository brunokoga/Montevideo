...
1/day—_ [create food and water](../spell_dir/createFoodAndWater#_create-food-and-water_,_ create wine_ (as _ [create water](../spell_dir/createWater#_create-water)_, but wine instead, _ [gaseous form](../spell_dir/gaseousForm#_gaseous-form)_ (for up to 1 hour, _ [major creation](../spell_dir/majorCreation#_major-creation)_ (created vegetable matter is permanent, _ [persistent image](../spell_dir/persistentImage#_persistent-image)_ (DC 17, _ [wind walk](../spell_dir/windWalk#_wind-walk_
...
At Will—_ [plane shift](../spell_dir/planeShift#_plane-shift)_ (willing targets to elemental planes, Astral Plane, or Material Plane only, _ [produce flame](../spell_dir/produceFlame#_produce-flame_, _ [pyrotechnics](../spell_dir/pyrotechnics#_pyrotechnics)_ (DC 14, _ [scorching ray](../spell_dir/scorchingRay#_scorching-ray_
...
1/day—grant up to 3 _wishes_ (to nongenies only), _ [gaseous form](../spell_dir/gaseousForm#_gaseous-form_, _ [permanent image](../spell_dir/permanentImage#_permanent-image)_ (DC 18
...
**SQ** [change shape](universalMonsterRules#_change-shape (humanoid or giant, _ [alter self](../spell_dir/alterSelf#_alter-self_ or _ [giant form I](../spell_dir/giantForm#_giant-form-i)_)
...
A small percentage of efreet are noble. Noble efreet, often called maliks, have 13 Hit Dice and gain the following spell-like abilities: 3/day—_ [fireball](../spell_dir/fireball#_fireball, [heat metal](../spell_dir/heatMetal#_heat-metal_; 1/day—_ [greater invisibility](../spell_dir/invisibility#_invisibility-greater_, _pyroclastic storm_ (as _ [ice storm](../spell_dir/iceStorm#_ice-storm)_, with fire instead of cold damage). A noble efreeti's caster level for its spell-like abilities is 15th. Noble efreet are CR 10.
...
3/day—_ [invisibility](../spell_dir/invisibility#_invisibility)_ (self only_,_ _ [plane shift](../spell_dir/planeShift#_plane-shift)_ (willing targets to elemental planes, Astral Plane, or Material Plane only, _ [speak with animals](../spell_dir/speakWithAnimals#_speak-with-animals_

1/day—_ [create food and water](../spell_dir/createFoodAndWater#_create-food-and-water_, _ [ethereal jaunt](../spell_dir/etherealJaunt#_ethereal-jaunt)_ (for 1 hour
...
Jann are physically strong and courageous, and do not take kindly to insult or injury. Most are quite prone to seeing insult even when none is intended by the speaker. If overwhelmed in battle, they escape using flight and _ [invisibility](../spell_dir/invisibility#_invisibility_, returning later with reinforcements.
...
Constant—_ [detect evil](../spell_dir/detectEvil#_detect-evil, [detect good](../spell_dir/detectGood#_detect-good, [detect magic](../spell_dir/detectMagic#_detect-magic, [water walk](../spell_dir/waterWalk#_water-walk_

At will—_ [create water](../spell_dir/createWater#_create-water, [invisibility](../spell_dir/invisibility#_invisibility,_ _ [plane shift](../spell_dir/planeShift#_plane-shift)_ (willing targets to elemental planes, Astral Plane, or Material Plane only, _ [purify food and drink](../spell_dir/purifyFoodAndDrink#_purify-food-and-drink)_ (liquids only, _ [quench](../spell_dir/quench#_quench_

5/day—_ [control water](../spell_dir/controlWater#_control-water, [gaseous form](../spell_dir/gaseousForm#_gaseous-form, [obscuring mist](../spell_dir/obscuringMist#_obscuring-mist, [water breathing](../spell_dir/waterBreathing#_water-breathing_

3/day—_ [see invisibility](../spell_dir/seeInvisibility#_see-invisibility_
...
**SQ** [change shape](universalMonsterRules#_change-shape (water elemental, humanoid or giant, _ [alter self](../spell_dir/alterSelf#_alter-self_, _ [elemental body III](../spell_dir/elementalBody#_elemental-body-iii_, or _ [giant form I](../spell_dir/giantForm#_giant-form-i)_)
...
3/day—quickened _ [glitterdust](../spell_dir/glitterdust#_glitterdust)_ (DC 14, _ [stoneskin](../spell_dir/stoneskin#_stoneskin_, _ [rusting grasp](../spell_dir/rustingGrasp#_rusting-grasp, [stone tell](../spell_dir/stoneTell#_stone-tell, [wall of stone](../spell_dir/wallOfStone#_wall-of-stone_

...
**Init** +0; **Senses** all-around vision, darkvision 60 ft., [tremorsense](../universalMonsterRules#_tremorsense) 60 ft.; [Perception](../../skills_dir/perception#_perception) +14
...
**DR** 5_dir/bludgeoning; **Immune** cold, fire, flanking; **Resist** electricity 10
...
**Skills** [Appraise](../../skills_dir/appraise#_appraise) +10, [Intimidate](../../skills_dir/intimidate#_intimidate) +10, [Knowledge](../../skills_dir/knowledge#_knowledge) (dungeonering) +10, [Perception](../../skills_dir/perception#_perception) +14, [Stealth](../../skills_dir/stealth#_stealth) +10, [Survival](../../skills_dir/survival#_survival) +10; **Racial Modifiers** +4 [Perception](../../skills_dir/perception#_perception)
...
**All-Around Vision (Ex)** A xorn sees in all directions at the same time, giving it a +4 racial bonus on [Perception](../../skills_dir/perception#_perception) checks. A xorn cannot be flanked.

**Earth Glide (Ex)** A xorn can glide through any sort of natural earth or stone as easily as a fish swims through water. Its burrowing leaves no sign of its passage nor hint at its presence to creatures that don't possess tremorsense. A _ [move earth](../../spells_dir/moveEarth#_move-earth)_ spell cast on an area containing a xorn moves the xorn back 30 feet, stunning the creature for 1 round unless it succeeds on a DC 15 Fortitude save.

...
**Init** +4; **Senses** see in darkness; [Perception](../skills/perception#_perception) +8
...
At will—_ [deeper darkness](../spells/deeperDarkness#_deeper-darkness), [detect magic](../spells/detectMagic#_detect-magic), [fog cloud](../spells/fogCloud)_
...
**Skills** [Climb](../skills/climb#_climb) +10, [Perception](../skills/perception#_perception) +8, [Sleight of Hand](../skills/sleightOfHand#_sleight-of-hand) +5, [Stealth](../skills/stealth#_stealth) +8; **Racial Modifiers** +4 [Climb](../skills/climb#_climb), +4 [Perception](../skills/perception#_perception), +4 [Stealth](../skills/stealth#_stealth)
...
**Death Throes (Su)** When a dark stalker is slain, its body combusts in a flash of white-hot flame. This acts like a _ [fireball](../spells/fireball#_fireball)_ that deals 3d6 points of fire damage to all creatures within a 20-foot-radius burst. A DC 15 Reflex save halves this damage. A dark stalker's gear and treasure are unaffected by this explosion. This save is Constitution-based.
...
**See in Darkness (Su)** A dark stalker can see perfectly in darkness of any kind, including that created by _ [deeper darkness](../spells/deeperDarkness#_deeper-darkness)_.

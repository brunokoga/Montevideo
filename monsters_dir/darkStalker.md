...
At will—_ [deeper darkness](../spell_dir/deeperDarkness#_deeper-darkness), [detect magic](../spell_dir/detectMagic#_detect-magic), [fog cloud](../spell_dir/fogCloud)_
...
In a fight, dark stalkers are not above sacrificing lesser creatures, including dark creepers, to win the day or cover their retreat if things go poorly. They hate well-lit areas and always prefer to fight under the cover of _ [deeper darkness](../spell_dir/deeperDarkness#_deeper-darkness)_. Dark stalkers rarely fight to the death if it can be avoided, preferring to slip away if things begin to look grim.

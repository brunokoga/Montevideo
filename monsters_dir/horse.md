...
**Init** +2; **Senses** low-light vision, [scent](universalMonsterRules#_scent); [Perception](../skill_dir/perception#_perception) +6
...
**Docile (Ex)** Unless specifically trained for combat (see the [Handle Animal](../skill_dir/handleAnimal#_handle-animal) skill, a horse's hooves are treated as secondary attacks.

...
**Construction** : A shield guardian's base materials cost an additional 25,000 gp above the base golem's cost. The creature's master may assemble the body or hire someone else to do the job. The [Craft](../skill_dir/craft#_craft) check required to make the body is 4 higher than normal for the base golem's kind. The keyed amulet is fashioned at the same time—it costs 20,000 gp above and beyond the shield guardian's total cost. After the body is sculpted, the shield guardian is animated through an extended magical ritual that requires a specially prepared laboratory or workroom, similar to an alchemist's laboratory and costing 500 gp to establish. If the creator is personally constructing the creature's body, the building and the ritual can be performed together. The creator must have a minimum caster level of 2 higher than the base golem's minimum required caster level. In addition, the following spells are added to the base golem's requirements: _ [discern location](../spell_dir/discernLocation#_discern-location)_ and either _ [shield](../spell_dir/shield#_shield)_ or _ [shield other](../spell_dir/shieldOther#_shield-other)_.
...
• A _ [move earth](../spell_dir/moveEarth#_move-earth) _spell drives the golem back 120 feet and deals 3d12 points of damage to it (no save).

• A _ [disintegrate](../spell_dir/disintegrate#_disintegrate) _spell slows the golem (as the _ [slow](../spell_dir/slow#_slow) _spell) for 1d6 rounds and deals 1d12 points of damage (no save).

• An _ [earthquake](../spell_dir/earthquake#_earthquake) _spell cast directly at a clay golem stops it from moving on its next turn and deals 5d10 points of damage (no save).
...
**Requirements** [Craft Construct](monsterFeats#_craft-construct), _ [animate objects](../spell_dir/animateObjects#_animate-objects), [bless](../spell_dir/bless#_bless), [commune](../spell_dir/commune#_commune), [prayer](../spell_dir/prayer#_prayer), [resurrection](../spell_dir/resurrection#_resurrection)_, creator must be caster level 11th; **Skill** [Craft](../skill_dir/craft#_craft) (sculptures) or [Craft](../skill_dir/craft#_craft) (pottery) DC 16; **Cost** 21,500 gp
...
• A magical attack that deals cold or fire damage slows a flesh golem (as the _ [slow](../spell_dir/slow#_slow) _spell) for 2d6 rounds (no save).

• A magical attack that deals electricity damage breaks any _ [slow](../spell_dir/slow#_slow) _effect on the golem and heals 1 point of damage for every 3 points of damage the attack would otherwise deal. If the amount of healing would cause the golem to exceed its full normal hit points, it gains any excess as temporary hit points. A flesh golem gets no saving throw against attacks that deal electricity damage.
...
**Requirements** [Craft Construct](monsterFeats#_craft-construct), _ [animate dead](../spell_dir/animateDead#_animate-dead), [bull's strength](../spell_dir/bullSStrength#_bull-s-strength), [geas/quest](../spell_dir/geasQuest#_geas-quest), [limited wish](../spell_dir/limitedWish#_limited-wish)_, creator must be caster level 8th; **Skill** [Craft](../skill_dir/craft#_craft) (leather) or [Heal](../skill_dir/heal#_heal) DC 13; **Cost** 10,500 gp

# Golem, Ice

_This icy [statue](../spell_dir/statue#_statue) stands a head taller than a normal human. A rime of frost coats it, and razor-sharp shards of ice adorn its limbs._
...
• A magical attack that deals electricity damage slows an ice golem (as the _ [slow](../spell_dir/slow#_slow) _spell) for 2d6 rounds, with no saving throw.
...
**Requirements** [Craft Construct](monsterFeats#_craft-construct), _ [chill touch](../spell_dir/chillTouch#_chill-touch), [cone of cold](../spell_dir/coneOfCold#_cone-of-cold), [geas/quest](../spell_dir/geasQuest#_geas-quest), [ice storm](../spell_dir/iceStorm#_ice-storm), [resist energy](../spell_dir/resistEnergy#_resist-energy) (cold)_, creator must be caster level 12th; **Skill** [Craft](../skill_dir/craft#_craft) (sculptures) DC 17; **Cost** 9,500 gp
...
A magical attack that deals electricity damage slows an iron golem (as the _ [slow](../spell_dir/slow#_slow) _spell) for 3 rounds, with no saving throw.

A magical attack that deals fire damage breaks any _ [slow](../spell_dir/slow#_slow) _effect on the golem and heals 1 point of damage for each 3 points of damage the attack would otherwise deal. If the amount of healing would cause the golem to exceed its full normal hit points, it gains any excess as temporary hit points. An iron golem gets no saving throw against fire effects.

An iron golem is affected normally by rust attacks, such as those of a rust monster or a _ [rusting grasp](../spell_dir/rustingGrasp#_rusting-grasp) _spell.
...
**Requirements** [Craft Construct](monsterFeats#_craft-construct), _ [cloudkill](../spell_dir/cloudkill#_cloudkill), [geas/quest](../spell_dir/geasQuest#_geas-quest), [limited wish](../spell_dir/limitedWish#_limited-wish)_, _ [polymorph any object](../spell_dir/polymorphAnyObject#_polymorph-any-object)_, creator must be caster level 16th; **Skill** [Craft](../skill_dir/craft#_craft) (armor) or [Craft](../skill_dir/craft#_craft) (weapons) DC 21; **Cost** 80,000 gp
...
A _ [transmute rock to mud](../spell_dir/transmuteRockToMud#_transmute-rock-to-mud) _spell slows a stone golem (as the _ [slow](../spell_dir/slow#_slow) _spell) for 2d6 rounds, with no saving throw, while _ [transmute mud to rock](../spell_dir/transmuteMudToRock#_transmute-mud-to-rock) _heals all of its lost hit points.

A _ [stone to flesh](../spell_dir/stoneToFlesh#_stone-to-flesh) _spell does not actually change the golem's structure but negates its damage reduction and immunity to magic for 1 full round.
...
**Requirements** [Craft Construct](monsterFeats#_craft-construct), _ [antimagic field](../spell_dir/antimagicField#_antimagic-field), [geas/quest](../spell_dir/geasQuest#_geas-quest), [limited wish](../spell_dir/limitedWish#_limited-wish), [symbol of stunning](../spell_dir/symbolOfStunning#_symbol-of-stunning)_, creator must be caster level 14th; **Skill** [Craft](../skill_dir/craft#_craft) (sculpture) or [Craft](../skill_dir/craft#_craft) (stonemasonry) DC 19; **Cost** 55,000 gp
...
**Init** +3; **Senses** darkvision 60 ft., low-light vision; [Perception](../skill_dir/perception#_perception) +0
...
_Warp wood_ or _ [wood shape](../spell_dir/woodShape#_wood-shape)_ slows a wood golem (as the _ [slow](../spell_dir/slow#_slow) _spell) for 2d6 rounds (no save).
...
**Requirements** [Craft Construct](monsterFeats#_craft-construct), _ [alarm](../spell_dir/alarm#_alarm), [animate objects](../spell_dir/animateObjects#_animate-objects), [cat's grace](../spell_dir/catSGrace#_cat-s-grace), [geas/quest](../spell_dir/geasQuest#_geas-quest), [limited wish](../spell_dir/limitedWish#_limited-wish)_, creator must be caster level 12th; **Skill** [Craft](../skill_dir/craft#_craft) (carpentry) DC 17; **Cost** 8,800 gp

...
**Init** +2; **Senses** darkvision 120 ft.; [Perception](../skill_dir/perception#_perception) +2
...
1/day—_ [dancing lights](../spell_dir/dancingLights#_dancing-lights, [darkness](../spell_dir/darkness#_darkness, [faerie fire](../spell_dir/faerieFire#_faerie-fire_
...
**Skills** [Perception](../skill_dir/perception#_perception +2, [Stealth](../skill_dir/stealth#_stealth +2; **Racial Modifiers** +2 [Perception](../skill_dir/perception#_perception)
...
**Keen Senses** : Drow receive a +2 racial bonus on [Perception](../skill_dir/perception#_perception checks.

**Spell Resistance** : Drow possess spell resistance equal to 6 plus their class levels.

**Spell-Like Abilities** : A drow can cast _ [dancing lights](../spell_dir/dancingLights#_dancing-lights_, _ [darkness](../spell_dir/darkness#_darkness_, and _ [faerie fire](../spell_dir/faerieFire#_faerie-fire_ each once per day, using his total character level as his caster level.
...
**Spell-Like Abilities** : Drow nobles can cast _ [dancing lights](../spell_dir/dancingLights#_dancing-lights_, [_deeper darkness_](../spell_dir/deeperDarkness#_deeperDarkness, _ [faerie fire](../spell_dir/faerieFire#_faerie-fire_, _ [feather fall](../spell_dir/featherFall#_feather-fall_, and _ [levitate](../spell_dir/levitate#_levitate_ each at will, and have _ [detect magic](../spell_dir/detectMagic#_detect-magic_ as a constant spell-like ability. A drow noble can also cast _ [divine favor](../spell_dir/divineFavor#_divine-favor_, _ [dispel magic](../spell_dir/dispelMagic#_dispel-magic_, and _ [suggestion](../spell_dir/suggestion#_suggestion)_ once per day each. In some cases, a drow noble's spell-like abilities might vary, although the level of a particular spell-like ability does not. A drow noble's caster level for her spell-like abilities is equal to her character level.
...
**Init** +3; **Senses** darkvision 120 ft.; [Perception](../skill_dir/perception#_perception) +5
...
At will—_ [dancing lights](../spell_dir/dancingLights#_dancing-lights, [deeper darkness](../spell_dir/deeperDarkness#_deeper-darkness, [faerie fire](../spell_dir/faerieFire#_faerie-fire, [feather fall](../spell_dir/featherFall#_feather-fall, [levitate](../spell_dir/levitate#_levitate_

1/day—_ [divine favor](../spell_dir/divineFavor#_divine-favor, [dispel magic](../spell_dir/dispelMagic#_dispel-magic, [suggestion](../spell_dir/suggestion#_suggestion)_ (DC 14)

**Spells Prepared** (CL 3rd

2nd—_ [death knell](../spell_dir/deathKnell#_death-knell)_D (DC 15,_ [hold person](../spell_dir/holdPerson#_hold-person) _(DC 15, _ [silence](../spell_dir/silence#_silence)_ (DC 15

1st—_ [bless](../spell_dir/bless#_bless, [cause fear](../spell_dir/causeFear#_cause-fear) _(DC 14_, [cure light wounds](../spell_dir/cureLightWounds#_cure-light-wounds, [protection from law](../spell_dir/protectionFromLaw#_protection-from-law_D

0—_ [bleed](../spell_dir/bleed#_bleed) _(DC 13, _ [detect poison](../spell_dir/detectPoison#_detect-poison, [read magic](../spell_dir/readMagic#_read-magic, [resistance](../spell_dir/resistance#_resistance_
...
**Skills** [Knowledge](../skill_dir/knowledge#_knowledge) (religion +6, [Sense Motive](../skill_dir/senseMotive#_sense-motive +9, [Spellcraft](../skill_dir/spellcraft#_spellcraft +6; **Racial Modifiers** +2 [Perception](../skill_dir/perception#_perception)

**Languages** Elven, Undercommon

**SQ** poison use

**Gear** masterwork breastplate, heavy steel shield, masterwork rapier, drow poison (4, _potion of [invisibility](../spell_dir/invisibility#_invisibility_, _scroll of [dispel magic](../spell_dir/dispelMagic#_dispel-magic_, _wand of [cure light wounds](../spell_dir/cureLightWounds#_cure-light-wounds) _(CL 1st, 20 charges, 400 gp

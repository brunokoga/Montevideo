...
**Init** +10; **Senses** blindsight 60 ft., _ [detect magic](../spell_dir/detectMagic#_detect-magic_; [Perception](../skill_dir/perception#_perception) +19
...
**Vulnerable to _Protection from Evil_ (Ex** An intellect devourer is treated as a summoned creature for the purpose of determining how it is affected by a _ [protection from evil](../spell_dir/protectionFromEvil#_protection-from-evil_ spell.

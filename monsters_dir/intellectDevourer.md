---
title: monster_dir/intellectDevourer
---
# Intellect Devourer
...
**Init** +10; **Senses** blindsight 60 ft., _ [detect magic](../spell_dir/detectMagic#_detect-magic)_; [Perception](../skill_dir/perception#_perception) +19
...
**Weaknesses** vulnerability to _ [protection from evil](../spell_dir/protectionFromEvil#_protection-from-evil)_
...
At will—_ [confusion](../spell_dir/confusion#_confusion) _(DC 17, single target only)_, [daze monster](../spell_dir/dazeMonster#_daze-monster) _(DC 15, no HD limit), _ [inflict serious wounds](../spell_dir/inflictSeriousWounds#_inflict-serious-wounds)_ (DC 16), _ [invisibility](../spell_dir/invisibility#_invisibility), reduce size_ (as _ [reduce person](../spell_dir/reducePerson#_reduce-person)_ but self only)

3/day—_ [cure moderate wounds](../spell_dir/cureModerateWounds#_cure-moderate-wounds), [globe of invulnerability](../spell_dir/globeOfInvulnerability#_globe-of-invulnerability)_
...
**Skills** [Bluff](../skill_dir/bluff#_bluff) +19, [Disguise](../skill_dir/disguise#_disguise) +11, [Knowledge](../skill_dir/knowledge#_knowledge) (local) +14, [Perception](../skill_dir/perception#_perception) +19, [Sense Motive](../skill_dir/senseMotive#_sense-motive) +8, [Stealth](../skill_dir/stealth#_stealth) +29, [Use Magic Device](../skill_dir/useMagicDevice#_use-magic-device) +11; **Racial Modifiers** +8 [Bluff](../skill_dir/bluff#_bluff), +8 [Perception](../skill_dir/perception#_perception), +8 [Stealth](../skill_dir/stealth#_stealth)

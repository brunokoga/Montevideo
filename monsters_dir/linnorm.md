...
**Init** +8; **Senses** darkvision 120 ft., low-light vision, [scent](universalMonsterRules#_scent), true seeing; [Perception](../skills/perception#_perception) +22
...
**Melee** bite +23 (2d8+12/19–20 plus [poison](universalMonsterRules#_poison)), 2 claws +23 (1d8+12), tail +18 (2d6+6 plus [grab](universalMonsterRules#_grab))
...
**Skills** [Fly](../skills/fly#_fly) +16, [Perception](../skills/perception#_perception) +22, [Swim](../skills/swim#_swim) +38
...
**Freedom of Movement (Ex)** A crag linnorm is under the constant effect of _ [freedom of movement](../spells/freedomOfMovement#_freedom-of-movement)_, as per the spell of the same name. This effect cannot be dispelled.
...
**True Seeing (Ex)** A crag linnorm has constant _ [true seeing](../spells/trueSeeing#_true-seeing)_, as per the spell of the same name.
...
**Init** +10; **Senses** darkvision 120 ft., low-light vision, [scent](universalMonsterRules#_scent), true seeing; [Perception](../skills/perception#_perception) +26
...
**Melee** bite +24 (3d8+14/19–20 plus [poison](universalMonsterRules#_poison)), 2 claws +24 (2d6+14), tail +19 (3d6+7 plus [grab](universalMonsterRules#_grab))
...
**Skills** [Climb](../skills/climb#_climb) +43, [Fly](../skills/fly#_fly) +19, [Perception](../skills/perception#_perception) +26, [Swim](../skills/swim#_swim) +22
...
**Freedom of Movement (Ex)** An ice linnorm is under the constant effect of _ [freedom of movement](../spells/freedomOfMovement#_freedom-of-movement)_, as per the spell of the same name. This effect cannot be dispelled.
...
**True Seeing (Ex)** An ice linnorm has _ [true seeing](../spells/trueSeeing#_true-seeing)_, as the spell of the same name. This effect cannot be dispelled.
...
**Init** +12; **Senses** all-around vision, darkvision 120 ft., low-light vision, [scent](universalMonsterRules#_scent), true seeing; [Perception](../skills/perception#_perception) +40
...
**Melee** 2 bites +30 (3d8+16/19–20 plus [poison](universalMonsterRules#_poison)), 2 claws +30 (2d6+16), tail +25 (3d6+8 plus [grab](universalMonsterRules#_grab))
...
**Skills** [Fly](../skills/fly#_fly) +25, [Perception](../skills/perception#_perception) +40, [Stealth](../skills/stealth#_stealth) +17, [Swim](../skills/swim#_swim) +49; **Racial Modifier** +8 [Perception](../skills/perception#_perception)
...
**All-Around Vision (Ex)** A tarn linnorm's two heads grant it a +8 racial bonus on [Perception](../skills/perception#_perception) checks. It cannot be flanked.
...
**Freedom of Movement (Ex)** A tarn linnorm is under the constant effect of _ [freedom of movement](../spells/freedomOfMovement#_freedom-of-movement)_, as the spell of the same name. This effect cannot be dispelled.
...
**True Seeing (Ex)** A tarn linnorm has _ [true seeing](../spells/trueSeeing#_true-seeing)_, as the spell of the same name. This effect cannot be dispelled.

...
**Bonus Feat** : A crusader gains a bonus feat at 1st level, then again at 5th level and every five levels thereafter (to a maximum of six at 20th level). These bonus feats must be chosen from the following list: Heavy Armor Proficiency, [Improved Shield Bash](feats.md#_improved-shield-bash), [Martial Weapon Proficiency](feats.md#_martial-weapon-proficiency), [Saving Shield](advanced/advancedFeats.md#_saving-shield-(combat)), [Shield Focus](feats.md#_shield-focus), [Tower Shield Proficiency](feats.md#_tower-shield-proficiency), and [Weapon Focus\*](feats.md#_weapon-focus). At 10th level, a crusader may also choose from the following feats: [Exotic Weapon Proficiency](feats.md#_exotic-weapon-proficiency), [Greater Shield Focus](feats.md#_greater-shield-focus), [Greater Weapon Focus\*](feats.md#_greater-weapon-focus), [Improved Critical\*](feats.md#_improved-critical), [Shield Slam](feats.md#_shield-slam), [Shield Specialization](advanced/advancedFeats.md#_shield-specialization-(combat)), and [Weapon Specialization\*](feats.md#_weapon-specialization). At 20th level, a crusader may also choose from the following feats: [Greater Shield Specialization](advanced/advancedFeats.md#_greater-shield-specialization-(combat)) and [Greater Weapon Specialization\*](feats.md#_greater-weapon-specialization). Bonus feats marked with an asterisk (\*) must be applied to the favored weapon of the crusader's deity. A crusader need not meet the normal class- or level-based prerequisites for these bonus feats.
...
**Single-Minded** : An evangelist focuses her skills and learning on proclamation rather than the fine details of the church's deeper mysteries or martial training. Thus, she may select only one domain and does not gain Medium Armor Proficiency or [Shield Proficiency](feats.md#_shield-proficiency).

**Public Speaker** : An evangelist gains [Perform](skills/perform.md#_perform) as a class skill. In addition, she is trained to project her voice with great skill and effect; the DC to hear her speak in difficult conditions is reduced by an amount equal to her class level plus her Charisma modifier (minimum 0).

**Sermonic Performance** : An evangelist gains the ability to deliver a select number of supernatural and spell-like performances through the force and power of her divinely inspired preaching and exhortation. This ability is similar in all respects to bardic performance as used by a bard of the same level (including interactions with feats, spells, and prestige classes), using [Perform](skills/perform.md#_perform) (oratory) as the evangelist's performance skill. However, an evangelist gains only the following types of bardic performance: countersong, fascinate, and inspire courage at 1st level; inspire greatness at 9th level; and inspire heroics at 15th level. Sermonic performance replaces the 1st-, 9th-, and 15th-level channel energy abilities. This caps the cleric's channel energy damage at 7d6 points.
...
| --- | --- |
| 1st level | _ [command](spells/command.md#_command)_ |
| 2nd level | _ [enthrall](spells/enthrall.md#_enthrall)_ |
| 3rd level | _ [tongues](spells/tongues.md#_tongues)_ |
| 4th level | _ [suggestion](spells/suggestion.md#_suggestion)_ |
| 5th level | _ [greater command](spells/command.md#_command-greater)_ |
| 6th level | _ [geas/quest](spells/geasQuest.md#_geas-quest)_ |
| 7th level | _ [mass suggestion](spells/suggestion.md#_suggestion-mass)_ |
| 8th level | _ [sympathy](spells/sympathy.md#_sympathy)_ |
| 9th level | _ [demand](spells/demand.md#_demand)_ |
...
**Combat Medic (Ex)** : A merciful healer does not provoke attacks of opportunity when using the [Heal](skills/heal.md#_heal) skill to stabilize another creature or casting healing spells.

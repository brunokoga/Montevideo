...
**Melee** 4 vines +20 (1d10+7 plus [grab](monster_dir/universalMonsterRules#_grab and [bleed](monster_dir/universalMonsterRules#_bleed)

**Space** 10 ft.; **Reach** 10 ft.

**Special Attacks** [bleed](monster_dir/universalMonsterRules#_bleed) (2d6, [constrict](monster_dir/universalMonsterRules#_constrict) (1d10+10), feed

**Spell-Like Abilities** (CL 13th; concentration +18

At will—_ [charm monster](spell_dir/charmMonster#_charm-monster)_ (DC 18, _ [detect thoughts](spell_dir/detectThoughts#_detect-thoughts) _(DC 17, _ [suggestion](spell_dir/suggestion#_suggestion)_ (DC 18

3/day—quickened _ [glitterdust](spell_dir/glitterdust#_glitterdust)_ (DC 17, _ [hold monster](spell_dir/holdMonster#_hold-monster)_ (DC 20

1/day—_ [commune with nature](spell_dir/communeWithNature#_commune-with-nature, [mind fog](spell_dir/mindFog#_mind-fog, [wall of thorns](spell_dir/wallOfThorns#_wall-of-thorns)_
...
**Calming Fragrance (Su** A supernaturally sweet perfume that calms the nerves and blunts aggression constantly surrounds an alraune to a radius of 60 feet. Any creature in this area of effect must make a DC 24 Will save at the start of its turn to avoid falling under the effects of _ [calm emotions](spell_dir/calmEmotions#_calm-emotions)_ for 1 round. Creatures that could be attracted to the alraune's current apparent gender take a –2 penalty on this Will save, while all other creatures gain a +2 bonus on the save. This is a mind-affecting effect. The save DC is Charisma-based.

...
**[Immunity](monster_dir/universalMonsterRules#_immunity-(ex-or-su)) to Magic (Ex)** A bone golem is immune to any spell or spell-like ability that allows spell [resistance](monsters/universalMonsterRules#_resistance). In addition, certain spells and abilities function differently against the creature, as noted below.

•Magical effects that heal living creatures slow a bone golem (as the [_slow_](spell_dir/slow#_slow) spell) for 1d4 rounds (no save).
...
•A _ [raise dead](spells/raiseDead#_raise-dead)_, _ [resurrection](spell_dir/resurrection#_resurrection)_, or _ [true resurrection](spells/trueResurrection#_true-resurrection)_ spell negates its DR and [immunity](monster_dir/universalMonsterRules#_immunity-(ex-or-su)) to magic for 1 minute.
...
**Requirements** [Craft Construct](monsters/monsterFeats#_craft-construct), _ [gea_dir/quest](spells/geasQuest#_geas-quest)_, _ [limited wish](spell_dir/limitedWish#_limited-wish)_, _ [telekinesis](spells/telekinesis#_telekinesis)_, and either _ [animate dead](spell_dir/animateDead#_animate-dead)_ or _ [animate objects](spells/animateObjects#_animate-objects)_, creator must be at least caster level 9th; **Skill** [Craft](skill_dir/craft#_craft) (sculpture) or [Heal](skills/heal#_heal) DC 15; **Cost** 21,000 gp
...
**Init** +0; **Senses** darkvision 60 ft., low-light vision, _ [see invisibility](spell_dir/seeInvisibility#_see-invisibility)_; [Perception](skills/perception#_perception) +1
...
**DR** 15/adamantine; **Immune** construct traits, [fire](monster_dir/creatureTypes#_fire-subtype), magic

Offense

**Speed** 40 ft.

**Melee** brass falchion +29 (3d6+11/18–20 plus 2d6 [fire](monster_dir/creatureTypes#_fire-subtype)), slam +29 (2d6+11 plus 2d6 [fire](monsters/creatureTypes#_fire-subtype))

**Space** 15 ft.; **Reach** 15 ft.

**Special Attacks** [breath weapon](monster_dir/universalMonsterRules#_breath-weapon) (DC 20), [heat](monsters/universalMonsterRules#_heat) (2d6 [fire](monster_dir/creatureTypes#_fire-subtype))
...
**[Breath Weapon](monster_dir/universalMonsterRules#_breath-weapon) (Su)** As a free action once every 1d4 rounds, a brass golem can expel a cloud of smoke and cinders that fills a 20-foot cube. This functions as an _ [incendiary cloud](spells/incendiaryCloud#_incendiary-cloud)_ that persists for 1d6 rounds, dealing 6d6 points of [fire](monster_dir/creatureTypes#_fire-subtype) damage (DC 20 Reflex for half). The save DC is Constitution-based.
...
**[Immunity](monster_dir/universalMonsterRules#_immunity-(ex-or-su)) to Magic (Ex)** A brass golem is immune to any spell or spell-like ability that allows spell [resistance](monsters/universalMonsterRules#_resistance). In addition, certain spells and effects function differently against the creature.

•A magical attack that deals [cold](monster_dir/creatureTypes#_cold-subtype) damage slows a brass golem (as per the [_slow_](spells/slow#_slow) spell) for 1d6 rounds, with no saving throw.

•A magical attack that deals [fire](monster_dir/creatureTypes#_fire-subtype) damage breaks any _slow_ effect on the golem and heals 1 point of damage for each 3 points of damage the attack would otherwise deal. If the amount of healing would cause the golem to exceed its full normal hit points, it gains any excess as temporary hit points. A brass golem gets no save against [fire](monsters/creatureTypes#_fire-subtype) effects.
...
**Requirements** [Craft Construct](monster_dir/monsterFeats#_craft-construct), _ [geas/quest](spell_dir/geasQuest#_geas-quest)_, _ [incendiary cloud](spells/incendiaryCloud#_incendiary-cloud)_, _ [limited wish](spell_dir/limitedWish#_limited-wish)_, _ [see invisibility](spells/seeInvisibility#_see-invisibility)_, creator must be caster level 17th; **Skill** [Craft](skill_dir/craft#_craft) (armor) or [Craft](skills/craft#_craft) (blacksmithing) DC 22; **Cost** 100,000 gp
...
**Alloyed (Ex)** A cannon golem's slam and cannon attacks count as adamantine, [cold](monster_dir/creatureTypes#_cold-subtype) iron, and silver for the purpose of overcoming [damage reduction](monsters/universalMonsterRules#_damage-reduction-(ex-or-su)).
...
**Cannon (Ex)** The golem's cannon has a range increment of 100 feet and deals 6d6 points of bludgeoning and piercing damage on a hit with a ×4 critical modifier. The cannon's magazine can hold up to 20 cannonballs at a time—reloading a single cannonball into this magazine is a standard action for the golem, while loading a cannonball into the cannon itself to [fire](monster_dir/creatureTypes#_fire-subtype) it is a swift action; this allows the golem to take two shots per round with the cannon.

**Gun Training (Ex)** A cannon golem adds its Dex modifier to the damage dealt by its cannon.

**[Immunity](monsters/universalMonsterRules#_immunity-(ex-or-su)) to Magic (Ex)** A cannon golem is immune to spells and spell-like abilities that allow spell [resistance](monster_dir/universalMonsterRules#_resistance). Certain spells and effects function differently against it, as noted below.
...
•A _ [heat metal](spell_dir/heatMetal#_heat-metal)_ spell causes the golem's cannon to instantly backfire, dealing 6d6 points of damage to the golem and staggering it for 1 round (no save).
...
**Requirements** [Craft Construct](monsters/monsterFeats#_craft-construct), _ [gea_dir/quest](spells/geasQuest#_geas-quest)_, _ [limited wish](spell_dir/limitedWish#_limited-wish)_, _ [plane shift](spells/planeShift#_plane-shift)_ or _ [secret chest](spell_dir/secretChest#_secret-chest)_, creator must be caster level 17th; **Skill** [Craft](skills/craft#_craft) (siege engine) and [Knowledge](skill_dir/knowledge#_knowledge) (engineering) DC 25; **Cost** 105,000 gp
...
**[Immunity](monster_dir/universalMonsterRules#_immunity-(ex-or-su)) to Magic (Su)** A fossil golem is immune to any spell or spell-like ability that allows spell [resistance](monsters/universalMonsterRules#_resistance). In addition, certain spells and abilities function differently against the creature, as noted below.

•A _ [transmute rock to mud](spell_dir/transmuteRockToMud#_transmute-rock-to-mud) _spell slows a fossil golem (as the [_slow_](spells/slow#_slow) spell) for 2d6 rounds, with no saving throw.

•A _ [stone to flesh](spell_dir/stoneToFlesh#_stone-to-flesh)_ spell negates its [damage reduction](monsters/universalMonsterRules#_damage-reduction-(ex-or-su)) and petrification ability for 1 round.
...
Fortitude save or take 1d6 points of Dexterity drain. A creature that is reduced to 0 Dexterity by this attack turns completely to stone, as if by a _ [flesh to stone](spell_dir/fleshToStone#_flesh-to-stone)_ spell. Casting _ [stone to flesh](spells/stoneToFlesh#_stone-to-flesh)_ on the creature removes all Dexterity drain caused by this attack. The save DC is Constitution-based and includes a +2 racial bonus.
...
**Requirements** [Craft Construct](monster_dir/monsterFeats#_craft-construct), _ [flesh to stone](spells/fleshToStone#_flesh-to-stone)_, _ [gea_dir/quest](spells/geasQuest#_geas-quest)_, _ [limited wish](spell_dir/limitedWish#_limited-wish)_, _ [stone shape](spells/stoneShape#_stone-shape)_, creator must be at least caster level 15th; **Skill** [Craft](skill_dir/craft#_craft) (sculpture) or [Heal](skills/heal#_heal) DC 20; **Cost** 65,000 gp

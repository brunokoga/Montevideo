...
•A _ [raise dead](spell_dir/raiseDead#_raise-dead_, _ [resurrection](spell_dir/resurrection#_resurrection_, or _ [true resurrection](spell_dir/trueResurrection#_true-resurrection_ spell negates its DR and [immunity](monster_dir/universalMonsterRules#_immunity-(ex-or-su) to magic for 1 minute.
...
**Requirements** [Craft Construct](monster_dir/monsterFeats#_craft-construct, _ [geas/quest](spell_dir/geasQuest#_geas-quest_, _ [limited wish](spell_dir/limitedWish#_limited-wish_, _ [telekinesis](spell_dir/telekinesis#_telekinesis_, and either _ [animate dead](spell_dir/animateDead#_animate-dead_ or _ [animate objects](spell_dir/animateObjects#_animate-objects_, creator must be at least caster level 9th; **Skill** [Craft](skill_dir/craft#_craft) (sculpture or [Heal](skill_dir/heal#_heal DC 15; **Cost** 21,000 gp
...
**Init** +0; **Senses** darkvision 60 ft., low-light vision, _ [see invisibility](spell_dir/seeInvisibility#_see-invisibility_; [Perception](skill_dir/perception#_perception) +1
...
**Melee** brass falchion +29 (3d6+11/18–20 plus 2d6 [fire](monster_dir/creatureTypes#_fire-subtype), slam +29 (2d6+11 plus 2d6 [fire](monster_dir/creatureTypes#_fire-subtype)

**Space** 15 ft.; **Reach** 15 ft.

**Special Attacks** [breath weapon](monster_dir/universalMonsterRules#_breath-weapon) (DC 20, [heat](monster_dir/universalMonsterRules#_heat (2d6 [fire](monster_dir/creatureTypes#_fire-subtype))
...
**[Breath Weapon](monster_dir/universalMonsterRules#_breath-weapon) (Su** As a free action once every 1d4 rounds, a brass golem can expel a cloud of smoke and cinders that fills a 20-foot cube. This functions as an _ [incendiary cloud](spell_dir/incendiaryCloud#_incendiary-cloud_ that persists for 1d6 rounds, dealing 6d6 points of [fire](monster_dir/creatureTypes#_fire-subtype) damage (DC 20 Reflex for half). The save DC is Constitution-based.

**Death Throes (Ex** A brass golem explodes when it is destroyed. All creatures within 30 feet of the golem take 12d8 points of [fire](monster_dir/creatureTypes#_fire-subtype) damage (DC 20 Reflex for half. The save DC is Constitution-based.

**[Immunity](monster_dir/universalMonsterRules#_immunity-(ex-or-su)) to Magic (Ex** A brass golem is immune to any spell or spell-like ability that allows spell [resistance](monster_dir/universalMonsterRules#_resistance. In addition, certain spells and effects function differently against the creature.

•A magical attack that deals [cold](monster_dir/creatureTypes#_cold-subtype damage slows a brass golem (as per the [_slow_](spell_dir/slow#_slow) spell for 1d6 rounds, with no saving throw.
...
**Requirements** [Craft Construct](monster_dir/monsterFeats#_craft-construct, _ [geas/quest](spell_dir/geasQuest#_geas-quest_, _ [incendiary cloud](spell_dir/incendiaryCloud#_incendiary-cloud_, _ [limited wish](spell_dir/limitedWish#_limited-wish_, _ [see invisibility](spell_dir/seeInvisibility#_see-invisibility_, creator must be caster level 17th; **Skill** [Craft](skill_dir/craft#_craft) (armor or [Craft](skill_dir/craft#_craft) (blacksmithing DC 22; **Cost** 100,000 gp
...
**Alloyed (Ex)** A cannon golem's slam and cannon attacks count as adamantine, [cold](monster_dir/creatureTypes#_cold-subtype iron, and silver for the purpose of overcoming [damage reduction](monster_dir/universalMonsterRules#_damage-reduction-(ex-or-su)).
...
**[Immunity](monster_dir/universalMonsterRules#_immunity-(ex-or-su)) to Magic (Ex** A cannon golem is immune to spells and spell-like abilities that allow spell [resistance](monster_dir/universalMonsterRules#_resistance. Certain spells and effects function differently against it, as noted below.

•Any spell with the [water](monster_dir/creatureTypes#_water-subtype) descriptor that affects a cannon golem renders its cannon unusable for 1 round (no save.
...
**Requirements** [Craft Construct](monster_dir/monsterFeats#_craft-construct, _ [geas/quest](spell_dir/geasQuest#_geas-quest_, _ [limited wish](spell_dir/limitedWish#_limited-wish_, _ [plane shift](spell_dir/planeShift#_plane-shift_ or _ [secret chest](spell_dir/secretChest#_secret-chest_, creator must be caster level 17th; **Skill** [Craft](skill_dir/craft#_craft) (siege engine and [Knowledge](skill_dir/knowledge#_knowledge) (engineering DC 25; **Cost** 105,000 gp
...
•A _ [transmute rock to mud](spell_dir/transmuteRockToMud#_transmute-rock-to-mud _spell slows a fossil golem (as the [_slow_](spell_dir/slow#_slow) spell for 2d6 rounds, with no saving throw.

•A _ [stone to flesh](spell_dir/stoneToFlesh#_stone-to-flesh_ spell negates its [damage reduction](monster_dir/universalMonsterRules#_damage-reduction-(ex-or-su)) and petrification ability for 1 round.
...
Fortitude save or take 1d6 points of Dexterity drain. A creature that is reduced to 0 Dexterity by this attack turns completely to stone, as if by a _ [flesh to stone](spell_dir/fleshToStone#_flesh-to-stone_ spell. Casting _ [stone to flesh](spell_dir/stoneToFlesh#_stone-to-flesh)_ on the creature removes all Dexterity drain caused by this attack. The save DC is Constitution-based and includes a +2 racial bonus.
...
**Requirements** [Craft Construct](monster_dir/monsterFeats#_craft-construct, _ [flesh to stone](spell_dir/fleshToStone#_flesh-to-stone_, _ [geas/quest](spell_dir/geasQuest#_geas-quest_, _ [limited wish](spell_dir/limitedWish#_limited-wish_, _ [stone shape](spell_dir/stoneShape#_stone-shape_, creator must be at least caster level 15th; **Skill** [Craft](skill_dir/craft#_craft) (sculpture or [Heal](skill_dir/heal#_heal DC 20; **Cost** 65,000 gp

...
[Human](monster_dir/creatureTypes#_human-subtype animal lord ranger 10

NG Medium outsider ( [native](monster_dir/creatureTypes#_native-subtype, [shapechanger](monster_dir/creatureTypes#_shapechanger-subtype)

**Init** +7; **Senses** low-light vision, [scent](monster_dir/universalMonsterRules#_scent; [Perception](skill_dir/perception#_perception) +17
...
**Melee** bite +15 (1d6+5 plus [grab](monster_dir/universalMonsterRules#_grab)), 2 claws +15 (1d3+5

**Ranged** _+1 [keen](magicItem_dir/weapons#_weapons-keen composite longbow_ +18/+13 (1d8+6/×3)

**Special Attacks** favored enemy ( [evil](monster_dir/creatureTypes#_evil-subtype) outsiders +6, giants +2, undead +2, [pounce](monster_dir/universalMonsterRules#_pounce, [rake](monster_dir/universalMonsterRules#_rake) (2 claws +15, 1d3+5)

**Spell-Like Abilities** (CL 10th; concentration +12

At will—_ [charm animal](spell_dir/charmAnimal#_charm-animal)_ (cats only, DC 13)

**Ranger Spells Prepared** (CL 7th; concentration +11

3rd—_ [greater magic fang](spell_dir/magicFang#_magic-fang-greater_

2nd—_ [cat's grace](spell_dir/catSGrace#_cat-s-grace_, _ [hold animal](spell_dir/holdAnimal#_hold-animal)_ (DC 16

1st—_ [charm animal](spell_dir/charmAnimal#_charm-animal)_ (DC 15, _ [longstrider](spell_dir/longstrider#_longstrider_, _ [pass without trace](spell_dir/passWithoutTrace#_pass-without-trace)_
...
**Skills** [Acrobatics](skill_dir/acrobatics#_acrobatics) +17 (+22 when jumping, [Climb](skill_dir/climb#_climb +26, [Handle Animal](skill_dir/handleAnimal#_handle-animal +15, [Knowledge](skill_dir/knowledge#_knowledge) (nature +14, [Perception](skill_dir/perception#_perception +17, [Sense Motive](skill_dir/senseMotive#_sense-motive +14, [Stealth](skill_dir/stealth#_stealth) +20 (+24 in undergrowth, [Survival](skill_dir/survival#_survival +17; **Racial Modifiers** +5 [Acrobatics](skill_dir/acrobatics#_acrobatics when jumping, +4 [Stealth](skill_dir/stealth#_stealth in undergrowth

**Languages** Common, Sylvan; _ [speak with animals](spell_dir/speakWithAnimals#_speak-with-animals)_ (cats only

**SQ** [change shape](monster_dir/universalMonsterRules#_change-shape (leopard; _ [shapechange](spell_dir/shapechange#_shapechange)_), favored terrain (jungle +4, plains +2), hunter's bond (leopard, swift tracker, track +5, wild empathy +12, woodland stride
...
**Treasure** NPC gear (_+1 leather armor_, _+1 [keen](magicItem_dir/weapons#_weapons-keen composite longbow_ [+5 Str] with 20 arrows, _ [amulet of natural armor](magicItem_dir/wondrousItems#_amulet-of-natural-armor +1_, _ [ring of protection](magicItem_dir/rings#_ring-of-protection) +1_, other treasure)
...
_Leap (Ex_: A cat lord adds half its Hit Dice to all [Acrobatics](skill_dir/acrobatics#_acrobatics) checks made to jump, and is always treated as if it had a running start when jumping.
...
_ [Poison](spell_dir/poison#_poison) Immunity (Ex:_ Serpent lords are immune to poison.

...
At will—_ [create water](spells/createWater#_create-water)_, _ [prestidigitation](spell_dir/prestidigitation#_prestidigitation)_
...
**Skills** [Climb](skills/climb#_climb) +6, [Escape Artist](skill_dir/escapeArtist#_escape-artist) +5, [Handle Animal](skills/handleAnimal#_handle-animal) +4, [Perception](skill_dir/perception#_perception) +5, [Stealth](skills/stealth#_stealth) +13, [Swim](skill_dir/swim#_swim) +10, [Use Magic Device](skills/useMagicDevice#_use-magic-device) +3; **Racial Modifiers** +4 [Handle Animal](skill_dir/handleAnimal#_handle-animal)

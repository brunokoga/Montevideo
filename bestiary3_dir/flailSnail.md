...
**Init** –1; **Senses** [blindsense](monster_dir/universalMonsterRules#_blindsense 30 ft., darkvision 60 ft., low-light vision, [scent](monster_dir/universalMonsterRules#_scent, tremorsense 60 ft.; [Perception](skill_dir/perception#_perception) +5
...
**Defensive Abilities** retraction, warp magic; **Immune** [poison](monster_dir/universalMonsterRules#_poison-(ex-or-su); **Resist** [fire](monster_dir/creatureTypes#_fire-subtype) 10
...
**Skills** [Climb](skill_dir/climb#_climb +15, [Perception](skill_dir/perception#_perception +5, [Stealth](skill_dir/stealth#_stealth) +0
...
**Slime Rope (Ex** A flail snail can turn its mucus into a ropelike strand up to 60 feet long, and can use this rope to hang itself and up to 1,000 extra pounds from the ceiling indefinitely, or to lower itself safely at a speed of 20 feet per round. It can climb back up this rope at a speed of 10 feet per round. Once the snail breaks contact with the rope, the slime decomposes in 1d4 rounds. While the slime rope exists, other creatures can climb the rope with a DC 20 [Climb](skill_dir/climb#_climb) check.

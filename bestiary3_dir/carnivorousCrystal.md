...
N Medium ooze ( [earth](monster_dir/creatureTypes#_earth-subtype, [extraplanar](monster_dir/creatureTypes#_extraplanar-subtype)

**Init** –5; **Senses** [blindsight](monster_dir/universalMonsterRules#_blindsight 120 ft.; [Perception](skill_dir/perception#_perception) –5
...
**DR** 10/—; **Immune** [cold](monster_dir/creatureTypes#_cold-subtype, electricity, ooze traits; **Resist** [fire](monster_dir/creatureTypes#_fire-subtype 20
...
**Special Attacks** crystallize, [entrap](monster_dir/universalMonsterRules#_entrap-(ex-or-su)) (DC 22, 1d10 rounds, hardness 10, hp 10), razor sharp
...
**Skills** [Climb](skill_dir/climb#_climb +14, [Stealth](skill_dir/stealth#_stealth) +0 (+5 in rocky environs); **Racial Modifiers** +5 stealth (+10 in rocky environs

**SQ** [freeze](monster_dir/universalMonsterRules#_freeze, [split](monster_dir/universalMonsterRules#_split) (critical hit from a bludgeoning or sonic attack, 15 hp
...
**Brittle (Ex** Bludgeoning and sonic attacks can inflict critical hits on a carnivorous crystal. A successful critical hit from such attacks causes the carnivorous crystal to [split](monster_dir/universalMonsterRules#_split), even if the attack causes no damage. The crystal remains immune to precision-based damage, such as damage from sneak attacks.

...
**Init** +4; **Senses** darkvision 60 ft., _ [detect secret doors](spell_dir/detectSecretDoors#_detect-secret-doors)_, low-light vision, _ [true seeing](spells/trueSeeing#_true-seeing)_; [Perception](skill_dir/perception#_perception) +37
...
**Melee** _+2 [axiomatic](magicItem_dir/weapons#_weapons-axiomatic) [light](spells/light#_light) mace_ +35/+30/+25/+20 (2d6+11/19–20), sting +27 (2d8+4/19–20 plus [poison](monster_dir/universalMonsterRules#_poison-(ex-or-su)))
...
Constant—_ [detect secret doors](spells/detectSecretDoors#_detect-secret-doors)_, _ [true seeing](spell_dir/trueSeeing#_true-seeing)_

At will—_ [daylight](spells/daylight#_daylight)_, _ [detect thoughts](spell_dir/detectThoughts#_detect-thoughts)_ (DC 21), _ [greater scrying](spells/scrying#_scrying-greater)_ (DC 26), _ [neutralize poison](spell_dir/neutralizePoison#_neutralize-poison)_, _ [remove disease](spells/removeDisease#_remove-disease)_, _ [speak with dead](spell_dir/speakWithDead#_speak-with-dead)_ (DC 22)

3/day—_ [charm monster](spell_dir/charmMonster#_charm-monster)_ (DC 23), _ [find the path](spells/findThePath#_find-the-path)_, _ [giant vermin](spell_dir/giantVermin#_giant-vermin)_ (8 bees or 6 wasps), _ [mass cure critical wounds](spells/cureCriticalWounds#_cure-critical-wounds-mass)_, _ [poison](spell_dir/poison#_poison)_   
(DC 23), _ [restoration](spells/restoration#_restoration), [slow](spell_dir/slow#_slow)_ (DC 22)

1/day—_ [foresight](spell_dir/foresight#_foresight)_, _ [mass heal](spells/heal#_heal-mass)_, quickened _ [regenerate](spell_dir/regenerate#_regenerate)_
...
**Skills** [Bluff](skills/bluff#_bluff) +34, [Diplomacy](skill_dir/diplomacy#_diplomacy) +34, [Fly](skills/fly#_fly) +24, [Knowledge](skill_dir/knowledge#_knowledge) (arcana) +30, [Knowledge](skills/knowledge#_knowledge) (religion) +30, [Perception](skill_dir/perception#_perception) +37, [Sense Motive](skills/senseMotive#_sense-motive) +34, [Spellcraft](skill_dir/spellcraft#_spellcraft) +30, [Use Magic Device](skills/useMagicDevice#_use-magic-device) +34
...
**Init** +5; **Senses** darkvision 60 ft., _ [detect secret doors](spell_dir/detectSecretDoors#_detect-secret-doors)_, low-light vision; [Perception](skills/perception#_perception) +27
...
Constant—_ [detect secret doors](spell_dir/detectSecretDoors#_detect-secret-doors)_

At will—_ [calm emotions](spells/calmEmotions#_calm-emotions)_ (DC 20), _ [detect thoughts](spell_dir/detectThoughts#_detect-thoughts)_ (DC 20), _ [sound burst](spells/soundBurst#_sound-burst)_ (DC 20)

3/day—_ [divination](spell_dir/divination#_divination)_, _ [invisibility purge](spells/invisibilityPurge#_invisibility-purge)_, _ [locate object](spell_dir/locateObject#_locate-object)_, _ [misdirection](spells/misdirection#_misdirection)_ (DC 20), _ [symbol of sleep](spell_dir/symbolOfSleep#_symbol-of-sleep)_ (DC 23)
...
**Skills** [Bluff](skills/bluff#_bluff) +22, [Diplomacy](skill_dir/diplomacy#_diplomacy) +22, [Fly](skills/fly#_fly) +26, [Knowledge](skill_dir/knowledge#_knowledge) (arcana) +18, [Perception](skills/perception#_perception) +27, [Sense Motive](skill_dir/senseMotive#_sense-motive) +24, [Spellcraft](skills/spellcraft#_spellcraft) +18, [Use Magic Device](skill_dir/useMagicDevice#_use-magic-device) +22
...
**Skills** [Fly](skill_dir/fly#_fly) +13, [Intimidate](skills/intimidate#_intimidate) +10, [Perception](skill_dir/perception#_perception) +9, [Stealth](skills/stealth#_stealth) +9, [Survival](skill_dir/survival#_survival) +9

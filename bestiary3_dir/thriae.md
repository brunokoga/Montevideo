...
**Init** +4; **Senses** darkvision 60 ft., _ [detect secret doors](spell_dir/detectSecretDoors#_detect-secret-doors_, low-light vision, _ [true seeing](spell_dir/trueSeeing#_true-seeing_; [Perception](skill_dir/perception#_perception) +37
...
**Defensive Abilities** merope coat; **Immune** [poison](monster_dir/universalMonsterRules#_poison-(ex-or-su)), sonic; **Resist** acid 20; **SR** 29

Offense

**Speed** 30 ft., fly 50 ft. (good

**Melee** _+2 [axiomatic](magicItem_dir/weapons#_weapons-axiomatic [light](spell_dir/light#_light mace_ +35/+30/+25/+20 (2d6+11/19–20), sting +27 (2d8+4/19–20 plus [poison](monster_dir/universalMonsterRules#_poison-(ex-or-su)))
...
Constant—_ [detect secret doors](spell_dir/detectSecretDoors#_detect-secret-doors_, _ [true seeing](spell_dir/trueSeeing#_true-seeing_

At will—_ [daylight](spell_dir/daylight#_daylight_, _ [detect thoughts](spell_dir/detectThoughts#_detect-thoughts)_ (DC 21, _ [greater scrying](spell_dir/scrying#_scrying-greater)_ (DC 26, _ [neutralize poison](spell_dir/neutralizePoison#_neutralize-poison_, _ [remove disease](spell_dir/removeDisease#_remove-disease_, _ [speak with dead](spell_dir/speakWithDead#_speak-with-dead)_ (DC 22

3/day—_ [charm monster](spell_dir/charmMonster#_charm-monster)_ (DC 23, _ [find the path](spell_dir/findThePath#_find-the-path_, _ [giant vermin](spell_dir/giantVermin#_giant-vermin)_ (8 bees or 6 wasps, _ [mass cure critical wounds](spell_dir/cureCriticalWounds#_cure-critical-wounds-mass_, _ [poison](spell_dir/poison#_poison)_   
(DC 23, _ [restoration](spell_dir/restoration#_restoration, [slow](spell_dir/slow#_slow)_ (DC 22

1/day—_ [foresight](spell_dir/foresight#_foresight_, _ [mass heal](spell_dir/heal#_heal-mass_, quickened _ [regenerate](spell_dir/regenerate#_regenerate)_
...
**Treasure** double (_+2 [axiomatic](magicItem_dir/weapons#_weapons-axiomatic) light mace_, other treasure)
...
**Merope Coat (Su** A thriae queen is covered in a thin layer of merope. This coating acts as a magical barrier between spells cast at the thriae queen, as though she were constantly under the effects of _ [spell turning](spell_dir/spellTurning#_spell-turning_. The coat affects a maximum of eight spell levels—when a spell effect is turned, this coating is depleted by a number of spell levels equal to the level of the spell reflected. The queen regenerates this coating at a rate of one spell level per round. A spell in excess of what the merope coat can currently reflect is not reflected, and reduces the merope coat to a score of 0. Spells that fail to penetrate the queen's spell [resistance](monster_dir/universalMonsterRules#_resistance) do not reduce the merope coat's efficiency in this manner.
...
**[Poison](monster_dir/universalMonsterRules#_poison-(ex-or-su)) (Ex** Sting—injury; _save_ Fort DC 29; _frequency_ 1/round for 6 rounds; _effect_ 1d6 Con plus staggered for 1 round; _cure_ 2 consecutive saves.
...
**Init** +5; **Senses** darkvision 60 ft., _ [detect secret doors](spell_dir/detectSecretDoors#_detect-secret-doors_, low-light vision; [Perception](skill_dir/perception#_perception) +27
...
**Immune** [poison](monster_dir/universalMonsterRules#_poison-(ex-or-su)), sonic; **Resist** acid 10; **SR** 22
...
Constant—_ [detect secret doors](spell_dir/detectSecretDoors#_detect-secret-doors_

At will—_ [calm emotions](spell_dir/calmEmotions#_calm-emotions)_ (DC 20, _ [detect thoughts](spell_dir/detectThoughts#_detect-thoughts)_ (DC 20, _ [sound burst](spell_dir/soundBurst#_sound-burst)_ (DC 20

3/day—_ [divination](spell_dir/divination#_divination_, _ [invisibility purge](spell_dir/invisibilityPurge#_invisibility-purge_, _ [locate object](spell_dir/locateObject#_locate-object_, _ [misdirection](spell_dir/misdirection#_misdirection)_ (DC 20, _ [symbol of sleep](spell_dir/symbolOfSleep#_symbol-of-sleep)_ (DC 23

1/day—summon bees (level 5, 1d3 giant queen bees or 1d4 wasp swarms), _ [true seeing](spell_dir/trueSeeing#_true-seeing)_
...
**Skills** [Bluff](skill_dir/bluff#_bluff +22, [Diplomacy](skill_dir/diplomacy#_diplomacy +22, [Fly](skill_dir/fly#_fly +26, [Knowledge](skill_dir/knowledge#_knowledge) (arcana +18, [Perception](skill_dir/perception#_perception +27, [Sense Motive](skill_dir/senseMotive#_sense-motive +24, [Spellcraft](skill_dir/spellcraft#_spellcraft +18, [Use Magic Device](skill_dir/useMagicDevice#_use-magic-device) +22
...
**Init** +3; **Senses** darkvision 60 ft., low-light vision; [Perception](skill_dir/perception#_perception) +9
...
**Immune** [poison](monster_dir/universalMonsterRules#_poison-(ex-or-su)), sonic

Offense

**Speed** 30 ft., fly 60 ft. (good

**Melee** sting +10 (1d8+7 plus [poison](monster_dir/universalMonsterRules#_poison-(ex-or-su))

**Ranged** composite longbow +8 (1d8+5/×3 plus [poison](monster_dir/universalMonsterRules#_poison-(ex-or-su))) or [Rapid Shot](feats#_rapid-shot +6/+6 (1d8+5/×3 plus poison)
...
**Skills** [Fly](skill_dir/fly#_fly +13, [Intimidate](skill_dir/intimidate#_intimidate +10, [Perception](skill_dir/perception#_perception +9, [Stealth](skill_dir/stealth#_stealth +9, [Survival](skill_dir/survival#_survival) +9
...
**[Poison](monster_dir/universalMonsterRules#_poison-(ex-or-su)) (Ex** Sting or arrow—injury; _save_ Fort DC 15; _frequency_ 1/round for 6 rounds; _effect_ 1d2 Str; _cure_ 1 save. As a free action, a thriae soldier can apply her venom to an arrow as she fires the shot. The save DC is Constitution-based.

...
LE Small outsider ( [native](monster_dir/creatureTypes#_native-subtype), [rakshasa](monsters/creatureTypes#_rakshasa-subtype), [shapechanger](monster_dir/creatureTypes#_shapechanger-subtype))
...
1/day—_ [clairaudienc_dir/clairvoyance](spells/clairaudienceClairvoyance#_clairaudience-clairvoyance)_

**Spells Known** (CL 2nd; concentration +4)

1st (7/day)—_ [charm person](spell_dir/charmPerson#_charm-person)_ (DC 13), _ [ventriloquism](spells/ventriloquism#_ventriloquism)_ (DC 13)

0 (at will)—_ [bleed](spell_dir/bleed#_bleed)_ (DC 12), _ [daze](spells/daze#_daze)_ (DC 12), _ [detect magic](spell_dir/detectMagic#_detect-magic), [ghost sound](spells/ghostSound#_ghost-sound) _(DC 12),_ [mage hand](spell_dir/mageHand#_mage-hand)_
...
**Skills** [Acrobatics](skills/acrobatics#_acrobatics) +10, [Bluff](skill_dir/bluff#_bluff) +15, [Climb](skills/climb#_climb) +10, [Disguise](skill_dir/disguise#_disguise) +19, [Perception](skills/perception#_perception) +9, [Sense Motive](skill_dir/senseMotive#_sense-motive) +10, [Sleight of Hand](skills/sleightOfHand#_sleight-of-hand) +10, [Stealth](skill_dir/stealth#_stealth) +17; **Racial Modifiers**   
+4 [Bluff](skills/bluff#_bluff), +8 [Disguise](skill_dir/disguise#_disguise)

**Languages** Common, Infernal, Undercommon

**SQ** [change shape](monsters/universalMonsterRules#_change-shape) (any humanoid; _ [alter self](spell_dir/alterSelf#_alter-self)_)
...
LE Medium outsider ( [native](monsters/creatureTypes#_native-subtype), [shapechanger](monster_dir/creatureTypes#_shapechanger-subtype))

**Init** +13; **Senses** [all-around vision](monsters/universalMonsterRules#_all-around-vision), darkvision 60 ft.; [Perception](skill_dir/perception#_perception) +31
...
Constant—_ [comprehend languages](spell_dir/comprehendLanguages#_comprehend-languages)_, _ [tongues](spells/tongues#_tongues)_

At will—_ [clairaudienc_dir/clairvoyance](spells/clairaudienceClairvoyance#_clairaudience-clairvoyance)_
...
8th (6/day)—_ [greater shadow evocation](spell_dir/shadowEvocation#_shadow-evocation-greater), [mind blank](spells/mindBlank#_mind-blank)_

7th (7/day)—_ [greater shadow conjuration](spell_dir/shadowConjuration#_shadow-conjuration-greater), [mass invisibility](spells/invisibility#_invisibility-mass), [spell turning](spell_dir/spellTurning#_spell-turning)_

6th (7/day)—_ [greater dispel magic](spell_dir/dispelMagic#_dispel-magic-greater), [mass suggestion](spells/suggestion#_suggestion-mass)_ (DC 25), _ [true seeing](spell_dir/trueSeeing#_true-seeing)_

5th (8/day)—_ [baleful polymorph](spell_dir/balefulPolymorph#_baleful-polymorph)_ (DC 24), _ [feeblemind](spells/feeblemind#_feeblemind)_ (DC 24), _ [mind fog](spell_dir/mindFog#_mind-fog) _(DC 24)

4th (8/day)—_ [charm monster](spell_dir/charmMonster#_charm-monster)_ (DC 23), _ [dimension door](spells/dimensionDoor#_dimension-door), [lesser globe of invulnerability](spell_dir/globeOfInvulnerability#_globe-of-invulnerability-lesser), [scrying](spells/scrying#_scrying)_

3rd (8/day)—_ [dispel magic](spell_dir/dispelMagic#_dispel-magic), [nondetection](spells/nondetection#_nondetection), [suggestion](spell_dir/suggestion#_suggestion)_ (DC 22), _ [vampiric touch](spells/vampiricTouch#_vampiric-touch)_ (DC 22)

2nd (8/day)—_ [darkness](spell_dir/darkness#_darkness), [knock](spells/knock#_knock), [misdirection](spell_dir/misdirection#_misdirection) _(DC 21), _ [resist energy](spells/resistEnergy#_resist-energy), [see invisibility](spell_dir/seeInvisibility#_see-invisibility)_

1st (9/day)—_ [charm person](spell_dir/charmPerson#_charm-person)_ (DC 20), _ [identify](spells/identify#_identify), [mage armor](spell_dir/mageArmor#_mage-armor), [magic missile](spells/magicMissile#_magic-missile), [ventriloquism](spell_dir/ventriloquism#_ventriloquism)_ (DC 20)

0 (at will)—_ [arcane mark](spells/arcaneMark#_arcane-mark), [bleed](spell_dir/bleed#_bleed)_ (DC 19), _ [daze](spells/daze#_daze) _(DC 19), _ [detect magic](spell_dir/detectMagic#_detect-magic), [ghost sound](spells/ghostSound#_ghost-sound), [mage hand](spell_dir/mageHand#_mage-hand), [message](spells/message#_message), [prestidigitation](spell_dir/prestidigitation#_prestidigitation), [read magic](spells/readMagic#_read-magic)_
...
**Skills** [Acrobatics](skills/acrobatics#_acrobatics) +27 (+31 when jumping), [Appraise](skill_dir/appraise#_appraise) +25, [Bluff](skills/bluff#_bluff) +35,   
 [Diplomacy](skill_dir/diplomacy#_diplomacy) +30, [Disguise](skills/disguise#_disguise) +30, [Fly](skill_dir/fly#_fly) +31, [Intimidate](skills/intimidate#_intimidate) +30, [Knowledge](skill_dir/knowledge#_knowledge) (arcana, history, nobility, religion) +25, [Perception](skills/perception#_perception) +31, [Sense Motive](skill_dir/senseMotive#_sense-motive) +27, [Spellcraft](skills/spellcraft#_spellcraft) +25, [Stealth](skill_dir/stealth#_stealth) +30; **Racial Modifiers** +4 [Bluff](skills/bluff#_bluff), +8 [Disguise](skill_dir/disguise#_disguise), +4 [Perception](skills/perception#_perception)

**Languages** Abyssal, Common, Infernal, Undercommon; _ [comprehend languages](spell_dir/comprehendLanguages#_comprehend-languages)_, _ [tongues](spells/tongues#_tongues)_

**SQ** [change shape](monster_dir/universalMonsterRules#_change-shape) (any humanoid; _ [alter self](spells/alterSelf#_alter-self)_)
...
LE Medium outsider ( [native](monster_dir/creatureTypes#_native-subtype), [rakshasa](monsters/creatureTypes#_rakshasa-subtype), [shapechanger](monster_dir/creatureTypes#_shapechanger-subtype))
...
2nd (5/day)—_ [invisibility](spell_dir/invisibility#_invisibility), [scorching ray](spells/scorchingRay#_scorching-ray)_

1st (7/day)—_ [charm person](spell_dir/charmPerson#_charm-person)_ (DC 15), _ [jump](spells/jump#_jump)_, _ [mage armor](spell_dir/mageArmor#_mage-armor)_, _ [magic missile](spells/magicMissile#_magic-missile)_

0 (at will)—_ [bleed](spell_dir/bleed#_bleed)_ (DC 14), _ [detect magic](spells/detectMagic#_detect-magic), [ghost sound](spell_dir/ghostSound#_ghost-sound)_ (DC 14),_ [mage hand](spells/mageHand#_mage-hand), [ope_dir/close](spells/openClose#_open-close), [read magic](spell_dir/readMagic#_read-magic)_
...
**Skills** [Acrobatics](skills/acrobatics#_acrobatics) +14 (+18 when jumping), [Bluff](skill_dir/bluff#_bluff) +20, [Climb](skills/climb#_climb) +7, [Disguise](skill_dir/disguise#_disguise) +16, [Knowledge](skills/knowledge#_knowledge) (arcana) +8, [Perception](skill_dir/perception#_perception) +10, [Sense Motive](skills/senseMotive#_sense-motive) +12, [Spellcraft](skill_dir/spellcraft#_spellcraft) +8; **Racial Modifiers** +4 [Bluff](skills/bluff#_bluff), +8 [Disguise](skill_dir/disguise#_disguise)
...
LE Tiny outsider ( [native](monster_dir/creatureTypes#_native-subtype), [rakshasa](monsters/creatureTypes#_rakshasa-subtype), [shapechanger](monster_dir/creatureTypes#_shapechanger-subtype))

**Init** +3; **Senses** darkvision 60 ft., _ [detect magic](spells/detectMagic#_detect-magic)_; [Perception](skill_dir/perception#_perception) +9
...
1/day—_ [charm person](spell_dir/charmPerson#_charm-person)_ (DC 13), _ [suggestion](spells/suggestion#_suggestion)_ (DC 15)
...
**Skills** [Bluff](skills/bluff#_bluff) +12, [Climb](skill_dir/climb#_climb) +9, [Disguise](skills/disguise#_disguise) +16, [Escape Artist](skill_dir/escapeArtist#_escape-artist) +6, [Perception](skills/perception#_perception) +9, [Sense Motive](skill_dir/senseMotive#_sense-motive) +9, [Stealth](skills/stealth#_stealth) +17, [Swim](skill_dir/swim#_swim) +6; **Racial Modifiers** +4 [Bluff](skills/bluff#_bluff), +8 [Disguise](skill_dir/disguise#_disguise)
...
**[Change Shape](monsters/universalMonsterRules#_change-shape) (Su)** As a full-round action, a raktavarna can take the shape of a handheld object, most often an ornamental light, a one-handed weapon, or a piece of treasure. If the [rakshasa](monster_dir/creatureTypes#_rakshasa-subtype) remains stationary in such a form, it can attempt [Stealth](skills/stealth#_stealth) checks even while being observed. It can remain motionless in object form indefinitely, but reverts to its true form as soon as it takes any action.
...
**[Poison](monsters/universalMonsterRules#_poison-(ex-or-su)) (Su)** Bite—injury; _save_ Fort DC 13; _frequency _1/round for 6 rounds; _effect_ 1d2 Wis plus _ [modify memory](spell_dir/modifyMemory#_modify-memory)_; _cure_ 1 save. Each time a victim takes Wisdom damage from this [poison](monsters/universalMonsterRules#_poison-(ex-or-su)), a _ [modify memory](spell_dir/modifyMemory#_modify-memory)_ effect causes the victim to forget the previous minute's interactions with the raktavarna, as long as the raktavarna is no longer visible or is in object form. The save DC is Constitution-based.
...
LE Large outsider ( [native](monsters/creatureTypes#_native-subtype), [rakshasa](monster_dir/creatureTypes#_rakshasa-subtype), [shapechanger](monsters/creatureTypes#_shapechanger-subtype))

**Init** +3; **Senses** darkvision 60 ft., [scent](monster_dir/universalMonsterRules#_scent), _ [true seeing](spells/trueSeeing#_true-seeing)_; [Perception](skill_dir/perception#_perception) +19
...
**Speed** 40 ft.; _ [air walk](spell_dir/airWalk#_air-walk)_
...
Constant—_ [air walk](spell_dir/airWalk#_air-walk), [true seeing](spells/trueSeeing#_true-seeing)_

**Spells Known** (CL 12th; concentration +17)

6th (3/day)—_ [heal](spell_dir/heal#_heal)_

5th (6/day)—_ [flame strike](spell_dir/flameStrike#_flame-strike)_ (DC 20), _ [telekinesis](spells/telekinesis#_telekinesis)_ (DC 20)

4th (7/day)—_ [charm monster](spell_dir/charmMonster#_charm-monster)_ (DC 19), _ [dimension door](spells/dimensionDoor#_dimension-door)_, _ [freedom of movement](spell_dir/freedomOfMovement#_freedom-of-movement)_

3rd (7/day)—_ [dispel magic](spell_dir/dispelMagic#_dispel-magic)_, _ [fireball](spells/fireball#_fireball)_ (DC 18), _ [haste](spell_dir/haste#_haste), [rage](spells/rage#_rage)_

2nd (7/day)—_ [acid arrow](spell_dir/acidArrow#_acid-arrow)_, _ [cure moderate wounds](spells/cureModerateWounds#_cure-moderate-wounds)_, _ [death knell](spell_dir/deathKnell#_death-knell) _(DC 17), _ [invisibility](spells/invisibility#_invisibility)_, _ [misdirection](spell_dir/misdirection#_misdirection)_

1st (8/day)—_ [command](spell_dir/command#_command)_ (DC 16), _ [mage armor](spells/mageArmor#_mage-armor)_, _ [magic missile](spell_dir/magicMissile#_magic-missile)_, _ [ray of enfeeblement](spells/rayOfEnfeeblement#_ray-of-enfeeblement)_ (DC 16), _ [shield of faith](spell_dir/shieldOfFaith#_shield-of-faith)_

0 (at will)—_ [acid splash](spells/acidSplash#_acid-splash)_, _ [bleed](spell_dir/bleed#_bleed)_ (DC 15), _ [light](spells/light#_light)_, _ [mage hand](spell_dir/mageHand#_mage-hand)_, _ [mending](spells/mending#_mending)_, _ [message](spell_dir/message#_message)_, _ [open/close](spell_dir/openClose#_open-close)_, _ [prestidigitation](spells/prestidigitation#_prestidigitation)_, _ [read magic](spell_dir/readMagic#_read-magic)_
...
**Skills** [Acrobatics](skills/acrobatics#_acrobatics) +18 (+22 when jumping), [Bluff](skill_dir/bluff#_bluff) +23, [Climb](skills/climb#_climb) +17,   
 [Disguise](skill_dir/disguise#_disguise) +26, [Intimidate](skills/intimidate#_intimidate) +23, [Knowledge](skill_dir/knowledge#_knowledge) (religion) +10, [Perception](skills/perception#_perception) +19, [Sense Motive](skill_dir/senseMotive#_sense-motive) +19, [Survival](skills/survival#_survival) +16, [Swim](skill_dir/swim#_swim) +18; **Racial Modifiers** +4 [Bluff](skills/bluff#_bluff), +8 [Disguise](skill_dir/disguise#_disguise)

**Languages** Common, Infernal, Undercommon

**SQ** [change shape](monsters/universalMonsterRules#_change-shape) (any humanoid; _ [alter self](spell_dir/alterSelf#_alter-self)_ or _ [giant form I](spells/giantForm#_giant-form-i)_)
...
**Martial Artist (Su)** A tataka's unarmed strikes deal 2d6 points of damage. If a tataka gains monk levels, it uses its tataka unarmed strike damage or its monk unarmed strike damage, whichever is higher. Its unarmed strikes function as [lawful](monster_dir/creatureTypes#_lawful-subtype) and [evil](monsters/creatureTypes#_evil-subtype) weapons for overcoming [damage reduction](monster_dir/universalMonsterRules#_damage-reduction-(ex-or-su)).

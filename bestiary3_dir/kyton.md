...
LE Tiny outsider ( [evil](monster_dir/creatureTypes#_evil-subtype), [extraplanar](monsters/creatureTypes#_extraplanar-subtype), [kyton](monster_dir/creatureTypes#_kyton-subtype), [lawful](monsters/creatureTypes#_lawful-subtype))

**Init** +7; **Senses** darkvision 60 ft., _ [deathwatch](spell_dir/deathwatch#_deathwatch)_; [Perception](skills/perception#_perception) +7
...
At will—_ [bleed](spell_dir/bleed#_bleed)_ (DC 8), _ [mage hand](spells/mageHand#_mage-hand)_, _ [ope_dir/close](spells/openClose#_open-close)_
...
**Skills** [Bluff](skills/bluff#_bluff) +4, [Escape Artist](skill_dir/escapeArtist#_escape-artist) +9, [Fly](skills/fly#_fly) +11, [Intimidate](skill_dir/intimidate#_intimidate) +4, [Perception](skills/perception#_perception) +7, [Sense Motive](skill_dir/senseMotive#_sense-motive) +7, [Sleight of Hand](skills/sleightOfHand#_sleight-of-hand) +9, [Stealth](skill_dir/stealth#_stealth) +17
...
LE Medium outsider ( [evil](monsters/creatureTypes#_evil-subtype), [extraplanar](monster_dir/creatureTypes#_extraplanar-subtype), [kyton](monsters/creatureTypes#_kyton-subtype), [lawful](monster_dir/creatureTypes#_lawful-subtype))

**Init** +12; **Senses** darkvision 60 ft., _ [true seeing](spells/trueSeeing#_true-seeing)_; [Perception](skill_dir/perception#_perception) +34
...
**DR** 15/good and silver; **Immune** [cold](monster_dir/creatureTypes#_cold-subtype), [fear](monsters/universalMonsterRules#_fear-(su-or-sp)) effects, nonlethal damage, pain; **SR** 31
...
At will—_ [greater teleport](spell_dir/teleport#_teleport-greater)_ (self plus 50 lbs. of objects only), _ [inflict critical wounds](spells/inflictCriticalWounds#_inflict-critical-wounds)_ (DC 25), _ [shadow walk](spell_dir/shadowWalk#_shadow-walk)_, _ [telekinesis](spells/telekinesis#_telekinesis) _(DC 26)

3/day—_ [blade barrier](spell_dir/bladeBarrier#_blade-barrier)_ (DC 27), _ [dimensional lock](spells/dimensionalLock#_dimensional-lock)_, _ [forcecage](spell_dir/forcecage#_forcecage)_ (DC 28),   
_ [greater](spells/shadowEvocation#_shadow-evocation-greater) [shadow](magicItem_dir/armor#_armor-shadow) evocation_ (DC 29), _ [heal](spells/heal#_heal)_ (self only), _ [insanity](spell_dir/insanity#_insanity)_ (DC 28), _ [mass inflict critical wounds](spells/inflictCriticalWounds#_inflict-critical-wounds-mass)_ (DC 29), _ [plane shift](spell_dir/planeShift#_plane-shift)_   
(DC 28), _ [shades](spells/shades#_shades)_ (DC 29), _ [symbol of pain](spell_dir/symbolOfPain#_symbol-of-pain)_ (DC 26), _ [wall of force](spells/wallOfForce#_wall-of-force)_

1/day—_ [binding](spell_dir/binding#_binding)_ (DC 29), _ [trap the soul](spells/trapTheSoul#_trap-the-soul)_ (DC 29)
...
**Skills** [Bluff](skills/bluff#_bluff) +34, [Diplomacy](skill_dir/diplomacy#_diplomacy) +34, [Fly](skills/fly#_fly) +12, [Heal](skill_dir/heal#_heal) +28, [Intimidate](skills/intimidate#_intimidate) +34, [Knowledge](skill_dir/knowledge#_knowledge) (arcana) +16, [Knowledge](skills/knowledge#_knowledge) (dungeoneering) +16, [Knowledge](skill_dir/knowledge#_knowledge) (nature) +16, [Knowledge](skills/knowledge#_knowledge) (planes) +29, [Knowledge](skill_dir/knowledge#_knowledge) (religion) +16, [Perception](skills/perception#_perception) +34, [Sense Motive](skill_dir/senseMotive#_sense-motive) +28, [Spellcraft](skills/spellcraft#_spellcraft) +29, [Stealth](skill_dir/stealth#_stealth) +31, [Use Magic Device](skills/useMagicDevice#_use-magic-device) +31
...
**Shadow Traveler (Ex)** When an eremite uses _ [plane shift](spells/planeShift#_plane-shift)_ to travel to the Plane of Shadow, it arrives at its intended destination with complete accuracy. When an eremite uses _ [shadow walk](spell_dir/shadowWalk#_shadow-walk)_, it moves at a rate of 100 miles per hour.

**Unnerving Gaze (Ex)** A creature that succumbs to an eremite's unnerving gaze becomes paralyzed with [fear](monsters/universalMonsterRules#_fear-(su-or-sp)) for 1d4 rounds as it finds itself almost longing to submit its flesh to the [kyton](monster_dir/creatureTypes#_kyton-subtype). At the end of any round it remains paralyzed in this way, the victim must make a DC 31 Will save or take 1d4 points of Wisdom drain from encroaching madness. This is a mind-affecting [fear](monsters/universalMonsterRules#_fear-(su-or-sp)) effect.
...
LE Large outsider ( [evil](monster_dir/creatureTypes#_evil-subtype), [extraplanar](monsters/creatureTypes#_extraplanar-subtype), [kyton](monster_dir/creatureTypes#_kyton-subtype), [lawful](monsters/creatureTypes#_lawful-subtype))
...
**DR** 10/silver or [good](monster_dir/creatureTypes#_good-subtype); **Immune** [cold](monsters/creatureTypes#_cold-subtype); **SR** 23
...
**Special Attacks** [bleed](monsters/universalMonsterRules#_bleed) (1d6), [poison](monster_dir/universalMonsterRules#_poison-(ex-or-su)), rend (2 claws, 1d8+7), surgical strikes, unnerving gaze (30 ft.; DC 22)

**Spell-Like Abilities** (CL 14th; concentration +19)

At will—_ [bleed](spells/bleed#_bleed)_ (DC 15), _ [plane shift](spell_dir/planeShift#_plane-shift)_ (from the Material Plane to the Plane of Shadow Plane, self only), _ [stabilize](spells/stabilize#_stabilize)_

3/day—_ [cure serious wounds](spell_dir/cureSeriousWounds#_cure-serious-wounds)_, _ [restoration](spells/restoration#_restoration)_
...
**Skills** [Heal](skills/heal#_heal) +23, [Intimidate](skill_dir/intimidate#_intimidate) +22, [Knowledge](skills/knowledge#_knowledge) (arcana, local, religion) +9, [Knowledge](skill_dir/knowledge#_knowledge) (dungeoneering, nature, planes) +12, [Perception](skills/perception#_perception) +23, [Sense Motive](skill_dir/senseMotive#_sense-motive) +23, [Stealth](skills/stealth#_stealth) +16

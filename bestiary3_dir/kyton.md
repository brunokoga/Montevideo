...
LE Tiny outsider ( [evil](monster_dir/creatureTypes#_evil-subtype, [extraplanar](monster_dir/creatureTypes#_extraplanar-subtype, [kyton](monster_dir/creatureTypes#_kyton-subtype, [lawful](monster_dir/creatureTypes#_lawful-subtype)

**Init** +7; **Senses** darkvision 60 ft., _ [deathwatch](spell_dir/deathwatch#_deathwatch_; [Perception](skill_dir/perception#_perception) +7

Defense

**AC** 17, touch 15, flat-footed 14 (+3 Dex, +2 natural, +2 size)

**hp** 19 (3d10+3; regeneration 2 ( [good](monster_dir/creatureTypes#_good-subtype) weapons and spells, silver weapons

**Fort** +2, **Ref** +8, **Will** +4

**DR** 5/good or silver; **Immune** [cold](monster_dir/creatureTypes#_cold-subtype)

Offense

**Speed** 20 ft., fly 50 ft. (perfect

**Melee** gore +4 (1d4–1 plus [bleed](monster_dir/universalMonsterRules#_bleed)

**Space** 2-1/2 ft.; **Reach** 0 ft.

**Special Attacks** [bleed](monster_dir/universalMonsterRules#_bleed) (1d2), unnerving gaze (30 ft., DC 9)

**Spell-Like Abilities** (CL 6th; concentration +4

Constant—_ [deathwatch](spell_dir/deathwatch#_deathwatch_

At will—_ [bleed](spell_dir/bleed#_bleed)_ (DC 8, _ [mage hand](spell_dir/mageHand#_mage-hand_, _ [open/close](spell_dir/openClose#_open-close_

3/day—_ [inflict light wounds](spell_dir/inflictLightWounds#_inflict-light-wounds)_ (DC 10
...
**Skills** [Bluff](skill_dir/bluff#_bluff +4, [Escape Artist](skill_dir/escapeArtist#_escape-artist +9, [Fly](skill_dir/fly#_fly +11, [Intimidate](skill_dir/intimidate#_intimidate +4, [Perception](skill_dir/perception#_perception +7, [Sense Motive](skill_dir/senseMotive#_sense-motive +7, [Sleight of Hand](skill_dir/sleightOfHand#_sleight-of-hand +9, [Stealth](skill_dir/stealth#_stealth) +17
...
LE Medium outsider ( [evil](monster_dir/creatureTypes#_evil-subtype, [extraplanar](monster_dir/creatureTypes#_extraplanar-subtype, [kyton](monster_dir/creatureTypes#_kyton-subtype, [lawful](monster_dir/creatureTypes#_lawful-subtype)

**Init** +12; **Senses** darkvision 60 ft., _ [true seeing](spell_dir/trueSeeing#_true-seeing_; [Perception](skill_dir/perception#_perception) +34

Defense

**AC** 38, touch 19, flat-footed 29 (+8 Dex, +1 dodge, +19 natural)

**hp** 310 (20d10+200; regeneration 15 ( [good](monster_dir/creatureTypes#_good-subtype) weapons and spells, silver weapons

**Fort** +22, **Ref** +16, **Will** +19

**DR** 15/good and silver; **Immune** [cold](monster_dir/creatureTypes#_cold-subtype, [fear](monster_dir/universalMonsterRules#_fear-(su-or-sp)) effects, nonlethal damage, pain; **SR** 31

Offense

**Speed** 40 ft., fly 60 ft. (good)

**Melee** bite +30 (2d6+10 plus pain, 2 claws +30 (2d6+10/19–20 plus [grab](monster_dir/universalMonsterRules#_grab) and pain), 2 wings +25 (1d8+5 plus pain)
...
At will—_ [greater teleport](spell_dir/teleport#_teleport-greater)_ (self plus 50 lbs. of objects only, _ [inflict critical wounds](spell_dir/inflictCriticalWounds#_inflict-critical-wounds)_ (DC 25, _ [shadow walk](spell_dir/shadowWalk#_shadow-walk_, _ [telekinesis](spell_dir/telekinesis#_telekinesis) _(DC 26

3/day—_ [blade barrier](spell_dir/bladeBarrier#_blade-barrier)_ (DC 27, _ [dimensional lock](spell_dir/dimensionalLock#_dimensional-lock_, _ [forcecage](spell_dir/forcecage#_forcecage)_ (DC 28,   
_ [greater](spell_dir/shadowEvocation#_shadow-evocation-greater [shadow](magicItem_dir/armor#_armor-shadow) evocation_ (DC 29, _ [heal](spell_dir/heal#_heal)_ (self only, _ [insanity](spell_dir/insanity#_insanity)_ (DC 28, _ [mass inflict critical wounds](spell_dir/inflictCriticalWounds#_inflict-critical-wounds-mass)_ (DC 29, _ [plane shift](spell_dir/planeShift#_plane-shift)_   
(DC 28, _ [shades](spell_dir/shades#_shades)_ (DC 29, _ [symbol of pain](spell_dir/symbolOfPain#_symbol-of-pain)_ (DC 26, _ [wall of force](spell_dir/wallOfForce#_wall-of-force_

1/day—_ [binding](spell_dir/binding#_binding)_ (DC 29, _ [trap the soul](spell_dir/trapTheSoul#_trap-the-soul)_ (DC 29)
...
**Skills** [Bluff](skill_dir/bluff#_bluff +34, [Diplomacy](skill_dir/diplomacy#_diplomacy +34, [Fly](skill_dir/fly#_fly +12, [Heal](skill_dir/heal#_heal +28, [Intimidate](skill_dir/intimidate#_intimidate +34, [Knowledge](skill_dir/knowledge#_knowledge) (arcana +16, [Knowledge](skill_dir/knowledge#_knowledge) (dungeoneering +16, [Knowledge](skill_dir/knowledge#_knowledge) (nature +16, [Knowledge](skill_dir/knowledge#_knowledge) (planes +29, [Knowledge](skill_dir/knowledge#_knowledge) (religion +16, [Perception](skill_dir/perception#_perception +34, [Sense Motive](skill_dir/senseMotive#_sense-motive +28, [Spellcraft](skill_dir/spellcraft#_spellcraft +29, [Stealth](skill_dir/stealth#_stealth +31, [Use Magic Device](skill_dir/useMagicDevice#_use-magic-device) +31
...
**Immune to Pain (Su** An eremite is immune to nonlethal damage, as well as to all magical effects associated with extreme pain, such as a _ [symbol of pain](spell_dir/symbolOfPain#_symbol-of-pain)_, another eremite's pain attack, or similar effects at the GM's discretion.
...
**Shadow Traveler (Ex** When an eremite uses _ [plane shift](spell_dir/planeShift#_plane-shift_ to travel to the Plane of Shadow, it arrives at its intended destination with complete accuracy. When an eremite uses _ [shadow walk](spell_dir/shadowWalk#_shadow-walk)_, it moves at a rate of 100 miles per hour.

**Unnerving Gaze (Ex** A creature that succumbs to an eremite's unnerving gaze becomes paralyzed with [fear](monster_dir/universalMonsterRules#_fear-(su-or-sp) for 1d4 rounds as it finds itself almost longing to submit its flesh to the [kyton](monster_dir/creatureTypes#_kyton-subtype. At the end of any round it remains paralyzed in this way, the victim must make a DC 31 Will save or take 1d4 points of Wisdom drain from encroaching madness. This is a mind-affecting [fear](monster_dir/universalMonsterRules#_fear-(su-or-sp) effect.
...
While pursuing a chosen victim, an eremite utilizes its supernatural abilities to distract and distress a given target before it captures and drags it back to the Plane of Shadow via _ [plane shift](spell_dir/planeShift#_plane-shift)_. Bargaining with an eremite is not usually an option, though if a particularly powerful victim can offer an eremite advice or aid, or otherwise assist in harvesting an even more interesting catch, an eremite can sometimes be convinced to let the helpful victim escape. It's worth remembering, though, that kytons as a whole have little patience for the petty pursuits of honor and pride, seeing such feelings as traits that ultimately spell the end for baser creatures. The only thing that matters to an eremite is the testing of its boundaries as well as the boundaries of existence itself. Just because an eremite might be convinced to let someone go in trade for an opportunity for a greater catch doesn't mean that once that other target is secured the eremite will cease its attempts to capture and harvest its original target. One who manages to distract and subsequently escape an eremite is well-advised to spend the rest of his life on the run.
...
LE Large outsider ( [evil](monster_dir/creatureTypes#_evil-subtype, [extraplanar](monster_dir/creatureTypes#_extraplanar-subtype, [kyton](monster_dir/creatureTypes#_kyton-subtype, [lawful](monster_dir/creatureTypes#_lawful-subtype)
...
**hp** 147 (14d10+70; regeneration 5 ( [good](monster_dir/creatureTypes#_good-subtype) weapons and spells, silver weapons

**Fort** +14, **Ref** +9, **Will** +17

**DR** 10/silver or [good](monster_dir/creatureTypes#_good-subtype; **Immune** [cold](monster_dir/creatureTypes#_cold-subtype; **SR** 23

Offense

**Speed** 40 ft.

**Melee** 4 claws +20 (1d8+7/19–20 plus [bleed](monster_dir/universalMonsterRules#_bleed)

**Space** 10 ft.; **Reach** 10 ft.

**Special Attacks** [bleed](monster_dir/universalMonsterRules#_bleed) (1d6, [poison](monster_dir/universalMonsterRules#_poison-(ex-or-su)), rend (2 claws, 1d8+7), surgical strikes, unnerving gaze (30 ft.; DC 22)

**Spell-Like Abilities** (CL 14th; concentration +19

At will—_ [bleed](spell_dir/bleed#_bleed)_ (DC 15, _ [plane shift](spell_dir/planeShift#_plane-shift)_ (from the Material Plane to the Plane of Shadow Plane, self only, _ [stabilize](spell_dir/stabilize#_stabilize_

3/day—_ [cure serious wounds](spell_dir/cureSeriousWounds#_cure-serious-wounds_, _ [restoration](spell_dir/restoration#_restoration_

1/day—_ [breath of life](spell_dir/breathOfLife#_breath-of-life)_
...
**Skills** [Heal](skill_dir/heal#_heal +23, [Intimidate](skill_dir/intimidate#_intimidate +22, [Knowledge](skill_dir/knowledge#_knowledge) (arcana, local, religion +9, [Knowledge](skill_dir/knowledge#_knowledge) (dungeoneering, nature, planes +12, [Perception](skill_dir/perception#_perception +23, [Sense Motive](skill_dir/senseMotive#_sense-motive +23, [Stealth](skill_dir/stealth#_stealth) +16
...
**Surgical Strikes (Ex** An interlocutor's claws threaten a critical hit on a roll of 19–20. On a successful critical hit, that claw deals 2d6 [bleed](monster_dir/universalMonsterRules#_bleed) damage rather than 1d6.

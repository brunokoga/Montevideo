...
**Init** +1; **Senses** darkvision 60 ft.; [Perception](skills_dir/perception#_perception) +13
...
**DR** 5_dir/bludgeoning; **SR** 17

Offense

**Speed** 40 ft.

**Melee** bite +13 (1d6+7), 2 claws +13 (1d6+7 plus [grab](monsters_dir/universalMonsterRules#_grab))
...
3_dir/day—_ [alter self](spells_dir/alterSelf#_alter-self)_, _ [fog cloud](spells_dir/fogCloud)_
...
**Skills** [Bluff](skills_dir/bluff#_bluff) +7, [Diplomacy](skills_dir/diplomacy#_diplomacy) +7, [Intimidate](skills_dir/intimidate#_intimidate) +17, [Perception](skills_dir/perception#_perception) +13, [Sense Motive](skills_dir/senseMotive#_sense-motive) +3, [Stealth](skills_dir/stealth#_stealth) +7

**Languages** Common, [Giant](monsters_dir/creatureTypes#_giant-subtype)

Ecology

**Environment** [cold](monsters_dir/creatureTypes#_cold-subtype) marshes

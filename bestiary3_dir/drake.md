...
NE Large dragon ( [earth](monsters_dir/creatureTypes#_earth-subtype))

**Init** +6; **Senses** darkvision 60 ft., low-light vision, [scent](monsters_dir/universalMonsterRules#_scent), tremorsense 30 ft.; [Perception](skills_dir/perception#_perception) +12
...
**Melee** bite +15 (2d6+9_dir/19–20 plus 1d10 electricity), tail slap +9 (1d8+3 plus push)
...
**Skills** [Fly](skills_dir/fly#_fly) +12, [Intimidate](skills_dir/intimidate#_intimidate) +13, [Perception](skills_dir/perception#_perception) +12, [Stealth](skills_dir/stealth#_stealth) +10, [Survival](skills_dir/survival#_survival) +12
...
CE Large dragon ( [earth](monsters_dir/creatureTypes#_earth-subtype))

**Init** +7; **Senses** darkvision 60 ft., low-light vision, [scent](monsters_dir/universalMonsterRules#_scent); [Perception](skills_dir/perception#_perception) +14
...
**Melee** bite +18 (2d8+10_dir/19–20 plus [bleed](monsters_dir/universalMonsterRules#_bleed)), tail slap +12 (1d10+3 plus trip)

**Space** 10 ft.; **Reach** 10 ft.

**Special Attacks** [bleed](monsters_dir/universalMonsterRules#_bleed) (1d6), clinging corrosion, [pounce](monsters_dir/universalMonsterRules#_pounce), savage bite
...
**Feats** [Bleeding Critical](feats#_bleeding-critical), [Critical Focus](feats#_critical-focus), [Flyby Attack](monsters_dir/monsterFeats#_flyby-attack), [Improved Initiative](feats#_improved-initiative), [Power Attack](feats#_power-attack), [Weapon Focus](feats#_weapon-focus) (bite)

**Skills** [Climb](skills_dir/climb#_climb) +15, [Fly](skills_dir/fly#_fly) +14, [Intimidate](skills_dir/intimidate#_intimidate) +12, [Perception](skills_dir/perception#_perception) +14, [Sense Motive](skills_dir/senseMotive#_sense-motive) +11, [Stealth](skills_dir/stealth#_stealth) +12, [Survival](skills_dir/survival#_survival) +13
...
**Clinging Corrosion (Su)** As a standard action, a rift drake can spit a ball of caustic gas that bursts into a cloud upon impact. This attack has a range of 60 feet and deals 5d10 points of acid damage to all creatures within the resulting 15-foot-radius spread. Additionally, any creature damaged by this attack is affected as though by the spell _ [slow](spells_dir/slow#_slow)_ for 1d4 rounds. A successful DC 20 Reflex save halves the damage and negates the slowing effect. Once a rift drake uses its [breath weapon](monsters_dir/universalMonsterRules#_breath-weapon), it cannot do so again for 1d6 rounds. The save DC is Constitution-based.

**Savage Bite (Ex)** A rift drake applies 1-1_dir/2 times its Strength bonus to damage dealt with its bite attack, and it threatens a critical hit on a 19–20.
...
NE Medium dragon ( [aquatic](monsters_dir/creatureTypes#_aquatic-subtype), [water](monsters_dir/creatureTypes#_water-subtype))

**Init** +7; **Senses** darkvision 60 ft., low-light vision, [scent](monsters_dir/universalMonsterRules#_scent); [Perception](skills_dir/perception#_perception) +7
...
**Special Attacks** caustic mucus, [pounce](monsters_dir/universalMonsterRules#_pounce)
...
**Skills** [Fly](skills_dir/fly#_fly) +10, [Intimidate](skills_dir/intimidate#_intimidate) +6, [Perception](skills_dir/perception#_perception) +7, [Stealth](skills_dir/stealth#_stealth) +10, [Survival](skills_dir/survival#_survival) +7, [Swim](skills_dir/swim#_swim) +11

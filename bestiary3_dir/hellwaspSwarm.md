...
**Melee** swarm (3d6 plus [distraction](monsters/universalMonsterRules#_distraction) and [poison](monster_dir/universalMonsterRules#_poison-(ex-or-su)))
...
A _ [remove disease](spells/removeDisease#_remove-disease)_ or _ [heal](spell_dir/heal#_heal)_ spell cast on an inhabited victim forces the hellwasp swarm to abandon its host.

**[Poison](monsters/universalMonsterRules#_poison-(ex-or-su)) (Ex)** [Swarm](monster_dir/creatureTypes#_swarm-subtype)—injury; _save_ Fort DC 20; _frequency_ 1/round for 6 rounds; _effect_ 1d6 Dex; _cure_ 2 consecutive saves.

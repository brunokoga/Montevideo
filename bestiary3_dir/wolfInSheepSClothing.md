...
**Init** +4; **Senses** [all-around vision](monster_dir/universalMonsterRules#_all-around-vision), darkvision 60 ft.; [Perception](skills/perception#_perception) +14
...
**Skills** [Climb](skill_dir/climb#_climb) +15, [Disguise](skills/disguise#_disguise) –1 (+11 as tree stump), [Knowledge](skill_dir/knowledge#_knowledge) (nature) +4, [Perception](skills/perception#_perception) +14, [Sense Motive](skill_dir/senseMotive#_sense-motive) +8, [Stealth](skills/stealth#_stealth) +9; **Racial Modifiers** +12 [Disguise](skill_dir/disguise#_disguise) as tree stump

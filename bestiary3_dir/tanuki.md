...
**Init** +3; **Senses** darkvision 60 ft., _ [detect poison](spell_dir/detectPoison#_detect-poison_, low-light vision; [Perception](skill_dir/perception#_perception) +8
...
Constant—_ [detect poison](spell_dir/detectPoison#_detect-poison_

At will—_ [purify food and drink](spell_dir/purifyFoodAndDrink#_purify-food-and-drink_

3/day—_ [magic stone](spell_dir/magicStone#_magic-stone, [major creation](spell_dir/majorCreation#_major-creation)_ (up to 1 cubic foot

1/day—_ [create food and water](spell_dir/createFoodAndWater#_create-food-and-water_, _ [shrink item](spell_dir/shrinkItem#_shrink-item, [veil](spell_dir/veil#_veil)_ (self only)
...
**Skills** [Bluff](skill_dir/bluff#_bluff +7, [Diplomacy](skill_dir/diplomacy#_diplomacy +6, [Knowledge](skill_dir/knowledge#_knowledge) (nature +5, [Perception](skill_dir/perception#_perception +8, [Perform](skill_dir/perform#_perform) (percussion +8, [Sense Motive](skill_dir/senseMotive#_sense-motive +4, [Spellcraft](skill_dir/spellcraft#_spellcraft +4, [Stealth](skill_dir/stealth#_stealth +10

**Languages** Common, Tanuki

**SQ** [change shape](monster_dir/universalMonsterRules#_change-shape (raccoon; _ [beast shape II](spell_dir/beastShape#_beast-shape-ii)_), sake affinity
...
**Sake Affinity (Su** As a swift action, a tanuki can take a swig of sake from the gourd it always carries at its side. When it does so, it gains the effect of one of the following spells at caster level 7th: _ [divine favor](spell_dir/divineFavor#_divine-favor_, _ [false life](spell_dir/falseLife#_false-life_, _ [haste](spell_dir/haste#_haste_, or _ [rage](spell_dir/rage#_rage_. Unusual tanukis might have additional spell effect choices at the GM's discretion. Each time a tanuki takes a swig of sake, it becomes progressively drunker and takes a –1 penalty to its AC and on Reflex saves for 1 minute. These penalties stack.

...
**Init** +11; **Senses** [blindsense](monster_dir/universalMonsterRules#_blindsense 120 ft., darkvision 120 ft., low-light vision, [scent](monster_dir/universalMonsterRules#_scent; [Perception](skill_dir/perception#_perception) +26
...
**Defensive Abilities** quick recovery, quill defense; **Immune** [fear](monster_dir/universalMonsterRules#_fear-(su-or-sp), paralysis, [poison](monster_dir/universalMonsterRules#_poison-(ex-or-su), sleep

Offense

**Speed** 60 ft., climb 20 ft.

**Melee** bite +32 (2d8+13 plus [grab](monster_dir/universalMonsterRules#_grab), 2 claws +32 (2d6+13/19–20), tail slap +27 (2d8+19/×3 plus pain)

**Ranged** 4 quills +26 (1d10+13/19–20)

**Space** 20 ft.; **Reach** 15 ft. (20 ft. with tail slap)

**Special Attacks** bounding charge, brutal tail, [gaze](monster_dir/universalMonsterRules#_gaze, lash out, [pounce](monster_dir/universalMonsterRules#_pounce, [rake](monster_dir/universalMonsterRules#_rake (4 claws, +32, 2d6+13/19–20), rend (2 claws, 2d6+19)
...
**Skills** [Acrobatics](skill_dir/acrobatics#_acrobatics) +19 (+31 when jumping, [Climb](skill_dir/climb#_climb +21, [Perception](skill_dir/perception#_perception +26, [Stealth](skill_dir/stealth#_stealth) +18 (+26 forests, [Survival](skill_dir/survival#_survival) +3 (+23 tracking; **Racial Modifiers** +8 [Acrobatics](skill_dir/acrobatics#_acrobatics, +10 [Perception](skill_dir/perception#_perception, +4 [Stealth](skill_dir/stealth#_stealth) (+12 forests, +20 [Survival](skill_dir/survival#_survival) when tracking
...
**[Gaze](monster_dir/universalMonsterRules#_gaze) (Su** Confused, range 30 feet, Fortitude DC 29 negates. A bandersnatch can direct its [gaze](monster_dir/universalMonsterRules#_gaze) attack against a single foe as a swift action. This is a mind-affecting compulsion effect. The save DC is Constitution-based.
...
**Planar Acclimation (Ex** A bandersnatch is always considered to be on its home plane, regardless of what plane it finds itself upon. It never gains the [extraplanar](monster_dir/creatureTypes#_extraplanar-subtype) subtype.
...
**Confounding Bandersnatch (+1 CR** : Confounding bandersnatches drip infectious madness from their quills and claws. _ [Poison](spell_dir/poison#_poison) (Ex_ Claws and quills—injury; _save_ Fort DC 29; _frequency_ 1/minute for 6 minutes; _effect_ confused for 1 minute; _cure_ 2 consecutive saves. The save DC is Constitution-based.

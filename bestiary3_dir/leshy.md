...
Leshys begin their existence as sentient though bodiless spirits of nature of the sort contacted by spells such as _ [commune with nature](spells_dir/communeWithNature#_commune-with-nature)_. These spirits normally have no way to directly manipulate the physical world, but a skilled spellcaster (typically a druid) can grow a special plant body for one of these spirits, giving the spirit a home to animate.
...
The process of growing a leshy has some similarities to making a construct, but doesn't require the [Craft Construct](monsters_dir/monsterFeats#_craft-construct) feat. Typically, the creator of a leshy must be a powerful druid, but anyone capable of making the required [Knowledge](skills_dir/knowledge#_knowledge) checks and casting the required spells may attempt the process.

Growing a leshy body takes 2 weeks per Hit Die, during which the nascent form must be well fertilized, watered as needed, and kept safe from harm. During this period of growth, certain rare nutrients and fertilizer must be used to prime the leshy's transformation from a normal plant into a sentient one—the cost of these components varies according to the leshy, but is never less than 1,000 gp. The cultivator must make a successful [Knowledge](skills_dir/knowledge#_knowledge) check at this time (usually a [Knowledge](skills_dir/knowledge#_knowledge) [nature] check) in order for the plant body to be properly formed—the exact check as well as the required DC varies according to the leshy. If the check fails, the plant withers and dies and the cultivator must begin anew.
...
Plant creatures are particularly adept at growing leshys. Such creators gain a +5 racial bonus on their [Knowledge](skills_dir/knowledge#_knowledge) checks, halve the time required to grow the leshy, and reduce the cost to create the creature by 25%. A plant creature is always successful in luring a spirit into the body, and need not make the final percentile roll for success.

Leshys with more Hit Dice than normal can be created. Each additional Hit Die adds 2,250 gp to the cost of creating the leshy (and thus 4,500 gp to the overall price), increases the DC of the [Knowledge](skills_dir/knowledge#_knowledge) check by +2, and requires an additional 2 weeks of growth. Attempts to create leshys larger than Small always fail—the strange spiritual energies that animate these creatures are only capable of doing so to a body no larger than that of a human child.
...
N Small plant (leshy, [shapechanger](monsters_dir/creatureTypes#_shapechanger-subtype))
...
**Skills** [Stealth](skills_dir/stealth#_stealth) +10 (+14 in swamps and underground), [Survival](skills_dir/survival#_survival) +3 (+7 in swamps and underground); **Racial Modifiers** +4 [Stealth](skills_dir/stealth#_stealth) and [Survival](skills_dir/survival#_survival) in swamps and underground

**Languages** Druidic, Sylvan; plantspeech (fungi)

**SQ** [change shape](monsters_dir/universalMonsterRules#_change-shape) (Small fungus; _ [tree shape](spells_dir/treeShape#_tree-shape)_), verdant burst
...
**Requirements** [Knowledge](skills_dir/knowledge#_knowledge) (nature) 5 ranks, _ [obscuring mist](spells_dir/obscuringMist#_obscuring-mist)_, _ [plant growth](spells_dir/plantGrowth#_plant-growth)_, _ [summon nature's ally II](spells_dir/summonNatureSAlly#_summon-nature-s-ally-ii)_; **Skill** [Knowledge](skills_dir/knowledge#_knowledge) (dungeoneering or nature) DC 14; **Cost** 1,250 gp
...
**Init** +2; **Senses** darkvision 60 ft., low-light vision; [Perception](skills_dir/perception#_perception) +4
...
**Skills** [Perception](skills_dir/perception#_perception) +4, [Stealth](skills_dir/stealth#_stealth) +6 (+10 in plains and undergrowth), [Survival](skills_dir/survival#_survival) +0 (+4 in plains and undergrowth); **Racial Modifiers** +4 [Stealth](skills_dir/stealth#_stealth)   
and [Survival](skills_dir/survival#_survival) in plains and undergrowth

**Languages** Druidic, Sylvan; plantspeech (gourds)

**SQ** [change shape](monsters_dir/universalMonsterRules#_change-shape) (Small gourd; _ [tree shape](spells_dir/treeShape#_tree-shape)_), keepsake, verdant burst
...
While within the leshy's head, the item is warded by _ [nondetection](spells_dir/nondetection#_nondetection)_. In addition, after 24 hours, the item within is cleaned and polished, and, if damaged, repaired as if by a _ [mending](spells_dir/mending#_mending)_ spell. Both spell effects have a caster level equal to twice the leshy's Hit Dice (CL 2nd for most gourd leshys).
...
**Requirements** [Knowledge](skills_dir/knowledge#_knowledge) (nature) 5 ranks, _ [entangle](spells_dir/entangle#_entangle)_, _ [plant growth](spells_dir/plantGrowth#_plant-growth)_, _ [summon nature's ally I](spells_dir/summonNatureSAlly#_summon-nature-s-ally-i)_; **Skill** [Knowledge](skills_dir/knowledge#_knowledge) (nature) DC 13; **Cost** 750 gp

# Leshy, Leaf

This little plant person is clad in a winglike leaf cloak and pinecone armor, wielding a twig as a makeshift spear.

Leaf Leshy CR 1_dir/2
...
**Melee** shortspear +2 (1d4–2_dir/19–20)
...
**Skills** [Fly](skills_dir/fly#_fly) –1, [Stealth](skills_dir/stealth#_stealth) +5 (+9 in forests and jungles), [Survival](skills_dir/survival#_survival) +1 (+5 in forests and jungles); **Racial Modifiers** +4 [Stealth](skills_dir/stealth#_stealth) and [Survival](skills_dir/survival#_survival) in forests and jungles

**Languages** Druidic, Sylvan; plantspeech (trees)

**SQ** [change shape](monsters_dir/universalMonsterRules#_change-shape) (Small tree; _ [tree shape](spells_dir/treeShape#_tree-shape)_), verdant burst
...
**Requirements** [Knowledge](skills_dir/knowledge#_knowledge) (nature) 5 ranks, _ [magic stone](spells_dir/magicStone#_magic-stone)_, _ [plant growth](spells_dir/plantGrowth#_plant-growth)_, _ [summon nature's ally I](spells_dir/summonNatureSAlly#_summon-nature-s-ally-i)_; **Skill** [Knowledge](skills_dir/knowledge#_knowledge) (nature) DC 12; **Cost** 500 gp
...
N Small plant ( [aquatic](monsters_dir/creatureTypes#_aquatic-subtype), leshy, [shapechanger](monsters_dir/creatureTypes#_shapechanger-subtype))

**Init** +1; **Senses** darkvision 60 ft., low-light vision; [Perception](skills_dir/perception#_perception) +7
...
**Ranged** [water](monsters_dir/creatureTypes#_water-subtype) [jet](monsters_dir/universalMonsterRules#_jet) +5 (1 plus blind)
...
1_dir/day—_ [entangle](spells_dir/entangle#_entangle)_ (in water only, DC 12)
...
**Feats** [Ability Focus](monsters_dir/monsterFeats#_ability-focus) ( [water](monsters_dir/creatureTypes#_water-subtype) [jet](monsters_dir/universalMonsterRules#_jet)), [Toughness](feats#_toughness)

**Skills** [Perception](skills_dir/perception#_perception) +7, [Stealth](skills_dir/stealth#_stealth) +9 (+13 in [water](monsters_dir/creatureTypes#_water-subtype)), [Survival](skills_dir/survival#_survival) +3 (+7 in [water](monsters_dir/creatureTypes#_water-subtype)), [Swim](skills_dir/swim#_swim) +8; **Racial Modifiers** +4 [Stealth](skills_dir/stealth#_stealth) and [Survival](skills_dir/survival#_survival) in [water](monsters_dir/creatureTypes#_water-subtype)

**Languages** Druidic, Sylvan; plantspeech (seaweed)

**SQ** [air](monsters_dir/creatureTypes#_air-subtype) cyst, amphibious, [change shape](monsters_dir/universalMonsterRules#_change-shape) (Small seaweed; _ [tree shape](spells_dir/treeShape#_tree-shape)_), verdant burst
...
**[Air](monsters_dir/creatureTypes#_air-subtype) Cyst (Su)** Seaweed leshys constantly grow small bulbs filled with [air](monsters_dir/creatureTypes#_air-subtype). As a move action, they can detach a bulb and give it to another creature. If consumed as a standard action, this [air](monsters_dir/creatureTypes#_air-subtype) cyst grants _ [water breathing](spells_dir/waterBreathing#_water-breathing)_ (as the spell) for 10 minutes. Seaweed leshys can have a maximum of four usable [air](monsters_dir/creatureTypes#_air-subtype) cysts at any one time, and [air](monsters_dir/creatureTypes#_air-subtype) cysts regrow at a rate of one per 24 hours.

**[Water](monsters_dir/creatureTypes#_water-subtype) [Jet](monsters_dir/universalMonsterRules#_jet) (Ex)** A seaweed leshy can expel a high-pressure [jet](monsters_dir/universalMonsterRules#_jet) of [water](monsters_dir/creatureTypes#_water-subtype) from its mouth to a range of 30 feet. It must make a ranged touch attack to strike a target—if it hits, the blast deals 1 point of bludgeoning damage (this damage is not modified by Strength). In addition, the creature hit must make a DC 15 Fortitude save or be blinded by the [water](monsters_dir/creatureTypes#_water-subtype) for 1 round. The save DC is Dexterity-based.
...
**Requirements** [Knowledge](skills_dir/knowledge#_knowledge) (nature) 5 ranks, _ [plant growth](spells_dir/plantGrowth#_plant-growth)_, _ [summon nature's ally III](spells_dir/summonNatureSAlly#_summon-nature-s-ally-iii)_, _ [water breathing](spells_dir/waterBreathing#_water-breathing)_; **Skill** [Knowledge](skills_dir/knowledge#_knowledge) (nature) DC 16; **Cost** 2,250 gp

...
**Melee** bite +17 (2d6+6 plus [energy drain](monsters/universalMonsterRules#_energy-drain)), bite +17 (1d4+6 plus [poison](monster_dir/universalMonsterRules#_poison-(ex-or-su))), 2 claws +17 (1d6+6)

**Space** 10 ft.; **Reach** 10 ft.

**Special Attacks** [energy drain](monsters/universalMonsterRules#_energy-drain) (2 levels, DC 16), [pounce](monster_dir/universalMonsterRules#_pounce)

**Spell-Like Abilities** (CL 12th; concentration +12)

3/day—_ [contagion](spell_dir/contagion#_contagion)_ (DC 14), _ [hold person](spells/holdPerson#_hold-person)_ (DC 13)

1/day—_ [nightmare](spell_dir/nightmare#_nightmare)_ (DC 15), _ [shout](spells/shout#_shout)_ (DC 14), _ [waves of fatigue](spell_dir/wavesOfFatigue#_waves-of-fatigue)_
...
**Skills** [Climb](skill_dir/climb#_climb) +13, [Perception](skills/perception#_perception) +10, [Stealth](skill_dir/stealth#_stealth) +11
...
**Cloud Form (Su)** A nue can change into the form of a 10-foot black cloud or back to its normal form as a standard action. A nue in cloud form is otherwise treated as if under the effects of _ [gaseous form](spells/gaseousForm#_gaseous-form)_, except that it obscures vision like _ [fog cloud](spell_dir/fogCloud)_.

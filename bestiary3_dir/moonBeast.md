...
**Init** +7; **Senses** [blindsight](monster_dir/universalMonsterRules#_blindsight 90 ft.; [Perception](skill_dir/perception#_perception) +21
...
**Defensive Abilities** [amorphous](monster_dir/universalMonsterRules#_amorphous; **DR** 10/piercing or slashing; **Immune** [cold](monster_dir/creatureTypes#_cold-subtype, [gaze](monster_dir/universalMonsterRules#_gaze attacks, illusions, [poison](monster_dir/universalMonsterRules#_poison-(ex-or-su); **Resist** electricity 30; **SR** 22

Offense

**Speed** 50 ft., climb 20 ft.; _ [air walk](spell_dir/airWalk#_air-walk)_
...
Constant—_ [air walk](spell_dir/airWalk#_air-walk_

At will—_ [detect thoughts](spell_dir/detectThoughts#_detect-thoughts)_ (DC 19

3/day—_ [charm monster](spell_dir/charmMonster#_charm-monster) _(DC 20, _ [dispel magic](spell_dir/dispelMagic#_dispel-magic_, _ [dominate person](spell_dir/dominatePerson#_dominate-person) _(DC 22, _ [shadow conjuration](spell_dir/shadowConjuration#_shadow-conjuration)_ (DC 21, _ [shadow evocation](spell_dir/shadowEvocation#_shadow-evocation)_ (DC 22, _ [veil](spell_dir/veil#_veil)_ (DC 23

1/day—_ [confusion](spell_dir/confusion#_confusion)_ (DC 21, _ [major image](spell_dir/majorImage#_major-image)_ (DC 20, _ [mirage arcana](spell_dir/mirageArcana#_mirage-arcana)_ (DC 22, _ [plane shift](spell_dir/planeShift#_plane-shift)_ (self only)
...
**Skills** [Climb](skill_dir/climb#_climb +14, [Diplomacy](skill_dir/diplomacy#_diplomacy +14, [Intimidate](skill_dir/intimidate#_intimidate +24, [Knowledge](skill_dir/knowledge#_knowledge) (arcana +11, [Knowledge](skill_dir/knowledge#_knowledge) (planes +18, [Perception](skill_dir/perception#_perception +21, [Sense Motive](skill_dir/senseMotive#_sense-motive +18, [Spellcraft](skill_dir/spellcraft#_spellcraft +21, [Stealth](skill_dir/stealth#_stealth +24, [Use Magic Device](skill_dir/useMagicDevice#_use-magic-device +21; **Racial Modifiers** +8 [Stealth](skill_dir/stealth#_stealth)

**Languages** Aklo (cannot speak; telepathy 300 ft.

**SQ** [compression](monster_dir/universalMonsterRules#_compression, [no breath](monster_dir/universalMonsterRules#_no-breath)
...
0 Wisdom, the moon-beast gains the effects of a _ [heal](spell_dir/heal#_heal_ spell. The save DC is Constitution-based.

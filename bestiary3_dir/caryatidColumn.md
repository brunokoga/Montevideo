...
•A _ [transmute rock to mud](spell_dir/transmuteRockToMud#_transmute-rock-to-mud_ spell deals 1d6 points of damage per caster level to a caryatid column, with no saving throw.

•_ [Transmute mud to rock](spell_dir/transmuteMudToRock#_transmute-mud-to-rock_ immediately heals any and all damage currently suffered by a caryatid column.

•A _ [stone to flesh](spell_dir/stoneToFlesh#_stone-to-flesh_ spell does not actually change the column's structure but negates its [damage reduction](monster_dir/universalMonsterRules#_damage-reduction-(ex-or-su) and [immunity](monster_dir/universalMonsterRules#_immunity-(ex-or-su)) to magic for 1 round.
...
**Requirements** [Craft Construct](monster_dir/monsterFeats#_craft-construct, _ [lesser geas](spell_dir/geasQuest#_geas-lesser_, _ [polymorph](spell_dir/polymorph#_polymorph_, _ [shatter](spell_dir/shatter#_shatter_, caster must be at least 9th level; **Skill** [Craft](skill_dir/craft#_craft) ( sculpting or [Craft](skill_dir/craft#_craft) (stonemasonry DC 15; **Cost** 7,000 gp

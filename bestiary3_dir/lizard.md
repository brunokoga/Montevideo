...
**Init** +6; **Senses** low-light vision; [Perception](skills/perception#_perception) +6
...
**Skills** [Climb](skills/climb#_climb) +21, [Perception](skills/perception#_perception) +6; **Racial Modifiers** +8 [Climb](skills/climb#_climb)
...
**Expert Climber (Ex)** A gecko's feet allow it to climb virtually any surface, no matter how slick or sheer. In effect, geckos are treated as constantly being under a natural version of the spell _ [spider climb](spells/spiderClimb#_spider-climb)_.
...
**Melee** bite +6 (2d6+4) or tongue +5 touch ( [grab](monsters/universalMonsterRules#_grab))
...
**Skills** [Climb](skills/climb#_climb) +15, [Perception](skills/perception#_perception) +4, [Stealth](skills/stealth#_stealth) +18 (+28 when still); **Racial Modifiers** +12 [Stealth](skills/stealth#_stealth) (+22 when still)

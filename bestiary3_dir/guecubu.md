...
CE Medium undead ( [earth](monsters_dir/creatureTypes#_earth-subtype))

**Init** +8; **Senses** darkvision 60 ft., tremorsense 60 ft.; [Perception](skills_dir/perception#_perception) +18
...
**Defensive Abilities** channel [resistance](monsters_dir/universalMonsterRules#_resistance) +2; **DR** 5_dir/bludgeoning; **Immune** electricity, undead traits; **Resist** [cold](monsters_dir/creatureTypes#_cold-subtype) 10

Offense

**Speed** 30 ft., burrow 15 ft.; [earth glide](monsters_dir/universalMonsterRules#_earth-glide)
...
3_dir/day—_ [soften earth and stone](spells_dir/softenEarthAndStone#_soften-earth-and-stone)_, _ [spike growth](spells_dir/spikeGrowth#_spike-growth)_ (DC 18)

1_dir/day—_ [spike stones](spells_dir/spikeStones#_spike-stones)_ (DC 19), _ [transmute mud to rock](spells_dir/transmuteMudToRock#_transmute-mud-to-rock)_ (DC 20), _ [transmute rock to mud](spells_dir/transmuteRockToMud#_transmute-rock-to-mud)_ (DC 20)
...
**Skills** [Acrobatics](skills_dir/acrobatics#_acrobatics) +15, [Knowledge](skills_dir/knowledge#_knowledge) (nature) +12, [Perception](skills_dir/perception#_perception) +18, [Sense Motive](skills_dir/senseMotive#_sense-motive) +18, [Stealth](skills_dir/stealth#_stealth) +18
...
**Broken Ground (Su)** The ground in a 30-foot radius around a guecubu ripples and shudders unnaturally. This transforms the area surrounding a guecubu into difficult terrain. A guecubu can move through this area with no penalty. Consecrated ground cannot be affected by this ability, nor can any area warded by a _ [magic circle against chaos](spells_dir/magicCircleAgainstChaos#_magic-circle-against-chaos)_ or a _ [magic circle against evil](spells_dir/magicCircleAgainstEvil#_magic-circle-against-evil)_.

**Misfortune (Su)** A creature struck by a guecubu must make a DC 20 Will save or become permanently cursed with misfortune. The victim of this [curse](monsters_dir/universalMonsterRules#_curse) takes a –4 penalty on all attack rolls, saving throws, and skill checks, and any critical threat against the victim automatically confirms. If a guecubu hits a creature already suffering from this [curse](monsters_dir/universalMonsterRules#_curse), the victim must make a DC 20 Will save or be staggered for 1 round. This is a [curse](monsters_dir/universalMonsterRules#_curse) effect. The save DC is Charisma-based.

...
**Special Attacks** self-destruction, [trample](monsters/universalMonsterRules#_trample) (3d6+25, DC 41)
...
**Requirements** [Craft Construct](monsters/monsterFeats#_craft-construct), [Gunsmithing](ultimateCombat/ultimateCombatFeats#_gunsmithing) (_Ultimate Combat_ 103),_ [animate objects](spells/animateObjects#_animate-objects)_, _ [geas/quest](spells/geasQuest#_geas-quest)_, and _ [limited wish](spells/limitedWish#_limited-wish),_ creator must be at least caster level 18th; **Skill** [Craft](skills/craft#_craft) (clockwork) DC 25; **Cost** 160,000 gp
...
**Init** +8; **Senses** darkvision 60 ft., low-light vision; [Perception](skills/perception#_perception) +0
...
**DR** 10/adamantine; **Immune** [fire](monsters/creatureTypes#_fire-subtype), construct traits
...
**Special Attacks** [breath weapon](monsters/universalMonsterRules#_breath-weapon) (60-ft. line, 12d8 [fire](monsters/creatureTypes#_fire-subtype) damage, DC 18 for half, usable every 1d4 rounds, 3/day), grind, swallow whole (2d8+16 slashing damage plus 2d6 [fire](monsters/creatureTypes#_fire-subtype) damage, AC 17, 20 hp)
...
**Skills** [Stealth](skills/stealth#_stealth) +8 (+12 in [water](monsters/creatureTypes#_water-subtype)), [Swim](skills/swim#_swim) +19; **Racial Modifiers** +12 [Stealth](skills/stealth#_stealth) (+16 in [water](monsters/creatureTypes#_water-subtype))
...
**[Breath Weapon](monsters/universalMonsterRules#_breath-weapon) (Su)** A clockwork leviathan's [breath weapon](monsters/universalMonsterRules#_breath-weapon) is a powerful [jet](monsters/universalMonsterRules#_jet) of scorching steam—it functions equally well above and under [water](monsters/creatureTypes#_water-subtype).
...
**Swallow Whole (Ex)** A clockwork leviathan's interior is filled with injurious grinding gears and superheated [water](monsters/creatureTypes#_water-subtype)—in addition to taking damage, a swallowed creature must hold its breath or risk drowning as long as it remains inside a clockwork leviathan's “stomach.”
...
**Requirements** [Craft Construct](monsters/monsterFeats#_craft-construct),_ [freedom of movement](spells/freedomOfMovement#_freedom-of-movement), [geas/quest](spells/geasQuest#_geas-quest)_, _ [heat metal](spells/heatMetal#_heat-metal)_, and _ [limited wish](spells/limitedWish#_limited-wish)_, creator must be at least caster level 12th; **Skill** [Craft](skills/craft#_craft) (clockwork) DC 20; **Cost** 70,000 gp
...
**Requirements** [Craft Construct](monsters/monsterFeats#_craft-construct),_ [geas/quest](spells/geasQuest#_geas-quest)_ and _ [make whole](spells/makeWhole#_make-whole)_, creator must be at least caster level 12th; **Skill** [Craft](skills/craft#_craft) (clockwork) DC 20; **Cost** 4,000 gp (7,000 for an intelligent clockwork servant)
...
**Requirements** [Craft Construct](monsters/monsterFeats#_craft-construct),_ [geas/quest](spells/geasQuest#_geas-quest)_ and _ [heroism](spells/heroism#_heroism)_, creator must be at least caster level 12th; **Skill** [Craft](skills/craft#_craft) (clockwork) DC 20; **Cost** 19,000 gp
...
**Init** +5; **Senses** darkvision 60 ft., low-light vision; [Perception](skills/perception#_perception) +0
...
**Skills** [Climb](skills/climb#_climb) +2, [Fly](skills/fly#_fly) –3, [Stealth](skills/stealth#_stealth) +11; **Racial Modifiers** +2 [Climb](skills/climb#_climb), +2 [Stealth](skills/stealth#_stealth)
...
**Requirements** [Craft Construct](monsters/monsterFeats#_craft-construct),_ [geas/quest](spells/geasQuest#_geas-quest)_ and _ [ghost sound](spells/ghostSound#_ghost-sound)_, creator must be at least caster level 12th; **Skill** [Craft](skills/craft#_craft) (clockwork) DC 20; **Cost** 750 gp

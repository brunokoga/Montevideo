...
**Init** +9; **Senses** darkvision 60 ft., low-light vision; [Perception](skills_dir/perception#_perception) +0
...
**DR** 15_dir/adamantine; **Immune** construct traits
...
**Ranged** cannon +29_dir/+24_dir/+19_dir/+14 (6d6_dir/×4)

**Space** 20 ft.; **Reach** 20 ft.

**Special Attacks** self-destruction, [trample](monsters_dir/universalMonsterRules#_trample) (3d6+25, DC 41)
...
**Cannon (Ex)** One of a goliath's arms ends in a cannon. The goliath may use this as one of its four slam attacks, or it can use it to [fire](monsters_dir/creatureTypes#_fire-subtype) cannonballs. A cannon has a range increment of 100 feet, and deals 6d6 points of bludgeoning and piercing damage on a hit with a ×4 critical modifier. A clockwork goliath's cannon can hold up to 12 cannonballs—reloading a single cannonball is a standard action.

**Self-Destruction (Su)** When a goliath's hit points are reduced to 10% its total (21 hp for most clockwork goliaths) or less but still above 0, it self-destructs on its next turn, bursting in an explosion of metal scraps and steam that deals 12d6 points of slashing damage plus 12d6 points of [fire](monsters_dir/creatureTypes#_fire-subtype) damage to all creatures within a 20-foot-radius burst. A successful DC 24 Reflex save halves the damage. The save is Constitution-based.
...
**Requirements** [Craft Construct](monsters_dir/monsterFeats#_craft-construct), [Gunsmithing](ultimateCombat_dir/ultimateCombatFeats#_gunsmithing) (_Ultimate Combat_ 103),_ [animate objects](spells_dir/animateObjects#_animate-objects)_, _ [geas_dir/quest](spells_dir/geasQuest#_geas-quest)_, and _ [limited wish](spells_dir/limitedWish#_limited-wish),_ creator must be at least caster level 18th; **Skill** [Craft](skills_dir/craft#_craft) (clockwork) DC 25; **Cost** 160,000 gp
...
**Init** +8; **Senses** darkvision 60 ft., low-light vision; [Perception](skills_dir/perception#_perception) +0
...
**DR** 10_dir/adamantine; **Immune** [fire](monsters_dir/creatureTypes#_fire-subtype), construct traits
...
**Melee** bite +25 (2d6+11), 2 slam +25 (1d8+11 plus [grab](monsters_dir/universalMonsterRules#_grab))

**Space** 15 ft.; **Reach** 15 ft.

**Special Attacks** [breath weapon](monsters_dir/universalMonsterRules#_breath-weapon) (60-ft. line, 12d8 [fire](monsters_dir/creatureTypes#_fire-subtype) damage, DC 18 for half, usable every 1d4 rounds, 3_dir/day), grind, swallow whole (2d8+16 slashing damage plus 2d6 [fire](monsters_dir/creatureTypes#_fire-subtype) damage, AC 17, 20 hp)
...
**Skills** [Stealth](skills_dir/stealth#_stealth) +8 (+12 in [water](monsters_dir/creatureTypes#_water-subtype)), [Swim](skills_dir/swim#_swim) +19; **Racial Modifiers** +12 [Stealth](skills_dir/stealth#_stealth) (+16 in [water](monsters_dir/creatureTypes#_water-subtype))
...
**[Breath Weapon](monsters_dir/universalMonsterRules#_breath-weapon) (Su)** A clockwork leviathan's [breath weapon](monsters_dir/universalMonsterRules#_breath-weapon) is a powerful [jet](monsters_dir/universalMonsterRules#_jet) of scorching steam—it functions equally well above and under [water](monsters_dir/creatureTypes#_water-subtype).
...
**Swallow Whole (Ex)** A clockwork leviathan's interior is filled with injurious grinding gears and superheated [water](monsters_dir/creatureTypes#_water-subtype)—in addition to taking damage, a swallowed creature must hold its breath or risk drowning as long as it remains inside a clockwork leviathan's “stomach.”
...
**Requirements** [Craft Construct](monsters_dir/monsterFeats#_craft-construct),_ [freedom of movement](spells_dir/freedomOfMovement#_freedom-of-movement), [geas_dir/quest](spells_dir/geasQuest#_geas-quest)_, _ [heat metal](spells_dir/heatMetal#_heat-metal)_, and _ [limited wish](spells_dir/limitedWish#_limited-wish)_, creator must be at least caster level 12th; **Skill** [Craft](skills_dir/craft#_craft) (clockwork) DC 20; **Cost** 70,000 gp
...
**Requirements** [Craft Construct](monsters_dir/monsterFeats#_craft-construct),_ [geas_dir/quest](spells_dir/geasQuest#_geas-quest)_ and _ [make whole](spells_dir/makeWhole#_make-whole)_, creator must be at least caster level 12th; **Skill** [Craft](skills_dir/craft#_craft) (clockwork) DC 20; **Cost** 4,000 gp (7,000 for an intelligent clockwork servant)
...
**DR** 5_dir/adamantine; **Immune** construct traits
...
**Melee** _+1 halberd_ +18_dir/+13 (1d10+13_dir/×3)
...
**Requirements** [Craft Construct](monsters_dir/monsterFeats#_craft-construct),_ [geas_dir/quest](spells_dir/geasQuest#_geas-quest)_ and _ [heroism](spells_dir/heroism#_heroism)_, creator must be at least caster level 12th; **Skill** [Craft](skills_dir/craft#_craft) (clockwork) DC 20; **Cost** 19,000 gp

# Clockwork Spy

This tiny steel creature has one oversized eye, a spherical body, and several spiderlike legs of grinding metal.

Clockwork Spy CR 1_dir/2

XP 200

N Tiny construct (clockwork)

**Init** +5; **Senses** darkvision 60 ft., low-light vision; [Perception](skills_dir/perception#_perception) +0
...
**Skills** [Climb](skills_dir/climb#_climb) +2, [Fly](skills_dir/fly#_fly) –3, [Stealth](skills_dir/stealth#_stealth) +11; **Racial Modifiers** +2 [Climb](skills_dir/climb#_climb), +2 [Stealth](skills_dir/stealth#_stealth)
...
**Requirements** [Craft Construct](monsters_dir/monsterFeats#_craft-construct),_ [geas_dir/quest](spells_dir/geasQuest#_geas-quest)_ and _ [ghost sound](spells_dir/ghostSound#_ghost-sound)_, creator must be at least caster level 12th; **Skill** [Craft](skills_dir/craft#_craft) (clockwork) DC 20; **Cost** 750 gp

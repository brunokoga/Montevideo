...
**Init** +9; **Senses** darkvision 60 ft., low-light vision; [Perception](skills/perception.md#_perception) +0
...
**Special Attacks** self-destruction, [trample](monsters/universalMonsterRules.md#_trample) (3d6+25, DC 41)
...
**Feats** [Improved Initiative](feats.md#_improved-initiative)B, [Lightning Reflexes](feats.md#_lightning-reflexes)B
...
**Cannon (Ex)** One of a goliath's arms ends in a cannon. The goliath may use this as one of its four slam attacks, or it can use it to [fire](monsters/creatureTypes.md#_fire-subtype) cannonballs. A cannon has a range increment of 100 feet, and deals 6d6 points of bludgeoning and piercing damage on a hit with a ×4 critical modifier. A clockwork goliath's cannon can hold up to 12 cannonballs—reloading a single cannonball is a standard action.

**Self-Destruction (Su)** When a goliath's hit points are reduced to 10% its total (21 hp for most clockwork goliaths) or less but still above 0, it self-destructs on its next turn, bursting in an explosion of metal scraps and steam that deals 12d6 points of slashing damage plus 12d6 points of [fire](monsters/creatureTypes.md#_fire-subtype) damage to all creatures within a 20-foot-radius burst. A successful DC 24 Reflex save halves the damage. The save is Constitution-based.
...
**Requirements** [Craft Construct](monsters/monsterFeats.md#_craft-construct), [Gunsmithing](ultimateCombat/ultimateCombatFeats.md#_gunsmithing) (_Ultimate Combat_ 103),_ [animate objects](spells/animateObjects.md#_animate-objects)_, _ [geas/quest](spells/geasQuest.md#_geas-quest)_, and _ [limited wish](spells/limitedWish.md#_limited-wish),_ creator must be at least caster level 18th; **Skill** [Craft](skills/craft.md#_craft) (clockwork) DC 25; **Cost** 160,000 gp
...
**Init** +8; **Senses** darkvision 60 ft., low-light vision; [Perception](skills/perception.md#_perception) +0
...
**DR** 10/adamantine; **Immune** [fire](monsters/creatureTypes.md#_fire-subtype), construct traits
...
**Melee** bite +25 (2d6+11), 2 slam +25 (1d8+11 plus [grab](monsters/universalMonsterRules.md#_grab))

**Space** 15 ft.; **Reach** 15 ft.

**Special Attacks** [breath weapon](monsters/universalMonsterRules.md#_breath-weapon) (60-ft. line, 12d8 [fire](monsters/creatureTypes.md#_fire-subtype) damage, DC 18 for half, usable every 1d4 rounds, 3/day), grind, swallow whole (2d8+16 slashing damage plus 2d6 [fire](monsters/creatureTypes.md#_fire-subtype) damage, AC 17, 20 hp)
...
**Skills** [Stealth](skills/stealth.md#_stealth) +8 (+12 in [water](monsters/creatureTypes.md#_water-subtype)), [Swim](skills/swim.md#_swim) +19; **Racial Modifiers** +12 [Stealth](skills/stealth.md#_stealth) (+16 in [water](monsters/creatureTypes.md#_water-subtype))
...
**[Breath Weapon](monsters/universalMonsterRules.md#_breath-weapon) (Su)** A clockwork leviathan's [breath weapon](monsters/universalMonsterRules.md#_breath-weapon) is a powerful [jet](monsters/universalMonsterRules.md#_jet) of scorching steam—it functions equally well above and under [water](monsters/creatureTypes.md#_water-subtype).
...
**Swallow Whole (Ex)** A clockwork leviathan's interior is filled with injurious grinding gears and superheated [water](monsters/creatureTypes.md#_water-subtype)—in addition to taking damage, a swallowed creature must hold its breath or risk drowning as long as it remains inside a clockwork leviathan's “stomach.”
...
**Requirements** [Craft Construct](monsters/monsterFeats.md#_craft-construct),_ [freedom of movement](spells/freedomOfMovement.md#_freedom-of-movement), [geas/quest](spells/geasQuest.md#_geas-quest)_, _ [heat metal](spells/heatMetal.md#_heat-metal)_, and _ [limited wish](spells/limitedWish.md#_limited-wish)_, creator must be at least caster level 12th; **Skill** [Craft](skills/craft.md#_craft) (clockwork) DC 20; **Cost** 70,000 gp
...
Rumors of clockwork servants with magically imparted intelligence persist among explorers of certain strange ruins—while no smarter than the average human, such “awakened” clockwork servants have skills and feats as appropriate for their Hit Dice ( [Disable Device](skills/disableDevice.md#_disable-device) +7, [Perception](skills/perception.md#_perception) +2, and [Skill Focus](feats.md#_skill-focus) [[Disable Device](skills/disableDevice.md#_disable-device)] for most intelligent clockwork servants), and are said to serve in more complex roles than mere repair workers. An intelligent clockwork has an Intelligence score of 11 and can speak one language.
...
**Requirements** [Craft Construct](monsters/monsterFeats.md#_craft-construct),_ [geas/quest](spells/geasQuest.md#_geas-quest)_ and _ [make whole](spells/makeWhole.md#_make-whole)_, creator must be at least caster level 12th; **Skill** [Craft](skills/craft.md#_craft) (clockwork) DC 20; **Cost** 4,000 gp (7,000 for an intelligent clockwork servant)
...
**Requirements** [Craft Construct](monsters/monsterFeats.md#_craft-construct),_ [geas/quest](spells/geasQuest.md#_geas-quest)_ and _ [heroism](spells/heroism.md#_heroism)_, creator must be at least caster level 12th; **Skill** [Craft](skills/craft.md#_craft) (clockwork) DC 20; **Cost** 19,000 gp
...
**Init** +5; **Senses** darkvision 60 ft., low-light vision; [Perception](skills/perception.md#_perception) +0
...
**Skills** [Climb](skills/climb.md#_climb) +2, [Fly](skills/fly.md#_fly) –3, [Stealth](skills/stealth.md#_stealth) +11; **Racial Modifiers** +2 [Climb](skills/climb.md#_climb), +2 [Stealth](skills/stealth.md#_stealth)
...
**Requirements** [Craft Construct](monsters/monsterFeats.md#_craft-construct),_ [geas/quest](spells/geasQuest.md#_geas-quest)_ and _ [ghost sound](spells/ghostSound.md#_ghost-sound)_, creator must be at least caster level 12th; **Skill** [Craft](skills/craft.md#_craft) (clockwork) DC 20; **Cost** 750 gp

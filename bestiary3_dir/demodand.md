...
CE Medium outsider ( [chaotic](monster_dir/creatureTypes#_chaotic-subtype, [demodand](monster_dir/creatureTypes#_demodand-subtype, [evil](monster_dir/creatureTypes#_evil-subtype, [extraplanar](monster_dir/creatureTypes#_extraplanar-subtype)

**Init** +11; **Senses** [blindsense](monster_dir/universalMonsterRules#_blindsense 30 ft., darkvision 60 ft., _ [detect good](spell_dir/detectGood#_detect-good_, _ [detect magic](spell_dir/detectMagic#_detect-magic_, _ [see invisibility](spell_dir/seeInvisibility#_see-invisibility_; [Perception](skill_dir/perception#_perception) +36
...
**DR** 15/good and magic; **Immune** acid, [poison](monster_dir/universalMonsterRules#_poison-(ex-or-su); **Resist** [cold](monster_dir/creatureTypes#_cold-subtype 10, [fire](monster_dir/creatureTypes#_fire-subtype) 10; **SR** 29

Offense

**Speed** 40 ft., fly 50 ft. (average

**Melee** _+2 [unholy](magicItem_dir/weapons#_unholy morningstar_ +36/+31/+26/+21 (1d8+11), bite +32 (2d6+4), claw +32 (1d6+4) or
...
Constant—_ [detect good](spell_dir/detectGood#_detect-good_, _ [detect magic](spell_dir/detectMagic#_detect-magic_, _ [see invisibility](spell_dir/seeInvisibility#_see-invisibility_

At will—_ [detect thoughts](spell_dir/detectThoughts#_detect-thoughts)_ (DC 17, _ [fear](spell_dir/fear#_fear)_ (DC 19, _ [gaseous form](spell_dir/gaseousForm#_gaseous-form_, _ [greater dispel magic](spell_dir/dispelMagic#_dispel-magic-greater_, _ [invisibility](spell_dir/invisibility#_invisibility)_ (self only, _ [magic circle against good](spell_dir/magicCircleAgainstGood#_magic-circle-against-good_

3/day—empowered _ [cloudkill](spell_dir/cloudkill#_cloudkill)_ (DC 20, _ [fog cloud](spell_dir/fogCloud_, quickened _ [ray of enfeeblement](spell_dir/rayOfEnfeeblement#_ray-of-enfeeblement)_ (DC 16, _ [stinking cloud](spell_dir/stinkingCloud#_stinking-cloud)_ (DC 18

1/day—_ [blasphemy](spell_dir/blasphemy#_blasphemy)_ (DC 22, _ [chaos hammer](spell_dir/chaosHammer#_chaos-hammer)_ (DC 19, _ [mass charm monster](spell_dir/charmMonster#_charm-monster-mass)_ (DC 23), summon (level 6, 1d6 tarry demodands or 1d4 slimy demodands 60%)
...
**Skills** [Acrobatics](skill_dir/acrobatics#_acrobatics) +35 (+39 when jumping, [Bluff](skill_dir/bluff#_bluff +28, [Diplomacy](skill_dir/diplomacy#_diplomacy +28, [Fly](skill_dir/fly#_fly +35, [Intimidate](skill_dir/intimidate#_intimidate +42, [Knowledge](skill_dir/knowledge#_knowledge) (arcana +26, [Knowledge](skill_dir/knowledge#_knowledge) (planes +15, [Knowledge](skill_dir/knowledge#_knowledge) (religion +15, [Perception](skill_dir/perception#_perception +36, [Sense Motive](skill_dir/senseMotive#_sense-motive +36, [Spellcraft](skill_dir/spellcraft#_spellcraft +29, [Use Magic Device](skill_dir/useMagicDevice#_use-magic-device) +30
...
**Organization** solitary or warband (1 shaggy [demodand](monster_dir/creatureTypes#_demodand-subtype) plus 2–5 tarry demodands
...
**Init** +4; **Senses** darkvision 120 ft., _ [detect good](spell_dir/detectGood#_detect-good_, _ [detect magic](spell_dir/detectMagic#_detect-magic_, _ [see invisibility](spell_dir/seeInvisibility#_see-invisibility_; [Perception](skill_dir/perception#_perception) +2
...
**DR** 10/good and magic; **Immune** acid, [poison](monster_dir/universalMonsterRules#_poison-(ex-or-su); **Resist** [cold](monster_dir/creatureTypes#_cold-subtype 10, [fire](monster_dir/creatureTypes#_fire-subtype) 10; **SR** 27
...
At will—_ [detect thoughts](spell_dir/detectThoughts#_detect-thoughts)_ (DC 15, _ [fear](spell_dir/fear#_fear)_ (DC 17

3/day—_ [acid fog](spell_dir/acidFog#_acid-fog_, _ [greater dispel magic](spell_dir/dispelMagic#_dispel-magic-greater_
...
**Skills** [Acrobatics](skill_dir/acrobatics#_acrobatics +11, [Bluff](skill_dir/bluff#_bluff +27, [Climb](skill_dir/climb#_climb +19, [Fly](skill_dir/fly#_fly +25, [Intimidate](skill_dir/intimidate#_intimidate +36, [Knowledge](skill_dir/knowledge#_knowledge) (arcana +13, [Knowledge](skill_dir/knowledge#_knowledge) (planes +13, [Sense Motive](skill_dir/senseMotive#_sense-motive +26, [Spellcraft](skill_dir/spellcraft#_spellcraft +20, [Stealth](skill_dir/stealth#_stealth +25, [Survival](skill_dir/survival#_survival) +20
...
**Init** +9; **Senses** darkvision 120 ft., _ [detect good](spell_dir/detectGood#_detect-good_, _ [detect magic](spell_dir/detectMagic#_detect-magic_; [Perception](skill_dir/perception#_perception) +22
...
**DR** 10/good and magic; **Immune** acid, [poison](monster_dir/universalMonsterRules#_poison-(ex-or-su); **Resist** [cold](monster_dir/creatureTypes#_cold-subtype 10, [fire](monster_dir/creatureTypes#_fire-subtype) 10; **SR** 24
...
3/day—_ [dispel magic](spell_dir/dispelMagic#_dispel-magic_
...
**Skills** [Bluff](skill_dir/bluff#_bluff +16, [Climb](skill_dir/climb#_climb +19, [Fly](skill_dir/fly#_fly +23, [Intimidate](skill_dir/intimidate#_intimidate +24, [Knowledge](skill_dir/knowledge#_knowledge) (arcana +14, [Knowledge](skill_dir/knowledge#_knowledge) (planes +14, [Perception](skill_dir/perception#_perception +22, [Sense Motive](skill_dir/senseMotive#_sense-motive +14, [Stealth](skill_dir/stealth#_stealth +17, [Survival](skill_dir/survival#_survival) +14

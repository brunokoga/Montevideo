...
CE Medium outsider ( [chaotic](monster_dir/creatureTypes#_chaotic-subtype), [demodand](monsters/creatureTypes#_demodand-subtype), [evil](monster_dir/creatureTypes#_evil-subtype), [extraplanar](monsters/creatureTypes#_extraplanar-subtype))

**Init** +11; **Senses** [blindsense](monster_dir/universalMonsterRules#_blindsense) 30 ft., darkvision 60 ft., _ [detect good](spells/detectGood#_detect-good)_, _ [detect magic](spell_dir/detectMagic#_detect-magic)_, _ [see invisibility](spells/seeInvisibility#_see-invisibility)_; [Perception](skill_dir/perception#_perception) +36
...
**DR** 15/good and magic; **Immune** acid, [poison](monster_dir/universalMonsterRules#_poison-(ex-or-su)); **Resist** [cold](monsters/creatureTypes#_cold-subtype) 10, [fire](monster_dir/creatureTypes#_fire-subtype) 10; **SR** 29

Offense

**Speed** 40 ft., fly 50 ft. (average)

**Melee** _+2 [unholy](magicItems/weapons#_unholy) morningstar_ +36/+31/+26/+21 (1d8+11), bite +32 (2d6+4), claw +32 (1d6+4) or
...
Constant—_ [detect good](spell_dir/detectGood#_detect-good)_, _ [detect magic](spells/detectMagic#_detect-magic)_, _ [see invisibility](spell_dir/seeInvisibility#_see-invisibility)_

At will—_ [detect thoughts](spells/detectThoughts#_detect-thoughts)_ (DC 17), _ [fear](spell_dir/fear#_fear)_ (DC 19), _ [gaseous form](spells/gaseousForm#_gaseous-form)_, _ [greater dispel magic](spell_dir/dispelMagic#_dispel-magic-greater)_, _ [invisibility](spells/invisibility#_invisibility)_ (self only), _ [magic circle against good](spell_dir/magicCircleAgainstGood#_magic-circle-against-good)_

3/day—empowered _ [cloudkill](spell_dir/cloudkill#_cloudkill)_ (DC 20), _ [fog cloud](spells/fogCloud)_, quickened _ [ray of enfeeblement](spell_dir/rayOfEnfeeblement#_ray-of-enfeeblement)_ (DC 16), _ [stinking cloud](spells/stinkingCloud#_stinking-cloud)_ (DC 18)

1/day—_ [blasphemy](spell_dir/blasphemy#_blasphemy)_ (DC 22), _ [chaos hammer](spells/chaosHammer#_chaos-hammer)_ (DC 19), _ [mass charm monster](spell_dir/charmMonster#_charm-monster-mass)_ (DC 23), summon (level 6, 1d6 tarry demodands or 1d4 slimy demodands 60%)
...
**Feats** [Alertness](feats#_alertness), Cleave, [Combat Casting](feats#_combat-casting), [Combat Reflexes](feats#_combat-reflexes), [Empower Spell-Like Ability](monsters/monsterFeats#_empower-spell-like-ability) (_ [cloudkill](spell_dir/cloudkill#_cloudkill)_), [Flyby Attack](monsters/monsterFeats#_flyby-attack), [Great Cleave](feats#_great-cleave), [Improved Initiative](feats#_improved-initiative), [Intimidating Prowess](feats#_intimidating-prowess), [Lightning Reflexes](feats#_lightning-reflexes), [Multiattack](monster_dir/monsterFeats#_multiattack), [Power Attack](feats#_power-attack), [Quicken Spell-Like Ability](monsters/monsterFeats#_quicken-spell-like-ability) (_ [ray of enfeeblement](spell_dir/rayOfEnfeeblement#_ray-of-enfeeblement)_)

**Skills** [Acrobatics](skills/acrobatics#_acrobatics) +35 (+39 when jumping), [Bluff](skill_dir/bluff#_bluff) +28, [Diplomacy](skills/diplomacy#_diplomacy) +28, [Fly](skill_dir/fly#_fly) +35, [Intimidate](skills/intimidate#_intimidate) +42, [Knowledge](skill_dir/knowledge#_knowledge) (arcana) +26, [Knowledge](skills/knowledge#_knowledge) (planes) +15, [Knowledge](skill_dir/knowledge#_knowledge) (religion) +15, [Perception](skills/perception#_perception) +36, [Sense Motive](skill_dir/senseMotive#_sense-motive) +36, [Spellcraft](skills/spellcraft#_spellcraft) +29, [Use Magic Device](skill_dir/useMagicDevice#_use-magic-device) +30
...
**Organization** solitary or warband (1 shaggy [demodand](monsters/creatureTypes#_demodand-subtype) plus 2–5 tarry demodands)

**Treasure** double (_+2 [unholy](magicItem_dir/weapons#_unholy) morningstar_, other treasure)
...
CE Medium outsider ( [chaotic](monsters/creatureTypes#_chaotic-subtype), [demodand](monster_dir/creatureTypes#_demodand-subtype), [evil](monsters/creatureTypes#_evil-subtype), [extraplanar](monster_dir/creatureTypes#_extraplanar-subtype))

**Init** +4; **Senses** darkvision 120 ft., _ [detect good](spells/detectGood#_detect-good)_, _ [detect magic](spell_dir/detectMagic#_detect-magic)_, _ [see invisibility](spells/seeInvisibility#_see-invisibility)_; [Perception](skill_dir/perception#_perception) +2
...
**DR** 10/good and magic; **Immune** acid, [poison](monster_dir/universalMonsterRules#_poison-(ex-or-su)); **Resist** [cold](monsters/creatureTypes#_cold-subtype) 10, [fire](monster_dir/creatureTypes#_fire-subtype) 10; **SR** 27

Offense

**Speed** 20 ft., fly 40 ft. (average)

**Melee** bite +30 (1d10+9 plus 2d6 acid), 2 claws +30 (2d6+13/19–20 plus 2d6 acid and [grab](monster_dir/universalMonsterRules#_grab))

**Special Attacks** acid, dread claws, faith-stealing strike

**Spell-Like Abilities** (CL 16th; concentration +19)

Constant—_ [detect good](spells/detectGood#_detect-good)_, _ [detect magic](spell_dir/detectMagic#_detect-magic)_, _ [see invisibility](spells/seeInvisibility#_see-invisibility)_

At will—_ [detect thoughts](spell_dir/detectThoughts#_detect-thoughts)_ (DC 15), _ [fear](spells/fear#_fear)_ (DC 17)

3/day—_ [acid fog](spell_dir/acidFog#_acid-fog)_, _ [greater dispel magic](spells/dispelMagic#_dispel-magic-greater)_
...
**Feats** [Bleeding Critical](feats#_bleeding-critcial), [Blind-Fight](feats#_blind-fight), [Critical Focus](feats#_critical-focus), [Flyby Attack](monster_dir/monsterFeats#_flyby-attack), Greater [Vital Strike](feats#_vital-strike), [Improved Critical](feats#_improved-critical) (claw), [Improved Vital Strike](feats#_improved-vital-strike), [Intimidating Prowess](feats#_intimidating-prowess), [Lightning Reflexes](feats#_lightning-reflexes), [Power Attack](feats#_power-attack), [Vital Strike](feats#_vital-strike)

**Skills** [Acrobatics](skills/acrobatics#_acrobatics) +11, [Bluff](skill_dir/bluff#_bluff) +27, [Climb](skills/climb#_climb) +19, [Fly](skill_dir/fly#_fly) +25, [Intimidate](skills/intimidate#_intimidate) +36, [Knowledge](skill_dir/knowledge#_knowledge) (arcana) +13, [Knowledge](skills/knowledge#_knowledge) (planes) +13, [Sense Motive](skill_dir/senseMotive#_sense-motive) +26, [Spellcraft](skills/spellcraft#_spellcraft) +20, [Stealth](skill_dir/stealth#_stealth) +25, [Survival](skills/survival#_survival) +20
...
**Acid (Su)** A slimy [demodand](monster_dir/creatureTypes#_demodand-subtype) is coated in an ever-dripping layer of acid that deals an extra 2d6 points of acid damage on a successful natural attack. In addition, opponents that successfully strike a slimy [demodand](monsters/creatureTypes#_demodand-subtype) with an unarmed strike or natural attack take 2d6 points of acid damage.

**Dread Claws (Ex)** A slimy [demodand](monster_dir/creatureTypes#_demodand-subtype) adds 1-1/2 times its strength bonus on all attack rolls made when using its claws.
...
**Init** +9; **Senses** darkvision 120 ft., _ [detect good](spell_dir/detectGood#_detect-good)_, _ [detect magic](spells/detectMagic#_detect-magic)_; [Perception](skill_dir/perception#_perception) +22
...
**DR** 10/good and magic; **Immune** acid, [poison](monster_dir/universalMonsterRules#_poison-(ex-or-su)); **Resist** [cold](monsters/creatureTypes#_cold-subtype) 10, [fire](monster_dir/creatureTypes#_fire-subtype) 10; **SR** 24
...
3/day—_ [dispel magic](spell_dir/dispelMagic#_dispel-magic)_

1/day—_ [chaos hammer](spell_dir/chaosHammer#_chaos-hammer)_ (DC 17), summon (level 4, 1d2 tarry demodands 40%)
...
**Skills** [Bluff](skills/bluff#_bluff) +16, [Climb](skill_dir/climb#_climb) +19, [Fly](skills/fly#_fly) +23, [Intimidate](skill_dir/intimidate#_intimidate) +24, [Knowledge](skills/knowledge#_knowledge) (arcana) +14, [Knowledge](skill_dir/knowledge#_knowledge) (planes) +14, [Perception](skills/perception#_perception) +22, [Sense Motive](skill_dir/senseMotive#_sense-motive) +14, [Stealth](skills/stealth#_stealth) +17, [Survival](skill_dir/survival#_survival) +14
...
**Adhesion (Ex)** A creature striking a tarry [demodand](monsters/creatureTypes#_demodand-subtype) with a manufactured weapon must make a DC 23 Reflex save; failure means the weapon sticks to the [demodand](monster_dir/creatureTypes#_demodand-subtype) and cannot be used to make attacks until freed. Freeing a stuck weapon requires a successful grapple check. This adhesion grants a +4 racial bonus to CMD against disarm attempts.

---
layout: default
title: bestiary3_dir/disenchanter
---
# Disenchanter
...
**Init** +3; **Senses** darkvision 60 ft., _ [detect magic](spells_dir/detectMagic#_detect-magic)_, low-light vision; [Perception](skills_dir/perception#_perception) +9
...
**Weaknesses** vulnerable to _ [dispel magic](spells_dir/dispelMagic#_dispel-magic)_
...
3_dir/day—_ [magic weapon](spells_dir/magicWeapon#_magic-weapon)_
...
**Skills** [Escape Artist](skills_dir/escapeArtist#_escape-artist) +5, [Perception](skills_dir/perception#_perception) +9
...
**Power Spray (Su)** Once per day, a disenchanter can release a 20-foot cone-shaped burst of raw magical energy through its trunk. Creatures in the cone take 4d6 points of damage (DC 14 Reflex save for half). Creatures immune to magic effects that allow spell [resistance](monsters_dir/universalMonsterRules#_resistance) (such as golems) are immune to this ability. The save DC is Constitution-based.

**Vulnerable to Dispel Magic (Ex)** A disenchanter targeted by _ [dispel magic](spells_dir/dispelMagic#_dispel-magic)_ takes 1d6 points of damage per caster level (maximum 10d6, Fortitude save for half). _ [Greater dispel magic](spells_dir/dispelMagic#_dispel-magic-greater)_ functions similarly (maximum 20d6 damage, Fortitude save for half).

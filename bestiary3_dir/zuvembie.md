...
**Init** +2; **Senses** darkvision 60 ft.; [Perception](skill_dir/perception#_perception) +10
...
**Defensive Abilities** channel [resistance](monster_dir/universalMonsterRules#_resistance +4; **DR** 5/piercing; **Immune** [cold](monster_dir/creatureTypes#_cold-subtype, undead traits
...
At will—_ [darkness](spell_dir/darkness#_darkness_

3/day—_ [ghoul touch](spell_dir/ghoulTouch#_ghoul-touch_, _ [scare](spell_dir/scare#_scare)_ (DC 14

1/day—_ [animate dead](spell_dir/animateDead#_animate-dead_, _ [ray of exhaustion](spell_dir/rayOfExhaustion#_ray-of-exhaustion), _summon (level 3, 1d3 bat or bird swarms [use the same stats], 1d2 constrictor snakes, 1d3 venomous snakes, or 1d4 wolves
...
**Feats** [Ability Focus](monster_dir/monsterFeats#_ability-focus) (corpse call), [Dodge](feats#_dodge), [Toughness](feats#_toughness

**Skills** [Bluff](skill_dir/bluff#_bluff +7, [Knowledge](skill_dir/knowledge#_knowledge) (arcana +8, [Perception](skill_dir/perception#_perception +10, [Stealth](skill_dir/stealth#_stealth +14; **Racial Modifiers** +4 [Stealth](skill_dir/stealth#_stealth)

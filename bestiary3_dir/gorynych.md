...
**Init** +2; **Senses** darkvision 60 ft., low-light vision, _ [true seeing](spell_dir/trueSeeing#_true-seeing_; [Perception](skill_dir/perception#_perception) +23
...
**DR** 10/lawful; **Immune** [fire](monster_dir/creatureTypes#_fire-subtype, paralysis, [poison](monster_dir/universalMonsterRules#_poison-(ex-or-su)), sleep; **SR** 26
...
At will—_ [charm person](spell_dir/charmPerson#_charm-person)_ (DC 15, _ [dancing lights](spell_dir/dancingLights#_dancing-lights_, _ [message](spell_dir/message#_message_

3/day—_ [alter self](spell_dir/alterSelf#_alter-self_, _ [bestow curse](spell_dir/bestowCurse#_bestow-curse)_ (DC 18, _ [greater dispel magic](spell_dir/dispelMagic#_dispel-magic-greater_

1/day—_ [lesser geas](spell_dir/geasQuest#_geas-lesser)_ (DC 18, _ [limited wish](spell_dir/limitedWish#_limited-wish_, _ [mislead](spell_dir/mislead#_mislead)_ (DC 20
...
**Skills** [Bluff](skill_dir/bluff#_bluff +17, [Diplomacy](skill_dir/diplomacy#_diplomacy +17, [Fly](skill_dir/fly#_fly +7, [Intimidate](skill_dir/intimidate#_intimidate +17, [Knowledge](skill_dir/knowledge#_knowledge) (arcana +14, [Knowledge](skill_dir/knowledge#_knowledge) (nature +14, [Perception](skill_dir/perception#_perception +23, [Sense Motive](skill_dir/senseMotive#_sense-motive +16, [Spellcraft](skill_dir/spellcraft#_spellcraft +14, [Stealth](skill_dir/stealth#_stealth +14, [Swim](skill_dir/swim#_swim +24
...
**[Breath Weapon](monster_dir/universalMonsterRules#_breath-weapon) (Su)** Each of a gorynych's heads has its own separate breath weapon. When a gorynych uses its breath weapon, it can breathe with one, two, or all three heads. If the areas of two or more breath weapons overlap, a creature caught in that overlapping area takes a –2 penalty on its Reflex save (or –4 if three breath weapons overlap. Damage done by overlapping breath weapons stacks and is considered to be a single source of [fire](monster_dir/creatureTypes#_fire-subtype damage for the purpose of tracking [fire](monster_dir/creatureTypes#_fire-subtype [resistance](monster_dir/universalMonsterRules#_resistance. Regardless of how many heads breathe [fire](monster_dir/creatureTypes#_fire-subtype), the gorynych can only use its breath weapon once every 1d4 rounds.
...
Motivated by greed, gluttony, and unnatural lust, a gorynych lives to collect treasure, feast as often as possible, and chase after humanoid maidens, using _ [alter self](spell_dir/alterSelf#_alter-self_ and _ [charm person](spell_dir/charmPerson#_charm-person_ as necessary. Gorynyches are particularly creative with the use of their _limited wishes_ in duplicating other spell effects to secure their desires and complete their hideous tasks.

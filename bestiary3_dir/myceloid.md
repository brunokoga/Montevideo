...
**Init** +4; **Senses** darkvision 60 ft., low-light vision, [scent](monster_dir/universalMonsterRules#_scent); [Perception](skills/perception#_perception) +6
...
**DR** 5/slashing; **Immune** plant traits; **Resist** [cold](monster_dir/creatureTypes#_cold-subtype) 10, [fire](monsters/creatureTypes#_fire-subtype) 10, sonic 10
...
**Skills** [Perception](skills/perception#_perception) +6, [Sense Motive](skill_dir/senseMotive#_sense-motive) +5, [Stealth](skills/stealth#_stealth) +9, [Survival](skill_dir/survival#_survival) +5; **Racial Modifiers** +4 [Sense Motive](skills/senseMotive#_sense-motive), +4 [Survival](skill_dir/survival#_survival)
...
**Spore Domination (Sp)** This spell-like ability functions as _ [charm monster](spell_dir/charmMonster#_charm-monster)_, but functions only against creatures currently infected with purple pox.

...
**Init** +3; **Senses** bloodsense, darkvision 30 ft.; [Perception](skills/perception#_perception) +21
...
**Special Attacks** [blood drain](monsters/universalMonsterRules#_blood-drain) (1d4 Con), bloodspray
...
**Feats** [Bleeding Critical](feats#_bleeding-critical), [Critical Focus](feats#_critical-focus), [Flyby Attack](monsters/monsterFeats#_flyby-attack), [Great Fortitude](feats#_great-fortitude), Improved Bull Rush, [Lightning Reflexes](feats#_lightning-reflexes), [Multiattack](monsters/monsterFeats#_multiattack), [Power Attack](feats#_power-attack)

**Skills** [Bluff](skills/bluff#_bluff) +18, [Climb](skills/climb#_climb) +14, [Fly](skills/fly#_fly) +27, [Knowledge](skills/knowledge#_knowledge) (dungeoneering) +17, [Perception](skills/perception#_perception) +21, [Stealth](skills/stealth#_stealth) +17, [Survival](skills/survival#_survival) +21
...
**Bloodsense (Su)** A ghorazagh notices living creatures within 60 feet just as if it possessed the [blindsight](monsters/universalMonsterRules#_blindsight) ability.

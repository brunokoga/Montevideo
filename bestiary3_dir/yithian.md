...
**Init** +1; **Senses** [all-around vision](../monsters_dir/universalMonsterRules#_all-around-vision), [blindsense](../monsters_dir/universalMonsterRules#_blindsense) 60 ft., darkvision 60 ft.; [Perception](../skills_dir/perception#_perception) +25
...
**DR** 10_dir/magic; **Resist** acid 10, [cold](../monsters_dir/creatureTypes#_cold-subtype) 10, [fire](../monsters_dir/creatureTypes#_fire-subtype) 10

Offense

**Speed** 20 ft., climb 10 ft.

**Melee** 2 pincers +15 (2d8+9_dir/×3)
...
At will—_ [astral projection](../spells_dir/astralProjection#_astral-projection)_ (self only), _ [detect thoughts](../spells_dir/detectThoughts#_detect-thoughts)_ (DC 16), _ [hold monster](../spells_dir/holdMonster#_hold-monster)_ (DC 19), _ [modify memory](../spells_dir/modifyMemory#_modify-memory)_ (DC 18)
...
**Skills** [Climb](../skills_dir/climb#_climb) +14, [Diplomacy](../skills_dir/diplomacy#_diplomacy) +18, [Heal](../skills_dir/heal#_heal) +18, [Knowledge](../skills_dir/knowledge#_knowledge) (arcana, engineering, geography, history, planes) +24, [Linguistics](../skills_dir/linguistics#_linguistics) +24, [Perception](../skills_dir/perception#_perception) +25, [Sense Motive](../skills_dir/senseMotive#_sense-motive) +22, [Use Magic Device](../skills_dir/useMagicDevice#_use-magic-device) +18

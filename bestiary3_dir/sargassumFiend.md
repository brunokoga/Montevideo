...
N Large plant ( [aquatic](monsters/creatureTypes#_aquatic-subtype))

**Init** +6; **Senses** [blindsense](monsters/universalMonsterRules#_blindsense) 60 ft., tremorsense 120 ft.; [Perception](skills/perception#_perception) +11
...
**DR** 5/slashing; **Immune** plant traits; **Resist** [cold](monsters/creatureTypes#_cold-subtype) 10
...
**Special Attacks** [constrict](monsters/universalMonsterRules#_constrict) (2d8+10), [grab](monsters/universalMonsterRules#_grab) (Huge)
...
**Feats** [Dodge](feats#_dodge), [Great Fortitude](feats#_great-fortitude), [Improved Initiative](feats#_improved-initiative), [Lightning Reflexes](feats#_lightning-reflexes), [Skill Focus](feats#_skill-focus) ( [Perception](skills/perception#_perception)), [Stealthy](feats#_stealthy), [Weapon Focus](feats#_weapon-focus) (slam)

**Skills** [Climb](skills/climb#_climb) +19, [Escape Artist](skills/escapeArtist#_escape-artist) +4, [Perception](skills/perception#_perception) +11, [Stealth](skills/stealth#_stealth) +7, [Swim](skills/swim#_swim) +15

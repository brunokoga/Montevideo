...
N Large outsider ( [native](../monsters_dir/creatureTypes#_native-subtype))

**Init** +2; **Senses** darkvision 60 ft.; [Perception](../skills_dir/perception#_perception) +17
...
**Fort** +13, **Ref** +5, **Will** +10; +2 vs. [fear](../monsters_dir/universalMonsterRules#_fear-(su-or-sp)) and sorrow effects

**Defensive Abilities** soul of sorrow; **DR** 10_dir/magic; **Resist** [cold](../monsters_dir/creatureTypes#_cold-subtype) 10, [fire](../monsters_dir/creatureTypes#_fire-subtype) 10; **SR** 19

Offense

**Speed** 30 ft.

**Melee** _+1 longsword_ +18_dir/+13_dir/+8 (2d6+11_dir/17–20) or 2 slams +17 (1d6+7)

**Ranged** mwk spear +13_dir/+8_dir/+3 (2d6+7_dir/×3)
...
**Skills** [Bluff](../skills_dir/bluff#_bluff) +12, [Climb](../skills_dir/climb#_climb) +13, [Diplomacy](../skills_dir/diplomacy#_diplomacy) +17, [Intimidate](../skills_dir/intimidate#_intimidate) +17, [Knowledge](../skills_dir/knowledge#_knowledge) (geography, planes) +11, [Perception](../skills_dir/perception#_perception) +17, [Sense Motive](../skills_dir/senseMotive#_sense-motive) +17, [Stealth](../skills_dir/stealth#_stealth) +9, [Survival](../skills_dir/survival#_survival) +12
...
**[Crushing Blow](../ultimateCombat_dir/ultimateCombatFeats#_crushing-blow) (Ex)** When a nephilim makes a successful critical hit with a melee attack, the target must make a DC 22 Fortitude save or take an additional 3d6 points of nonlethal damage and be staggered for 1 round. The save DC is Strength-based.
...
**Soul of Sorrow (Ex)** A nephilim gains a +2 bonus on Will saves against [fear](../monsters_dir/universalMonsterRules#_fear-(su-or-sp)) effects and any effect that causes sorrow.

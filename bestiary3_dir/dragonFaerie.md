...
1st (6/day)—_ [grease](spell_dir/grease#_grease)_ (DC 14, _ [silent image](spell_dir/silentImage#_silent-image)_ (DC 14, _ [sleep](spell_dir/sleep#_sleep)_ (DC 14)

0 (at will—_ [dancing lights](spell_dir/dancingLights#_dancing-lights_, _ [flare](spell_dir/flare#_flare)_ (DC 13, _ [ghost sound](spell_dir/ghostSound#_ghost-sound)_ (DC 13, _ [mage hand](spell_dir/mageHand#_mage-hand_, _ [open/close](spell_dir/openClose#_open-close)_
...
**Skills** [Acrobatics](skill_dir/acrobatics#_acrobatics) +8 (+0 when jumping, [Bluff](skill_dir/bluff#_bluff +9, [Diplomacy](skill_dir/diplomacy#_diplomacy +9, [Fly](skill_dir/fly#_fly +23, [Perception](skill_dir/perception#_perception +8, [Sense Motive](skill_dir/senseMotive#_sense-motive +8, [Stealth](skill_dir/stealth#_stealth +17, [Swim](skill_dir/swim#_swim +13, [Use Magic Device](skill_dir/useMagicDevice#_use-magic-device) +9
...
**[Breath Weapon](monster_dir/universalMonsterRules#_breath-weapon) (Su** 5-foot cone, euphoria for 1d6 rounds, DC 12 Fortitude negates. Creatures affected by euphoria are staggered, sickened, and immune to [fear](monster_dir/universalMonsterRules#_fear-(su-or-sp)) effects for the duration. A faerie dragon can use this breath weapon once every 1d4 rounds. The save DC is Constitution-based.

...
**Special Attacks** [pounce](monsters/universalMonsterRules#_pounce), [rake](monster_dir/universalMonsterRules#_rake) (2 claws +20, 2d6+8), roar

**Spells Prepared** (CL 6th; concentration +9)

3rd—_ [bestow curse](spells/bestowCurse#_bestow-curse)_ (DC 16), _ [searing light](spell_dir/searingLight#_searing-light)_, _ [speak with dead](spells/speakWithDead#_speak-with-dead)_

2nd—_ [bull's strength](spell_dir/bullSStrength#_bull-s-strength)_, _ [calm emotions](spells/calmEmotions#_calm-emotions)_ (DC 15), _ [cure moderate wounds](spell_dir/cureModerateWounds#_cure-moderate-wounds)_, _ [resist energy](spells/resistEnergy#_resist-energy)_

1st—_ [comprehend languages](spell_dir/comprehendLanguages#_comprehend-languages)_, _ [divine favor](spells/divineFavor#_divine-favor)_, _ [remove fear](spell_dir/removeFear#_remove-fear)_, _ [shield of faith](spells/shieldOfFaith#_shield-of-faith)_

0—_ [detect magic](spell_dir/detectMagic#_detect-magic)_, _ [guidance](spells/guidance#_guidance)_, _ [purify food and drink](spell_dir/purifyFoodAndDrink#_purify-food-and-drink)_, _ [stabilize](spells/stabilize#_stabilize)_
...
**Feats** [Alertness](feats#_alertness), Cleave, [Flyby Attack](monster_dir/monsterFeats#_flyby-attack), Great Cleave, [Hover](monsters/monsterFeats#_hover), [Improved Critical](feats#_improved-critical) (claw), [Power Attack](feats#_power-attack)

**Skills** [Fly](skill_dir/fly#_fly) +5, [Intimidate](skills/intimidate#_intimidate) +13, [Knowledge](skill_dir/knowledge#_knowledge) (any one) +16, [Perception](skills/perception#_perception) +23, [Sense Motive](skill_dir/senseMotive#_sense-motive) +13, [Survival](skills/survival#_survival) +16
...
**Skills** [Bluff](skill_dir/bluff#_bluff) +10, [Fly](skills/fly#_fly) +1, [Intimidate](skill_dir/intimidate#_intimidate) +16, [Perception](skills/perception#_perception) +10
...
**Feats** Cleave, [Flyby Attack](monster_dir/monsterFeats#_flyby-attack), [Power Attack](feats#_power-attack), [Skill Focus](feats#_skill-focus) ( [Perception](skills/perception#_perception))

**Skills** [Fly](skill_dir/fly#_fly) +3, [Perception](skills/perception#_perception) +16; **Racial Modifiers** +4 [Perception](skill_dir/perception#_perception)

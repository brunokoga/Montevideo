...
**Requirements** [Craft Construct](monsters/monsterFeats#_craft-construct), _ [animate objects](spell_dir/animateObjects#_animate-objects)_, _ [permanency](spells/permanency#_permanency)_; **Skill** [Spellcraft](skill_dir/spellcraft#_spellcraft) or appropriate [Craft](skills/craft#_craft) skill; **Cost** 1/2 price

## New Animated Object Abilities

The following are new abilities that can be applied to animated objects, whether created by the _ [animate objects](spell_dir/animateObjects#_animate-objects)_ spell or with the [Craft Construct](monsters/monsterFeats#_craft-construct) feat. Adding to these abilities requires the expenditure of Construction Points (CP), as described in [the Animated Object description](monster_dir/animatedObject#_animated-object).
...
New constructs should stick fairly close to the [Monster Statistics by CR table](monsters/monsterCreation#_table-1-1-monster-statistics-by-cr). As they are usually mindless combat brutes, most use the “high attack” column, with damage falling in between the High and Low average damage columns. Note that all the construct's saving throws are likely to be poor, and they have no favored saves. Lacking a Constitution score, a construct's hit points also tend to be low in comparison to creatures with similar CRs. Consider giving any construct that doesn't have either damage reduction or hardness a higher AC to compensate.
...
| [Iron cobra](monsters/ironCobra#_iron-cobra) | 2 | — | 4,000 gp | 2,000 gp | Find target, poison |
| [Darkwood cobra](monster_dir/ironCobra#_darkwood-cobra) | 2 | — | 5,000 gp | 2,500 gp | Find target, poison |
| [Soulbound doll](additionalMonsters/soulboundDoll#_soulbound-doll) | 2 | 300 gp | 4,300 gp | 2,300 gp | DR, variable, susceptible to mind-affecting effects |
...
| [Adamantine cobra](monsters/ironCobra#_adamantine-cobra) | 3 | — | 20,000 gp | 10,000 gp | High DR, find target, poison |
| [Necrophidius](additionalMonster_dir/necrophidius#_necrophidius) | 3 | 1,000 gp | 7,500 gp | 4,425 gp | DR, dance of death, paralysis |
| [Carrion golem](additionalMonsters/golem#_golem,-carrion) | 4 | 500 gp | 10,500 gp | 5,500 gp | DR/bludgeoning or slashing, stench |
...
| [Ice golem](monsters/golem#_golem-ice) | 5 | 500 gp | 18,500 gp | 9,500 gp | Cold, golem, icy destruction |
...
| [Flesh golem](monsters/golem#_golem-flesh) | 7 | 500 gp | 20,500 gp | 10,500 gp | Berserk, golem |
...
| [Stained glass golem](additionalMonsters/golem#_stained-glass-golems-(+0-cr)) | 8 | 1,000 gp | 39,400 gp | 20,200 gp | DR, golem, deflect spells, dazzling brightness |
...
| [Clay golem](monsters/golem#_golem-clay) | 10 | 1,500 g | 41,500 gp | 21,500 gp | Special DR, golem, berserk, cursed wounds |
...
| [Clockwork golem](additionalMonsters/golem#_golem,-clockwork) | 12 | 10,000 gp | 120,000 gp | 65,000 gp | High DR, golem, death burst, grind, wall of gears |
| [Iron golem](monster_dir/golem#_golem-iron) | 13 | 10,000 gp | 150,000 gp | 80,000 gp | High DR, golem, breath weapon |
| [Mithral golem](additionalMonsters/golem#_golem,-mithral) | 16 | 50,000 gp | 250,000 gp | 150,000 gp | High DR, golem, fluid form |
...
**Requirements** : [Craft Construct](monster_dir/monsterFeats#_craft-construct), _ [regenerate](spells/regenerate#_regenerate)_
...
**Requirements** : [Craft Construct](monster_dir/monsterFeats#_craft-construct), [Craft Magic Arms and Armor](feats#_craft-magic-arms-and-armor), _ [animate objects](spells/animateObjects#_animate-objects)_, the construct modified must be the same size as the creator
...
**Requirements** : [Craft Construct](monster_dir/monsterFeats#_craft-construct), _ [scrying](spells/scrying#_scrying)_

**CR Increase** : none

**Cost** : 8,000 gp

The crafter gives her construct crystalline eyes that permit her to use a _ [scrying](spell_dir/scrying#_scrying)_ or _ [greater scrying](spells/scrying#_scrying-greater)_ spell to see from the perspective of her creation. This modification requires the crafter also to prepare a special crystalline orb magically bonded to the eyes, which serves as her focus for the _ [scrying](spell_dir/scrying#_scrying)_ or _ [greater scrying](spells/scrying#_scrying-greater)_ spell. The cost of creating that focus is included in the cost of modifying the construct.

Unlike normal _ [scrying](spell_dir/scrying#_scrying)_ or_ [greater scrying](spells/scrying#_scrying-greater)_, there is no chance of failure for viewing creatures though the sensor; the creator simply sees what the construct sees for the duration of the spell. Spells cast through the sensor still have the normal chance of operating through the construct's eyes.

Construct Limb

**Requirements** : [Craft Construct](monster_dir/monsterFeats#_craft-construct), [Craft Magic Arms and Armor](feats#_craft-magic-arms-and-armor), _ [animate objects](spells/animateObjects#_animate-objects)_, Small or Tiny construct
...
This subcategory of complex modification allows a construct's creator to carve a runic spell trigger into her creation. Choose one of the following runes. The cost of the rune and any prerequisites are detailed in the rune's description. Once per day, the first time the rune is triggered, its effect occurs. As an immediate action, the creator can attempt to delay the effect until the next time it is triggered. Doing so requires that the construct be within line of sight of the creator (or for the creator to be using _ [scrying](spells/scrying#_scrying)_ or _ [greater scrying](spell_dir/scrying#_scrying-greater) _through the crafter's eyes construct modification) and that the caster make a [Spellcraft](skills/spellcraft#_spellcraft) check equal to 10 + the caster level of the rune's effect.
...
**Requirements** _ [symbol of pain](spell_dir/symbolOfPain#_symbol-of-pain)_; **Cost** 18,000 gp
...
While a creature is trapped within the gem, the gem is vulnerable to critical hits; if an attacker confirms a critical hit, the construct takes damage and the gem is destroyed, releasing the entrapped creature into a space adjacent to the construct. The broken gem must then be replaced before the _rune of [imprisonment](spells/imprisonment#_imprisonment)_ can function again.

Modification

**Requirements** _ [trap the soul](spell_dir/trapTheSoul#_trap-the-soul)_, gem worth 20,000 gp to serve as the rune's focus; **Cost** 57,600 gp
...
**Requirements** _ [shocking grasp](spells/shockingGrasp#_shocking-grasp)_; **Cost** 2,000 gp
...
This rune is triggered the first time the modified construct is attacked with a melee attack, ranged attack, or _ [magic missile](spell_dir/magicMissile#_magic-missile)_. The construct gains a +4 shield bonus to its Armor Class for 3 minutes. This is a force effect and applies against incorporeal touch attacks.

Modification

**Requirements** _ [shield](spells/shield#_shield)_; **Cost** 1,200 gp
...
**Requirements** _ [fear](spell_dir/fear#_fear)_; **Cost** 11,200 gp

## Shatter Stash

**Requirements** : [Craft Construct](monsters/monsterFeats#_craft-construct), _ [shatter](spell_dir/shatter#_shatter)_, and variable (see below)
...
**Requirements** _ [fireball](spells/fireball#_fireball)_; **Cost** 1,200 gp
...
**Requirements** _ [fireball](spell_dir/fireball#_fireball)_; **Cost** 1,200 gp
...
**Requirements** _ [cone of cold](spells/coneOfCold#_cone-of-cold)_; **Cost** 1,000 gp
...
**Requirements** _ [lightning bolt](spell_dir/lightningBolt#_lightning-bolt)_; **Cost** 1,200 gp
...
**Requirements** _ [stinking cloud](spells/stinkingCloud#_stinking-cloud)_; **Cost** 2,000 gp

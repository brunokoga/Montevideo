---
layout: default
title: ultimateMagi_dir/magic/newFamiliars
---
# New Familiars

The following are statistics for several new animals that can serve as familiars, in addition to a number of familiars [for the Witch Class](advance_dir/baseClasses/witch#_witch's-familiar). These familiars can be taken by anyone gaining a familiar, and utilize all the standard rules for familiars [for Wizard familiars](classe_dir/wizard#_familiars). Tiny or smaller familiars in this section use Dexterity to modify [Climb](skills/climb#_climb) and [Swim](skill_dir/swim#_swim) skill checks.
...
**Skills** [Escape Artist](skills/escapeArtist#_escape-artist) +15, [Stealth](skill_dir/stealth#_stealth) +25, [Swim](skills/swim#_swim) +13; **Racial Modifiers** +10 [Escape Artist](skill_dir/escapeArtist#_escape-artist), +8 [Stealth](skills/stealth#_stealth)
...
**Skills** [Perception](skill_dir/perception#_perception) +4, [Stealth](skills/stealth#_stealth) +15, [Swim](skill_dir/swim#_swim) +11
...
**Skills** [Acrobatics](skills/acrobatics#_acrobatics) +2 (+10 jumping), [Perception](skill_dir/perception#_perception) +8, [Stealth](skills/stealth#_stealth) +10, [Survival](skill_dir/survival#_survival) +1 (+5 scent tracking); **Racial Modifiers** +4 [Acrobatics](skills/acrobatics#_acrobatics) when jumping, +4 [Survival](skill_dir/survival#_survival) when tracking by scent
...
**Skills** [Acrobatics](skills/acrobatics#_acrobatics) +1 (+5 when jumping), [Climb](skill_dir/climb#_climb) +5, [Survival](skills/survival#_survival) +0   
(+4 to find food); **Racial Modifiers** +4 [Acrobatics](skill_dir/acrobatics#_acrobatics) when jumping, +4 [Survival](skills/survival#_survival) to find food
...
**Skills** [Climb](skill_dir/climb#_climb) +7, [Perception](skills/perception#_perception) +4, [Stealth](skill_dir/stealth#_stealth) +15; **Racial Modifiers** +4 [Climb](skills/climb#_climb), +4 [Perception](skill_dir/perception#_perception), +4 [Stealth](skills/stealth#_stealth)
...
**Skills** [Climb](skills/climb#_climb) +5, [Stealth](skill_dir/stealth#_stealth) +19, [Swim](skills/swim#_swim) +5
...
**Skills** [Climb](skill_dir/climb#_climb) +11, [Perception](skills/perception#_perception) +4, [Stealth](skill_dir/stealth#_stealth) +19; **Racial Modifiers** +4 [Perception](skills/perception#_perception), +8 [Stealth](skill_dir/stealth#_stealth)
...
**Skills** [Perception](skill_dir/perception#_perception) +4, [Swim](skills/swim#_swim) +10; **Racial Modifiers** +4 [Perception](skill_dir/perception#_perception)
...
**Skills** [Acrobatics](skill_dir/acrobatics#_acrobatics) +13, [Climb](skills/climb#_climb) +21, [Perception](skill_dir/perception#_perception) +4, [Stealth](skills/stealth#_stealth) +17; **Racial Modifiers** +8 [Acrobatics](skill_dir/acrobatics#_acrobatics), +8 [Climb](skills/climb#_climb), +4 [Perception](skill_dir/perception#_perception), +4 [Stealth](skills/stealth#_stealth)
...
**Skills** [Fly](skill_dir/fly#_fly) +12, [Perception](skills/perception#_perception) +5
...
**Skills** [Perception](skills/perception#_perception) +4, [Swim](skill_dir/swim#_swim) +10

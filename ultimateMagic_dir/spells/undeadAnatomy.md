---
layout: default
title: ultimateMagi_dir/spells/undeadAnatomy
---
Undead Anatomy I
...
In this form, you detect as an undead creature (such as with _ [detect undead](spell_dir/detectUndead#_detect-undead)_, but not with magic that reveals your true form, such as _ [true seeing](spells/trueSeeing#_true-seeing)_) and are treated as undead for the purposes of channeled energy, _cure_ spells, and _inflict_ spells, but not for other effects that specifically target or react differently to undead (such as _ [searing light](spell_dir/searingLight#_searing-light)_).

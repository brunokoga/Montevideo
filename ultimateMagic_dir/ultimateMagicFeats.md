---
title: ultimateMagic/ultimateMagicFeats
---
# Feats
...
| Accursed Critical | [Critical Focus](feats.md#_critical-focus), ability to cast _ [bestow curse](spells/bestowCurse.md#_bestow-curse)_ or _ [major curse](ultimateMagic/spells/curse.md#_curse,-major)_, caster level 9th | Confirm a critical hit and cast a curse as part of the attack |
| Accursed Hex | Hex class feature | Target a creature with a hex a second time that day if it made its save the first time |
| Advanced Ranger Trap | Trap class feature, ranger level 5th | Add +1 to the [Disable Device](skills/disableDevice.md#_disable-device) and [Perception](skills/perception.md#_perception) check DCs for your ranger traps |
| Antagonize | — | Use [Diplomacy](skills/diplomacy.md#_diplomacy) or [Intimidate](skills/intimidate.md#_intimidate) to goad creatures |
...
| Greater Blighted Critical | [Blighted Critical](ultimateMagic/ultimateMagicFeats.md#_blighted-critical-), caster level 12th | Confirm a critical hit with a spell or spell-like ability to inflict a random major spellblight |
...
| Create Reliquary Arms and Shields | [Craft Magic Arms and Armor](feats.md#_craft-magic-arms-and-armor), ability to cast _ [hallow](spells/hallow.md#_hallow)_ or _ [unhallow](spells/unhallow.md#_unhallow)_ | Make your shield or weapon a holy symbol |
| Create Sanguine Elixir | Cha 15, [Brew Potion](feats.md#_brew-potion), [Craft](skills/craft.md#_craft) (alchemy) 12 ranks, sorcerer level 3rd | Create an elixir that allows another to use a bloodline power |
| Defending Eidolon | Shield ally class feature | Your eidolon sacrifices its attacks to defend you |
| Deny Death | _Ki_ pool, [Endurance](feats.md#_endurance) | Use _ki _to stave off death |
| Detect Expertise | Int 13; ability to cast _ [detect chaos](spells/detectChaos.md#_detect-chaos)_, _ [detect evil](spells/detectEvil.md#_detect-evil)_, _ [detect good](spells/detectGood.md#_detect-good)_, _ [detect law](spells/detectLaw.md#_detect-law)_, or _ [detect magic](spells/detectMagic.md#_detect-magic)_ | Detect a creature's magical abilities |
...
| Eldritch Heritage | Cha 13, [Skill Focus](feats.md#_skill-focus) in bloodline skill, character level 3rd | Gain a bloodline power |
...
| Extra Summons | Ability to cast [_summon monster_](advanced/baseClasses/summoner.md#_summon-monster-i) as a spell-like ability, summoner level 1st | Gain 1 extra use of _summon monster_ per day |
...
| Fast Empathy | [Handle Animal](skills/handleAnimal.md#_handle-animal) 5 ranks, wild empathy class feature | Use wild empathy as a standard action |
...
| Fire Music | [Spellcraft](skills/spellcraft.md#_spellcraft) 5 ranks, ability to cast bard spells, ability to cast at least one arcane fire spell from another class | Replace bard spell damage with fire damage, summoned monsters gain fire attacks |
| Focused Eidolon | Shield ally class feature | Gain +4 on concentration checks while adjacent to your eidolon |
| Gliding Steps | [Dodge](feats.md#_dodge), [Mobility](feats.md#_mobility), [Nimble Moves](feats.md#_nimble-moves), _ki_ pool | Use _ki_ to provoke fewer attacks of opportunities while moving |
...
| Greater Wild Empathy | [Knowledge](skills/knowledge.md#_knowledge) (nature) 5 ranks, wild empathy class feature | Use wild empathy to intimidate and expand the creatures it can affect |
| Implant Bomb | [Heal](skills/heal.md#_heal) 5 ranks, delayed bomb alchemist discovery | Implant a bomb in a willing or helpless creature |
| Improved Monster Lore | Monster lore class feature | Gain a sacred bonus on monster lore checks |
| Insightful Gaze | Stern gaze class feature, [Sense Motive](skills/senseMotive.md#_sense-motive) 5 ranks | When using [Sense Motive](skills/senseMotive.md#_sense-motive), roll twice and take the higher roll |
| Intimidating Gaze | Stern gaze class feature, [Intimidate](skills/intimidate.md#_intimidate) 5 ranks | When using [Intimidate](skills/intimidate.md#_intimidate), roll twice and take the higher roll |
...
| Learn Ranger Trap | [Survival](skills/survival.md#_survival) 5 ranks | Learn a single ranger trap |
| Life Lure | Channel positive energy class feature | Channel positive energy to fascinate undead |
| Moonlight Summons | [Spell Focus](feats.md#_spell-focus) (conjuration), ability to cast [_summon nature's ally_](spells/summonNatureSAlly.md) | Summoned creatures are immune to confusion and sleep effects, and their natural weapons are treated as silver |
| Mystic Stride | Dex 15, [Nimble Moves](feats.md#_nimble-moves), woodland stride class feature | Move at full speed even through magically enhanced foliage |
| Oracular Intuition | Mystery class feature | Gain bonuses to [Sense Motive](skills/senseMotive.md#_sense-motive) and [Spellcraft](skills/spellcraft.md#_spellcraft) to identify magic item properties |
...
| Prodigy | — | Gain a +2 bonus on two [Craft](skills/craft.md#_craft), [Perform](skills/perform.md#_perform), or [Profession](skills/profession.md#_profession) skills |
...
| Quarterstaff Master\* | [Weapon Focus](feats.md#_weapon-focus) (quarterstaff), base attack bonus +5 | Use a quarterstaff one-handed |
| Tripping Staff\* | Int 13, [Combat Expertise](feats.md#_combat-expertise), [Improved Trip](feats.md#_improved-trip), [Weapon Focus](feats.md#_weapon-focus) (quarterstaff), base attack bonus +6 | Treat a quarterstaff as if it had the trip weapon special feature |
| Tripping Twirl\* | Int 13, [Combat Expertise](feats.md#_combat-expertise), [Improved Trip](feats.md#_improved-trip), Tripping Staff, [Weapon Focus](feats.md#_weapon-focus) (quarterstaff), Weapons Specialization (quarterstaff), base attack bonus +12 | Use a quarterstaff to make a trip attempt against all adjacent enemies |
| Quick Channel | [Knowledge](skills/knowledge.md#_knowledge) (religion) 5 ranks, channel energy class feature | Channel energy faster by expending more uses |
...
| Ricochet Splash Weapon | Dex 13, [Throw Anything](feats.md#_throw-anything) | Make an attack roll with a splash weapon if it misses and lands in another creature's square |
| Sacred Summons | Aura class feature, ability to cast [_summon monster_](advanced/baseClasses/summoner.md#_summon-monster-i) | Summon monsters whose alignment subtype matches yours as a standard action |
| Sense Link | Bond senses class feature | Gain a +4 bonus on [Perception](skills/perception.md#_perception) checks when sharing your eidolon's senses |
| Shaping Focus | [Knowledge](skills/knowledge.md#_knowledge) (nature) 5 ranks, wild shape class feature | Count other class levels as druid levels for the purpose of wild shape |
| Sin Seer | Detect undead class feature | Gain the ability to detect evil |
| Skeleton Summoner | [Spell Focus](feats.md#_spell-focus) (necromancy), ability to cast [_summon monster_](advanced/baseClasses/summoner.md#_summon-monster-i) | Summon skeletons instead of living creatures with _summon monster_ |
...
| [Spell Bluff](ultimateMagic/ultimateMagicFeats.md#_spell-bluff) | [Bluff](skills/bluff.md#_bluff) 5 ranks, [Spellcraft](skills/spellcraft.md#_spellcraft) 5 ranks | [Bluff](skills/bluff.md#_bluff) other spellcasters, increasing the DC needed to identify your spell |
| Spell Hex | Major hex class feature | Cast a 1st-level spell as a hex |
| Spell Specialization | Int 13, [Spell Focus](feats.md#_spell-focus) | Pick one spell and cast it as if you were higher level |
| Greater Spell Specialization | Int 13, [Spell Focus](feats.md#_spell-focus), Spell Specialization, ability to cast 5th-level spells | Sacrifice a spell to cast your specialized spell |
...
| Starlight Summons | [Spell Focus](feats.md#_spell-focus) (conjuration), ability to cast [_summon nature's ally_](spells/summonNatureSAlly.md) | Summoned creatures gain a bonus on [Perception](skills/perception.md#_perception) and [Stealth](skills/stealth.md#_stealth) checks |
| Sunlight Summons | [Spell Focus](feats.md#_spell-focus) (conjuration), ability to cast [_summon nature's ally_](spells/summonNatureSAlly.md) | Summoned creatures glow and are immune to blinding and dazzling effects |
| Superior Summoning | [Augment Summoning](feats.md#_augment-summoning), caster level 3rd | When summoning more than one creature, summon an extra one |
...
| Thoughtful Discernment | _ [Discern lies](spells/discernLies.md#_discern-lies)_ class feature | Detect lies in a statement you heard, even hours after it has been uttered |
| Ultimate Resolve | Aura of resolve class feature | Aura of resolve expands and does not fall when you do |
| [Uncanny Alertness](ultimateMagic/ultimateMagicFeats.md#_uncanny-alertness) | [Alertness](feats.md#_alertness) | +1 on [Perception](skills/perception.md#_perception) and [Sense Motive](skills/senseMotive.md#_sense-motive) checks and a +2 bonus on saving throws against sleep and charm effects |
| Uncanny Concentration | [Combat Casting](feats.md#_combat-casting) | Don't make concentration checks for violent movement, gain a +2 bonus on all other concentration checks |
| Undead Master | Spell focus (necromancy), ability to cast _ [animate dead](spells/animateDead.md#_animate-dead)_ or _ [command undead](spells/commandUndead.md#_command-undead)_ | Animate and command more undead |
| Unsanctioned Detection | _ [Detect evil](spells/detectEvil.md#_detect-evil)_ class feature | Use _ [detect evil](spells/detectEvil.md#_detect-evil)_ to gain bonuses on [Perception](skills/perception.md#_perception) and [Sense Motive](skills/senseMotive.md#_sense-motive) checks |
| [Unsanctioned](ultimateMagic/ultimateMagicFeats.md#_unsanctioned-knowledge) [Knowledge](skills/knowledge.md#_knowledge) | Int 13, must be able to cast 1st-level paladin spells | Add spells to your paladin spell list |
...
| Vigilant Eidolon | Eidolon class feature | +4 bonus on [Perception](skills/perception.md#_perception) checks when your eidolon is within arm's reach, conscious, and not helpless |
| Voice of the Sibyl | Cha 15 | Gain bonus to [Bluff](skills/bluff.md#_bluff), [Diplomacy](skills/diplomacy.md#_diplomacy), and [Perform](skills/perform.md#_perform) (oratory) checks |
...
| Thanatopic Spell | [Knowledge](skills/knowledge.md#_knowledge) (religion) 6 ranks, [Spell Focus](feats.md#_spell-focus) (necromancy) | Affected spell's death effects, energy drain, and negative levels affect undead |
| Threnodic Spell | [Knowledge](skills/knowledge.md#_knowledge) (religion) 6 ranks, [Spell Focus](feats.md#_spell-focus) (necromancy) | Change a mind-affecting spell so it can affect undead, but not living creatures |
| Toppling Spell | — | Spell with the sonic descriptor knocks targets prone |
| Teamwork Feats | Prerequisites | Benefits |
| --- | --- | --- |
| Ensemble | [Perform](skills/perform.md#_perform) 5 ranks | Nearby performers can aid your perform checks |
...
**Prerequisites:** [Critical Focus](feats.md#_critical-focus), ability to cast _ [bestow curse](spells/bestowCurse.md#_bestow-curse)_ or _ [major curse](ultimateMagic/spells/curse.md#_curse,-major)_, caster level 9th.

**Benefit:** When you confirm a critical hit with a spell or spell-like ability, you may cast _ [bestow curse](spells/bestowCurse.md#_bestow-curse) _or _ [major curse](ultimateMagic/spells/curse.md#_curse,-major)_ on that target as an immediate action. This works even with ranged spells. You must have _ [bestow curse](spells/bestowCurse.md#_bestow-curse) _or _ [major curse](ultimateMagic/spells/curse.md#_curse,-major) _prepared or otherwise available to cast, and using this ability casts the corresponding spell.
...
**Benefit:** Add +1 to the Difficulty Class on all [Perception](skills/perception.md#_perception) and [Disable Device](skills/disableDevice.md#_disable-device) skill checks to find or disable the traps you make with your trap class feature. Add a +1 to the Difficulty Class on all saving throws against the effects of the trap you make with your trap class feature.

## Antagonize

Whether with biting remarks or hurtful words, you are adept at making creatures angry with you.

**Benefit:** You can make [Diplomacy](skills/diplomacy.md#_diplomacy) and [Intimidate](skills/intimidate.md#_intimidate) checks to make creatures respond to you with hostility. No matter which skill you use, antagonizing a creature takes a standard action that does not provoke attacks of opportunity, and has a DC equal to 10+ the target's Hit Dice + the target's Wisdom modifier. You cannot make this check against a creature that does not understand you or has an Intelligence score of 3 or lower. Before you make these checks, you may make a [Sense Motive](skills/senseMotive.md#_sense-motive) check (DC 20) as a swift action to gain an insight bonus on these [Diplomacy](skills/diplomacy.md#_diplomacy) or Intimitade checks equal to your Charisma bonus until the end of your next turn. The benefits you gain for this check depend on the skill you use. This is a mind-affecting effect.

_ [Diplomacy](skills/diplomacy.md#_diplomacy)_: You fluster your enemy. For the next minute, the target takes a –2 penalty on all attacks rolls made against creatures other than you and has a 10% spell failure chance on all spells that do not target you or that have you within their area of effect.

_ [Intimidate](skills/intimidate.md#_intimidate)_: The creature flies into a rage. On its next turn, the target must attempt to make a melee attack against you, make a ranged attack against you, target you with a spell, or include you in the area of a spell. The effect ends if the creature is prevented from attacking you or attempting to do so would harm it (for example, if you are on the other side of a chasm or a _ [wall of fire](spells/wallOfFire.md#_wall-of-fire)_). If it cannot attack you on its turn, you may make the check again as an immediate action to extend the effect for 1 round (but cannot extend it thereafter). The effect ends as soon as the creature attacks you. Once you have targeted a creature with this ability, you cannot target it again for 1 day.
...
**Special:** You can apply the effects of only one critical feat to a given critical hit unless you possess [Critical Mastery](feats.md#_critical-mastery).

## Blighted [Critical Mastery](feats.md#_critical-mastery)

You control the type of spellblight your critical hits give your opponent.

**Prerequisites:** [Blighted Critical](ultimateMagic/ultimateMagicFeats.md#_blighted-critical-), caster level 9th.

**Benefit:** Whenever you apply a spellblight by way of the [Blighted Critical](ultimateMagic/ultimateMagicFeats.md#_blighted-critical-) or Greater Blighted critical feat, you can choose the spellblight you apply rather than determining it randomly.
...
**Prerequisites:** [Craft Magic Arms and Armor](feats.md#_craft-magic-arms-and-armor), ability to cast _ [consecrate](spells/consecrate.md#_consecrate) _or _ [desecrate](spells/desecrate.md#_desecrate)_.

**Benefit:** When you craft a magic weapon, magic armor, or magic shield, you may add one casting of _ [consecrate](spells/consecrate.md#_consecrate) _or _ [desecrate](spells/desecrate.md#_desecrate) _as part of the item crafting process. This increases the item's price by 250 gp. The item becomes a reliquary and can be used as a holy (or unholy) symbol divine focus of your deity. If you cast _ [consecrate](spells/consecrate.md#_consecrate)_ or _ [desecrate](spells/desecrate.md#_desecrate)_, your reliquary counts as a permanent fixture for that spell while it remains in the spell's area.

## Create Sanguine Elixir

You can condense a fraction of your bloodline's power into a powerful elixir.

**Prerequisites:** Cha 15, [Brew Potion](feats.md#_brew-potion), [Craft](skills/craft.md#_craft) (alchemy) 12 ranks, sorcerer level 3rd.
...
**Prerequisite:** _Ki_ pool, [Endurance](feats.md#_endurance)
...
**Prerequisites:** Int 13; ability to cast _ [detect chaos](spells/detectChaos.md#_detect-chaos)_, _ [detect evil](spells/detectEvil.md#_detect-evil)_, _ [detect good](spells/detectGood.md#_detect-good)_, _ [detect law](spells/detectLaw.md#_detect-law)_, or _ [detect magic](spells/detectMagic.md#_detect-magic)._
...
**Benefit:** Once per day, when you successfully identify all abilities and weaknesses of a creature using the appropriate [Knowledge](skills/knowledge.md#_knowledge) check, you gain a +2 bonus on attack and damage rolls against that creature for 1 minute. If you identify the abilities and weaknesses of numerous creatures, you must pick one creature to be the target of this effect.
...
**Prerequisites:** [Handle Animal](skills/handleAnimal.md#_handle-animal) 5 ranks, wild empathy class feature.
...
**Prerequisites:** [Spellcraft](skills/spellcraft.md#_spellcraft) 5 ranks, ability to cast bard spells, ability to cast an arcane fire spell from some other spellcasting class.
...
**Prerequisites:** [Dodge](feats.md#_dodge), [Mobility](feats.md#_mobility), [Nimble Moves](feats.md#_nimble-moves), _ki_ pool.
...
**Prerequisites:** Int 13, [Spell Focus](feats.md#_spell-focus), Spell Specialization, able to prepare 5th-level spells.
...
**Prerequisites:** [Knowledge](skills/knowledge.md#_knowledge) (nature) 5 ranks, wild empathy class feature.

**Benefit:** You gain a +2 insight bonus on wild empathy checks, and you may use wild empathy to duplicate an [Intimidate](skills/intimidate.md#_intimidate) check rather than a [Diplomacy](skills/diplomacy.md#_diplomacy) check. In addition, choose one of the following kinds of creatures: elementals, fey, lycanthropes, plants, or vermin. You may influence creatures of that type with wild empathy, if their Intelligence score is 1 or 2, or they do not possess an Intelligence score. Once you choose the type of creature, it cannot be changed.
...
**Prerequisites:** [Heal](skills/heal.md#_heal) 5 ranks, delayed bomb alchemist discovery.
...
**Prerequisites:** Stern gaze class feature, [Sense Motive](skills/senseMotive.md#_sense-motive) 5 ranks.

**Benefit:** Whenever you make a Sense Motive check to oppose someone's [Bluff](skills/bluff.md#_bluff) check, you can roll two dice and take the higher result.

## Intimidating Gaze

There is something in your eyes that scares people.

**Prerequisites:** Cha 13+, stern gaze class feature, [Intimidate](skills/intimidate.md#_intimidate) 5 ranks.
...
**Prerequisites:** [Survival](skills/survival.md#_survival) 5 ranks.
...
**Prerequisites:** [Spell Focus](feats.md#_spell-focus) (conjuration), able to cast _summon nature's ally_.

**Benefit:** Creatures you summon shed light as a _ [light](spells/light.md#_light)_ spell. They are immune to confusion and sleep effects, and their natural weapons are treated as silver for the purposes of overcoming damage reduction.

## Mystic Stride

Enchanted vegetation does not bar your path.

**Prerequisites:** Dex 15, [Nimble Moves](feats.md#_nimble-moves), woodland stride class feature.
...
**Benefit:** You get a +2 bonus on [Sense Motive](skills/senseMotive.md#_sense-motive) checks and [Spellcraft](skills/spellcraft.md#_spellcraft) checks. If you have 10 or more ranks in one of these skills, the bonus increases to +4 for that skill.
...
**Benefit:** When an evil outsider uses a calling, summoning, or teleportation effect, or any ability that physically transports a creature to or from another plane (such as _ [blink](spells/blink.md#_blink)_ or _ [etherealness](magicItems/armor.md#_armor-etherealness)_) within your anchoring aura, it takes damage equal to 4d8 + your Charisma modifier. This damage comes from holy power and is not subject to damage reduction, energy immunities, or energy resistances.
...
**Benefit:** For every [_summon nature's ally_](spells/summonNatureSAlly.md#_table-10-2-summon-nature-s-ally) extract you know, you learn the equivalent [_summon monster_](spells/summonMonster.md#_summon-monster-i) spell as an extract. If you later learn other summon nature's ally extracts, you automatically learn the equivalent summon monster spell as an extract.
...
**Prerequisites:** [Weapon Focus](feats.md#_weapon-focus) (quarterstaff), base attack bonus +5.

**Benefit:** By employing a number of different stances and techniques, you can wield a quarterstaff as a one-handed weapon. At the start of your turn, you decide whether or not you are going to wield the quarterstaff as a one-handed or two-handed weapon. When you wield it as a one-handed weapon, your other hand is free, and you cannot use the staff as a double weapon. You can take the feat [Weapon Specialization](feats.md#_weapon-specialization) in the quarterstaff even if you have no levels in fighter.

## Quick Channel

Your divine energies flash with dazzling speed.

**Prerequisites:** [Knowledge](skills/knowledge.md#_knowledge) (religion) 5 ranks, channel energy class feature.
...
**Prerequisites:** Dex 13, [Throw Anything](feats.md#_throw-anything).
...
**Prerequisites:** Aura class feature, ability to cast [_summon monster_](spells/summonMonster.md#_summon-monster-i).
...
**Benefit:** When sharing the senses of your eidolon, you gain a +4 competence bonus on [Perception](skills/perception.md#_perception) checks for the duration of your bond senses ability.

## Shaping Focus

Your powers of shapeshifting outstrip your dabbling in the druidic faith.

**Prerequisites:** Wild shape class feature, [Knowledge](skills/knowledge.md#_knowledge) (nature) 5 ranks.
...
**Benefit:** You gain the _ [detect evil](spells/detectEvil.md#_detect-evil)_ class feature. You may use it or the _ [detect undead](spells/detectUndead.md#_detect-undead)_ class feature, but not at the same time.

## Skeleton Summoner

The walking dead respond to your call.

**Prerequisites:** [Spell Focus](feats.md#_spell-focus) (necromancy), ability to cast _summon monster_.

**Benefit:** Add “human skeleton” to the list of creatures you can summon with _ [summon monster I](spells/summonMonster.md#_summon-monster-i)_ and “human skeletal champion” to the list of creatures you can summon with _ [summon monster III](spells/summonMonster.md#_summon-monster-iii)_.
...
**Prerequisites:** [Bluff](skills/bluff.md#_bluff) 5 ranks, [Spellcraft](skills/spellcraft.md#_spellcraft) 5 ranks.
...
**Prerequisites:** Int 13, [Spell Focus](feats.md#_spell-focus).
...
First, you can conceal the activity of casting a bard spell by masking it in a performance. As a swift action, you may combine your casting time of a spell with a [Perform](skills/perform.md#_perform) check. Observers must make a [Perception](skills/perception.md#_perception) or [Sense Motive](skills/senseMotive.md#_sense-motive) check opposed by your Perform check to realize you are also casting a spell. This uses 1 round of your bardic performance ability, regardless of the spell's casting time.
...
**Benefit:** Creatures you summon gain the [Blind-Fight](feats.md#_blind-fight) feat, a +5 bonus to [Perception](skills/perception.md#_perception) and [Stealth](skills/stealth.md#_stealth) checks in dim light or darkness, and their natural weapons are treated as cold iron for overcoming damage reduction.
...
**Benefit:** Creatures that you summon shed light as a _ [light](spells/light.md#_light)_ spell. They are immune to blinding or dazzling effects, and their natural weapons are treated as magical for overcoming damage reduction.

## Superior Summoning

You can summon more creatures.

**Prerequisites:** [Augment Summoning](feats.md#_augment-summoning), caster level 3rd.
...
**Prerequisites:** [Knowledge](skills/knowledge.md#_knowledge) (religion) 6 ranks, [Spell Focus](feats.md#_spell-focus) (necromancy).
...
For example, you could cast a thanatopic _ [vampiric touch](spells/vampiricTouch.md#_vampiric-touch)_ or _ [enervation](spells/enervation.md#_enervation)_ spell on a target under the effects of _ [death ward](spells/deathWard.md#_death-ward)_, and the target would suffer the normal effect of the spell. Saving throws and SR (if any) still apply.
...
**Normal:** Defenses such as _ [death ward](spells/deathWard.md#_death-ward)_ negate death effects, negative levels, and energy drain. Undead are immune to these attacks.
...
**Benefit:** Once per day as a free action, you can think back about a single statement you heard in the last day and determine if it was a lie. This acts like the _ [discern lies](spells/discernLies.md#_discern-lies)_ spell, but instead of affecting a creature, it affects a single statement a creature has made.
...
**Prerequisites:** Int 13, [Combat Expertise](feats.md#_combat-expertise), [Improved Trip](feats.md#_improved-trip), [Weapon Focus](feats.md#_weapon-focus) (quarterstaff), base attack bonus +6.
...
**Prerequisites:** Int 13, [Combat Expertise](feats.md#_combat-expertise), [Improved Trip](feats.md#_improved-trip), [Tripping Staff](ultimateMagic/ultimateMagicFeats.md#_tripping-staff), [Weapon Focus](feats.md#_weapon-focus) (quarterstaff), [Weapon Specialization](feats.md#_weapon-specialization) (quarterstaff), base attack bonus +12.
...
**Benefit:** You can expend 10 uses of lay on hands to bring a single dead creature you touch back to life as a _ [raise dead](spells/raiseDead.md#_raise-dead)_ spell with a caster level equal to your paladin level. You must provide the material component for _ [raise dead](spells/raiseDead.md#_raise-dead)_ or choose to accept 1 temporary negative level; this level automatically goes away after 24 hours, never becomes a permanent negative level, and cannot be overcome in any way except by waiting for the duration to expire.
...
**Benefit:** This feat gives you an additional +1 bonus on [Perception](skills/perception.md#_perception) and [Sense Motive](skills/senseMotive.md#_sense-motive) checks, and you gain a +2 bonus on saving throws against sleep and charm effects.
...
**Prerequisite:** [Combat Casting](feats.md#_combat-casting).
...
**Prerequisites:** Spell focus (necromancy), the ability to cast _ [animate dead](spells/animateDead.md#_animate-dead)_ or _ [command undead](spells/commandUndead.md#_command-undead)_.

**Benefit:** When you cast _animate dead_ or use the [Command Undead](feats.md#_command-undead) feat, you are considered to be four levels higher when determining the number of Hit Dice you animate. When you cast _command undead_, your duration is doubled.

## Unsanctioned Detection

You can focus your ability to detect evil for more practical or mundane purposes

**Prerequisite:** _ [Detect evil](spells/detectEvil.md#_detect-evil)_ class feature.

**Benefit:** As a swift action, you can focus the clarity granted by your _detect evil_ ability to heighten your awareness of other things. This gives you a +10 sacred bonus on [Perception](skills/perception.md#_perception) and [Sense Motive](skills/senseMotive.md#_sense-motive) checks for one round. This expends your use of the _detect evil_ class ability for the next 24 hours.
...
Having this feat means you qualify for feats and abilities that have “channel positive energy” or “channel negative energy” as a prerequisite (for example, you qualify for the [Command Undead](feats.md#_command-undead) feat and the [Turn Undead](feats.md#_turn-undead) feat).
...
**Benefit:** While your eidolon is within your reach, you gain a +4 bonus on [Perception](skills/perception.md#_perception) checks. If you have 10 or more ranks in Perception, this bonus increases to +8. This does not apply if your eidolon is helpless or unconscious.
...
**Benefit:** You get a +1 bonus on all [Bluff](skills/bluff.md#_bluff), [Diplomacy](skills/diplomacy.md#_diplomacy), and [Perform](skills/perform.md#_perform) (oratory) skill checks. If you have 10 or more ranks in one of these skills, the bonus increases to +3 for that skill. You do not get these bonuses if you do not use your voice when using the skill (such as using Bluff to feint in combat).
...
**Benefit:** When using wild shape to take the form in which you cannot speak (such as an animal), you are able to speak normally in any language you know. This allows you to cast spells with verbal components, speak command words, and activate spell completion and spell trigger items. However, it does not give you the ability to cast spells requiring somatic components unless you also have the [Natural Spell](feats.md#_natural-spell) feat, or cast spells with material components merged into your form.

When using wild shape to take the form of an animal, you may use _ [speak with animals](spells/speakWithAnimals.md#_speak-with-animals)_ to communicate with animals of your assumed form. This is a spell-like ability with a caster level equal to your druid level, and you may use it for a number of minutes per day equal to your druid level. These minutes do not have to be consecutive, but must be used in one-minute increments.

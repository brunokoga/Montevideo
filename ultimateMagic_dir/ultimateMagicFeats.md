...
| Accursed Critical | [Critical Focus](feats#_critical-focus), ability to cast _ [bestow curse](spells/bestowCurse#_bestow-curse)_ or _ [major curse](ultimateMagi_dir/spells/curse#_curse,-major)_, caster level 9th | Confirm a critical hit and cast a curse as part of the attack |
| Accursed Hex | Hex class feature | Target a creature with a hex a second time that day if it made its save the first time |
| Advanced Ranger Trap | Trap class feature, ranger level 5th | Add +1 to the [Disable Device](skill_dir/disableDevice#_disable-device) and [Perception](skills/perception#_perception) check DCs for your ranger traps |
| Antagonize | — | Use [Diplomacy](skill_dir/diplomacy#_diplomacy) or [Intimidate](skills/intimidate#_intimidate) to goad creatures |
...
| Create Reliquary Arms and Shields | [Craft Magic Arms and Armor](feats#_craft-magic-arms-and-armor), ability to cast _ [hallow](spells/hallow#_hallow)_ or _ [unhallow](spell_dir/unhallow#_unhallow)_ | Make your shield or weapon a holy symbol |
| Create Sanguine Elixir | Cha 15, [Brew Potion](feats#_brew-potion), [Craft](skills/craft#_craft) (alchemy) 12 ranks, sorcerer level 3rd | Create an elixir that allows another to use a bloodline power |
...
| Fast Empathy | [Handle Animal](skills/handleAnimal#_handle-animal) 5 ranks, wild empathy class feature | Use wild empathy as a standard action |
...
| Greater Wild Empathy | [Knowledge](skills/knowledge#_knowledge) (nature) 5 ranks, wild empathy class feature | Use wild empathy to intimidate and expand the creatures it can affect |
...
| Insightful Gaze | Stern gaze class feature, [Sense Motive](skills/senseMotive#_sense-motive) 5 ranks | When using [Sense Motive](skill_dir/senseMotive#_sense-motive), roll twice and take the higher roll |
| Intimidating Gaze | Stern gaze class feature, [Intimidate](skills/intimidate#_intimidate) 5 ranks | When using [Intimidate](skill_dir/intimidate#_intimidate), roll twice and take the higher roll |
...
| Learn Ranger Trap | [Survival](skills/survival#_survival) 5 ranks | Learn a single ranger trap |
...
| Oracular Intuition | Mystery class feature | Gain bonuses to [Sense Motive](skills/senseMotive#_sense-motive) and [Spellcraft](skill_dir/spellcraft#_spellcraft) to identify magic item properties |
...
| Prodigy | — | Gain a +2 bonus on two [Craft](skills/craft#_craft), [Perform](skill_dir/perform#_perform), or [Profession](skills/profession#_profession) skills |
...
| Sense Link | Bond senses class feature | Gain a +4 bonus on [Perception](skills/perception#_perception) checks when sharing your eidolon's senses |
...
| [Spell Bluff](ultimateMagic/ultimateMagicFeats#_spell-bluff) | [Bluff](skill_dir/bluff#_bluff) 5 ranks, [Spellcraft](skills/spellcraft#_spellcraft) 5 ranks | [Bluff](skill_dir/bluff#_bluff) other spellcasters, increasing the DC needed to identify your spell |
...
| Starlight Summons | [Spell Focus](feats#_spell-focus) (conjuration), ability to cast [_summon nature's ally_](spells/summonNatureSAlly) | Summoned creatures gain a bonus on [Perception](skill_dir/perception#_perception) and [Stealth](skills/stealth#_stealth) checks |
...
| Thoughtful Discernment | _ [Discern lies](spells/discernLies#_discern-lies)_ class feature | Detect lies in a statement you heard, even hours after it has been uttered |
| Ultimate Resolve | Aura of resolve class feature | Aura of resolve expands and does not fall when you do |
| [Uncanny Alertness](ultimateMagi_dir/ultimateMagicFeats#_uncanny-alertness) | [Alertness](feats#_alertness) | +1 on [Perception](skills/perception#_perception) and [Sense Motive](skill_dir/senseMotive#_sense-motive) checks and a +2 bonus on saving throws against sleep and charm effects |
...
| Undead Master | Spell focus (necromancy), ability to cast _ [animate dead](spells/animateDead#_animate-dead)_ or _ [command undead](spell_dir/commandUndead#_command-undead)_ | Animate and command more undead |
| Unsanctioned Detection | _ [Detect evil](spells/detectEvil#_detect-evil)_ class feature | Use _ [detect evil](spell_dir/detectEvil#_detect-evil)_ to gain bonuses on [Perception](skills/perception#_perception) and [Sense Motive](skill_dir/senseMotive#_sense-motive) checks |
| [Unsanctioned](ultimateMagic/ultimateMagicFeats#_unsanctioned-knowledge) [Knowledge](skill_dir/knowledge#_knowledge) | Int 13, must be able to cast 1st-level paladin spells | Add spells to your paladin spell list |
...
| Vigilant Eidolon | Eidolon class feature | +4 bonus on [Perception](skills/perception#_perception) checks when your eidolon is within arm's reach, conscious, and not helpless |
| Voice of the Sibyl | Cha 15 | Gain bonus to [Bluff](skill_dir/bluff#_bluff), [Diplomacy](skills/diplomacy#_diplomacy), and [Perform](skill_dir/perform#_perform) (oratory) checks |
...
| Thanatopic Spell | [Knowledge](skills/knowledge#_knowledge) (religion) 6 ranks, [Spell Focus](feats#_spell-focus) (necromancy) | Affected spell's death effects, energy drain, and negative levels affect undead |
...
| --- | --- | --- |
| Ensemble | [Perform](skills/perform#_perform) 5 ranks | Nearby performers can aid your perform checks |
...
**Prerequisites:** [Critical Focus](feats#_critical-focus), ability to cast _ [bestow curse](spell_dir/bestowCurse#_bestow-curse)_ or _ [major curse](ultimateMagic/spell_dir/curse#_curse,-major)_, caster level 9th.

**Benefit:** When you confirm a critical hit with a spell or spell-like ability, you may cast _ [bestow curse](spells/bestowCurse#_bestow-curse) _or _ [major curse](ultimateMagi_dir/spells/curse#_curse,-major)_ on that target as an immediate action. This works even with ranged spells. You must have _ [bestow curse](spell_dir/bestowCurse#_bestow-curse) _or _ [major curse](ultimateMagic/spell_dir/curse#_curse,-major) _prepared or otherwise available to cast, and using this ability casts the corresponding spell.
...
**Benefit:** You can make [Diplomacy](skills/diplomacy#_diplomacy) and [Intimidate](skill_dir/intimidate#_intimidate) checks to make creatures respond to you with hostility. No matter which skill you use, antagonizing a creature takes a standard action that does not provoke attacks of opportunity, and has a DC equal to 10+ the target's Hit Dice + the target's Wisdom modifier. You cannot make this check against a creature that does not understand you or has an Intelligence score of 3 or lower. Before you make these checks, you may make a [Sense Motive](skills/senseMotive#_sense-motive) check (DC 20) as a swift action to gain an insight bonus on these [Diplomacy](skill_dir/diplomacy#_diplomacy) or Intimitade checks equal to your Charisma bonus until the end of your next turn. The benefits you gain for this check depend on the skill you use. This is a mind-affecting effect.

_ [Diplomacy](skills/diplomacy#_diplomacy)_: You fluster your enemy. For the next minute, the target takes a –2 penalty on all attacks rolls made against creatures other than you and has a 10% spell failure chance on all spells that do not target you or that have you within their area of effect.

_ [Intimidate](skill_dir/intimidate#_intimidate)_: The creature flies into a rage. On its next turn, the target must attempt to make a melee attack against you, make a ranged attack against you, target you with a spell, or include you in the area of a spell. The effect ends if the creature is prevented from attacking you or attempting to do so would harm it (for example, if you are on the other side of a chasm or a _ [wall of fire](spells/wallOfFire#_wall-of-fire)_). If it cannot attack you on its turn, you may make the check again as an immediate action to extend the effect for 1 round (but cannot extend it thereafter). The effect ends as soon as the creature attacks you. Once you have targeted a creature with this ability, you cannot target it again for 1 day.
...
**Benefit:** Whenever you apply a spellblight by way of the [Blighted Critical](ultimateMagic/ultimateMagicFeats#_blighted-critical-) or Greater Blighted critical feat, you can choose the spellblight you apply rather than determining it randomly.
...
**Prerequisites:** [Craft Magic Arms and Armor](feats#_craft-magic-arms-and-armor), ability to cast _ [consecrate](spell_dir/consecrate#_consecrate) _or _ [desecrate](spells/desecrate#_desecrate)_.

**Benefit:** When you craft a magic weapon, magic armor, or magic shield, you may add one casting of _ [consecrate](spell_dir/consecrate#_consecrate) _or _ [desecrate](spells/desecrate#_desecrate) _as part of the item crafting process. This increases the item's price by 250 gp. The item becomes a reliquary and can be used as a holy (or unholy) symbol divine focus of your deity. If you cast _ [consecrate](spell_dir/consecrate#_consecrate)_ or _ [desecrate](spells/desecrate#_desecrate)_, your reliquary counts as a permanent fixture for that spell while it remains in the spell's area.
...
**Prerequisites:** Int 13; ability to cast _ [detect chaos](spells/detectChaos#_detect-chaos)_, _ [detect evil](spell_dir/detectEvil#_detect-evil)_, _ [detect good](spells/detectGood#_detect-good)_, _ [detect law](spell_dir/detectLaw#_detect-law)_, or _ [detect magic](spells/detectMagic#_detect-magic)._
...
**Prerequisites:** [Handle Animal](skills/handleAnimal#_handle-animal) 5 ranks, wild empathy class feature.
...
**Prerequisites:** [Knowledge](skills/knowledge#_knowledge) (nature) 5 ranks, wild empathy class feature.

**Benefit:** You gain a +2 insight bonus on wild empathy checks, and you may use wild empathy to duplicate an [Intimidate](skill_dir/intimidate#_intimidate) check rather than a [Diplomacy](skills/diplomacy#_diplomacy) check. In addition, choose one of the following kinds of creatures: elementals, fey, lycanthropes, plants, or vermin. You may influence creatures of that type with wild empathy, if their Intelligence score is 1 or 2, or they do not possess an Intelligence score. Once you choose the type of creature, it cannot be changed.
...
**Benefit:** Whenever you make a Sense Motive check to oppose someone's [Bluff](skills/bluff#_bluff) check, you can roll two dice and take the higher result.
...
**Prerequisites:** [Survival](skills/survival#_survival) 5 ranks.
...
**Benefit:** You get a +2 bonus on [Sense Motive](skills/senseMotive#_sense-motive) checks and [Spellcraft](skill_dir/spellcraft#_spellcraft) checks. If you have 10 or more ranks in one of these skills, the bonus increases to +4 for that skill.
...
**Benefit:** When an evil outsider uses a calling, summoning, or teleportation effect, or any ability that physically transports a creature to or from another plane (such as _ [blink](spells/blink#_blink)_ or _ [etherealness](magicItem_dir/armor#_armor-etherealness)_) within your anchoring aura, it takes damage equal to 4d8 + your Charisma modifier. This damage comes from holy power and is not subject to damage reduction, energy immunities, or energy resistances.
...
**Prerequisites:** [Knowledge](skills/knowledge#_knowledge) (religion) 5 ranks, channel energy class feature.
...
**Benefit:** When sharing the senses of your eidolon, you gain a +4 competence bonus on [Perception](skills/perception#_perception) checks for the duration of your bond senses ability.
...
**Benefit:** You gain the _ [detect evil](spells/detectEvil#_detect-evil)_ class feature. You may use it or the _ [detect undead](spell_dir/detectUndead#_detect-undead)_ class feature, but not at the same time.
...
**Benefit:** Add “human skeleton” to the list of creatures you can summon with _ [summon monster I](spells/summonMonster#_summon-monster-i)_ and “human skeletal champion” to the list of creatures you can summon with _ [summon monster III](spell_dir/summonMonster#_summon-monster-iii)_.
...
**Prerequisites:** [Bluff](skills/bluff#_bluff) 5 ranks, [Spellcraft](skill_dir/spellcraft#_spellcraft) 5 ranks.
...
First, you can conceal the activity of casting a bard spell by masking it in a performance. As a swift action, you may combine your casting time of a spell with a [Perform](skills/perform#_perform) check. Observers must make a [Perception](skill_dir/perception#_perception) or [Sense Motive](skills/senseMotive#_sense-motive) check opposed by your Perform check to realize you are also casting a spell. This uses 1 round of your bardic performance ability, regardless of the spell's casting time.
...
**Benefit:** Creatures you summon gain the [Blind-Fight](feats#_blind-fight) feat, a +5 bonus to [Perception](skill_dir/perception#_perception) and [Stealth](skills/stealth#_stealth) checks in dim light or darkness, and their natural weapons are treated as cold iron for overcoming damage reduction.
...
**Prerequisites:** [Knowledge](skills/knowledge#_knowledge) (religion) 6 ranks, [Spell Focus](feats#_spell-focus) (necromancy).
...
For example, you could cast a thanatopic _ [vampiric touch](spell_dir/vampiricTouch#_vampiric-touch)_ or _ [enervation](spells/enervation#_enervation)_ spell on a target under the effects of _ [death ward](spell_dir/deathWard#_death-ward)_, and the target would suffer the normal effect of the spell. Saving throws and SR (if any) still apply.
...
**Normal:** Defenses such as _ [death ward](spells/deathWard#_death-ward)_ negate death effects, negative levels, and energy drain. Undead are immune to these attacks.
...
**Benefit:** You can expend 10 uses of lay on hands to bring a single dead creature you touch back to life as a _ [raise dead](spells/raiseDead#_raise-dead)_ spell with a caster level equal to your paladin level. You must provide the material component for _ [raise dead](spell_dir/raiseDead#_raise-dead)_ or choose to accept 1 temporary negative level; this level automatically goes away after 24 hours, never becomes a permanent negative level, and cannot be overcome in any way except by waiting for the duration to expire.
...
**Benefit:** This feat gives you an additional +1 bonus on [Perception](skills/perception#_perception) and [Sense Motive](skill_dir/senseMotive#_sense-motive) checks, and you gain a +2 bonus on saving throws against sleep and charm effects.
...
**Prerequisites:** Spell focus (necromancy), the ability to cast _ [animate dead](spells/animateDead#_animate-dead)_ or _ [command undead](spell_dir/commandUndead#_command-undead)_.
...
**Benefit:** You get a +1 bonus on all [Bluff](skills/bluff#_bluff), [Diplomacy](skill_dir/diplomacy#_diplomacy), and [Perform](skills/perform#_perform) (oratory) skill checks. If you have 10 or more ranks in one of these skills, the bonus increases to +3 for that skill. You do not get these bonuses if you do not use your voice when using the skill (such as using Bluff to feint in combat).
...
When using wild shape to take the form of an animal, you may use _ [speak with animals](spell_dir/speakWithAnimals#_speak-with-animals)_ to communicate with animals of your assumed form. This is a spell-like ability with a caster level equal to your druid level, and you may use it for a number of minutes per day equal to your druid level. These minutes do not have to be consecutive, but must be used in one-minute increments.

...
The magus's class skills are [Climb](skills/climb#_climb) (Str), [Craft](skills/craft#_craft) (Int), [Fly](skills/fly#_fly) (Dex), [Intimidate](skills/intimidate#_intimidate) (Cha), [Knowledge](skills/knowledge#_knowledge) (arcana) (Int), [Knowledge](skills/knowledge#_knowledge) (dungeoneering) (Int), [Knowledge](skills/knowledge#_knowledge) (planes) (Int), [Profession](skills/profession#_profession) (Wis), [Ride](skills/ride#_ride) (Dex), [Spellcraft](skills/spellcraft#_spellcraft) (Int), [Swim](skills/swim#_swim) (Str), and [Use Magic Device](skills/useMagicDevice#_use-magic-device) (Cha).
...
At 5th level, these bonuses can be used to add any of the following weapon properties: _ [dancing](magicItems/weapons#_weapons-dancing)_, _ [flaming](magicItems/weapons#_weapons-flaming)_, _ [flaming burst](magicItems/weapons#_weapons-flaming-burst)_, _ [frost](magicItems/weapons#_weapons-frost)_, _ [icy burst](magicItems/weapons#_weapons-icy-burst)_, _ [keen](magicItems/weapons#_weapons-keen)_, _ [shock](magicItems/weapons#_weapons-shock)_, _ [shocking burst](magicItems/weapons#_weapons-shocking-burst)_, _ [speed](magicItems/weapons#_weapons-speed)_, or_ [vorpal](magicItems/weapons#_vorpal)_. Adding these properties consumes an amount of bonus equal to the property's base price modifier (see the [Magic Weapon Special Ability Descriptions](advanced/magicItems/weapons#_magic-weapon-special-ability-descriptions)). These properties are added to any the weapon already has, but duplicates do not stack. If the weapon is not magical, at least a +1 enhancement bonus must be added before any other properties can be added. These bonuses and properties are decided when the arcane pool point is spent and cannot be changed until the next time the magus uses this ability. These bonuses do not function if the weapon is wielded by anyone other than the magus.
...
**Spellstrike (Su)** : At 2nd level, whenever a magus casts a spell with a range of “touch” from the magus spell list, he can deliver the spell through any weapon he is wielding as part of a melee attack. Instead of the free melee touch attack normally allowed to deliver the spell, a magus can make one free melee attack with his weapon (at his highest base attack bonus) as part of casting this spell. If successful, this melee attack deals its normal damage as well as the effects of the spell. If the magus makes this attack in concert with spell combat, this melee attack takes all the penalties accrued by spell combat melee attacks. This attack uses the weapon's critical range (20, 19–20, or 18–20 and modified by the _ [keen](magicItems/weapons#_weapons-keen)_ weapon property or similar effects), but the spell effect only deals ×2 damage on a successful critical hit, while the weapon damage uses its own critical modifier.
...
**0-Level Magus Spells** —_ [acid splash](spells/acidSplash#_acid-splash)_, _ [arcane mark](spells/arcaneMark#_arcane-mark)_, _ [dancing lights](spells/dancingLights#_dancing-lights)_, _ [daze](spells/daze#_daze)_, _ [detect magic](spells/detectMagic#_detect-magic)_, _ [disrupt undead](spells/disruptUndead#_disrupt-undead)_, _ [flare](spells/flare#_flare)_, _ [ghost sound](spells/ghostSound#_ghost-sound)_, _ [light](spells/light#_light)_, _ [mage hand](spells/mageHand#_mage-hand)_, _ [open/close](spells/openClose#_open-close)_, _ [prestidigitation](spells/prestidigitation#_prestidigitation)_, _ [ray of frost](spells/rayOfFrost#_ray-of-frost)_, _ [read magic](spells/readMagic#_read-magic)_, _ [spark](advanced/spells/spark#_spark-)_.

**1st-Level Magus Spells** —_ [burning hands](spells/burningHands#_burning-hands)_, _ [chill touch](spells/chillTouch#_chill-touch)_, _ [color spray](spells/colorSpray#_color-spray)_, _ [corrosive touch](../spells/corrosiveTouch#_corrosive-touch)_, _ [enlarge person](spells/enlargePerson#_enlarge-person)_, _ [expeditious retreat](spells/expeditiousRetreat#_expeditious-retreat)_, _ [feather fall](spells/featherFall#_feather-fall)_, _ [flare burst](advanced/spells/flareBurst#_flare-burst)_, _ [floating disk](spells/floatingDisk#_floating-disk)_, _ [frostbite](../spells/frostbite#_frostbite)_, _ [grease](spells/grease#_grease)_, _ [hydraulic push](advanced/spells/hydraulicPush#_hydraulic-push-)_, _ [jump](spells/jump#_jump)_, _ [magic missile](spells/magicMissile#_magic-missile)_, _ [magic weapon](spells/magicWeapon#_magic-weapon)_, _ [mount](spells/mount#_mount)_, _ [obscuring mist](spells/obscuringMist#_obscuring-mist)_, _ [ray of enfeeblement](spells/rayOfEnfeeblement#_ray-of-enfeeblement)_, _ [reduce person](spells/reducePerson#_reduce-person)_, _ [shield](spells/shield#_shield)_, _ [shocking grasp](spells/shockingGrasp#_shocking-grasp)_,_ [silent image](spells/silentImage#_silent-image)_, _ [stone fist](advanced/spells/stoneFist#_stone-fist)_, _ [true strike](spells/trueStrike#_true-strike)_, _ [unseen servant](spells/unseenServant#_unseen-servant)_, _ [vanish](advanced/spells/vanish#_vanish)_.

**2nd-Level Magus Spells** —_ [acid arrow](spells/acidArrow#_acid-arrow)_, _ [alter self](spells/alterSelf#_alter-self)_, _ [bear's endurance](spells/bearSEndurance#_bear-s-endurance)_, _ [blood transcription](../spells/bloodTranscription#_blood-transcription)_, _ [blur](spells/blur#_blur)_, _ [bull's strength](spells/bullSStrength#_bull-s-strength)_, _ [burning gaze](advanced/spells/burningGaze#_burning-gaze)_, _ [cat's grace](spells/catSGrace#_cat-s-grace)_, _ [darkness](spells/darkness#_darkness)_, _ [defensive shock](../spells/defensiveShock#_defensive-shock)_, _ [elemental touch](advanced/spells/elementalTouch#_elemental-touch)_, _ [fire breath](advanced/spells/fireBreath#_fire-breath)_, _ [flaming sphere](spells/flamingSphere#_flaming-sphere)_, _ [fog cloud](spells/fogCloud)_, _ [frigid touch](../spells/frigidTouch#_frigid-touch)_, _ [glitterdust](spells/glitterdust#_glitterdust)_, _ [gust of wind](spells/gustOfWind#_gust-of-wind)_, _ [invisibility](spells/invisibility#_invisibility)_, _ [levitate](spells/levitate#_levitate)_, _ [minor image](spells/minorImage#_minor-image)_, _ [mirror image](spells/mirrorImage#_mirror-image)_, _ [pyrotechnics](spells/pyrotechnics#_pyrotechnics)_, _ [scorching ray](spells/scorchingRay#_scorching-ray)_, _ [shatter](spells/shatter#_shatter)_, _ [spider climb](spells/spiderClimb#_spider-climb)_, _ [stone call](advanced/spells/stoneCall#_stone-call)_, _ [web](spells/web#_web)_.

**3rd-Level Magus Spells** —_ [aqueous orb](advanced/spells/aqueousOrb#_aqueous-orb)_, _ [arcane sight](spells/arcaneSight#_arcane-sight)_, _ [beast shape I](spells/beastShape#_beast-shape-i)_, _ [blink](spells/blink#_blink)_, _ [cloak of winds](advanced/spells/cloakOfWinds#_cloak-of-winds)_, _ [daylight](spells/daylight#_daylight)_, _ [dispel magic](spells/dispelMagic#_dispel-magic)_, _ [displacement](spells/displacement#_displacement)_, _ [elemental aura](advanced/spells/elementalAura#_elemental-aura)_, _ [fireball](spells/fireball#_fireball)_, _ [flame arrow](spells/flameArrow#_flame-arrow)_, _ [fly](spells/fly)_, _ [force hook charge](../spells/forceHookCharge#_force-hook-charge)_, _ [force punch](../spells/forcePunch#_force-punch)_, _ [gaseous form](spells/gaseousForm#_gaseous-form)_, _ [haste](spells/haste#_haste), [hydraulic torrent](advanced/spells/hydraulicTorrent#_hydraulic-torrent-)_, _ [keen edge](spells/keenEdge#_keen-edge)_, _ [lightning bolt](spells/lightningBolt#_lightning-bolt)_, _ [magic weapon (greater)](spells/magicWeapon#_magic-weapon-greater)_, _ [major image](spells/majorImage#_major-image)_, _ [monstrous physique I](../spells/monstrousPhysique#_monstrous-physique-i)_, _ [phantom steed](spells/phantomSteed#_phantom-steed)_, _ [ray of exhaustion](spells/rayOfExhaustion#_ray-of-exhaustion)_, _ [sleet storm](spells/sleetStorm#_sleet-storm)_, _ [slow](spells/slow#_slow)_, _ [stinking cloud](spells/stinkingCloud#_stinking-cloud)_, _ [undead anatomy I](../spells/undeadAnatomy#_undead-anatomy-i)_, _ [vampiric touch](spells/vampiricTouch#_vampiric-touch)_, _ [versatile weapon](advanced/spells/versatileWeapon#_versatile-weapon)_, _ [water breathing](spells/waterBreathing#_water-breathing)_, _ [wind wall](spells/windWall#_wind-wall)_.

**4th-Level Magus Spells** —_ [arcana theft](../spells/arcanaTheft#_arcana-theft)_, _ [ball lightning](advanced/spells/ballLightning#_ball-lightning)_, _ [beast shape II](spells/beastShape#_beast-shape-ii)_, _ [black tentacles](spells/blackTentacles#_black-tentacles)_, _ [detonate](advanced/spells/detonate#_detonate)_, _ [dimension door](spells/dimensionDoor#_dimension-door)_, _ [dragon's breath](advanced/spells/dragonSBreath#_dragon's-breath)_, _ [elemental body I](spells/elementalBody#_elemental-body-i)_, _ [enlarge person (mass)](spells/enlargePerson#_enlarge-person-mass)_, _ [fire shield](spells/fireShield#_fire-shield)_, _ [firefall](advanced/spells/firefall#_firefall)_, _ [ice storm](spells/iceStorm#_ice-storm)_, _ [invisibility (greater)](spells/invisibility#_invisibility-greater)_, _ [monstrous physique II](../spells/monstrousPhysique#_monstrous-physique-ii)_, _ [phantasmal killer](spells/phantasmalKiller#_phantasmal-killer)_, _ [reduce person (mass)](spells/reducePerson#_reduce-person-mass)_, _ [river of wind](advanced/spells/riverOfWind#_river-of-wind)_, _ [shout](spells/shout#_shout)_, _ [solid fog](spells/solidFog#_solid-fog)_, _ [stoneskin](spells/stoneskin#_stoneskin)_, _ [vermin shape I](../spells/verminShape#_vermin-shape-i-)_, _ [wall of fire](spells/wallOfFire#_wall-of-fire)_, _ [wall of ice](spells/wallOfIce#_wall-of-ice)_, _ [wall of sound](../spells/wallOfSound#_wall-of-sound)_.

**5th-Level Magus Spells** —_ [acidic spray](../spells/acidicSpray#_acidic-spray)_, _ [baleful polymorph](spells/balefulPolymorph#_baleful-polymorph)_, _ [beast shape III](spells/beastShape#_beast-shape-iii)_, _ [cloudkill](spells/cloudkill#_cloudkill)_, _ [cone of cold](spells/coneOfCold#_cone-of-cold)_, _ [corrosive consumption](../spells/corrosiveConsumption#_corrosive-consumption)_, _ [elemental body II](spells/elementalBody#_elemental-body-ii)_, _ [fire snake](advanced/spells/fireSnake#_fire-snake)_, _ [geyser](advanced/spells/geyser#_geyser-)_, _ [interposing hand](spells/interposingHand#_interposing-hand)_, _ [monstrous physique III](../spells/monstrousPhysique#_monstrous-physique-iii)_, _ [overland flight](spells/overlandFlight#_overland-flight)_, _ [telekinesis](spells/telekinesis#_telekinesis)_, _ [teleport](spells/teleport#_teleport)_, _ [undead anatomy II](../spells/undeadAnatomy#_undead-anatomy-ii)_, _ [vermin shape II](../spells/verminShape#_vermin-shape-ii)_, _ [wall of force](spells/wallOfForce#_wall-of-force)_, _ [wall of stone](spells/wallOfStone#_wall-of-stone)_.

**6th-Level Magus Spells** —_ [acid fog](spells/acidFog#_acid-fog)_, _ [bear's endurance (mass)](spells/bearSEndurance#_bear-s-endurance-mass)_, _ [beast shape IV](spells/beastShape#_beast-shape-iv)_, _ [bull's strength (mass)](spells/bullSStrength#_bull-s-strength-mass)_, _ [cat's grace (mass)](spells/catSGrace#_cat-s-grace-mass)_, _ [chain lightning](spells/chainLightning#_chain-lightning)_, _ [contagious flame](advanced/spells/contagiousFlame#_contagious-flame)_, _ [disintegrate](spells/disintegrate#_disintegrate)_, _ [dispel magic](spells/dispelMagic#_dispel-magic)_ (_greater)_, _ [elemental body III](spells/elementalBody#_elemental-body-iii)_, _ [flesh to stone](spells/fleshToStone#_flesh-to-stone)_, _ [forceful hand](spells/forcefulHand#_forceful-hand)_, _ [form of the dragon I](spells/formOfTheDragon#_form-of-the-dragon-i)_, _ [freezing sphere](spells/freezingSphere#_freezing-sphere)_, _ [mislead](spells/mislead#_mislead)_, _ [monstrous physique IV](../spells/monstrousPhysique#_monstrous-physique-iv)_, _ [sirocco](advanced/spells/sirocco#_sirocco)_, _ [stone to flesh](spells/stoneToFlesh#_stone-to-flesh)_, _ [transformation](spells/transformation#_transformation)_, _ [true seeing](spells/trueSeeing#_true-seeing)_, _ [undead anatomy III](../spells/undeadAnatomy#_undead-anatomy-iii)_, _ [wall of iron](spells/wallOfIron#_wall-of-iron)_.

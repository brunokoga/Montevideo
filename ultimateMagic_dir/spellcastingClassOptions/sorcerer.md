---
layout: default
title: ultimateMagi_dir/spellcastingClassOptions/sorcerer
---
# Sorcerer
...
**Bonus Spells** : _ [ray of enfeeblement](spells/rayOfEnfeeblement#_ray-of-enfeeblement)_ (3rd), _ [touch of idiocy](spell_dir/touchOfIdiocy#_touch-of-idiocy)_ (5th), _ [ray of exhaustion](spells/rayOfExhaustion#_ray-of-exhaustion)_ (7th), _ [bestow curse](spell_dir/bestowCurse#_bestow-curse)_ (9th), _ [feeblemind](spells/feeblemind#_feeblemind)_ (11th), _ [eyebite](spell_dir/eyebite#_eyebite)_ (13th), _ [insanity](spells/insanity#_insanity)_ (15th), _ [dimensional lock](spell_dir/dimensionalLock#_dimensional-lock)_ (17th), _ [energy drain](spells/energyDrain#_energy-drain)_ (19th).
...
_ [Dream](spell_dir/dream#_dream) Walking (Sp)_: At 15th level, you can enter the ethereal plane. This functions like _ [ethereal jaunt](spells/etherealJaunt#_ethereal-jaunt)_, but with a duration of 1 minute for every 2 sorcerer levels you possess. Once during this trip, you may cast _ [nightmare](spell_dir/nightmare#_nightmare)_ as a spell-like ability on a creature you see on the Material Plane. (This is an exception to the normal rule that ethereal creatures cannot affect targets on the Material Plane).

_Fearsome [Survival](skills/survival#_survival) (Su)_: At 20th level, your hag-blood gives you considerable resilience. You gain DR 10/cold iron, and gain SR equal to 6 + your sorcerer level.
...
**Bonus Spells** : _ [shocking grasp](spells/shockingGrasp#_shocking-grasp)_ (3rd), _ [invisibility](spell_dir/invisibility#_invisibility)_ (5th), _ [fly](spells/fly)_ (7th), _ [minor creation](spell_dir/minorCreation#_minor-creation)_ (9th), _ [overland flight](spells/overlandFlight#_overland-flight)_ (11th), _ [chain lightning](spell_dir/chainLightning#_chain-lightning)_ (13th), _ [plane shift](spells/planeShift#_plane-shift)_ (15th), _ [greater planar binding](spell_dir/planarBinding#_planar-binding-greater)_ (17th), _ [wish](spells/wish#_wish)_ (19th).
...
_Elemental [Resistance](spells/resistance#_resistance) (Ex)_: At 3rd level, you gain electricity resistance 10. Your electricity resistance increases to 20 at 9th level.
...
_Power of the Djinn (Su)_: At 20th level, you gain the power of genies to grant wishes. Once per day, you can cast _ [limited wish](spells/limitedWish#_limited-wish)_ as a spell-like ability. Such wishes must begin with the words “I wish,” and cannot duplicate a wish you have granted within the past 24 hours. If you use this ability to duplicate a spell with a costly material component, you must provide that component.

You also become immune to electricity damage, and can use _ [plane shift](spell_dir/planeShift#_plane-shift)_ once per day to travel to or from the Plane of Air.
...
**Bonus Spells** : _ [enlarge person](spell_dir/enlargePerson#_enlarge-person)_ (3rd), _ [scorching ray](spells/scorchingRay#_scorching-ray)_ (5th), _ [fireball](spell_dir/fireball#_fireball)_ (7th), _ [wall of fire](spells/wallOfFire#_wall-of-fire)_ (9th), _ [persistent image](spell_dir/persistentImage#_persistent-image)_ (11th), _ [planar binding](spells/planarBinding#_planar-binding)_ (13th), _ [plane shift](spell_dir/planeShift#_plane-shift)_ (15th), _ [giant form II](spells/giantForm#_giant-form-ii)_ (17th), _ [wish](spell_dir/wish#_wish)_ (19th).
...
_Efreeti Form (Su)_: At 9th level, you gain the ability to assume the form of an efreeti once per day. This acts like the spell _ [giant form I](spells/giantForm#_giant-form-i)_, except you only use it to become an efreeti and its duration is 1 round per level. While in this form, you also gain an efreeti's heat ability.

_Elemental Movement (Su)_: At 15th level, your base speed increases by +30 feet.

_Power of the Efreet (Su)_: At 20th level, you gain the power of genies to grant wishes. Once per day, you can cast _ [limited wish](spell_dir/limitedWish#_limited-wish)_ as a spell-like ability. Such wishes must begin with the words “I wish,” and cannot duplicate a wish you have granted within the past 24 hours. If you use this ability to duplicate a spell with a costly material component, you must provide that component.

You also become immune to fire damage, and can use _ [plane shift](spells/planeShift#_plane-shift)_ once per day to travel to or from the Plane of Fire.
...
**Bonus Spells** : _ [ventriloquism](spells/ventriloquism#_ventriloquism)_ (3rd), _ [hideous laughter](spell_dir/hideousLaughter#_hideous-laughter)_ (5th), _ [suggestion](spells/suggestion#_suggestion)_ (7th), _ [shout](spell_dir/shout#_shout)_ (9th), _ [dominate person](spells/dominatePerson#_dominate-person)_ (11th), _ [mass suggestion](spell_dir/suggestion#_suggestion-mass)_ (13th), _ [power word blind](spells/powerWordBlind#_power-word-blind)_ (15th), _ [greater shout](spell_dir/shout#_shout-greater)_ (17th), _ [wail of the banshee](spells/wailOfTheBanshee#_wail-of-the-banshee)_ (19th).

**Bonus Feats** : [Deceitful](feats#_deceitful), [Greater Spell Focus](feats#_greater-spell-focus) (enchantment), Lingering Performance, [Persuasive](feats#_persuasive), [Skill Focus](feats#_skill-focus) ( [Perform](skill_dir/perform#_perform)), [Spell Focus](feats#_spell-focus) (enchantment), [Spellsong](ultimateMagic/ultimateMagicFeats#_spellsong), [Still Spell](feats#_still-spell).
...
_Fascinate (Ex)_: At 3rd level, you gain the ability to use a [Perform](skills/perform#_perform) skill to cause one or more creatures to become fascinated with you. This acts as the fascinate bardic perform ability, except the save DC is 10 + 1/2 your sorcerer level + your Charisma bonus, and it lasts 1 roun_dir/level. You may use this ability once per day at 3rd level, twice per day at 8th level, three times per day at 13th level, and four times per day at 18th level.
...
**Bonus Spells** : _ [obscuring mist](spells/obscuringMist#_obscuring-mist)_ (3rd), _ [see invisibility](spell_dir/seeInvisibility#_see-invisibility)_ (5th), _ [gaseous form](spells/gaseousForm#_gaseous-form)_ (7th), _ [wall of ice](spell_dir/wallOfIce#_wall-of-ice)_ (9th), _ [persistent image](spells/persistentImage#_persistent-image)_ (11th), _ [elemental body III](spell_dir/elementalBody#_elemental-body-iii)_ (13th), _ [plane shift](spells/planeShift#_plane-shift)_ (15th), _ [polar ray](spell_dir/polarRay#_polar-ray)_ (17th), _ [wish](spells/wish#_wish)_ (19th).
...
_Power of the Marid (Su)_: At 20th level, you gain the power of genies to grant wishes. Once per day, you can cast _ [limited wish](spell_dir/limitedWish#_limited-wish)_ as a spell-like ability. Such wishes must begin with the words “I wish,” and cannot duplicate a wish you have granted within the past 24 hours. If you use this ability to duplicate a spell with a costly material component, you must provide that component.

You become immune to cold damage, and can use _ [plane shift](spells/planeShift#_plane-shift)_ once per day to travel to or from the Plane of Water.
...
**Bonus Spells** : _ [charm person](spells/charmPerson#_charm-person)_ (3rd), _ [invisibility](spell_dir/invisibility#_invisibility)_ (5th), _ [suggestion](spells/suggestion#_suggestion)_ (7th), _ [detect scrying](spell_dir/detectScrying#_detect-scrying)_ (9th), _ [prying eyes](spells/pryingEyes#_prying-eyes)_ (11th), _ [mass suggestion](spell_dir/suggestion#_suggestion-mass)_ (13th), _ [greater polymorph](spells/polymorph#_polymorph-greater)_ (15th), _ [mind blank](spell_dir/mindBlank#_mind-blank)_ (17th), _ [dominate monster](spells/dominateMonster#_dominate-monster)_ (19th).
...
**Bloodline Arcana** : Add half your sorcerer level to the [Spellcraft](skills/spellcraft#_spellcraft) DC for others to identify spells you cast. If their checks fail by 5 or more, they mistakenly believe you are casting an entirely different spell (selected by you when you begin casting).
...
_Hide Aura (Sp)_: At 9th level, you can conceal yourself from prying magic. This ability acts like a constant _ [nondetection](spells/nondetection#_nondetection)_ spell cast upon yourself. You can end or restore this protection as a move action.

_Alter Self (Sp)_: At 15th level, you can change your shape into that of any humanoid at will. This ability acts like _ [alter self](spell_dir/alterSelf#_alter-self)_, except you may remain in a chosen form as long as you want.

_Outsider (Su)_: At 20th level, your natural form becomes an animal-headed humanoid, like a true rakshasa. This does not affect your ability to speak or cast spells. You can use your _ [alter self](spells/alterSelf#_alter-self)_ or other disguise and polymorph abilities to assume your original form or other forms when it suits you. You are forevermore treated as a native outsider rather than as a humanoid (or whatever your original type was) for the purpose of spells and other magical effects. Unlike other outsiders, you can still be brought back from the dead as if you were a member of your previous creature type. You gain DR 10/piercing.
...
**Bonus Spells** : _ [true strike](spells/trueStrike#_true-strike)_ (3rd), _ [glitterdust](spell_dir/glitterdust#_glitterdust)_ (5th), _ [greater magic weapon](spells/magicWeapon#_magic-weapon-greater)_ (7th), _ [stoneskin](spell_dir/stoneskin#_stoneskin)_ (9th), _ [wall of stone](spells/wallOfStone#_wall-of-stone)_ (11th), _ [wall of iron](spell_dir/wallOfIron#_wall-of-iron)_ (13th), _ [plane shift](spells/planeShift#_plane-shift)_ (15th), _ [iron body](spell_dir/ironBody#_iron-body)_ (17th), _ [wish](spells/wish#_wish)_ (19th).
...
_Elemental [Resistance](spells/resistance#_resistance) (Ex)_: At 3rd level, you gain acid resistance 10. At 9th level, your acid resistance increases to 20.
...
_Power of the Shaitan (Su)_: At 20th level, you gain the power of genies to grant wishes. Once per day, you can cast _ [limited wish](spell_dir/limitedWish#_limited-wish)_ as a spell-like ability. Such wishes must begin with the words “I wish,” and cannot duplicate a wish you have granted within the past 24 hours. If you use this ability to duplicate a spell with a costly material component, you must provide that component.

You become immune to acid damage, and can use _ [plane shift](spells/planeShift#_plane-shift)_ once per day to travel to or from the Plane of Earth.
...
_Example_: A 3rd-level aberran_dir/abyssal crossblooded sorcerer has the choice of learning _ [cause fear](spells/causeFear#_cause-fear)_ or _ [enlarge person](spell_dir/enlargePerson#_enlarge-person)_ as her bloodline bonus spell. If she selected _ [cause fear](spells/causeFear#_cause-fear)_ as her 3rd-level bonus spell, at 5th level she could use her new bonus spell to learn _ [enlarge person](spell_dir/enlargePerson#_enlarge-person)_ instead of _ [bull's strength](spells/bullSStrength#_bull-s-strength)_ or _ [see invisibility](spell_dir/seeInvisibility#_see-invisibility)_, and she would add it to her list of 1st-level spells known (just as if she had learned it as her 3rd-level bonus spell).
...
**Bloodline Arcana** : You gain a +2 bonus on [Acrobatics](skill_dir/acrobatics#_acrobatics), [Climb](skills/climb#_climb), and [Stealth](skill_dir/stealth#_stealth) checks.
...
**Bloodline Arcana** : Whenever you cast an evocation spell, you may select one affected target that fails its save to suffer the choking airlessness of the void, silencing it (as _ [silence](spells/silence#_silence)_, but affecting only the target) for 1 round. This is a supernatural ability.
...
_Voidfield (Sp)_: At 9th level, you can create an area influenced by the black void. This ability acts as an _ [ice storm](spell_dir/iceStorm#_ice-storm)_, except the area is also subject to _ [deeper darkness](spells/deeperDarkness#_deeper-darkness)_ for 1 round per four sorcerer levels. You may use this ability once per day at 3rd level, and one additional time per day for every three additional levels. The bloodline power replaces aurora borealis.
...
| 2 | Webbed Digits: +2 on [Swim](skills/swim#_swim) checks. |
| 3 | Iron Grip: +2 on [Climb](skill_dir/climb#_climb) checks and to CMD against disarm maneuvers. |
| 4 | Bug Eyes: +2 on [Perception](skills/perception#_perception) checks. |
...
| 12 | [Eagle Eyes](advanced/advancedFeats#_eagle-eyes): +1 on ranged attack rolls. |

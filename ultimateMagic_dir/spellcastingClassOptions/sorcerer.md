...
**Bonus Spells** : _ [ray of enfeeblement](spells/rayOfEnfeeblement#_ray-of-enfeeblement)_ (3rd), _ [touch of idiocy](spells/touchOfIdiocy#_touch-of-idiocy)_ (5th), _ [ray of exhaustion](spells/rayOfExhaustion#_ray-of-exhaustion)_ (7th), _ [bestow curse](spells/bestowCurse#_bestow-curse)_ (9th), _ [feeblemind](spells/feeblemind#_feeblemind)_ (11th), _ [eyebite](spells/eyebite#_eyebite)_ (13th), _ [insanity](spells/insanity#_insanity)_ (15th), _ [dimensional lock](spells/dimensionalLock#_dimensional-lock)_ (17th), _ [energy drain](spells/energyDrain#_energy-drain)_ (19th).
...
**Bonus Spells** : _ [shocking grasp](spells/shockingGrasp#_shocking-grasp)_ (3rd), _ [invisibility](spells/invisibility#_invisibility)_ (5th), _ [fly](spells/fly)_ (7th), _ [minor creation](spells/minorCreation#_minor-creation)_ (9th), _ [overland flight](spells/overlandFlight#_overland-flight)_ (11th), _ [chain lightning](spells/chainLightning#_chain-lightning)_ (13th), _ [plane shift](spells/planeShift#_plane-shift)_ (15th), _ [greater planar binding](spells/planarBinding#_planar-binding-greater)_ (17th), _ [wish](spells/wish#_wish)_ (19th).
...
_ [Whirlwind](spells/whirlwind#_whirlwind) (Su)_: At 9th level, you gain the ability to turn into a 10-foot-high whirlwind once per day for 1 round per sorcerer level.
...
You also become immune to electricity damage, and can use _ [plane shift](spells/planeShift#_plane-shift)_ once per day to travel to or from the Plane of Air.
...
**Bonus Spells** : _ [enlarge person](spells/enlargePerson#_enlarge-person)_ (3rd), _ [scorching ray](spells/scorchingRay#_scorching-ray)_ (5th), _ [fireball](spells/fireball#_fireball)_ (7th), _ [wall of fire](spells/wallOfFire#_wall-of-fire)_ (9th), _ [persistent image](spells/persistentImage#_persistent-image)_ (11th), _ [planar binding](spells/planarBinding#_planar-binding)_ (13th), _ [plane shift](spells/planeShift#_plane-shift)_ (15th), _ [giant form II](spells/giantForm#_giant-form-ii)_ (17th), _ [wish](spells/wish#_wish)_ (19th).
...
_Elemental [Resistance](spells/resistance#_resistance) (Ex)_: At 3rd level, you gain fire resistance 10. At 9th level, your fire resistance increases to 20.
...
_Power of the Efreet (Su)_: At 20th level, you gain the power of genies to grant wishes. Once per day, you can cast _ [limited wish](spells/limitedWish#_limited-wish)_ as a spell-like ability. Such wishes must begin with the words “I wish,” and cannot duplicate a wish you have granted within the past 24 hours. If you use this ability to duplicate a spell with a costly material component, you must provide that component.
...
**Class Skill** : [Perform](skills/perform#_perform).

**Bonus Spells** : _ [ventriloquism](spells/ventriloquism#_ventriloquism)_ (3rd), _ [hideous laughter](spells/hideousLaughter#_hideous-laughter)_ (5th), _ [suggestion](spells/suggestion#_suggestion)_ (7th), _ [shout](spells/shout#_shout)_ (9th), _ [dominate person](spells/dominatePerson#_dominate-person)_ (11th), _ [mass suggestion](spells/suggestion#_suggestion-mass)_ (13th), _ [power word blind](spells/powerWordBlind#_power-word-blind)_ (15th), _ [greater shout](spells/shout#_shout-greater)_ (17th), _ [wail of the banshee](spells/wailOfTheBanshee#_wail-of-the-banshee)_ (19th).

**Bonus Feats** : [Deceitful](feats#_deceitful), [Greater Spell Focus](feats#_greater-spell-focus) (enchantment), Lingering Performance, [Persuasive](feats#_persuasive), [Skill Focus](feats#_skill-focus) ( [Perform](skills/perform#_perform)), [Spell Focus](feats#_spell-focus) (enchantment), [Spellsong](ultimateMagic/ultimateMagicFeats#_spellsong), [Still Spell](feats#_still-spell).
...
_Beguiling Voice (Ex)_: At 1st level, you can use the sound of your voice to lull a target creature into taking no action. This ability acts as the _ [daze](spells/daze#_daze)_ spell, except it is language-dependent, has a duration of 1 round, and affects a living creature whose Hit Dice do not exceed your sorcerer level. You can use this ability a number of times per day equal to 3 + your Charisma modifier.

_Fascinate (Ex)_: At 3rd level, you gain the ability to use a [Perform](skills/perform#_perform) skill to cause one or more creatures to become fascinated with you. This acts as the fascinate bardic perform ability, except the save DC is 10 + 1/2 your sorcerer level + your Charisma bonus, and it lasts 1 round/level. You may use this ability once per day at 3rd level, twice per day at 8th level, three times per day at 13th level, and four times per day at 18th level.
...
**Bonus Spells** : _ [obscuring mist](spells/obscuringMist#_obscuring-mist)_ (3rd), _ [see invisibility](spells/seeInvisibility#_see-invisibility)_ (5th), _ [gaseous form](spells/gaseousForm#_gaseous-form)_ (7th), _ [wall of ice](spells/wallOfIce#_wall-of-ice)_ (9th), _ [persistent image](spells/persistentImage#_persistent-image)_ (11th), _ [elemental body III](spells/elementalBody#_elemental-body-iii)_ (13th), _ [plane shift](spells/planeShift#_plane-shift)_ (15th), _ [polar ray](spells/polarRay#_polar-ray)_ (17th), _ [wish](spells/wish#_wish)_ (19th).
...
_Elemental [Resistance](spells/resistance#_resistance) (Ex)_: At 3rd level, you gain cold resistance 10. At 9th level, your cold resistance increases to 20.
...
_Power of the Marid (Su)_: At 20th level, you gain the power of genies to grant wishes. Once per day, you can cast _ [limited wish](spells/limitedWish#_limited-wish)_ as a spell-like ability. Such wishes must begin with the words “I wish,” and cannot duplicate a wish you have granted within the past 24 hours. If you use this ability to duplicate a spell with a costly material component, you must provide that component.
...
**Class Skill** : [Disguise](skills/disguise#_disguise).

**Bonus Spells** : _ [charm person](spells/charmPerson#_charm-person)_ (3rd), _ [invisibility](spells/invisibility#_invisibility)_ (5th), _ [suggestion](spells/suggestion#_suggestion)_ (7th), _ [detect scrying](spells/detectScrying#_detect-scrying)_ (9th), _ [prying eyes](spells/pryingEyes#_prying-eyes)_ (11th), _ [mass suggestion](spells/suggestion#_suggestion-mass)_ (13th), _ [greater polymorph](spells/polymorph#_polymorph-greater)_ (15th), _ [mind blank](spells/mindBlank#_mind-blank)_ (17th), _ [dominate monster](spells/dominateMonster#_dominate-monster)_ (19th).

**Bonus Feats** : [Arcane Armor Mastery](feats#_arcane-armor-mastery), [Arcane Armor Training](feats#_arcane-armor-training), Deceitful, [Detect Expertise](ultimateMagic/ultimateMagicFeats#_detect-expertise), Empower Spell, Light Armor Proficiency, [Martial Weapon Proficiency](feats#_martial-weapon-proficiency), [Stealthy](feats#_stealthy).
...
_Alter Self (Sp)_: At 15th level, you can change your shape into that of any humanoid at will. This ability acts like _ [alter self](spells/alterSelf#_alter-self)_, except you may remain in a chosen form as long as you want.
...
**Bonus Spells** : _ [true strike](spells/trueStrike#_true-strike)_ (3rd), _ [glitterdust](spells/glitterdust#_glitterdust)_ (5th), _ [greater magic weapon](spells/magicWeapon#_magic-weapon-greater)_ (7th), _ [stoneskin](spells/stoneskin#_stoneskin)_ (9th), _ [wall of stone](spells/wallOfStone#_wall-of-stone)_ (11th), _ [wall of iron](spells/wallOfIron#_wall-of-iron)_ (13th), _ [plane shift](spells/planeShift#_plane-shift)_ (15th), _ [iron body](spells/ironBody#_iron-body)_ (17th), _ [wish](spells/wish#_wish)_ (19th).
...
_Power of the Shaitan (Su)_: At 20th level, you gain the power of genies to grant wishes. Once per day, you can cast _ [limited wish](spells/limitedWish#_limited-wish)_ as a spell-like ability. Such wishes must begin with the words “I wish,” and cannot duplicate a wish you have granted within the past 24 hours. If you use this ability to duplicate a spell with a costly material component, you must provide that component.
...
_Example_: A 3rd-level aberrant/abyssal crossblooded sorcerer has the choice of learning _ [cause fear](spells/causeFear#_cause-fear)_ or _ [enlarge person](spells/enlargePerson#_enlarge-person)_ as her bloodline bonus spell. If she selected _ [cause fear](spells/causeFear#_cause-fear)_ as her 3rd-level bonus spell, at 5th level she could use her new bonus spell to learn _ [enlarge person](spells/enlargePerson#_enlarge-person)_ instead of _ [bull's strength](spells/bullSStrength#_bull-s-strength)_ or _ [see invisibility](spells/seeInvisibility#_see-invisibility)_, and she would add it to her list of 1st-level spells known (just as if she had learned it as her 3rd-level bonus spell).
...
**Bloodline Arcana** : You gain a +2 bonus on [Acrobatics](skills/acrobatics#_acrobatics), [Climb](skills/climb#_climb), and [Stealth](skills/stealth#_stealth) checks.
...
**Bloodline Arcana** : Whenever you cast a spell, you gain a bonus on [Intimidate](skills/intimidate#_intimidate) checks equal to the spell's level for 1 round.
...
| d12 | Effect |
| --- | --- |
| 1 | Double-Jointed: +2 on [Escape Artist](skills/escapeArtist#_escape-artist) checks. |
| 2 | Webbed Digits: +2 on [Swim](skills/swim#_swim) checks. |
| 3 | Iron Grip: +2 on [Climb](skills/climb#_climb) checks and to CMD against disarm maneuvers. |
| 4 | Bug Eyes: +2 on [Perception](skills/perception#_perception) checks. |
| 5 | Camouflage: +2 on [Stealth](skills/stealth#_stealth) checks. |

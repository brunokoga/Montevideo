---
layout: default
title: ultimateMagic_dir/spellcastingClassOptions_dir/summoner
---
# Summoner
...
**25 points** : **Base Form** aquatic; **Primary Evolutions** reach (tentacles), tentacles (2); **Secondary Evolutions** basic magic (_ [ghost sound](../../spells_dir/ghostSound#_ghost-sound)_), huge, large, major magic (_ [minor image](../../spells_dir/minorImage#_minor-image)_), minor magic (_ [silent image](../../spells_dir/silentImage#_silent-image)_), tentacles (2), ultimate magic (_ [major image](../../spells_dir/majorImage#_major-image)_).
...
**24 points** : **Base Form** biped; **Primary Evolutions** resistance (fire or electricity), weapon training; **Secondary Evolutions** basic magic (_ [stabilize](../../spells_dir/stabilize#_stabilize)_), damage reduction (evil), flight, immunity (acid or cold), major magic (_ [cure moderate wounds](../../spells_dir/cureModerateWounds#_cure-moderate-wounds)_ or _ [invisibility](../../spells_dir/invisibility#_invisibility)_), minor magic (_ [cure light wounds](../../spells_dir/cureLightWounds#_cure-light-wounds)_ or _ [detect evil](../../spells_dir/detectEvil#_detect-evil)_), spell resistance, ultimate magic (_ [cure serious wounds](../../spells_dir/cureSeriousWounds#_cure-serious-wounds)_, _ [daylight](../../spells_dir/daylight#_daylight)_, or _ [tongues](../../spells_dir/tongues#_tongues)_) or _ [dimension door](../../spells_dir/dimensionDoor#_dimension-door)_.
...
The eidolon looks like a humanoid warrior. The natural armor of a bodyguard eidolon appears to be a suit of metal plate, though this armor is actually part of the eidolon's body. [Bodyguard](../../advanced_dir/advancedFeats#_bodyguard-(combat)) eidolons are normally trained in a variety of dangerous weapons.
...
**26 points** : **Base Form** any; **Primary Evolutions** resistance (acid, cold, fire); **Secondary Evolutions** basic magic (_ [acid splash](../../spells_dir/acidSplash#_acid-splash)_); bite, claws, slam, or tentacle; damage reduction (good); flight; immunity (electricity); magic attacks; major magic (_ [darkness](../../spells_dir/darkness#_darkness)_ or _ [see invisibility](../../spells_dir/seeInvisibility#_see-invisibility)_); minor magic (_ [detect good](../../spells_dir/detectGood#_detect-good)_ or _ [vanish](../../advanced_dir/spells_dir/vanish#_vanish)_); spell resistance; ultimate magic (_ [gaseous form](../../spells_dir/gaseousForm#_gaseous-form)_ or _ [stinking cloud](../../spells_dir/stinkingCloud#_stinking-cloud)_) or _ [dimension door](../../spells_dir/dimensionDoor#_dimension-door)_.

## Devil

The eidolon has an infernal appearance. Devil eidolons might have large bat wings or could fly magically.

**26 points** : **Base Form** biped; **Primary Evolutions** basic magic (_ [daze](../../spells_dir/daze#_daze) _or _ [ray of frost](../../spells_dir/rayOfFrost#_ray-of-frost)_), magic attacks, resistance (acid or cold); **Secondary Evolutions** damage reduction (good), flight, immunity (fire), major magic (_ [invisibility](../../spells_dir/invisibility#_invisibility)_, _ [minor image](../../spells_dir/minorImage#_minor-image)_, or _ [scorching ray](../../spells_dir/scorchingRay#_scorching-ray)_), minor magic (_ [burning hands](../../spells_dir/burningHands#_burning-hands)_ or _ [detect good](../../spells_dir/detectGood#_detect-good)_), see in darkness, spell resistance, ultimate magic (_ [fireball](../../spells_dir/fireball#_fireball)_,_ [lightning bolt](../../spells_dir/lightningBolt#_lightning-bolt)_, or _ [major image](../../spells_dir/majorImage#_major-image)_) or _ [dimension door](../../spells_dir/dimensionDoor#_dimension-door)_.
...
**25 points** : **Base Form** quadruped; **Primary Evolutions** climb, limbs (arms); **Secondary Evolutions** basic magic (_ [dancing lights](../../spells_dir/dancingLights#_dancing-lights)_ or _ [detect magic](../../spells_dir/detectMagic#_detect-magic)_), large, limbs (legs, 2), minor magic (_ [detect good](../../spells_dir/detectGood#_detect-good) or [detect law](../../spells_dir/detectLaw#_detect-law)_), poison, spell resistance, weapon training, web.
...
**22 points** : **Base Form** biped; **Primary Evolutions** basic magic (_ [daze](../../spells_dir/daze#_daze)_, _ [dancing lights](../../spells_dir/dancingLights#_dancing-lights)_, _ [detect magic](../../spells_dir/detectMagic#_detect-magic)_, or _ [ghost sound](../../spells_dir/ghostSound#_ghost-sound)_), weapon training; **Secondary Evolutions** damage reduction (lawful), _ [dimension door](../../spells_dir/dimensionDoor#_dimension-door)_, flight, low-light vision, major magic (_ [cure moderate wounds](../../spells_dir/cureModerateWounds#_cure-moderate-wounds)_ or _ [invisibility](../../spells_dir/invisibility#_invisibility)_), minor magic (_ [obscuring mist](../../spells_dir/obscuringMist#_obscuring-mist)_ or vanish), spell resistance.
...
**21–23 points** : **Base Form** biped; **Primary Evolutions** basic magic (_ [detect magic](../../spells_dir/detectMagic#_detect-magic)_), weapon training; **Secondary Evolutions** burrow, flight, or swim; energy attacks; immunity; large; major magic (_ [acid arrow](../../spells_dir/acidArrow#_acid-arrow)_, _ [invisibility](../../spells_dir/invisibility#_invisibility)_, or_ [scorching ray](../../spells_dir/scorchingRay#_scorching-ray)_); minor magic (_ [burning hands](../../spells_dir/burningHands#_burning-hands)_ or _ [obscuring mist](../../spells_dir/obscuringMist#_obscuring-mist)_); ultimate magic (_ [create food and water](../../spells_dir/createFoodAndWater#_create-food-and-water)_, _ [gaseous form](../../spells_dir/gaseousForm#_gaseous-form)_, or _ [water breathing](../../spells_dir/waterBreathing#_water-breathing)_).
...
**17 points** : **Base Form** quadruped; **Primary Evolutions** energy attacks (fire), hooves; **Secondary Evolutions** flight (magic), large, minor magic (_ [obscuring mist](../../spells_dir/obscuringMist#_obscuring-mist)_), mount, resistance (fire), trample.
...
**23 points** (couatl), **26 points** (lillend): **Base Form** serpentine; **Primary Evolutions** basic magic (any), grab; **Secondary Evolutions** couatl (constrict, flight, large, magic attacks, major magic [_ [invisibility](../../spells_dir/invisibility#_invisibility)_], minor magic [_ [detect chaos](../../spells_dir/detectChaos#_detect-chaos)_dir/evil_dir/good_dir/law_], poison, ultimate magic [_ [gaseous form](../../spells_dir/gaseousForm#_gaseous-form)_]); lillend (constrict, flight, immunity [electricity], large, limbs [arms], magic attacks, major magic [_ [darkness](../../spells_dir/darkness#_darkness)_ or _ [invisibility](../../spells_dir/invisibility#_invisibility)_], minor magic [_ [cure light wounds](../../spells_dir/cureLightWounds#_cure-light-wounds)_], resistance [cold, fire], skilled [[Perform](../../skills_dir/perform#_perform)], weapon training [martial]).
...
_ [Low-Light Vision](../../monsters_dir/universalMonsterRules#_low-light-vision) (Ex)_: An eidolon gains low-light vision, enabling it to see twice as far as a human in conditions of dim light.

_Unnatural Aura (Su)_: An eidolon is obviously of unnatural origin. Normal animals do not willingly approach the eidolon unless the animal's master makes a DC 25 [Handle Animal](../../skills_dir/handleAnimal#_handle-animal), [Ride](../../skills_dir/ride#_ride), or wild empathy check.

## 2-Point Evolutions

The following evolutions each cost 2 points from the eidolon's evolution pool.

[_Channel Resistance_](../../monsters_dir/UniversalMonsterRules#_channel-resistance) (Ex): An eidolon becomes less easily affected by the channel energy ability of clerics or paladins. The eidolon gains a +2 bonus on any saves that are made to resist the effects of channel energy, including effects that rely on the use of channel energy (such as the [Command Undead](../../feats#_command-undead) feat). At 7th level, this bonus can be increased to +4 by spending 2 additional evolution points. The eidolon must possess the undead appearance evolution to take this evolution.
...
_ [Keen Scent](../../advanced_dir/advancedFeats#_keen-scent) (Ex)_: An eidolon's sense of smell becomes even more acute. The eidolon can notice other creatures by scent in a 180-foot radius underwater and can detect blood in the water at ranges of up to a mile. The eidolon must possess the gills and scent evolutions to take this evolution.

_Minor Magic (Sp)_: An eidolon learns to cast a minor spell as a spell-like ability. Select one spell from the following list: _ [burning hands](../../spells_dir/burningHands#_burning-hands)_, _ [comprehend languages](../../spells_dir/comprehendLanguages#_comprehend-languages)_, _ [cure light wounds](../../spells_dir/cureLightWounds#_cure-light-wounds)_, _ [detect chaos](../../spells_dir/detectChaos#_detect-chaos)_dir/evil_dir/good_dir/law_, _ [magic missile](../../spells_dir/magicMissile#_magic-missile)_, _ [obscuring mist](../../spells_dir/obscuringMist#_obscuring-mist)_, _ [silent image](../../spells_dir/silentImage#_silent-image)_, _ [vanish](../../advanced_dir/spells_dir/vanish#_vanish)_ (self only), or _ [ventriloquism](../../spells_dir/ventriloquism#_ventriloquism)_. This spell can be cast once per day as a spell-like ability. At 7th level, this spell can be cast three times per day by spending 2 additional evolution points. The caster level for this evolution is equal to the eidolon's Hit Dice – 2. The save DC for this spell is 10 + 1_dir/2 the eidolon's HD + the eidolon's Charisma modifier. The eidolon must have a Charisma score of at least 11 and must possess the basic magic evolution to take this evolution.
...
_Undead Appearance (Ex)_: An eidolon appears as an undead creature, and mimics some of an undead creature's abilities and weaknesses. Negative energy heals the eidolon, and positive energy (including a cleric's channel energy ability) harms it. Spells and effects that target undead or have specific effects against undead (such as [Command Undead](../../feats#_command-undead), _hold undead_, and _ [searing light](../../spells_dir/searingLight#_searing-light)_) affect the eidolon as if it were undead. The eidolon gains a +2 bonus on saves against disease, exhaustion, fatigue, paralysis, poison, sleep effects, and stunning.
...
_Major Magic (Sp)_: An eidolon learns to cast a major spell as a spell-like ability. Select one spell from the following list: _ [acid arrow](../../spells_dir/acidArrow#_acid-arrow)_, _ [cure moderate wounds](../../spells_dir/cureModerateWounds#_cure-moderate-wounds)_, _ [darkness](../../spells_dir/darkness#_darkness)_, _ [daze monster](../../spells_dir/dazeMonster#_daze-monster)_, _ [glide](../../advanced_dir/spells_dir/glide#_glide-)_, _ [invisibility](../../spells_dir/invisibility#_invisibility)_ (self only), _ [lesser restoration](../../spells_dir/restoration#_restoration-lesser)_, _ [levitate](../../spells_dir/levitate#_levitate)_, _ [minor image](../../spells_dir/minorImage#_minor-image)_, _ [scorching ray](../../spells_dir/scorchingRay#_scorching-ray)_, _ [see invisibility](../../spells_dir/seeInvisibility#_see-invisibility)_, or _ [spider climb](../../spells_dir/spiderClimb#_spider-climb)_. This spell can be cast once per day as a spell-like ability.
...
_See in [Darkness](../../spells_dir/darkness#_darkness) (Su)_: An eidolon can see perfectly in darkness of any kind, including that created by _ [deeper darkness](../../spells_dir/deeperDarkness#_deeper-darkness)_. The summoner must be at least 9th level before selecting this evolution.

## 4-Point Evolutions

The following evolutions cost 4 points from the eidolon's evolution pool.

_Dimension Door (Sp)_: An eidolon learns to cast _ [dimension door](../../spells_dir/dimensionDoor#_dimension-door)_ as a spell-like ability once per day. The caster level for this evolution is equal to the eidolon's Hit Dice. The save DC for this spell is 10 + 1_dir/2 the eidolon's HD + the eidolon's Charisma modifier. The eidolon must have a Charisma score of at least 14 to take this evolution. The summoner must be at least 13th level before selecting this evolution.
...
_Ultimate Magic (Sp)_: An eidolon learns to cast a powerful spell as a spell-like ability. Select one spell from the following list: _ [arcane sight](../../spells_dir/arcaneSight#_arcane-sight)_, _ [create food and water](../../spells_dir/createFoodAndWater#_create-food-and-water)_, _ [cure serious wounds](../../spells_dir/cureSeriousWounds#_cure-serious-wounds)_, _ [daylight](../../spells_dir/daylight#_daylight)_, _ [fireball](../../spells_dir/fireball#_fireball)_, _ [fly](../../spells_dir/fly)_, _ [gaseous form](../../spells_dir/gaseousForm#_gaseous-form)_, _ [lightning bolt](../../spells_dir/lightningBolt#_lightning-bolt)_, _ [major image](../../spells_dir/majorImage#_major-image)_, _ [stinking cloud](../../spells_dir/stinkingCloud#_stinking-cloud)_, _ [tongues](../../spells_dir/tongues#_tongues)_, or _ [water breathing](../../spells_dir/waterBreathing#_water-breathing)_. This spell can be cast once per day as a spell-like ability. The caster level for this evolution is equal to the eidolon's Hit Dice – 2. The save DC for this spell is 10 + 1_dir/2 the eidolon's HD + the eidolon's Charisma modifier. The eidolon must have a Charisma score of at least 13 and must possess the major magic evolution to take this evolution.
...
**Transmogrify (Sp)** : At 12th level, the evolutionist can cast _ [transmogrify](../../advanced_dir/spells_dir/transmogrify#_transmogrify)_ as a spell-like ability once per day without the need for a material component. This ability has a casting time of 1 minute. This ability replaces greater shield ally.
...
**Summoning Mastery (Sp)** : Starting at 1st level, a master summoner can cast _ [summon monster I](../../spells_dir/summonMonster#_summon-monster-i)_ as a spell-like ability a number of times per day equal to 5 + his Charisma modifier. The summoner can use this ability when his eidolon is summoned. Only one _summon monster_ spell may be in effect while the eidolon is summoned. If the summoner's eidolon is not summoned, the number of creatures that can be summoned with this ability is only limited by its uses per day. This ability otherwise functions as the summoner's normal _ [summon monster I](../../spells_dir/summonMonster#_summon-monster-i)_ ability. Other than these restrictions, there is no limit to how many _summon monster_ or _ [gate](../../spells_dir/gate#_gate)_ spells the summoner can have active at one time. This ability replaces the summoner's normal _ [summon monster I](../../spells_dir/summonMonster#_summon-monster-i)_ ability and shield ally.

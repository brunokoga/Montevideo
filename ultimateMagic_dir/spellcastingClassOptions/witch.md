---
layout: default
title: ultimateMagi_dir/spellcastingClassOptions/witch
---
# Witch
...
_ [Poison](spell_dir/poison#_poison) Steep (Sp)_: The witch can use her cauldron to brew a foul toxin in which she can steep fruits and other delicious edibles, transforming them so that when eaten, they have the same effect as a _ [poison](spells/poison#_poison)_ spell. Brewing the toxin and then steeping the food takes 1 hour in total; steeping can affect up to 1 pound of food. The food is poisoned for 24 hours, and the poison cannot be transferred to other objects. The food tastes normal, but magic detects it as poisonous. The witch must have the cauldron hex to select this hex.
...
_Speak in Dreams (Sp)_: The witch can contact a creature as if using _ [dream](spell_dir/dream#_dream)_. The witch can use this ability on a number of creatures per day equal to her Intelligence bonus, but can dream-speak to those creatures as often as desired throughout that time period.
...
_Witch's Hut (Su)_: The witch can animate a hut, small house, covered wagon, tent, or similar construction as an animated object. The hut can be of up to Huge size (approximately 15 feet by 15 feet). The animated hut's hardness increases to 8 and its hit points double. The witch can give the hut the following commands: guard (the hut watches for trespassers within 120 feet using the witch's [Perception](skill_dir/perception#_perception) modifier and screams if it spots any), hide (all entrances are hidden by _ [illusory wall](spells/illusoryWall#_illusory-wall)_ spells and locked with _ [arcane lock](spell_dir/arcaneLock#_arcane-lock)_), and move (moves at speed 60 on giant bird or bone legs as directed by the witch, even obeying commands such as “follow me from 100 feet away”). The hut remains animate for 24 hours, until she dismisses it or she animates another, at which time the hut stops where it is and reverts to its nonmagical state.

# Witch Patron Themes

The following are alternative patrons themes that a witch can choose.

**Ancestors** : 2nd—_ [bless](spells/bless#_bless)_, 4th—_ [aid](spell_dir/aid#_aid)_, 6th—_ [prayer](spells/prayer#_prayer)_, 8th—_ [blessing of fervor](advance_dir/spells/blessingOfFervor#_blessing-of-fervor)_, 10th—_ [commune](spell_dir/commune#_commune)_, 12th—_ [greater heroism](spells/heroism#_heroism-greater)_, 14th—_ [refuge](spell_dir/refuge#_refuge)_, 16th—_ [euphoric tranquility](advanced/spell_dir/euphoricTranquility#_euphoric-tranquility)_, 18th—_weird_.

**Death** : 2nd—_ [deathwatch](spells/deathwatch#_deathwatch)_, 4th—_ [blessing of courage and life](advance_dir/spells/blessingOfCourageAndLife#_blessing-of-courage-and-life)_, 6th—_ [speak with dead](spell_dir/speakWithDead#_speak-with-dead)_, 8th—_ [rest eternal](advanced/spell_dir/restEternal#_rest-eternal)_, 10th—_ [suffocation](advanced/spell_dir/suffocation#_suffocation)_, 12th—_ [circle of death](spells/circleOfDeath#_circle-of-death)_, 14th—_ [finger of death](spell_dir/fingerOfDeath#_finger-of-death)_, 16th—_ [symbol of death](spells/symbolOfDeath#_symbol-of-death)_, 18th—_ [power word kill](spell_dir/powerWordKill#_power-word-kill)_.

**Enchantment** : 2nd—_ [unnatural lust](ultimateMagic/spell_dir/unnaturalLust#_unnatural-lust)_, 4th—_ [calm emotions](spells/calmEmotions#_calm-emotions)_, 6th—_ [unadulterated loathing](ultimateMagi_dir/spells/unadulteratedLoathing#_unadulterated-loathing)_, 8th—_ [overwhelming grief](ultimateMagi_dir/spells/overwhelmingGrief#_overwhelming-grief)_, 10th—_ [dominate person](spell_dir/dominatePerson#_dominate-person)_, 12th—_geas_, 14th—_ [euphoric tranquility](advanced/spell_dir/euphoricTranquility#_euphoric-tranquility)_, 16th—_ [demand](spells/demand#_demand)_, 18th—_ [dominate monster](spell_dir/dominateMonster#_dominate-monster)_.

**Healing** : 2nd—_ [remove fear](spells/removeFear#_remove-fear)_, 4th—_ [lesser restoration](spell_dir/restoration#_restoration-lesser)_, 6th—_ [remove disease](spells/removeDisease#_remove-disease)_, 8th—_ [restoration](spell_dir/restoration#_restoration)_, 10th—_ [cleanse](advanced/spell_dir/cleanse#_cleanse)_, 12th—_ [pillar of life](advanced/spell_dir/pillarOfLife#_pillar-of-life)_ 14th—_ [greater restoration](spells/restoration#_restoration-greater)_, 16th—_ [mass cure critical wounds](spell_dir/cureCriticalWounds#_cure-critical-wounds-mass)_, 18th—_ [true resurrection](spells/trueResurrection#_true-resurrection)_.

**Insanity** : 2nd—_ [memory lapse](advance_dir/spells/memoryLapse#_memory-lapse)_, 4th—_ [hideous laughter](spell_dir/hideousLaughter#_hideous-laughter)_, 6th—_distracting cacophony_, 8th—_ [confusion](spells/confusion#_confusion)_, 10th—_ [mind fog](spell_dir/mindFog#_mind-fog)_, 12th—_ [envious urge](ultimateMagic/spell_dir/enviousUrge#_envious-urge)_, 14th—_ [insanity](spells/insanity#_insanity)_, 16th—_ [symbol of insanity](spell_dir/symbolOfInsanity#_symbol-of-insanity)_, 18th—_ [overwhelming presence](ultimateMagic/spell_dir/overwhelmingPresence#_overwhelming-presence)_.

**Light** : 2nd—_ [dancing lantern](advanced/spell_dir/dancingLantern#_dancing-lantern-)_, 4th—_ [continual flame](spells/continualFlame#_continual-flame)_, 6th—_ [daylight](spell_dir/daylight#_daylight)_, 8th—_ [rainbow pattern](spells/rainbowPattern#_rainbow-pattern)_, 10th—_ [fire snake](advance_dir/spells/fireSnake#_fire-snake)_, 12th—_ [sirocco](advance_dir/spells/sirocco#_sirocco)_, 14th—_ [sunbeam](spell_dir/sunbeam#_sunbeam)_, 16th—_ [sunburst](spells/sunburst#_sunburst)_, 18th—_fiery body_.

**Moon** : 2nd—_ [darkness](spell_dir/darkness#_darkness)_, 4th—_ [darkvision](spells/darkvision#_darkvision)_, 6th—_ [owl's wisdom](spell_dir/owlSWisdom#_owl-s-wisdom)_, 8th—_ [moonstruck](advanced/spell_dir/moonstruck#_moonstruck)_, 10th—_ [aspect of the wolf](advanced/spell_dir/aspectOfTheWolf#_aspect-of-the-wolf)_, 12th—_ [control water](spells/controlWater#_control-water)_, 14th—_ [lunar veil](ultimateMagi_dir/spells/lunarVeil#_lunar-veil)_, 16th—_ [horrid wilting](spell_dir/horridWilting#_horrid-wilting)_, 18th—_ [meteor swarm](spells/meteorSwarm#_meteor-swarm)_.

**Occult** : 2nd—_ [detect undead](spell_dir/detectUndead#_detect-undead)_, 4th—_ [command undead](spells/commandUndead#_command-undead)_, 6th—_ [twilight knife](advance_dir/spells/twilightKnife#_twilight-knife-)_, 8th—_ [black tentacles](spell_dir/blackTentacles#_black-tentacles)_, 10th—_ [snake staff](advanced/spell_dir/snakeStaff#_snake-staff)_, 12th—_ [create undead](spells/createUndead#_create-undead)_, 14th—_ [waves of exhaustion](spell_dir/wavesOfExhaustion#_waves-of-exhaustion)_, 16th—_ [trap the soul](spells/trapTheSoul#_trap-the-soul)_, 18th—_ [gate](spell_dir/gate#_gate)_.

**Portents** : 2nd—_ill-omen_, 4th—_ [locate object](spells/locateObject#_locate-object)_, 6th—_ [blood biography](advance_dir/spells/bloodBiography#_blood-biography-)_, 8th—_ [divination](spell_dir/divination#_divination)_, 10th—_ [contact other plane](spells/contactOtherPlane#_contact-other-plane)_, 12th—_ [legend lore](spell_dir/legendLore#_legend-lore)_, 14th—_ [vision](spells/vision#_vision)_, 16th—_ [moment of prescience](spell_dir/momentOfPrescience#_moment-of-prescience)_, 18th—_ [foresight](spells/foresight#_foresight)_.

**Spirits** : 2nd—_ [ghostbane dirge](advance_dir/spells/ghostbaneDirge#_ghostbane-dirge)_, 4th—_ [invisibility](spell_dir/invisibility#_invisibility)_, 6th—_ [speak with dead](spells/speakWithDead#_speak-with-dead)_, 8th—_ [spiritual ally](advance_dir/spells/spiritualAlly#_spiritual-ally)_, 10th—_ [mass ghostbane dirge](advance_dir/spells/ghostbaneDirge#_ghostbane-dirge,-mass)_, 12th—_ [shadow walk](spell_dir/shadowWalk#_shadow-walk)_, 14th—_ [ethereal jaunt](spells/etherealJaunt#_ethereal-jaunt)_, 16th—_ [planar ally](spell_dir/planarAlly#_planar-ally)_, 18th—_ [etherealness](magicItems/armor#_armor-etherealness)_.

**Stars** : 2nd—_ [faerie fire](spell_dir/faerieFire#_faerie-fire)_, 4th—_ [dust of twilight](advanced/spell_dir/dustOfTwilight#_dust-of-twilight)_, 6th—_ [guiding star](advanced/spell_dir/guidingStar#_guiding-star-)_, 8th—_ [wandering star motes](advanced/spell_dir/wanderingStarMotes#_wandering-star-motes)_, 10th—_ [dream](spells/dream#_dream)_, 12th—_ [cloak of dreams](advance_dir/spells/cloakOfDreams#_cloak-of-dreams)_ 14th—_ [circle of clarity](ultimateMagi_dir/spells/circleOfClarity#_circle-of-clarity)_, 16th—_ [euphoric tranquility](advance_dir/spells/euphoricTranquility#_euphoric-tranquility)_, 18th—_ [astral projection](spell_dir/astralProjection#_astral-projection)_.

**Time** : 2nd—_ [ventriloquism](spells/ventriloquism#_ventriloquism)_, 4th—_ [silence](spell_dir/silence#_silence)_, 6th—_ [haste](spells/haste#_haste)_, 8th—_ [threefold aspect](advance_dir/spells/threefoldAspect#_threefold-aspect)_, 10th—_ [teleport](spell_dir/teleport#_teleport)_, 12th—_ [disintegrate](spells/disintegrate#_disintegrate)_, 14th—_ [expend](advance_dir/spells/expend#_expend-)_, 16th—_ [temporal stasis](spell_dir/temporalStasis#_temporal-stasis)_, 18th—_ [time stop](spells/timeStop#_time-stop)_.

**Vengeance** : 2nd—_ [burning hands](spell_dir/burningHands#_burning-hands)_, 4th—_ [burning gaze](advanced/spell_dir/burningGaze#_burning-gaze)_, 6th—_ [pain strike](advanced/spell_dir/painStrike#_pain-strike)_, 8th—_ [shout](spells/shout#_shout)_, 10th—_ [symbol of pain](spell_dir/symbolOfPain#_symbol-of-pain)_, 12th—_ [mass pain strike](advanced/spell_dir/painStrike#_pain-strike,-mass)_, 14th—_ [phantasmal revenge](advanced/spell_dir/phantasmalRevenge#_phantasmal-revenge)_ 16th—_ [incendiary cloud](spells/incendiaryCloud#_incendiary-cloud)_, 18th—_ [winds of vengeance](advance_dir/spells/windsOfVengeance#_winds-of-vengeance)_.

**Winter** : 2nd—_ [unshakable chill](ultimateMagi_dir/spells/unshakableChill#_unshakable-chill)_, 4th—_ [resist energy](spell_dir/resistEnergy#_resist-energy)_ (cold only), 6th—_ [ice storm](spells/iceStorm#_ice-storm)_, 8th—_ [wall of ice](spell_dir/wallOfIce#_wall-of-ice)_, 10th—_ [cone of cold](spells/coneOfCold#_cone-of-cold)_, 12th—_ [freezing sphere](spell_dir/freezingSphere#_freezing-sphere)_ 14th—_ [control weather](spells/controlWeather#_control-weather)_, 16th—_ [polar ray](spell_dir/polarRay#_polar-ray)_, 18th—_ [polar midnight](ultimateMagic/spell_dir/polarMidnight#_polar-midnight)_.
...
**Spells** : A gravewalker replaces some of her patron spells with the following: 4th—_ [command undead](spells/commandUndead#_command-undead)_, 6th—_ [animate dead](spell_dir/animateDead#_animate-dead)_, 12th—_ [create undead](spells/createUndead#_create-undead)_, 14th—_ [control undead](spell_dir/controlUndead#_control-undead)_, 16th—_ [create greater undead](spells/createGreaterUndead#_create-greater-undead)_. These replace the patron spells
...
**Spells** : A sea witch replaces some of her patron spells with the following: 2nd—_touch of sea_, 4th—_ [gust of wind](spell_dir/gustOfWind#_gust-of-wind)_, 6th—_ [water breathing](spells/waterBreathing#_water-breathing)_, 8th—_ [control water](spell_dir/controlWater#_control-water)_, 10th—_ [cloudkill](spells/cloudkill#_cloudkill)_, 12th—_control wind_, 14th—_ [control weather](spell_dir/controlWeather#_control-weather)_, 16th—_ [vortex](advanced/spell_dir/vortex#_vortex)_, 18th—_ [tsunami](advanced/spell_dir/tsunami#_tsunami)_.

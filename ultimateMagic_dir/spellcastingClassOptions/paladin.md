---
title: ultimateMagi_dir/spellcastingClassOptions/paladin
---
# Paladin
...
**Oath Spells** : 1st—_ [true strike](spell_dir/trueStrike#_true-strike)_; 2nd—_ [acute senses](ultimateMagic/spell_dir/acuteSenses#_acute-senses)_; 3rd—_ [touch of idiocy](spells/touchOfIdiocy#_touch-of-idiocy)_; 4th—_ [spell immunity](spell_dir/spellImmunity#_spell-immunity)_.
...
**Anchoring Aura (Su)** : At 8th level, a paladin's aura hampers extradimensional travel by evil outsiders. The aura extends 20 feet from the paladin. Evil outsiders attempting to use abilities such as _ [dimension door](spells/dimensionDoor#_dimension-door)_, _ [plane shift](spell_dir/planeShift#_plane-shift)_, or _ [teleport](spells/teleport#_teleport)_ to leave or enter the aura must succeed at a Will save (DC 10 + 1/2 the paladin's level + the paladin's Charisma modifier); failure means the ability does not function, as if the outsider were affected by _ [dimensional anchor](spell_dir/dimensionalAnchor#_dimensional)_. The aura functions only while the paladin is conscious, not if she is unconscious or dead.

Alternatively, as an immediate action, the paladin can expend one use of her smite evil ability to target an evil outsider within 30 feet with _ [dimensional anchor](spells/dimensionalAnchor#_dimensional)_. A targeted _ [dimensional anchor](spell_dir/dimensionalAnchor#_dimensional)_ persists even if the paladin is unconscious or dead.

This ability replaces aura of resolve.

**Holy Vessel (Su)** : At 9th level, a paladin whose divine bond is with a weapon can also use her divine bond to augment her armor or shield with enhancement bonuses, or add any of the following armor or shield properties: _ [bashing](magicItems/armor#_armor-bashing)_, _ [fortification](magicItem_dir/armor#_armor-fortification)_, and _ [spell resistance](magicItems/armor#_armor-spell-resistance)_. Adding these properties consumes an amount of bonus equal to the property's cost (see the [armor special abilities](magicItem_dir/armor#_table-15-4-armor-special-abilities) and [shield special abilities](magicItems/armor#_table-15-5-shield-special-abilities) tables). She can divide her bonuses from the divine bond ability among her weapon, armor, and shield as she sees fit. This ability has no effect for a paladin whose divine bond is with a mount. This ability replaces the mercy gained at 9th level.
...
**Oath Spells** : 1st—_ [resist energy](spell_dir/resistEnergy#_resist-energy)_; 2nd—_ [detect thoughts](spells/detectThoughts#_detect-thoughts)_; 3rd—_ [invisibility purge](spell_dir/invisibilityPurge#_invisibility-purge)_; 4th—_ [plane shift](spells/planeShift#_plane-shift)_.
...
**Oath Spells** : 1st—_ [deathwatch](spell_dir/deathwatch#_deathwatch)_; 2nd—_ [protection from arrows](spells/protectionFromArrows#_protection-from-arrows)_; 3rd—_ [haste](spell_dir/haste#_haste)_; 4th—_ [divine power](spells/divinePower#_divine-power)_.
...
**Detect Undead (Su)** : This ability works like the standard paladin ability to detect evil, except as _ [detect undead](spell_dir/detectUndead#_detect-undead) _instead of _ [detect evil](spells/detectEvil#_detect-evil)_. This ability replaces _ [detect evil](spell_dir/detectEvil#_detect-evil)_.
...
**Oath Spells** : 1st—_ [sanctify corpse](ultimateMagi_dir/spells/sanctifyCorpse#_sanctify-corpse)_; 2nd—_ [darkvision](spell_dir/darkvision#_darkvision)_; 3rd—_ [searing light](spells/searingLight#_searing-light)_; 4th—_ [halt undead](spell_dir/haltUndead#_halt-undead-copy)_.
...
**Divine Bond (Sp)** : This works like the paladin's normal divine bond ability, except as follows. If the paladin's bond is with a weapon, she cannot use that ability to add the _ [brilliant energy](magicItems/weapons#_weapons-brilliant-energy)_, _ [disruption](magicItem_dir/weapons#_weapons-disruption)_, or _ [merciful](magicItems/weapons#_weapons-merciful) weapon_ properties, but she can add the _ [bane](magicItem_dir/weapons#_weapons-bane)_ weapon property (but only against dragons). If the paladin's bond is with her steed, the steed gains the paladin's aura-based immunities and her aura does not affect allies. This replaces the standard divine bond ability.

**Dragon-Slaying Strike (Su)** : At 20th level, an oathbound paladin becomes a conduit of holy power. Her DR increases to 10/evil. Whenever she uses smite evil and successfully strikes a dragon, the dragon is also subject to a single-target _ [holy word](spell_dir/holyWord#_holy-word)_, using her paladin level +10 as the caster level. After the banishment effect and the damage from the attack are resolved, the smite immediately ends. In addition, whenever she channels positive energy or uses lay on hands to heal a creature, she heals the maximum possible amount. This ability replaces holy champion.
...
**Oath Spells** : 1st—_ [enlarge person](spells/enlargePerson#_enlarge-person)_; 2nd—_ [bear's endurance](spell_dir/bearSEndurance#_bear-s-endurance)_; 3rd—_ [fly](spells/fly)_; 4th—_ [stoneskin](spell_dir/stoneskin#_stoneskin)_.
...
**Oath Spells** : 1st—_ [magic stone](spells/magicStone#_magic-stone)_; 2nd—_ [make whole](spell_dir/makeWhole#_make-whole)_; 3rd—_ [magic vestment](spells/magicVestment#_magic-vestment)_; 4th—_ [imbue with spell ability](spell_dir/imbueWithSpellAbility#_imbue-with-spell-ability)_.
...
**Oath Spells** : 1st—_ [remove fear](spell_dir/removeFear#_remove-fear)_; 2nd—_ [confess](advanced/spell_dir/confess#_confess)_; 3rd—_ [heroism](spells/heroism#_heroism)_; 4th—_ [freedom of movement](spell_dir/freedomOfMovement#_freedom-of-movement)_.
...
**Oath Spells** : 1st—_ [wrath](advanced/spell_dir/wrath#_wrath)_; 2nd—_ [aid](spells/aid#_aid)_; 3rd—_ [helping hand](spell_dir/helpingHand#_helping-hand)_; 4th—_ [sending](spells/sending#_sending)_.
...
**Oath Spells** : 1st—_ [wrath](advance_dir/spells/wrath#_wrath)_; 2nd—_ [confess](advance_dir/spells/confess#_confess)_; 3rd—_ [blessing of fervor](advance_dir/spells/blessingOfFervor#_blessing-of-fervor)_; 4th—_ [order's wrath](spell_dir/orderSWrath#_order-s-wrath)_.

---
title: ultimateMagic/spellcastingClassOption_dir/paladin
---
# Paladin
...
**Oath Spells** : 1st—_ [true strike](spell_dir/trueStrike#_true-strike_; 2nd—_ [acute senses](ultimateMagic/spell_dir/acuteSenses#_acute-senses_; 3rd—_ [touch of idiocy](spell_dir/touchOfIdiocy#_touch-of-idiocy_; 4th—_ [spell immunity](spell_dir/spellImmunity#_spell-immunity)_.
...
**Anchoring Aura (Su** : At 8th level, a paladin's aura hampers extradimensional travel by evil outsiders. The aura extends 20 feet from the paladin. Evil outsiders attempting to use abilities such as _ [dimension door](spell_dir/dimensionDoor#_dimension-door_, _ [plane shift](spell_dir/planeShift#_plane-shift_, or _ [teleport](spell_dir/teleport#_teleport_ to leave or enter the aura must succeed at a Will save (DC 10 + 1/2 the paladin's level + the paladin's Charisma modifier); failure means the ability does not function, as if the outsider were affected by _ [dimensional anchor](spell_dir/dimensionalAnchor#_dimensional_. The aura functions only while the paladin is conscious, not if she is unconscious or dead.

Alternatively, as an immediate action, the paladin can expend one use of her smite evil ability to target an evil outsider within 30 feet with _ [dimensional anchor](spell_dir/dimensionalAnchor#_dimensional_. A targeted _ [dimensional anchor](spell_dir/dimensionalAnchor#_dimensional)_ persists even if the paladin is unconscious or dead.

This ability replaces aura of resolve.

**Holy Vessel (Su** : At 9th level, a paladin whose divine bond is with a weapon can also use her divine bond to augment her armor or shield with enhancement bonuses, or add any of the following armor or shield properties: _ [bashing](magicItem_dir/armor#_armor-bashing_, _ [fortification](magicItem_dir/armor#_armor-fortification_, and _ [spell resistance](magicItem_dir/armor#_armor-spell-resistance_. Adding these properties consumes an amount of bonus equal to the property's cost (see the [armor special abilities](magicItem_dir/armor#_table-15-4-armor-special-abilities and [shield special abilities](magicItem_dir/armor#_table-15-5-shield-special-abilities) tables. She can divide her bonuses from the divine bond ability among her weapon, armor, and shield as she sees fit. This ability has no effect for a paladin whose divine bond is with a mount. This ability replaces the mercy gained at 9th level.
...
**Oath Spells** : 1st—_ [resist energy](spell_dir/resistEnergy#_resist-energy_; 2nd—_ [detect thoughts](spell_dir/detectThoughts#_detect-thoughts_; 3rd—_ [invisibility purge](spell_dir/invisibilityPurge#_invisibility-purge_; 4th—_ [plane shift](spell_dir/planeShift#_plane-shift)_.
...
**Oath Spells** : 1st—_ [deathwatch](spell_dir/deathwatch#_deathwatch_; 2nd—_ [protection from arrows](spell_dir/protectionFromArrows#_protection-from-arrows_; 3rd—_ [haste](spell_dir/haste#_haste_; 4th—_ [divine power](spell_dir/divinePower#_divine-power)_.
...
**Detect Undead (Su** : This ability works like the standard paladin ability to detect evil, except as _ [detect undead](spell_dir/detectUndead#_detect-undead _instead of _ [detect evil](spell_dir/detectEvil#_detect-evil_. This ability replaces _ [detect evil](spell_dir/detectEvil#_detect-evil)_.

**Ghost Touch Aura (Su** : At 3rd level, the paladin's armor is treated as if it had the _ [ghost touch](magicItem_dir/weapons#_weapons-ghost-touch) _armor property. This does not affect the cost or effect of any other abilities of the armor. At 9th level, this ability also applies to the paladin's shield. This ability replaces the paladin's 3rd-level and 9th-level mercies.
...
**Oath Spells** : 1st—_ [sanctify corpse](ultimateMagic/spell_dir/sanctifyCorpse#_sanctify-corpse_; 2nd—_ [darkvision](spell_dir/darkvision#_darkvision_; 3rd—_ [searing light](spell_dir/searingLight#_searing-light_; 4th—_ [halt undead](spell_dir/haltUndead#_halt-undead-copy)_.
...
**Divine Bond (Sp** : This works like the paladin's normal divine bond ability, except as follows. If the paladin's bond is with a weapon, she cannot use that ability to add the _ [brilliant energy](magicItem_dir/weapons#_weapons-brilliant-energy_, _ [disruption](magicItem_dir/weapons#_weapons-disruption_, or _ [merciful](magicItem_dir/weapons#_weapons-merciful weapon_ properties, but she can add the _ [bane](magicItem_dir/weapons#_weapons-bane)_ weapon property (but only against dragons). If the paladin's bond is with her steed, the steed gains the paladin's aura-based immunities and her aura does not affect allies. This replaces the standard divine bond ability.

**Dragon-Slaying Strike (Su** : At 20th level, an oathbound paladin becomes a conduit of holy power. Her DR increases to 10/evil. Whenever she uses smite evil and successfully strikes a dragon, the dragon is also subject to a single-target _ [holy word](spell_dir/holyWord#_holy-word_, using her paladin level +10 as the caster level. After the banishment effect and the damage from the attack are resolved, the smite immediately ends. In addition, whenever she channels positive energy or uses lay on hands to heal a creature, she heals the maximum possible amount. This ability replaces holy champion.
...
**Oath Spells** : 1st—_ [enlarge person](spell_dir/enlargePerson#_enlarge-person_; 2nd—_ [bear's endurance](spell_dir/bearSEndurance#_bear-s-endurance_; 3rd—_ [fly](spell_dir/fly_; 4th—_ [stoneskin](spell_dir/stoneskin#_stoneskin)_.
...
**Oath Spells** : 1st—_ [magic stone](spell_dir/magicStone#_magic-stone_; 2nd—_ [make whole](spell_dir/makeWhole#_make-whole_; 3rd—_ [magic vestment](spell_dir/magicVestment#_magic-vestment_; 4th—_ [imbue with spell ability](spell_dir/imbueWithSpellAbility#_imbue-with-spell-ability)_.
...
**Pure of Body (Su** : Upon reaching 8th level, the paladin has a 50% chance to turn any critical hit or sneak attack against her into a normal hit, as if she were wearing _ [fortification](magicItem_dir/armor#_armor-fortification_ armor. This ability replaces aura of resolve.

**Code of Conduct** : Never engage in a romantic relationship or a sexual act.

**Oath Spells** : 1st—_ [remove fear](spell_dir/removeFear#_remove-fear_; 2nd—_ [confess](advanced/spell_dir/confess#_confess_; 3rd—_ [heroism](spell_dir/heroism#_heroism_; 4th—_ [freedom of movement](spell_dir/freedomOfMovement#_freedom-of-movement)_.
...
**Oath Spells** : 1st—_ [wrath](advanced/spell_dir/wrath#_wrath_; 2nd—_ [aid](spell_dir/aid#_aid_; 3rd—_ [helping hand](spell_dir/helpingHand#_helping-hand_; 4th—_ [sending](spell_dir/sending#_sending)_.
...
**Oath Spells** : 1st—_ [wrath](advanced/spell_dir/wrath#_wrath_; 2nd—_ [confess](advanced/spell_dir/confess#_confess_; 3rd—_ [blessing of fervor](advanced/spell_dir/blessingOfFervor#_blessing-of-fervor_; 4th—_ [order's wrath](spell_dir/orderSWrath#_order-s-wrath_.

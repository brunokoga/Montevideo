---
layout: default
title: ultimateMagi_dir/spellcastingClassOptions/oracle
---
# Oracle
...
**Class Skills:** An oracle with the ancestor mystery adds [Linguistics](skill_dir/linguistics#_linguistics), and all [Knowledge](skills/knowledge#_knowledge) skills to her list of class skills.

**Bonus Spells** : _ [unseen servant](spell_dir/unseenServant#_unseen-servant)_ (2nd), _ [spiritual weapon](spells/spiritualWeapon#_spiritual-weapon)_ (4th), _ [heroism](spell_dir/heroism#_heroism)_ (6th), _ [spiritual ally](advanced/spell_dir/spiritualAlly#_spiritual-ally)_ (8th), _ [telekinesis](spells/telekinesis#_telekinesis)_ (10th), _ [greater heroism](spell_dir/heroism#_heroism-greater)_ (12th), _ [ethereal jaunt](spells/etherealJaunt#_ethereal-jaunt)_ (14th), _ [vision](spell_dir/vision#_vision)_ (16th), _ [astral projection](spells/astralProjection#_astral-projection)_ (18th).

**Revelations** : An oracle with the ancestor mystery can choose from any of the following revelations.

_Ancestral Weapon (Su)_: You can summon a simple or martial weapon from your family's history that is appropriate for your current size. You are considered proficient with this weapon. At 3rd level, the weapon is considered masterwork. At 7th level, 15th level, and 19th level, the weapon gains a cumulative +1 enhancement bonus. At 11th level, the weapon gains the _ [ghost touch](magicItem_dir/weapons#_weapons-ghost-touch)_ weapon property. You can use this ability for a number of minutes per day equal to your oracle level. This duration does not need to be consecutive, but it must be used in 1-minute increments. The weapon disappears after 1 round if it leaves your grasp.
...
_Wisdom of the Ancestors (Su)_: Once per day, you can enter a trance in which you commune with the spirits of your ancestors. This trance lasts for 10 minutes, which must be uninterrupted and during which you can take no other actions. When you come out of this trance, you have gained mystical insight into the future. At 1st level, this insight acts as an _ [augury](spell_dir/augury#_augury)_ spell with 80% effectiveness. At 5th level, the insight takes the form of a _ [divination](spells/divination#_divination)_ with 90% effectiveness. At 8th level, the knowledge you gain is equivalent to a _ [commune](spell_dir/commune#_commune)_ spell. None of these spell effects require material components.

**Final Revelation** : Upon reaching 20th level, you become one with the spirits of your ancestors. You gain a bonus on Will saving throws equal to your Charisma modifier, blindsense out to a range of 60 feet, and a +4 bonus on your caster level for all divination spells. You can cast _ [astral projection](spells/astralProjection#_astral-projection)_ as a spell-like ability once per day without requiring material components.

## Dark Tapestry

**Deities**

**Class Skills:** An oracle with the dark tapestry mystery adds [Disguise](skill_dir/disguise#_disguise), [Intimidate](skills/intimidate#_intimidate), [Knowledge](skill_dir/knowledge#_knowledge) (arcana), and [Stealth](skills/stealth#_stealth) to her list of class skills.

**Bonus Spells** : _ [entropic shield](spell_dir/entropicShield#_entropic-shield)_ (2nd), _ [dust of twilight](advanced/spell_dir/dustOfTwilight#_dust-of-twilight)_ (4th), _ [tongues](spells/tongues#_tongues)_ (6th), _ [black tentacles](spell_dir/blackTentacles#_black-tentacles)_ (8th), _ [feeblemind](spells/feeblemind#_feeblemind)_ (10th), _ [planar binding](spell_dir/planarBinding#_planar-binding)_ (12th), _ [insanity](spells/insanity#_insanity)_ (14th), _ [reverse gravity](spell_dir/reverseGravity#_reverse-gravity)_ (16th), _ [interplanetary teleport](ultimateMagic/spell_dir/interplanetaryTeleport#_interplanetary-teleport)_ (18th).
...
_Cloak of Darkness (Su)_: You conjure a cloak of shadowy darkness that grants you a +4 armor bonus and a +2 circumstance bonus on [Stealth](skills/stealth#_stealth) checks. At 7th level, and every four levels thereafter, these bonuses increase by +2. You can use this cloak for 1 hour per day per oracle level. The duration does not need to be consecutive, but it must be spent in 1-hour increments.
...
_Many Forms (Su)_: As a standard action, you can assume the form of a Small or Medium humanoid, as the _ [alter self](spell_dir/alterSelf#_alter-self)_ spell. At 7th level, you can assume the form of a Small or Medium animal, as _ [beast shape I](spells/beastShape#_beast-shape-i)_. At 11th level, you can assume the form of a Small or Medium magical beast, as _ [beast shape III](spell_dir/beastShape#_beast-shape-iii)_. At 15th level, you can assume a variety of forms, as _ [greater polymorph](spells/polymorph#_polymorph-greater)_. You can use this ability for 1 minute per day per oracle level. This duration does not need to be consecutive, but it must be spent in 1-minute increments. You must be at least 3rd level to select this revelation.
...
_Wings of Darkness (Su)_:As a swift action, you can manifest a set of translucent, inky wings that grant you a fly speed of 60 feet with good maneuverability. You can use these wings for 1 minute per day per oracle level. This duration does not need to be consecutive, but it must be spent in 1-minute increments. At 11th level, you can use these wings to fly as if with _ [overland flight](spell_dir/overlandFlight#_overland-flight)_ once per day. Used in this way, the ability lasts for up to 1 hour per level, and counts as your total use of this ability for the day. You must be at least 7th level to select this revelation.

**Final Revelation** : Upon reaching 20th level, you become a truly alien and unnatural creature. You gain damage reduction 5/— and immunity to acid, critical hits, and sneak attacks. Once per day, you can cast _ [shapechange](spell_dir/shapechange#_shapechange)_ as a spell-like ability without requiring a material component.

## Metal

**Deities**

**Class Skills:** An oracle with the metal mystery adds [Appraise](skills/appraise#_appraise), [Bluff](skill_dir/bluff#_bluff), [Disable Device](skills/disableDevice#_disable-device), and [Intimidate](skill_dir/intimidate#_intimidate) to her list of class skills.

**Bonus Spells** : _ [lead blades](advanced/spell_dir/leadBlades#_lead-blades-)_ (2nd), _ [heat metal](spells/heatMetal#_heat-metal)_ (4th), _ [keen edge](spell_dir/keenEdge#_keen-edge)_ (6th), _ [versatile weapon](advanced/spell_dir/versatileWeapon#_versatile-weapon)_ (8th), _ [major creation](spells/majorCreation#_major-creation)_ (metal items only) (10th), _ [wall of iron](spell_dir/wallOfIron#_wall-of-iron)_ (12th), _ [statue](spells/statue#_statue)_ (metal statue instead of iron) (14th), _ [repel metal or stone](spell_dir/repelMetalOrStone#_repel-metal-or-stone)_ (16th), _ [iron body](spells/ironBody#_iron-body)_ (18th).
...
_Riddle of Steel (Su)_: Your sacred bond with metal gives you insight into its form and function. Once per day, you may spend 10 minutes meditating on the structure of a piece of unworked metal or ore to gain a +5 insight bonus on your next [Craft](skills/craft#_craft) check to make something using that metal.
...
_Time Sight (Su)_: You can peer through the mists of time to see things as they truly are, as if using the _ [true seeing](spells/trueSeeing#_true-seeing)_ spell. At 15th level, this functions like _ [moment of prescience](spell_dir/momentOfPrescience#_moment-of-prescience)_. At 18th level, this functions like _ [foresight](spells/foresight#_foresight)_. You can use this ability for a number of minutes per day equal to your oracle level, but these minutes do not need to be consecutive. You must be at least 11th level to select this revelation.

**Final Revelation** : Upon reaching 20th level, you become a true master of time and stop aging. You cannot be magically aged and no longer take penalties to your ability scores for aging. Age bonuses still accrue, and any aging penalties that you have already accrued remain in place. You cannot die of old age, but you can be killed or die through accident, disease, poison, or other external effects. In addition, you can cast _ [time stop](spell_dir/timeStop#_time-stop)_ once per day as a spell-like ability.

## Wood

**Deities**

**Class Skills** : An oracle with the wood mystery adds [Climb](skills/climb#_climb), [Knowledge](skill_dir/knowledge#_knowledge) (nature), [Stealth](skills/stealth#_stealth), and [Survival](skill_dir/survival#_survival) to her list of class skills.

**Bonus Spells** : _ [shillelagh](spells/shillelagh#_shillelagh)_ (2nd), _ [barkskin](spell_dir/barkskin#_barkskin)_ (4th), _ [minor creation](spells/minorCreation#_minor-creation)_ (wood items only) (6th), _ [thorn body](advance_dir/spells/thornBody#_thorn-body)_ (8th), _ [tree stride](spell_dir/treeStride#_tree-stride)_ (10th), _ [ironwood](spells/ironwood#_ironwood)_ (12th), _ [transmute metal to wood](spell_dir/transmuteMetalToWood#_transmute-metal-to-wood)_ (14th), _ [changestaff](spells/changestaff#_changestaff)_ (16th), _ [wooden phalanx](ultimateMagi_dir/spells/woodenPhalanx#_wooden-phalanx)_ (18th).

**Revelations** : An oracle with the wood mystery can choose from any of the following revelations.

_Bend the Grain (Sp)_: Once per day as a standard action, you can shape or warp wooden objects. This functions as either _ [wood shape](spell_dir/woodShape#_wood-shape)_ or _ [warp wood](spells/warpWood#_warp-wood)_. At 11th level, you can use this ability to push wood away from you, as _ [repel wood](spell_dir/repelWood#_repel-wood)_. At 7th level, and again at 14th level, you can use this ability an additional time per day.

_Lignification (Su)_: Once per day, you can turn a creature into wood. As a standard action, you may direct your gaze against a single creature within 30 feet. The targeted creature (along with all its carried gear) must make a Fortitude save or turn into a mindless, inert statue made out of wood for a number of rounds equal to 1/2 your oracle level. This ability otherwise functions as a _ [flesh to stone](spell_dir/fleshToStone#_flesh-to-stone) _spell, except the target turns to wood instead of stone. This can be reverse by any effect that can reverse _ [flesh to stone](spells/fleshToStone#_flesh-to-stone)_. At 15th level, you can use this ability twice per day. You must be at least 11th level to select this revelation.
...
_Tree Form (Sp)_: As a standard action, you can assume the form of a Large living or dead tree or shrub, as _ [tree shape](spells/treeShape#_tree-shape)_. At 9th level, you can assume the form of a Small or Medium plant creature, as _ [plant shape I](spell_dir/plantShape#_plant-shape-i)_. At 11th level, you can assume the form of a Large plant creature, as _ [plant shape II](spells/plantShape#_plant-shape-ii)_. At 13th level, you can assume the form of a Huge plant creature, as _ [plant shape III](spell_dir/plantShape#_plant-shape-iii)_. You can use this ability once per day, but the duration is 1 hour/level. You must be at least 3rd level to select this revelation.
...
**Bonus Spells** : _ [ill omen](advanced/spell_dir/illOmen#_ill-omen)_ (2nd), _ [oracle's burden](advanced/spell_dir/oracleSBurden#_oracle's-burden)_ (4th), _ [bestow curse](spells/bestowCurse#_bestow-curse)_ (6th). These bonus spells replace the oracle's mystery bonus spells at these levels.
...
**Class Skills** : An enlightened philosopher adds [Linguistics](skill_dir/linguistics#_linguistics) and all [Knowledge](skills/knowledge#_knowledge) skills to her list of class skills. These replace the additional class skills from her mystery.

**Bonus Spells** : _ [owl's wisdom](spell_dir/owlSWisdom#_owl-s-wisdom)_ (4th), _ [water walk](spells/waterWalk#_water-walk)_ (6th), _ [discern lies](spell_dir/discernLies#_discern-lies)_ (8th), _ [true seeing](spells/trueSeeing#_true-seeing)_ (10th), _ [wind walk](spell_dir/windWalk#_wind-walk)_ (12th), _ [ethereal jaunt](spells/etherealJaunt#_ethereal-jaunt)_ (14th), _ [moment of prescience](spell_dir/momentOfPrescience#_moment-of-prescience)_ (16th), _ [astral projection](spells/astralProjection#_astral-projection)_ (18th). These bonus spells replace the oracle's mystery bonus spells at these levels.
...
**Final Revelation** : Upon achieving 20th level, you achieve true enlightenment and become one with the universe. You receive a bonus on all saving throws equal to your Charisma modifier. You become immune to confusion, exhaustion, fatigue, nausea, and sickened effects. You can take 20 on all [Knowledge](skill_dir/knowledge#_knowledge) skill checks. Should you die, you are reborn 3 days later as a living example of the summoning of your chosen philosophy (treat as the _ [reincarnate](spells/reincarnate#_reincarnate)_ spell). This replaces the final revelation of the oracle's mystery.
...
**Bonus Spells** : _ [endure elements](spell_dir/endureElements#_endure-elements)_ (2nd), _ [elemental speech](advanced/spell_dir/elementalSpeech#_elemental-speech)_ (4th), _ [tongues](spells/tongues#_tongues)_ (6th), _ [planar adaptation](advance_dir/spells/planarAdaptation#_planar-adaptation)_ (8th), _ [plane shift](spell_dir/planeShift#_plane-shift)_ (10th), _ [mass planar adaptation](advanced/spell_dir/planarAdaptation#_planar-adaptation,-mass)_ (12th), _ [shadow walk](spells/shadowWalk#_shadow-walk)_ (14th), _ [etherealness](magicItem_dir/armor#_armor-etherealness)_ (16th), _ [gate](spells/gate#_gate)_ (18th). These bonus spells replace the oracle's mystery bonus spells at these levels.
...
**Bonus Spells** : _ [ventriloquism](spell_dir/ventriloquism#_ventriloquism)_ (1st), _ [spider climb](spells/spiderClimb#_spider-climb)_ (4th), _ [screech](advance_dir/spells/screech#_screech)_ (6th), _ [sleepwalk](advance_dir/spells/sleepwalk#_sleepwalk)_ (8th), _ [telekinesis](spell_dir/telekinesis#_telekinesis)_ (10th), _ [animate objects](spells/animateObjects#_animate-objects)_ (12th), _ [divine vessel](advance_dir/spells/divineVessel#_divine-vessel)_ (16th). These bonus spells replace the oracle's normal mystery bonus spells at these levels.
...
**Bonus Spells** : _ [detect thoughts](spell_dir/detectThoughts#_detect-thoughts)_ (4th), _ [clairaudience/clairvoyance](spell_dir/clairaudienceClairvoyance#_clairaudience-clairvoyance)_ (6th), _ [scrying](spells/scrying#_scrying)_ (8th), _ [true seeing](spell_dir/trueSeeing#_true-seeing)_ (10th), _ [legend lore](spells/legendLore#_legend-lore)_ (12th), _ [greater scrying](spell_dir/scrying#_scrying-greater)_ (14th), _ [vision](spells/vision#_vision)_ (16th), _ [foresight](spell_dir/foresight#_foresight)_ (18th). These bonus spells replace the oracle's mystery bonus spells at these levels.

**Revelations** : A seer must take the following revelations at the listed levels.

_Natural [Divination](spells/divination#_divination) (Ex)_: As the nature mystery revelation. You must take this revelation at 1st level.

_Gift of Prophecy (Su)_: Once per day, you can enter a trance to gain a glimpse of the future. This trance lasts for 1 minute, which must be uninterrupted and during which you can take no other actions. At 3rd level, you gain the benefits of an _ [augury](spell_dir/augury#_augury)_ spell with 90% effectiveness. At 5th level, you gain the benefits of a _ [divination](spells/divination#_divination)_ spell with 90% effectiveness. At 9th level, the knowledge you gain is equivalent to a _ [commune](spell_dir/commune#_commune)_ spell. None of these spell effects require material components. You must take this revelation at 3rd level.
...
**Class Skills** : A stargazer adds [Knowledge](skills/knowledge#_knowledge) (nature), [Perception](skill_dir/perception#_perception), and [Survival](skills/survival#_survival) to her list of class skills. These replace the additional class skills from her mystery.

**Bonus Spells** : _ [faerie fire](spell_dir/faerieFire#_faerie-fire)_ (2nd), _ [glitterdust](spells/glitterdust#_glitterdust)_ (4th), _ [guiding star](advance_dir/spells/guidingStar#_guiding-star-)_ (6th), _ [wandering star motes](advance_dir/spells/wanderingStarMotes#_wandering-star-motes)_ (8th), _ [meteor swarm](spell_dir/meteorSwarm#_meteor-swarm)_ (18th). These bonus spells replace the oracle's mystery bonus spells at these levels.

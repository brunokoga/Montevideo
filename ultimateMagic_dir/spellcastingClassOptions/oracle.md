...
**Class Skills:** An oracle with the ancestor mystery adds [Linguistics](skills/linguistics#_linguistics), and all [Knowledge](skills/knowledge#_knowledge) skills to her list of class skills.

**Bonus Spells** : _ [unseen servant](spells/unseenServant#_unseen-servant)_ (2nd), _ [spiritual weapon](spells/spiritualWeapon#_spiritual-weapon)_ (4th), _ [heroism](spells/heroism#_heroism)_ (6th), _ [spiritual ally](advanced/spells/spiritualAlly#_spiritual-ally)_ (8th), _ [telekinesis](spells/telekinesis#_telekinesis)_ (10th), _ [greater heroism](spells/heroism#_heroism-greater)_ (12th), _ [ethereal jaunt](spells/etherealJaunt#_ethereal-jaunt)_ (14th), _ [vision](spells/vision#_vision)_ (16th), _ [astral projection](spells/astralProjection#_astral-projection)_ (18th).

**Revelations** : An oracle with the ancestor mystery can choose from any of the following revelations.

_Ancestral Weapon (Su)_: You can summon a simple or martial weapon from your family's history that is appropriate for your current size. You are considered proficient with this weapon. At 3rd level, the weapon is considered masterwork. At 7th level, 15th level, and 19th level, the weapon gains a cumulative +1 enhancement bonus. At 11th level, the weapon gains the _ [ghost touch](magicItems/weapons#_weapons-ghost-touch)_ weapon property. You can use this ability for a number of minutes per day equal to your oracle level. This duration does not need to be consecutive, but it must be used in 1-minute increments. The weapon disappears after 1 round if it leaves your grasp.
...
_Wings of Darkness (Su)_:As a swift action, you can manifest a set of translucent, inky wings that grant you a fly speed of 60 feet with good maneuverability. You can use these wings for 1 minute per day per oracle level. This duration does not need to be consecutive, but it must be spent in 1-minute increments. At 11th level, you can use these wings to fly as if with _ [overland flight](spells/overlandFlight#_overland-flight)_ once per day. Used in this way, the ability lasts for up to 1 hour per level, and counts as your total use of this ability for the day. You must be at least 7th level to select this revelation.

**Final Revelation** : Upon reaching 20th level, you become a truly alien and unnatural creature. You gain damage reduction 5/— and immunity to acid, critical hits, and sneak attacks. Once per day, you can cast _ [shapechange](spells/shapechange#_shapechange)_ as a spell-like ability without requiring a material component.

## Metal

**Deities**

**Class Skills:** An oracle with the metal mystery adds [Appraise](skills/appraise#_appraise), [Bluff](skills/bluff#_bluff), [Disable Device](skills/disableDevice#_disable-device), and [Intimidate](skills/intimidate#_intimidate) to her list of class skills.

**Bonus Spells** : _ [lead blades](advanced/spells/leadBlades#_lead-blades-)_ (2nd), _ [heat metal](spells/heatMetal#_heat-metal)_ (4th), _ [keen edge](spells/keenEdge#_keen-edge)_ (6th), _ [versatile weapon](advanced/spells/versatileWeapon#_versatile-weapon)_ (8th), _ [major creation](spells/majorCreation#_major-creation)_ (metal items only) (10th), _ [wall of iron](spells/wallOfIron#_wall-of-iron)_ (12th), _ [statue](spells/statue#_statue)_ (metal statue instead of iron) (14th), _ [repel metal or stone](spells/repelMetalOrStone#_repel-metal-or-stone)_ (16th), _ [iron body](spells/ironBody#_iron-body)_ (18th).
...
_Iron Skin (Sp)_: Once per day, your skin hardens and takes on the appearance of iron, granting you DR 10/adamantine. This ability functions as _ [stoneskin](spells/stoneskin#_stoneskin)_, using your oracle level as the caster level, except it only affects you. At 15th level, you can use this ability twice per day. You must be at least 11th level to select this revelation.
...
**Class Skills:** An oracle with the time mystery adds [Fly](skills/fly#_fly), [Knowledge](skills/knowledge#_knowledge) (arcana), [Perception](skills/perception#_perception), and [Use Magic Device](skills/useMagicDevice#_use-magic-device) to her list of class skills.

**Bonus Spells** : _ [memory lapse](advanced/spells/memoryLapse#_memory-lapse)_ (2nd), _ [gentle repose](spells/gentleRepose#_gentle-repose)_ (4th), _ [sands of time](ultimateMagic/spells/sandsOfTime#_sands-of-time)_ (6th), _ [threefold aspect](advanced/spells/threefoldAspect#_threefold-aspect)_ (8th), _ [permanency](spells/permanency#_permanency)_ (10th), _ [contingency](spells/contingency#_contingency)_ (12th), _ [disintegrate](spells/disintegrate#_disintegrate)_ (14th), _ [temporal stasis](spells/temporalStasis#_temporal-stasis)_ (16th), _ [time stop](spells/timeStop#_time-stop)_ (18th).
...
_Knowledge of the Ages (Su)_: You can search through time to recall some bit of forgotten lore or information. You can retry any [Knowledge](skills/knowledge#_knowledge) skill check you have made within the past minute, gaining an insight bonus on the check equal to your Charisma modifier. You can use this ability a number times per day equal to your Charisma modifier.
...
_Time Sight (Su)_: You can peer through the mists of time to see things as they truly are, as if using the _ [true seeing](spells/trueSeeing#_true-seeing)_ spell. At 15th level, this functions like _ [moment of prescience](spells/momentOfPrescience#_moment-of-prescience)_. At 18th level, this functions like _ [foresight](spells/foresight#_foresight)_. You can use this ability for a number of minutes per day equal to your oracle level, but these minutes do not need to be consecutive. You must be at least 11th level to select this revelation.

**Final Revelation** : Upon reaching 20th level, you become a true master of time and stop aging. You cannot be magically aged and no longer take penalties to your ability scores for aging. Age bonuses still accrue, and any aging penalties that you have already accrued remain in place. You cannot die of old age, but you can be killed or die through accident, disease, poison, or other external effects. In addition, you can cast _ [time stop](spells/timeStop#_time-stop)_ once per day as a spell-like ability.

## Wood

**Deities**

**Class Skills** : An oracle with the wood mystery adds [Climb](skills/climb#_climb), [Knowledge](skills/knowledge#_knowledge) (nature), [Stealth](skills/stealth#_stealth), and [Survival](skills/survival#_survival) to her list of class skills.

**Bonus Spells** : _ [shillelagh](spells/shillelagh#_shillelagh)_ (2nd), _ [barkskin](spells/barkskin#_barkskin)_ (4th), _ [minor creation](spells/minorCreation#_minor-creation)_ (wood items only) (6th), _ [thorn body](advanced/spells/thornBody#_thorn-body)_ (8th), _ [tree stride](spells/treeStride#_tree-stride)_ (10th), _ [ironwood](spells/ironwood#_ironwood)_ (12th), _ [transmute metal to wood](spells/transmuteMetalToWood#_transmute-metal-to-wood)_ (14th), _ [changestaff](spells/changestaff#_changestaff)_ (16th), _ [wooden phalanx](ultimateMagic/spells/woodenPhalanx#_wooden-phalanx)_ (18th).

**Revelations** : An oracle with the wood mystery can choose from any of the following revelations.

_Bend the Grain (Sp)_: Once per day as a standard action, you can shape or warp wooden objects. This functions as either _ [wood shape](spells/woodShape#_wood-shape)_ or _ [warp wood](spells/warpWood#_warp-wood)_. At 11th level, you can use this ability to push wood away from you, as _ [repel wood](spells/repelWood#_repel-wood)_. At 7th level, and again at 14th level, you can use this ability an additional time per day.

_Lignification (Su)_: Once per day, you can turn a creature into wood. As a standard action, you may direct your gaze against a single creature within 30 feet. The targeted creature (along with all its carried gear) must make a Fortitude save or turn into a mindless, inert statue made out of wood for a number of rounds equal to 1/2 your oracle level. This ability otherwise functions as a _ [flesh to stone](spells/fleshToStone#_flesh-to-stone) _spell, except the target turns to wood instead of stone. This can be reverse by any effect that can reverse _ [flesh to stone](spells/fleshToStone#_flesh-to-stone)_. At 15th level, you can use this ability twice per day. You must be at least 11th level to select this revelation.

_Speak with Wood (Sp)_: You can talk to wood and learn what it knows. You must spend 1 minute meditating on and communing with the wood. At the end of this time, you can speak with the wood. This functions as the _ [stone tell](spells/stoneTell#_stone-tell)_ spell, except with wood instead of stones. You can use this ability for 1 minute per oracle level. This duration does not need to be consecutive, but it must be used in 1-minute increments. You can speak with natural or worked wood. You must be at least 11th level to select this revelation.
...
_Tree Form (Sp)_: As a standard action, you can assume the form of a Large living or dead tree or shrub, as _ [tree shape](spells/treeShape#_tree-shape)_. At 9th level, you can assume the form of a Small or Medium plant creature, as _ [plant shape I](spells/plantShape#_plant-shape-i)_. At 11th level, you can assume the form of a Large plant creature, as _ [plant shape II](spells/plantShape#_plant-shape-ii)_. At 13th level, you can assume the form of a Huge plant creature, as _ [plant shape III](spells/plantShape#_plant-shape-iii)_. You can use this ability once per day, but the duration is 1 hour/level. You must be at least 3rd level to select this revelation.
...
**Final Revelation** : Upon reaching 20th level, you become a living creature of wood. You are forevermore treated as the plant type rather than your original type for the purpose of spells and magical effects. Your skin takes on the appearance of polished wood grain, and you gain a +4 natural armor bonus to your Armor Class and damage reduction 10/— against wooden weapons or any natural attacks made by a wooden or woodlike creature. You gain immunity to paralysis, poison, polymorph, sleep, and stunning. At will, you can meld with any tree or single block of wood (as _ [meld into stone](spells/meldIntoStone#_meld-into-stone)_, except wood only, and with no limit to how long you can remain in the wood).
...
**Bonus Spells** : _ [ill omen](advanced/spells/illOmen#_ill-omen)_ (2nd), _ [oracle's burden](advanced/spells/oracleSBurden#_oracle's-burden)_ (4th), _ [bestow curse](spells/bestowCurse#_bestow-curse)_ (6th). These bonus spells replace the oracle's mystery bonus spells at these levels.
...
**Class Skills** : An enlightened philosopher adds [Linguistics](skills/linguistics#_linguistics) and all [Knowledge](skills/knowledge#_knowledge) skills to her list of class skills. These replace the additional class skills from her mystery.

**Bonus Spells** : _ [owl's wisdom](spells/owlSWisdom#_owl-s-wisdom)_ (4th), _ [water walk](spells/waterWalk#_water-walk)_ (6th), _ [discern lies](spells/discernLies#_discern-lies)_ (8th), _ [true seeing](spells/trueSeeing#_true-seeing)_ (10th), _ [wind walk](spells/windWalk#_wind-walk)_ (12th), _ [ethereal jaunt](spells/etherealJaunt#_ethereal-jaunt)_ (14th), _ [moment of prescience](spells/momentOfPrescience#_moment-of-prescience)_ (16th), _ [astral projection](spells/astralProjection#_astral-projection)_ (18th). These bonus spells replace the oracle's mystery bonus spells at these levels.
...
**Final Revelation** : Upon achieving 20th level, you achieve true enlightenment and become one with the universe. You receive a bonus on all saving throws equal to your Charisma modifier. You become immune to confusion, exhaustion, fatigue, nausea, and sickened effects. You can take 20 on all [Knowledge](skills/knowledge#_knowledge) skill checks. Should you die, you are reborn 3 days later as a living example of the summoning of your chosen philosophy (treat as the _ [reincarnate](spells/reincarnate#_reincarnate)_ spell). This replaces the final revelation of the oracle's mystery.
...
**Bonus Spells** : _ [endure elements](spells/endureElements#_endure-elements)_ (2nd), _ [elemental speech](advanced/spells/elementalSpeech#_elemental-speech)_ (4th), _ [tongues](spells/tongues#_tongues)_ (6th), _ [planar adaptation](advanced/spells/planarAdaptation#_planar-adaptation)_ (8th), _ [plane shift](spells/planeShift#_plane-shift)_ (10th), _ [mass planar adaptation](advanced/spells/planarAdaptation#_planar-adaptation,-mass)_ (12th), _ [shadow walk](spells/shadowWalk#_shadow-walk)_ (14th), _ [etherealness](magicItems/armor#_armor-etherealness)_ (16th), _ [gate](spells/gate#_gate)_ (18th). These bonus spells replace the oracle's mystery bonus spells at these levels.
...
_Planar [Resistance](spells/resistance#_resistance) (Su)_: At 3rd level, you gain energy resistance 10 against one energy type associated with your chosen plane. At 11th level, your energy resistance increases to 20.
...
**Bonus Spells** : _ [ventriloquism](spells/ventriloquism#_ventriloquism)_ (1st), _ [spider climb](spells/spiderClimb#_spider-climb)_ (4th), _ [screech](advanced/spells/screech#_screech)_ (6th), _ [sleepwalk](advanced/spells/sleepwalk#_sleepwalk)_ (8th), _ [telekinesis](spells/telekinesis#_telekinesis)_ (10th), _ [animate objects](spells/animateObjects#_animate-objects)_ (12th), _ [divine vessel](advanced/spells/divineVessel#_divine-vessel)_ (16th). These bonus spells replace the oracle's normal mystery bonus spells at these levels.
...
**Bonus Spells** : _ [detect thoughts](spells/detectThoughts#_detect-thoughts)_ (4th), _ [clairaudience/clairvoyance](spells/clairaudienceClairvoyance#_clairaudience-clairvoyance)_ (6th), _ [scrying](spells/scrying#_scrying)_ (8th), _ [true seeing](spells/trueSeeing#_true-seeing)_ (10th), _ [legend lore](spells/legendLore#_legend-lore)_ (12th), _ [greater scrying](spells/scrying#_scrying-greater)_ (14th), _ [vision](spells/vision#_vision)_ (16th), _ [foresight](spells/foresight#_foresight)_ (18th). These bonus spells replace the oracle's mystery bonus spells at these levels.
...
**Class Skills** : A stargazer adds [Knowledge](skills/knowledge#_knowledge) (nature), [Perception](skills/perception#_perception), and [Survival](skills/survival#_survival) to her list of class skills. These replace the additional class skills from her mystery.

**Bonus Spells** : _ [faerie fire](spells/faerieFire#_faerie-fire)_ (2nd), _ [glitterdust](spells/glitterdust#_glitterdust)_ (4th), _ [guiding star](advanced/spells/guidingStar#_guiding-star-)_ (6th), _ [wandering star motes](advanced/spells/wanderingStarMotes#_wandering-star-motes)_ (8th), _ [meteor swarm](spells/meteorSwarm#_meteor-swarm)_ (18th). These bonus spells replace the oracle's mystery bonus spells at these levels.

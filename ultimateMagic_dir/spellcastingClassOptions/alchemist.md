...
_Alchemical Simulacrum (Su)_: The alchemist gains the ability to create a lesser simulacrum. This works like the _ [lesser simulacrum](ultimateMagic/spells/simulacrum#_simulacrum,-lesser)_\* spell, except it costs 100 gp in alchemical materials per Hit Die of the simulacrum, requires 24 hours to grow, and decays into inert flesh rather than ice or snow if killed. An alchemist must be at least 8th level before selecting this discovery. The created simulacrum is a creature, not a supernatural effect.
...
_Confusion Bomb\* (Su)_: The alchemist's bombs twist the target's perception of friend and foe. A creature that takes a direct hit from a confusion bomb takes damage from the bomb and is under the effect of a _ [confusion](spells/confusion#_confusion)_ spell for 1 round per caster level of the alchemist. Reduce the amount of normal damage dealt by the bomb by 2d6 (so a bomb that would normally deal 6d6+4 points of damage deals 4d6+4 points of damage instead). An alchemist must be at least 8th level before selecting this discovery.
...
**Anaesthetic** : At 5th level, a chirurgeon learns how to supplement uses of the [Heal](skills/heal#_heal) skill with pain-killing drugs. He gains [Skill Focus](feats#_skill-focus) ( [Heal](skills/heal#_heal)) as a bonus feat. Any use of the [Heal](skills/heal#_heal) skill that has a risk of harming the patient (such as extracting a barb) only deals the minimum damage when performed by a chirurgeon. This ability replaces poison resistance +4.
...
**Lesser Simulacrum** : At 7th level, a clone master adds _ [lesser simulacrum](ultimateMagic/spells/simulacrum#_simulacrum,-lesser)_ to his formula book as a 3rd-level extract.

**Rebirth** : At 8th level, a clone master can prepare a clone of himself that awakens if he is slain. Creating the clone costs 5,000 gp, takes 1 week of work, and requires 3 additional weeks for the clone to grow to maturity. If he dies, the clone awakens as if the alchemist had used the _ [clone](spells/clone#_clone)_ spell on himself. He can have one inert of himself at a time. Unused clones created by a clone master do not rot. This ability replaces poison resistance +6 and poison immunity.
...
**Clone** : At 16th level, a clone master adds _ [clone](spells/clone#_clone)_ to his formula book as a 6th-level extract.
...
**Bottled Ally IV** : At 10th level, a preservationist adds _ [summon nature's ally V](spells/summonNatureSAlly#_summon-nature-s-ally-v)_ to his formula book as a 4th-level extract. This ability replaces poison immunity.
...
**Bottled Ally VI** : At 18 level, a preservationist adds _ [summon nature's ally IX](spells/summonNatureSAlly#_summon-nature-s-ally-ix)_ to his formula book as a 6th-level extract. This ability replaces his 18th-level discovery.
...
**Psychic Senses** : At 8th level, a psychonaut adds _ [clairaudience/clairvoyance](spells/clairaudienceClairvoyance#_clairaudience-clairvoyance)_, _ [detect scrying](spells/detectScrying#_detect-scrying)_, _ [scrying](spells/scrying#_scrying)_, and _ [speak with dead](spells/speakWithDead#_speak-with-dead)_ to his formula book as 3rd-level extracts (a _ [scrying](spells/scrying#_scrying)_ extract does not require a focus or divine focus component). When a psychonaut uses a _ [speak with dead](spells/speakWithDead#_speak-with-dead) _extract, he gains the power to hear the lingering spirit within a corpse rather than enabling the corpse to audibly speak, but the extract otherwise works as the spell. This ability replaces poison resistance +6.

**Remote Consciousness** : At 10th level, a psychonaut adds _ [dream](spells/dream#_dream)_, _ [lesser astral projection](ultimateMagic/spells/astralProjection#_astral-projection,-lesser)_, _ [nightmare](spells/nightmare#_nightmare)_, _ [plane shift](spells/planeShift#_plane-shift)_, _ [sending](spells/sending#_sending)_, and _ [telepathic bond](spells/telepathicBond#_telepathic-bond)_ to his formula book as 4th-level extracts (a _ [plane shift](spells/planeShift#_plane-shift)_ extract does not require a focus component). This ability replaces poison immunity.
...
**Master Precognition** : At 17th level, a psychonaut adds _ [foresight](spells/foresight#_foresight)_ to his formula book as a 6th-level extract. This ability replaces the increase to bomb damage at this level.
...
**Create Greater Undead** : At 15th level, a reanimator adds _ [create greater undead](spells/createGreaterUndead#_create-greater-undead)_ to his formula book as a 5th-level extract. This otherwise acts similarly to a _ [create undead](spells/createUndead#_create-undead)_ extract. This ability replaces the increase to bomb damage at this level.
...
**Torturer's Eye** : At 2nd level, a vivisectionist adds _ [deathwatch](spells/deathwatch#_deathwatch)_ to his formula book as a 1st-level extract.

**Cruel Anatomist** : At 3rd level, a vivisectionist may use his [Knowledge](skills/knowledge#_knowledge) (nature) skill bonus in place of his [Heal](skills/heal#_heal) skill bonus.

**Torturous Transformation** : At 7th level, a vivisectionist adds _ [anthropomorphic animal](ultimateMagic/spells/anthropomorphicAnimal#_anthropomorphic-animal)_ to his formula book as a 2nd-level extract. When he uses this extract, he injects it into an animal as part of a 2-hour surgical procedure. By using multiple doses of this extract as part of the surgery, he multiplies the duration by the number of extracts used.

At 9th level, a vivisectionist adds _ [awaken](spells/awaken#_awaken)_ and _ [baleful polymorph](spells/balefulPolymorph#_baleful-polymorph)_ to his formula book as 3rd-level extracts. When he uses the _ [awaken](spells/awaken#_awaken)_ or _ [baleful polymorph](spells/balefulPolymorph#_baleful-polymorph)_ extract, he injects it into the target (not a plant) as part of a 24-hour surgical procedure. He can make _ [anthropomorphic animal](ultimateMagic/spells/anthropomorphicAnimal#_anthropomorphic-animal)_ permanent on a creature by spending 7,500 gp.

---
layout: default
title: ultimateMagi_dir/spellcastingClassOptions/alchemist
---
# Alchemist
...
_Alchemical Simulacrum (Su)_: The alchemist gains the ability to create a lesser simulacrum. This works like the _ [lesser simulacrum](ultimateMagic/spell_dir/simulacrum#_simulacrum,-lesser)_\* spell, except it costs 100 gp in alchemical materials per Hit Die of the simulacrum, requires 24 hours to grow, and decays into inert flesh rather than ice or snow if killed. An alchemist must be at least 8th level before selecting this discovery. The created simulacrum is a creature, not a supernatural effect.

_Alchemical Zombie (Su)_: The alchemist gains the ability to animate a relatively complete corpse as an alchemy-powered zombie. This process takes 1 hour and costs 100 gp in alchemical reagents per HD of the corpse being animated; the dead creature gains the zombie template. Zombies that are created in this manner count as undead created by _ [animate dead](spells/animateDead#_animate-dead)_ for the purposes of determining how many undead the alchemist can control. An alchemist must be at least 8th level before selecting this discovery. The created zombie is a creature, not a supernatural effect.
...
_Greater Alchemical Simulacrum (Su)_: The alchemist gains the ability to create a simulacrum. This works like the _ [simulacrum](spells/simulacrum#_simulacrum)_ spell, except it costs 100 gp in alchemical materials per Hit Die of the simulacrum, requires 24 hours to grow, and decays into inert flesh rather than ice or snow if killed. An alchemist must be at least 14th level and must have the alchemical simulacrum discovery before selecting this discovery. The created simulacrum is a creature, not a supernatural effect.
...
**Anaesthetic** : At 5th level, a chirurgeon learns how to supplement uses of the [Heal](skill_dir/heal#_heal) skill with pain-killing drugs. He gains [Skill Focus](feats#_skill-focus) ( [Heal](skills/heal#_heal)) as a bonus feat. Any use of the [Heal](skill_dir/heal#_heal) skill that has a risk of harming the patient (such as extracting a barb) only deals the minimum damage when performed by a chirurgeon. This ability replaces poison resistance +4.

**Power Over Death** : At 10th level, a chirurgeon adds _ [breath of life](spells/breathOfLife#_breath-of-life)_ to his formula book as a 4th-level extract. His infused curative ability applies to this extract. This ability replaces poison immunity.
...
**Lesser Simulacrum** : At 7th level, a clone master adds _ [lesser simulacrum](ultimateMagi_dir/spells/simulacrum#_simulacrum,-lesser)_ to his formula book as a 3rd-level extract.

**Rebirth** : At 8th level, a clone master can prepare a clone of himself that awakens if he is slain. Creating the clone costs 5,000 gp, takes 1 week of work, and requires 3 additional weeks for the clone to grow to maturity. If he dies, the clone awakens as if the alchemist had used the _ [clone](spell_dir/clone#_clone)_ spell on himself. He can have one inert of himself at a time. Unused clones created by a clone master do not rot. This ability replaces poison resistance +6 and poison immunity.

**Simulacrum** : At 13th level, a clone master adds _ [simulacrum](spells/simulacrum#_simulacrum)_ to his formula book as a 5th-level extract.
...
**Perfect Recall** : At 2nd level, a mindchemist has honed his memory. When making a [Knowledge](skill_dir/knowledge#_knowledge) check, he may add his Intelligence bonus on the check a second time. Thus, a mindchemist with 5 ranks in [Knowledge](skills/knowledge#_knowledge) (history) and a +2 Intelligence bonus has a total skill bonus of +9 (5 + 2 + 2) using this ability. The mindchemist can also use this ability when making an Intelligence check to remember something. This ability replaces poison use.

**Bonus Feats** : A mindchemist may select [Skill Focus](feats#_skill-focus) ( [Disable Device](skill_dir/disableDevice#_disable-device), [Disguise](skills/disguise#_disguise), [Heal](skill_dir/heal#_heal), any [Knowledge](skills/knowledge#_knowledge) skill, [Sense Motive](skill_dir/senseMotive#_sense-motive), or [Spellcraft](skills/spellcraft#_spellcraft)) in place of a discovery.
...
**Bottled Ally II** : At 5th level, a preservationist adds _ [summon nature's ally II](spell_dir/summonNatureSAlly#_summon-nature-s-ally-ii)_ to his formula book as a 2nd-level extract. This ability replaces poison resistance +4.

**Bottled Ally III** : At 8th level, a preservationist adds _ [summon nature's ally IV](spells/summonNatureSAlly#_summon-nature-s-ally-iv)_ to his formula book as a 3rd-level extract. This ability replaces poison resistance +6.

**Bottled Ally IV** : At 10th level, a preservationist adds _ [summon nature's ally V](spell_dir/summonNatureSAlly#_summon-nature-s-ally-v)_ to his formula book as a 4th-level extract. This ability replaces poison immunity.

**Bottled Ally V** : At 14th level, a preservationist adds _ [summon nature's ally VII](spells/summonNatureSAlly#_summon-nature-s-ally-vii)_ to his formula book as a 5th-level extract. This ability replaces persistent mutagen.
...
**Precognition** : At 5th level, a psychonaut adds _ [augury](spells/augury#_augury)_ to his formula book as a 2nd-level extract (this extract does not require a divine focus component). This replaces poison resistance +4.

**Psychic Senses** : At 8th level, a psychonaut adds _ [clairaudienc_dir/clairvoyance](spells/clairaudienceClairvoyance#_clairaudience-clairvoyance)_, _ [detect scrying](spell_dir/detectScrying#_detect-scrying)_, _ [scrying](spells/scrying#_scrying)_, and _ [speak with dead](spell_dir/speakWithDead#_speak-with-dead)_ to his formula book as 3rd-level extracts (a _ [scrying](spells/scrying#_scrying)_ extract does not require a focus or divine focus component). When a psychonaut uses a _ [speak with dead](spell_dir/speakWithDead#_speak-with-dead) _extract, he gains the power to hear the lingering spirit within a corpse rather than enabling the corpse to audibly speak, but the extract otherwise works as the spell. This ability replaces poison resistance +6.

**Remote Consciousness** : At 10th level, a psychonaut adds _ [dream](spells/dream#_dream)_, _ [lesser astral projection](ultimateMagi_dir/spells/astralProjection#_astral-projection,-lesser)_, _ [nightmare](spell_dir/nightmare#_nightmare)_, _ [plane shift](spells/planeShift#_plane-shift)_, _ [sending](spell_dir/sending#_sending)_, and _ [telepathic bond](spells/telepathicBond#_telepathic-bond)_ to his formula book as 4th-level extracts (a _ [plane shift](spell_dir/planeShift#_plane-shift)_ extract does not require a focus component). This ability replaces poison immunity.

**Greater Precognition** : At 15th level, a psychonaut adds _ [moment of prescience](spells/momentOfPrescience#_moment-of-prescience)_ to his formula book as a 5th-level extract. This ability replaces the increase to bomb damage at this level.
...
**Create Undead** : At 13th level, a reanimator adds _ [create undead](spells/createUndead#_create-undead)_ to his formula book as a 4th-level extract. When he uses that extract, rather than drinking it, he injects it into the corpse he intends to animate, which rises as an uncontrolled undead 1 hour later. The extract can only create corporeal undead. This ability replaces the increase to bomb damage at this level.

**Create Greater Undead** : At 15th level, a reanimator adds _ [create greater undead](spell_dir/createGreaterUndead#_create-greater-undead)_ to his formula book as a 5th-level extract. This otherwise acts similarly to a _ [create undead](spells/createUndead#_create-undead)_ extract. This ability replaces the increase to bomb damage at this level.
...
**Torturer's Eye** : At 2nd level, a vivisectionist adds _ [deathwatch](spell_dir/deathwatch#_deathwatch)_ to his formula book as a 1st-level extract.

**Cruel Anatomist** : At 3rd level, a vivisectionist may use his [Knowledge](skills/knowledge#_knowledge) (nature) skill bonus in place of his [Heal](skill_dir/heal#_heal) skill bonus.

**Torturous Transformation** : At 7th level, a vivisectionist adds _ [anthropomorphic animal](ultimateMagic/spell_dir/anthropomorphicAnimal#_anthropomorphic-animal)_ to his formula book as a 2nd-level extract. When he uses this extract, he injects it into an animal as part of a 2-hour surgical procedure. By using multiple doses of this extract as part of the surgery, he multiplies the duration by the number of extracts used.

At 9th level, a vivisectionist adds _ [awaken](spells/awaken#_awaken)_ and _ [baleful polymorph](spell_dir/balefulPolymorph#_baleful-polymorph)_ to his formula book as 3rd-level extracts. When he uses the _ [awaken](spells/awaken#_awaken)_ or _ [baleful polymorph](spell_dir/balefulPolymorph#_baleful-polymorph)_ extract, he injects it into the target (not a plant) as part of a 24-hour surgical procedure. He can make _ [anthropomorphic animal](ultimateMagic/spell_dir/anthropomorphicAnimal#_anthropomorphic-animal)_ permanent on a creature by spending 7,500 gp.

At 15th level, a vivisectionist adds _ [regenerate](spells/regenerate#_regenerate)_ to his formula book as a 5th-level extract.

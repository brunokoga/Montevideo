---
title: ultimateMagic/spellcastingClassOption_dir/druid
---
# Druid
...
**Seastrike (Su)** : At 6th level, as a free action, you may use natural and manufactured weapons in water as if you had continuous _ [freedom of movement](spell_dir/freedomOfMovement#_freedom-of-movement_. As a standard action, you can throw a weapon underwater without the normal penalties for throwing weapons; if your target is in or under the water, the weapon also acts as a _ [returning](magicItem_dir/weapons#_weapons-returning)_ weapon (see page 471 of the _Core Rulebook_ for that attack.

**Domain Spells** : 1st—_ [hydraulic push](advanced/spell_dir/hydraulicPush#_hydraulic-push-_, 2nd—_ [slipstream](advanced/spell_dir/slipstream#_slipstream_, 3rd—_ [water breathing](spell_dir/waterBreathing#_water-breathing_, 4th—_ [freedom of movement](spell_dir/freedomOfMovement#_freedom-of-movement_, 5th—_ [black tentacles](spell_dir/blackTentacles#_black-tentacles_, 6th—_ [freezing sphere](spell_dir/freezingSphere#_freezing-sphere_, 7th—_ [animal shapes](spell_dir/animalShapes#_animal-shapes)_ (aquatic creatures only, 8th—_ [seamantle](advanced/spell_dir/seamantle#_seamantle_, 9th—_ [tsunami](advanced/spell_dir/tsunami#_tsunami)_.
...
**Banish Flame (Su)** : At 6th level, you may use your call cold ability to damage creatures with the fire subtype (as a cleric channeling negative energy) or to cause them to flee from you (as the [Turn Undead](feats#_turn-undead) feat). Alternatively, you may use this ability to negate magical fire effects as if using a targeted _ [dispel magic](spell_dir/dispelMagic#_dispel-magic_; at 12th level, this functions as targeted or area _ [greater dispel magic](spell_dir/dispelMagic#_dispel-magic-greater_ instead of _ [dispel magic](spell_dir/dispelMagic#_dispel-magic_.

**Domain Spells** : 1st—_ [frostbite](ultimateMagic/spell_dir/frostbite#_frostbite_, 2nd—_ [aspect of the bear](advanced/spell_dir/aspectOfTheBear#_aspect-of-the-bear_, 3rd—_ [sleet storm](spell_dir/sleetStorm#_sleet-storm_, 4th—_ [wall of ice](spell_dir/wallOfIce#_wall-of-ice_, 5th—_ [aspect of the wolf](advanced/spell_dir/aspectOfTheWolf#_aspect-of-the-wolf_, 6th—_ [freezing sphere](spell_dir/freezingSphere#_freezing-sphere_, 7th—_ [wind walk](spell_dir/windWalk#_wind-walk_, 8th—_ [polar ray](spell_dir/polarRay#_polar-ray_, 9th—_ [polar midnight](ultimateMagic/spell_dir/polarMidnight#_polar-midnight)_.
...
**Domain Spells** : 1st—_ [detect aberration](advanced/spell_dir/detectAberration#_detect-aberration_, 2nd—_ [stone call](advanced/spell_dir/stoneCall#_stone-call_, 3rd—_ [deeper darkness](spell_dir/deeperDarkness#_deeper-darkness_, 4th—_echolocation_, 5th—_ [wall of stone](spell_dir/wallOfStone#_wall-of-stone_, 6th—_ [conjure black pudding](ultimateMagic/spell_dir/conjureBlackPudding#_conjure-black-pudding_, 7th—_ [statue](spell_dir/statue#_statue)_ (looking like a stalagmite or stalactite, 8th—_ [earthquake](spell_dir/earthquake#_earthquake_, 9th—_ [imprisonment](spell_dir/imprisonment#_imprisonment)_.

## Desert Domain

**Granted Powers** : The spirits and secrets of the endless wastes are yours to command.

**Heat Shimmer (Su** : As a free action, you can surround yourself with heat distortion that acts as the _ [blur](spell_dir/blur#_blur)_ spell. Creatures that strike you in melee while you're using this ability are dazzled for 1 round (Fortitude negates). You may use this ability for a number of rounds per day equal to 3 + your Wisdom modifier. These rounds need not be consecutive.

**Servant of the Sands (Sp** : At 8th level, once per day, you may call upon the aid of a janni as if using _ [lesser planar ally](spell_dir/planarAlly#_planar-ally-lesser)_. At 12th level, you may call upon the aid of any type of common (non-noble genie as if using _ [planar ally](spell_dir/planarAlly#_planar-ally_. At 16th level, you may call upon the aid of a noble genie as if using _ [greater planar ally](spell_dir/planarAlly#_planar-ally-greater)_. If you use this power while in desert terrain, you need not make an offering to call the creature(s, and the cost of any service is halved.

**Domain Spells** : 1st—_ [cloak of shade](advanced/spell_dir/cloakOfShade#_cloak-of-shade_, 2nd—_ [shifting sand](advanced/spell_dir/shiftingSand#_shifting-sand_, 3rd—_ [cup of dust](advanced/spell_dir/cupOfDust#_cup-of-dust_, 4th—_ [hallucinatory terrain](spell_dir/hallucinatoryTerrain#_hallucinatory-terrain_, 5th—_ [transmute rock to mud](spell_dir/transmuteRockToMud#_transmute-rock-to-mud)_ (creates loose sand instead of mud, 6th—_ [sirocco](advanced/spell_dir/sirocco#_sirocco_, 7th—_ [sunbeam](spell_dir/sunbeam#_sunbeam_, 8th—_ [sunburst](spell_dir/sunburst#_sunburst_, 9th—_ [horrid wilting](spell_dir/horridWilting#_horrid-wilting)_.
...
**Hawkeye (Su)** : As a swift action, you may add a bonus equal to half your druid level (minimum +1 on one ranged attack or on one [Perception](skill_dir/perception#_perception) check. You can use this ability a number of times per day equal to 3 + your Wisdom modifier.
...
**Domain Spells** : 1st—_ [aspect of the falcon](advanced/spell_dir/aspectOfTheFalcon#_aspect-of-the-falcon_, 2nd—_ [eagle's splendor](spell_dir/eagleSSplendor#_eagle-s-splendor_, 3rd—_ [fly](spell_dir/fly_, 4th—_ [river of wind](advanced/spell_dir/riverOfWind#_river-of-wind_, 5th—_ [overland flight](spell_dir/overlandFlight#_overland-flight_, 6th—_ [eagle aerie](ultimateMagic/spell_dir/eagleAerie#_eagle-aerie_, 7th—_ [animal shapes](spell_dir/animalShapes#_animal-shapes)_ (birds only, 8th—_ [sunburst](spell_dir/sunburst#_sunburst_, 9th—_ [winds of vengeance](advanced/spell_dir/windsOfVengeance#_winds-of-vengeance)_.
...
**Domain Spells** : 1st—_ [jump](spell_dir/jump#_jump_, 2nd—_ [delay poison](spell_dir/delayPoison#_delay-poison_, 3rd—_ [lily pad stride](advanced/spell_dir/lilyPadStride#_lily-pad-stride_, 4th—_ [shout](spell_dir/shout#_shout_, 5th—_ [blessing of the salamander](advanced/spell_dir/blessingOfTheSalamander#_blessing-of-the-salamander_, 6th—_ [confusion](spell_dir/confusion#_confusion_, 7th—_ [animal shapes](spell_dir/animalShapes#_animal-shapes)_ (amphibians only, 8th—_ [greater shout](spell_dir/shout#_shout-greater_, 9th—_ [summon froghemoth](ultimateMagic/spell_dir/summonFroghemoth#_summon-froghemoth)_.

## Jungle Domain

**Granted Powers** : The spirits of the jungle, both of natural guardians and lost civilizations, whisper in your heart.

**Brachiation (Ex** : As a free action for a number of rounds per day equal to your druid level, you may climb with a climb speed equal to your land speed, and gain a bonus on [Acrobatics](skill_dir/acrobatics#_acrobatics) checks equal to your druid level. These rounds do not have to be consecutive.
...
**Domain Spells** : 1st—_ [glide](advanced/spell_dir/glide#_glide-_, 2nd—_ [tar ball](ultimateMagic/spell_dir/tarBall#_tar-ball_, 3rd—_ [venomous bolt](advanced/spell_dir/venomousBolt#_venomous-bolt_, 4th—_ [arboreal hammer](ultimateMagic/spell_dir/arborealHammer#_arboreal-hammer_, 5th—_ [blessing of the salamander](advanced/spell_dir/blessingOfTheSalamander#_blessing-of-the-salamander_, 6th—_ [swarm skin](advanced/spell_dir/swarmSkin#_swarm-skin-_, 7th—_ [creeping doom](spell_dir/creepingDoom#_creeping-doom_, 8th—_ [wall of lava](advanced/spell_dir/wallOfLava#_wall-of-lava_, 9th—_ [shambler](spell_dir/shambler#_shambler)_.
...
**Monkey Athletics (Su)** : As a free action, you may add a competence bonus equal to half your druid level (minimum of +1 on one [Acrobatics](skill_dir/acrobatics#_acrobatics, [Climb](skill_dir/climb#_climb, [Disable Device](skill_dir/disableDevice#_disable-device, or [Sleight of Hand](skill_dir/sleightOfHand#_sleight-of-hand) check. You can use this ability a number of times per day equal to 3 + your Wisdom modifier.

**Ranged Legerdemain (Su** : At 6th level, you can use the [Disable Device](skill_dir/disableDevice#_disable-device and [Sleight of Hand](skill_dir/sleightOfHand#_sleight-of-hand skills at a range of 30 feet. Working at a distance increases the normal skill check DC by 5, and you cannot take 10 on this check. Any object to be manipulated must weigh 5 pounds or less. You can only use this ability if you have at least 1 rank in the skill being used.

**Domain Spells** : 1st—_ [beguiling gift](advanced/spell_dir/beguilingGift#_beguiling-gift_, 2nd—_ [spider climb](spell_dir/spiderClimb#_spider-climb_, 3rd—_ [cacophonous call](advanced/spell_dir/cacophonousCall#_cacophonous-call_, 4th—_ [freedom of movement](spell_dir/freedomOfMovement#_freedom-of-movement_, 5th—_ [summon nature's ally V](spell_dir/summonNatureSAlly#_summon-nature-s-ally-v)_ (dire ape or girallon only, 6th—_ [confusion](spell_dir/confusion#_confusion_, 7th—_ [animal shapes](spell_dir/animalShapes#_animal-shapes)_ (apes and monkeys only, 8th—_ [clenched fist](spell_dir/clenchedFist#_clenched-fist_, 9th—_ [foresight](spell_dir/foresight#_foresight)_.
...
**Foothold (Su** : As a standard action, you can cause an adjacent stone surface up to 10 feet square to mold itself into ridges and creases. A foothold that is created on a horizontal surface is treated as difficult terrain, and a Medium or smaller creature standing in the area or moving through it takes a –2 penalty on [Acrobatics](skill_dir/acrobatics#_acrobatics checks and to CMD due to poor footing. A foothold that is created on a vertical surface grants a +10 bonus on [Climb](skill_dir/climb#_climb) checks to climb it. The stone remains altered for 1 hour. You can use this ability a number of times per day equal to 3 + your Wisdom modifier.
...
**Domain Spells** : 1st—_fist of stone_, 2nd—_ [stone call](advanced/spell_dir/stoneCall#_stone-call_, 3rd—_ [cloak of winds](advanced/spell_dir/cloakOfWinds#_cloak-of-winds_, 4th—_ [stoneskin](spell_dir/stoneskin#_stoneskin_, 5th—_ [geyser](advanced/spell_dir/geyser#_geyser-_, 6th—_suffocate_, 7th—_ [flesh to stone](spell_dir/fleshToStone#_flesh-to-stone_, 8th—_ [reverse gravity](spell_dir/reverseGravity#_reverse-gravity_, 9th—_ [clashing rocks](advanced/spell_dir/clashingRocks#_clashing-rocks)_.
...
**Domain Spells** : 1st—_ [mount](spell_dir/mount#_mount_, 2nd—_ [chameleon stride](advanced/spell_dir/chameleonStride#_chameleon-stride_, 3rd—_ [haste](spell_dir/haste#_haste_, 4th—_ [aspect of the stag](advanced/spell_dir/aspectOfTheStag#_aspect-of-the-stag_, 5th—_ [control winds](spell_dir/controlWinds#_control-winds_, 6th—_ [find the path](spell_dir/findThePath#_find-the-path_, 7th—_ [whirlwind](spell_dir/whirlwind#_whirlwind_, 8th—_ [animal shapes](spell_dir/animalShapes#_animal-shapes)_, 9th—_worldwave_.
...
**Slither (Ex** : As a free action, you can distend and stretch your body to fit easily through narrow spaces for 1 round. You can move freely through a tight space that would normally require a creature of your size to squeeze through. While slithering, you gain a +2 dodge bonus to Armor Class against attacks of opportunity provoked by your movement and a +2 bonus on CMB and on [Escape Artist](skill_dir/escapeArtist#_escape-artist) checks made to escape from a grapple. You can use this ability a number of times per day equal to 3 + your Wisdom modifier.
...
**Domain Spells** : 1st—_ [charm animal](spell_dir/charmAnimal#_charm-animal_, 2nd—_ [animal trance](spell_dir/animalTrance#_animal-trance_, 3rd—_ [poison](spell_dir/poison#_poison_, 4th—_strong_ jaw, 5th—_snakestaff_, 6th—_ [charm monster](spell_dir/charmMonster#_charm-monster_, 7th—_ [animal shapes](spell_dir/animalShapes#_animal-shapes)_ (reptiles and snakes only, 8th—_ [scintillating pattern](spell_dir/scintillatingPattern#_scintillating-pattern_, 9th—_ [crushing hand](spell_dir/crushingHand#_crushing-hand)_.
...
**Domain Spells** : 1st—_ [hydraulic push](advanced/spell_dir/hydraulicPush#_hydraulic-push-_, 2nd—_ [burst of nettles](ultimateMagic/spell_dir/burstOfNettles#_burst-of-nettles_, 3rd—_ [lily pad stride](advanced/spell_dir/lilyPadStride#_lily-pad-stride_, 4th—_ [cape of wasps](ultimateMagic/spell_dir/capeOfWasps#_cape-of-wasps_, 5th—_ [insect plague](spell_dir/insectPlague#_insect-plague_, 6th—_ [mass fester](advanced/spell_dir/fester#_fester,-mass_, 7th—_ [animate plants](spell_dir/animatePlants#_animate-plants_, 8th—_ [blood mist](ultimateMagic/spell_dir/bloodMist#_blood-mist_, 9th—_ [shambler](spell_dir/shambler#_shambler)_.
...
**Domain Spells** : 1st—_ [hunter's howl](advanced/spell_dir/hunterSHowl#_hunter's-howl_, 2nd—_ [bloodhound](advanced/spell_dir/bloodhound#_bloodhound_, 3rd—_ [aspect of the wolf](advanced/spell_dir/aspectOfTheWolf#_aspect-of-the-wolf_, 4th—_ [strong jaw](advanced/spell_dir/strongJaw#_strong-jaw_, 5th—_ [tireless pursuers](advanced/spell_dir/tirelessPursuers#_tireless-pursuers_, 6th—_ [find the path](spell_dir/findThePath#_find-the-path_, 7th—_ [animal shapes](spell_dir/animalShapes#_animal-shapes)_ (canines only, 8th—_ [phantasmal revenge](advanced/spell_dir/phantasmalRevenge#_phantasmal-revenge_, 9th—_ [freedom](spell_dir/freedom#_freedom_.

# Vermin Companions

In addition to the normal choices of animal companions, a druid who is so inclined may select a vermin as her companion. Vermin companions follow the same rules as animal companions, advancing their Hit Dice and other abilities per the [animal companion base statistics table](classe_dir/druid#_table-3-8-animal-companion-base-statistics. Vermin companions can be trained as if they were animals using the [Handle Animal](skill_dir/handleAnimal#_handle-animal) skill.
...
**Spirit Sense (Sp** : At 1st level, a menhir savant can detect the presence of undead; fey; outsiders; and astral, ethereal, or incorporeal creatures. This ability functions like _ [detect undead](spell_dir/detectUndead#_detect-undead)_, and the druid detects all of these creatures rather than trying to detect one kind. This ability replaces nature sense and wild empathy.
...
**Walk the Lines (Su** : At 9th level, a menhir savant can use her connection to ley lines to cast _ [transport via plants](spell_dir/transportViaPlants#_transport-via-plants)_ a number of times per day equal to her Wisdom bonus.

**Empty Body (Su** : At 13th level, a menhir savant can become ethereal as a standard action, as if using _ [ethereal jaunt](spell_dir/etherealJaunt#_ethereal-jaunt)_. She can remain ethereal for a number of rounds per day equal to her druid level. These rounds do not need to be consecutive. This ability replaces a thousand faces.
...
**Mysterious Stranger (Ex** : At 2nd level, a reincarnated druids adds 1/2 her druid level to the DC of [Sense Motive](skill_dir/senseMotive#_sense-motive, [Diplomacy](skill_dir/diplomacy#_diplomacy, and [Knowledge](skill_dir/knowledge#_knowledge) checks to learn about her. This ability replaces woodland stride.
...
**Many Lives (Ex** : At 5th level, if a reincarnated druid is killed, she may automatically _ [reincarnate](spell_dir/reincarnate#_reincarnate)_ (as the spell 1 day later. The reincarnated druid appears in a safe location within 1 mile of her previous body. At will for the next 7 days, she can sense the presence of her remains as if using _ [locate object](spell_dir/locateObject#_locate-object)_ as a spell-like ability. If she is killed during these 7 days, she remains dead and does not reincarnate. The many lives ability does not function ifthe reincarnated druid is slain by a death effect. A reincarnated druid cannot be raised from the dead or resurrected, though she can be reincarnated.
...
**Totem Transformation (Su)** : At 2nd level, a saurian shaman may adopt an aspect of the saurian while retaining her normal form. This ability functions as the dragon shaman's totem transformation ability, but the druid may select from the following bonuses: movement (+10 enhancement bonus to land speed), scales (+2 natural armor bonus to AC), senses (low-light vision, scent), or natural weapons (bite [1d6], 2 claws [1d4] for a Medium druid, rake, +2 CMB to grapple. While using totem transformation, a saurian shaman may speak normally and can cast _ [speak with animals](spell_dir/speakWithAnimals#_speak-with-animals)_ (reptiles and dinosaurs only) at will.
...
**Stormvoice (Ex** : At 3rd level, a storm druid's voice can magically carry over howling winds and peals of thunder. Whenever a [Perception](skill_dir/perception#_perception) check is needed to hear the druid's voice, the DC is reduced by an amount equal to the druid's level. This ability replaces trackless step.

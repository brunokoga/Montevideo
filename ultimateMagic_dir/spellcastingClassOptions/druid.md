...
**Seastrike (Su)** : At 6th level, as a free action, you may use natural and manufactured weapons in water as if you had continuous _ [freedom of movement](spells/freedomOfMovement#_freedom-of-movement)_. As a standard action, you can throw a weapon underwater without the normal penalties for throwing weapons; if your target is in or under the water, the weapon also acts as a _ [returning](magicItems/weapons#_weapons-returning)_ weapon (see page 471 of the _Core Rulebook_) for that attack.

**Domain Spells** : 1st—_ [hydraulic push](advanced/spells/hydraulicPush#_hydraulic-push-)_, 2nd—_ [slipstream](advanced/spells/slipstream#_slipstream)_, 3rd—_ [water breathing](spells/waterBreathing#_water-breathing)_, 4th—_ [freedom of movement](spells/freedomOfMovement#_freedom-of-movement)_, 5th—_ [black tentacles](spells/blackTentacles#_black-tentacles)_, 6th—_ [freezing sphere](spells/freezingSphere#_freezing-sphere)_, 7th—_ [animal shapes](spells/animalShapes#_animal-shapes)_ (aquatic creatures only), 8th—_ [seamantle](advanced/spells/seamantle#_seamantle)_, 9th—_ [tsunami](advanced/spells/tsunami#_tsunami)_.
...
**Banish Flame (Su)** : At 6th level, you may use your call cold ability to damage creatures with the fire subtype (as a cleric channeling negative energy) or to cause them to flee from you (as the [Turn Undead](feats#_turn-undead) feat). Alternatively, you may use this ability to negate magical fire effects as if using a targeted _ [dispel magic](spells/dispelMagic#_dispel-magic)_; at 12th level, this functions as targeted or area _ [greater dispel magic](spells/dispelMagic#_dispel-magic-greater)_ instead of _ [dispel magic](spells/dispelMagic#_dispel-magic)_.

**Domain Spells** : 1st—_ [frostbite](ultimateMagic/spells/frostbite#_frostbite)_, 2nd—_ [aspect of the bear](advanced/spells/aspectOfTheBear#_aspect-of-the-bear)_, 3rd—_ [sleet storm](spells/sleetStorm#_sleet-storm)_, 4th—_ [wall of ice](spells/wallOfIce#_wall-of-ice)_, 5th—_ [aspect of the wolf](advanced/spells/aspectOfTheWolf#_aspect-of-the-wolf)_, 6th—_ [freezing sphere](spells/freezingSphere#_freezing-sphere)_, 7th—_ [wind walk](spells/windWalk#_wind-walk)_, 8th—_ [polar ray](spells/polarRay#_polar-ray)_, 9th—_ [polar midnight](ultimateMagic/spells/polarMidnight#_polar-midnight)_.
...
**Domain Spells** : 1st—_ [detect aberration](advanced/spells/detectAberration#_detect-aberration)_, 2nd—_ [stone call](advanced/spells/stoneCall#_stone-call)_, 3rd—_ [deeper darkness](spells/deeperDarkness#_deeper-darkness)_, 4th—_echolocation_, 5th—_ [wall of stone](spells/wallOfStone#_wall-of-stone)_, 6th—_ [conjure black pudding](ultimateMagic/spells/conjureBlackPudding#_conjure-black-pudding)_, 7th—_ [statue](spells/statue#_statue)_ (looking like a stalagmite or stalactite), 8th—_ [earthquake](spells/earthquake#_earthquake)_, 9th—_ [imprisonment](spells/imprisonment#_imprisonment)_.
...
**Servant of the Sands (Sp)** : At 8th level, once per day, you may call upon the aid of a janni as if using _ [lesser planar ally](spells/planarAlly#_planar-ally-lesser)_. At 12th level, you may call upon the aid of any type of common (non-noble) genie as if using _ [planar ally](spells/planarAlly#_planar-ally)_. At 16th level, you may call upon the aid of a noble genie as if using _ [greater planar ally](spells/planarAlly#_planar-ally-greater)_. If you use this power while in desert terrain, you need not make an offering to call the creature(s), and the cost of any service is halved.

**Domain Spells** : 1st—_ [cloak of shade](advanced/spells/cloakOfShade#_cloak-of-shade)_, 2nd—_ [shifting sand](advanced/spells/shiftingSand#_shifting-sand)_, 3rd—_ [cup of dust](advanced/spells/cupOfDust#_cup-of-dust)_, 4th—_ [hallucinatory terrain](spells/hallucinatoryTerrain#_hallucinatory-terrain)_, 5th—_ [transmute rock to mud](spells/transmuteRockToMud#_transmute-rock-to-mud)_ (creates loose sand instead of mud), 6th—_ [sirocco](advanced/spells/sirocco#_sirocco)_, 7th—_ [sunbeam](spells/sunbeam#_sunbeam)_, 8th—_ [sunburst](spells/sunburst#_sunburst)_, 9th—_ [horrid wilting](spells/horridWilting#_horrid-wilting)_.
...
**Hawkeye (Su)** : As a swift action, you may add a bonus equal to half your druid level (minimum +1) on one ranged attack or on one [Perception](skills/perception#_perception) check. You can use this ability a number of times per day equal to 3 + your Wisdom modifier.
...
**Domain Spells** : 1st—_ [aspect of the falcon](advanced/spells/aspectOfTheFalcon#_aspect-of-the-falcon)_, 2nd—_ [eagle's splendor](spells/eagleSSplendor#_eagle-s-splendor)_, 3rd—_ [fly](spells/fly)_, 4th—_ [river of wind](advanced/spells/riverOfWind#_river-of-wind)_, 5th—_ [overland flight](spells/overlandFlight#_overland-flight)_, 6th—_ [eagle aerie](ultimateMagic/spells/eagleAerie#_eagle-aerie)_, 7th—_ [animal shapes](spells/animalShapes#_animal-shapes)_ (birds only), 8th—_ [sunburst](spells/sunburst#_sunburst)_, 9th—_ [winds of vengeance](advanced/spells/windsOfVengeance#_winds-of-vengeance)_.
...
**Domain Spells** : 1st—_ [jump](spells/jump#_jump)_, 2nd—_ [delay poison](spells/delayPoison#_delay-poison)_, 3rd—_ [lily pad stride](advanced/spells/lilyPadStride#_lily-pad-stride)_, 4th—_ [shout](spells/shout#_shout)_, 5th—_ [blessing of the salamander](advanced/spells/blessingOfTheSalamander#_blessing-of-the-salamander)_, 6th—_ [confusion](spells/confusion#_confusion)_, 7th—_ [animal shapes](spells/animalShapes#_animal-shapes)_ (amphibians only), 8th—_ [greater shout](spells/shout#_shout-greater)_, 9th—_ [summon froghemoth](ultimateMagic/spells/summonFroghemoth#_summon-froghemoth)_.

## Jungle Domain

**Granted Powers** : The spirits of the jungle, both of natural guardians and lost civilizations, whisper in your heart.

**Brachiation (Ex)** : As a free action for a number of rounds per day equal to your druid level, you may climb with a climb speed equal to your land speed, and gain a bonus on [Acrobatics](skills/acrobatics#_acrobatics) checks equal to your druid level. These rounds do not have to be consecutive.
...
**Domain Spells** : 1st—_ [glide](advanced/spells/glide#_glide-)_, 2nd—_ [tar ball](ultimateMagic/spells/tarBall#_tar-ball)_, 3rd—_ [venomous bolt](advanced/spells/venomousBolt#_venomous-bolt)_, 4th—_ [arboreal hammer](ultimateMagic/spells/arborealHammer#_arboreal-hammer)_, 5th—_ [blessing of the salamander](advanced/spells/blessingOfTheSalamander#_blessing-of-the-salamander)_, 6th—_ [swarm skin](advanced/spells/swarmSkin#_swarm-skin-)_, 7th—_ [creeping doom](spells/creepingDoom#_creeping-doom)_, 8th—_ [wall of lava](advanced/spells/wallOfLava#_wall-of-lava)_, 9th—_ [shambler](spells/shambler#_shambler)_.
...
**Monkey Athletics (Su)** : As a free action, you may add a competence bonus equal to half your druid level (minimum of +1) on one [Acrobatics](skills/acrobatics#_acrobatics), [Climb](skills/climb#_climb), [Disable Device](skills/disableDevice#_disable-device), or [Sleight of Hand](skills/sleightOfHand#_sleight-of-hand) check. You can use this ability a number of times per day equal to 3 + your Wisdom modifier.

**Ranged Legerdemain (Su)** : At 6th level, you can use the [Disable Device](skills/disableDevice#_disable-device) and [Sleight of Hand](skills/sleightOfHand#_sleight-of-hand) skills at a range of 30 feet. Working at a distance increases the normal skill check DC by 5, and you cannot take 10 on this check. Any object to be manipulated must weigh 5 pounds or less. You can only use this ability if you have at least 1 rank in the skill being used.

**Domain Spells** : 1st—_ [beguiling gift](advanced/spells/beguilingGift#_beguiling-gift)_, 2nd—_ [spider climb](spells/spiderClimb#_spider-climb)_, 3rd—_ [cacophonous call](advanced/spells/cacophonousCall#_cacophonous-call)_, 4th—_ [freedom of movement](spells/freedomOfMovement#_freedom-of-movement)_, 5th—_ [summon nature's ally V](spells/summonNatureSAlly#_summon-nature-s-ally-v)_ (dire ape or girallon only), 6th—_ [confusion](spells/confusion#_confusion)_, 7th—_ [animal shapes](spells/animalShapes#_animal-shapes)_ (apes and monkeys only), 8th—_ [clenched fist](spells/clenchedFist#_clenched-fist)_, 9th—_ [foresight](spells/foresight#_foresight)_.
...
**Foothold (Su)** : As a standard action, you can cause an adjacent stone surface up to 10 feet square to mold itself into ridges and creases. A foothold that is created on a horizontal surface is treated as difficult terrain, and a Medium or smaller creature standing in the area or moving through it takes a –2 penalty on [Acrobatics](skills/acrobatics#_acrobatics) checks and to CMD due to poor footing. A foothold that is created on a vertical surface grants a +10 bonus on [Climb](skills/climb#_climb) checks to climb it. The stone remains altered for 1 hour. You can use this ability a number of times per day equal to 3 + your Wisdom modifier.
...
**Domain Spells** : 1st—_fist of stone_, 2nd—_ [stone call](advanced/spells/stoneCall#_stone-call)_, 3rd—_ [cloak of winds](advanced/spells/cloakOfWinds#_cloak-of-winds)_, 4th—_ [stoneskin](spells/stoneskin#_stoneskin)_, 5th—_ [geyser](advanced/spells/geyser#_geyser-)_, 6th—_suffocate_, 7th—_ [flesh to stone](spells/fleshToStone#_flesh-to-stone)_, 8th—_ [reverse gravity](spells/reverseGravity#_reverse-gravity)_, 9th—_ [clashing rocks](advanced/spells/clashingRocks#_clashing-rocks)_.
...
**Domain Spells** : 1st—_ [mount](spells/mount#_mount)_, 2nd—_ [chameleon stride](advanced/spells/chameleonStride#_chameleon-stride)_, 3rd—_ [haste](spells/haste#_haste)_, 4th—_ [aspect of the stag](advanced/spells/aspectOfTheStag#_aspect-of-the-stag)_, 5th—_ [control winds](spells/controlWinds#_control-winds)_, 6th—_ [find the path](spells/findThePath#_find-the-path)_, 7th—_ [whirlwind](spells/whirlwind#_whirlwind)_, 8th—_ [animal shapes](spells/animalShapes#_animal-shapes)_, 9th—_worldwave_.
...
**Domain Spells** : 1st—_ [charm animal](spells/charmAnimal#_charm-animal)_, 2nd—_ [animal trance](spells/animalTrance#_animal-trance)_, 3rd—_ [poison](spells/poison#_poison)_, 4th—_strong_ jaw, 5th—_snakestaff_, 6th—_ [charm monster](spells/charmMonster#_charm-monster)_, 7th—_ [animal shapes](spells/animalShapes#_animal-shapes)_ (reptiles and snakes only), 8th—_ [scintillating pattern](spells/scintillatingPattern#_scintillating-pattern)_, 9th—_ [crushing hand](spells/crushingHand#_crushing-hand)_.
...
**Domain Spells** : 1st—_ [hydraulic push](advanced/spells/hydraulicPush#_hydraulic-push-)_, 2nd—_ [burst of nettles](ultimateMagic/spells/burstOfNettles#_burst-of-nettles)_, 3rd—_ [lily pad stride](advanced/spells/lilyPadStride#_lily-pad-stride)_, 4th—_ [cape of wasps](ultimateMagic/spells/capeOfWasps#_cape-of-wasps)_, 5th—_ [insect plague](spells/insectPlague#_insect-plague)_, 6th—_ [mass fester](advanced/spells/fester#_fester,-mass)_, 7th—_ [animate plants](spells/animatePlants#_animate-plants)_, 8th—_ [blood mist](ultimateMagic/spells/bloodMist#_blood-mist)_, 9th—_ [shambler](spells/shambler#_shambler)_.
...
**Domain Spells** : 1st—_ [hunter's howl](advanced/spells/hunterSHowl#_hunter's-howl)_, 2nd—_ [bloodhound](advanced/spells/bloodhound#_bloodhound)_, 3rd—_ [aspect of the wolf](advanced/spells/aspectOfTheWolf#_aspect-of-the-wolf)_, 4th—_ [strong jaw](advanced/spells/strongJaw#_strong-jaw)_, 5th—_ [tireless pursuers](advanced/spells/tirelessPursuers#_tireless-pursuers)_, 6th—_ [find the path](spells/findThePath#_find-the-path)_, 7th—_ [animal shapes](spells/animalShapes#_animal-shapes)_ (canines only), 8th—_ [phantasmal revenge](advanced/spells/phantasmalRevenge#_phantasmal-revenge)_, 9th—_ [freedom](spells/freedom#_freedom)_.

# Vermin Companions

In addition to the normal choices of animal companions, a druid who is so inclined may select a vermin as her companion. Vermin companions follow the same rules as animal companions, advancing their Hit Dice and other abilities per the [animal companion base statistics table](classes/druid#_table-3-8-animal-companion-base-statistics). Vermin companions can be trained as if they were animals using the [Handle Animal](skills/handleAnimal#_handle-animal) skill.
...
**Walk the Lines (Su)** : At 9th level, a menhir savant can use her connection to ley lines to cast _ [transport via plants](spells/transportViaPlants#_transport-via-plants)_ a number of times per day equal to her Wisdom bonus.
...
**Mysterious Stranger (Ex)** : At 2nd level, a reincarnated druids adds 1/2 her druid level to the DC of [Sense Motive](skills/senseMotive#_sense-motive), [Diplomacy](skills/diplomacy#_diplomacy), and [Knowledge](skills/knowledge#_knowledge) checks to learn about her. This ability replaces woodland stride.

...
**Secret** : Hidden pathways carved through the mountains offer speedier paths. If the PCs succeed at a DC 20 [Perception](skill_dir/perception#_perception) check to find the pathways, they can ignore the default travel time increase for the mountain hex.
...
**Difficult** : Whitewater rapids, strong tides, or underwater vortexes mean this water is more challenging to cross. The [Swim](skill_dir/swim#_swim) DCs to cross these waters increase by 5.

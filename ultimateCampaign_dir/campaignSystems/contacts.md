---
layout: default
title: ultimateCampaig_dir/campaignSystems/contacts
---
# Contacts
...
A relationship with a contact develops as you spend time with him. Each time you have a positive or profound interaction with the contact (but no more than once at each of your character levels), attempt a [Diplomacy](skills/diplomacy#_diplomacy) check to improve the contact's Trust score by 1. If the interaction is profound rather than merely positive, you gain a +5 bonus on this [Diplomacy](skill_dir/diplomacy#_diplomacy) check. The DC of the check depends on the contact's Trust score with you.

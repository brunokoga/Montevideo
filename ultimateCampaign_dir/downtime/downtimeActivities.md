---
title: ultimateCampaig_dir/downtime/downtimeActivities
---
# Downtime Activities
...
You can spend 1 day of downtime earning capital. Depending on the nature of the work, this might require making some kind of check and paying an amount of gp. This work might be unskilled labor or skilled labor with a [Craft](skill_dir/craft#_craft) or [Profession](skills/profession#_profession) skill. See [Gaining Capital](ultimateCampaig_dir/downtime#_gaining-capital) for more information.
...
If you are using the kingdom-building rules and have a leadership role in the kingdom, you must spend 7 days per month performing [various leadership duties](ultimateCampaig_dir/kingdomsAndWar/kingdomBuilding#_leadership-roles). In the downtime system, performing leadership duties for a day costs 1 day of downtime. You can't perform any other downtime activities on a day you perform kingdom leadership duties.
...
4. Attempt a [Spellcraft](skill_dir/spellcraft#_spellcraft) check and a [Knowledge](skills/knowledge#_knowledge) check (arcana for an arcane spell, religion for a divine spell) against the spell research DC. You can't take 10 on these checks. You may spend Magic to modify a check result, with 1 point of Magic adding 2 to your total (maximum +10). If both checks succeed, you make 1 day's progress toward completing the spell. When your days of progress equal the total number of days needed, the spell is completed and added to your spellbook or list of spells known.

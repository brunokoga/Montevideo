---
title: ultimateCampaign/downtim_dir/downtimeEvents
---
# Downtime Events
...
**Sickness** : Your employees have become sick, and any earnings from this building today are halved. Attempt a DC 15 [Heal](skill_dir/heal#_heal) check at the end of each day—on a success, your employees get well enough to work. If you fail, the sickness persists to the next day. Each day sickness persists, you have a 20% chance of losing 1d2 points of Labor.
...
**Stolen Instrument** : One student's valuable instrument has been stolen right before an important performance. If you succeed at a DC 30 [Perform](skill_dir/perform#_perform check, you find a suitable replacement and offers from investors gain you 1d3 points of Goods. Otherwise, you lose 1d3 points of Influence.
...
**Violence** : There is a 60% chance that this is just a simple brawl in the common room, and a 40% chance that someone has attempted actual harm against your employees or guests. If it is a simple brawl, you can break it up with a successful DC 20 [Diplomacy](skill_dir/diplomacy#_diplomacy or [Intimidate](skill_dir/intimidate#_intimidate) check or by spending 1 point of Goods on the quarrelers. If it is a violent attack and you're present when it occurs, you can attempt to intercede (the GM should determine an appropriate combat encounter. Whether or not the violent attack is successful, the perpetrator must be dealt with. If you do nothing at all, you lose 1d4 points of Influence and 1d2 points of Labor as you lose frightened customers and employees. If you want the local authorities to take care of it, attempt a DC 20 [Diplomacy](skill_dir/diplomacy#_diplomacy or [Intimidate](skill_dir/intimidate#_intimidate) check. Success means an investigation and arrest occur without any negative repercussions. Failure means you lose 1d4 points of Influence and 1 point of Labor. If you find and punish the perpetrator yourself (or hire someone to do so, you gain 1d4 points of Influence.
...
**Escaped Animal** : One of your exhibits escapes its cage. If you keep track of specific creatures, determine the escaped creature randomly. Attempt a DC 25 [Handle Animal](skill_dir/handleAnimal#_handle-animal, [Perception](skill_dir/perception#_perception, [Survival](skill_dir/survival#_survival, or wild empathy check (or if the escaped creature is intelligent, a [Bluff](skill_dir/bluff#_bluff or [Diplomacy](skill_dir/diplomacy#_diplomacy) check) to find the creature and safely return it to its cage. If you fail, you lose 1d6 points of Influence and 1d4 points of Labor, and the building generates no capital that day.
...
**Scandal** : This is the same as the scandal event from Military Academy Events , except a Monastery scandal lasts for 2d6 days. You can attempt to repair the reputation damage from a Monastery scandal with a DC 30 [Bluff](skill_dir/bluff#_bluff, [Diplomacy](skill_dir/diplomacy#_diplomacy, or [Knowledge](skill_dir/knowledge#_knowledge) (religion) check.
...
**Forge Waste** : An employee ruins some equipment or refined metal. Attempt a DC 30 [Craft](skill_dir/craft#_craft check appropriate to your Smithy. If you succeed, you are able to salvage much of the metal and only lose 1 point of Goods. If you fail, you lose 1d3 points of Goods.
...
**Famous Visitor** : A well-known ranger, a messenger for a king, or someone of equal import stables a mount in your building. If you succeed at a DC 20 [Handle Animal](skill_dir/handleAnimal#_handle-animal check, you impress the visitor enough to gain 1d4 points of Influence as she spreads the word of the quality of your stabling. If you roll a 4 on the 1d4 roll, you instead gain 3 points of Influence and 1 point of Magic.
...
**Important Visitor** : A cleric, inquisitor, paladin, or other notable holy person associated with your faith or an allied faith visits your Temple. If you succeed at a DC 20 [Diplomacy](skill_dir/diplomacy#_diplomacy) check, the visitor stays 1d8 days. Each day the visitor remains, you gain 1 point of Influence and the building gains a +5 bonus on its first check to generate capital each day.
...
**Familiar Scraps** : Several familiars belonging to members of your Cabal are causing problems with each other or with local animals. You must succeed at a DC 25 [Diplomacy](skill_dir/diplomacy#_diplomacy, [Handle Animal](skill_dir/handleAnimal#_handle-animal, or [Knowledge](skill_dir/knowledge#_knowledge) (arcana) check, or spend 1d4 points of Goods and Influence (divided as you see fit to calm things down.

**Image Problem** : An influential person, such as a conservative noble, leader of a rival organization, or professor at a local academy tries to discredit your organization. Attempt a [Diplomacy](skill_dir/diplomacy#_diplomacy, [Intimidate](skill_dir/intimidate#_intimidate, or [Knowledge](skill_dir/knowledge#_knowledge) (arcana check opposed by this person's [Bluff](skill_dir/bluff#_bluff, [Intimidate](skill_dir/intimidate#_intimidate, or [Knowledge](skill_dir/knowledge#_knowledge) (arcana) check (1d20 + 5 if the GM doesn't have a specific person in mind). If you succeed, you weather the bad comments and the event ends with no negative repercussions. If you succeed by at least 5, you increase your acclaim, gaining 1 point of Influence or Labor. If you fail, you lose 1d3 points of Goods, Influence, Labor, and Magic (divided as you see fit) because of vandalism or members leaving out of fear.
...
**Image Problem** : An influential person, such as a conservative noble or leader of a rival church, attempts to discredit your organization. Attempt a [Bluff](skill_dir/bluff#_bluff, [Diplomacy](skill_dir/diplomacy#_diplomacy, or [Intimidate](skill_dir/intimidate#_intimidate check opposed by this person's [Bluff](skill_dir/bluff#_bluff or [Intimidate](skill_dir/intimidate#_intimidate) check (1d20 + 5 if the GM doesn't have a specific person in mind). Success means you weather these attempts and the event ends with no negative repercussions. If you win by at least 5, you increase your fame, gaining your choice of 1 point of Influence or Labor. If you fail, you lose 1d3 points of Goods, Influence, and Labor (divided as you see fit because of vandalism or members leaving out of fear.
...
**Brawl** : This functions like the bar brawl in Tavern Events, except you may attempt a [Profession](skill_dir/profession#_profession) (soldier check instead of an [Intimidate](skill_dir/intimidate#_intimidate check, and a failed check causes a loss of Influence and Labor.

**Duel** : This functions like the duel event from the Military Academy Events section , except you may attempt a [Profession](skill_dir/profession#_profession) (soldier check instead of a [Diplomacy](skill_dir/diplomacy#_diplomacy or [Intimidate](skill_dir/intimidate#_intimidate check.
...
**Schism** : This functions as the schism from the Cult Events section, except that the skills you can use to attempt to end it are [Bluff](skill_dir/bluff#_bluff, [Diplomacy](skill_dir/diplomacy#_diplomacy, [Intimidate](skill_dir/intimidate#_intimidate, and [Profession](skill_dir/profession#_profession) (soldier, and that succeeding at the check means you lose 1 point of Labor and the event ends.
...
**Big Heist** : You have the opportunity to take on a risky but profitable job. If you accept, attempt a DC 30 [Disable Device](skill_dir/disableDevice#_disable-device, [Sleight of Hand](skill_dir/sleightOfHand#_sleight-of-hand, or [Stealth](skill_dir/stealth#_stealth) check. If you succeed, the guild gains a +20 bonus on its next check to generate capital and you gain 1d4 points of Influence. If you fail, the guild automatically rolls a 1 on all checks to generate capital for 1 day, and you lose 1 point of Influence. If you fail by 10 or more, there's a 25% chance that a team involved in the heist is captured (treat this as the entrapment event.
...
**Meddling Adventurers** : Unusually competent do-gooders sniff around your territory and spar with your teams. You must succeed at a DC 25 [Disable Device](skill_dir/disableDevice#_disable-device, [Sleight of Hand](skill_dir/sleightOfHand#_sleight-of-hand, or [Stealth](skill_dir/stealth#_stealth) check or lose 1d6 points of Goods because of their activities. If you succeed by 10 or more, you gain 1d3 points of Influence for trouncing the adventurers. If you fail by 10 or more, one of your teams is captured (treat this as the entrapment event described above).

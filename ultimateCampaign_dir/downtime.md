...
[Downtime Activities](ultimateCampaign/downtim_dir/downtimeActivities [Managers](ultimateCampaign/downtim_dir/managers [Rooms and Teams](ultimateCampaign/downtim_dir/roomsAndTeams [Buildings and Organizations](ultimateCampaign/downtim_dir/buildingsAndOrganizations [Downtime Events](ultimateCampaign/downtim_dir/downtimeEvents
...
Even if you don't want to use the rules to earn extra gold or throw your weight around in town as a business owner, there are campaign and roleplaying benefits for using the downtime system. For example, if you build or buy a house, you have a comfortable, private place to rest between adventures. By adding a few more rooms, you can easily convert a house into a base of operations for your adventuring party; it would count as "very familiar" for the purpose of your _ [teleport](spell_dir/teleport#_teleport_ spells, and if it includes an altar to your deity, you can use it as the destination for a _ [word of recall](spell_dir/wordOfRecall#_word-of-recall)_.
...
**Gold Pieces** : Gold pieces (or gp constitute the normal money your character has, such as from looting monsters or earning a living with [Craft](skill_dir/craft#_craft or [Profession](skill_dir/profession#_profession) checks. Many downtime activities require you to spend gp.
...
**Skilled Work** : If you have ranks in a useful skill, you can spend 1 day working in a settlement to earn more capital than you would doing unskilled work. Note that this method includes both legal and illegal means of earning capital—for example, a day spent using [Sleight of Hand](skill_dir/sleightOfHand#_sleight-of-hand) to earn money could be a day spent performing as a street magician or a day spent pickpocketing.
...
If you are using this option to earn Goods, Influence, Labor, or Magic, the skill you're using must be suitable for earning the chosen type of capital; if the GM deems it is not, using that skill reduces the amount generated by half (minimum 1. For example, [Perform](skill_dir/perform#_perform might earn you Influence as a musician, but it's not as useful for earning Labor. The GM should inform you of this before you attempt the skill check. In general, the appropriate skills for each type of capital are as follows.

_Goods_: [Appraise](skill_dir/appraise#_appraise, [Bluff](skill_dir/bluff#_bluff, [Craft](skill_dir/craft#_craft, [Diplomacy](skill_dir/diplomacy#_diplomacy, [Disable Device](skill_dir/disableDevice#_disable-device, [Handle Animal](skill_dir/handleAnimal#_handle-animal, [Intimidate](skill_dir/intimidate#_intimidate, [Knowledge](skill_dir/knowledge#_knowledge) (dungeoneering, engineering, geography, history, local, nature, nobility, religion, [Profession](skill_dir/profession#_profession, [Sleight of Hand](skill_dir/sleightOfHand#_sleight-of-hand, [Stealth](skill_dir/stealth#_stealth.

_Influence_: [Appraise](skill_dir/appraise#_appraise, [Bluff](skill_dir/bluff#_bluff, [Craft](skill_dir/craft#_craft, [Diplomacy](skill_dir/diplomacy#_diplomacy, [Handle Animal](skill_dir/handleAnimal#_handle-animal, [Heal](skill_dir/heal#_heal, [Intimidate](skill_dir/intimidate#_intimidate, [Knowledge](skill_dir/knowledge#_knowledge) (any, [Linguistics](skill_dir/linguistics#_linguistics, [Perform](skill_dir/perform#_perform, [Profession](skill_dir/profession#_profession, [Ride](skill_dir/ride#_ride.

_Labor_: [Bluff](skill_dir/bluff#_bluff, [Climb](skill_dir/climb#_climb, [Craft](skill_dir/craft#_craft, [Diplomacy](skill_dir/diplomacy#_diplomacy, [Handle Animal](skill_dir/handleAnimal#_handle-animal, [Intimidate](skill_dir/intimidate#_intimidate, [Knowledge](skill_dir/knowledge#_knowledge) (local, [Profession](skill_dir/profession#_profession, [Ride](skill_dir/ride#_ride, [Survival](skill_dir/survival#_survival, [Swim](skill_dir/swim#_swim.

_Magic_: [Appraise](skill_dir/appraise#_appraise, [Craft](skill_dir/craft#_craft, [Diplomacy](skill_dir/diplomacy#_diplomacy, [Heal](skill_dir/heal#_heal, [Knowledge](skill_dir/knowledge#_knowledge) (arcana, dungeoneering, nature, planes, religion, [Linguistics](skill_dir/linguistics#_linguistics, [Profession](skill_dir/profession#_profession, [Spellcraft](skill_dir/spellcraft#_spellcraft, [Use Magic Device](skill_dir/useMagicDevice#_use-magic-device.

The value of a particular skill for a given type of capital can vary from settlement to settlement. For example, in a frontier settlement with a tradition of serious hard work, a day of humorous performances using [Perform](skill_dir/perform#_perform) (comedy might not earn you much capital, but inspirational public speeches about the city's heroes using [Knowledge](skill_dir/knowledge#_knowledge) (history or [Perform](skill_dir/perform#_perform) (oratory could. The GM should tell you this before you attempt the skill check, or allow you to assess the inhabitants' preferences with a successful DC 15 [Knowledge](skill_dir/knowledge#_knowledge) (local or [Sense Motive](skill_dir/senseMotive#_sense-motive) check.
...
**Phase 2—Activity** : [Perform](skill_dir/perform#_perform) downtime activities, such as constructing a building, recruiting an organization, or retraining.

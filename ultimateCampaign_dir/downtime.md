---
layout: default
title: ultimateCampaig_dir/downtime
---
# Downtime
...
**Gold Pieces** : Gold pieces (or gp) constitute the normal money your character has, such as from looting monsters or earning a living with [Craft](skills/craft#_craft) or [Profession](skill_dir/profession#_profession) checks. Many downtime activities require you to spend gp.
...
If you are using this option to earn Goods, Influence, Labor, or Magic, the skill you're using must be suitable for earning the chosen type of capital; if the GM deems it is not, using that skill reduces the amount generated by half (minimum 1). For example, [Perform](skills/perform#_perform) might earn you Influence as a musician, but it's not as useful for earning Labor. The GM should inform you of this before you attempt the skill check. In general, the appropriate skills for each type of capital are as follows.

_Goods_: [Appraise](skill_dir/appraise#_appraise), [Bluff](skills/bluff#_bluff), [Craft](skill_dir/craft#_craft), [Diplomacy](skills/diplomacy#_diplomacy), [Disable Device](skill_dir/disableDevice#_disable-device), [Handle Animal](skills/handleAnimal#_handle-animal), [Intimidate](skill_dir/intimidate#_intimidate), [Knowledge](skills/knowledge#_knowledge) (dungeoneering, engineering, geography, history, local, nature, nobility, religion), [Profession](skill_dir/profession#_profession), [Sleight of Hand](skills/sleightOfHand#_sleight-of-hand), [Stealth](skill_dir/stealth#_stealth).

_Influence_: [Appraise](skills/appraise#_appraise), [Bluff](skill_dir/bluff#_bluff), [Craft](skills/craft#_craft), [Diplomacy](skill_dir/diplomacy#_diplomacy), [Handle Animal](skills/handleAnimal#_handle-animal), [Heal](skill_dir/heal#_heal), [Intimidate](skills/intimidate#_intimidate), [Knowledge](skill_dir/knowledge#_knowledge) (any), [Linguistics](skills/linguistics#_linguistics), [Perform](skill_dir/perform#_perform), [Profession](skills/profession#_profession), [Ride](skill_dir/ride#_ride).

_Labor_: [Bluff](skills/bluff#_bluff), [Climb](skill_dir/climb#_climb), [Craft](skills/craft#_craft), [Diplomacy](skill_dir/diplomacy#_diplomacy), [Handle Animal](skills/handleAnimal#_handle-animal), [Intimidate](skill_dir/intimidate#_intimidate), [Knowledge](skills/knowledge#_knowledge) (local), [Profession](skill_dir/profession#_profession), [Ride](skills/ride#_ride), [Survival](skill_dir/survival#_survival), [Swim](skills/swim#_swim).

_Magic_: [Appraise](skill_dir/appraise#_appraise), [Craft](skills/craft#_craft), [Diplomacy](skill_dir/diplomacy#_diplomacy), [Heal](skills/heal#_heal), [Knowledge](skill_dir/knowledge#_knowledge) (arcana, dungeoneering, nature, planes, religion), [Linguistics](skills/linguistics#_linguistics), [Profession](skill_dir/profession#_profession), [Spellcraft](skills/spellcraft#_spellcraft), [Use Magic Device](skill_dir/useMagicDevice#_use-magic-device).

The value of a particular skill for a given type of capital can vary from settlement to settlement. For example, in a frontier settlement with a tradition of serious hard work, a day of humorous performances using [Perform](skills/perform#_perform) (comedy) might not earn you much capital, but inspirational public speeches about the city's heroes using [Knowledge](skill_dir/knowledge#_knowledge) (history) or [Perform](skills/perform#_perform) (oratory) could. The GM should tell you this before you attempt the skill check, or allow you to assess the inhabitants' preferences with a successful DC 15 [Knowledge](skill_dir/knowledge#_knowledge) (local) or [Sense Motive](skills/senseMotive#_sense-motive) check.

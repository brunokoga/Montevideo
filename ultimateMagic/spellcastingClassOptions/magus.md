...
_Alertness (Ex)_: While a magus is wielding his _black blade_, he gains the [Alertness](feats.md#_alertness) feat.
...
_Accursed Strike (Sp)_: A hexcrafter magus who can cast _ [bestow curse](spells/bestowCurse.md#_bestow-curse)_, _major curse_, or any spell with the curse descriptor can deliver these prepared spells using the spellstrike ability, even if the spells are not touch attack spells.

**Spells** : A hexcrafter magus adds the following spells to his magus spell list: _ [bestow curse](spells/bestowCurse.md#_bestow-curse)_, _ [major curse](ultimateMagic/spells/curse.md#_curse,-major)_, and all other spells of 6th level or lower that have the curse descriptor.
...
**Quarterstaff Master (Ex)** : At 1st level, the staff magus gains the [Quarterstaff Master](ultimateMagic/ultimateMagicFeats.md#_quarterstaff-master-(combat)) feat as a bonus feat, even if he does not meet the normal prerequisites. He only gains the benefit of this feat when wearing no armor or light armor.

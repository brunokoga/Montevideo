...
- [Report Issues](_dir/paizo_dir/messageboards_dir/paizo_dir/websiteFeedback_dir/theNewPRD)
...
- [Races](advanced_dir/advancedRaces)
- [Base Classes](advanced_dir/advancedBaseClasses)
- [Core Classes](advanced_dir/advancedCoreClasses)
- [Prestige Classes](advanced_dir/advancedPrestigeClasses)
- [Feats](advanced_dir/advancedFeats)
- [Gear](advanced_dir/advancedGear)
- [Spell Lists](advanced_dir/advancedSpellLists)
- [Spell Index](navigation_dir/spells-by-book#_apg-spells)
- [Magic Items](navigation_dir/magicitems-by-book#_magicitems-apg)
- [New Rules](advanced_dir/advancedNewRules)

- [Core Races](advancedRaceGuide_dir/coreRaces)
- [Featured Races](advancedRaceGuide_dir/featuredRaces)
- [Uncommon Races](advancedRaceGuide_dir/uncommonRaces)
- [Race Builder](advancedRaceGuide_dir/raceBuilder)
- [Age, Height & Weight](advancedRaceGuide_dir/ageHeightWeight)
- [Spell Lists](advancedRaceGuide_dir/spellLists)
...
- [Gunslinger](ultimateCombat_dir/classes_dir/gunslinger)
- [Ninja](ultimateCombat_dir/classes_dir/ninja)
- [Samurai](ultimateCombat_dir/classes_dir/samurai)
- [Class Archetypes](ultimateCombat_dir/classArchetypes)
- [Feats](ultimateCombat_dir/ultimateCombatFeats)
- [Mastering Combat](ultimateCombat_dir/combat_dir/introduction)
- [Vehicles](ultimateCombat_dir/ultimateCombatVehicles)
- [Variant Rules](ultimateCombat_dir/variants_dir/introduction)
- [Spell Index](navigation_dir/spells-by-book#_uc-spells)
- [Spell Lists](ultimateCombat_dir/ultimateCombatSpellLists)

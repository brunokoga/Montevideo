...
**Base Statistics** Without _ [barkskin](spells_dir/barkskin#_barkskin) _and _ [cat's grace](spells_dir/catSGrace#_cat-s-grace)_, the druid's statistics are **Init** +5; **AC** 23, touch 13, flat-footed 22; **Ref** +7; **Ranged** dart +9_dir/+4 (1d3–2); **Dex** 12; **CMD** 16; **Skills** [Fly](skills_dir/fly#_fly) +5.
...
0 (at will)—_ [detect magic](spells_dir/detectMagic#_detect-magic)_, _ [guidance](spells_dir/guidance#_guidance)_, _ [stabilize](spells_dir/stabilize#_stabilize)_, _ [virtue](spells_dir/virtue#_virtue)_
...
2nd—_ [barkskin](spells_dir/barkskin#_barkskin)_ (2), _ [cat's grace](spells_dir/catSGrace#_cat-s-grace)_ (2), _fog clou d_D, _ [spider climb](spells_dir/spiderClimb#_spider-climb)_
...
2nd—_ [barkskin](spells_dir/barkskin#_barkskin)_ (3), _ [bull's strength](spells_dir/bullSStrength#_bull-s-strength)_, _ [cat's grace](spells_dir/catSGrace#_cat-s-grace)_, _ [produce flame](spells_dir/produceFlame#_produce-flame)_D
...
**Ranged** _+1 sling_ +15_dir/+10_dir/+5 (1d4+3)
...
7th—_ [animate plants](spells_dir/animatePlants#_animate-plants)_D, _ [fire storm](spells_dir/fireStorm#_fire-storm)_ (DC 22), _ [heal](spells_dir/heal#_heal)_, _ [true seeing](spells_dir/trueSeeing#_true-seeing)_

6th—empowered_ [flame strike](spells_dir/flameStrike#_flame-strike)_ (2, DC 19), _ [greater dispel magic](spells_dir/dispelMagic#_dispel-magic-greater)_, _ [mass cat's grace](spells_dir/catSGrace#_cat-s-grace-mass)_, _ [repel wood](spells_dir/repelWood#_repel-wood)_D

5th—_ [animal growth](spells_dir/animalGrowth#_animal-growth)_ (DC 20), _ [baleful polymorph](spells_dir/balefulPolymorph#_baleful-polymorph)_ (DC 20), _ [control winds](spells_dir/controlWinds#_control-winds)_ (DC 20), _ [stoneskin](spells_dir/stoneskin#_stoneskin)_ (2), _ [wall of thorns](spells_dir/wallOfThorns#_wall-of-thorns)_D

4th—_ [command plants](spells_dir/commandPlants#_command-plants)_D (DC 19), _ [cure serious wounds](spells_dir/cureSeriousWounds#_cure-serious-wounds), [flame strike](spells_dir/flameStrike#_flame-strike)_ (2, DC 19), _ [freedom of movement](spells_dir/freedomOfMovement#_freedom-of-movement)_, _ [spike stones](spells_dir/spikeStones#_spike-stones)_ (DC 19)

3rd—_ [dominate animal](spells_dir/dominateAnimal#_dominate-animal)_ (DC 18), _ [greater magic fang](spells_dir/magicFang#_magic-fang-greater)_ (2), _ [plant growth](spells_dir/plantGrowth#_plant-growth)_D, _ [protection from energy](spells_dir/protectionFromEnergy#_protection-from-energy)_ (2)

2nd—_ [barkskin](spells_dir/barkskin#_barkskin)_D (3), _ [fog cloud](spells_dir/fogCloud)_, _ [hold animal](spells_dir/holdAnimal#_hold-animal) _(DC 17), _ [spider climb](spells_dir/spiderClimb#_spider-climb)_

1st—_ [cure light wounds](spells_dir/cureLightWounds#_cure-light-wounds)_, _ [entangle](spells_dir/entangle#_entangle)_D (DC 16), _ [faerie fire](spells_dir/faerieFire#_faerie-fire)_ (2), _ [obscuring mist](spells_dir/obscuringMist#_obscuring-mist)_, _ [shillelagh](spells_dir/shillelagh#_shillelagh)_, _ [speak with animals](spells_dir/speakWithAnimals#_speak-with-animals)_

0 (at will)—_ [know direction](spells_dir/knowDirection#_know-direction)_, _ [light](spells_dir/light#_light)_, _ [read magic](spells_dir/readMagic#_read-magic)_, _ [stabilize](spells_dir/stabilize#_stabilize)_

**D** Domain spell; **Domain** Plant

Tactics

**Before Combat** The druid casts _ [liveoak](spells_dir/liveoak#_liveoak)_ and _ [shambler](spells_dir/shambler#_shambler)_ on a regular basis, and always has a retinue of 1d4+2 advanced shambling mounds and a treant with her.

**During Combat** The druid detests trespassers. She begins combat by sending her shambling mounds and treant into melee and summoning a storm giant. She then summons a tyrannosaurus and casts _ [animal growth](spells_dir/animalGrowth#_animal-growth)_ on it, and spends the next few rounds buffing her summoned creatures with _ [barkskin](spells_dir/barkskin#_barkskin)_, _ [mass cat's grace](spells_dir/catSGrace#_cat-s-grace-mass)_, and _ [greater magic fang](spells_dir/magicFang#_magic-fang-greater)_. She then casts offensive spells and drinks her _potion of [haste](spells_dir/haste#_haste)_ before wild shaping into a Huge elemental and moving into melee.
...
**Skills** [Acrobatics](skills_dir/acrobatics#_acrobatics) +4 (+0 when jumping), [Climb](skills_dir/climb#_climb) +8, [Fly](skills_dir/fly#_fly) +12, [Handle Animal](skills_dir/handleAnimal#_handle-animal) +6, [Heal](skills_dir/heal#_heal) +13, [Knowledge](skills_dir/knowledge#_knowledge) (geography) +14, [Knowledge](skills_dir/knowledge#_knowledge) (nature) +16, [Linguistics](skills_dir/linguistics#_linguistics) +5, Perception +24, [Ride](skills_dir/ride#_ride) +9, [Spellcraft](skills_dir/spellcraft#_spellcraft) +19, [Survival](skills_dir/survival#_survival) +19, [Swim](skills_dir/swim#_swim) +7

**Languages** Aquan, Auran, Common, Druidic, Halfling, Ignan, Sylvan, Terran

**SQ** a thousand faces, bramble armor (1d6+9, 18 rounds_dir/day), nature bond (Plant domain), nature sense, timeless body, trackless step, wild empathy +18, woodland stride

**Combat Gear** _potions of [cure serious wounds](spells_dir/cureSeriousWounds#_cure-serious-wounds)_ (2), _potion of [haste](spells_dir/haste#_haste)_, _wand of [ice storm](spells_dir/iceStorm#_ice-storm)_ (3 charges); **Other Gear** _+2 leather armor, +3 heavy [wild](magicItems_dir/armor#_armor-wild) darkwood wooden [shield](spells_dir/shield#_shield)_, _+1 quarterstaff_, _+1 sling_ with 20 bullets, _ [cloak of resistance](magicItems_dir/wondrousItems#_cloak-of-resistance) +3_, _dusty rose prism [ioun stone](magicItems_dir/wondrousItems#_ioun-stones)_, _ [headband of inspired wisdom](magicItems_dir/wondrousItems#_headband-of-inspired-wisdom) +4_, _ [ring of protection](magicItems_dir/rings#_ring-of-protection) +3_, backpack, everburning torch, holly and mistletoe, silk rope (50 ft.), spell component pouch, 96 gp
...
**Melee** _+1 club_ +17_dir/+12_dir/+7 (1d6+3)

**Ranged** _+1 sling_ +17_dir/+12_dir/+7 (1d4+3)

**Special Attacks** wild shape 8_dir/day

**Domain Spell-Like Abilities** (CL 19th; concentration +27)

11_dir/day—fire bolt

**Druid Spells Prepared** (CL 19th; concentration +27)

9th—_ [elemental swarm](spells_dir/elementalSwarm#_elemental-swarm)_D (fire spell only), empowered_ [fire storm](spells_dir/fireStorm#_fire-storm)_ (3, DC 27)

8th—quickened_ [cure serious wounds](spells_dir/cureSeriousWounds#_cure-serious-wounds)_, _incendiary clou d_D (DC 26), _ [reverse gravity](spells_dir/reverseGravity#_reverse-gravity)_, _ [sunburst](spells_dir/sunburst#_sunburst)_ (DC 28), _ [word of recall](spells_dir/wordOfRecall#_word-of-recall)_

7th—quickened_ [cure moderate wounds](spells_dir/cureModerateWounds#_cure-moderate-wounds)_, _ [fire storm](spells_dir/fireStorm#_fire-storm) _(2, DC 27),_ [elemental body I](spells_dir/elementalBody#_elemental-body-i) V_D (fire only), _ [heal](spells_dir/heal#_heal)_, _ [true seeing](spells_dir/trueSeeing#_true-seeing)_

6th—_fire seed s_D, empowered_ [flame strike](spells_dir/flameStrike#_flame-strike)_ (3, DC 24), _ [greater dispel magic](spells_dir/dispelMagic#_dispel-magic-greater)_, _ [mass cat's grace](spells_dir/catSGrace#_cat-s-grace-mass)_

5th—_ [cure critical wounds](spells_dir/cureCriticalWounds#_cure-critical-wounds)_ (2), _fire shiel d_D, _ [stoneskin](spells_dir/stoneskin#_stoneskin)_, _ [wall of fire](spells_dir/wallOfFire#_wall-of-fire)_ (2)

4th—_ [dispel magic](spells_dir/dispelMagic#_dispel-magic)_ (2), _ [flame strike](spells_dir/flameStrike#_flame-strike)_ (2, DC 24), _ [freedom of movement](spells_dir/freedomOfMovement#_freedom-of-movement)_, _ [ice storm](spells_dir/iceStorm#_ice-storm)_ (DC 24), _ [wall of fire](spells_dir/wallOfFire#_wall-of-fire)_D

3rd—_firebal l_D (5, DC 23), _ [greater magic fang](spells_dir/magicFang#_magic-fang-greater)_, _ [protection from energy](spells_dir/protectionFromEnergy#_protection-from-energy)_ (DC 21)

2nd—_ [barkskin](spells_dir/barkskin#_barkskin)_ (2), _ [bull's strength](spells_dir/bullSStrength#_bull-s-strength)_ (2), _ [hold animal](spells_dir/holdAnimal#_hold-animal)_ (DC 20), _ [produce flame](spells_dir/produceFlame#_produce-flame)_D, _ [lesser restoration](spells_dir/restoration#_restoration-lesser)_

1st—_ [burning hands](spells_dir/burningHands#_burning-hands)_D (2, DC 21), _ [cure light wounds](spells_dir/cureLightWounds#_cure-light-wounds)_, _ [endure elements](spells_dir/endureElements#_endure-elements)_, _ [faerie fire](spells_dir/faerieFire#_faerie-fire)_ (2), _ [shillelagh](spells_dir/shillelagh#_shillelagh)_

0 (at will)—_ [create water](spells_dir/createWater#_create-water)_, _ [flare](spells_dir/flare#_flare)_ (DC 20), _ [guidance](spells_dir/guidance#_guidance)_, _ [resistance](spells_dir/resistance#_resistance)_

**D** Domain spell; **Domain** Fire

TACTICS

**Before Combat** The druid casts _ [shambler](spells_dir/shambler#_shambler)_ once per week and casts _ [ironwood](spells_dir/ironwood#_ironwood)_ on his armor every 19 days.

**During Combat** The druid sends shambling mounds into combat, casts _ [mass cat's grace](spells_dir/catSGrace#_cat-s-grace-mass)_, wild shapes into a Huge fire elemental, and moves in to flank.
...
**Skills** [Climb](skills_dir/climb#_climb) +6, [Fly](skills_dir/fly#_fly) +6, [Handle Animal](skills_dir/handleAnimal#_handle-animal) +5, [Intimidate](skills_dir/intimidate#_intimidate) +1, [Knowledge](skills_dir/knowledge#_knowledge) (geography) +7, [Knowledge](skills_dir/knowledge#_knowledge) (nature) +13, [Knowledge](skills_dir/knowledge#_knowledge) (planes) +4, [Linguistics](skills_dir/linguistics#_linguistics) +5, Perception +23, [Ride](skills_dir/ride#_ride) +6, [Sense Motive](skills_dir/senseMotive#_sense-motive) +16, [Spellcraft](skills_dir/spellcraft#_spellcraft) +15, [Survival](skills_dir/survival#_survival) +21, [Swim](skills_dir/swim#_swim) +6
...
**Combat Gear** _potions of [cure serious wounds](spells_dir/cureSeriousWounds#_cure-serious-wounds)_ (2), _potion of [haste](spells_dir/haste#_haste)_, _scroll of [mass cure serious wounds](spells_dir/cureSeriousWounds#_cure-serious-wounds-mass)_; **Other Gear** , _+2 [wild](magicItems_dir/armor#_armor-wild) [ironwood](spells_dir/ironwood#_ironwood) breastplate_, _+2 [animated](magicItems_dir/armor#_armor-animated) darkwood heavy wooden [shield](spells_dir/shield#_shield)_, _+1 club_, _+1 sling _with 10 bullets, _ [belt of mighty constitution](magicItems_dir/wondrousItems#_belt-of-mighty-constitution) +2_, _ [cloak of resistance](magicItems_dir/wondrousItems#_cloak-of-resistance) +3_, _dusty rose prism [ioun stone](magicItems_dir/wondrousItems#_ioun-stones)_, _ [headband of inspired wisdom](magicItems_dir/wondrousItems#_headband-of-inspired-wisdom) +6, [ring of protection](magicItems_dir/rings#_ring-of-protection) +3_, holly and mistletoe, spell component pouch, silver crown (worth 200 gp), 63 gp
...
**Melee** _+1 [ghost touch](magicItems_dir/weapons#_weapons-ghost-touch) quarterstaff_ +19_dir/+14_dir/+9 (1d6+5)

**Ranged** _+1 [light](spells_dir/light#_light) hammer_ +17_dir/+12_dir/+7 (1d4+4)
...
10_dir/day—acid dart

**Druid Spells Prepared** (CL 20th; concentration +27)

9th—quickened_ [cure critical wounds](spells_dir/cureCriticalWounds#_cure-critical-wounds)_ (2), _ [elemental swarm](spells_dir/elementalSwarm#_elemental-swarm)_D (earth spell only), empowered_ [fire storm](spells_dir/fireStorm#_fire-storm)_ (DC 24), _ [storm of vengeance](spells_dir/stormOfVengeance#_storm-of-vengeance)_ (DC 27)

8th—_ [earthquake](spells_dir/earthquake#_earthquake)_D, _ [finger of death](spells_dir/fingerOfDeath#_finger-of-death)_ (DC 25), _ [repel metal or stone](spells_dir/repelMetalOrStone#_repel-metal-or-stone)_, _ [reverse gravity](spells_dir/reverseGravity#_reverse-gravity)_, _ [word of recall](spells_dir/wordOfRecall#_word-of-recall)_

7th—_ [changestaff](spells_dir/changestaff#_changestaff)_, _ [creeping doom](spells_dir/creepingDoom#_creeping-doom)_ (DC 25), _ [elemental body I](spells_dir/elementalBody#_elemental-body-i) V_D (earth only), _ [heal](spells_dir/heal#_heal)_, _ [mass cure moderate wounds](spells_dir/cureModerateWounds#_cure-moderate-wounds-mass)_, _ [true seeing](spells_dir/trueSeeing#_true-seeing)_

6th—_ [antilife shell](spells_dir/antilifeShell#_antilife-shell)_, empowered_ [flame strike](spells_dir/flameStrike#_flame-strike)_ (DC 21), _ [greater dispel magic](spells_dir/dispelMagic#_dispel-magic-greater)_ (2), _ [stoneskin](spells_dir/stoneskin#_stoneskin)_D

5th—_ [animal growth](spells_dir/animalGrowth#_animal-growth)_ (2, DC 22), _ [death ward](spells_dir/deathWard#_death-ward)_, quickened_ [obscuring mist](spells_dir/obscuringMist#_obscuring-mist)_, _ [wall of stone](spells_dir/wallOfStone#_wall-of-stone)_D, _ [wall of thorns](spells_dir/wallOfThorns#_wall-of-thorns)_

4th—_ [air walk](spells_dir/airWalk#_air-walk)_, _ [dispel magic](spells_dir/dispelMagic#_dispel-magic)_, _ [flame strike](spells_dir/flameStrike#_flame-strike)_ (DC 21), _ [freedom of movement](spells_dir/freedomOfMovement#_freedom-of-movement)_ (2), _ [spike stones](spells_dir/spikeStones#_spike-stones)_D (DC 21)

3rd—_ [cure moderate wounds](spells_dir/cureModerateWounds#_cure-moderate-wounds)_, _ [dominate animal](spells_dir/dominateAnimal#_dominate-animal)_ (DC 20), _ [greater magic fang](spells_dir/magicFang#_magic-fang-greater)_ (3), _ [stone shape](spells_dir/stoneShape#_stone-shape)_D, _ [wind wall](spells_dir/windWall#_wind-wall)_

2nd—_ [barkskin](spells_dir/barkskin#_barkskin)_ (3), _ [bear's endurance](spells_dir/bearSEndurance#_bear-s-endurance)_, _ [bull's strength](spells_dir/bullSStrength#_bull-s-strength)_, _ [cat's grace](spells_dir/catSGrace#_cat-s-grace)_, _ [soften earth and stone](spells_dir/softenEarthAndStone#_soften-earth-and-stone)_D

1st—_ [cure light wounds](spells_dir/cureLightWounds#_cure-light-wounds)_ (2), _ [faerie fire](spells_dir/faerieFire#_faerie-fire)_ (2), _ [magic stone](spells_dir/magicStone#_magic-stone)_D, _ [obscuring mist](spells_dir/obscuringMist#_obscuring-mist)_, _ [speak with animals](spells_dir/speakWithAnimals#_speak-with-animals)_

0 (at will)—_ [create water](spells_dir/createWater#_create-water)_, _ [guidance](spells_dir/guidance#_guidance), [mending](spells_dir/mending#_mending)_, _ [stabilize](spells_dir/stabilize#_stabilize)_

**D** Domain spell; **Domain** Earth

TACTICS

**Before Combat** The druid casts _ [shambler](spells_dir/shambler#_shambler)_ to create 1d4+2 advanced shambling mounds.

**During Combat** The druid deploys shambling mounds, wild shapes into a Huge earth elemental, and casts spells on himself. If interrupted, he earth glides and casts _ [storm of vengeance](spells_dir/stormOfVengeance#_storm-of-vengeance)_.
...
**Skills** [Fly](skills_dir/fly#_fly) +3, [Handle Animal](skills_dir/handleAnimal#_handle-animal) +3, [Knowledge](skills_dir/knowledge#_knowledge) (engineering) +4, [Knowledge](skills_dir/knowledge#_knowledge) (nature) +15, [Knowledge](skills_dir/knowledge#_knowledge) (planes) +8, [Linguistics](skills_dir/linguistics#_linguistics) +4, Perception +22 (+24 to notice unusual stonework), [Perform](skills_dir/perform#_perform) (percussion) +4, [Ride](skills_dir/ride#_ride) +3, [Spellcraft](skills_dir/spellcraft#_spellcraft) +21, [Survival](skills_dir/survival#_survival) +19, [Swim](skills_dir/swim#_swim) +5
...
**Gear** _+3 [wild](magicItems_dir/armor#_armor-wild) [ironwood](spells_dir/ironwood#_ironwood) full plate_, _+3 [animated](magicItems_dir/armor#_armor-animated) darkwood heavy wooden [shield](spells_dir/shield#_shield)_, _+1 [ghost touch](magicItems_dir/weapons#_weapons-ghost-touch) quarterstaff_, _+1 [light](spells_dir/light#_light) hammer_, _ [boots of speed](magicItems_dir/wondrousItems#_boots-of-speed)_, _ [cloak of resistance](magicItems_dir/wondrousItems#_cloak-of-resistance) +3_, _dusty rose prism [ioun stone](magicItems_dir/wondrousItems#_ioun-stones)_, _ [headband of inspired wisdom](magicItems_dir/wondrousItems#_headband-of-inspired-wisdom) +4_, _ [ring of evasion](magicItems_dir/rings#_ring-of-evasion)_, _ [ring of protection](magicItems_dir/rings#_ring-of-protection) +3_, holly and mistletoe, spell component pouch, 487 gp

...
1st—_ [bane](magicItems_dir/weapons#_weapons-bane)_ (DC 14), _ [magic stone](spells_dir/magicStone#_magic-stone)_, _ [magic weapon](spells_dir/magicWeapon#_magic-weapon)_, _ [true strike](spells_dir/trueStrike#_true-strike)_D
...
**Feats** [Deadly Aim](feats#_deadly-aim), [Martial Weapon Proficiency](feats#_martial-weapon-proficiency) (shortbow), [Skill Focus](feats#_skill-focus) ( [Stealth](skills_dir/stealth#_stealth))
...
0 (at will)—_ [guidance](spells_dir/guidance#_guidance)_, _ [light](spells_dir/light#_light)_, _ [purify food and drink](spells_dir/purifyFoodAndDrink#_purify-food-and-drink)_, _ [resistance](spells_dir/resistance#_resistance)_
...
**Melee** _+1 greataxe_ +12_dir/+7 (1d12+9_dir/×3)
...
5th—_ [slay living](spells_dir/slayLiving#_slay-living)_ D (2, DC 21)
...
7_dir/day—strength surge (+5), vision of madness (+_dir/–5)
...
**Skills** [Handle Animal](skills_dir/handleAnimal#_handle-animal) +11, [Heal](skills_dir/heal#_heal) +8, [Knowledge](skills_dir/knowledge#_knowledge) (nature) +1, [Knowledge](skills_dir/knowledge#_knowledge) (religion) +6, Perception +14, [Spellcraft](skills_dir/spellcraft#_spellcraft) +8
...
8_dir/day—fire bolt (1d6+5 fire), touch of law
...
**Base Statistics** Without _ [bear's endurance](spells_dir/bearSEndurance#_bear-s-endurance)_ and _ [stoneskin](spells_dir/stoneskin#_stoneskin)_, the cleric's statistics are **hp** 95, **Fort** +11; **DR** none; **Con** 14.
...
**Skills** [Bluff](skills_dir/bluff#_bluff) +5, [Intimidate](skills_dir/intimidate#_intimidate) +5, [Knowledge](skills_dir/knowledge#_knowledge) (local) +6, [Knowledge](skills_dir/knowledge#_knowledge) (religion) +9, Perception +20, [Spellcraft](skills_dir/spellcraft#_spellcraft) +11
...
7th—_ [elemental body I](spells_dir/elementalBody#_elemental-body-i) V_D (air only), _ [ethereal jaunt](spells_dir/etherealJaunt#_ethereal-jaunt)_, _ [repulsion](spells_dir/repulsion#_repulsion)_ (DC 24), _ [summon monster VII](spells_dir/summonMonster#_summon-monster-vii)_ (2)
...
0 (at will)—_ [bleed](spells_dir/bleed#_bleed)_ (DC 16), _ [detect magic](spells_dir/detectMagic#_detect-magic)_, _ [detect poison](spells_dir/detectPoison#_detect-poison)_, _ [mending](spells_dir/mending#_mending)_
...
**Combat Gear** _wand of [invisibility](spells_dir/invisibility#_invisibility)_ (10 charges); **Other Gear** _+1 [seeking](magicItems_dir/weapons#_weapons-seeking) [light](spells_dir/light#_light) crossbow_ with 20 bolts, _+1 [shadow](magicItems_dir/armor#_armor-shadow) studded leather_, _+1 short sword_, _ [amulet of natural armor](magicItems_dir/wondrousItems#_amulet-of-natural-armor) +2_, _ [belt of mighty constitution](magicItems_dir/wondrousItems#_belt-of-mighty-constitution) +2_, _ [boots of speed](magicItems_dir/wondrousItems#_boots-of-speed)_, _ [cloak of resistance](magicItems_dir/wondrousItems#_cloak-of-resistance) +4_, _ [headband of inspired wisdom](magicItems_dir/wondrousItems#_headband-of-inspired-wisdom) +4_, _ [ring of protection](magicItems_dir/rings#_ring-of-protection) +3_, wooden unholy symbol, eye ointment for _ [true seeing](spells_dir/trueSeeing#_true-seeing)_ (worth 250 gp), 4,254 gp
...
**Melee** _+4 spiked chain_ +23_dir/+18_dir/+13 (2d4+10_dir/19–20)

**Special Attacks** channel negative energy 7_dir/day (DC 23, 12d6)

**Domain Spell-Like Abilities** (CL 19th; concentration +25)

9_dir/day—bleeding touch (9 rounds), touch of darkness (9 rounds)

**Cleric Spells Prepared** (CL 19th; concentration +25)

9th—_ [energy drain](spells_dir/energyDrain#_energy-drain)_ (DC 25), _ [etherealness](magicItems_dir/armor#_armor-etherealness)_, _ [implosion](spells_dir/implosion#_implosion)_ (DC 25), _ [wail of the banshee](spells_dir/wailOfTheBanshee#_wail-of-the-banshee)_D (DC 25)

8th—_ [antimagic field](spells_dir/antimagicField#_antimagic-field)_, _create greater undea d_D, _ [earthquake](spells_dir/earthquake#_earthquake)_, _ [fire storm](spells_dir/fireStorm#_fire-storm)_ (DC 24)

7th—_ [blasphemy](spells_dir/blasphemy#_blasphemy)_ (2, DC 23), _ [ethereal jaunt](spells_dir/etherealJaunt#_ethereal-jaunt)_, _power word blin d_D_, [repulsion](spells_dir/repulsion#_repulsion)_ (DC 23)

6th—_ [antilife shell](spells_dir/antilifeShell#_antilife-shell)_, _ [blade barrier](spells_dir/bladeBarrier#_blade-barrier)_ (DC 22), _ [harm](spells_dir/harm#_harm)_ (2, DC 22), _ [shadow walk](spells_dir/shadowWalk#_shadow-walk)_D (DC 22), _ [word of recall](spells_dir/wordOfRecall#_word-of-recall)_

5th—_ [greater command](spells_dir/command#_command-greater)_ (DC 21), _ [insect plague](spells_dir/insectPlague#_insect-plague)_, _ [slay living](spells_dir/slayLiving#_slay-living)_D (2), _ [unhallow](spells_dir/unhallow#_unhallow)_, _ [wall of stone](spells_dir/wallOfStone#_wall-of-stone)_

4th—_ [air walk](spells_dir/airWalk#_air-walk)_, _death war d_D, _ [freedom of movement](spells_dir/freedomOfMovement#_freedom-of-movement)_, _ [greater magic weapon](spells_dir/magicWeapon#_magic-weapon-greater)_, _ [neutralize poison](spells_dir/neutralizePoison#_neutralize-poison)_, _ [unholy blight](spells_dir/unholyBlight#_unholy-blight)_ (DC 20)

3rd—_ [deeper darkness](spells_dir/deeperDarkness#_deeper-darkness)_D (2), _ [dispel magic](spells_dir/dispelMagic#_dispel-magic)_ (2), _ [invisibility purge](spells_dir/invisibilityPurge#_invisibility-purge)_, _ [magic vestment](spells_dir/magicVestment#_magic-vestment)_

2nd—_ [darkness](spells_dir/darkness#_darkness)_, _death knel l_D (DC 18), _ [desecrate](spells_dir/desecrate#_desecrate)_, _ [gentle repose](spells_dir/gentleRepose#_gentle-repose)_, _ [hold person](spells_dir/holdPerson#_hold-person)_ (DC 18), _ [shield other](spells_dir/shieldOther#_shield-other)_, _ [spiritual weapon](spells_dir/spiritualWeapon#_spiritual-weapon)_

1st—_ [bane](magicItems_dir/weapons#_weapons-bane)_ (DC 17), _ [bless](spells_dir/bless#_bless)_, _cause fea r_D (DC 17), _ [deathwatch](spells_dir/deathwatch#_deathwatch)_, _ [doom](spells_dir/doom#_doom)_ (DC 17), _ [entropic shield](spells_dir/entropicShield#_entropic-shield)_, _ [obscuring mist](spells_dir/obscuringMist#_obscuring-mist)_

0 (at will)—_ [detect magic](spells_dir/detectMagic#_detect-magic)_, _ [guidance](spells_dir/guidance#_guidance)_, _ [read magic](spells_dir/readMagic#_read-magic)_, _ [virtue](spells_dir/virtue#_virtue)_

**D** Domain spell; **Domains** Darkness, Death

Tactics

**Before Combat** The cleric casts _ [air walk](spells_dir/airWalk#_air-walk)_, _ [freedom of movement](spells_dir/freedomOfMovement#_freedom-of-movement)_, _ [greater magic weapon](spells_dir/magicWeapon#_magic-weapon-greater)_, and _ [magic vestment](spells_dir/magicVestment#_magic-vestment)_.
...
**Base Statistics** Without _ [greater magic weapon](spells_dir/magicWeapon#_magic-weapon-greater)_ and _ [magic vestment](spells_dir/magicVestment#_magic-vestment)_, the cleric's statistics are **AC** 28, touch 14, flat-footed 28; **Melee** _+1 spiked chain_ +20_dir/+15_dir/+10 (2d4+7_dir/19–20).
...
**Skills** [Knowledge](skills_dir/knowledge#_knowledge) (local) +4, [Knowledge](skills_dir/knowledge#_knowledge) (religion) +12, Perception +21, [Sense Motive](skills_dir/senseMotive#_sense-motive) +17

**Languages** Common

**SQ** aura, death's embrace, eyes of darkness (9 rounds_dir/day)

**Gear** _+1 full plate_, _+1 spiked chain_, _ [javelin of lightning](magicItems_dir/weapons#_javelin-of-lightning)_,_ [amulet of natural armor](magicItems_dir/wondrousItems#_amulet-of-natural-armor) +2_, _ [belt of physical might](magicItems_dir/wondrousItems#_belt-of-physical-might) +4_ (Str, Con), _ [cloak of resistance](magicItems_dir/wondrousItems#_cloak-of-resistance) +1_, _ [headband of mental prowess](magicItems_dir/wondrousItems#_headband-of-mental-prowess) +2_ (Wis, Cha), _ [phylactery of negative channeling](magicItems_dir/wondrousItems#_phylactery-of-negative-channeling)_, _ [ring of force shield](magicItems_dir/rings#_ring-of-force-shield)_, _ [ring of protection](magicItems_dir/rings#_ring-of-protection) +4_, silver unholy symbol, unholy water, materials for _ [unhallow](spells_dir/unhallow#_unhallow)_ (worth 1,000 gp), onyx gems (worth 1,500 gp each), platinum rings for _ [shield other](spells_dir/shieldOther#_shield-other)_ (worth 100 gp), silver dust for _ [desecrate](spells_dir/desecrate#_desecrate)_ (worth 25 gp), 3,450 gp
...
**Melee** _rod of the viper_ +18_dir/+13_dir/+8 (1d8+3)

**Ranged** _+1 heavy crossbow_ +16 (1d10+1_dir/19–20)

**Special Attacks** channel negative energy 6_dir/day (DC 23, 10d6), hand of the acolyte (8_dir/day)

**Domain Spell-Like Abilities** (CL 20th; concentration +25)

8_dir/day—fire bolt (1d6+10 fire)

4_dir/day—dispelling touch

**Cleric Spells Prepared** (CL 20th; concentration +25)

9th—_ [elemental swarm](spells_dir/elementalSwarm#_elemental-swarm)_D (fire spell only), _ [energy drain](spells_dir/energyDrain#_energy-drain)_ (DC 24), _ [gate](spells_dir/gate#_gate)_, _ [implosion](spells_dir/implosion#_implosion)_ (DC 26), _ [summon monster IX](spells_dir/summonMonster#_summon-monster-ix)_

8th—_ [antimagic field](spells_dir/antimagicField#_antimagic-field)_, _ [fire storm](spells_dir/fireStorm#_fire-storm)_ (DC 25), _incendiary clou d_D (DC 24),_ [summon monster VIII](spells_dir/summonMonster#_summon-monster-viii)_, _ [unholy aura](spells_dir/unholyAura#_unholy-aura)_

7th—_ [blasphemy](spells_dir/blasphemy#_blasphemy)_ (DC 24), _ [ethereal jaunt](spells_dir/etherealJaunt#_ethereal-jaunt)_, _ [greater restoration](spells_dir/restoration#_restoration-greater)_, _ [spell turning](spells_dir/spellTurning#_spell-turning)_D, _ [summon monster VII](spells_dir/summonMonster#_summon-monster-vii)_

6th—_antimagic fiel d_D, _ [blade barrier](spells_dir/bladeBarrier#_blade-barrier)_ (2, DC 23), _ [heal](spells_dir/heal#_heal)_ (2)

5th—_ [break enchantment](spells_dir/breakEnchantment#_break-enchantment)_, _ [dispel good](spells_dir/dispelGood#_dispel-good)_, _ [flame strike](spells_dir/flameStrike#_flame-strike)_ (DC 22), _ [greater command](spells_dir/command#_command-greater)_ (DC 20), _ [insect plague](spells_dir/insectPlague#_insect-plague)_, _ [spell resistance](magicItems_dir/armor#_armor-spell-resistance)_D

4th—_ [cure critical wounds](spells_dir/cureCriticalWounds#_cure-critical-wounds)_, _ [dimensional anchor](spells_dir/dimensionalAnchor#_dimensional)_, _ [dismissal](spells_dir/dismissal#_dismissal)_ (DC 19), _ [freedom of movement](spells_dir/freedomOfMovement#_freedom-of-movement)_, _ [unholy blight](spells_dir/unholyBlight#_unholy-blight)_ (DC 21), _ [wall of fire](spells_dir/wallOfFire#_wall-of-fire)_D

3rd—_ [bestow curse](spells_dir/bestowCurse#_bestow-curse)_ (DC 18), _firebal l_D (DC 20), _ [magic vestment](spells_dir/magicVestment#_magic-vestment)_ (2), _ [protection from energy](spells_dir/protectionFromEnergy#_protection-from-energy)_ (2, DC 18)

2nd—_ [align weapon](spells_dir/alignWeapon#_align-weapon)_, _ [delay poison](spells_dir/delayPoison#_delay-poison)_, _ [hold person](spells_dir/holdPerson#_hold-person)_ (DC 17), _ [lesser restoration](spells_dir/restoration#_restoration-lesser)_, _ [produce flame](spells_dir/produceFlame#_produce-flame)_D, _ [spiritual weapon](spells_dir/spiritualWeapon#_spiritual-weapon)_

1st—_ [bless](spells_dir/bless#_bless)_, _ [burning hands](spells_dir/burningHands#_burning-hands)_D (DC 18), _ [command](spells_dir/command#_command)_ (3, DC 16), _ [doom](spells_dir/doom#_doom)_ (DC 16), _ [sanctuary](spells_dir/sanctuary#_sanctuary)_ (DC 16)

0 (at will)—_ [create water](spells_dir/createWater#_create-water)_, _ [detect magic](spells_dir/detectMagic#_detect-magic)_, _ [guidance](spells_dir/guidance#_guidance)_, _ [mending](spells_dir/mending#_mending)_

**D** Domain spell; **Domains** Fire, Magic

Tactics

**Before Combat** The cleric casts _ [delay poison](spells_dir/delayPoison#_delay-poison)_, _ [freedom of movement](spells_dir/freedomOfMovement#_freedom-of-movement)_, _ [magic vestment](spells_dir/magicVestment#_magic-vestment)_ (armor and shield), and _ [spell turning](spells_dir/spellTurning#_spell-turning)_.

**During Combat** The cleric first conjures devils to defend him.

**Base Statistics** Without _ [magic vestment](spells_dir/magicVestment#_magic-vestment)_the cleric's statistics are **AC** 29, touch 14, flat-footed 29.
...
**Skills** [Bluff](skills_dir/bluff#_bluff) +13, [Diplomacy](skills_dir/diplomacy#_diplomacy) +16, [Intimidate](skills_dir/intimidate#_intimidate) +13, [Knowledge](skills_dir/knowledge#_knowledge) (arcana) +9, [Knowledge](skills_dir/knowledge#_knowledge) (religion) +14, Perception +20, [Sense Motive](skills_dir/senseMotive#_sense-motive) +18, [Spellcraft](skills_dir/spellcraft#_spellcraft) +14

**Languages** Common, Infernal

**SQ** aura

**Combat Gear** _potion of [displacement](spells_dir/displacement#_displacement)_, _potion of [fly](spells_dir/fly)_, _potion of [haste](spells_dir/haste#_haste)_; **Other Gear** _+1 mithral breastplate_, _+1 heavy steel [shield](spells_dir/shield#_shield)_, _+1 heavy crossbow_ with 20 bolts, _rod of the viper_, _ [amulet of natural armor](magicItems_dir/wondrousItems#_amulet-of-natural-armor) +4_, _ [bag of holding](magicItems_dir/wondrousItems#_bag-of-holding) _(type II), _ [belt of physical might](magicItems_dir/wondrousItems#_belt-of-physical-might) +2_ (Con, Dex), _ [cloak of resistance](magicItems_dir/wondrousItems#_cloak-of-resistance) +4_, _ [headband of inspired wisdom](magicItems_dir/wondrousItems#_headband-of-inspired-wisdom) +4_, _ [ring of counterspells](magicItems_dir/rings#_ring-of-counterspells)_, _ [ring of protection](magicItems_dir/rings#_ring-of-protection) +4_, silver unholy symbol, material components for _ [gate](spells_dir/gate#_gate)_ (worth 10,000 gp), 3,855 gp

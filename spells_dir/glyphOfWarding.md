...
**Saving Throw** see text; **[Spell Resistance](../glossary.md#_spell-resistance)** no (object) and yes; see text
...
Glyphs cannot be affected or bypassed by such means as physical or magical probing, though they can be dispelled. _ [Mislead](mislead.md#_mislead)_, _ [polymorph](polymorph.md#_polymorph)_, and _ [nondetection](nondetection.md#_nondetection) _(and similar magical effects) can fool a glyph, though nonmagical disguises and the like can't. _ [Read magic](readMagic.md#_read-magic) _allows you to identify a _glyph of warding _with a DC 13 Knowledge (arcana) check. Identifying the glyph does not discharge it and allows you to know the basic nature of the glyph (version, type of damage caused, what spell is stored).
...
_ [Read magic](readMagic.md#_read-magic)_ allows you to identify a _greater glyph of warding_ with a DC 16 Spellcraft check.

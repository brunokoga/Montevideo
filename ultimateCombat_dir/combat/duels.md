---
layout: default
title: ultimateCombat_dir/combat_dir/duels
---
# Duels
...
When a dueling opponent tries to cast a spell, the targeted spellcaster can make a [Spellcraft](../skills_dir/spellcraft#_spellcraft) check (DC 15 + the spell's level) as a free action. If the check succeeds, she can identify her opponent's spell and can attempt a dueling counter. If it fails, she cannot attempt a dueling counter against that spell (although special actions are still available to her).
...
| Spell is of a higher level than the spell being countered | +1_dir/level above |

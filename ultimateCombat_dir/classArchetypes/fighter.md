---
title: ultimateCombat/classArchetype_dir/fighter
---
# Fighter
...
**Fortification (Ex)** : At 9th level, an armor master can use his armor to shield critical areas from injury. He treats any armor he wears as if it had the _ [light](spell_dir/light#_light [fortification](magicItem_dir/armor#_armor-fortification_ special ability. At 13th level, his armor gains the _moderate [fortification](magicItem_dir/armor#_armor-fortification)_ special ability. This fortification does not stack in any way with armor that has these special abilities. In these cases the armor master takes the better of the two fortifications. This ability replaces weapon training 2 and 4.
...
**Skills** : [Acrobatics](skill_dir/acrobatics#_acrobatics) (Dex, [Bluff](skill_dir/bluff#_bluff) (Cha, [Escape Artist](skill_dir/escapeArtist#_escape-artist) (Dex, [Sleight of Hand](skill_dir/sleightOfHand#_sleight-of-hand) (Dex, and [Stealth](skill_dir/stealth#_stealth) (Dex) are class skills for a cad.
...
**Skilled Rider (Ex)** : At 1st level, a dragoon gains both the [Mounted Combat](feats#_mounted-combat) and [Skill Focus](feats#_skill-focus) ( [Ride](skill_dir/ride#_ride)) feats as bonus feats. This ability replaces the 1st-level fighter bonus combat feat.
...
**Piercing Lance (Ex)** : At 11th level, as a standard action or as part of a charge, a dragoon attacking a mounted opponent can make two attacks, one against the mount and the other against the rider, using his highest base attack bonus. Furthermore, if the mount is hit and its rider attempts to negate the hit with the [Mounted Combat](feats#_mounted-combat feat, the dragoon's attack roll is considered 4 higher when calculating the DC of the [Ride](skill_dir/ride#_ride) check to negate the hit. This ability replaces armor training 3.

**Leaping Lance (Ex** : At 15th level, a dragoon and his mount suffer no armor check penalty on [Acrobatics](skill_dir/acrobatics#_acrobatics) checks while mounted. When charging, a dragoon may jump from his mount toward his target. If he jumps 10 feet, his charge modifiers on attack rolls and to AC are doubled and he is still considered mounted for lance damage, mounted combat feats, and so on. This ability replaces armor training 4.
...
**Skills** : A gladiator gains [Perform](skill_dir/perform#_perform) (act, comedy, and dance) (Cha as class skills.
...
**Strategic Training (Ex)** : A tactician gains 4 skill points + a number of skill points equal to his Intelligence modifier at each level, instead of the normal 2 skill points + Intelligence modifier at each level. Furthermore, [Diplomacy](skill_dir/diplomacy#_diplomacy) (Cha, [Knowledge](skill_dir/knowledge#_knowledge) (geography) (Int, [Knowledge](skill_dir/knowledge#_knowledge) (nobility) (Int, [Linguistics](skill_dir/linguistics#_linguistics) (Int, and [Sense Motive](skill_dir/senseMotive#_sense-motive) (Wis) are all class skills for the tactician. This ability replaces the bonus fighter combat feat gained at 1st level.

**Bonus Feats** : A tactician may choose [Skill Focus](feats#_skill-focus) or any teamwork feat, in addition to combat feats, as bonus feats.
...
**Heroic Recovery (Ex)** : At 5th level, an unbreakable gains the [Heroic Recovery](advance_dir/advancedFeats#_heroic-recovery) feat as a bonus feat, if he does not have it already. If he already has this feat, the unbreakable can choose any combat feat instead. In addition, he may use this feat one additional time per day for every four levels after 5th (to a maximum of 4 times per day at 17th level). This ability replaces weapon training 1.

**Heroic Defiance (Ex** : At 9th level, an unbreakable gains the [Heroic Defiance](advance_dir/advancedFeats#_heroic-defiance) feat as a bonus feat, if he does not have it already. If he already has this feat, the unbreakable can choose any combat feat instead. In addition, he may use this feat one additional time per day for every four levels after 9th (to a maximum of 3 times per day at 19th level). This ability replaces weapon training 2.
...
**Axes** : [bardiche](advance_dir/advancedGear#_table-4-1:-weapons), [battleaxe](equipment#_weapon-descriptions), [dwarven waraxe](equipment#_weapon-descriptions), [greataxe](equipment#_weapon-descriptions), [handaxe](equipment#_weapon-descriptions), [heavy pick](equipment#_weapon-descriptions, [hooked axe](../comba_dir/gladiatorWeapons#_table-gladiator-weapons, [knuckle axe](../comba_dir/gladiatorWeapons#_table-gladiator-weapons), [light pick](equipment#_weapon-descriptions, [mattock](../comba_dir/primitiveArmorAndWeapons#_table-bronze-age-weapons), [orc double axe](equipment#_weapon-descriptions, [pata](../comba_dir/gladiatorWeapons#_table-gladiator-weapons), and [throwing axe](equipment#_weapon-descriptions)

**Blades, Heavy** : [bastard sword](equipment#_weapon-descriptions, [chakram](advance_dir/advancedGear#_table-4-1:-weapons, [double chicken saber](../comba_dir/easternArmorAndWeapons#table-eastern-weapons-martial, [double walking stick katana](../comba_dir/easternArmorAndWeapons#table-eastern-weapons-exotic), [elven curve blade](equipment#_weapon-descriptions, [falcata](advance_dir/advancedGear#_table-4-1:-weapons), [falchion](equipment#_weapon-descriptions), [greatsword](equipment#_weapon-descriptions, [great terbutje](../comba_dir/primitiveArmorAndWeapons#table-stone-age-weapons, [katana](../comba_dir/easternArmorAndWeapons#table-eastern-weapons-exotic, [khopesh](advance_dir/advancedGear#_table-4-1:-weapons), [longsword](equipment#_weapon-descriptions, [nine-ring broadsword](../comba_dir/easternArmorAndWeapons#table-eastern-weapons-martial, [nodachi](../comba_dir/easternArmorAndWeapons#table-eastern-weapons-martial), [scimitar](equipment#_weapon-descriptions), [scythe](equipment#_weapon-descriptions, [seven-branched sword](../comba_dir/easternArmorAndWeapons#table-eastern-weapons-exotic, [shotel](../comba_dir/gladiatorWeapons#_table-gladiator-weapons, [temple sword](advance_dir/advancedGear#_table-4-1:-weapons, [terbutje](../comba_dir/primitiveArmorAndWeapons#table-stone-age-weapons), and [two-bladed sword](equipment#_weapon-descriptions

**Blades, Light** : [bayonet](advance_dir/advancedGear#_table-4-1:-weapons, [butterfly sword](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-martial), [dagger](equipment#_weapon-descriptions, [gladius](../comba_dir/gladiatorWeapons#_table-gladiator-weapons), [kama](equipment#_weapon-descriptions, [kerambit](../comba_dir/easternArmorAndWeapons#_eastern-weapons-martial), [kukri](equipment#_weapon-descriptions, [pata](../comba_dir/gladiatorWeapons#_table-gladiator-weapons, [quadrens](../comba_dir/gladiatorWeapons#_table-gladiator-weapons), [rapier](equipment#_weapon-descriptions), [short sword](equipment#_weapon-descriptions, [sica](../comba_dir/gladiatorWeapons#_table-gladiator-weapons), [sickle](equipment#_weapon-descriptions), [starknife](equipment#_weapon-descriptions, [swordbreaker dagger](advance_dir/advancedGear#_table-4-1:-weapons, [sword cane](advance_dir/advancedGear#_table-4-1:-weapons, and [wakizashi](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-exotic)
...
**Close** : [bayonet](advance_dir/advancedGear#_table-4-1:-weapons, [brass knuckles](advance_dir/advancedGear#_table-4-1:-weapons, [dan bong](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-exotic, [emei piercer](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-exotic, [fighting fan](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-exotic), [gauntlet](equipment#_weapon-descriptions), [heavy shield](equipment#_weapon-descriptions, [iron brush](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-martial), [light shield](equipment#_weapon-descriptions, [madu](../comba_dir/gladiatorWeapons#_table-gladiator-weapons, [mere club](../comba_dir/primitiveArmorAndWeapons#_table-stone-age-weapons), [punching dagger](equipment#_weapon-descriptions), [sap](equipment#_weapon-descriptions, [scizore](../comba_dir/gladiatorWeapons#_table-gladiator-weapons), [spiked armor](equipment#_weapon-descriptions), [spiked gauntlet](equipment#_weapon-descriptions), [spiked shield](equipment#_weapon-descriptions, [tekko-kagi](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-exotic, [tonfa](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-martial), [unarmed strike](equipment#_weapon-descriptions, [wooden stake](advance_dir/advancedGear#_table-4-1:-weapons, and [wushu dart](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-martial

**Crossbows** : [double crossbow](advance_dir/advancedGear#_table-4-1:-weapons), [hand crossbow](equipment#_weapon-descriptions), [heavy crossbow](equipment#_weapon-descriptions), [heavy repeating crossbow](equipment#_weapon-descriptions), [light crossbow](equipment#_weapon-descriptions), [light repeating crossbow](equipment#_weapon-descriptions, and [tube arrow shooter](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-martial)
...
**Flails** : [chain spear](advance_dir/advancedGear#_table-4-1:-weapons), [dire flail](equipment#_weapon-descriptions, [double chained kama](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-exotic), [flail](equipment#_weapon-descriptions, [flying blade](../comba_dir/gladiatorWeapons#_table-gladiator-weapons), [heavy flail](equipment#_weapon-descriptions, [kusarigama](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-exotic, [kyoketsu shoge](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-exotic, [meteor hammer](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-exotic), [morningstar](equipment#_weapon-descriptions, [nine-section whip](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-exotic), [nunchaku](equipment#_weapon-descriptions, [sansetsukon](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-martial, [scorpion whip](../comba_dir/gladiatorWeapons#_table-gladiator-weapons), [spiked chain](equipment#_weapon-descriptions, [urumi](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-exotic), and [whip](equipment#_weapon-descriptions

**Hammers** : [aklys](../comba_dir/gladiatorWeapons#_table-gladiatorweapons, [battle aspergillum](advance_dir/advancedGear#_table-4-1:-weapons), [club](equipment#_weapon-descriptions), [greatclub](equipment#_weapon-descriptions), [heavy mace](equipment#_weapon-descriptions), [light hammer](equipment#_weapon-descriptions), [light mace](equipment#_weapon-descriptions, [mere club](../comba_dir/primitiveArmorAndWeapons#_table-stone-age-weapons, [taiaha](../comba_dir/primitiveArmorAndWeapons, [tetsubo](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-exotic, [wahaika](../comba_dir/primitiveArmorAndWeapons#_table-stone-age-weapons), and [warhammer](equipment#_weapon-descriptions

**Monk** : [bo staff](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-exotic, [brass knuckles](advance_dir/advancedGear#_table-4-1:-weapons, [butterfly sword](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-martial, [cestus](advance_dir/advancedGear#_table-4-1:-weapons, [dan bong](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-exotic, [double chained kama](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-exotic, [double chicken saber](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-martial, [emei piercer](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-exotic, [fighting fan](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-exotic), jutte, [kama](equipment#_weapon-descriptions, [kusarigama](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-exotic, [kyoketsu shoge](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-exotic, [lungshuan tamo](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-martial, [monk's spade](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-martial, [nine-ring broadsword](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-martial, [nine-section whip](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-exotic), [nunchaku](equipment#_weapon-descriptions), [quarterstaff](equipment#_weapon-descriptions, [rope dart](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-exotic), [sai](equipment#_weapon-descriptions, [sansetsukon](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-martial, [seven-branched sword](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-exotic, [shang gou](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-martial), [shuriken](equipment#_weapon-descriptions), [siangham](equipment#_weapon-descriptions, [tiger fork](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-martial, [tonfa](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-martial, [tri-point double-edged sword](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-martial), [unarmed strike](equipment#_weapon-descriptions, [urumi](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-exotic, [wushu dart](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-martial

**Natural** : unarmed strike and all natural weapons, such as bite, claw, gore, tail, and wing

**Polearms** : [bardiche](advance_dir/advancedGear#_table-4-1:-weapons, [bec de corbin](advance_dir/advancedGear#_table-4-1:-weapons, [bill](advance_dir/advancedGear#_table-4-1:-weapons), [glaive](equipment#_weapon-descriptions, [glaive-guisarme](advance_dir/advancedGear#_table-4-1:-weapons), [guisarme](equipment#_weapon-descriptions), [halberd](equipment#_weapon-descriptions, [hooked lance](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-martial, [lucerne hammer](advance_dir/advancedGear#_table-4-1:-weapons, [mancatcher](advance_dir/advancedGear#_table-4-1:-weapons, [monk's spade](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-martial, [naginata](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-martial, [nodachi](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-martial), [ranseur](equipment#_weapon-descriptions, and [tiger fork](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-martial

**Spears** : [amentum](../comba_dir/gladiatorWeapons#_table-gladiatorweapons, [boar spear](advance_dir/advancedGear#_table-4-1:-weapons), [javelin](equipment#_weapon-descriptions, [harpoon](../comba_dir/primitiveArmorAndWeapons), [lance](equipment#_weapon-descriptions), [longspear](equipment#_weapon-descriptions, [pilum](advance_dir/advancedGear#_table-4-1:-weapons), [shortspear](equipment#_weapon-descriptions, [sibat](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-martial), [spear](equipment#_weapon-descriptions, [tiger fork](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-martial), and [trident](equipment#_weapon-descriptions

**Thrown** : [aklys](../comba_dir/gladiatorWeapons#_table-gladiatorweapons, [amentum](../comba_dir/gladiatorWeapons#_table-gladiatorweapons, [atlatl](../comba_dir/primitiveArmorAndWeapons#_table-stone-age-weapons), [blowgun](equipment#_weapon-descriptions), [bolas](equipment#_weapon-descriptions, [boomerang](advance_dir/advancedGear#_table-4-1:-weapons, [chakram](advance_dir/advancedGear#_table-4-1:-weapons), [club](equipment#_weapon-descriptions), [dagger](equipment#_weapon-descriptions), [dart](equipment#_weapon-descriptions), [halfling sling staff](equipment#_weapon-descriptions, [harpoon](../comba_dir/primitiveArmorAndWeapons), [javelin](equipment#_weapon-descriptions, [lasso](advance_dir/advancedGear#_table-4-1:-weapons, [kestros](../comba_dir/primitiveArmorAndWeapons), [light hammer](equipment#_weapon-descriptions), [net](equipment#_weapon-descriptions, [poisoned sand tube](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-martial, [rope dart](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-exotic), [shortspear](equipment#_weapon-descriptions), [shuriken](equipment#_weapon-descriptions), [sling](equipment#_weapon-descriptions), [spear](equipment#_weapon-descriptions), [starknife](equipment#_weapon-descriptions), [throwing axe](equipment#_weapon-descriptions, [throwing shield](../comba_dir/gladiatorWeapons#_table-gladiator-weapons), [trident](equipment#_weapon-descriptions, and [wushu dart](../comba_dir/easternArmorAndWeapons#_table-eastern-weapons-martial

...
_Granted Powers_: You gain [Exotic Weapon Proficiency](feats.md#_exotic-weapon-proficiency) (firearms) and [Gunsmithing](../ultimateCombatFeats.md#_gunsmithing) as bonus feats. When you hit an arcane spellcaster or a creature that uses spell-like abilities with a firearm attack, that creature must succeed at a Fortitude saving throw. If the spellcaster fails, he takes a –4 penalty on concentration checks for 1 round.
...
**Detect Magic (Sp)** : At 2nd level, an iconoclast gains the ability to _ [detect magic](spells/detectMagic.md#_detect-magic) _at will. This ability replaces _detect alignment_.

**Dispelling Attack (Sp)** : At 5th level, once per day as a standard action, an iconoclast can make a melee or ranged attack against an opponent, and if she hits, she can affect that opponent as if she had cast _ [dispel magic](spells/dispelMagic.md#_dispel-magic)_, using the targeted dispel option. If she misses, this ability is wasted. Use her inquisitor level as the caster level of the _ [dispel magic](spells/dispelMagic.md#_dispel-magic)_ effect. This ability replaces _ [discern lies](spells/discernLies.md#_discern-lies)_.

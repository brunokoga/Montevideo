...
**Clever Explorer (Ex)** : At 2nd level, an archaeologist gains a bonus equal to half his class level on [Disable Device](skills/disableDevice.md#_disable-device) and [Perception](skills/perception.md#_perception) checks. He can disable intricate and complex devices in half the normal amount of time (minimum 1 round) and open a lock as a standard action. At 6th level, an archaeologist can take 10 on [Disable Device](skills/disableDevice.md#_disable-device) checks, even if distracted or endangered, and can disarm magical traps. This ability replaces the versatile performance ability.
...
**Agile (Ex)** : A daredevil adds half her class level (minimum 1) on [Acrobatics](skills/acrobatics.md#_acrobatics), [Bluff](skills/bluff.md#_bluff), [Climb](skills/climb.md#_climb), and [Escape Artist](skills/escapeArtist.md#_escape-artist) checks. This ability replaces bardic knowledge.
...
**Versatile Dance (Ex)** : At 2nd level, a dervish dancer gains a bonus equal to half his level on [Perform](skills/perform.md#_perform) (dance) checks. He can use his bonus for his [Perform](skills/perform.md#_perform) (dance) skill in place of his bonus for [Acrobatics](skills/acrobatics.md#_acrobatics). This ability replaces versatile performance.

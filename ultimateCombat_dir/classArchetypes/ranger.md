---
title: ultimateComba_dir/classArchetypes/ranger
---
# Ranger
...
_2nd Round_: Allies within line of sight and that can hear the battle scout gain a +2 on [Perception](skill_dir/perception#_perception), [Stealth](skills/stealth#_stealth), and [Survival](skill_dir/survival#_survival) checks while within the advantageous terrain area.

  
  

_3rd Round_: The battle scout's movement is not hampered by difficult terrain while within the advantageous terrain area. Furthermore, the battle scout can take 10 on [Climb](skills/climb#_climb) and [Swim](skill_dir/swim#_swim) checks and checks to jump while within the area, even when in immediate danger or distracted. This ability replaces the ranger's second favored enemy.

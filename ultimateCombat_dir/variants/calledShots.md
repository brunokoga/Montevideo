---
title: ultimateComba_dir/variants/calledShots
---
# Called Shots
...
**Called Shot** : A called shot to the chest deals no additional damage, but any skill checks caused by the hit (such as an [Acrobatics](skill_dir/acrobatics#_acrobatics) check while balancing or a [Climb](skills/climb#_climb) check while climbing) take a –2 penalty.
...
**Called Shot** : A called shot to the ear deafens that ear for 1 round, and imposes a –2 penalty on [Perception](skills/perception#_perception) checks. A creature that loses hearing in all ears is deafened until hearing is returned by way of the _ [remove blindnes_dir/deafness](spells/removeBlindnessDeafness#_remove-blindness-deafness)_ spell or a similar effect.
...
**Debilitating Blow** : A debilitating blow to the ear destroys that ear and stuns the target for 1 round, then leaves it staggered for 1d4 rounds, and deafened until removed with the remove _ [blindnes_dir/deafness](spells/blindnessDeafness#_blindness-deafness) spell_ or a similar effect. A successful Fortitude saving throw deafens the creature until it is restored by the _ [remove blindnes_dir/deafness](spells/removeBlindnessDeafness#_remove-blindness-deafness)_ spell or a similar effect.

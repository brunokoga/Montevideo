---
title: advancedRaceGuid_dir/raceBuilder/racialTraits
---
# Racial Traits
...
**Cave Dweller (1 RP)** : _Prerequisites_: None; _Benefit_: Members of this race gain a +1 bonus on [Knowledge](skill_dir/knowledge#_knowledge) (dungeoneering) and [Survival](skills/survival#_survival) checks made underground.

**Craftsman (1 RP)** : _Prerequisites_: None; _Benefit_: Member of this race gain a +2 racial bonus on all [Craft](skill_dir/craft#_craft) or [Profession](skills/profession#_profession) checks to create objects from metal or stone.

**Curiosity (4 RP)** : _Prerequisites_: None; _Benefit_: Members of this race are naturally inquisitive about the world around them. They gain a +4 bonus on [Diplomacy](skill_dir/diplomacy#_diplomacy) checks to gather information, and [Knowledge](skills/knowledge#_knowledge) (history) and [Knowledge](skill_dir/knowledge#_knowledge) (local) become class skills for them. If they choose a class that has either of these [Knowledge](skills/knowledge#_knowledge) skills as class skills, they gain a +2 racial bonus on those skills instead.

**Emissary (1 RP)** : _Prerequisites_: None; _Benefit_: Once per day, members of this race can roll twice when making a [Bluff](skill_dir/bluff#_bluff) or [Diplomacy](skills/diplomacy#_diplomacy) check and take the better roll.
...
**Gift of Tongues (2 RP)** : _Prerequisite_: Standard or linguist language quality; _Benefit_: Members of this race gain a +1 racial bonus on [Bluff](skill_dir/bluff#_bluff) and [Diplomacy](skills/diplomacy#_diplomacy) checks, and they learn one additional language every time they put a rank in the [Linguistics](skill_dir/linguistics#_linguistics) skill.

**Gifted Linguist (2 RP)** : _Prerequisite_: Standard or linguist language quality; _Benefit_: Members of this race gain a +4 racial bonus on [Linguistics](skills/linguistics#_linguistics) checks, and they learn one additional language every time they put a rank in the [Linguistics](skill_dir/linguistics#_linguistics) skill.
...
**Integrated (1 RP)** : _Prerequisites_: None; _Benefit_: Members of this race gain a +1 bonus on [Bluff](skills/bluff#_bluff), [Disguise](skill_dir/disguise#_disguise), and [Knowledge](skills/knowledge#_knowledge) (local) checks.

**Master Tinker (2 RP)** : _Prerequisites_: None; _Benefit_: Members of this race gain a +1 bonus on [Disable Device](skill_dir/disableDevice#_disable-device) and [Knowledge](skills/knowledge#_knowledge) (engineering) checks. Members of this race are also treated as proficient with any weapon they have personally crafted.
...
**Scavenger (2 RP)** : _Prerequisites_: None; _Benefit_: Members of this race gain a +2 racial bonus on [Appraise](skill_dir/appraise#_appraise) and [Perception](skills/perception#_perception) checks to find hidden objects (including traps and secret doors), determine whether food is spoiled, or identify a potion by taste.
...
**Silent Hunter (2 RP)** _: Prerequisites_: None; _Benefit_: Members of this race reduce the penalty for using [Stealth](skill_dir/stealth#_stealth) while moving by 5 and can make [Stealth](skills/stealth#_stealth) checks while running at a –20 penalty (this number includes the penalty reduction from this trait).

**Silver Tongued (3 RP)** : _Prerequisites_: None; _Benefit_: Members of this race gain a +2 bonus on [Diplomacy](skill_dir/diplomacy#_diplomacy) and [Bluff](skills/bluff#_bluff) checks. In addition, when they use [Diplomacy](skill_dir/diplomacy#_diplomacy) to shift a creature's attitude, they can do so up to three steps up rather than just two.
...
**Sneaky Rider (6 RP)** : _Prerequisites_: None; _Benefit_: Members of this race gain a +4 racial bonus on [Ride](skill_dir/ride#_ride) and [Stealth](skills/stealth#_stealth) checks.
...
**Stalker (1 RP)** : _Prerequisites_: None; _Benefit_: [Perception](skills/perception#_perception) and [Stealth](skill_dir/stealth#_stealth) are always class skills for members of this race.
...
**Underground Sneak (5 RP)** : _Prerequisite_: Race is native to the Darklands; _Benefit_: Members of this race gain a +2 racial bonus on [Craft](skill_dir/craft#_craft) (alchemy), [Perception](skills/perception#_perception), and [Stealth](skill_dir/stealth#_stealth) checks. The bonus on [Stealth](skills/stealth#_stealth) checks increases to a +4 bonus while underground.

**Urbanite (1 RP)** : _Prerequisites_: None; _Benefit_: Members of this race gain a +2 racial bonus on [Diplomacy](skill_dir/diplomacy#_diplomacy) checks made to gather information and [Sense Motive](skills/senseMotive#_sense-motive) checks made to get a hunch about a social situation.
...
**Immortal Spark (7 RP)** : _Prerequisite_: Outsider (native) with ties to Elysium, Heaven, or Nirvana; _Benefit_: Members of this race gain a +2 bonus on [Knowledge](skills/knowledge#_knowledge) (history) checks and saving throws against death effects and can use _ [lesser age resistance](ultimateMagi_dir/spells/ageResistance#_age-resistance,-lesser)_ once per day as a spell-like ability.
...
**Stoneseer (2 RP)** : _Prerequisites_: None; _Benefit_: Members of this race add +1 to the caster level of any spells with the earth descriptor they cast. Members of this race also gain the following spell-like abilities: constant—_ [nondetection](spell_dir/nondetection#_nondetection)_; 1/day—_ [magic stone](spell_dir/magicStone#_magic-stone)_, _ [stone shape](spells/stoneShape#_stone-shape)_, _ [stone tell](spell_dir/stoneTell#_stone-tell)_. The caster level for these spell-like abilities is equal to the user's character level.
...
**Svirfneblin Magic (2 RP)** : _Prerequisite_: Gnome subtype; _Benefit_: Members of this race add +1 to the DC of any illusion spells they cast. They also gain the following spell-like abilities: constant—_ [nondetection](spells/nondetection#_nondetection)_; 1/day—_ [blindnes_dir/deafness](spells/blindnessDeafness#_blindness-deafness)_, _ [blur](spell_dir/blur#_blur)_, _ [disguise self](spells/disguiseSelf#_disguise-self)_. The DC for the spells is equal to 10 + the spell's level + the caster's Charisma modifier.
...
**Mountaineer (1 RP)** : _Prerequisites_: None; _Benefit_: Members of this race are immune to altitude sickness and do not lose their Dexterity bonus to AC when making [Climb](skills/climb#_climb) checks or [Acrobatics](skill_dir/acrobatics#_acrobatics) checks to cross narrow or slippery surfaces.
...
**Swift as Shadows (3 RP)** : _Prerequisite_: The race has at least a +2 racial bonus to Dexterity; _Benefit_: Members of this race reduce the penalty for using [Stealth](skills/stealth#_stealth) while moving at full speed by 5, and reduce the [Stealth](skill_dir/stealth#_stealth) check penalty for sniping by 10.

---
title: advancedRaceGuide/raceBuilde_dir/racialQualities
---
# Racial Qualities
...
- Constructs cannot heal damage on their own, but can often be repaired via exposure to a certain kind of effect (depending on the construct's racial abilities or through the use of the [Craft Construct](monster_dir/monsterFeats#_craft-construct feat. Constructs can also be healed through spells such as _ [make whole](spell_dir/makeWhole#_make-whole). _A construct with the fast healing special quality still benefits from that quality.
...
**Small (0 RP** : Small races gain a +1 size bonus to their AC, a +1 size bonus on attack rolls, a –1 penalty on combat maneuver checks and to their CMD, and a +4 size bonus on [Stealth](skill_dir/stealth#_stealth) checks. Small races have a space of 5 feet by 5 feet and a reach of 5 feet.

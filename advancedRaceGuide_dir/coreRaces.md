---
layout: default
title: advancedRaceGuide_dir/coreRaces
---
# Core Races
...
Some of these alternate class rewards only add +1_dir/2, +1_dir/3, +1_dir/4, or +1_dir/6 on a roll (rather than +1) each time the reward is selected. When applying this type of result to a die roll, always round down (minimum 0). For example, a half-orc with gunslinger as her favored class adds a +1_dir/4 bonus on attack rolls and a +1_dir/2 bonus on damage rolls when using the pistol whip deed each time she selects that favored class bonus, though this means the net effect is +0 on each after selecting it once (because both +1_dir/4 and +1_dir/2 rounds down to 0). After 20 levels, this benefit gives the half-orc a +5 bonus on attack rolls and a +10 bonus on damage rolls when using the pistol whip deed (in addition to the base value from being a 20th-level gunslinger).
...
**Dwarves** : [Exarch (inquisitor)](../advancedRaceGuide_dir/coreRaces_dir/dwarves#_exarch-(inquisitor)), [forgemaster (cleric)](../advancedRaceGuide_dir/coreRaces_dir/dwarves#_forgemaster-(cleric)), [stonelord (paladin)](../advancedRaceGuide_dir/coreRaces_dir/dwarves#_stonelord-(paladin)).

**Elves** : [Ancient lorekeeper (oracle)](../advancedRaceGuide_dir/coreRaces_dir/elves#_ancient-lorekeeper-(oracle)), [spell dancer (magus)](../advancedRaceGuide_dir/coreRaces_dir/elves#_spell-dancer-(magus)), [spellbinder (wizard)](../advancedRaceGuide_dir/coreRaces_dir/elves#_spellbinder-(wizard)), [treesinger (druid)](../advancedRaceGuide_dir/coreRaces_dir/elves#_treesinger-(druid)).

**Gnomes** : [Experimental gunsmith (gunslinger)](../advancedRaceGuide_dir/coreRaces_dir/gnomes#_experimental-gunsmith-(gunslinger)), [prankster (bard)](../advancedRaceGuide_dir/coreRaces_dir/gnomes#_prankster-(bard)), [saboteur (alchemist)](../advancedRaceGuide_dir/coreRaces_dir/gnomes#_saboteur-(alchemist)).

**Half-Elves** : [Bramble brewer (alchemist)](../advancedRaceGuide_dir/coreRaces_dir/halfElves#_bramble-brewer-(alchemist)), [bonded witch (witch)](../advancedRaceGuide_dir/coreRaces_dir/halfElves#_bonded-witch-(witch)), [wild caller (summoner)](../advancedRaceGuide_dir/coreRaces_dir/halfElves#_wild-caller-(summoner)), [wild shadow (ranger)](../advancedRaceGuide_dir/coreRaces_dir/halfElves#_wild-shadow-(ranger)).

**Half-Orcs** : [Blood god disciple (summoner)](../advancedRaceGuide_dir/coreRaces_dir/halfOrcs#_blood-god-disciple-(summoner)), [hateful rager (barbarian)](../advancedRaceGuide_dir/coreRaces_dir/halfOrcs#_hateful-rager-(barbarian)), [redeemer (paladin)](../advancedRaceGuide_dir/coreRaces_dir/halfOrcs#_redeemer-(paladin)), [skulking slayer (rogue)](../advancedRaceGuide_dir/coreRaces_dir/halfOrcs#_skulking-slayer-(rogue)).

**Halflings** : [Community guardian (oracle)](../advancedRaceGuide_dir/coreRaces_dir/halflings#_community-guardian-(oracle), [filcher (rogue)](../advancedRaceGuide_dir/coreRaces_dir/halflings#_filcher-(rogue)), [order of the paw (cavalier)](../advancedRaceGuide_dir/coreRaces_dir/halflings#_order-of-the-paw-(cavalier)), [underfoot adept (monk)](../advancedRaceGuide_dir/coreRaces_dir/halflings#_underfoot-adept-(monk)).

**Humans** : [Buccaneer (gunslinger)](../advancedRaceGuide_dir/coreRaces_dir/humans#_buccaneer-(gunslinger)), [feral child (druid)](../advancedRaceGuide_dir/coreRaces_dir/humans#_feral-child-(druid)), [imperious bloodline (sorcerer)](../advancedRaceGuide_dir/coreRaces_dir/humans#_imperious-bloodline-(sorcerer)), [wanderer (monk)](../advancedRaceGuide_dir/coreRaces_dir/humans#_wanderer-(monk)).

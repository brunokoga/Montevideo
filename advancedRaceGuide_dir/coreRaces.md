...
**Alternate Racial Traits** : This section lists alternate racial traits for each of the seven core races. Many of them play on racial themes not reflected in the standard racial traits, like the elven alternate racial trait fleet-footed, which grants the [Run](feats.md#_run) feat and a bonus on initiative checks instead of the normal keen senses and weapon familiarity traits, reflecting the grace and uncanny reflexes of that race. To take one of these alternate racial traits, you must exchange one or more of the existing standard racial traits available to the race. You can exchange one or several of the standard racial traits, but you cannot exchange the same racial trait more than once. For example, an elf who takes the fleet-footed racial trait cannot take the urbanite racial trait, because the latter trait also replaces keen senses.
...
**Dwarves** : [Exarch (inquisitor)](advancedRaceGuide/coreRaces_dir/dwarves.md#_exarch-(inquisitor)), [forgemaster (cleric)](advancedRaceGuide/coreRaces_dir/dwarves.md#_forgemaster-(cleric)), [stonelord (paladin)](advancedRaceGuide/coreRaces_dir/dwarves.md#_stonelord-(paladin)).

**Elves** : [Ancient lorekeeper (oracle)](advancedRaceGuide/coreRaces_dir/elves.md#_ancient-lorekeeper-(oracle)), [spell dancer (magus)](advancedRaceGuide/coreRaces_dir/elves.md#_spell-dancer-(magus)), [spellbinder (wizard)](advancedRaceGuide/coreRaces_dir/elves.md#_spellbinder-(wizard)), [treesinger (druid)](advancedRaceGuide/coreRaces_dir/elves.md#_treesinger-(druid)).

**Gnomes** : [Experimental gunsmith (gunslinger)](advancedRaceGuide/coreRaces_dir/gnomes.md#_experimental-gunsmith-(gunslinger)), [prankster (bard)](advancedRaceGuide/coreRaces_dir/gnomes.md#_prankster-(bard)), [saboteur (alchemist)](advancedRaceGuide/coreRaces_dir/gnomes.md#_saboteur-(alchemist)).

**Half-Elves** : [Bramble brewer (alchemist)](advancedRaceGuide/coreRaces_dir/halfElves.md#_bramble-brewer-(alchemist)), [bonded witch (witch)](advancedRaceGuide/coreRaces_dir/halfElves.md#_bonded-witch-(witch)), [wild caller (summoner)](advancedRaceGuide/coreRaces_dir/halfElves.md#_wild-caller-(summoner)), [wild shadow (ranger)](advancedRaceGuide/coreRaces_dir/halfElves.md#_wild-shadow-(ranger)).

**Half-Orcs** : [Blood god disciple (summoner)](advancedRaceGuide/coreRaces_dir/halfOrcs.md#_blood-god-disciple-(summoner)), [hateful rager (barbarian)](advancedRaceGuide/coreRaces_dir/halfOrcs.md#_hateful-rager-(barbarian)), [redeemer (paladin)](advancedRaceGuide/coreRaces_dir/halfOrcs.md#_redeemer-(paladin)), [skulking slayer (rogue)](advancedRaceGuide/coreRaces_dir/halfOrcs.md#_skulking-slayer-(rogue)).

**Halflings** : [Community guardian (oracle)](advancedRaceGuide/coreRaces_dir/halflings.md#_community-guardian-(oracle), [filcher (rogue)](advancedRaceGuide/coreRaces_dir/halflings.md#_filcher-(rogue)), [order of the paw (cavalier)](advancedRaceGuide/coreRaces_dir/halflings.md#_order-of-the-paw-(cavalier)), [underfoot adept (monk)](advancedRaceGuide/coreRaces_dir/halflings.md#_underfoot-adept-(monk)).

**Humans** : [Buccaneer (gunslinger)](advancedRaceGuide/coreRaces_dir/humans.md#_buccaneer-(gunslinger)), [feral child (druid)](advancedRaceGuide/coreRaces_dir/humans.md#_feral-child-(druid)), [imperious bloodline (sorcerer)](advancedRaceGuide/coreRaces_dir/humans.md#_imperious-bloodline-(sorcerer)), [wanderer (monk)](advancedRaceGuide/coreRaces_dir/humans.md#_wanderer-(monk)).

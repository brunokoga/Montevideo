...
**Dwarves** : [Exarch (inquisitor)](advancedRaceGuide/coreRaces_dir/dwarves#_exarch-(inquisitor)), [forgemaster (cleric)](advancedRaceGuide/coreRaces_dir/dwarves#_forgemaster-(cleric)), [stonelord (paladin)](advancedRaceGuide/coreRaces_dir/dwarves#_stonelord-(paladin)).

**Elves** : [Ancient lorekeeper (oracle)](advancedRaceGuide/coreRaces_dir/elves#_ancient-lorekeeper-(oracle)), [spell dancer (magus)](advancedRaceGuide/coreRaces_dir/elves#_spell-dancer-(magus)), [spellbinder (wizard)](advancedRaceGuide/coreRaces_dir/elves#_spellbinder-(wizard)), [treesinger (druid)](advancedRaceGuide/coreRaces_dir/elves#_treesinger-(druid)).

**Gnomes** : [Experimental gunsmith (gunslinger)](advancedRaceGuide/coreRaces_dir/gnomes#_experimental-gunsmith-(gunslinger)), [prankster (bard)](advancedRaceGuide/coreRaces_dir/gnomes#_prankster-(bard)), [saboteur (alchemist)](advancedRaceGuide/coreRaces_dir/gnomes#_saboteur-(alchemist)).

**Half-Elves** : [Bramble brewer (alchemist)](advancedRaceGuide/coreRaces_dir/halfElves#_bramble-brewer-(alchemist)), [bonded witch (witch)](advancedRaceGuide/coreRaces_dir/halfElves#_bonded-witch-(witch)), [wild caller (summoner)](advancedRaceGuide/coreRaces_dir/halfElves#_wild-caller-(summoner)), [wild shadow (ranger)](advancedRaceGuide/coreRaces_dir/halfElves#_wild-shadow-(ranger)).

**Half-Orcs** : [Blood god disciple (summoner)](advancedRaceGuide/coreRaces_dir/halfOrcs#_blood-god-disciple-(summoner)), [hateful rager (barbarian)](advancedRaceGuide/coreRaces_dir/halfOrcs#_hateful-rager-(barbarian)), [redeemer (paladin)](advancedRaceGuide/coreRaces_dir/halfOrcs#_redeemer-(paladin)), [skulking slayer (rogue)](advancedRaceGuide/coreRaces_dir/halfOrcs#_skulking-slayer-(rogue)).

**Halflings** : [Community guardian (oracle)](advancedRaceGuide/coreRaces_dir/halflings#_community-guardian-(oracle), [filcher (rogue)](advancedRaceGuide/coreRaces_dir/halflings#_filcher-(rogue)), [order of the paw (cavalier)](advancedRaceGuide/coreRaces_dir/halflings#_order-of-the-paw-(cavalier)), [underfoot adept (monk)](advancedRaceGuide/coreRaces_dir/halflings#_underfoot-adept-(monk)).

**Humans** : [Buccaneer (gunslinger)](advancedRaceGuide/coreRaces_dir/humans#_buccaneer-(gunslinger)), [feral child (druid)](advancedRaceGuide/coreRaces_dir/humans#_feral-child-(druid)), [imperious bloodline (sorcerer)](advancedRaceGuide/coreRaces_dir/humans#_imperious-bloodline-(sorcerer)), [wanderer (monk)](advancedRaceGuide/coreRaces_dir/humans#_wanderer-(monk)).

...
**Dwarves** : [Exarch (inquisitor)](advancedRaceGuide/coreRace_dir/dwarves#_exarch-(inquisitor)), [forgemaster (cleric](advancedRaceGuide/coreRace_dir/dwarves#_forgemaster-(cleric)), [stonelord (paladin](advancedRaceGuide/coreRace_dir/dwarves#_stonelord-(paladin)).

**Elves** : [Ancient lorekeeper (oracle](advancedRaceGuide/coreRace_dir/elves#_ancient-lorekeeper-(oracle)), [spell dancer (magus](advancedRaceGuide/coreRace_dir/elves#_spell-dancer-(magus)), [spellbinder (wizard](advancedRaceGuide/coreRace_dir/elves#_spellbinder-(wizard)), [treesinger (druid](advancedRaceGuide/coreRace_dir/elves#_treesinger-(druid)).

**Gnomes** : [Experimental gunsmith (gunslinger](advancedRaceGuide/coreRace_dir/gnomes#_experimental-gunsmith-(gunslinger)), [prankster (bard](advancedRaceGuide/coreRace_dir/gnomes#_prankster-(bard)), [saboteur (alchemist](advancedRaceGuide/coreRace_dir/gnomes#_saboteur-(alchemist)).

**Half-Elves** : [Bramble brewer (alchemist](advancedRaceGuide/coreRace_dir/halfElves#_bramble-brewer-(alchemist)), [bonded witch (witch](advancedRaceGuide/coreRace_dir/halfElves#_bonded-witch-(witch)), [wild caller (summoner](advancedRaceGuide/coreRace_dir/halfElves#_wild-caller-(summoner)), [wild shadow (ranger](advancedRaceGuide/coreRace_dir/halfElves#_wild-shadow-(ranger)).

**Half-Orcs** : [Blood god disciple (summoner](advancedRaceGuide/coreRace_dir/halfOrcs#_blood-god-disciple-(summoner)), [hateful rager (barbarian](advancedRaceGuide/coreRace_dir/halfOrcs#_hateful-rager-(barbarian)), [redeemer (paladin](advancedRaceGuide/coreRace_dir/halfOrcs#_redeemer-(paladin)), [skulking slayer (rogue](advancedRaceGuide/coreRace_dir/halfOrcs#_skulking-slayer-(rogue)).

**Halflings** : [Community guardian (oracle](advancedRaceGuide/coreRace_dir/halflings#_community-guardian-(oracle), [filcher (rogue](advancedRaceGuide/coreRace_dir/halflings#_filcher-(rogue)), [order of the paw (cavalier](advancedRaceGuide/coreRace_dir/halflings#_order-of-the-paw-(cavalier)), [underfoot adept (monk](advancedRaceGuide/coreRace_dir/halflings#_underfoot-adept-(monk)).

**Humans** : [Buccaneer (gunslinger](advancedRaceGuide/coreRace_dir/humans#_buccaneer-(gunslinger)), [feral child (druid](advancedRaceGuide/coreRace_dir/humans#_feral-child-(druid)), [imperious bloodline (sorcerer](advancedRaceGuide/coreRace_dir/humans#_imperious-bloodline-(sorcerer)), [wanderer (monk](advancedRaceGuide/coreRace_dir/humans#_wanderer-(monk).

---
title: advancedRaceGuid_dir/uncommonRaces/changelings
---
# Changelings
...
> 
> _Green Widow (Green Hag)_: The changeling gains a +2 racial bonus on [Bluff](skill_dir/bluff#_bluff) checks against creatures that are sexually attracted to her.
> 
...
**Object of Desire** : The changeling adds +1 to her caster level when casting _ [charm person](spells/charmPerson#_charm-person)_ and _ [charm monster](spell_dir/charmMonster#_charm-monster)_. This replaces green widow.

**Ocean's Daughter** : The changeling gains a +1 trait bonus on [Swim](skills/swim#_swim) checks. She automatically succeeds at [Swim](skill_dir/swim#_swim) checks made to avoid nonlethal damage from swimming. This racial trait replaces sea lungs.
...
**Spells** : A dreamweaver replaces some of her patron's spells with the following: 2nd—_sow thoughts_ (see below), 4th—_ [dust of twilight](advanced/spell_dir/dustOfTwilight#_dust-of-twilight)_ , 6th—_ [deep slumber](spells/deepSlumber#_deep-slumber)_, 8th—_ [modify memory](spell_dir/modifyMemory#_modify-memory)_, 10th—_ [dream](spells/dream#_dream)_, 12th—_ [cloak of dreams](advance_dir/spells/cloakOfDreams#_cloak-of-dreams)_ , 14th—_ [ethereal jaunt](spell_dir/etherealJaunt#_ethereal-jaunt)_, 16th—_ [moment of prescience](spells/momentOfPrescience#_moment-of-prescience)_, 18th—_ [astral projection](spell_dir/astralProjection#_astral-projection)_.
...
**School** enchantment (compulsion) [mind-affecting]; **Level** bard 1, sorcere_dir/wizard 1, witch 1

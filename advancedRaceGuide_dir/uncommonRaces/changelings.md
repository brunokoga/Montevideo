---
title: advancedRaceGuide/uncommonRace_dir/changelings
---
# Changelings
...
> 
> _Green Widow (Green Hag_: The changeling gains a +2 racial bonus on [Bluff](skill_dir/bluff#_bluff) checks against creatures that are sexually attracted to her.
> 
...
**Object of Desire** : The changeling adds +1 to her caster level when casting _ [charm person](spell_dir/charmPerson#_charm-person_ and _ [charm monster](spell_dir/charmMonster#_charm-monster_. This replaces green widow.

**Ocean's Daughter** : The changeling gains a +1 trait bonus on [Swim](skill_dir/swim#_swim checks. She automatically succeeds at [Swim](skill_dir/swim#_swim checks made to avoid nonlethal damage from swimming. This racial trait replaces sea lungs.
...
**Class Skills** : The dreamweaver adds [Sense Motive](skill_dir/senseMotive#_sense-motive) to her list of class skills and removes Healing from her list of class skills.

**Patron** : A dreamweaver's patron is normally portents or stars .

**Spells** : A dreamweaver replaces some of her patron's spells with the following: 2nd—_sow thoughts_ (see below, 4th—_ [dust of twilight](advanced/spell_dir/dustOfTwilight#_dust-of-twilight_ , 6th—_ [deep slumber](spell_dir/deepSlumber#_deep-slumber_, 8th—_ [modify memory](spell_dir/modifyMemory#_modify-memory_, 10th—_ [dream](spell_dir/dream#_dream_, 12th—_ [cloak of dreams](advanced/spell_dir/cloakOfDreams#_cloak-of-dreams_ , 14th—_ [ethereal jaunt](spell_dir/etherealJaunt#_ethereal-jaunt_, 16th—_ [moment of prescience](spell_dir/momentOfPrescience#_moment-of-prescience_, 18th—_ [astral projection](spell_dir/astralProjection#_astral-projection)_.

**Dream Spinner (Su** : At 2nd level, when a dreamweaver casts a mind-affecting spell on a target that is sleeping because of her slumber hex or a spell she cast, she adds +1 to the mind-affecting spell's DC. If the target succeeds at the saving throw against the spell, it does not wake up, nor does it have any recollection of having resisted a spell. If appropriate, the dreamweaver may incorporate elements of a mind-affecting spell (i.e., _sow thought_, _ [suggestion](spell_dir/suggestion#_suggestion)_, and so on) into the target's subconscious so it believes the spell's effects originated in its dreams (the details of how these elements fit into the dream is up to the GM). This ability replaces the witch's hex gained at 2nd level.

**Dream Thief (Su** : At 6th level, a dreamweaver can alter the sleeping mind of any creature that is sleeping because of her slumber hex or a spell she cast. She can reshape one of the target's memories as if using _ [modify memory](spell_dir/modifyMemory#_modify-memory_. Alternatively, she may insert herself into the dreaming memories of the target, prompting the target's mind to show her some specific information; the dreamer's subconscious may resist, or try to deceive her with out-of-context memories, similar to the way a corpse can resist when questioned with _ [speak with dead](spell_dir/speakWithDead#_speak-with-dead)_. A Will save negates either effect (DC equal to that of the witch's hex). Whether or not the save is successful, a creature cannot be the target of this hex again for 1 day. This ability replaces the witch's hex gained at 6th level.

**Dream Possession (Su** : At 10th level, a dreamweaver can take control of any creature that is sleeping because of her slumber hex or a spell she cast. This effect functions as _ [magic jar](spell_dir/magicJar#_magic-jar)_, using the witch's familiar acting as the soul receptacle. A Will save negates either effect (DC equal to that of the witch's hex). Whether or not the save is successful, a creature cannot be the target of this hex again for 1 day. This ability replaces the witch's hex gained at 10th level.
...
_Surprisingly Tough (Ex_: Your natural armor bonus increases by +1.

_Uncanny [Resistance](spell_dir/resistance#_resistance) (Su)_: You gain spell resistance equal to 6 + your character level.

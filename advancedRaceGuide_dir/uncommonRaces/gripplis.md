...
**Camouflage** : Gripplis receive a +4 racial bonus on [Stealth](skill_dir/stealth#_stealth) checks in marshes and forested areas.
...
**Princely** : The grippli gains proficiency with rapiers and a +2 racial bonus on [Diplomacy](skill_dir/diplomacy#_diplomacy and [Intimidate](skill_dir/intimidate#_intimidate) checks. This racial trait replaces swamp stride and weapon familiarity.
...
**Ranger** : Add a +1 racial bonus on [Swim](skill_dir/swim#_swim skill checks. When this bonus reaches +8, the ranger gains a swim speed of 15 feet (this does not grant the ranger another +8 racial bonus on [Swim](skill_dir/swim#_swim) checks).
...
**Class Skills** : A bogborn alchemist adds [Swim](skill_dir/swim#_swim) to his list of class skills.
...
**Chameleon (Su** : An alchemist with this discovery can shift the colors of his skin and equipment to blend in with the surrounding terrain. He gains a +4 enhancement bonus on [Stealth](skill_dir/stealth#_stealth checks. At 10th level, the bonus on [Stealth](skill_dir/stealth#_stealth) checks increases to +8.
...
**Requirements** [Craft Wondrous Item](feats#_craft-wondrous-item, _ [shrink item](spell_dir/shrinkItem#_shrink-item_, _ [unseen servant](spell_dir/unseenServant#_unseen-servant_; **Cost** 750 gp

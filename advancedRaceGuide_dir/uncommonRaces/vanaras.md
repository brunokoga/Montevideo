...
**Normal Speed** : Vanaras have a base speed of 30 feet and a [Climb](skills/climb.md#_climb) speed of 30 feet.

**Low-Light Vision** : A vanara can see twice as far as a human in dim light.

**Nimble** : Vanaras have a +2 racial bonus on [Acrobatics](skills/acrobatics.md#_acrobatics) and [Stealth](skills/stealth.md#_stealth) checks.
...
**Tree Stranger** : Some vanaras have spent their lives among humans in centers of learning instead of traditional treetop homes. These vanaras treat all [Knowledge](skills/knowledge.md#_knowledge) skills as class skills, but lose their climb speed racial trait.
...
**Druid** : Add a +1/2 bonus on wild empathy checks and a +1/2 bonus on [Handle Animal](skills/handleAnimal.md#_handle-animal) skill checks.

**Fighter** : Add +1 to the fighter's CMD when resisting a reposition or trip attempt.

**Monk** : Add a +1 bonus on [Acrobatics](skills/acrobatics.md#_acrobatics) checks made to jump.
...
**Wood Affinity (Su)** : At 5th level, a treetop monk may expend 1 point from his _ki_ pool as a free action to treat a wooden object as if it were not broken for 1 minute (this includes a weapon with a wooden haft such as an axe or spear). At 8th level, as a free action, a treetop monk can expend 1 point from his _ki _pool to use the [Lunge](feats.md#_lunge) feat with any wooden or wood-hafted melee weapon. This ability replaces purity of body.

**_ [Freedom](spells/freedom.md#_freedom) of Movement_ (Su)** : At 12th level, a treetop may expend 1 point from his _ki_ pool as a swift action to gain the effects of _ [freedom of movement](spells/freedomOfMovement.md#_freedom-of-movement)_ for 1 round. This ability replaces abundant step.
...
**Prerequisites** : [Acrobatics](skills/acrobatics.md#_acrobatics) 1 rank, vanara.

**Benefit** : You gain a +2 bonus to your CMD against all trip attacks. If your square has a branch or other sturdy large object that you could hang from, as a swift action you may make a DC 15 [Acrobatics](skills/acrobatics.md#_acrobatics) check to jump upward and use your tail to hang from that object. While hanging, you can't be tripped, you ignore the effects of difficult terrain in your square, and you gain a +2 bonus to your CMD against bull rush, drag, and reposition attacks. If you leave that square (including if you are moved against your will), you lose your grip on the object and are no longer hanging. While hanging, you cannot use your tail for anything else.
...
**Requirements** [Craft Wondrous Item](feats.md#_craft-wondrous-item), _ [polymorph](spells/polymorph.md#_polymorph)_; **Cost** 500 gp

...
**Normal Speed** : Vanaras have a base speed of 30 feet and a [Climb](skills/climb#_climb) speed of 30 feet.
...
**Druid** : Add a +1/2 bonus on wild empathy checks and a +1/2 bonus on [Handle Animal](skills/handleAnimal#_handle-animal) skill checks.
...
**_ [Freedom](spells/freedom#_freedom) of Movement_ (Su)** : At 12th level, a treetop may expend 1 point from his _ki_ pool as a swift action to gain the effects of _ [freedom of movement](spells/freedomOfMovement#_freedom-of-movement)_ for 1 round. This ability replaces abundant step.

...
**Svirfneblin Magic** : Svirfneblin add +1 to the DC of any illusion spells they cast. Svirfneblin also gain the following spell-like abilities: Constant—_ [nondetection](spell_dir/nondetection#_nondetection_; 1/day—_ [blindness/deafness](spell_dir/blindnessDeafness#_blindness-deafness_, _ [blur](spell_dir/blur#_blur_, _ [disguise self](spell_dir/disguiseSelf#_disguise-self_; caster level equals the svirfneblin's class levels.
...
**Stonekin** : At 6th level, the deep bomber automatically learns _ [tree shape](spell_dir/treeShape#_tree-shape_ as a 2nd-level extract, except instead of a tree, he takes the form of a stalagmite that is the same size as his current size. At 7th level, he automatically learns _ [meld into stone](spell_dir/meldIntoStone#_meld-into-stone_ as a 3rd-level extract. This ability replaces swift poisoning.
...
_ [Darkness](spell_dir/darkness#_darkness Bomb\*_: When the alchemist creates a bomb, he can choose to have it suppress light sources on the target. This extinguishes nonmagical light sources carried by the target and dispels magical light sources for 1 round/level as _ [deeper darkness](spell_dir/deeperDarkness#_deeper-darkness)_.
...
**School** transmutation [[earth](monster_dir/creatureTypes#_earth-subtype]; **Level** alchemist 4, druid 4, sorcerer/wizard 4

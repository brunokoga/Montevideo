---
layout: default
title: advancedRaceGuid_dir/uncommonRaces/nagaji
---
# Nagaji
...
**Serpent's Sense (Ex)** : Nagaji receive a +2 racial bonus on [Handle Animal](skill_dir/handleAnimal#_handle-animal) checks against reptiles, and a +2 racial bonus on [Perception](skills/perception#_perception) checks.
...
**Alchemist** : Add +1 on [Craft](skills/craft#_craft) (alchemy) checks to craft poison and +1/3 on the DCs of poisons the alchemist creates.
...
0—_ [acid splash](spell_dir/acidSplash#_acid-splash)_, _ [bleed](spells/bleed#_bleed)_, _ [daze](spell_dir/daze#_daze)_, _ [mage hand](spells/mageHand#_mage-hand)_, _ [ope_dir/close](spells/openClose#_open-close)_, _ [ray of frost](spell_dir/rayOfFrost#_ray-of-frost)_; 1st—_ [charm person](spells/charmPerson#_charm-person)_, _ [divine favor](spell_dir/divineFavor#_divine-favor)_, _ [expeditious retreat](spells/expeditiousRetreat#_expeditious-retreat)_, _ [mage armor](spell_dir/mageArmor#_mage-armor)_, _ [magic missile](spells/magicMissile#_magic-missile), [ray of enfeeblement](spell_dir/rayOfEnfeeblement#_ray-of-enfeeblement), [shield](spells/shield#_shield), [shield of faith](spell_dir/shieldOfFaith#_shield-of-faith), [silent image](spells/silentImage#_silent-image), [true strike](spell_dir/trueStrike#_true-strike)_; 2nd—_ [acid arrow](spells/acidArrow#_acid-arrow)_, _ [detect thoughts](spell_dir/detectThoughts#_detect-thoughts)_, _ [invisibility](spells/invisibility#_invisibility)_, _ [mirror image](spell_dir/mirrorImage#_mirror-image)_, _ [scorching ray](spells/scorchingRay#_scorching-ray)_, _ [see invisibility](spell_dir/seeInvisibility#_see-invisibility)_; 3rd—_ [dispel magic](spells/dispelMagic#_dispel-magic), [displacement](spell_dir/displacement#_displacement), [fireball](spells/fireball#_fireball), [lightning bolt](spell_dir/lightningBolt#_lightning-bolt), [suggestion](spells/suggestion#_suggestion)_; 4th—_ [divine power](spell_dir/divinePower#_divine-power)_, _ [greater invisibility](spells/invisibility#_invisibility-greater)_.
...
> _Charming Gaze (Sp)_: The druid gains a gaze attack that affects creatures within 30 feet as a _ [charm person](spell_dir/charmPerson#_charm-person)_ spell.
> 
> _ [Darkvision](spells/darkvision#_darkvision) (Su)_: The druid gains darkvision with a range of 60 feet.
> 
> _Detect Thoughts (Su)_: The druid can use _ [detect thoughts](spell_dir/detectThoughts#_detect-thoughts)_ at will.
> 
> _Guarded Thoughts (Ex)_: The druid gains a +2 racial bonus on saves against charm effects and immunity to any form of mind reading (such as _ [detect thoughts](spells/detectThoughts#_detect-thoughts)_).
> 
...
**Requirements** [Craft Wondrous Item](feats#_craft-wondrous-item), _ [imbue with spell ability](spells/imbueWithSpellAbility#_imbue-with-spell-ability)_ or _ [mnemonic enhancer](spell_dir/mnemonicEnhancer#_mnemonic-enhancer)_; **Cost** 700 gp

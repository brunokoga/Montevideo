...
**Changelings** : [Dreamweaver (witch)](advancedRaceGuide/uncommonRaces_dir/changelings.md#_dreamweaver-(witch))

**Duergar** : [Gray disciple (monk)](advancedRaceGuide/uncommonRaces_dir/duergar.md#_gray-disciple-(monk))

**Gillmen** : [Eldritch raider (rogue)](advancedRaceGuide/uncommonRaces_dir/gillmen.md#_eldritch-raider-(rogue))

**Gripplis** : [Bogborn alchemist (alchemist)](advancedRaceGuide/uncommonRaces_dir/gripplis.md#_bogborn-alchemist-(alchemist))

**Kitsune** : [Kitsune trickster (rogue)](advancedRaceGuide/uncommonRaces_dir/kitsune.md#_kitsune-trickster-(rogue))

**Merfolk** : [Wave warden (ranger)](advancedRaceGuide/uncommonRaces_dir/merfolk.md#_wave-warden-(ranger))

**Nagaji** : [Naga aspirant (druid)](advancedRaceGuide/uncommonRaces_dir/nagaji.md#_naga-aspirant-(druid))

**Samsarans** : [Reincarnated oracle (oracle)](advancedRaceGuide/uncommonRaces_dir/samsarans.md#_reincarnated-oracle-(oracle))

**Strix** : [Airborne ambusher (fighter)](advancedRaceGuide/uncommonRaces_dir/strix.md#_airborne-ambusher-(fighter))

**Sulis** : [Elemental knight (magus)](advancedRaceGuide/uncommonRaces_dir/sulis.md#_elemental-knight-(magus))

**Svirfneblin** : [Deep bomber (alchemist)](advancedRaceGuide/uncommonRaces_dir/svirfneblin.md#_deep-bomber-(alchemist))

**Vanaras** : [Treetop monk (monk)](advancedRaceGuide/uncommonRaces_dir/vanaras.md#_treetop-monk-(monk))

**Vishkanyas** : [Deadly courtesan (rogue)](advancedRaceGuide/uncommonRaces_dir/vishkanyas.md#_deadly-courtesan-(rogue))

**Wayangs** : [Shadow puppeteer (bard)](advancedRaceGuide/uncommonRaces_dir/wayangs.md#_shadow-puppeteer-(bard))

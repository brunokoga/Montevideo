---
layout: default
title: advancedRaceGuide_dir/uncommonRaces
---
# Uncommon Races
...
**Changelings** : [Dreamweaver (witch)](../advancedRaceGuide_dir/uncommonRaces_dir/changelings#_dreamweaver-(witch))

**Duergar** : [Gray disciple (monk)](../advancedRaceGuide_dir/uncommonRaces_dir/duergar#_gray-disciple-(monk))

**Gillmen** : [Eldritch raider (rogue)](../advancedRaceGuide_dir/uncommonRaces_dir/gillmen#_eldritch-raider-(rogue))

**Gripplis** : [Bogborn alchemist (alchemist)](../advancedRaceGuide_dir/uncommonRaces_dir/gripplis#_bogborn-alchemist-(alchemist))

**Kitsune** : [Kitsune trickster (rogue)](../advancedRaceGuide_dir/uncommonRaces_dir/kitsune#_kitsune-trickster-(rogue))

**Merfolk** : [Wave warden (ranger)](../advancedRaceGuide_dir/uncommonRaces_dir/merfolk#_wave-warden-(ranger))

**Nagaji** : [Naga aspirant (druid)](../advancedRaceGuide_dir/uncommonRaces_dir/nagaji#_naga-aspirant-(druid))

**Samsarans** : [Reincarnated oracle (oracle)](../advancedRaceGuide_dir/uncommonRaces_dir/samsarans#_reincarnated-oracle-(oracle))

**Strix** : [Airborne ambusher (fighter)](../advancedRaceGuide_dir/uncommonRaces_dir/strix#_airborne-ambusher-(fighter))

**Sulis** : [Elemental knight (magus)](../advancedRaceGuide_dir/uncommonRaces_dir/sulis#_elemental-knight-(magus))

**Svirfneblin** : [Deep bomber (alchemist)](../advancedRaceGuide_dir/uncommonRaces_dir/svirfneblin#_deep-bomber-(alchemist))

**Vanaras** : [Treetop monk (monk)](../advancedRaceGuide_dir/uncommonRaces_dir/vanaras#_treetop-monk-(monk))

**Vishkanyas** : [Deadly courtesan (rogue)](../advancedRaceGuide_dir/uncommonRaces_dir/vishkanyas#_deadly-courtesan-(rogue))

**Wayangs** : [Shadow puppeteer (bard)](../advancedRaceGuide_dir/uncommonRaces_dir/wayangs#_shadow-puppeteer-(bard))

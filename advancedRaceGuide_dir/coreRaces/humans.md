...
This rod functions as a _+2 [light](spell_dir/light#_light) mace_. It takes the form of a light mace with a head in the shape of a clenched fist. While a creature wields this rod, it grants all its allies within a 20-foot-radius burst a +2 morale bonus on saving throws against fear and emotion effects, or a +4 morale bonus on such saves if the ally has the human subtype.
...
**School** necromancy [[curse](monster_dir/universalMonsterRules#_curse)]; **Level** druid 5, witch 5

...
**Skilled** : Fetchlings have a +2 racial bonus on [Knowledge](skill_dir/knowledge#_knowledge) (planes and [Stealth](skill_dir/stealth#_stealth) checks.

**Shadow Blending (Su)** : Attacks against a fetchling in dim light have a 50% miss chance instead of the normal 20% miss chance. This ability does not grant total concealment; it just increases the miss chance.

**Shadowy Resistance** : Fetchlings have cold resistance 5 and electricity resistance 5.

**Spell-Like Abilities (Sp** : A fetchling can use _ [disguise self](spell_dir/disguiseSelf#_disguise-self_ once per day as a spell-like ability. He can assume the form of any humanoid creature using this spell-like ability. When a fetchling reaches 9th level in any combination of classes, he gains _ [shadow walk](spell_dir/shadowWalk#_shadow-walk)_ (self only as a spell-like ability usable once per day, and at 13th level, he gains _ [plane shift](spell_dir/planeShift#_plane-shift)_ (self only, to the Shadow Plane or the Material Plane only) usable once per day. A fetchling's caster level is equal to his total Hit Dice.
...
**Emissary** : Rare fetchlings excel in the role of emissary between the Shadow Plane and the Material Plane. Once per day, such a fetchling can roll twice when making a [Bluff](skill_dir/bluff#_bluff or [Diplomacy](skill_dir/diplomacy#_diplomacy check and take the better roll. This racial trait replaces shadow blending.

**Gloom Shimmer** : Some fetchlings can manipulate shadowy energy in order to displace their location instead of transporting between shadows. Upon reaching 9th level, instead of gaining _ [shadow walk](spell_dir/shadowWalk#_shadow-walk_ as a spell-like ability, these fetchlings gain _ [displacement](spell_dir/displacement#_displacement)_ as a spell-like ability usable twice per day. For this ability, a fetchling's caster level is equal to his total Hit Dice. This racial trait modifies the spell-like ability racial trait.
...
**Subtle Manipulator** : Rather than taking on the forms of others, some fetchling are adept at destroying the memories of other creatures. Instead of gaining _ [disguise self](spell_dir/disguiseSelf#_disguise-self_ as a spell-like ability, such fetchlings can use _ [memory lapse](advanced/spell_dir/memoryLapse#_memory-lapse _ once per day as a spell-like ability. For this ability, a fetchling's caster level is equal to his total Hit Dice. This racial trait modifies the spell-like ability racial trait.

**World Walker** : Fetchlings who have spent most of their lives on the Material Plane can become more acclimated to their new environments. Instead of gaining a +2 racial bonus on [Knowledge](skill_dir/knowledge#_knowledge) (planes checks, these fetchlings gain a +1 racial bonus on [Knowledge](skill_dir/knowledge#_knowledge) (nature and [Knowledge](skill_dir/knowledge#_knowledge) (local checks. This racial trait modifies the skilled racial trait.
...
**Ranger** : Add a +1/2 bonus on [Perception](skill_dir/perception#_perception and [Survival](skill_dir/survival#_survival checks made on the Plane of Shadow.

**Rogue** : Add a +1/2 bonus on [Stealth](skill_dir/stealth#_stealth and [Sleight of Hand](skill_dir/sleightOfHand#_sleight-of-hand checks made while in dim light or darkness.
...
**Class Skills** : The dusk stalker adds [Knowledge](skill_dir/knowledge#_knowledge) (planes to his list of class skills and removes [Knowledge](skill_dir/knowledge#_knowledge) (nature) from his list of class skills.
...
**Class Skills** : The shadow caller adds [Stealth](skill_dir/stealth#_stealth to his list of class skills and removes [Use Magic Device](skill_dir/useMagicDevice#_use-magic-device) from his list of class skills.
...
**Shadow Form (Su)** : The eidolon's body becomes shadowy and more indistinct. This shadow form grants the eidolon constant concealment (20% miss chance, and its melee attacks affect incorporeal creatures as if it had the _ [ghost touch](magicItem_dir/weapons#_weapons-ghost-touch)_ weapon property. The eidolon's melee attacks deal only half damage to corporeal creatures.
...
**Benefit** : You gain the ability to see up to 15 feet clearly in magical darkness, such as that created by the _ [deeper darkness](spell_dir/deeperDarkness#_deeper-darkness)_ spell.
...
**Prerequisites** : Fetchling, _ [shadow walk](spell_dir/shadowWalk#_shadow-walk_ spell-like ability.

**Benefit** : You gain the ability to use _ [shadow walk](spell_dir/shadowWalk#_shadow-walk_ an additional time each day.
...
**Benefit** : You can expend one use of your shadow walk spell-like ability to use _ [dimension door](spell_dir/dimensionDoor#_dimension-door)_ as a spell-like ability. Your start and end locations for this ability must be in dim light or darkness.
...
**Requirements** [Craft Wondrous Item](feats#_craft-wondrous-item, _ [light](spell_dir/light#_light_, _ [invisibility](spell_dir/invisibility#_invisibility_; **Cost** 4,500 gp
...
A person holding an active _lambent window_ can use it as a special focus when casting _ [plane shift](spell_dir/planeShift#_plane-shift_ or using _ [plane shift](spell_dir/planeShift#_plane-shift)_ as a spell-like ability to reach the specific location shown in the mirror, rather than 5–500 miles from the bearer's intended destination.

Construction

**Requirements** [Craft Wondrous Item](feats#_craft-wondrous-item, _ [plane shift](spell_dir/planeShift#_plane-shift_, _ [scrying](spell_dir/scrying#_scrying_; **Cost** 10,000 gp
...
Once per day, the lit _lantern of [dancing](magicItem_dir/weapons#_weapons-dancing shadows_ can be commanded to create quasi-real illusions from the shadows cast by its light, as the _ [shadow conjuration](spell_dir/shadowConjuration#_shadow-conjuration)_ spell. In addition, once per day, the lantern can be commanded to solidify shadows for a short period of time. These solidified shadows cause incorporeal creatures within the lantern's illumination radius (30 feet to coalesce into semi-physical forms, as the _ [mass ghostbane dirge](advanced/spell_dir/ghostbaneDirge#_ghostbane-dirge,-mass)_ spell.

Construction

**Requirements** [Craft Wondrous Item](feats#_craft-wondrous-item, _ [darkness](spell_dir/darkness#_darkness_, _ [mass ghostbane dirge](advanced/spell_dir/ghostbaneDirge#_ghostbane-dirge,-mass_, _ [shadow conjuration](spell_dir/shadowConjuration#_shadow-conjuration)_; **Cost** 20,500 gp
...
This spell functions like _ [rope trick](spell_dir/ropeTrick#_rope-trick)_, except the point of entry is through a 5-foot-square instead of a rope. The space holds as many as 10 creatures of any size.
...
Because the extradimensional space is adjacent to the Shadow Plane, any _ [shadow walk](spell_dir/shadowWalk#_shadow-walk_ spell or similar effect that allows travel to the Shadow Plane is more accurate, reducing the distance creatures arrive off-target by half.

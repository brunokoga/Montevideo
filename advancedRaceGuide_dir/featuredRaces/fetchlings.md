---
title: advancedRaceGuid_dir/featuredRaces/fetchlings
---
# Fetchlings 
...
**Emissary** : Rare fetchlings excel in the role of emissary between the Shadow Plane and the Material Plane. Once per day, such a fetchling can roll twice when making a [Bluff](skill_dir/bluff#_bluff) or [Diplomacy](skills/diplomacy#_diplomacy) check and take the better roll. This racial trait replaces shadow blending.

**Gloom Shimmer** : Some fetchlings can manipulate shadowy energy in order to displace their location instead of transporting between shadows. Upon reaching 9th level, instead of gaining _ [shadow walk](spell_dir/shadowWalk#_shadow-walk)_ as a spell-like ability, these fetchlings gain _ [displacement](spells/displacement#_displacement)_ as a spell-like ability usable twice per day. For this ability, a fetchling's caster level is equal to his total Hit Dice. This racial trait modifies the spell-like ability racial trait.
...
**Ranger** : Add a +1/2 bonus on [Perception](skill_dir/perception#_perception) and [Survival](skills/survival#_survival) checks made on the Plane of Shadow.

**Rogue** : Add a +1/2 bonus on [Stealth](skill_dir/stealth#_stealth) and [Sleight of Hand](skills/sleightOfHand#_sleight-of-hand) checks made while in dim light or darkness.
...
**Class Skills** : The dusk stalker adds [Knowledge](skill_dir/knowledge#_knowledge) (planes) to his list of class skills and removes [Knowledge](skills/knowledge#_knowledge) (nature) from his list of class skills.
...
**Class Skills** : The shadow caller adds [Stealth](skills/stealth#_stealth) to his list of class skills and removes [Use Magic Device](skill_dir/useMagicDevice#_use-magic-device) from his list of class skills.
...
**Shadow Form (Su)** : The eidolon's body becomes shadowy and more indistinct. This shadow form grants the eidolon constant concealment (20% miss chance), and its melee attacks affect incorporeal creatures as if it had the _ [ghost touch](magicItems/weapons#_weapons-ghost-touch)_ weapon property. The eidolon's melee attacks deal only half damage to corporeal creatures.
...
**Prerequisites** : Fetchling, _ [shadow walk](spells/shadowWalk#_shadow-walk)_ spell-like ability.

**Benefit** : You gain the ability to use _ [shadow walk](spell_dir/shadowWalk#_shadow-walk)_ an additional time each day.
...
**Requirements** [Craft Wondrous Item](feats#_craft-wondrous-item), _ [light](spells/light#_light)_, _ [invisibility](spell_dir/invisibility#_invisibility)_; **Cost** 4,500 gp
...
A person holding an active _lambent window_ can use it as a special focus when casting _ [plane shift](spells/planeShift#_plane-shift)_ or using _ [plane shift](spell_dir/planeShift#_plane-shift)_ as a spell-like ability to reach the specific location shown in the mirror, rather than 5–500 miles from the bearer's intended destination.

Construction

**Requirements** [Craft Wondrous Item](feats#_craft-wondrous-item), _ [plane shift](spells/planeShift#_plane-shift)_, _ [scrying](spell_dir/scrying#_scrying)_; **Cost** 10,000 gp
...
Once per day, the lit _lantern of [dancing](magicItems/weapons#_weapons-dancing) shadows_ can be commanded to create quasi-real illusions from the shadows cast by its light, as the _ [shadow conjuration](spell_dir/shadowConjuration#_shadow-conjuration)_ spell. In addition, once per day, the lantern can be commanded to solidify shadows for a short period of time. These solidified shadows cause incorporeal creatures within the lantern's illumination radius (30 feet) to coalesce into semi-physical forms, as the _ [mass ghostbane dirge](advanced/spell_dir/ghostbaneDirge#_ghostbane-dirge,-mass)_ spell.

Construction

**Requirements** [Craft Wondrous Item](feats#_craft-wondrous-item), _ [darkness](spells/darkness#_darkness)_, _ [mass ghostbane dirge](advance_dir/spells/ghostbaneDirge#_ghostbane-dirge,-mass)_, _ [shadow conjuration](spell_dir/shadowConjuration#_shadow-conjuration)_; **Cost** 20,500 gp
...
Because the extradimensional space is adjacent to the Shadow Plane, any _ [shadow walk](spells/shadowWalk#_shadow-walk)_ spell or similar effect that allows travel to the Shadow Plane is more accurate, reducing the distance creatures arrive off-target by half.

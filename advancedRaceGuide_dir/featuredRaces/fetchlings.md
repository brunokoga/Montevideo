...
**Subtle Manipulator** : Rather than taking on the forms of others, some fetchling are adept at destroying the memories of other creatures. Instead of gaining _ [disguise self](spells/disguiseSelf#_disguise-self)_ as a spell-like ability, such fetchlings can use _ [memory lapse](advanced/spells/memoryLapse#_memory-lapse) _ once per day as a spell-like ability. For this ability, a fetchling's caster level is equal to his total Hit Dice. This racial trait modifies the spell-like ability racial trait.

**World Walker** : Fetchlings who have spent most of their lives on the Material Plane can become more acclimated to their new environments. Instead of gaining a +2 racial bonus on [Knowledge](skills/knowledge#_knowledge) (planes) checks, these fetchlings gain a +1 racial bonus on [Knowledge](skills/knowledge#_knowledge) (nature) and [Knowledge](skills/knowledge#_knowledge) (local) checks. This racial trait modifies the skilled racial trait.
...
**Ranger** : Add a +1/2 bonus on [Perception](skills/perception#_perception) and [Survival](skills/survival#_survival) checks made on the Plane of Shadow.

**Rogue** : Add a +1/2 bonus on [Stealth](skills/stealth#_stealth) and [Sleight of Hand](skills/sleightOfHand#_sleight-of-hand) checks made while in dim light or darkness.
...
**Class Skills** : The dusk stalker adds [Knowledge](skills/knowledge#_knowledge) (planes) to his list of class skills and removes [Knowledge](skills/knowledge#_knowledge) (nature) from his list of class skills.
...
**Class Skills** : The shadow caller adds [Stealth](skills/stealth#_stealth) to his list of class skills and removes [Use Magic Device](skills/useMagicDevice#_use-magic-device) from his list of class skills.
...
**Benefit** : You gain the ability to see up to 15 feet clearly in magical darkness, such as that created by the _ [deeper darkness](spells/deeperDarkness#_deeper-darkness)_ spell.
...
**Benefit** : You gain the ability to use _ [shadow walk](spells/shadowWalk#_shadow-walk)_ an additional time each day.
...
**Benefit** : You can expend one use of your shadow walk spell-like ability to use _ [dimension door](spells/dimensionDoor#_dimension-door)_ as a spell-like ability. Your start and end locations for this ability must be in dim light or darkness.
...
**Requirements** [Craft Wondrous Item](feats#_craft-wondrous-item), _ [light](spells/light#_light)_, _ [invisibility](spells/invisibility#_invisibility)_; **Cost** 4,500 gp
...
Once per day, the lit _lantern of [dancing](magicItems/weapons#_weapons-dancing) shadows_ can be commanded to create quasi-real illusions from the shadows cast by its light, as the _ [shadow conjuration](spells/shadowConjuration#_shadow-conjuration)_ spell. In addition, once per day, the lantern can be commanded to solidify shadows for a short period of time. These solidified shadows cause incorporeal creatures within the lantern's illumination radius (30 feet) to coalesce into semi-physical forms, as the _ [mass ghostbane dirge](advanced/spells/ghostbaneDirge#_ghostbane-dirge,-mass)_ spell.

Construction

**Requirements** [Craft Wondrous Item](feats#_craft-wondrous-item), _ [darkness](spells/darkness#_darkness)_, _ [mass ghostbane dirge](advanced/spells/ghostbaneDirge#_ghostbane-dirge,-mass)_, _ [shadow conjuration](spells/shadowConjuration#_shadow-conjuration)_; **Cost** 20,500 gp
...
This spell functions like _ [rope trick](spells/ropeTrick#_rope-trick)_, except the point of entry is through a 5-foot-square instead of a rope. The space holds as many as 10 creatures of any size.

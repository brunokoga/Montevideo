---
title: advancedRaceGuid_dir/featuredRaces/tieflings
---
# Tieflings
...
**Skilled** : Tieflings gain a +2 racial bonus on [Bluff](skill_dir/bluff#_bluff) and [Stealth](skills/stealth#_stealth) checks.

**Spell-Like Ability** : Tieflings can use _ [darkness](spell_dir/darkness#_darkness)_ once per day as a spell-like ability. The caster level for this ability equals the tiefling's class level.
...
**Soul Seer** : Rare tieflings have a peculiar sight that allows them to see the state of a creature's soul. They can use _ [deathwatch](spell_dir/deathwatch#_deathwatch)_ at will as spell-like ability. This racial trait replaces the spell-like ability and fiendish sorcery racial traits.
...
**Inquisitor** : Add a +1/2 bonus on [Intimidate](skill_dir/intimidate#_intimidate) checks and [Knowledge](skills/knowledge#_knowledge) checks to identify creatures.
...
At 5th level, these bonuses can be used to add any of the following weapon properties to the fiendblade: _ [anarchic](magicItem_dir/weapons#_weapons-anarchic)_, _ [axiomatic](magicItems/weapons#_weapons-axiomatic)_, _ [dancing](magicItem_dir/weapons#_weapons-dancing)_, _ [flaming](magicItems/weapons#_weapons-flaming)_, _burst_, _ [frost](magicItem_dir/weapons#_weapons-frost)_, _ [icy burst](magicItems/weapons#_weapons-icy-burst)_, _ [keen](magicItem_dir/weapons#_weapons-keen)_, _ [shock](magicItems/weapons#_weapons-shock)_, _ [shocking burst](magicItem_dir/weapons#_weapons-shocking-burst)_, _ [speed](magicItems/weapons#_weapons-speed)_, or _ [unholy](magicItem_dir/weapons#_unholy)_.
...
> _Fiendish [Augury](spell_dir/augury#_augury) (Sp)_: At 3rd level, the fiendish vessel can ask the familiar whether a particular course of action will bring good or bad results for her in the immediate future. This ability acts like the _ [augury](spells/augury#_augury)_ spell, with a caster level equal to the fiendish vessel's level, with the familiar acting as the mouthpiece for the spell. This ability can be used once per day.
> 
...
> 
> _Extra [Divination](spell_dir/divination#_divination) (Sp)_: At 13th level, the fiendish vessel can gain intelligence from her patron more often each day. She can use fiendish divination up to 3 times per day.
...
**Requirements** [Craft Wondrous Item](feats#_craft-wondrous-item), creator must be a tiefling of [good](monsters/creatureTypes#_good-subtype) alignment, _ [holy aura](spell_dir/holyAura#_holy-aura)_; **Cost** 8,000 gp

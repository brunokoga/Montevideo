---
title: advancedRaceGuide/featuredRace_dir/aasimars
---
# Aasimars
...
**Celestial Crusader** : Some aasimars follow their destiny to war against the powers of ultimate evil. These individuals gain a +1 insight bonus on attack rolls and to AC against evil outsiders and a +2 racial bonus on [Knowledge](skill_dir/knowledge#_knowledge) (planes and [Spellcraft](skill_dir/spellcraft#_spellcraft checks to identify evil outsiders or items or effects created by evil outsiders; they may use these skills untrained for this purpose. This racial trait replaces celestial resistance and skilled.
...
**Halo** : Some aasimars possess the ability to manifest halos. An aasimar with this racial trait can create _ [light](spell_dir/light#_light _centered on her head at will as a spell-like ability. When using her halo, she gains a +2 circumstance bonus on [Intimidate](skill_dir/intimidate#_intimidate checks against evil creatures and on saving throws against becoming blinded or dazzled. This racial trait replaces the darkvision racial trait.

**Heavenborn** : Born in the celestial realms, aasimars with this racial trait gain a +2 bonus on [Knowledge](skill_dir/knowledge#_knowledge) (planes checks and they cast spells with the good or light descriptor at +1 caster level. This racial trait replaces the skilled and spell-like ability racial traits.

**Immortal Spark** : Aasimars with this racial trait defy the powers of death. They gain a +2 bonus on [Knowledge](skill_dir/knowledge#_knowledge) (history checks and saving throws against death effects and can use _ [lesser age resistance](ultimateMagic/spell_dir/ageResistance#_age-resistance,-lesser_ once per day as a spell-like ability. This racial trait replaces the skilled and spell-like ability racial traits.
...
**Inquisitor** : Add +1/2 on [Intimidate](skill_dir/intimidate#_intimidate, [Knowledge](skill_dir/knowledge#_knowledge, and [Sense Motive](skill_dir/senseMotive#_sense-motive checks made against outsiders.
...
**Bonus Spells** : _veil of heaven _(2nd),_ [confess](advanced/spell_dir/confess#_confess)_ (4th, _ [cast out](advanced/spell_dir/castOut#_cast-out) _(6th, _ [denounce](advanced/spell_dir/denounce#_denounce) _(8th, _ [dispel evil](spell_dir/dispelEvil#_dispel-evil)_ (10th, _ [banishment](spell_dir/banishment#_banishment) _(12th, _ [holy word](spell_dir/holyWord#_holy-word) _(14th, _ [mind blank](spell_dir/mindBlank#_mind-blank) _(16th, _ [freedom](spell_dir/freedom#_freedom) _(18th).
...
> 
> If the target is possessed (such as by a _ [magic jar](spell_dir/magicJar#_magic-jar) _effect or a ghost's malevolence ability), the possessor is forced out on a successful check. Whether the check succeeds or fails, the possessor is sickened for 2d4 rounds.
...
**Benefit** : You gain a pair of gleaming feathered wings that grant a fly speed of 30 feet (average maneuverability) if wearing light armor or unencumbered, or 20 feet (poor maneuverability with a medium or heavy load or medium or heavy armor. [Fly](skill_dir/fly#_fly) is a class skill for you.
...
**Benefit** : You take a –2 penalty on [Disguise](skill_dir/disguise#_disguise and [Stealth](skill_dir/stealth#_stealth) checks but gain one of the following benefits, depending on the metallic affinity of your flesh (choose one).
...
**Prerequisites** : Aasimar, _ [daylight](spell_dir/daylight#_daylight) _spell-like ability, sufficiently high level (see below.

**Benefit** : You gain one additional use per day of _ [daylight](spell_dir/daylight#_daylight. C_hoose one spell from the table below; by expending a use of _ [daylight](spell_dir/daylight#_daylight_, you may use this spell as a spell-like ability. To select a spell, you must meet the minimum character level for its listing in the table. The save DC for this spell is Charisma-based.
...
| --- | --- |
| _ [Flare burst](advanced/spell_dir/flareBurst#_flare-burst_ | 1st |
| _ [Wake of light](advanced/spell_dir/wakeOfLight#_wake-of-light-_ | 3rd |
| _ [Searing light](spell_dir/searingLight#_searing-light_ | 5th |
| _ [Wandering star motes](advanced/spell_dir/wanderingStarMotes#_wandering-star-motes_ | 7th |
| _ [Sunbeam](spell_dir/sunbeam#_sunbeam) _(one beam only | 9th |
...
This bright silver or gold _+2 [blinding](magicItem_dir/armor#_armor-blinding heavy steel [shield](spell_dir/shield#_shield _is impossibly light and handy despite its size. It has no armor check penalty or arcane spell failure chance, and it allows the wielder to use _ [feather fall](spell_dir/featherFall#_feather-fall _on himself once per day. A creature wearing _celestial armor _while wielding a _celestial [shield](spell_dir/shield#_shield _may command the armor to provide _ [overland flight](spell_dir/overlandFlight#_overland-flight _rather than _ [fly](spell_dir/fly) _once per day.

Construction

**Requirements** [Craft Magic Arms and Armor](feats#_craft-magic-arms-and-armor, _ [feather fall](spell_dir/featherFall#_feather-fall, [overland flight](spell_dir/overlandFlight#_overland-flight_; **Cost** 6,670 gp
...
This _+2 [ghost touch](magicItem_dir/weapons#_weapons-ghost-touch tower [shield](spell_dir/shield#_shield _is engraved with funerary runes depicting the peaceful rest of the contented dead. The wielder of an _elysian [shield](spell_dir/shield#_shield)_ is immune to the create spawn ability of undead, and once per day as an immediate action can negate a single energy drain, ability drain, or ability damage attack by an undead creature. In addition, once per day as a standard action, the wielder can release a wave of positive energy that panics undead, as the [Turn Undead](feats#_turn-undead) feat (DC 20 Will negates).

Construction

**Requirements** [Craft Magic Arms and Armor](feats#_craft-magic-arms-and-armor), [Turn Undead](feats#_turn-undead, _ [death ward](spell_dir/deathWard#_death-ward, [etherealness](magicItem_dir/armor#_armor-etherealness)_; **Cost** 26,390 gp

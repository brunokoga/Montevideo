...
**Spell-Like Ability** : _ [Feather fall](spells/featherFall#_feather-fall)_ 1/day (caster level equals the sylph's total level).
...
**Sky Speaker** : Sylphs with this racial trait feel kinship toward the creatures of the air, and can use _ [speak with animals](spells/speakWithAnimals#_speak-with-animals)_ once per day to speak to birds or other flying animals. Her caster level for these effects is equal to her level. This racial trait replaces the sylph's spell-like ability racial trait.
...
**Cleric** : Add a +1/2 bonus on [Knowledge](skills/knowledge#_knowledge) (planes) checks relating to the Plane of Air and creatures with the air subtype.

**Druid** : Add a +1/2 bonus on [Knowledge](skills/knowledge#_knowledge) (nature) checks relating to weather and flying animals.

**Inquisitor** : Add a +1/2 bonus on [Stealth](skills/stealth#_stealth) checks while motionless and on opposed [Perception](skills/perception#_perception) checks.

**Oracle** : Add +1/2 to the oracle's level for the purpose of determining the effects of one revelation.

**Rogue** : Add a +1/2 bonus on [Acrobatics](skills/acrobatics#_acrobatics) checks to jump and a +1/2 bonus on [Sense Motive](skills/senseMotive#_sense-motive) checks.
...
**Witch** : Add a +1/2 bonus on [Stealth](skills/stealth#_stealth) checks and [Perception](skills/perception#_perception) checks made by the witch's familiar. If the sylph ever replaces her familiar, the new familiar gains these bonus skill ranks.
...
**Sky's Embrace (Su)** : At 2nd level, a sky druid no longer takes falling damage, as though she were constantly under the effect of _ [feather fall](spells/featherFall#_feather-fall)_. Additionally, she may take ranks in the [Fly](skills/fly#_fly) skill regardless of whether she has a natural fly speed, and may use her [Fly](skills/fly#_fly) skill in place of [Acrobatics](skills/acrobatics#_acrobatics) when making jump checks. This ability replaces woodland stride.

**Resist Storm (Ex)** : At 4th level, a sky druid gains a +4 bonus on saving throws against spells with the air or electricity descriptors and against effects that control or modify the weather (such as _ [sleet storm](spells/sleetStorm#_sleet-storm)_). This ability replaces resist nature's lure.
...
**Class Skills** : A wind listener adds [Perception](skills/perception#_perception) to his list of class skills.
...
**Benefit** : You no longer need to breathe. You are immune to effects that require breathing (such as inhaled poison). This does not give you immunity to cloud or gas attacks that do not require breathing, such as _ [cloudkill](spells/cloudkill#_cloudkill)_.
...
**Effect** 5-ft.-diameter sphere of [air](monsters/creatureTypes#_air-subtype)
...
**School** transmutation [[air](monsters/creatureTypes#_air-subtype), [poison](monsters/universalMonsterRules#_poison-(ex-or-su))]; **Level** alchemist 4, sorcerer/wizard 4
...
_ [Stinking cloud](spells/stinkingCloud#_stinking-cloud)_: The target's body nauseates creatures that fail their saving throws, as _ [stinking cloud](spells/stinkingCloud#_stinking-cloud)_ (Fortitude negates, see text). This form of the spell does not require a material component.

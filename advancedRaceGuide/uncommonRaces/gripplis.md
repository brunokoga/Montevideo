...
**Small** : Gripplis are Small creatures and gain a +1 size bonus to their AC, a +1 size bonus on attack rolls, a –1 penalty to their CMB and CMD, and a +4 size bonus on [Stealth](skills/stealth.md#_stealth) checks.
...
**Camouflage** : Gripplis receive a +4 racial bonus on [Stealth](skills/stealth.md#_stealth) checks in marshes and forested areas.
...
**Jumper** : Gripplis with this trait are always considered to have a running start when making [Acrobatics](skills/acrobatics.md#_acrobatics) checks to jump. This racial trait replaces camouflage.

**Princely** : The grippli gains proficiency with rapiers and a +2 racial bonus on [Diplomacy](skills/diplomacy.md#_diplomacy) and [Intimidate](skills/intimidate.md#_intimidate) checks. This racial trait replaces swamp stride and weapon familiarity.
...
**Rogue** : Add a +1/2 bonus on [Perception](skills/perception.md#_perception) checks while in a forest or swamp.

**Ranger** : Add a +1 racial bonus on [Swim](skills/swim.md#_swim) skill checks. When this bonus reaches +8, the ranger gains a swim speed of 15 feet (this does not grant the ranger another +8 racial bonus on [Swim](skills/swim.md#_swim) checks).
...
**Class Skills** : A bogborn alchemist adds [Swim](skills/swim.md#_swim) to his list of class skills.
...
**Chameleon (Su)** : An alchemist with this discovery can shift the colors of his skin and equipment to blend in with the surrounding terrain. He gains a +4 enhancement bonus on [Stealth](skills/stealth.md#_stealth) checks. At 10th level, the bonus on [Stealth](skills/stealth.md#_stealth) checks increases to +8.
...
**Benefit** : You have a prehensile tongue with a range of 10 feet. You can pick up items weighing no more than 5 pounds, make [Sleight of Hand](skills/sleightOfHand.md#_sleight-of-hand) checks, perform the steal or disarm combat maneuvers, or make melee touch attacks with your tongue.
...
**Requirements** [Craft Wondrous Item](feats.md#_craft-wondrous-item), _ [shrink item](spells/shrinkItem.md#_shrink-item)_, _ [unseen servant](spells/unseenServant.md#_unseen-servant)_; **Cost** 750 gp

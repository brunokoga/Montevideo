...
**Skills** : [Knowledge](../../skills/knowledge#_knowledge) (geography) 6 ranks.

**Feats** : [Endurance](../../feats#_endurance).

# Class Skills

The horizon walker's class skills are [Climb](../../skills/climb#_climb) (Str), [Diplomacy](../../skills/diplomacy#_diplomacy) (Cha), [Handle Animal](../../skills/handleAnimal#_handle-animal) (Cha), [Knowledge](../../skills/knowledge#_knowledge) (geography) (Int), [Knowledge](../../skills/knowledge#_knowledge) (nature) (Int), [Knowledge](../../skills/knowledge#_knowledge) (the planes) (Int), [Linguistics](../../skills/linguistics#_linguistics) (Int), [Perception](../../skills/perception#_perception) (Wis), [Stealth](../../skills/stealth#_stealth) (Dex), [Survival](../../skills/survival#_survival) (Wis), and [Swim](../../skills/swim#_swim) (Str).
...
_Forest_: The horizon walker gains a +4 competence bonus on [Stealth](../../skills/stealth#_stealth) checks.

_Jungle_: The horizon walker gains a +4 competence bonus on [Escape Artist](../../skills/escapeArtist#_escape-artist) checks and increases his CMD against grapple maneuvers by +4.

_Mountain_: The horizon walker gains a +4 competence bonus on [Climb](../../skills/climb#_climb) checks and does not lose his Dexterity modifier to AC while climbing.

_Plains_: The horizon walker's movement is not reduced by wearing medium armor or carrying a medium load.

_Plane of Air_: The horizon walker gains a +4 competence bonus on [Fly](../../skills/fly#_fly) checks and +1 competence bonus on all attack and damage rolls against flying creatures. He gains the ability to breathe air if he cannot already do so.

_Plane of Earth_: The horizon walker gains DR 1/adamantine.

_Plane of Fire_: The horizon walker gains fire resistance 10.

_Plane of Water_: The horizon walker gains a +4 competence bonus on [Swim](../../skills/swim#_swim) checks and a +1 competence bonus on all attack and damage rolls against swimming creatures. He gains the ability to breathe water if he cannot already do so.
...
_Swamp_: The horizon walker gains a +4 competence bonus on [Perception](../../skills/perception#_perception) checks.

_Underground_: The horizon walker gains [Blind-Fight](../../feats#_blind-fight) as a bonus feat.

_Urban_: The horizon walker gains a +4 competence bonus on [Diplomacy](../../skills/diplomacy#_diplomacy) checks.

_Water_: The horizon walker gains a +4 competence bonus on [Swim](../../skills/swim#_swim) checks and +1 competence bonus on all attack and damage rolls against swimming creatures.
...
_Astral Plane_: The horizon walker gains a +1 competence bonus on attack and damage rolls against outsiders. He gains _ [dimension door](../../spells/dimensionDoor#_dimension-door)_ as a spell-like ability a number of times per day equal to 3 + the character's Wisdom modifier (caster level equal to the character's level).
...
_Ethereal Plane_: The walker gains _ [ethereal jaunt](../../spells/etherealJaunt#_ethereal-jaunt)_ as a spell-like ability once per day (caster level equal to the character's level). He must be at least 7th level before selecting this power.

_Forest_: The horizon walker gains _ [hallucinatory terrain](../../spells/hallucinatoryTerrain#_hallucinatory-terrain)_ as a spell-like ability a number of times per day equal to 3 + the character's Wisdom modifier (caster level equal to the character's level). The horizon walker can only use this ability to create illusory forests.

_Jungle_: The horizon walker gains _ [charm monster](../../spells/charmMonster#_charm-monster)_ as a spell-like ability a number of times per day equal to 3 + the character's Wisdom modifier (caster level equal to the character's level). This charm only affects animals, magical beasts, and creatures primarily found in the jungle.

_Mountain_: The horizon walker gains DR 2/adamantine.

_Plains_: The walker's base speed increases by +10 feet.

_Plane of Air_: The horizon walker gains _ [fly](../../spells/fly)_ as a spell-like ability a number of times per day equal to 3 + the character's Wisdom modifier (caster level equal to the character's level).
...
_Plane of Water_: The horizon walker's movements and actions are not hampered when underwater. This allows him to speak, make attacks, and cast spells normally underwater (as if using _ [freedom of movement](../../spells/freedomOfMovement#_freedom-of-movement)_).
...
_Urban_: The horizon walker gains _ [charm person](../../spells/charmPerson#_charm-person)_ as a spell-like ability a number of times per day equal to 3 + the character's Wisdom modifier (caster level equal to the character's level).

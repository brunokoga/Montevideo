---
layout: default
title: advance_dir/prestigeClasses/masterChymist
---
# Master Chymist
...
_Growth Mutagen (Su)_: When the chymist assumes her mutagenic form, she increases one size category, as if under the effects of an _ [enlarge person](../../spell_dir/enlargePerson#_enlarge-person)_ spell. The character must have an effective alchemist level (alchemist level plus chymist level) of at least 16 and must know the _ [enlarge person](../../spell_dir/enlargePerson#_enlarge-person)_, _ [giant form I](../../spell_dir/giantForm#_giant-form-i)_, or _ [polymorph](../../spell_dir/polymorph#_polymorph)_ extract to select this ability.

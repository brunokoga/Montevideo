---
title: advance_dir/coreClasses/bard
---
# Bard
...
_Bladethirst (Su)_: An arcane duelist of 6th level or higher may use performance to grant one weapon, one natural weapon, one end of a double weapon, or 50 items of ammunition of the same type within 30 feet a +1 enhancement bonus. This enhancement bonus increases by +1 for every three levels after 6th (maximum +5 at 18th level). These bonuses stack with existing bonuses and may be used to increase the item's enhancement bonus up to +5 or to add any of the following weapon properties: _ [defending](../../magicItem_dir/weapons#_weapons-defending)_, _ [distance](../../magicItem_dir/weapons#_weapons-distance)_, _ [ghost touch](../../magicItem_dir/weapons#_weapons-ghost-touch)_, _ [keen](../../magicItem_dir/weapons#_weapons-keen)_, _ [mighty cleaving](../../magicItem_dir/weapons#_weapons-mighty-cleaving)_, _ [returning](../../magicItem_dir/weapons#_weapons-returning)_, _ [shock](../../magicItem_dir/weapons#_weapons-shock)_, _ [shocking burst](../../magicItem_dir/weapons#_weapons-shocking-burst)_, _ [seeking](../../magicItem_dir/weapons#_weapons-seeking)_, _ [speed](../../magicItem_dir/weapons#_weapons-speed)_, or _ [wounding](../../magicItem_dir/weapons#_wounding)_. If the weapon is not magical, at least a +1 enhancement bonus must be added before adding special abilities. This performance replaces suggestion.
...
_Scandal (Su)_: A court bard of 14th level or higher can combine salacious gossip and biting calumny to incite a riot. Each enemy within 30 feet is affected as if by a _ [song of discord](../../spell_dir/songOfDiscord#_song-of-discord)_ for as long as it can hear the performance. A successful Will save (DC 10 + 1/2 the bard's level + the bard's Cha modifier) negates the effect, and that creature is immune to this ability for 24 hours. Scandal is a language-dependent, mind-affecting ability that uses audible components. This performance replaces frightening tune.
...
**Arcane Insight (Ex)** : At 2nd level, a detective can find and disable magical traps, like a rogue's trapfinding ability. In addition, he gains a +4 bonus on saving throws made against illusions and a +4 bonus on caster level checks and saving throws to see through disguises and protections against divination (such as _ [magic aura](../../spell_dir/magicAura#_magic-aura)_, _ [misdirection](../../spell_dir/misdirection#_misdirection)_, and _ [nondetection](../../spell_dir/nondetection#_nondetection)_). This ability replaces well-versed.

**Arcane Investigation** : In addition, a detective's class spell list includes the following: 1st—_ [detect chaos](../../spell_dir/detectChaos#_detect-chaos)/evi_dir/law/good_; 2nd—_ [zone of truth](../../spell_dir/zoneOfTruth#_zone-of-truth)_; 3rd—_ [arcane eye](../../spell_dir/arcaneEye#_arcane-eye), [speak with dead](../../spell_dir/speakWithDead#_speak-with-dead), [speak with plants](../../spell_dir/speakWithPlants#_speak-with-plants)_; 4th—_ [discern lies](../../spell_dir/discernLies#_discern-lies)_; 5th—_ [prying eyes](../../spell_dir/pryingEyes#_prying-eyes), [stone tell](../../spell_dir/stoneTell#_stone-tell)_; 6th—_ [discern location](../../spell_dir/discernLocation#_discern-location), [find the path](../../spell_dir/findThePath#_find-the-path), [greater prying eyes](../../spell_dir/pryingEyes#_prying-eyes-greater), [moment of prescience](../../spell_dir/momentOfPrescience#_moment-of-prescience)_. A detective may add one of these spells or any divination spell on the bard spell list to his list of spells known at 2nd level and every four levels thereafter. This ability replaces versatile performance.
...
_Incite [Rage](../../spell_dir/rage#_rage) (Su)_: At 6th level, a savage skald can induce a furious rage in one creature within 30 feet. This effect functions as a _ [rage](../../spell_dir/rage#_rage)_ spell that lasts as long as the target can hear the bard's performance; however, unwilling creatures can be affected if they fail a Will save (DC 10 + 1/2 the bard's level + the bard's Cha modifier). Success renders the target immune to this power for 24 hours. The bard cannot target himself with this ability. If the target has the rage class feature, it can instead immediately rage and stay in this rage without consuming rounds of rage per day as long as the bard continues performing. This mind-affecting effect requires audible components. This performance replaces suggestion.
...
_Slip through the Crowd (Su)_: At 15th level, a street performer's disappearing act enables affected creatures to move through crowd squares and enemy-occupied squares without impediment. Affected creatures are treated as if having _ [greater invisibility](../../spell_dir/invisibility#_invisibility-greater)_, but enemies gain a new saving throw to notice them each time they are attacked. This performance replaces inspire heroics.

...
**_Ki_ Mystic (Su)** : At 3rd level, a _ki _mystic gains a pool of _ki_ points equal to his Wisdom modifier. The pool increases to 1/2 his monk level + his Wisdom modifier + 2 at level 4. If the monk has at least 1 point of _ki_ in his _ki_ pool, he gains a +2 bonus on all [Knowledge](../../skills/knowledge#_knowledge) skill checks. As a swift action, the monk can spend 1 _ki_ point immediately before making an ability, or skill check to gain a +4 insight bonus on the check. This ability replaces still mind.
...
**Mystic Visions (Su)** : At 11th level, a _ki _mystic may receive mystic visions when he rests. These visions can come as a dream, an epiphany, or even as the voice of an old friend whispering in the monk's mind. The effect is similar to a _ [divination](../../spells/divination#_divination) _spell with a caster level equal to the monk's level. The _ [divination](../../spells/divination#_divination)_ has no casting time; it is just part of the normal dreams or visions that occur every night. Using this ability costs 2 _ki_ points that are removed from the next day's total. This ability replaces diamond body.
...
**_Ki_ Weapons (Su)** : At 5th level, a monk of the empty hand may spend 1 point from his _ki_ pool as a swift action to deal damage equal to his unarmed strike damage with an improvised weapon for 1 round. At 11th level, the monk may spend _ki_ to grant an enhancement bonus or magical weapon abilities to an improvised weapon for 1 round, at the rate of 1 point of _ki_ per +1 bonus or its equivalent. The monk may not spend more than 3 points of _ki_ at one time for this purpose. For example, a monk can spend 2 points of _ki_ to give his improvised weapon a +1 enhancement bonus and the _ [ki focus](../../magicItems/weapons#_weapons-ki-focus)_ quality, or just the _ [flaming burst](../../magicItems/weapons#_weapons-flaming-burst)_ quality. At 15th level, the limit increases to 5 _ki_ per round. The monk may use this ability to add magical weapon qualities to improvised weapons that could not normally have such a quality, such as adding the _ [disruption](../../magicItems/weapons#_weapons-disruption)_ quality to a slashing weapon, or the _ [vorpal](../../magicItems/weapons#_vorpal)_ quality to a bludgeoning weapon. This ability replaces purity of body and diamond body.
...
**Learned Master (Ex)** : At 17th level, a monk of the lotus gains all [Knowledge](../../skills/knowledge#_knowledge) skills and the [Linguistics](../../skills/linguistics#_linguistics) skill as class skills. The monk uses Wisdom instead of Intelligence as the key ability for these skills. This ability replaces tongue of the sun and the moon.
...
**_Ki Focus_ Bow (Su)** : At 17th level, as long as he has at least 1 point of _ki_ in his _ki_ pool, a zen archer may treat arrows fired from his bow as if they were _ [ki focus](../../magicItems/weapons#_weapons-ki-focus)_ weapons, allowing him to use his special _ki_ attacks as if his arrows were unarmed attacks. This ability replaces tongue of the sun and moon.

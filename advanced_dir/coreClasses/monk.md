---
title: advanced/coreClasse_dir/monk
---
# Monk
...
**_Ki_ Mystic (Su)** : At 3rd level, a _ki _mystic gains a pool of _ki_ points equal to his Wisdom modifier. The pool increases to 1/2 his monk level + his Wisdom modifier + 2 at level 4. If the monk has at least 1 point of _ki_ in his _ki_ pool, he gains a +2 bonus on all [Knowledge](../../skill_dir/knowledge#_knowledge) skill checks. As a swift action, the monk can spend 1 _ki_ point immediately before making an ability, or skill check to gain a +4 insight bonus on the check. This ability replaces still mind.
...
**Mystic Visions (Su** : At 11th level, a _ki _mystic may receive mystic visions when he rests. These visions can come as a dream, an epiphany, or even as the voice of an old friend whispering in the monk's mind. The effect is similar to a _ [divination](../../spell_dir/divination#_divination _spell with a caster level equal to the monk's level. The _ [divination](../../spell_dir/divination#_divination)_ has no casting time; it is just part of the normal dreams or visions that occur every night. Using this ability costs 2 _ki_ points that are removed from the next day's total. This ability replaces diamond body.
...
**_Ki_ Weapons (Su)** : At 5th level, a monk of the empty hand may spend 1 point from his _ki_ pool as a swift action to deal damage equal to his unarmed strike damage with an improvised weapon for 1 round. At 11th level, the monk may spend _ki_ to grant an enhancement bonus or magical weapon abilities to an improvised weapon for 1 round, at the rate of 1 point of _ki_ per +1 bonus or its equivalent. The monk may not spend more than 3 points of _ki_ at one time for this purpose. For example, a monk can spend 2 points of _ki_ to give his improvised weapon a +1 enhancement bonus and the _ [ki focus](../../magicItem_dir/weapons#_weapons-ki-focus_ quality, or just the _ [flaming burst](../../magicItem_dir/weapons#_weapons-flaming-burst_ quality. At 15th level, the limit increases to 5 _ki_ per round. The monk may use this ability to add magical weapon qualities to improvised weapons that could not normally have such a quality, such as adding the _ [disruption](../../magicItem_dir/weapons#_weapons-disruption_ quality to a slashing weapon, or the _ [vorpal](../../magicItem_dir/weapons#_vorpal_ quality to a bludgeoning weapon. This ability replaces purity of body and diamond body.
...
**_Ki_ Sacrifice (Su** : At 11th level, a monk of the healing hand can use his entire _ki_ pool to bring a person back to life. It takes 1 hour to perform this ritual. At the end of the ritual, the monk sacrifices all of his_ ki _in order to cast _ [raise dead](../../spell_dir/raiseDead#_raise-dead)_ (as the spell with a caster level equal to his monk level. The ritual uses all of the _ki_ in the monk's _ki_ pool; the monk must have at least 6 points of _ki_ in his _ki_ pool to use this ability. At 15th level, the monk may sacrifice his _ki_ to cast _ [resurrection](../../spell_dir/resurrection#_resurrection)_. The monk must have at least 8 points of _ki_ in his _ki_ pool to use this ability. These rituals do not require material components. When this ability is used, the monk's _ki_ pool is not replenished until 24 hours have passed. This ability replaces both diamond body and quivering palm.

**True Sacrifice (Su** : At 20th level, in a final selfless act, a monk of the healing hand can draw in his entire _ki_, which then explodes outward in a 50-foot-radius emanation. All dead allies within the emanation are brought back to life, as if they were the subject of a _ [true resurrection](../../spell_dir/trueResurrection#_true-resurrection_ spell with a caster level equal to the monk's level. When the monk does this, he is truly and utterly destroyed. A monk destroyed in this way can never come back to life, not even by way of a _ [wish](../../spell_dir/wish#_wish_ or _ [miracle](../../spell_dir/miracle#_miracle_ spell or by the power of a deity. Furthermore, the monk's name can never be spoken or written down again. All written mentions of his name become nothing more than a blank space. This ability replaces perfect self.
...
**Learned Master (Ex** : At 17th level, a monk of the lotus gains all [Knowledge](../../skill_dir/knowledge#_knowledge skills and the [Linguistics](../../skill_dir/linguistics#_linguistics) skill as class skills. The monk uses Wisdom instead of Intelligence as the key ability for these skills. This ability replaces tongue of the sun and the moon.
...
**_Ki_ Pool (Su)** : At 4th level, in addition to the normal abilities of his _ki_ pool, a zen archer may spend 1 point from his _ki_ pool to increase the range increment for his bow by 50 feet for 1 round.
...
**_Ki Focus_ Bow (Su)** : At 17th level, as long as he has at least 1 point of _ki_ in his _ki_ pool, a zen archer may treat arrows fired from his bow as if they were _ [ki focus](../../magicItem_dir/weapons#_weapons-ki-focus_ weapons, allowing him to use his special _ki_ attacks as if his arrows were unarmed attacks. This ability replaces tongue of the sun and moon.

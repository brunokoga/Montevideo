---
title: advance_dir/coreClasses/druid
---
# Druid
...
**Deep Diver (Ex)** : At 13th level, an aquatic druid gains DR/slashing or piercing equal to 1/2 her level. This damage reduction also applies against spells and spell-like abilities that inflict damage by grappling or crushing (e.g., _ [black tentacles](../../spell_dir/blackTentacles#_black-tentacles)_, _ [crushing hand](../../spell_dir/crushingHand#_crushing-hand)_). She never takes pressure damage from deep water. This ability replaces a thousand faces.
...
**Snowcaster (Su)** : At 9th level, an arctic druid can see normally in _ [ice storm](../../spell_dir/iceStorm#_ice-storm)_, _ [sleet storm](../../spell_dir/sleetStorm#_sleet-storm)_, or similar natural snowstorms. In addition, she can prepare any druid spell with the fire subtype as a cold spell, with an identical effect but inflicting cold damage instead of fire damage. This ability replaces venom immunity.

**Flurry Form (Ex)** : At 13th level, an arctic druid can assume the form of a swirling column of snow equivalent to _ [gaseous form](../../spell_dir/gaseousForm#_gaseous-form)_ at will. While in this form, she gains a circumstance bonus on [Stealth](../../skill_dir/stealth#_stealth) checks made in cold terrain equal to her druid level. This ability replaces a thousand faces.
...
**Desert Endurance (Ex)** : At 4th level, a desert druid ignores the effects of a hot climate as if using _ [endure elements](../../spell_dir/endureElements#_endure-elements)_. She also has a reduced need to eat and drink, as if wearing a _ [ring of sustenance](../../magicItem_dir/rings#_ring-of-sustenance)_ (though normal sleep is still required). This ability replaces resist nature's lure.
...
**Dunemeld (Ex)** : At 13th level, a desert druid can assume the form of a swirling mass of sand at will. This is equivalent to _ [gaseous form](../../spell_dir/gaseousForm#_gaseous-form)_, but the druid gains a land and burrow speed of 10 feet rather than a fly speed. While in this form, the druid gains a circumstance bonus on [Stealth](../../skill_dir/stealth#_stealth) checks made in desert terrain equal to her druid level. This ability replaces a thousand faces.

---
layout: default
title: advance_dir/coreClasses/rogue
---
# Rogue
...
_Canny Observer (Ex)_: When a rogue with this talent makes a [Perception](../../skill_dir/perception#_perception) check to hear the details of a conversation or to find concealed or secret objects (including doors and traps), she gains a +4 bonus.

_Charmer (Ex)_: Once per day, the rogue can roll two dice while making a [Diplomacy](../../skill_dir/diplomacy#_diplomacy) check, and take the better result. She must choose to use this talent before making the [Diplomacy](../../skill_dir/diplomacy#_diplomacy) check. A rogue can use this ability one additional time per day for every 5 rogue levels she possesses.

_Coax Information (Ex)_: A rogue with this talent can use [Bluff](../../skill_dir/bluff#_bluff) or [Diplomacy](../../skill_dir/diplomacy#_diplomacy) in place of [Intimidate](../../skill_dir/intimidate#_intimidate) to force an opponent to act friendly toward her.
...
_Fast Getaway (Ex)_: After successfully making a sneak attack or [Sleight of Hand](../../skill_dir/sleightOfHand#_sleight-of-hand) check, a rogue with this talent can spend a move action to take the withdraw action. She can move no more than her speed during this movement.

_Fast Picks (Ex)_: A rogue with this talent can use the [Disable Device](../../skill_dir/disableDevice#_disable-device) skill to attempt to open a lock as a standard action instead of a full-round action.

_Follow Clues (Ex)_: A rogue with this talent can use [Perception](../../skill_dir/perception#_perception) to follow tracks as per the [Survival](../../skill_dir/survival#_survival) skill.
...
_Honeyed Words (Ex)_: Once per day, the rogue can roll two dice while making a [Bluff](../../skill_dir/bluff#_bluff) check, and take the better result. She must choose to use this talent before making the Bluff check. A rogue can use this ability one additional time per day for every five rogue levels she possesses.
...
_Quick Disguise (Ex)_: A rogue with this talent can use the items at hand and seemingly innocuous material hidden on her person to create startlingly effective disguises, reducing the amount of time it takes to create a disguise using the [Disguise](../../skill_dir/disguise#_disguise) skill.
...
_Fast Tumble (Ex)_: When a rogue with this talent uses [Acrobatics](../../skill_dir/acrobatics#_acrobatics) to move at full speed through a threatened square without provoking an attack of opportunity, the DC of the [Acrobatics](../../skill_dir/acrobatics#_acrobatics) check does not increase by 10.
...
_Stealthy Sniper (Ex)_: When a rogue with this talent uses the [Stealth](../../skill_dir/stealth#_stealth) skill to snipe, she only suffers a –10 penalty on the [Stealth](../../skill_dir/stealth#_stealth) check, instead of –20.

...
_Camouflage (Ex)_: Once per day, a rogue with this talent can craft simple but effective camouflage from the surrounding foliage. The rogue needs 1 minute to prepare the camouflage, but once she does, it is good for the rest of the day or until the rogue fails a saving throw against an area effect spell that deals fire, cold, or acid damage, whichever comes first. The rogue gains a +4 bonus on [Stealth](../../skills/stealth.md#_stealth) checks while within terrain that matches the foliage used to make the camouflage. This ability cannot be used in areas without natural foliage.

_Canny Observer (Ex)_: When a rogue with this talent makes a [Perception](../../skills/perception.md#_perception) check to hear the details of a conversation or to find concealed or secret objects (including doors and traps), she gains a +4 bonus.

_Charmer (Ex)_: Once per day, the rogue can roll two dice while making a [Diplomacy](../../skills/diplomacy.md#_diplomacy) check, and take the better result. She must choose to use this talent before making the [Diplomacy](../../skills/diplomacy.md#_diplomacy) check. A rogue can use this ability one additional time per day for every 5 rogue levels she possesses.

_Coax Information (Ex)_: A rogue with this talent can use [Bluff](../../skills/bluff.md#_bluff) or [Diplomacy](../../skills/diplomacy.md#_diplomacy) in place of [Intimidate](../../skills/intimidate.md#_intimidate) to force an opponent to act friendly toward her.

_Combat Swipe_: A rogue who selects this talent gains [Improved Steal](../advancedFeats.md#_improved-steal-(combat)) as a bonus feat.
...
_Expert Leaper (Ex)_: When making jump checks, the rogue is always considered to have a running start. Also, when the rogue deliberately falls, a DC 15 [Acrobatics](../../skills/acrobatics.md#_acrobatics) check allows her to ignore the first 20 feet fallen, instead of the first 10 feet.

_Fast Fingers (Ex)_: Once per day, a rogue with this talent can roll two dice while making a [Sleight of Hand](../../skills/sleightOfHand.md#_sleight-of-hand) check and take the better result. She must choose to use this talent before making the [Sleight of Hand](../../skills/sleightOfHand.md#_sleight-of-hand) check. A rogue can use this ability one additional time per day for every 5 rogue levels she possesses.

_Fast Getaway (Ex)_: After successfully making a sneak attack or [Sleight of Hand](../../skills/sleightOfHand.md#_sleight-of-hand) check, a rogue with this talent can spend a move action to take the withdraw action. She can move no more than her speed during this movement.

_Fast Picks (Ex)_: A rogue with this talent can use the [Disable Device](../../skills/disableDevice.md#_disable-device) skill to attempt to open a lock as a standard action instead of a full-round action.

_Follow Clues (Ex)_: A rogue with this talent can use [Perception](../../skills/perception.md#_perception) to follow tracks as per the [Survival](../../skills/survival.md#_survival) skill.

_Guileful Polyglot (Ex)_: A rogue with this talent who has at least one rank in [Linguistics](../../skills/linguistics.md#_linguistics) gains four additional languages. A rogue with this talent who does not have any ranks in [Linguistics](../../skills/linguistics.md#_linguistics) gains two additional languages. If the rogue later gains ranks in [Linguistics](../../skills/linguistics.md#_linguistics), she gains two additional languages, to a total of four additional languages above those granted by the [Linguistics](../../skills/linguistics.md#_linguistics) skill itself.

_Hard to Fool (Ex)_: Once per day, a rogue with this talent can roll two dice while making a [Sense Motive](../../skills/senseMotive.md#_sense-motive) check, and take the better result. She must choose to use this talent before making the [Sense Motive](../../skills/senseMotive.md#_sense-motive) check. A rogue can use this ability one additional time per day for every 5 rogue levels she possesses.

_Honeyed Words (Ex)_: Once per day, the rogue can roll two dice while making a [Bluff](../../skills/bluff.md#_bluff) check, and take the better result. She must choose to use this talent before making the Bluff check. A rogue can use this ability one additional time per day for every five rogue levels she possesses.
...
_Peerless Maneuver (Ex)_: Once per day, a rogue with this talent can roll two dice while making an [Acrobatics](../../skills/acrobatics.md#_acrobatics) check, and take the better result. She must choose to use this talent before making the [Acrobatics](../../skills/acrobatics.md#_acrobatics) check. A rogue can use this ability one additional time per day for every 5 rogue levels she possesses.
...
_Quick Disguise (Ex)_: A rogue with this talent can use the items at hand and seemingly innocuous material hidden on her person to create startlingly effective disguises, reducing the amount of time it takes to create a disguise using the [Disguise](../../skills/disguise.md#_disguise) skill.
...
| [Disguise](../../skills/disguise.md#_disguise) as a different gender | 1 minute |
| [Disguise](../../skills/disguise.md#_disguise) as a different race | 1 minute |
| [Disguise](../../skills/disguise.md#_disguise) as a different age category | 1 minute |
| [Disguise](../../skills/disguise.md#_disguise) as a different size category | 1 minute |
...
_Strong Impression_: A rogue who selects this talent gains [Intimidating Prowess](../../feats.md#_intimidating-prowess) as a bonus feat.

_Survivalist_: A rogue with this talent adds [Heal](../../skills/heal.md#_heal) and [Survival](../../skills/survival.md#_survival) to her list of class skills.
...
_Fast Tumble (Ex)_: When a rogue with this talent uses [Acrobatics](../../skills/acrobatics.md#_acrobatics) to move at full speed through a threatened square without provoking an attack of opportunity, the DC of the [Acrobatics](../../skills/acrobatics.md#_acrobatics) check does not increase by 10.
...
_Master of Disguise (Ex)_: Once per day, a rogue with this talent gains a +10 bonus on a single [Disguise](../../skills/disguise.md#_disguise) check.
...
_Stealthy Sniper (Ex)_: When a rogue with this talent uses the [Stealth](../../skills/stealth.md#_stealth) skill to snipe, she only suffers a –10 penalty on the [Stealth](../../skills/stealth.md#_stealth) check, instead of –20.

_Thoughtful Reexamining (Ex)_: Once per day, a rogue with this talent can reroll a [Knowledge](../../skills/knowledge.md#_knowledge), [Sense Motive](../../skills/senseMotive.md#_sense-motive), or [Perception](../../skills/perception.md#_perception) skill check to try to gain new or better information from the roll. This reroll can be made any time during the same day as the original check.
...
**Expert Acrobat (Ex)** : At 1st level, an acrobat does not suffer any armor check penalties on [Acrobatics](../../skills/acrobatics.md#_acrobatics), [Climb](../../skills/climb.md#_climb), [Fly](../../skills/fly.md#_fly), [Sleight of Hand](../../skills/sleightOfHand.md#_sleight-of-hand), or [Stealth](../../skills/stealth.md#_stealth) skill checks while wearing light armor. When she is not wearing armor, she gains a +2 competency bonus on [Acrobatics](../../skills/acrobatics.md#_acrobatics) and [Fly](../../skills/fly.md#_fly) skill checks. This ability replaces trapfinding.

**Second Chance (Ex)** : At 3rd level, an acrobat can reroll any [Acrobatics](../../skills/acrobatics.md#_acrobatics), [Climb](../../skills/climb.md#_climb), or [Fly](../../skills/fly.md#_fly) skill check she has just made. This reroll is made at a –5 penalty. She must take the second result, even if it is worse. An acrobat can use this ability only once on any given skill check. She can use this ability once per day at 3rd level, plus one additional time per day for every 3 levels beyond 3rd. This ability replaces trap sense.
...
**Careful Disarm (Ex)** : At 4th level, whenever a burglar attempts to disarm a trap using [Disable Device](../../skills/disableDevice.md#_disable-device), she does not spring the trap unless she fails by 10 or more. If she does set off a trap she was attempting to disarm, she adds double her trap sense bonus to avoid the trap. This ability replaces uncanny dodge.

**Distraction (Ex)** : At 8th level, whenever a burglar is detected while using [Stealth](../../skills/stealth.md#_stealth), she can immediately attempt a [Bluff](../../skills/bluff.md#_bluff) skill check opposed by the [Sense Motive](../../skills/senseMotive.md#_sense-motive) skill of the creature that spotted her. If this check succeeds, the target assumes that the noise was something innocent and disregards the detection. This only functions if the creature cannot see the rogue. This ability can only be used once during a given [Stealth](../../skills/stealth.md#_stealth) attempt. If the same creature detects the rogue's presence again, the ability has no effect. This ability replaces improved uncanny dodge.
...
**Measure the Mark (Ex)** : When a cutpurse makes a [Sleight of Hand](../../skills/sleightOfHand.md#_sleight-of-hand) check to take something from a creature, the target makes its [Perception](../../skills/perception.md#_perception) check before the rogue makes her [Sleight of Hand](../../skills/sleightOfHand.md#_sleight-of-hand) check, and the rogue knows the [Perception](../../skills/perception.md#_perception) check result. She can decide whether or not to make the check based on the results of the target's [Perception](../../skills/perception.md#_perception) check. If the rogue elects not to make the check, she can make a [Bluff](../../skills/bluff.md#_bluff) check, opposed by the target's [Sense Motive](../../skills/senseMotive.md#_sense-motive), to prevent the target from noticing the attempt. This ability replaces trapfinding.

**Stab and Grab (Ex)** : At 3rd level, as a full-round action, a cutpurse can make an attack and also make a [Sleight of Hand](../../skills/sleightOfHand.md#_sleight-of-hand) check to steal something from the target of the attack. If the attack deals sneak attack damage, the rogue can use [Sleight of Hand](../../skills/sleightOfHand.md#_sleight-of-hand) to take an item from the creature during combat; otherwise this ability can only be used in a surprise round before the target has acted. If the attack is successful, the target takes a –5 penalty on the [Perception](../../skills/perception.md#_perception) check to notice the theft. This ability replaces trap sense.
...
**Master Poisoner (Ex)** : At 3rd level, a poisoner can use [Craft](../../skills/craft.md#_craft) (alchemy) to change the type of a poison. This requires 1 hour of work with an alchemist's lab and a [Craft](../../skills/craft.md#_craft) (alchemy) skill check with a DC equal to the poison's DC. If successful, the poison's type changes to contact, ingested, inhaled, or injury. If the check fails, the poison is ruined. The poisoner also receives a bonus on [Craft](../../skills/craft.md#_craft) (alchemy) skill checks when working with poison equal to 1/2 her rogue level. This ability replaces trap sense.
...
**Bravado's Blade (Ex)** : When a rake hits an opponent and deals sneak attack damage, she can forgo 1d6 points of that damage and make a free [Intimidate](../../skills/intimidate.md#_intimidate) check to demoralize the foe. For every additional 1d6 points of sneak attack damage she forgoes, she receives a +5 circumstance bonus on this check. This ability replaces trapfinding.

**Rake's Smile (Ex)** : At 3rd level, a rake gains a +1 morale bonus on [Bluff](../../skills/bluff.md#_bluff) and [Diplomacy](../../skills/diplomacy.md#_diplomacy) checks. This bonus increases by +1 for every 3 levels beyond 3rd. This ability replaces trap sense.
...
**Skilled Liar (Ex)** : Whenever a spy uses [Bluff](../../skills/bluff.md#_bluff) to attempt to deceive someone, she gains a bonus on the opposed roll equal to 1/2 her rogue level (minimum +1). This bonus does not apply to feint attempts or attempts to pass secret messages. This ability replaces trapfinding.
...
**Daring (Ex)** : At 3rd level, a swashbuckler gains a +1 morale bonus on [Acrobatics](../../skills/acrobatics.md#_acrobatics) checks and saving throws against fear. This bonus increases by +1 for every 3 levels beyond 3rd. This ability replaces trap sense.
...
**Frightening (Ex)** : Whenever a thug successfully uses [Intimidate](../../skills/intimidate.md#_intimidate) to demoralize a creature, the duration of the shaken condition is increased by 1 round. In addition, if the target is shaken for 4 or more rounds, the thug can instead decide to make the target frightened for 1 round. This ability replaces trapfinding.
...
**Trap Master (Ex)** : At 8th level, whenever a trapsmith disarms a trap using [Disable Device](../../skills/disableDevice.md#_disable-device), she can bypass it even if her check did not exceed the DC by 10 or more. If it is a magic trap that allows specific creatures to pass it without danger, she can modify which creatures it allows to pass, adding her allies and restricting enemies if she desires. This ability replaces improved uncanny dodge.

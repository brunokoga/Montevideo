...
_Protective Aura (Su)_: At 8th level, you can emit a 30-foot protective aura as a standard action. Allies in this aura receive a +2 deflection bonus to AC and a +2 resistance bonus on all saving throws. In addition, allies in the area gain the benefits of _ [protection from evil](../../spells/protectionFromEvil#_protection-from-evil)_ (although the AC bonus and saving throw bonus do not stack with those granted by this effect). You can use this ability for a number of rounds per day equal to your cleric level. These rounds do not have to be consecutive.

**Replacement Domain Spells** : 1st—_ [shield of faith](../../spells/shieldOfFaith#_shield-of-faith)_, 3rd—_ [tongues](../../spells/tongues#_tongues)_, 6th—_ [planar ally](../../spells/planarAlly#_planar-ally) _(agathions only).
...
_Speak With Dead (Su)_: At 8th level, as a standard action, you can ask one question of a dead creature as if using _ [speak with dead](../../spells/speakWithDead#_speak-with-dead)_. The dead creature you are questioning does not gain a Will saving throw if your alignments are different. You can use this ability a number of times per day equal to your cleric level.

**Replacement Domain Spells** : 4th—_ [rest eternal](../spells/restEternal#_rest-eternal)_\*, 6th—_ [geas/quest](../../spells/geasQuest#_geas-quest)_.
...
**Replacement Domain Spells** : 1st level—_ [magic aura](../../spells/magicAura#_magic-aura)_, 4th—_ [arcane eye](../../spells/arcaneEye#_arcane-eye)_, 6th—_ [analyze dweomer](../../spells/analyzeDweomer#_analyze-dweomer)_.

## Archon Subdomain

**Associated Domains** : Good, Law.

**Replacement Power** : The following granted power replaces the holy lance power of the Good domain or the staff of order power of the Law domain. [Archons](../../monsters/archon) are a race of lawful good outsiders.
...
**Replacement Domain Spells** : 1st—_ [divine favor](../../spells/divineFavor#_divine-favor)_, 3rd—_ [prayer](../../spells/prayer#_prayer)_, 6th—_ [planar ally](../../spells/planarAlly#_planar-ally) _(archon only).
...
**Replacement Domain Spells** : 7th—_ [disintegrate](../../spells/disintegrate#_disintegrate)_, 9th—_ [fiery body](../spells/fieryBody#_fiery-body)_\*.

## Azata Subdomain

**Associated Domains** : Chaos, Good.

**Replacement Power** : The following granted power replaces the touch of chaos power of the Chaos domain or the touch of good power of the Good domain. [Azatas](../../monsters/azata) are a race of chaotic good outsiders.
...
**Replacement Domain Spells** : 1st—_ [expeditious retreat](../../spells/expeditiousRetreat#_expeditious-retreat)_, 3rd—_ [fly](../../spells/fly)_, 6th—_ [planar ally](../../spells/planarAlly#_planar-ally) _(azata only).
...
_ [Wounding](../../magicItems/weapons#_wounding) Blade (Su)_: At 8th level, you can give a weapon that you touch the _ [wounding](../../magicItems/weapons#_wounding)_ special weapon quality for a number of rounds equal to 1/2 your cleric level. You can use this ability once per day at 8th level, and an additional time per day for every four levels beyond 8th.

**Replacement Domain Spells** : 3rd—_ [vampiric touch](../../spells/vampiricTouch#_vampiric-touch)_, 5th—_ [wall of thorns](../../spells/wallOfThorns#_wall-of-thorns)_, 7th—_ [inflict serious wounds (mass)](../../spells/inflictSeriousWounds#_inflict-serious-wounds-mass)_.
...
_Tunnel Runner (Su)_: At 8th level, you can move through tunnels and caves with ease. Activating this ability is a standard action. You can move across any stone surface as if under the effects of _ [spider climb](../../spells/spiderClimb#_spider-climb)_. You can also see very well in darkness, gaining darkvision out to a range of 60 feet. If you already possess darkvision, extend the range by 60 feet. While underground, you also gain an insight bonus equal to your cleric level on [Stealth](../../skills/stealth#_stealth) skill checks and an insight bonus equal to your Wisdom modifier on initiative checks. You can use this ability for 1 minute per day per cleric level you possess. These minutes do not need to be consecutive, but they must be spent in 1-minute increments.

**Replacement Domain Spells** : 2nd—_ [create pit\*](../spells/createPit#_create-pit-)_, 3rd—_ [spiked pit](../spells/spikedPit#_spiked-pit)_\*, 6th—_ [hungry pit\*](../spells/hungryPit#_hungry-pit-)_.
...
_Thundercloud (Su)_: At 8th level, you can, as a standard action, summon a storm cloud. This power functions as _ [fog cloud](../../spells/fogCloud)_ except that creatures inside the cloud are deafened and take 2d6 points of electricity damage each round from the flashes of thunder and lightning. Once created, you can concentrate on the cloud to move it up to 30 feet each round. You can use this ability for a number of rounds per day equal to your cleric level. These rounds do not need to be consecutive.

**Replacement Domain Spells** : 4th—_ [solid fog](../../spells/solidFog#_solid-fog)_, 9th—_ [storm of vengeance](../../spells/stormOfVengeance#_storm-of-vengeance)_.
...
_Animate Servant (Su)_: At 8th level, as a standard action, you can give life to inanimate objects. This ability functions as _ [animate objects](../../spells/animateObjects#_animate-objects)_ using your cleric level as the caster level. You can use this ability once per day at 8th level, and one additional time per day for every four levels beyond 8th.

**Replacement Domain Spells** : 7th—_ [limited wish](../../spells/limitedWish#_limited-wish)_, 8th—_ [polymorph any object](../../spells/polymorphAnyObject#_polymorph-any-object)_.
...
**Replacement Domain Spells** : 1st level—_ [bane](../../magicItems/weapons#_weapons-bane)_, 3rd—_ [bestow curse](../../spells/bestowCurse#_bestow-curse)_, 6th—_ [eyebite](../../spells/eyebite#_eyebite)._
...
**Replacement Domain Spells** : 1st—_ [cause fear](../../spells/causeFear#_cause-fear)_, 3rd—_ [vampiric touch](../../spells/vampiricTouch#_vampiric-touch)_, 6th—_ [planar binding](../../spells/planarBinding#_planar-binding) _(daemons only).
...
**Replacement Domain Spells** : 2nd level—_ [continual flame](../../spells/continualFlame#_continual-flame)_, 3rd—_ [daylight](../../spells/daylight#_daylight)._
...
**Replacement Domain Spells** : 3rd—_ [contagion](../../spells/contagion#_contagion)_, 4th—_ [poison](../../spells/poison#_poison)_, 6th—_ [harm](../../spells/harm#_harm)._
...
**Replacement Domain Spells** : 2nd—_ [mirror image](../../spells/mirrorImage#_mirror-image)_, 7th—_ [project image](../../spells/projectImage#_project-image)_.
...
_ [Deflection](../spells/deflection#_deflection-) Aura (Su)_: Once each day, you can emit a 20-foot aura for a number of rounds equal to your cleric level. Allies within the aura gain a +2 deflection bonus to AC and combat maneuver defense.

**Replacement Domain Spells** : 1st—_ [shield](../../spells/shield#_shield)_, 2nd—_ [barkskin](../../spells/barkskin#_barkskin)_, 7th—_ [deflection](../spells/deflection#_deflection-)_\*_._

## Demon Subdomain

**Associated Domains** : Chaos, Evil.

**Replacement Power** : The following granted power replaces the touch of chaos power of the Chaos domain or the touch of evil power of the Evil domain. [Demons](../../monsters/demon) are a race of chaotic evil outsiders.
...
**Replacement Domain Spells** : 1st—_ [doom](../../spells/doom#_doom)_, 3rd—_ [rage](../../spells/rage#_rage)_, 6th—_ [planar binding](../../spells/planarBinding#_planar-binding) _(demons only).

## Devil Subdomain

**Associated Domains** : Evil, Law.

**Replacement Power** : The following granted power replaces the touch of evil power of the Evil domain or the touch of law power of the Law domain. [Devils](../../monsters/devil) are a race of lawful evil outsiders.
...
**Replacement Domain Spells** : 1st—_ [command](../../spells/command#_command)_, 3rd—_ [suggestion](../../spells/suggestion#_suggestion)_, 6th—_ [planar binding](../../spells/planarBinding#_planar-binding) _(devils only).
...
**Replacement Domain Spells** : 2nd level—_ [bless water](../../spells/blessWater#_bless-water)_, 5th—_ [cleanse\*](../spells/cleanse#_cleanse)_, 7th—_ [resurrection](../../spells/resurrection#_resurrection)_, 9th_— [miracle](../../spells/miracle#_miracle)._
...
**Replacement Domain Spells** : 1st—_ [expeditious retreat](../../spells/expeditiousRetreat#_expeditious-retreat)_, 4th—_ [locate creature](../../spells/locateCreature#_locate-creature)_, 9th—_ [world wave\*](../spells/worldWave#_world-wave-)._
...
**Replacement Domain Spells** : 2nd—_ [augury](../../spells/augury#_augury)_, 3rd—_ [borrow fortune](../spells/borrowFortune#_borrow-fortune)_\*.

## Feather Subdomain

**Associated Domain** : Animal.

Add [Fly](../../skills/fly#_fly) to your list of class skills. In addition, whenever you cast a spell that grants you a fly speed, your maneuverability increases by one step (up to perfect).

**Replacement Power** : The following granted power replaces the speak with animals power of the Animal domain.

_Eyes of the Hawk (Ex)_: You gain a racial bonus on [Perception](../../skills/perception#_perception) checks equal to 1/2 your cleric level (minimum +1). In addition, if you can act during a surprise round, you receive a +2 racial bonus on your Initiative check.

**Replacement Domain Spells** : 2nd—_ [feather fall](../../spells/featherFall#_feather-fall)_, 3rd—_ [fly](../../spells/fly)_, 6th—_ [fly (mass)\*](../spells/fly#_fly,-mass)_.
...
**Replacement Domain Spells** : 3rd—_ [rage](../../spells/rage#_rage)_, 6th—_ [bull's strength (mass)](../../spells/bullSStrength#_bull-s-strength-mass)._
...
**Replacement Domain Spells** : 1st—_ [sanctuary](../../spells/sanctuary#_sanctuary)_, 5th—_ [plane shift](../../spells/planeShift#_plane-shift)_.
...
_Predator's [Grace](../spells/grace#_grace) (Su)_: You can, as a swift action, grant yourself a +10-foot bonus to your base speed for 1 round. This bonus increases by 5 feet for every 5 cleric levels you possess. In addition, you gain low-light vision for 1 round. If you already possess low-light vision, the range of your sight becomes three times that of a human in dim light for 1 round. You can use this ability a number of times per day equal to 3 + your Wisdom modifier.

**Replacement Domain Spells** : 1st—_ [magic fang](../../spells/magicFang#_magic-fang)_, 3rd—_ [beast shape I](../../spells/beastShape#_beast-shape-i) _(animals only).
...
_Enlarge (Su)_: As a swift action you can enlarge yourself for 1 round, as if you were the target of the _ [enlarge person](../../spells/enlargePerson#_enlarge-person)_ spell. You can use this ability a number of times per day equal to 3 + your Wisdom modifier.

**Replacement Domain Spells** : 1st—_ [enlarge person](../../spells/enlargePerson#_enlarge-person)_, 5th—_ [righteous might](../../spells/righteousMight#_righteous-might)._
...
**Replacement Domain Spells** : 3rd—_ [heroism](../../spells/heroism#_heroism)_, 6th—_ [heroism (greater)](../../spells/heroism#_heroism-greater)_.
...
**Replacement Domain Spells** : 1st—_ [alarm](../../spells/alarm#_alarm)_, 3rd—_ [glyph of warding](../../spells/glyphOfWarding#_glyph-of-warding)_, 7th—_ [guards and wards](../../spells/guardsAndWards#_guards-and-wards)_.
...
**Replacement Domain Spells** : 2nd—_ [zone of truth](../../spells/zoneOfTruth#_zone-of-truth)_, 6th—_ [geas/quest](../../spells/geasQuest#_geas-quest)._
...
**Replacement Domain Spells** : 7th—_ [freezing sphere](../../spells/freezingSphere#_freezing-sphere)_, 9th—_ [polar ray](../../spells/polarRay#_polar-ray)_.
...
_ [Command](../../spells/command#_command) (Su)_: As a standard action, you can give a creature an emotionless yet undeniable order, as per the spell _ [command](../../spells/command#_command)_. A Will save negates this effect. You cannot target a creature more than once per day with this ability. You can use this ability a number of times per day equal to 3 + your Wisdom modifier.

**Replacement Domain Spells** : 3rd—_ [command undead](../../spells/commandUndead#_command-undead)_, 5th—_ [command (greater)](../../spells/command#_command-greater)_, 6th—_ [planar binding](../../spells/planarBinding#_planar-binding)_ (inevitables only).
...
**Replacement Domain Spells** : 4th—_ [moonstruck](../spells/moonstruck#_moonstruck)_\*, 6th—_ [phantasmal web](../spells/phantasmalWeb#_phantasmal-web)_\*_._
...
**Replacement Domain Spells** : 1st—_ [comprehend languages](../../spells/comprehendLanguages#_comprehend-languages)_, 2nd—_ [share language](../spells/shareLanguage#_share-language-)_\*, 3rd—_ [tongues](../../spells/tongues#_tongues)_, 5th_— [telepathic bond](../../spells/telepathicBond#_telepathic-bond)._
...
**Replacement Domain Spells** : 5th—_ [enervation](../../spells/enervation#_enervation)_, 6th—_ [modify memory](../../spells/modifyMemory#_modify-memory)_, 9th—_ [energy drain](../../spells/energyDrain#_energy-drain)_.
...
_Adoration (Su)_: As an immediate action, you can attempt to thwart a melee or ranged attack that targets you. This ability functions as _ [sanctuary](../../spells/sanctuary#_sanctuary)_, but only against one individual attack. You must use the ability after the attack is declared but before the roll is made. The creature attacking you receives a Will save to negate this effect. If a creature has more than one attack, this ability only affects one of the attacks. You can use the ability a number of times per day equal to 3 + your Wisdom modifier. This is a mind-affecting effect.

**Replacement Domain Spells** : 2nd—_ [enthrall](../../spells/enthrall#_enthrall)_, 8th—_ [euphoric tranquility](../spells/euphoricTranquility#_euphoric-tranquility)_\*.
...
**Replacement Domain Spells** : 2nd—_ [touch of idiocy](../../spells/touchOfIdiocy#_touch-of-idiocy)_, 4th—_ [confusion](../../spells/confusion#_confusion)_.
...
**Replacement Domain Spells** : 2nd—_ [shield other](../../spells/shieldOther#_shield-other)_, 6th—_ [sacrificial oath\*](../spells/sacrificialOath#_sacrificial-oath)._

## Memory Subdomain

**Associated Domain** : [Knowledge](classes/cleric#_knowledge-domain).

**Replacement Power** : The following granted power replaces the lore keeper power of the [Knowledge](classes/cleric#_knowledge-domain) domain.
...
**Replacement Domain Spells** : 2nd—_ [memory lapse\*](../spells/memoryLapse#_memory-lapse)_, 6th—_ [modify memory](../../spells/modifyMemory#_modify-memory)_, 8th—_ [moment of prescience](../../spells/momentOfPrescience#_moment-of-prescience)_.
...
**Replacement Domain Spells** : 2nd—_ [heat metal](../../spells/heatMetal#_heat-metal)_, 6th—_ [wall of iron](../../spells/wallOfIron#_wall-of-iron)_, 8th—_ [iron body](../../spells/ironBody#_iron-body)._
...
**Replacement Domain Spells** : 3rd—_ [keen edge](../../spells/keenEdge#_keen-edge)_, 5th—_ [suffocation](../spells/suffocation#_suffocation)_\*, 9th—_ [suffocation (mass)\*](../spells/suffocation#_suffocation,-mass)_.
...
_Night Hunter (Su)_: As a standard action, you can blend into the shadows of the night, becoming nearly invisible_._ As long as you are in an area of dim light or darkness, you are invisible (as per _ [invisibility](../../spells/invisibility#_invisibility)_) to creatures without darkvision. This ability lasts for a number of rounds equal to 1/2 your cleric level (minimum 1). You can use this ability for a number of times per day equal to 3 + your Wisdom modifier.

**Replacement Domain Spells** : 1st—_ [sleep](../../spells/sleep#_sleep)_, 6th—_ [nightmare](../../spells/nightmare#_nightmare)._
...
**Replacement Domain Spells** : 4th—_ [phantasmal killer](../../spells/phantasmalKiller#_phantasmal-killer)_, 6th—_ [cloak of dreams\*](../spells/cloakOfDreams)_, 9th—_ [weird](../../spells/weird)._
...
**Replacement Domain Spells** : 2nd—_ [slipstream\*](../spells/slipstream#_slipstream)_, 3rd—_ [water walk](../../spells/waterWalk#_water-walk), _9th—_ [tsunami\*](../spells/tsunami#_tsunami)._
...
**Replacement Domain Spells** : 1st—_ [confusion (lesser)](../../spells/confusion#_confusion-lesser)_, 3rd—_ [displacement](../../spells/displacement#_displacement)_, 6th—_ [planar binding](../../spells/planarBinding#_planar-binding) _(proteans only).
...
**Replacement Domain Spells** : 1st—_ [protection from chaos](../../spells/protectionFromChaos#_protection-from-chaos)/evil/good/law_, 3rd—_ [remove blindness/deafness](../../spells/removeBlindnessDeafness#_remove-blindness-deafness)_, 5th—_ [atonement](../../spells/atonement#_atonement)_.
...
**Replacement Domain Spells** : 1st—_ [bless](../../spells/bless#_bless)_, 6th—_ [heroes' feast](../../spells/heroesFeast#_heroes-feast)._
...
**Replacement Domain Spells** : 2nd—_ [remove disease](../../spells/removeDisease#_remove-disease)_, 4th—_ [neutralize poison](../../spells/neutralizePoison#_neutralize-poison)_, 5th—_ [break enchantment](../../spells/breakEnchantment#_break-enchantment)_.
...
**Replacement Domain Spells** : 5th—_ [raise dead](../../spells/raiseDead#_raise-dead)_, 7th—_ [resurrection](../../spells/resurrection#_resurrection)_, 9th—_ [true resurrection](../../spells/trueResurrection#_true-resurrection)_.
...
_Powerful Persuader (Su)_: At 8th level, when you make a [Diplomacy](../../skills/diplomacy#_diplomacy) or [Intimidate](../../skills/intimidate#_intimidate) check, you can roll twice and take the higher result. Using this ability is a free action. You can use this ability once per day at 8th level, plus one additional time per day for every 2 levels beyond 8th.

**Replacement Domain Spells** : 2nd—_ [enthrall](../../spells/enthrall#_enthrall)_, 6th—_ [symbol of persuasion](../../spells/symbolOfPersuasion#_symbol-of-persuasion)._
...
_Untouched by the Seasons (Su)_: By touching a creature, you can grant it the benefits of _ [endure elements](../../spells/endureElements#_endure-elements)_, which last for 1 hour per cleric level. You can use this ability a number of times per day equal to 3 + your Wisdom modifier.

**Replacement Domain Spells** : 1st—_ [goodberry](../../spells/goodberry#_goodberry)_, 4th—_ [blight](../../spells/blight#_blight)_, 8th—_ [sunburst](../../spells/sunburst#_sunburst)._
...
**Replacement Domain Spells** : 2nd—_ [pyrotechnics](../../spells/pyrotechnics#_pyrotechnics)_, 3rd—_ [stinking cloud](../../spells/stinkingCloud#_stinking-cloud)_.
...
**Replacement Domain Spells** : 3rd—_ [animate dead](../../spells/animateDead#_animate-dead)_, 6th—_antilife [shield](../../spells/shield#_shield), _9th—_ [trap the soul](../../spells/trapTheSoul#_trap-the-soul)._
...
**Replacement Domain Spells** : 5th—_ [call lightning storm](../../spells/callLightningStorm#_call-lightning-storm)_, 6th—_ [sirocco\*](../spells/sirocco#_sirocco)._
...
**Replacement Domain Spells** : 2nd—_ [aid](../../spells/aid#_aid)_, 5th—_ [command (greater)](../../spells/command#_command-greater)_, 8th—_ [planar ally (greater)](../../spells/planarAlly#_planar-ally-greater)_.
...
_Thief of the Gods (Su)_: At 8th level, when you make a [Disable Device](../../skills/disableDevice#_disable-device) or [Sleight of Hand](../../skills/sleightOfHand#_sleight-of-hand) check, you can roll twice and take the higher result. Using this ability is a free action. You can use this ability once per day at 8th level, plus one additional time per day for every 2 levels beyond 8th.

**Replacement Domain Spells** : 3rd—_ [locate object](../../spells/locateObject#_locate-object)_, 7th—_ [ethereal jaunt](../../spells/etherealJaunt#_ethereal-jaunt)_.

## Thought Subdomain

**Associated Domain** : [Knowledge](classes/cleric#_knowledge-domain).

**Replacement Power** : The following granted power replaces the remote viewing power of the [Knowledge](classes/cleric#_knowledge-domain) domain.

_Read Minds (Su)_: At 8th level, you can broaden your mental spectrum to encompass those around you. Doing so allows you to read the mind of every creature within 30 feet as if you had cast _ [detect thoughts](../../spells/detectThoughts#_detect-thoughts)_. This ability allows you to read the surface thoughts of any creature that you are aware of after only 1 round of concentration. Creatures in this area are allowed a Will save to negate the effect. The DC of this Will save is 10 + 1/2 your cleric level + your Wisdom modifier. You can use this ability for a number of rounds per day equal to your cleric level. These rounds do not need to be consecutive.

**Replacement Domain Spells** : 3rd—_ [seek thoughts\*](../spells/seekThoughts#_seek-thoughts)_, 5th—_ [telepathic bond](../../spells/telepathicBond#_telepathic-bond)_, 8th—_ [mind blank](../../spells/mindBlank#_mind-blank)_.
...
**Replacement Domain Spells** : 1st—_ [command](../../spells/command#_command)_, 5th—_ [waves of fatigue](../../spells/wavesOfFatigue#_waves-of-fatigue)_, 7th—_ [waves of exhaustion](../../spells/wavesOfExhaustion#_waves-of-exhaustion)_.
...
_Silver-Tongued Haggler (Su)_: Whenever you make a [Bluff](../../skills/bluff#_bluff), [Diplomacy](../../skills/diplomacy#_diplomacy), or [Sense Motive](../../skills/senseMotive#_sense-motive) check, you can, as a free action, grant yourself a bonus on the roll equal to 1/2 your cleric level (minimum +1). You can use this ability a number of times per day equal to 3 + your Wisdom modifier.

**Replacement Domain Spells** : 1st—_ [floating disk](../../spells/floatingDisk#_floating-disk)_, 5th—_ [overland flight](../../spells/overlandFlight#_overland-flight)_, 9th—_ [gate](../../spells/gate#_gate)._
...
**Replacement Domain Spells** : 2nd—_ [ghoul touch](../../spells/ghoulTouch#_ghoul-touch)_, 4th—_ [enervation](../../spells/enervation#_enervation)_, 9th—_ [energy drain](../../spells/energyDrain#_energy-drain)_.
...
_Warding Rune (Su)_: At 6th level, when a creature is damaged by your blast rune, it cannot attack you for a number of rounds equal to 1/2 your cleric level unless it succeeds at a Will save, as per the spell _ [sanctuary](../../spells/sanctuary#_sanctuary)_. Using this ability is an immediate action when a creature triggers one of your blast runes. The ability does not prevent you from being attacked or affected by area of effect spells or abilities. You can use this ability once per day at 8th level, plus one additional time per day at 14th level and 20th level.

**Replacement Domain Spells** : 1st level—_ [arcane lock](../../spells/arcaneLock#_arcane-lock)_, 4th—_ [dimensional anchor](../../spells/dimensionalAnchor#_dimensional)_, 6th—_ [guards and wards](../../spells/guardsAndWards#_guards-and-wards)._
...
**Replacement Domain Spells** : 1st—_ [whispering wind](../../spells/whisperingWind#_whispering-wind)_, 6th—_ [wind walk](../../spells/windWalk#_wind-walk), _9th—_ [winds of vengeance\*](../spells/windsOfVengeance#_winds-of-vengeance)_.

---
title: advance_dir/coreClasses/cleric
---
# Cleric
...
**Replacement Domain Spells** : 1st—_ [shield of faith](../../spell_dir/shieldOfFaith#_shield-of-faith)_, 3rd—_ [tongues](../../spell_dir/tongues#_tongues)_, 6th—_ [planar ally](../../spell_dir/planarAlly#_planar-ally) _(agathions only).
...
_Speak With Dead (Su)_: At 8th level, as a standard action, you can ask one question of a dead creature as if using _ [speak with dead](../../spell_dir/speakWithDead#_speak-with-dead)_. The dead creature you are questioning does not gain a Will saving throw if your alignments are different. You can use this ability a number of times per day equal to your cleric level.

**Replacement Domain Spells** : 4th—_ [rest eternal](../spell_dir/restEternal#_rest-eternal)_\*, 6th—_ [geas/quest](../../spell_dir/geasQuest#_geas-quest)_.
...
**Replacement Domain Spells** : 1st level—_ [magic aura](../../spell_dir/magicAura#_magic-aura)_, 4th—_ [arcane eye](../../spell_dir/arcaneEye#_arcane-eye)_, 6th—_ [analyze dweomer](../../spell_dir/analyzeDweomer#_analyze-dweomer)_.
...
**Replacement Domain Spells** : 1st—_ [divine favor](../../spell_dir/divineFavor#_divine-favor)_, 3rd—_ [prayer](../../spell_dir/prayer#_prayer)_, 6th—_ [planar ally](../../spell_dir/planarAlly#_planar-ally) _(archon only).
...
**Replacement Domain Spells** : 7th—_ [disintegrate](../../spell_dir/disintegrate#_disintegrate)_, 9th—_ [fiery body](../spell_dir/fieryBody#_fiery-body)_\*.
...
**Replacement Domain Spells** : 1st—_ [expeditious retreat](../../spell_dir/expeditiousRetreat#_expeditious-retreat)_, 3rd—_ [fly](../../spell_dir/fly)_, 6th—_ [planar ally](../../spell_dir/planarAlly#_planar-ally) _(azata only).
...
_ [Wounding](../../magicItem_dir/weapons#_wounding) Blade (Su)_: At 8th level, you can give a weapon that you touch the _ [wounding](../../magicItem_dir/weapons#_wounding)_ special weapon quality for a number of rounds equal to 1/2 your cleric level. You can use this ability once per day at 8th level, and an additional time per day for every four levels beyond 8th.

**Replacement Domain Spells** : 3rd—_ [vampiric touch](../../spell_dir/vampiricTouch#_vampiric-touch)_, 5th—_ [wall of thorns](../../spell_dir/wallOfThorns#_wall-of-thorns)_, 7th—_ [inflict serious wounds (mass)](../../spell_dir/inflictSeriousWounds#_inflict-serious-wounds-mass)_.
...
**Replacement Domain Spells** : 2nd—_ [gust of wind](../../spell_dir/gustOfWind#_gust-of-wind)_, 3rd—_ [call lightning](../../spell_dir/callLightning#_call-lightning)_, 7th—_ [control weather](../../spell_dir/controlWeather#_control-weather)._
...
_Tunnel Runner (Su)_: At 8th level, you can move through tunnels and caves with ease. Activating this ability is a standard action. You can move across any stone surface as if under the effects of _ [spider climb](../../spell_dir/spiderClimb#_spider-climb)_. You can also see very well in darkness, gaining darkvision out to a range of 60 feet. If you already possess darkvision, extend the range by 60 feet. While underground, you also gain an insight bonus equal to your cleric level on [Stealth](../../skill_dir/stealth#_stealth) skill checks and an insight bonus equal to your Wisdom modifier on initiative checks. You can use this ability for 1 minute per day per cleric level you possess. These minutes do not need to be consecutive, but they must be spent in 1-minute increments.

**Replacement Domain Spells** : 2nd—_ [create pit\*](../spell_dir/createPit#_create-pit-)_, 3rd—_ [spiked pit](../spell_dir/spikedPit#_spiked-pit)_\*, 6th—_ [hungry pit\*](../spell_dir/hungryPit#_hungry-pit-)_.
...
_Thundercloud (Su)_: At 8th level, you can, as a standard action, summon a storm cloud. This power functions as _ [fog cloud](../../spell_dir/fogCloud)_ except that creatures inside the cloud are deafened and take 2d6 points of electricity damage each round from the flashes of thunder and lightning. Once created, you can concentrate on the cloud to move it up to 30 feet each round. You can use this ability for a number of rounds per day equal to your cleric level. These rounds do not need to be consecutive.

**Replacement Domain Spells** : 4th—_ [solid fog](../../spell_dir/solidFog#_solid-fog)_, 9th—_ [storm of vengeance](../../spell_dir/stormOfVengeance#_storm-of-vengeance)_.
...
_Animate Servant (Su)_: At 8th level, as a standard action, you can give life to inanimate objects. This ability functions as _ [animate objects](../../spell_dir/animateObjects#_animate-objects)_ using your cleric level as the caster level. You can use this ability once per day at 8th level, and one additional time per day for every four levels beyond 8th.

**Replacement Domain Spells** : 7th—_ [limited wish](../../spell_dir/limitedWish#_limited-wish)_, 8th—_ [polymorph any object](../../spell_dir/polymorphAnyObject#_polymorph-any-object)_.
...
**Replacement Domain Spells** : 1st level—_ [bane](../../magicItem_dir/weapons#_weapons-bane)_, 3rd—_ [bestow curse](../../spell_dir/bestowCurse#_bestow-curse)_, 6th—_ [eyebite](../../spell_dir/eyebite#_eyebite)._
...
**Replacement Domain Spells** : 1st—_ [cause fear](../../spell_dir/causeFear#_cause-fear)_, 3rd—_ [vampiric touch](../../spell_dir/vampiricTouch#_vampiric-touch)_, 6th—_ [planar binding](../../spell_dir/planarBinding#_planar-binding) _(daemons only).
...
**Replacement Domain Spells** : 2nd level—_ [continual flame](../../spell_dir/continualFlame#_continual-flame)_, 3rd—_ [daylight](../../spell_dir/daylight#_daylight)._
...
**Replacement Domain Spells** : 3rd—_ [contagion](../../spell_dir/contagion#_contagion)_, 4th—_ [poison](../../spell_dir/poison#_poison)_, 6th—_ [harm](../../spell_dir/harm#_harm)._
...
**Replacement Domain Spells** : 2nd—_ [mirror image](../../spell_dir/mirrorImage#_mirror-image)_, 7th—_ [project image](../../spell_dir/projectImage#_project-image)_.
...
_ [Deflection](../spell_dir/deflection#_deflection-) Aura (Su)_: Once each day, you can emit a 20-foot aura for a number of rounds equal to your cleric level. Allies within the aura gain a +2 deflection bonus to AC and combat maneuver defense.

**Replacement Domain Spells** : 1st—_ [shield](../../spell_dir/shield#_shield)_, 2nd—_ [barkskin](../../spell_dir/barkskin#_barkskin)_, 7th—_ [deflection](../spell_dir/deflection#_deflection-)_\*_._
...
**Replacement Domain Spells** : 1st—_ [doom](../../spell_dir/doom#_doom)_, 3rd—_ [rage](../../spell_dir/rage#_rage)_, 6th—_ [planar binding](../../spell_dir/planarBinding#_planar-binding) _(demons only).
...
**Replacement Domain Spells** : 1st—_ [command](../../spell_dir/command#_command)_, 3rd—_ [suggestion](../../spell_dir/suggestion#_suggestion)_, 6th—_ [planar binding](../../spell_dir/planarBinding#_planar-binding) _(devils only).
...
**Replacement Domain Spells** : 2nd level—_ [bless water](../../spell_dir/blessWater#_bless-water)_, 5th—_ [cleanse\*](../spell_dir/cleanse#_cleanse)_, 7th—_ [resurrection](../../spell_dir/resurrection#_resurrection)_, 9th_— [miracle](../../spell_dir/miracle#_miracle)._
...
**Replacement Domain Spells** : 1st—_ [expeditious retreat](../../spell_dir/expeditiousRetreat#_expeditious-retreat)_, 4th—_ [locate creature](../../spell_dir/locateCreature#_locate-creature)_, 9th—_ [world wave\*](../spell_dir/worldWave#_world-wave-)._
...
**Replacement Domain Spells** : 2nd—_ [augury](../../spell_dir/augury#_augury)_, 3rd—_ [borrow fortune](../spell_dir/borrowFortune#_borrow-fortune)_\*.
...
_Eyes of the Hawk (Ex)_: You gain a racial bonus on [Perception](../../skill_dir/perception#_perception) checks equal to 1/2 your cleric level (minimum +1). In addition, if you can act during a surprise round, you receive a +2 racial bonus on your Initiative check.

**Replacement Domain Spells** : 2nd—_ [feather fall](../../spell_dir/featherFall#_feather-fall)_, 3rd—_ [fly](../../spell_dir/fly)_, 6th—_ [fly (mass)\*](../spell_dir/fly#_fly,-mass)_.
...
**Replacement Domain Spells** : 1st—_ [sanctuary](../../spell_dir/sanctuary#_sanctuary)_, 5th—_ [plane shift](../../spell_dir/planeShift#_plane-shift)_.
...
_Predator's [Grace](../spell_dir/grace#_grace) (Su)_: You can, as a swift action, grant yourself a +10-foot bonus to your base speed for 1 round. This bonus increases by 5 feet for every 5 cleric levels you possess. In addition, you gain low-light vision for 1 round. If you already possess low-light vision, the range of your sight becomes three times that of a human in dim light for 1 round. You can use this ability a number of times per day equal to 3 + your Wisdom modifier.

**Replacement Domain Spells** : 1st—_ [magic fang](../../spell_dir/magicFang#_magic-fang)_, 3rd—_ [beast shape I](../../spell_dir/beastShape#_beast-shape-i) _(animals only).
...
_Enlarge (Su)_: As a swift action you can enlarge yourself for 1 round, as if you were the target of the _ [enlarge person](../../spell_dir/enlargePerson#_enlarge-person)_ spell. You can use this ability a number of times per day equal to 3 + your Wisdom modifier.

**Replacement Domain Spells** : 1st—_ [enlarge person](../../spell_dir/enlargePerson#_enlarge-person)_, 5th—_ [righteous might](../../spell_dir/righteousMight#_righteous-might)._
...
_Aura of [Heroism](../../spell_dir/heroism#_heroism) (Su)_: At 8th level, you can emit a 30-foot aura of heroism for a number of rounds per day equal to your cleric level. Using this ability is a swift action. Allies in the area are treated as if they were under the effects of _ [heroism](../../spell_dir/heroism#_heroism)_. These rounds do not need to be consecutive.
...
**Replacement Domain Spells** : 1st—_ [alarm](../../spell_dir/alarm#_alarm)_, 3rd—_ [glyph of warding](../../spell_dir/glyphOfWarding#_glyph-of-warding)_, 7th—_ [guards and wards](../../spell_dir/guardsAndWards#_guards-and-wards)_.
...
**Replacement Domain Spells** : 2nd—_ [zone of truth](../../spell_dir/zoneOfTruth#_zone-of-truth)_, 6th—_ [geas/quest](../../spell_dir/geasQuest#_geas-quest)._
...
**Replacement Domain Spells** : 7th—_ [freezing sphere](../../spell_dir/freezingSphere#_freezing-sphere)_, 9th—_ [polar ray](../../spell_dir/polarRay#_polar-ray)_.
...
_ [Command](../../spell_dir/command#_command) (Su)_: As a standard action, you can give a creature an emotionless yet undeniable order, as per the spell _ [command](../../spell_dir/command#_command)_. A Will save negates this effect. You cannot target a creature more than once per day with this ability. You can use this ability a number of times per day equal to 3 + your Wisdom modifier.

**Replacement Domain Spells** : 3rd—_ [command undead](../../spell_dir/commandUndead#_command-undead)_, 5th—_ [command (greater)](../../spell_dir/command#_command-greater)_, 6th—_ [planar binding](../../spell_dir/planarBinding#_planar-binding)_ (inevitables only).
...
**Replacement Domain Spells** : 4th—_ [moonstruck](../spell_dir/moonstruck#_moonstruck)_\*, 6th—_ [phantasmal web](../spell_dir/phantasmalWeb#_phantasmal-web)_\*_._
...
**Replacement Domain Spells** : 1st—_ [comprehend languages](../../spell_dir/comprehendLanguages#_comprehend-languages)_, 2nd—_ [share language](../spell_dir/shareLanguage#_share-language-)_\*, 3rd—_ [tongues](../../spell_dir/tongues#_tongues)_, 5th_— [telepathic bond](../../spell_dir/telepathicBond#_telepathic-bond)._
...
**Replacement Domain Spells** : 5th—_ [enervation](../../spell_dir/enervation#_enervation)_, 6th—_ [modify memory](../../spell_dir/modifyMemory#_modify-memory)_, 9th—_ [energy drain](../../spell_dir/energyDrain#_energy-drain)_.
...
_Adoration (Su)_: As an immediate action, you can attempt to thwart a melee or ranged attack that targets you. This ability functions as _ [sanctuary](../../spell_dir/sanctuary#_sanctuary)_, but only against one individual attack. You must use the ability after the attack is declared but before the roll is made. The creature attacking you receives a Will save to negate this effect. If a creature has more than one attack, this ability only affects one of the attacks. You can use the ability a number of times per day equal to 3 + your Wisdom modifier. This is a mind-affecting effect.

**Replacement Domain Spells** : 2nd—_ [enthrall](../../spell_dir/enthrall#_enthrall)_, 8th—_ [euphoric tranquility](../spell_dir/euphoricTranquility#_euphoric-tranquility)_\*.
...
**Replacement Domain Spells** : 2nd—_ [touch of idiocy](../../spell_dir/touchOfIdiocy#_touch-of-idiocy)_, 4th—_ [confusion](../../spell_dir/confusion#_confusion)_.
...
**Replacement Domain Spells** : 2nd—_ [shield other](../../spell_dir/shieldOther#_shield-other)_, 6th—_ [sacrificial oath\*](../spell_dir/sacrificialOath#_sacrificial-oath)._

## Memory Subdomain

**Associated Domain** : [Knowledge](classes/cleric#_knowledge-domain).
...
_Recall (Su)_: With a touch, you can cause a creature to recall some bit of forgotten lore or information. The creature can retry any [Knowledge](classes/cleric#_knowledge-domain) skill check it has made within the past minute, gaining a insight bonus on the check equal to your Wisdom modifier. You can use this ability a number times per day equal to 3 + your Wisdom modifier.

**Replacement Domain Spells** : 2nd—_ [memory lapse\*](../spell_dir/memoryLapse#_memory-lapse)_, 6th—_ [modify memory](../../spell_dir/modifyMemory#_modify-memory)_, 8th—_ [moment of prescience](../../spell_dir/momentOfPrescience#_moment-of-prescience)_.
...
**Replacement Domain Spells** : 2nd—_ [heat metal](../../spell_dir/heatMetal#_heat-metal)_, 6th—_ [wall of iron](../../spell_dir/wallOfIron#_wall-of-iron)_, 8th—_ [iron body](../../spell_dir/ironBody#_iron-body)._
...
**Replacement Domain Spells** : 3rd—_ [keen edge](../../spell_dir/keenEdge#_keen-edge)_, 5th—_ [suffocation](../spell_dir/suffocation#_suffocation)_\*, 9th—_ [suffocation (mass)\*](../spell_dir/suffocation#_suffocation,-mass)_.
...
**Replacement Domain Spells** : 1st—_ [sleep](../../spell_dir/sleep#_sleep)_, 6th—_ [nightmare](../../spell_dir/nightmare#_nightmare)._
...
**Replacement Domain Spells** : 4th—_ [phantasmal killer](../../spell_dir/phantasmalKiller#_phantasmal-killer)_, 6th—_ [cloak of dreams\*](../spell_dir/cloakOfDreams)_, 9th—_ [weird](../../spell_dir/weird)._
...
**Replacement Domain Spells** : 2nd—_ [slipstream\*](../spell_dir/slipstream#_slipstream)_, 3rd—_ [water walk](../../spell_dir/waterWalk#_water-walk), _9th—_ [tsunami\*](../spell_dir/tsunami#_tsunami)._
...
**Replacement Domain Spells** : 1st—_ [confusion (lesser)](../../spell_dir/confusion#_confusion-lesser)_, 3rd—_ [displacement](../../spell_dir/displacement#_displacement)_, 6th—_ [planar binding](../../spell_dir/planarBinding#_planar-binding) _(proteans only).
...
**Replacement Domain Spells** : 1st—_ [protection from chaos](../../spell_dir/protectionFromChaos#_protection-from-chaos)/evi_dir/good/law_, 3rd—_ [remove blindnes_dir/deafness](../../spell_dir/removeBlindnessDeafness#_remove-blindness-deafness)_, 5th—_ [atonement](../../spell_dir/atonement#_atonement)_.
...
**Replacement Domain Spells** : 1st—_ [bless](../../spell_dir/bless#_bless)_, 6th—_ [heroes' feast](../../spell_dir/heroesFeast#_heroes-feast)._
...
**Replacement Domain Spells** : 2nd—_ [remove disease](../../spell_dir/removeDisease#_remove-disease)_, 4th—_ [neutralize poison](../../spell_dir/neutralizePoison#_neutralize-poison)_, 5th—_ [break enchantment](../../spell_dir/breakEnchantment#_break-enchantment)_.
...
**Replacement Domain Spells** : 5th—_ [raise dead](../../spell_dir/raiseDead#_raise-dead)_, 7th—_ [resurrection](../../spell_dir/resurrection#_resurrection)_, 9th—_ [true resurrection](../../spell_dir/trueResurrection#_true-resurrection)_.
...
_Powerful Persuader (Su)_: At 8th level, when you make a [Diplomacy](../../skill_dir/diplomacy#_diplomacy) or [Intimidate](../../skill_dir/intimidate#_intimidate) check, you can roll twice and take the higher result. Using this ability is a free action. You can use this ability once per day at 8th level, plus one additional time per day for every 2 levels beyond 8th.

**Replacement Domain Spells** : 2nd—_ [enthrall](../../spell_dir/enthrall#_enthrall)_, 6th—_ [symbol of persuasion](../../spell_dir/symbolOfPersuasion#_symbol-of-persuasion)._
...
_Untouched by the Seasons (Su)_: By touching a creature, you can grant it the benefits of _ [endure elements](../../spell_dir/endureElements#_endure-elements)_, which last for 1 hour per cleric level. You can use this ability a number of times per day equal to 3 + your Wisdom modifier.

**Replacement Domain Spells** : 1st—_ [goodberry](../../spell_dir/goodberry#_goodberry)_, 4th—_ [blight](../../spell_dir/blight#_blight)_, 8th—_ [sunburst](../../spell_dir/sunburst#_sunburst)._
...
**Replacement Domain Spells** : 2nd—_ [pyrotechnics](../../spell_dir/pyrotechnics#_pyrotechnics)_, 3rd—_ [stinking cloud](../../spell_dir/stinkingCloud#_stinking-cloud)_.
...
**Replacement Domain Spells** : 3rd—_ [animate dead](../../spell_dir/animateDead#_animate-dead)_, 6th—_antilife [shield](../../spell_dir/shield#_shield), _9th—_ [trap the soul](../../spell_dir/trapTheSoul#_trap-the-soul)._
...
**Replacement Domain Spells** : 5th—_ [call lightning storm](../../spell_dir/callLightningStorm#_call-lightning-storm)_, 6th—_ [sirocco\*](../spell_dir/sirocco#_sirocco)._
...
_Thief of the Gods (Su)_: At 8th level, when you make a [Disable Device](../../skill_dir/disableDevice#_disable-device) or [Sleight of Hand](../../skill_dir/sleightOfHand#_sleight-of-hand) check, you can roll twice and take the higher result. Using this ability is a free action. You can use this ability once per day at 8th level, plus one additional time per day for every 2 levels beyond 8th.

**Replacement Domain Spells** : 3rd—_ [locate object](../../spell_dir/locateObject#_locate-object)_, 7th—_ [ethereal jaunt](../../spell_dir/etherealJaunt#_ethereal-jaunt)_.
...
_Read Minds (Su)_: At 8th level, you can broaden your mental spectrum to encompass those around you. Doing so allows you to read the mind of every creature within 30 feet as if you had cast _ [detect thoughts](../../spell_dir/detectThoughts#_detect-thoughts)_. This ability allows you to read the surface thoughts of any creature that you are aware of after only 1 round of concentration. Creatures in this area are allowed a Will save to negate the effect. The DC of this Will save is 10 + 1/2 your cleric level + your Wisdom modifier. You can use this ability for a number of rounds per day equal to your cleric level. These rounds do not need to be consecutive.

**Replacement Domain Spells** : 3rd—_ [seek thoughts\*](../spell_dir/seekThoughts#_seek-thoughts)_, 5th—_ [telepathic bond](../../spell_dir/telepathicBond#_telepathic-bond)_, 8th—_ [mind blank](../../spell_dir/mindBlank#_mind-blank)_.
...
**Replacement Domain Spells** : 1st—_ [command](../../spell_dir/command#_command)_, 5th—_ [waves of fatigue](../../spell_dir/wavesOfFatigue#_waves-of-fatigue)_, 7th—_ [waves of exhaustion](../../spell_dir/wavesOfExhaustion#_waves-of-exhaustion)_.
...
_Silver-Tongued Haggler (Su)_: Whenever you make a [Bluff](../../skill_dir/bluff#_bluff), [Diplomacy](../../skill_dir/diplomacy#_diplomacy), or [Sense Motive](../../skill_dir/senseMotive#_sense-motive) check, you can, as a free action, grant yourself a bonus on the roll equal to 1/2 your cleric level (minimum +1). You can use this ability a number of times per day equal to 3 + your Wisdom modifier.

**Replacement Domain Spells** : 1st—_ [floating disk](../../spell_dir/floatingDisk#_floating-disk)_, 5th—_ [overland flight](../../spell_dir/overlandFlight#_overland-flight)_, 9th—_ [gate](../../spell_dir/gate#_gate)._
...
**Replacement Domain Spells** : 2nd—_ [ghoul touch](../../spell_dir/ghoulTouch#_ghoul-touch)_, 4th—_ [enervation](../../spell_dir/enervation#_enervation)_, 9th—_ [energy drain](../../spell_dir/energyDrain#_energy-drain)_.
...
_Warding Rune (Su)_: At 6th level, when a creature is damaged by your blast rune, it cannot attack you for a number of rounds equal to 1/2 your cleric level unless it succeeds at a Will save, as per the spell _ [sanctuary](../../spell_dir/sanctuary#_sanctuary)_. Using this ability is an immediate action when a creature triggers one of your blast runes. The ability does not prevent you from being attacked or affected by area of effect spells or abilities. You can use this ability once per day at 8th level, plus one additional time per day at 14th level and 20th level.

**Replacement Domain Spells** : 1st level—_ [arcane lock](../../spell_dir/arcaneLock#_arcane-lock)_, 4th—_ [dimensional anchor](../../spell_dir/dimensionalAnchor#_dimensional)_, 6th—_ [guards and wards](../../spell_dir/guardsAndWards#_guards-and-wards)._
...
**Replacement Domain Spells** : 1st—_ [whispering wind](../../spell_dir/whisperingWind#_whispering-wind)_, 6th—_ [wind walk](../../spell_dir/windWalk#_wind-walk), _9th—_ [winds of vengeance\*](../spell_dir/windsOfVengeance#_winds-of-vengeance)_.

---
layout: default
title: advanced_dir/advancedNewRules
---
# New Rules
...
You can attempt to reposition a foe to a different location as a standard action. You can only reposition an opponent that is no more than one size category larger than you. A reposition attempts to force a foe to move to a different position in relation to your location without doing any harm. If you do not have the [Improved Reposition](../advancedFeats#_improved-reposition) feat or a similar ability, attempting to reposition a foe provokes an attack of opportunity from the target of your maneuver. You cannot use this maneuver to move a foe into a space that is intrinsically dangerous, such as a pit or _ [wall of fire](../../spells_dir/wallOfFire#_wall-of-fire)_.
...
**Return from the Dead** : When a character dies, she does not lose any hero points she has accumulated. If she died with no hero points remaining, she gains 1 hero point when she is brought back from the dead through powerful magic, such as _ [raise dead](../../spells_dir/raiseDead#_raise-dead)_ or _ [resurrection](../../spells_dir/resurrection#_resurrection)_.
...
**School** necromancy [death, evil]; **Level** sorcerer_dir/wizard 3, witch 3
...
**Duration** instantaneous_dir/1 minute per HD of the target; see text
...
You curse the target, preventing it from drawing upon the powers of destiny. The target is shaken and cannot use hero points for the duration of the spell. This effect can be removed by _ [dispel magic](../../spells_dir/dispelMagic#_dispel-magic), [remove curse](../../spells_dir/removeCurse#_remove-curse)_, or other similar effects.

**Unravel Destiny**

**School** divination; **Level** cleric 3, sorcerer_dir/wizard 3, witch 3

**Casting Time** 1 standard action

**Components** V, S, DF

**Range** short (25 ft. + 5 ft._dir/2 levels)
...
**Requirements** [Craft Magic Arms and Armor](../../feats#_craft-magic-arms-and-armor), _heroic fortune_; **Cost** 8,815 gp
...
**Child of the Temple** : You have long served at a temple in a city, and not only did you pick up on many of the nobility's customs, you spent much time in the temple libraries studying your faith. You gain a +1 trait bonus on [Knowledge](../../skills_dir/knowledge#_knowledge) (nobility) and [Knowledge](../../skills_dir/knowledge#_knowledge) (religion) checks, and one of these skills (your choice) is always a class skill for you.
...
**Fast-Talker** : You had a knack at getting yourself into trouble as a child, and as a result developed a silver tongue at an early age. You gain a +1 trait bonus on [Bluff](../../skills_dir/bluff#_bluff) checks, and [Bluff](../../skills_dir/bluff#_bluff) is always a class skill for you.
...
**Lore Seeker** : The secrets of an ancient fallen civilization intrigue you, particularly the magical traditions of its highly mystical culture. You've studied magic intensely, and hope to increase that knowledge by adding ancient lore. You've come to the region to pursue that study, and chose the town as your base because it was out of the way of bigger cities—meaning less competition to study the ancient monuments in the region, you hope! You gain a +1 trait bonus on [Knowledge](../../skills_dir/knowledge#_knowledge) (arcana) checks, and [Knowledge](../../skills_dir/knowledge#_knowledge) (arcana) is a class skill for you. If you cast arcane spells, pick three spells on your spell list. You are particularly adept at casting these spells, so they function at +1 caster level when you cast them, and their save DCs (if any) gain a +1 bonus.
...
**Missionary** : You have come to town to see about expanding the presence of your chosen faith after receiving visions that told you your faith is needed in the region—what that need is, though, you're not quite sure. You gain a +1 trait bonus on [Knowledge](../../skills_dir/knowledge#_knowledge) (religion) checks, and [Knowledge](../../skills_dir/knowledge#_knowledge) (religion) is a class skill for you. If you cast divine spells, pick three spells on your spell list. You are particularly adept at casting these spells, so they function at +1 caster level when you cast them, and their save DCs (if any) gain a +1 bonus.
...
**Rapscallion** : You've spent your entire life thumbing your nose at the establishment and take pride in your run-ins with the law. Somehow, despite all the mischievous behavior in your life, you've never been caught. You gain a +1 trait bonus on [Escape Artist](../../skills_dir/escapeArtist#_escape-artist) checks and a +1 trait bonus on Initiative checks.
...
**Militia Veteran (any town or village)** : Your first job was serving in a civilian militia in your home town. Skills learned through daily drilling and protecting your fellow townsfolk gave you special insight into military life. Select one of the following skills: [Profession](../../skills_dir/profession#_profession) (soldier), [Ride](../../skills_dir/ride#_ride), or [Survival](../../skills_dir/survival#_survival). You gain a +1 trait bonus on that skill, and it is always a class skill for you.

**River Rat (marsh or river)** : You learned to swim right after you learned to walk. As a youth, a gang of river pirates put you to work swimming in nighttime rivers and canals with a dagger in your teeth so you could sever the anchor ropes of merchant vessels. You gain a +1 trait bonus on damage dealt with a dagger and a +1 trait bonus on [Swim](../../skills_dir/swim#_swim) checks. [Swim](../../skills_dir/swim#_swim) is always a class skill for you.

**Savanna Child (plains)** : You were born and raised among rolling plains or savannas. You spent much of your youth exploring these vast reaches and know many of the savanna's secrets. Pick one of the following skills: [Handle Animal](../../skills_dir/handleAnimal#_handle-animal), [Knowledge](../../skills_dir/knowledge#_knowledge) (nature), or [Ride](../../skills_dir/ride#_ride). You gain a +1 trait bonus on that skill, and it is always a class skill for you.

**Vagabond Child (urban)** : You grew up among the outcasts and outlaws of your society, learning to forage and survive in an urban environment. Select one of the following skills: [Disable Device](../../skills_dir/disableDevice#_disable-device), [Escape Artist](../../skills_dir/escapeArtist#_escape-artist), or [Sleight of Hand](../../skills_dir/sleightOfHand#_sleight-of-hand). You gain a +1 trait bonus on that skill, and it is always a class skill for you.

# Religion Traits

Religion traits are tied to specific deities.

**Child of Nature (N)** You have been blessed to be as comfortable in the wilderness as you are at home. You gain a +2 trait bonus on [Survival](../../skills_dir/survival#_survival) checks to find food and water, and a +1 trait bonus on [Knowledge](../../skills_dir/knowledge#_knowledge) (nature) checks. One of these skills (your choice) is always a class skill for you.
...
**Divine Courtesan (CN):** You worked in one of your goddess’s temples as a sacred courtesan, and you know how to flatter, please, and (most of all) listen. You gain a +1 trait bonus on [Sense Motive](../../skills_dir/senseMotive#_sense-motive) checks and [Diplomacy](../../skills_dir/diplomacy#_diplomacy) checks to gather information, and one of these skills (your choice) is always a class skill for you.
...
**Ear for Music (NG):** You spent countless hours of your youth in one of your goddess’s temples, listening to wonderful musicians and singers. You gain a +1 trait bonus on one category of [Perform](../../skills_dir/perform#_perform) checks and a +2 trait bonus on any [Knowledge](../../skills_dir/knowledge#_knowledge) (local) checks that deal with the local art or music scene.
...
**Guardian of the Forge (LG):** Your god’s sacred duties are to protect the faithful, take lessons from the great craftsmen and strategists of the past, and prepare against dark times. You receive a +1 trait bonus on [Knowledge](../../skills_dir/knowledge#_knowledge) (engineering) and [Knowledge](../../skills_dir/knowledge#_knowledge) (history) checks. One of these skills (your choice) is a class skill for you.
...
**Patient Optimist (LG):** You know that all things pass in time, and are used to having to repeat arguments multiple times to convince even the most stubborn believer. You gain a +2 trait bonus on [Diplomacy](../../skills_dir/diplomacy#_diplomacy) checks to influence hostile or unfriendly creatures, and if you fail at such an attempt, you may retry it once.

**Starchild (CG):** Your goddess sensed your love of travel and promised you would always be able to find your way home. You can automatically determine where true north is. You gain a +4 trait bonus on [Survival](../../skills_dir/survival#_survival) checks to avoid becoming lost.

---
layout: default
title: advanced_dir/advancedFeats
---
# Feats
...
| Bashing Finish\* | [Shield Master](../feats#_shield-master), [Two-Weapon Fighting](../feats#_two-weapon-fighting), base attack bonus +11 | Make a free shield bash after a critical hit |
| Bloody Assault\* | [Power Attack](../feats#_power-attack), base attack bonus +6 | Trade melee attack bonus for bleed damage |
| Bodyguard\* | [Combat Reflexes](../feats#_combat-reflexes) | Use attack of opportunity to add a bonus to adjacent ally's AC |
| In Harm's Way\* | Bodyguard | Take the damage of a successful attack upon an adjacent ally |
| Breadth of Experience | Dwarf, elf, or gnome; 100+ years old | +2 bonus on all [Knowledge](../skills_dir/knowledge#_knowledge) and [Profession](../skills_dir/profession#_profession) checks |
| Bull Rush Strike\* | [Improved Bull Rush](../feats#_improved-bull-rush), base attack bonus +9 | Attempt a bull rush on a successful critical hit |
| Charge Through\* | [Improved Overrun](../feats#_improved-overrun), base attack bonus +1 | Make overrun as free action while charging |
| Childlike | Cha 13, halfling | +2 on [Disguise](../skills_dir/disguise#_disguise) checks to look like human child, take 10 on [Bluff](../skills_dir/bluff#_bluff) checks |
| Cockatrice Strike\* | [Medusa's Wrath](../feats#_medusa-s-wrath), base attack bonus +16 | Turn a target to stone with a critical hit |
| Combat Patrol\* | [Combat Reflexes](../feats#_combat-reflexes), [Mobility](../feats#_mobility), base attack bonus +5 | Increase threatened area for attack of opportunity |
| Cooperative Crafting | 1 rank in any [Craft](../skills_dir/craft#_craft) skill, any item creation feat | +2 bonus on [Craft](../skills_dir/craft#_craft) or [Spellcraft](../skills_dir/spellcraft#_spellcraft) checks while workingtogether |
| Cosmopolitan | — | Read and speak two additional languages |
| Covering Defense\* | [Shield Focus](../feats#_shield-focus), base attack bonus +6 | Provide cover to an ally with total defense |
| Crippling Critical\* | [Critical Focus](../feats#_critical-focus), base attack bonus +13 | Whenever you score a critical hit, the target's speed is halved |
| Crossbow Mastery\* | Dex 15, [Rapid Reload](../feats#_rapid-reload), [Rapid Shot](../feats#_rapid-shot) | Reload crossbow as free action and make full attacks |
| Dastardly Finish\* | Sneak attack +5d6 | Deliver coup de grace to cowering or stunned target |
| Dazing Assault\* | [Power Attack](../feats#_power-attack), base attack bonus +11 | Trade melee attack bonus to daze opponents |
...
| Disarming Strike\* | [Improved Disarm](../feats#_improved-disarm), base attack bonus +9 | Attempt a disarm on a successful critical hit |
| Disrupting Shot\* | Dex 13, [Point-Blank Shot](../feats#_point-blank-shot), 6th-level fighter | Ranged attacks increase enemy's DC to cast spells |
| Diviner's Delving | [Spell Focus](../feats#_spell-focus) (divination) | +2 bonus on caster level checks with divinations |
| Eagle Eyes | Wis 13, keen senses racial trait | Ignore up to –5 due to distance on visual [Perception](../skills_dir/perception#_perception) checks |
...
| Elemental Fist\* | Con 13, Wis 13, [Improved Unarmed Strike](../feats#_improved-unarmed-strike), base attack bonus +8 | Deal 1d6 energy damage with an unarmed strike |
...
| Enforcer\* | [Intimidate](../skills_dir/intimidate#_intimidate) 1 rank | Demoralize opponent as free action when you inflict nonlethal damage |
...
| Fast Healer | Con 13, [Diehard](../feats#_diehard), [Endurance](../feats#_endurance) | Regain additional hit points when healing |
...
| Focused Shot\* | Int 13, [Precise Shot](../feats#_precise-shot) | Add Int modifier on damage rolls with bows or crossbows |
| Following Step\* | Dex 13, [Step Up](../feats#_step-up) | Move up to 10 feet as an immediate action |
| Step Up and Strike\* | Following Step, base attack bonus +6 | Follow adjacent creature and attack as an immediate action |
| Furious Focus\* | Str 13, [Power Attack](../feats#_power-attack), base attack bonus +1 | Do not take the [Power Attack](../feats#_power-attack) penalty on the first attack each round |
| Dreadful Carnage\* | Str 15, Furious Focus, base attack bonus +11 | Make a free [Intimidate](../skills_dir/intimidate#_intimidate) check when you knock down a foe |
| Gang Up\* | [Combat Expertise](../feats#_combat-expertise) | Flank an opponent if at least two allies are adjacent to it |
| Team Up\* | Gang-Up, base attack bonus +6 | Aid another as a move action with two adjacent allies |
| Gnome Trickster | Cha 13, gnome, gnome magic racial trait | Use _ [mage hand](../spells_dir/mageHand#_mage-hand)_ and _ [prestidigitation](../spells_dir/prestidigitation#_prestidigitation)_ once per day |
| Go Unnoticed | Dex 13, Small size or smaller | Make [Stealth](../skills_dir/stealth#_stealth) check against flat-footed opponents during first round of combat |
| Groundling | Cha 13, gnome, gnome magic racial trait | Speak with burrowing animals as spell-like ability |
| Heroic Defiance | [Diehard](../feats#_diehard), base Fortitude save +8 | Once per day, delay onset of harmful condition for 1 round |
| Heroic Recovery | [Diehard](../feats#_diehard), base Fortitude save +4 | Once per day, gain new saving throw against harmful condition requiring Fort save |
| Improved Blind-Fight\* | [Perception](../skills_dir/perception#_perception) 10 ranks, [Blind-Fight](../feats#_blind-fight) | Ignore miss chance for less than total concealment |
| Greater Blind-Fight\* | [Perception](../skills_dir/perception#_perception) 15 ranks, Improved [Blind-Fight](../feats#_blind-fight) | Total concealment is considered normal concealment |
| Improved Dirty Trick\* | [Combat Expertise](../feats#_combat-expertise) | +2 bonus on dirty trick attempts, no attack of opportunity |
| Greater Dirty Trick\* | Improved Dirty Trick, base attack bonus +6 | Dirty trick penalty lasts 1d4 rounds |
| Improved Drag\* | [Power Attack](../feats#_power-attack) | +2 bonus on drag attempts, no attack of opportunity |
| Greater Drag\* | Improved Drag, base attack bonus +6 | Enemies you drag provoke attacks of opportunity |
| Improved Reposition\* | [Combat Expertise](../feats#_combat-expertise) | +2 bonus on reposition attempts, no attack of opportunity |
| Greater Reposition\* | Improved Reposition, base attack bonus +6 | Enemies you reposition provoke attacks of opportunity |
| Improved Share Spells | [Spellcraft](../skills_dir/spellcraft#_spellcraft) 10 ranks, see feat | Spells affect both you and your bonded creature |
| Improved Steal\* | [Combat Expertise](../feats#_combat-expertise) | +2 bonus on steal attempts, no attack of opportunity |
| Greater Steal\* | Improved Steal, base attack bonus +6 | Enemies don't notice theft until after combat |
| Improved Stonecunning | Wis 13, dwarf, stonecunning racial trait | +4 bonus on [Perception](../skills_dir/perception#_perception) checks to notice unusual stonework |
| Stone Sense | [Perception](../skills_dir/perception#_perception) 10 ranks, Improved Stonecunning | Gain tremorsense 10 ft. |
...
| Smell Fear | Keen Scent, half-orc or orc | +4 on [Perception](../skills_dir/perception#_perception) checks to detect frightened creatures |
| _Ki_ Throw\* | [Improved Trip](../feats#_improved-trip), [Improved Unarmed Strike](../feats#_improved-unarmed-strike) | Throw opponent into adjacent square with a trip attack |
| Improved _Ki_ Throw\* | [Improved Bull Rush](../feats#_improved-bull-rush), Ki Throw | Throw opponent into occupied square as a bull rush |
| Leaf Singer | Cha 13, bardic performance, elf or half-elf | Gain benefits to bardic performance in forests and against fey |
| Light Step | [Acrobatic Steps](../feats#_acrobatic-steps), [Nimble Moves](../feats#_nimble-moves), elf | Move normal speed in difficult terrain |
...
| Master Alchemist | [Craft](../skills_dir/craft#_craft) (alchemy) 5 ranks | +2 on [Craft](../skills_dir/craft#_craft) (alchemy) checks, and you can create alchemical items and poisons faster |
| Minor Spell Expertise | Cast 4th-level spells | Cast 1st-level spell as spell-like ability 2_dir/day |
| Major Spell Expertise | Minor Spell Expertise, cast 9th-level spells | Cast 5th-level or lower spell as spell-like ability 2_dir/day |
| Missile Shield\* | Dex 13, [Shield Focus](../feats#_shield-focus) | Deflect one ranged attack per round with shield |
| Ray Shield\* | Dex 15, Missile Shield, [Spellbreaker](../feats#_spellbreaker) | Deflect one ranged touch attack per round with shield |
| Mounted Shield\* | [Mounted Combat](../feats#_mounted-combat), [Shield Focus](../feats#_shield-focus) | Apply shield bonus to mount's AC |
| Parry Spell | [Spellcraft](../skills_dir/spellcraft#_spellcraft) 15 ranks, [Improved Counterspell](../feats#_improved-counterspell) | Reflect a counterspelled spell back on its caster |
| Parting Shot\* | [Shot on the Run](../feats#_shot-on-the-run), base attack bonus +6 | Make a ranged attack when withdrawing |
| Pass for Human | Half-elf, half-orc, or halfling | +10 on [Disguise](../skills_dir/disguise#_disguise) checks to look like a human |
| Perfect Strike\* | Dex 13, Wis 13, [Improved Unarmed Strike](../feats#_improved-unarmed-strike), base attack bonus +8 | Roll twice for attacks with monk weapons and take the better roll |
| Point-Blank Master\* | [Weapon Specialization](../feats#_weapon-specialization) with a ranged weapon | Do not provoke attacks of opportunity while firing one ranged weapon |
| Practiced Tactician | Tactician class feature | Use tactician ability one additional time per day |
| Preferred Spell | [Spellcraft](../skills_dir/spellcraft#_spellcraft) 5 ranks, [Heighten Spell](../feats#_heighten-spell) | Spontaneously cast a specific spell |
| Punishing Kick\* | Con 13, Wis 13, [Improved Unarmed Strike](../feats#_improved-unarmed-strike), base attack bonus +8 | Knock down or push back foes with unarmed strikes |
| Pushing Assault\* | Str 15, [Power Attack](../feats#_power-attack), base attack bonus +1 | Push a foe back with a two-handed weapon |
...
| Saving Shield\* | [Shield Proficiency](../feats#_shield-proficiency) | Grant shield bonus to an adjacent ally |
| Second Chance\* | [Combat Expertise](../feats#_combat-expertise), base attack bonus +6 | Exchange later attacks to reroll missed first attack |
...
| Shared Insight | Wis 13, half-elf | Grant friendly creatures a +2 bonus on [Perception](../skills_dir/perception#_perception) checks |
| Sharp Senses | Keen senses racial trait | +4 racial bonus on [Perception](../skills_dir/perception#_perception) checks |
| Shield of Swings\* | Str 13, [Power Attack](../feats#_power-attack), base attack bonus +1 | Reduce damage with a two handed weapon to gain a +4 shield bonus |
| Shield Specialization\* | [Shield Focus](../feats#_shield-focus), 4th-level fighter | +2 bonus to AC against criticals with one type of shield |
| Greater Shield Specialization\* | [Greater Shield Focus](../feats#_greater-shield-focus), Shield Specialization, 12th-level fighter | +2 bonus to AC against criticals, and negate critical hit once per day |
| Sidestep\* | Dex 13, [Dodge](../feats#_dodge), [Mobility](../feats#_mobility) | Make 5-foot step immediately after an opponent misses |
| Improved Sidestep\* | Dex 15, Sidestep | Sidestep without using your 5-foot step on your next turn |
| Smash\* | [Power Attack](../feats#_power-attack), half-orc | Ignore 5 points of hardness when breaking an object |
| Sociable | Cha 13, half-elf | Grant friendly creatures a +2 bonus on [Diplomacy](../skills_dir/diplomacy#_diplomacy) checks |
| Spell Perfection | [Spellcraft](../skills_dir/spellcraft#_spellcraft) 15 ranks, 3 metamagic feats | Apply any metamagic feat to one spell without penalty, up to 9th level |
| Spider Step | [Acrobatics](../skills_dir/acrobatics#_acrobatics) 6 ranks, [Climb](../skills_dir/climb#_climb) 6 ranks, 6th-level monk | Walk on walls or ceilings for half your slow fall distance |
| Cloud Step | Spider Step, 12th-level monk | _ [Air walk](../spells_dir/airWalk#_air-walk)_ for half your slow fall distance |
| Stabbing Shot\* | [Rapid Shot](../feats#_rapid-shot), elf | Use arrow as a melee attack to push enemies back |
| Steel Soul | Dwarf, hardy racial trait | +4 racial bonus on saves against spells and spell-like abilities |
| Stone-Faced | Dwarf | +4 bonus on [Bluff](../skills_dir/bluff#_bluff) checks to lie or conceal motives |
| Stone Singer | Cha 13, bardic performance, dwarf | Gain benefits to bardic performance underground and against earth creatures |
| Stunning Assault\* | [Power Attack](../feats#_power-attack), base attack bonus +16 | Trade melee attack bonus to stun opponents |
| Summoner's Call | Eidolon class feature | Your eidolon gets a bonus when summoned |
| Sundering Strike\* | [Improved Sunder](../feats#_improved-sunder), base attack bonus | +9 Attempt a sunder attack on a successful critical hit |
| Swift Aid\* | [Combat Expertise](../feats#_combat-expertise), base attack bonus | +6 Attempt to aid another as a swift action |
| Taunt | Cha 13, Small size or smaller | Demoralize opponents with [Bluff](../skills_dir/bluff#_bluff) instead of [Intimidate](../skills_dir/intimidate#_intimidate) |
| Teleport Tactician\* | [Combat Reflexes](../feats#_combat-reflexes), [Disruptive](../feats#_disruptive), [Spellbreaker](../feats#_spellbreaker) | Teleporting creatures provoke attacks of opportunity |
| Tenacious Transmutation | [Spell Focus](../feats#_spell-focus) (transmutation) | +2 to DC to dispel your transmutations |
| Touch of Serenity\* | Wis 18, [Improved Unarmed Strike](../feats#_improved-unarmed-strike), base attack bonus +8 | Foes hit by unarmed strikes cannot attack or cast spells |
| Trick Riding\* | [Ride](../skills_dir/ride#_ride) rank 9, [Mounted Combat](../feats#_mounted-combat) | Automatically pass simple [Ride](../skills_dir/ride#_ride) skill checks |
| Mounted Skirmisher\* | [Ride](../skills_dir/ride#_ride) rank 14, Trick Riding | Make a full attack if mount moves its speed or less |
| Tripping Strike\* | [Improved Trip](../feats#_improved-trip), base attack bonus +9 | Attempt a trip attack on a successful critical hit |
| Under and Over\* | [Agile Maneuvers](../feats#_agile-maneuvers), Small size or smaller | Failed grapples against you cause attacker to fall prone |
| Underfoot\* | [Dodge](../feats#_dodge), [Mobility](../feats#_mobility), Small size or smaller | +4 on [Acrobatics](../skills_dir/acrobatics#_acrobatics) checks to move past larger opponents |
...
| Selective Spell | [Spellcraft](../skills_dir/spellcraft#_spellcraft) 10 ranks | Exclude targets from an area effect spell |
...
| Shield Wall\* | [Shield Proficiency](../feats#_shield-proficiency) | Increase your shield bonus to AC |
...
**Benefit:** Choose a 0-level spell from the sorcerer_dir/wizard spell list. You can cast this spell three times per day as a spell-like ability. The caster level is equal to your character level. The save DC is 10 + your Charisma modifier.
...
_Wild Instinct (Ex)_: You gain a +2 bonus on initiative checks and a +2 bonus on [Survival](../skills_dir/survival#_survival) skill checks.
...
**Prerequisites:** [Improved Shield Bash](../feats#_improved-shield-bash), [Shield Master](../feats#_shield-master), [Two-Weapon Fighting](../feats#_two-weapon-fighting), base attack bonus +11.
...
**Benefit:** You get a +2 bonus on all [Knowledge](../skills_dir/knowledge#_knowledge) and [Profession](../skills_dir/profession#_profession) skill checks, and can make checks with those skills untrained.

## Bull Rush Strike (Combat)

Your critical hits can push back your foes.

**Prerequisites:** Str 13, [Improved Bull Rush](../feats#_improved-bull-rush), [Power Attack](../feats#_power-attack), base attack bonus +9.
...
**Prerequisites:** Str 13, [Improved Overrun](../feats#_improved-overrun), [Power Attack](../feats#_power-attack), base attack bonus +1.
...
**Benefit:** You can take 10 on [Bluff](../skills_dir/bluff#_bluff) checks to convince others you are telling the truth, so long as your story makes you appear innocent. You gain a +2 bonus on [Disguise](../skills_dir/disguise#_disguise) skill checks to pose as a human child, and ignore the check penalties for disguising yourself as a different race and age category while doing so.
...
**Benefit:** As a move action, you can _ [air walk](../spells_dir/airWalk#_air-walk)_ (as the spell) up to half your slow fall distance, maximum 50 feet. You must reach a solid, level surface by the end of your turn or you will fall.

## Cockatrice Strike (Combat)

With a single strike, you transmute flesh to stone.

**Prerequisites:** [Improved Unarmed Strike](../feats#_improved-unarmed-strike), [Gorgon's Fist](../feats#_gorgon-s-fist), [Medusa's Wrath](../feats#_medusa-s-wrath), base attack bonus +16.

**Benefit:** As a full-round action, you can make a single unarmed strike against a dazed, flat-footed, paralyzed, staggered, stunned, or unconscious foe. If that attack is a critical hit, the target is petrified unless it succeeds on a Fortitude saving throw with a DC of 10 + 1_dir/2 your character level + your Wisdom modifier. This is a supernatural polymorph effect.

## Combat Patrol (Combat)

You range across the battlefield, dealing with threats wherever they arise.

**Prerequisites:** [Combat Reflexes](../feats#_combat-reflexes), [Mobility](../feats#_mobility), base attack bonus +5.
...
**Prerequisites:** 1 rank in any [Craft](../skills_dir/craft#_craft) skill, any item creation feat.

**Benefit:** You can assist another character in crafting mundane and magical items. You must both possess the relevant [Craft](../skills_dir/craft#_craft) skill or item creation feat, but either one of you can fulfill any other prerequisites for crafting the item. You provide a +2 circumstance bonus on any [Craft](../skills_dir/craft#_craft) or [Spellcraft](../skills_dir/spellcraft#_spellcraft) checks related to making an item, and your assistance doubles the gp value of items that can be crafted each day.
...
**Prerequisites:** [Shield Focus](../feats#_shield-focus), base attack bonus +6.
...
**Prerequisites:** [Critical Focus](../feats#_critical-focus), base attack bonus +13.

**Benefit:** Whenever you score a critical hit against an opponent, its speed is halved for 1 minute. A successful Fortitude save reduces this duration to 1d4 rounds. The DC of this save is equal to 10 + your base attack bonus. Against creatures with multiple types of movement, you must choose which movement type to affect. A flying creature hit by this attack must make a DC 10 [Fly](../skills_dir/fly#_fly) check to remain airborne, and has its maneuverability reduced by one step.
...
**Prerequisites:** Dex 15, [Point-Blank Shot](../feats#_point-blank-shot), [Rapid Reload](../feats#_rapid-reload), [Rapid Shot](../feats#_rapid-shot).

**Benefit:** The time required for you to reload any type of crossbow is reduced to a free action, regardless of the type of crossbow used. You can fire a crossbow as many times in a full attack action as you could attack if you were using a bow. Reloading a crossbow for the type of crossbow you chose when you took [Rapid Reload](../feats#_rapid-reload) no longer provokes attacks of opportunity.
...
**Prerequisites:** Str 13, [Power Attack](../feats#_power-attack), base attack bonus +11.
...
**Prerequisites:** Int 13, [Combat Expertise](../feats#_combat-expertise), [Improved Disarm](../feats#_improved-disarm), base attack bonus +9.
...
**Prerequisites:** Dex 13, [Point-Blank Shot](../feats#_point-blank-shot), fighter level 6th.
...
**Prerequisite:** [Spell Focus](../feats#_spell-focus) (divination).

**Benefit:** You gain a +2 bonus on caster level checks with divinations to overcome spell resistance or effects that impede divination (for example, _ [nondetection](../spells_dir/nondetection#_nondetection)_). When using a divination spell that requires concentration, you gain information from the spell 1 round sooner than normal (so you gain information from the first 2 rounds with 1 round of concentration, and information from the third round in the second round of concentration).

## Dreadful Carnage (Combat)

Slaying an enemy demoralizes your other nearby foes.

**Prerequisites:** Str 15, [Power Attack](../feats#_power-attack), Furious Focus, base attack bonus +11.

**Benefit:** Whenever you reduce an enemy to 0 or fewer hit points, you can make an [Intimidate](../skills_dir/intimidate#_intimidate) check to demoralize all enemies within 30 feet as a free action. Enemies that cannot see both you and the enemy you reduced to 0 or fewer hit points are unaffected.
...
**Benefit:** You ignore up to –5 in penalties due to distance on visual [Perception](../skills_dir/perception#_perception) checks, allowing you to see accurately at much greater distances than most.
...
**Prerequisites:** Con 13, Wis 13, [Improved Unarmed Strike](../feats#_improved-unarmed-strike), base attack bonus +8.
...
**Prerequisite:** [Intimidate](../skills_dir/intimidate#_intimidate) 1 rank.

**Benefit:** Whenever you deal nonlethal damage with a melee weapon, you can make an [Intimidate](../skills_dir/intimidate#_intimidate) check to demoralize your target as a free action. If you are successful, the target is shaken for a number of rounds equal to the damage dealt. If your attack was a critical hit, your target is frightened for 1 round with a successful [Intimidate](../skills_dir/intimidate#_intimidate) check, as well as being shaken for a number of rounds equal to the damage dealt.
...
**Prerequisites:** Con 13, [Diehard](../feats#_diehard), [Endurance](../feats#_endurance).
...
**Prerequisites:** Int 13, Point Blank Shot, [Precise Shot](../feats#_precise-shot).
...
**Prerequisites:** Dex 13, [Step Up](../feats#_step-up).

**Benefit:** When using the [Step Up](../feats#_step-up) feat to follow an adjacent foe, you may move up to 10 feet. You may still take a 5-foot step during your next turn, and any movement you make using this feat does not subtract any distance from your movement during your next turn.

**Normal:** You can only take a 5-foot step to follow an opponent using [Step Up](../feats#_step-up).
...
**Prerequisites:** Str 13, [Power Attack](../feats#_power-attack), base attack bonus +1.

**Benefit:** When you are wielding a two-handed weapon or a one-handed weapon with two hands, and using the [Power Attack](../feats#_power-attack) feat, you do not suffer [Power Attack](../feats#_power-attack)'s penalty on melee attack rolls on the first attack you make each turn. You still suffer the penalty on any additional attacks, including attacks of opportunity.
...
**Benefit:** In addition to your normal gnome spell-like abilities, you also gain the following spell-like abilities: 1_dir/day—_ [mage hand](../spells_dir/mageHand#_mage-hand)_ and _ [prestidigitation](../spells_dir/prestidigitation#_prestidigitation)_.
...
**Benefit:** During the first round of combat, flat-footed opponents are considered not to have noticed you yet for the purposes of [Stealth](../skills_dir/stealth#_stealth) skill checks, allowing you to make a [Stealth](../skills_dir/stealth#_stealth) check that round to hide from them.

## Greater Blind-Fight (Combat)

Your enemies cannot hide from you.

**Prerequisites:** [Perception](../skills_dir/perception#_perception) 15 ranks, Improved [Blind-Fight](../feats#_blind-fight).
...
**Special:** The Greater [Blind-Fight](../feats#_blind-fight) feat is of no use against a character who is the subject of a _ [blink](../spells_dir/blink#_blink)_ spell.

## Greater Dirty Trick (Combat)

When you pull a dirty trick, your foe is truly hindered.

**Prerequisites:** Int 13, [Combat Expertise](../feats#_combat-expertise), Improved Dirty Trick, base attack bonus +6.
...
**Prerequisites:** Str 13, Improved Drag, [Power Attack](../feats#_power-attack), base attack bonus +6.
...
**Prerequisites:** Int 13, [Combat Expertise](../feats#_combat-expertise), Improved Reposition, base attack bonus +6.
...
**Prerequisites:** Proficiency with selected shield, [Greater Shield Focus](../feats#_greater-shield-focus), [Shield Focus](../feats#_shield-focus), Shield Specialization with selected shield, fighter level 12th.
...
**Prerequisites:** Int 13, [Combat Expertise](../feats#_combat-expertise), Improved Steal, base attack bonus +6.
...
**Benefit:** You can use _ [speak with animals](../spells_dir/speakWithAnimals#_speak-with-animals)_ as a spell-like ability at will, but only to communicate with burrowing animals like gophers, moles, and the like. You can still use your gnome _ [speak with animals](../spells_dir/speakWithAnimals#_speak-with-animals)_ ability once per day to speak with any animal, as usual.

## Heroic Defiance

You struggle on when others would fall.

**Prerequisites:** [Diehard](../feats#_diehard), [Endurance](../feats#_endurance), base Fortitude save +8.
...
**Prerequisites:** [Diehard](../feats#_diehard), [Endurance](../feats#_endurance), base Fortitude save +4.
...
**Prerequisites:** [Perception](../skills_dir/perception#_perception) 10 ranks, [Blind-Fight](../feats#_blind-fight).
...
**Special:** The Improved Blind-Fight feat is of no use against a character who is the subject of a _ [blink](../spells_dir/blink#_blink)_ spell.
...
**Prerequisites:** Int 13, [Combat Expertise](../feats#_combat-expertise), Second Chance, base attack bonus +11.
...
**Prerequisites:** [Spellcraft](../skills_dir/spellcraft#_spellcraft) 10 ranks, ability to acquire an animal companion, eidolon, familiar, or special mount.
...
**Prerequisites:** Dex 15, [Dodge](../feats#_dodge), [Mobility](../feats#_mobility), Sidestep.
...
**Benefit:** You receive a +4 bonus on [Perception](../skills_dir/perception#_perception) checks to notice unusual stonework. This bonus replaces the stonecunning ability's normal bonus on [Perception](../skills_dir/perception#_perception) checks.
...
**Prerequisites:** [Improved Trip](../feats#_improved-trip), [Improved Unarmed Strike](../feats#_improved-unarmed-strike).
...
**Prerequisites:** [Acrobatic Steps](../feats#_acrobatic-steps), [Nimble Moves](../feats#_nimble-moves), elf.
...
**Prerequisite:** [Craft](../skills_dir/craft#_craft) (alchemy) 5 ranks.

**Benefit:** You receive a +2 bonus on [Craft](../skills_dir/craft#_craft) (alchemy) checks, and you may create mundane alchemical items much more quickly than normal. When making poisons, you can create a number of doses equal to your Intelligence modifier (minimum 1) at one time. These additional doses do not increase the time required, but they do increase the raw material cost.

In addition, whenever you make alchemical items or poisons using [Craft](../skills_dir/craft#_craft) (alchemy), use the item's gp value as its sp value when determining your progress (do not multiply the item's gp cost by 10 to determine its sp cost).
...
**Prerequisites:** Dex 13, [Shield Focus](../feats#_shield-focus).

**Benefit:** You must be using a light, heavy, or tower shield to use this feat. Once per round when you would normally be hit with an attack from a ranged weapon (not including spell effects, natural attacks, or massive ranged weapons), you may deflect it so that you take no damage, as if you had the [Deflect Arrows](../feats#_deflect-arrows) feat. You must be aware of the attack and not flat-footed.

## Mounted Shield (Combat)

Your defensive tactics defend both you and your mount.

**Prerequisites:** [Mounted Combat](../feats#_mounted-combat), [Shield Focus](../feats#_shield-focus).

**Benefit:** You may add your base shield bonus (including the bonus from [Shield Focus](../feats#_shield-focus) but not including enhancement bonuses) to your mount's AC. In addition, you may add this bonus when making a [Ride](../skills_dir/ride#_ride) check to negate a hit against your mount using the [Mounted Combat](../feats#_mounted-combat) feat.

## Mounted Skirmisher (Combat)

You are adept at attacking from upon a swift moving steed.

**Prerequisites:** [Ride](../skills_dir/ride#_ride) rank 14, [Mounted Combat](../feats#_mounted-combat), Trick Riding.
...
**Prerequisites:** [Spellcraft](../skills_dir/spellcraft#_spellcraft) 15 ranks, [Improved Counterspell](../feats#_improved-counterspell) .

**Benefit:** Whenever you successfully counter a spell, it returns back to its caster. This works exactly like the _ [spell turning](../spells_dir/spellTurning#_spell-turning)_ spell.

## Parting Shot (Combat)

You are an expert skirmisher, able to rain missiles upon your enemies whether advancing or retreating.

**Prerequisites:** Dex 13, [Dodge](../feats#_dodge), [Mobility](../feats#_mobility), Point Blank Shot, [Shot on the Run](../feats#_shot-on-the-run), base attack bonus +6.
...
**Prerequisites:** Dex 13, Wis 13, [Improved Unarmed Strike](../feats#_improved-unarmed-strike), base attack bonus +8.
...
**Prerequisite:** [Weapon Specialization](../feats#_weapon-specialization) with selected ranged weapon.
...
**Special:** Starting at 6th level, a ranger with the archery combat style may select Point Blank Master as a combat style feat, but he must have [Weapon Focus](../feats#_weapon-focus) instead of [Weapon Specialization](../feats#_weapon-specialization) in the selected weapon.
...
**Prerequisites:** [Spellcraft](../skills_dir/spellcraft#_spellcraft) 5 ranks, [Heighten Spell](../feats#_heighten-spell).
...
**Prerequisites:** Str 15, [Power Attack](../feats#_power-attack), base attack bonus +1.

**Benefit:** When you hit a creature your size or smaller with a two-handed weapon attack modified by the [Power Attack](../feats#_power-attack) feat, you can choose to push the target 5 feet directly away from you instead of dealing the extra damage from [Power Attack](../feats#_power-attack). If you score a critical hit, you can instead push the target 10 feet directly away from you. This movement does not provoke attacks of opportunities, and the target must end this move in a safe space it can stand in. You choose which effect to apply after the attack roll has been made, but before the damage is rolled.
...
**Prerequisites:** Dex 15, Missile Shield, [Spellbreaker](../feats#_spellbreaker).
...
**Prerequisites:** Int 13, [Combat Expertise](../feats#_combat-expertise), [Improved Trip](../feats#_improved-trip), base attack bonus +9.
...
**Prerequisite:** [Shield Proficiency](../feats#_shield-proficiency).
...
**Prerequisites:** Int 13, [Combat Expertise](../feats#_combat-expertise), base attack bonus +6.
...
**Prerequisite:** [Spellcraft](../skills_dir/spellcraft#_spellcraft) 10 ranks.
...
**Benefit:** As a move action, you can grant all friendly creatures within 30 feet who can see or hear you a +2 bonus on [Perception](../skills_dir/perception#_perception) checks for a number of rounds equal to your Wisdom modifier (minimum 1 round).
...
**Benefit:** You receive a +4 racial bonus on [Perception](../skills_dir/perception#_perception) skill checks. This replaces the normal bonus from the keen senses racial trait.

**Normal:** The keen senses trait normally grants a +2 racial bonus on [Perception](../skills_dir/perception#_perception) skill checks.
...
**Benefit:** When you take a full-attack action while wielding a two-handed weapon, you can choose to reduce the damage by 1_dir/2 to gain a +4 shield bonus to AC and CMD until the beginning of your next turn. The reduction in damage applies until the beginning of your next turn.

## Shield Specialization (Combat)

You have mastered the use of one type of shield.

**Prerequisites:** Proficiency with selected shield, [Shield Focus](../feats#_shield-focus), fighter level 4th.

**Benefit:** Choose one type of shield (buckler, light, heavy, or tower shield). With the selected shield, you gain a +2 bonus to your Armor Class against critical hit confirmation rolls. In addition, you may add your base shield bonus (including the bonus from [Shield Focus](../feats#_shield-focus) but not including enhancement bonuses) to your CMD.
...
**Benefit:** Whenever you are adjacent to an ally who also has this feat, you receive a +4 competence bonus on concentration checks. If your ally is wielding a buckler or a light shield, this bonus increases by +1. If your ally is wielding a heavy shield or a tower shield, this bonus increases by +2. Finally, if an enemy threatening you and your ally has the [Disruptive](../feats#_disruptive) feat, or another ability that increases the DC of concentration checks, the amount of the increase is halved.
...
**Prerequisites:** [Power Attack](../feats#_power-attack), half-orc.
...
**Benefit:** You receive a +4 bonus on [Perception](../skills_dir/perception#_perception) checks to detect creatures with the shaken, frightened, or panicked conditions using scent. You can substitute your [Perception](../skills_dir/perception#_perception) skill for [Sense Motive](../skills_dir/senseMotive#_sense-motive) skill checks if the subject has one of the previous conditions or is attempting to cover up their fear in some way.
...
**Benefit:** As a move action, you grant all friendly creatures within 30 feet who can see or hear you (including yourself) a +2 bonus on [Diplomacy](../skills_dir/diplomacy#_diplomacy) checks for a number of rounds equal to your Charisma modifier (minimum 1 round).

## Spell Perfection

You are unequaled at the casting of one particular spell.

**Prerequisites:** [Spellcraft](../skills_dir/spellcraft#_spellcraft) 15 ranks, at least three metamagic feats.

**Benefit:** Pick one spell which you have the ability to cast. Whenever you cast that spell you may apply any one metamagic feat you have to that spell without affecting its level or casting time, as long as the total modified level of the spell does not use a spell slot above 9th level. In addition, if you have other feats which allow you to apply a set numerical bonus to any aspect of this spell (such as [Spell Focus](../feats#_spell-focus), [Spell Penetration](../feats#_spell-penetration), [Weapon Focus](../feats#_weapon-focus) [ray], and so on), double the bonus granted by that feat when applied to this spell.

## Spider Step

Your physical mastery grants you an impossible stride.

**Prerequisites:** [Acrobatics](../skills_dir/acrobatics#_acrobatics) 6 ranks, [Climb](../skills_dir/climb#_climb) 6 ranks, monk level 6th.
...
**Benefit:** You receive a +4 bonus on [Bluff](../skills_dir/bluff#_bluff) checks to lie or conceal your feelings or true motives, but not to feint in combat or deliver secret messages. In addition, the DC for [Sense Motive](../skills_dir/senseMotive#_sense-motive) checks to get a hunch about you is 25 rather than 20.

## Stone Sense

You can feel movement in the very earth and stones around you.

**Prerequisites:** Improved Stonecunning, [Perception](../skills_dir/perception#_perception) 10 ranks.
...
**Prerequisites:** Str 13, [Power Attack](../feats#_power-attack), base attack bonus +16.
...
**Prerequisites:** Str 13, [Improved Sunder](../feats#_improved-sunder), [Power Attack](../feats#_power-attack), base attack bonus +9.
...
**Benefit:** You can demoralize opponents using [Bluff](../skills_dir/bluff#_bluff) rather than [Intimidate](../skills_dir/intimidate#_intimidate) (see the [Intimidate](../skills_dir/intimidate#_intimidate) skill description for details) and take no skill check penalty for being smaller than your target.

## Team Up (Combat)

When you are ganging up against an enemy, you can aid an ally with a quick feint.

**Prerequisites:** Int 13, [Combat Expertise](../feats#_combat-expertise), Gang Up, base attack bonus +6.
...
**Prerequisites:** [Combat Reflexes](../feats#_combat-reflexes), [Disruptive](../feats#_disruptive), [Spellbreaker](../feats#_spellbreaker).
...
**Prerequisite:** [Spell Focus](../feats#_spell-focus) (transmutation).
...
**Prerequisites:** [Ride](../skills_dir/ride#_ride) 9 ranks, [Mounted Combat](../feats#_mounted-combat).

**Benefit:** While wearing light or no armor, you do not need to make [Ride](../skills_dir/ride#_ride) skill checks for any task listed in the [Ride](../skills_dir/ride#_ride) skill with a DC of 15 or lower. You do not take a –5 penalty for riding a mount bareback. You can make a check using [Mounted Combat](../feats#_mounted-combat) to negate a hit on your mount twice per round instead of just once.
...
**Prerequisites:** [Agile Maneuvers](../feats#_agile-maneuvers), Small size or smaller.
...
**Prerequisites:** [Dodge](../feats#_dodge), [Mobility](../feats#_mobility), Small size or smaller.

**Benefit:** You receive a +4 dodge bonus on [Acrobatics](../skills_dir/acrobatics#_acrobatics) checks to move past opponents without provoking attacks of opportunity, so long as they are larger than you. In addition, you gain a +2 dodge bonus to Armor Class against attacks of opportunity caused when you move out of or within a larger opponent's threatened area (this stacks with the +4 bonus provided by [Mobility](../feats#_mobility), for a total bonus of +6).

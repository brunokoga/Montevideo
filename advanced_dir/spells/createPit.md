---
layout: default
title: advance_dir/spells/createPit
---
 **Create Pit**

**School** conjuration (creation); **Level** sorcere_dir/wizard 2, summoner 2
...
**Effect** 10-ft.-by-10-ft. hole, 10 ft. dee_dir/2 levels
...
Creatures who fall into the pit take falling damage as normal. The pit's coarse stone walls have a [Climb](../../skill_dir/climb#_climb) DC of 25. When the duration of the spell ends, creatures within the hole rise up with the bottom of the pit until they are standing on the surface over the course of a single round.

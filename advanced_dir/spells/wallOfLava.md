---
layout: default
title: advanced_dir/spells_dir/wallOfLava
---
 **Wall of Lava**

**School** conjuration (creation) [earth, fire]; **Level** druid 8, sorcerer_dir/wizard 8

**Casting Time** 1 standard action

**Components** V, S, M_dir/DF (a chunk of dried lava)

**Range** medium (100 ft. + 10 ft._dir/level)

**Target** lava wall whose area is up to one 5-ft. square_dir/level (S)
...
A creature can move through a _wall of lava_ as a full-round action by making a DC 25 Strength check—failure indicates that the creature is pushed back out of the wall to the point he just attempted to leave. A creature with a burrow speed can move through the wall using its burrow speed. An attempt to move through a _wall of lava_ inflicts 20d6 fire damage. A _wall of lava_ also radiates heat as if it were a _ [wall of fire](../../../spells_dir/wallOfFire#_wall-of-fire)_, although the heat from a _wall of lava_ radiates from both sides.

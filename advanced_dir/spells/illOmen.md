---
layout: default
title: advanced_dir/spells_dir/illOmen
---
 **Ill Omen**
...
A target who can speak and has at least one free hand and who is aware of the spell and its effects (such as from a [Spellcraft](../../skills_dir/spellcraft#_spellcraft) check to identify the spell as it is cast) can negate one reroll by spending a move action to utter a brief prayer or good luck charm to appease the spirits of ill fortune.

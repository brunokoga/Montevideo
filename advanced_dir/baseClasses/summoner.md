...
The summoner's class skills are [Craft](../../skill_dir/craft#_craft) (Int, [Fly](../../skill_dir/fly#_fly) (Dex, [Handle Animal](../../skill_dir/handleAnimal#_handle-animal) (Cha, [Knowledge](../../skill_dir/knowledge#_knowledge) (all) (Int, [Linguistics](../../skill_dir/linguistics#_linguistics) (Int, [Profession](../../skill_dir/profession#_profession) (Wis, [Ride](../../skill_dir/ride#_ride) (Dex, [Spellcraft](../../skill_dir/spellcraft#_spellcraft) (Int, and [Use Magic Device](../../skill_dir/useMagicDevice#_use-magic-device) (Cha.
...
| --- | --- | --- | --- | --- | --- |
| 1st | +0 | +0 | +0 | +2 | Cantrips, eidolon, life link,_ [summon monster I](../../spell_dir/summonMonster#_summon-monster-i_ | 1 | — | — | — | — | — |
| 2nd | +1 | +0 | +0 | +3 | Bond senses | 2 | — | — | — | — | — |
| 3rd | +2 | +1 | +1 | +3 | _ [Summon monster II](../../spell_dir/summonMonster#_summon-monster-ii_ | 3 | — | — | — | — | — |
| 4th | +3 | +1 | +1 | +4 | Shield ally | 3 | 1 | — | — | — | — |
| 5th | +3 | +1 | +1 | +4 | _ [Summon monster III](../../spell_dir/summonMonster#_summon-monster-iii_ | 4 | 2 | — | — | — | — |
| 6th | +4 | +2 | +2 | +5 | Maker's call | 4 | 3 | — | — | — | — |
| 7th | +5 | +2 | +2 | +5 | _ [Summon monster IV](../../spell_dir/summonMonster#_summon-monster-iv_ | 4 | 3 | 1 | — | — | — |
| 8th | +6/+1 | +2 | +2 | +6 | Transposition | 4 | 4 | 2 | — | — | — |
| 9th | +6/+1 | +3 | +3 | +6 | _ [Summon monster V](../../spell_dir/summonMonster#_summon-monster-v_ | 5 | 4 | 3 | — | — | — |
| 10th | +7/+2 | +3 | +3 | +7 | Aspect | 5 | 4 | 3 | 1 | — | — |
| 11th | +8/+3 | +3 | +3 | +7 | _ [Summon monster VI](../../spell_dir/summonMonster#_summon-monster-vi_ | 5 | 4 | 4 | 2 | — | — |
| 12th | +9/+4 | +4 | +4 | +8 | Greater shield ally | 5 | 5 | 4 | 3 | — | — |
| 13th | +9/+4 | +4 | +4 | +8 | _ [Summon monster VII](../../spell_dir/summonMonster#_summon-monster-vii_ | 5 | 5 | 4 | 3 | 1 | — |
| 14th | +10/+5 | +4 | +4 | +9 | Life bond | 5 | 5 | 4 | 4 | 2 | — |
| 15th | +11/+6/+1 | +5 | +5 | +9 | _ [Summon monster VIII](../../spell_dir/summonMonster#_summon-monster-viii_ | 5 | 5 | 5 | 4 | 3 | — |
| 16th | +12/+7/+2 | +5 | +5 | +10 | Merge forms | 5 | 5 | 5 | 4 | 3 | 1 |
| 17th | +12/+7/+2 | +5 | +5 | +10 | _ [Summon monster IX](../../spell_dir/summonMonster#_summon-monster-ix_ | 5 | 5 | 5 | 4 | 4 | 2 |
| 18th | +13/+8/+3 | +6 | +6 | +11 | Greater aspect | 5 | 5 | 5 | 5 | 4 | 3 |
| 19th | +14/+9/+4 | +6 | +6 | +11 | _ [Gate](../../spell_dir/gate#_gate_ | 5 | 5 | 5 | 5 | 5 | 4 |
...
**Eidolon** : A summoner begins play with the ability to summon to his side a powerful outsider called an eidolon. The eidolon forms a link with the summoner, who, forever after, summons an aspect of the same creature. An eidolon has the same alignment as the summoner that calls it and can speak all of his languages. Eidolons are treated as summoned creatures, except that they are not sent back to their home plane until reduced to a number of negative hit points equal to or greater than their Constitution score. In addition, due to its tie to its summoner, an eidolon can touch and attack creatures warded by _ [protection from evil](../../spell_dir/protectionFromEvil#_protection-from-evil)_ and similar effects that prevent contact with summoned creatures.

A summoner can summon his eidolon in a ritual that takes 1 minute to perform. When summoned in this way, the eidolon hit points are unchanged from the last time it was summoned. The only exception to this is if the eidolon was slain, in which case it returns with half its normal hit points. The eidolon does not heal naturally. The eidolon remains until dismissed by the summoner (a standard action. If the eidolon is sent back to its home plane due to death, it cannot be summoned again until the following day. The eidolon cannot be sent back to its home plane by means of _ [dispel magic](../../spell_dir/dispelMagic#_dispel-magic_, but spells such as _ [dismissal](../../spell_dir/dismissal#_dismissal _and _ [banishment](../../spell_dir/banishment#_banishment_ work normally. If the summoner is unconscious, asleep, or killed, his eidolon is immediately banished.

The eidolon takes a form shaped by the summoner's desires. The eidolon's Hit Dice, saving throws, skills, feats, and abilities are tied to the summoner's class level and increase as the summoner gains levels. In addition, each eidolon receives a pool of evolution points, based on the summoner's class level, that can be used to give the eidolon different abilities and powers. Whenever the summoner gains a level, he must decide how these points are spent, and they are set until he gains another level of summoner.

The eidolon's physical appearance is up to the summoner, but it always appears as some sort of fantastical creature. This control is not fine enough to make the eidolon appear like a specific creature. The eidolon also bears a glowing rune that is identical to a rune that appears on the summoner's forehead as long as the eidolon is summoned. While this rune can be hidden through mundane means, it cannot be concealed through magic that changes appearance, such as _ [alter self](../../spell_dir/alterSelf#_alter-self_ or _ [polymorph](../../spell_dir/polymorph#_polymorph_ (although _ [invisibility](../../spell_dir/invisibility#_invisibility) _does conceal it as long as the spell lasts).
...
**_Summon Monster I_ (Sp** : Starting at 1st level, a summoner can cast _ [summon monster I](../../spell_dir/summonMonster#_summon-monster-i)_ as a spell-like ability a number of times per day equal to 3 + his Charisma modifier. Drawing upon this ability uses up the same power as the summoner uses to call his eidolon. As a result, he can only use this ability when his eidolon is not summoned. He can cast this spell as a standard action and the creatures remain for 1 minute per level (instead of 1 round per level. At 3rd level, and every 2 levels thereafter, the power of this ability increases by one spell level, allowing him to summon more powerful creatures (to a maximum of _ [summon monster IX](../../spell_dir/summonMonster#_summon-monster-ix)_ at 17th level. At 19th level, this ability can be used as _ [gate](../../spell_dir/gate#_gate_ or _ [summon monster IX](../../spell_dir/summonMonster#_summon-monster-ix_. If used as _ [gate](../../spell_dir/gate#_gate_, the summoner must pay any required material components. A summoner cannot have more than one _summon monster_ or _ [gate](../../spell_dir/gate#_gate _spell active in this way at one time. If this ability is used again, any existing _summon monster_ or _ [gate](../../spell_dir/gate#_gate)_ immediately ends. These summon spells are considered to be part of his spell list for the purposes of spell trigger and spell completion items. In addition, he can expend uses of this ability to fufill the construction requirements of any magic item he creates, so long as he can use this ability to cast the required spell.
...
**Goo_dir/Bad Saves** : These are the eidolon's base saving throw bonuses. An eidolon possesses two good saving throws and one bad saving throw, determined by the creature's base form.
...
_ [Darkvision](../../spell_dir/darkvision#_darkvision) (Ex)_: The eidolon has darkvision out to a range of 60 feet.
...
_Devotion (Ex_: An eidolon gains a +4 morale bonus on Will saves against enchantment spells and effects.

_ [Multiattack](../../monster_dir/monsterFeats#_multiattack_: An eidolon gains [Multiattack](../../monster_dir/monsterFeats#_multiattack) as a bonus feat if it has 3 or more natural attacks and does not already have that feat. If it does not have the requisite 3 or more natural attacks (or it is reduced to less than 3 attacks, the eidolon instead gains a second attack with one of its natural weapons, albeit at a –5 penalty. If the eidolon later gains 3 or more natural attacks, it loses this additional attack and instead gains [Multiattack](../../monster_dir/monsterFeats#_multiattack).

_Improved Evasion (Ex_: When subjected to an attack that allows a Reflex saving throw for half damage, an eidolon takes no damage if it makes a successful saving throw and only half damage if the saving throw fails.
...
| 9th | 7 | +7 | +5 | +2 | 28 | 4 | +6 | +3 | 13 | 5 | [Multiattack](../../monster_dir/monsterFeats#_multiattack |
...
The following skills are class skills for eidolons: [Bluff](../../skill_dir/bluff#_bluff) (Cha, [Craft](../../skill_dir/craft#_craft) (Int, [Knowledge](../../skill_dir/knowledge#_knowledge) (planes) (Int, [Perception](../../skill_dir/perception#_perception) (Wis, [Sense Motive](../../skill_dir/senseMotive#_sense-motive) (Wis, and [Stealth](../../skill_dir/stealth#_stealth) (Dex. In addition, at 1st level, the summoner can choose 4 additional skills to be class skills for his eidolon. Note that eidolons with a fly speed receive [Fly](../../skill_dir/fly#_fly) (Dex) as a free class skill, even if they do not gain a fly speed until a later level.
...
Alternatively, any one of these base forms can be used to make a Small eidolon. If the eidolon is Small, it gains a +2 bonus to its Dexterity score. It also takes a –4 penalty to its Strength and a –2 penalty to its Constitution. It also gains a +1 size bonus to its AC and attack rolls, a –1 penalty to its CMB and CMD scores, a +2 bonus on its [Fly](../../skill_dir/fly#_fly skill checks, and a +4 bonus on its [Stealth](../../skill_dir/stealth#_stealth) skill checks. Reduce the damage of all of its attacks by one step (1d6 becomes 1d4, 1d4 becomes 1d3). If this choice is made, the eidolon can be made Medium whenever the summoner can change the eidolon's evolution pool (which causes it to lose these modifiers for being Small).
...
_ [Climb](../../skill_dir/climb#_climb) (Ex)_: An eidolon becomes a skilled climber, gaining a climb speed equal to its base speed. This evolution can be selected more than once. Each additional time it is selected, increase the eidolon's climb speed by 20 feet.

_Gills (Ex)_: An eidolon has gills and can breathe underwater indefinitely.

_Improved Damage (Ex_: One of the eidolon's natural attacks is particularly deadly. Select one natural attack form and increase the damage die type by one step. This evolution can be selected more than once. Its effects do not stack. Each time an eidolon selects this evolution, it applies to a different natural attack.

_ [Improved Natural Armor](../../monster_dir/monsterFeats#_improved-natural-armor) (Ex)_: An eidolon's hide grows thick fur, rigid scales, or bony plates, giving it a +2 bonus to its natural armor. This evolution can be taken once for every five levels the summoner possesses.

_Magic Attacks (Su_: An eidolon is infused with magic, allowing it to treat all of its natural attacks as if they were magic for the purpose of overcoming damage reduction. If the summoner is 10th level or higher, all of the eidolon's weapons are treated as the alignment of the eidolon for the purpose of overcoming damage reduction.

_ [Mount](../../spell_dir/mount#_mount) (Ex)_: An eidolon is properly skilled and formed to serve as a combat-trained mount. The eidolon must be at least one size category larger than its rider. This evolution is only available to eidolons of the quadruped and serpentine base forms.
...
_Reach (Ex_: One of an eidolon's attacks is capable of striking at foes at a distance. Pick one attack. The eidolon's reach with that attack increases by 5 feet.

_ [Resistance](../../spell_dir/resistance#_resistance) (Ex)_: An eidolon's form takes on a resiliency to one particular energy type, which is usually reflected in its physical body (ashen hide for fire, icy breath for cold, and so on). Pick one energy type (acid, cold, electricity, fire, or sonic). The eidolon gains resist 5 against that energy type. This resistance increases by 5 for every 5 levels the summoner possesses, to a maximum of 15 at 10th level. This evolution can be selected more than once. Its effects do not stack. Each time an eidolon selects this evolution, it applies to a different energy type.

_Scent (Ex_: An eidolon's sense of smell becomes quite acute. The eidolon gains the [scent](../../glossary#_scent) special quality, allowing it to detect opponents within 30 feet by sense of smell. If the opponent is upwind, the range increases to 60 feet; if downwind, it drops to 15 feet. Strong scents can be detected at twice the normal range. Scent does not allow the eidolon to precisely locate the creature, only to detect its presence. It can detect the direction with a move action. The eidolon can pinpoint the creature's location if it is within 5 feet. The eidolon can use scent to track creatures.

_Skilled (Ex)_: An eidolon becomes especially adept at a specific skill, gaining a +8 racial bonus on that skill. This evolution can be selected more than once. Its effects do not stack. Each time an eidolon selects this evolution, it applies to a different skill.
...
_ [Swim](../../skill_dir/swim#_swim) (Ex)_: An eidolon gains webbed hands, feet, or powerful flippers, giving it a swim speed equal to its base speed. This evolution does not give the eidolon the ability to breathe underwater. This evolution can be selected more than once. Each additional time it is selected, increase the eidolon's swim speed by 20 feet.

_Tail (Ex_: An eidolon grows a long, powerful tail. This grants it a +2 racial bonus on [Acrobatics](../../skill_dir/acrobatics#_acrobatics) checks made to balance on a surface. This evolution can be selected more than once.
...
_Tremorsense (Ex)_: An eidolon becomes attuned to vibrations in the ground, gaining tremorsense out to a range of 30 feet. This works like the blindsense evolution, but only if both the eidolon and the creature to be pinpointed are in contact with the ground. The summoner must be at least 7th level before selecting this evolution.
...
_Blindsense (Ex)_: An eidolon's senses become incredibly acute, giving it blindsense out to a range of 30 feet. This ability allows the eidolon to pinpoint the location of creatures that it cannot see without having to make a [Perception](../../skill_dir/perception#_perception) check, but such creatures still have total concealment from the eidolon. Visibility still affects the eidolon's movement and it is still denied its Dexterity bonus to Armor Class against attacks from creatures it cannot see. The summoner must be at least 9th level before selecting this evolution.

_Burrow (Ex_: An eidolon grows thick and gnarled claws, allowing it to move through the earth. The eidolon gains a burrow speed equal to 1/2 its base speed. It can use this speed to move through dirt, clay, sand, and earth. It does not leave a hole behind, nor is its passage marked on the surface. The summoner must be at least 9th level before selecting this evolution.
...
_ [Web](../../spell_dir/web#_web) (Ex_: An eidolon gains a pair of spinnerets, giving it the ability to spin webs. The eidolon can use these webs to support itself plus up to one creature of the same size. It can throw webbing as a ranged touch attack up to 8 times per day, entangling a creature up to one size larger than the eidolon. The webbing has a range of 50 feet and a 10-foot range increment. Creatures entangled by the web can escape with an [Escape Artist](../../skill_dir/escapeArtist#_escape-artist) check or a Strength check (at a –4 penalty. The DC of these checks is equal to 10 + 1/2 the eidolon's HD + the eidolon's Con modifier. The webs have a Hardness of 0 and a number of hits points equal to the eidolon's total Hit Dice. The eidolon can climb its own webs at its climb speed and can pinpoint any creature touching its webs. The eidolon must possess the climb evolution to take this evolution. The summoner must be at least 7th level before selecting this evolution.
...
_Spell [Resistance](../../spell_dir/resistance#_resistance) (Ex)_: An eidolon is protected against magic, gaining spell resistance. The eidolon's spell resistance is equal to 11 + the summoner's level. This spell resistance does not apply to spells cast by the summoner. The summoner must be at least 9th level before selecting this evolution.
...
**0-Level Summoner Spells** —_ [acid splash](../../spell_dir/acidSplash#_acid-splash, [arcane mark](../../spell_dir/arcaneMark#_arcane-mark, [daze](../../spell_dir/daze#_daze, [detect magic](../../spell_dir/detectMagic#_detect-magic, [guidance](../../spell_dir/guidance#_guidance, [light](../../spell_dir/light#_light, [mage hand](../../spell_dir/mageHand#_mage-hand, [mending](../../spell_dir/mending#_mending, [message](../../spell_dir/message#_message, [open/close](../../spell_dir/openClose#_open-close, [read magic](../../spell_dir/readMagic#_read-magic, [resistance](../../spell_dir/resistance#_resistance._

**1st-Level Summoner Spells** —_ [alarm](../../spell_dir/alarm#_alarm, [ant haul\*](../spell_dir/antHaul#_ant-haul-, [daze monster](../../spell_dir/dazeMonster#_daze-monster, [endure elements](../../spell_dir/endureElements#_endure-elements, [enlarge person](../../spell_dir/enlargePerson#_enlarge-person, [expeditious retreat](../../spell_dir/expeditiousRetreat#_expeditious-retreat, [feather fall](../../spell_dir/featherFall#_feather-fall, [grease](../../spell_dir/grease#_grease, [identify](../../spell_dir/identify#_identify, [jump](../../spell_dir/jump#_jump, [mage armor](../../spell_dir/mageArmor#_mage-armor, [magic fang](../../spell_dir/magicFang#_magic-fang, [magic mouth](../../spell_dir/magicMouth#_magic-mouth, [mount](../../spell_dir/mount#_mount, [protection from chaos](../../spell_dir/protectionFromChaos#_protection-from-chaos/evil/good/law, [reduce person](../../spell_dir/reducePerson#_reduce-person), [rejuvenate eidolon (lesser\*](../spell_dir/rejuvenateEidolon#_rejuvenate-eidolon,-lesser, [shield](../../spell_dir/shield#_shield, [summon monster I](../../spell_dir/summonMonster#_summon-monster-i, [unfetter\*](../spell_dir/unfetter#_unfetter, [unseen servant](../../spell_dir/unseenServant#_unseen-servant, [ventriloquism](../../spell_dir/ventriloquism#_ventriloquism._

**2nd-Level Summoner Spells** —_ [alter self](../../spell_dir/alterSelf#_alter-self, [barkskin](../../spell_dir/barkskin#_barkskin, [bear's endurance](../../spell_dir/bearSEndurance#_bear-s-endurance, [blur](../../spell_dir/blur#_blur, [bull's strength](../../spell_dir/bullSStrength#_bull-s-strength, [cat's grace](../../spell_dir/catSGrace#_cat-s-grace, [create pit\*](../spell_dir/createPit#_create-pit-, [detect thoughts](../../spell_dir/detectThoughts#_detect-thoughts, [eagle's splendor](../../spell_dir/eagleSSplendor#_eagle-s-splendor), [evolution surge (lesser\*](../spell_dir/evolutionSurge#_evolution-surge,-lesser, [fox's cunning](../../spell_dir/foxSCunning#_fox-s-cunning, [glide\*](../spell_dir/glide#_glide-, [glitterdust](../../spell_dir/glitterdust#_glitterdust, [haste](../../spell_dir/haste#_haste, [invisibility](../../spell_dir/invisibility#_invisibility, [levitate](../../spell_dir/levitate#_levitate, [misdirection](../../spell_dir/misdirection#_misdirection, [owl's wisdom](../../spell_dir/owlSWisdom#_owl-s-wisdom, [phantom steed](../../spell_dir/phantomSteed#_phantom-steed, [protection from arrows](../../spell_dir/protectionFromArrows#_protection-from-arrows, [resist energy](../../spell_dir/resistEnergy#_resist-energy, [see invisibility](../../spell_dir/seeInvisibility#_see-invisibility, [slow](../../spell_dir/slow#_slow, [spider climb](../../spell_dir/spiderClimb#_spider-climb, [summon eidolon\*](../spell_dir/summonEidolon#_summon-eidolon, [summon monster II](../../spell_dir/summonMonster#_summon-monster-ii, [summon swarm](../../spell_dir/summonSwarm#_summon-swarm, [wind wall](../../spell_dir/windWall#_wind-wall._

**3rd-Level Summoner Spells** —_ [aqueous orb\*](../spell_dir/aqueousOrb#_aqueous-orb, [black tentacles](../../spell_dir/blackTentacles#_black-tentacles, [charm monster](../../spell_dir/charmMonster#_charm-monster, [devolution\*](../spell_dir/devolution#_devolution, [dimension door](../../spell_dir/dimensionDoor#_dimension-door, [dimensional anchor](../../spell_dir/dimensionalAnchor#_dimensional, [dispel magic](../../spell_dir/dispelMagic#_dispel-magic, [displacement](../../spell_dir/displacement#_displacement), [enlarge person (mass](../../spell_dir/enlargePerson#_enlarge-person-mass, [evolution surge\*](../spell_dir/evolutionSurge#_evolution-surge, [fire shield](../../spell_dir/fireShield#_fire-shield, [fly](../../spell_dir/fly, [heroism](../../spell_dir/heroism#_heroism), [invisibility (greater](../../spell_dir/invisibility#_invisibility-greater, [locate creature](../../spell_dir/locateCreature#_locate-creature, [magic circle against chaos](../../spell_dir/magicCircleAgainstChaos#_magic-circle-against-chaos/evil/goo_dir/law, [magic fang (greater](../../spell_dir/magicFang#_magic-fang-greater, [minor creation](../../spell_dir/minorCreation#_minor-creation, [nondetection](../../spell_dir/nondetection#_nondetection, [protection from energy](../../spell_dir/protectionFromEnergy#_protection-from-energy, [rage](../../spell_dir/rage#_rage), [reduce person (mass](../../spell_dir/reducePerson#_reduce-person-mass, [rejuvenate eidolon\*](../spell_dir/rejuvenateEidolon#_rejuvenate-eidolon, [seek thoughts\*](../spell_dir/seekThoughts#_seek-thoughts, [spiked pit\*](../spell_dir/spikedPit#_spiked-pit, [stoneskin](../../spell_dir/stoneskin#_stoneskin, [summon monster IV](../../spell_dir/summonMonster#_summon-monster-iv, [tongues](../../spell_dir/tongues#_tongues, [wall of fire](../../spell_dir/wallOfFire#_wall-of-fire, [wall of ice](../../spell_dir/wallOfIce#_wall-of-ice, [water breathing](../../spell_dir/waterBreathing#_water-breathing._

**4th-Level Summoner Spells** —_ [acid pit\*](../spell_dir/acidPit#_acid-pit-, [baleful polymorph](../../spell_dir/balefulPolymorph#_baleful-polymorph), [bear's endurance (mass](../../spell_dir/bearSEndurance#_bear-s-endurance-mass), [bull's strength (mass](../../spell_dir/bullSStrength#_bull-s-strength-mass, [cat's](../../spell_dir/catSGrace#_cat-s-grace-mass [grace](../spell_dir/grace#_grace) (mass, [contact other plane](../../spell_dir/contactOtherPlane#_contact-other-plane, [dismissal](../../spell_dir/dismissal#_dismissal), [eagle's splendor (mass](../../spell_dir/eagleSSplendor#_eagle-s-splendor-mass), [evolution surge (greater\*](../spell_dir/evolutionSurge#_evolution-surge,-greater, [fox's](../../spell_dir/foxSCunning#_fox-s-cunning-mass [cunning](../magicItem_dir/weapons#_cunning) (mass, [hold monster](../../spell_dir/holdMonster#_hold-monster, [insect plague](../../spell_dir/insectPlague#_insect-plague, [mage's faithful hound](../../spell_dir/mageSFaithfulHound#_mage-s-faithful-hound, [magic jar](../../spell_dir/magicJar#_magic-jar, [major creation](../../spell_dir/majorCreation#_major-creation, [overland flight](../../spell_dir/overlandFlight#_overland-flight), [owl's wisdom (mass](../../spell_dir/owlSWisdom#_owl-s-wisdom-mass), [planar binding (lesser](../../spell_dir/planarBinding#_planar-binding-lesser, [purified calling\*](../spell_dir/purifiedCalling#_purified-calling, [sending](../../spell_dir/sending#_sending, [summon monster V](../../spell_dir/summonMonster#_summon-monster-v, [teleport](../../spell_dir/teleport#_teleport, [transmogrify\*](../spell_dir/transmogrify#_transmogrify, [wall of stone](../../spell_dir/wallOfStone#_wall-of-stone._

**5th-Level Summoner Spells** —_ [banishment](../../spell_dir/banishment#_banishment, [creeping doom](../../spell_dir/creepingDoom#_creeping-doom), [dispel magic (greater](../../spell_dir/dispelMagic#_dispel-magic-greater [ethereal jaunt](../../spell_dir/etherealJaunt#_ethereal-jaunt), [heroism (greater](../../spell_dir/heroism#_heroism-greater, [hungry pit\*](../spell_dir/hungryPit#_hungry-pit-), [invisibility (mass](../../spell_dir/invisibility#_invisibility-mass, [planar adaptation\*](../spell_dir/planarAdaptation#_planar-adaptation, [planar binding](../../spell_dir/planarBinding#_planar-binding, [plane shift](../../spell_dir/planeShift#_plane-shift, [repulsion](../../spell_dir/repulsion#_repulsion), [rejuvenate eidolon (greater\*](../spell_dir/rejuvenateEidolon#_rejuvenate-eidolon,-greater, [sequester](../../spell_dir/sequester#_sequester, [simulacrum](../../spell_dir/simulacrum#_simulacrum, [spell turning](../../spell_dir/spellTurning#_spell-turning, [summon monster VII](../../spell_dir/summonMonster#_summon-monster-vii), [teleport (greater](../../spell_dir/teleport#_teleport-greater, [true seeing](../../spell_dir/trueSeeing#_true-seeing, [wall of iron](../../spell_dir/wallOfIron#_wall-of-iron._

**6th-Level Summoner Spells** —_ [antipathy](../../spell_dir/antipathy#_antipathy, [binding](../../spell_dir/binding#_binding), [charm monster (mass](../../spell_dir/charmMonster#_charm-monster-mass, [dimensional lock](../../spell_dir/dimensionalLock#_dimensional-lock, [discern location](../../spell_dir/discernLocation#_discern-location, [dominate monster](../../spell_dir/dominateMonster#_dominate-monster, [incendiary cloud](../../spell_dir/incendiaryCloud#_incendiary-cloud, [maze](../../spell_dir/maze#_maze), [planar adaptation (mass\*](../spell_dir/planarAdaptation#_planar-adaptation,-mass), [planar binding (greater](../../spell_dir/planarBinding#_planar-binding-greater, [protection from spells](../../spell_dir/protectionFromSpells#_protection-from-spells, [summon monster VIII](../../spell_dir/summonMonster#_summon-monster-viii, [sympathy](../../spell_dir/sympathy#_sympathy, [teleportation circle](../../spell_dir/teleportationCircle#_teleportation-circle._

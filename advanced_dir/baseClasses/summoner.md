...
The summoner's class skills are [Craft](../../skills/craft#_craft) (Int), [Fly](../../skills/fly#_fly) (Dex), [Handle Animal](../../skills/handleAnimal#_handle-animal) (Cha), [Knowledge](../../skills/knowledge#_knowledge) (all) (Int), [Linguistics](../../skills/linguistics#_linguistics) (Int), [Profession](../../skills/profession#_profession) (Wis), [Ride](../../skills/ride#_ride) (Dex), [Spellcraft](../../skills/spellcraft#_spellcraft) (Int), and [Use Magic Device](../../skills/useMagicDevice#_use-magic-device) (Cha).
...
| --- | --- | --- | --- | --- | --- |
| 1st | +0 | +0 | +0 | +2 | Cantrips, eidolon, life link,_ [summon monster I](../../spells/summonMonster#_summon-monster-i)_ | 1 | — | — | — | — | — |
| 2nd | +1 | +0 | +0 | +3 | Bond senses | 2 | — | — | — | — | — |
| 3rd | +2 | +1 | +1 | +3 | _ [Summon monster II](../../spells/summonMonster#_summon-monster-ii)_ | 3 | — | — | — | — | — |
| 4th | +3 | +1 | +1 | +4 | Shield ally | 3 | 1 | — | — | — | — |
| 5th | +3 | +1 | +1 | +4 | _ [Summon monster III](../../spells/summonMonster#_summon-monster-iii)_ | 4 | 2 | — | — | — | — |
| 6th | +4 | +2 | +2 | +5 | Maker's call | 4 | 3 | — | — | — | — |
| 7th | +5 | +2 | +2 | +5 | _ [Summon monster IV](../../spells/summonMonster#_summon-monster-iv)_ | 4 | 3 | 1 | — | — | — |
| 8th | +6/+1 | +2 | +2 | +6 | Transposition | 4 | 4 | 2 | — | — | — |
| 9th | +6/+1 | +3 | +3 | +6 | _ [Summon monster V](../../spells/summonMonster#_summon-monster-v)_ | 5 | 4 | 3 | — | — | — |
| 10th | +7/+2 | +3 | +3 | +7 | Aspect | 5 | 4 | 3 | 1 | — | — |
| 11th | +8/+3 | +3 | +3 | +7 | _ [Summon monster VI](../../spells/summonMonster#_summon-monster-vi)_ | 5 | 4 | 4 | 2 | — | — |
| 12th | +9/+4 | +4 | +4 | +8 | Greater shield ally | 5 | 5 | 4 | 3 | — | — |
| 13th | +9/+4 | +4 | +4 | +8 | _ [Summon monster VII](../../spells/summonMonster#_summon-monster-vii)_ | 5 | 5 | 4 | 3 | 1 | — |
| 14th | +10/+5 | +4 | +4 | +9 | Life bond | 5 | 5 | 4 | 4 | 2 | — |
| 15th | +11/+6/+1 | +5 | +5 | +9 | _ [Summon monster VIII](../../spells/summonMonster#_summon-monster-viii)_ | 5 | 5 | 5 | 4 | 3 | — |
| 16th | +12/+7/+2 | +5 | +5 | +10 | Merge forms | 5 | 5 | 5 | 4 | 3 | 1 |
| 17th | +12/+7/+2 | +5 | +5 | +10 | _ [Summon monster IX](../../spells/summonMonster#_summon-monster-ix)_ | 5 | 5 | 5 | 4 | 4 | 2 |
| 18th | +13/+8/+3 | +6 | +6 | +11 | Greater aspect | 5 | 5 | 5 | 5 | 4 | 3 |
| 19th | +14/+9/+4 | +6 | +6 | +11 | _ [Gate](../../spells/gate#_gate)_ | 5 | 5 | 5 | 5 | 5 | 4 |
...
**Eidolon** : A summoner begins play with the ability to summon to his side a powerful outsider called an eidolon. The eidolon forms a link with the summoner, who, forever after, summons an aspect of the same creature. An eidolon has the same alignment as the summoner that calls it and can speak all of his languages. Eidolons are treated as summoned creatures, except that they are not sent back to their home plane until reduced to a number of negative hit points equal to or greater than their Constitution score. In addition, due to its tie to its summoner, an eidolon can touch and attack creatures warded by _ [protection from evil](../../spells/protectionFromEvil#_protection-from-evil)_ and similar effects that prevent contact with summoned creatures.

A summoner can summon his eidolon in a ritual that takes 1 minute to perform. When summoned in this way, the eidolon hit points are unchanged from the last time it was summoned. The only exception to this is if the eidolon was slain, in which case it returns with half its normal hit points. The eidolon does not heal naturally. The eidolon remains until dismissed by the summoner (a standard action). If the eidolon is sent back to its home plane due to death, it cannot be summoned again until the following day. The eidolon cannot be sent back to its home plane by means of _ [dispel magic](../../spells/dispelMagic#_dispel-magic)_, but spells such as _ [dismissal](../../spells/dismissal#_dismissal) _and _ [banishment](../../spells/banishment#_banishment)_ work normally. If the summoner is unconscious, asleep, or killed, his eidolon is immediately banished.

The eidolon takes a form shaped by the summoner's desires. The eidolon's Hit Dice, saving throws, skills, feats, and abilities are tied to the summoner's class level and increase as the summoner gains levels. In addition, each eidolon receives a pool of evolution points, based on the summoner's class level, that can be used to give the eidolon different abilities and powers. Whenever the summoner gains a level, he must decide how these points are spent, and they are set until he gains another level of summoner.

The eidolon's physical appearance is up to the summoner, but it always appears as some sort of fantastical creature. This control is not fine enough to make the eidolon appear like a specific creature. The eidolon also bears a glowing rune that is identical to a rune that appears on the summoner's forehead as long as the eidolon is summoned. While this rune can be hidden through mundane means, it cannot be concealed through magic that changes appearance, such as _ [alter self](../../spells/alterSelf#_alter-self)_ or _ [polymorph](../../spells/polymorph#_polymorph)_ (although _ [invisibility](../../spells/invisibility#_invisibility) _does conceal it as long as the spell lasts).
...
**_Summon Monster I_ (Sp)** : Starting at 1st level, a summoner can cast _ [summon monster I](../../spells/summonMonster#_summon-monster-i)_ as a spell-like ability a number of times per day equal to 3 + his Charisma modifier. Drawing upon this ability uses up the same power as the summoner uses to call his eidolon. As a result, he can only use this ability when his eidolon is not summoned. He can cast this spell as a standard action and the creatures remain for 1 minute per level (instead of 1 round per level). At 3rd level, and every 2 levels thereafter, the power of this ability increases by one spell level, allowing him to summon more powerful creatures (to a maximum of _ [summon monster IX](../../spells/summonMonster#_summon-monster-ix)_ at 17th level). At 19th level, this ability can be used as _ [gate](../../spells/gate#_gate)_ or _ [summon monster IX](../../spells/summonMonster#_summon-monster-ix)_. If used as _ [gate](../../spells/gate#_gate)_, the summoner must pay any required material components. A summoner cannot have more than one _summon monster_ or _ [gate](../../spells/gate#_gate) _spell active in this way at one time. If this ability is used again, any existing _summon monster_ or _ [gate](../../spells/gate#_gate)_ immediately ends. These summon spells are considered to be part of his spell list for the purposes of spell trigger and spell completion items. In addition, he can expend uses of this ability to fufill the construction requirements of any magic item he creates, so long as he can use this ability to cast the required spell.
...
_ [Darkvision](../../spells/darkvision#_darkvision) (Ex)_: The eidolon has darkvision out to a range of 60 feet.
...
_ [Multiattack](../../monsters/monsterFeats#_multiattack)_: An eidolon gains [Multiattack](../../monsters/monsterFeats#_multiattack) as a bonus feat if it has 3 or more natural attacks and does not already have that feat. If it does not have the requisite 3 or more natural attacks (or it is reduced to less than 3 attacks), the eidolon instead gains a second attack with one of its natural weapons, albeit at a –5 penalty. If the eidolon later gains 3 or more natural attacks, it loses this additional attack and instead gains [Multiattack](../../monsters/monsterFeats#_multiattack).
...
| 9th | 7 | +7 | +5 | +2 | 28 | 4 | +6 | +3 | 13 | 5 | [Multiattack](../../monsters/monsterFeats#_multiattack) |
...
The following skills are class skills for eidolons: [Bluff](../../skills/bluff#_bluff) (Cha), [Craft](../../skills/craft#_craft) (Int), [Knowledge](../../skills/knowledge#_knowledge) (planes) (Int), [Perception](../../skills/perception#_perception) (Wis), [Sense Motive](../../skills/senseMotive#_sense-motive) (Wis), and [Stealth](../../skills/stealth#_stealth) (Dex). In addition, at 1st level, the summoner can choose 4 additional skills to be class skills for his eidolon. Note that eidolons with a fly speed receive [Fly](../../skills/fly#_fly) (Dex) as a free class skill, even if they do not gain a fly speed until a later level.
...
Alternatively, any one of these base forms can be used to make a Small eidolon. If the eidolon is Small, it gains a +2 bonus to its Dexterity score. It also takes a –4 penalty to its Strength and a –2 penalty to its Constitution. It also gains a +1 size bonus to its AC and attack rolls, a –1 penalty to its CMB and CMD scores, a +2 bonus on its [Fly](../../skills/fly#_fly) skill checks, and a +4 bonus on its [Stealth](../../skills/stealth#_stealth) skill checks. Reduce the damage of all of its attacks by one step (1d6 becomes 1d4, 1d4 becomes 1d3). If this choice is made, the eidolon can be made Medium whenever the summoner can change the eidolon's evolution pool (which causes it to lose these modifiers for being Small).
...
_ [Climb](../../skills/climb#_climb) (Ex)_: An eidolon becomes a skilled climber, gaining a climb speed equal to its base speed. This evolution can be selected more than once. Each additional time it is selected, increase the eidolon's climb speed by 20 feet.
...
_ [Improved Natural Armor](../../monsters/monsterFeats#_improved-natural-armor) (Ex)_: An eidolon's hide grows thick fur, rigid scales, or bony plates, giving it a +2 bonus to its natural armor. This evolution can be taken once for every five levels the summoner possesses.
...
_ [Mount](../../spells/mount#_mount) (Ex)_: An eidolon is properly skilled and formed to serve as a combat-trained mount. The eidolon must be at least one size category larger than its rider. This evolution is only available to eidolons of the quadruped and serpentine base forms.
...
_ [Resistance](../../spells/resistance#_resistance) (Ex)_: An eidolon's form takes on a resiliency to one particular energy type, which is usually reflected in its physical body (ashen hide for fire, icy breath for cold, and so on). Pick one energy type (acid, cold, electricity, fire, or sonic). The eidolon gains resist 5 against that energy type. This resistance increases by 5 for every 5 levels the summoner possesses, to a maximum of 15 at 10th level. This evolution can be selected more than once. Its effects do not stack. Each time an eidolon selects this evolution, it applies to a different energy type.
...
_ [Swim](../../skills/swim#_swim) (Ex)_: An eidolon gains webbed hands, feet, or powerful flippers, giving it a swim speed equal to its base speed. This evolution does not give the eidolon the ability to breathe underwater. This evolution can be selected more than once. Each additional time it is selected, increase the eidolon's swim speed by 20 feet.

_Tail (Ex)_: An eidolon grows a long, powerful tail. This grants it a +2 racial bonus on [Acrobatics](../../skills/acrobatics#_acrobatics) checks made to balance on a surface. This evolution can be selected more than once.
...
_ [Web](../../spells/web#_web) (Ex)_: An eidolon gains a pair of spinnerets, giving it the ability to spin webs. The eidolon can use these webs to support itself plus up to one creature of the same size. It can throw webbing as a ranged touch attack up to 8 times per day, entangling a creature up to one size larger than the eidolon. The webbing has a range of 50 feet and a 10-foot range increment. Creatures entangled by the web can escape with an [Escape Artist](../../skills/escapeArtist#_escape-artist) check or a Strength check (at a –4 penalty). The DC of these checks is equal to 10 + 1/2 the eidolon's HD + the eidolon's Con modifier. The webs have a Hardness of 0 and a number of hits points equal to the eidolon's total Hit Dice. The eidolon can climb its own webs at its climb speed and can pinpoint any creature touching its webs. The eidolon must possess the climb evolution to take this evolution. The summoner must be at least 7th level before selecting this evolution.
...
_Spell [Resistance](../../spells/resistance#_resistance) (Ex)_: An eidolon is protected against magic, gaining spell resistance. The eidolon's spell resistance is equal to 11 + the summoner's level. This spell resistance does not apply to spells cast by the summoner. The summoner must be at least 9th level before selecting this evolution.
...
**0-Level Summoner Spells** —_ [acid splash](../../spells/acidSplash#_acid-splash), [arcane mark](../../spells/arcaneMark#_arcane-mark), [daze](../../spells/daze#_daze), [detect magic](../../spells/detectMagic#_detect-magic), [guidance](../../spells/guidance#_guidance), [light](../../spells/light#_light), [mage hand](../../spells/mageHand#_mage-hand), [mending](../../spells/mending#_mending), [message](../../spells/message#_message), [open/close](../../spells/openClose#_open-close), [read magic](../../spells/readMagic#_read-magic), [resistance](../../spells/resistance#_resistance)._

**1st-Level Summoner Spells** —_ [alarm](../../spells/alarm#_alarm), [ant haul\*](../spells/antHaul#_ant-haul-), [daze monster](../../spells/dazeMonster#_daze-monster), [endure elements](../../spells/endureElements#_endure-elements), [enlarge person](../../spells/enlargePerson#_enlarge-person), [expeditious retreat](../../spells/expeditiousRetreat#_expeditious-retreat), [feather fall](../../spells/featherFall#_feather-fall), [grease](../../spells/grease#_grease), [identify](../../spells/identify#_identify), [jump](../../spells/jump#_jump), [mage armor](../../spells/mageArmor#_mage-armor), [magic fang](../../spells/magicFang#_magic-fang), [magic mouth](../../spells/magicMouth#_magic-mouth), [mount](../../spells/mount#_mount), [protection from chaos](../../spells/protectionFromChaos#_protection-from-chaos)/evil/good/law, [reduce person](../../spells/reducePerson#_reduce-person), [rejuvenate eidolon (lesser)\*](../spells/rejuvenateEidolon#_rejuvenate-eidolon,-lesser), [shield](../../spells/shield#_shield), [summon monster I](../../spells/summonMonster#_summon-monster-i), [unfetter\*](../spells/unfetter#_unfetter), [unseen servant](../../spells/unseenServant#_unseen-servant), [ventriloquism](../../spells/ventriloquism#_ventriloquism)._

**2nd-Level Summoner Spells** —_ [alter self](../../spells/alterSelf#_alter-self), [barkskin](../../spells/barkskin#_barkskin), [bear's endurance](../../spells/bearSEndurance#_bear-s-endurance), [blur](../../spells/blur#_blur), [bull's strength](../../spells/bullSStrength#_bull-s-strength), [cat's grace](../../spells/catSGrace#_cat-s-grace), [create pit\*](../spells/createPit#_create-pit-), [detect thoughts](../../spells/detectThoughts#_detect-thoughts), [eagle's splendor](../../spells/eagleSSplendor#_eagle-s-splendor), [evolution surge (lesser)\*](../spells/evolutionSurge#_evolution-surge,-lesser), [fox's cunning](../../spells/foxSCunning#_fox-s-cunning), [glide\*](../spells/glide#_glide-), [glitterdust](../../spells/glitterdust#_glitterdust), [haste](../../spells/haste#_haste), [invisibility](../../spells/invisibility#_invisibility), [levitate](../../spells/levitate#_levitate), [misdirection](../../spells/misdirection#_misdirection), [owl's wisdom](../../spells/owlSWisdom#_owl-s-wisdom), [phantom steed](../../spells/phantomSteed#_phantom-steed), [protection from arrows](../../spells/protectionFromArrows#_protection-from-arrows), [resist energy](../../spells/resistEnergy#_resist-energy), [see invisibility](../../spells/seeInvisibility#_see-invisibility), [slow](../../spells/slow#_slow), [spider climb](../../spells/spiderClimb#_spider-climb), [summon eidolon\*](../spells/summonEidolon#_summon-eidolon), [summon monster II](../../spells/summonMonster#_summon-monster-ii), [summon swarm](../../spells/summonSwarm#_summon-swarm), [wind wall](../../spells/windWall#_wind-wall)._

**3rd-Level Summoner Spells** —_ [aqueous orb\*](../spells/aqueousOrb#_aqueous-orb), [black tentacles](../../spells/blackTentacles#_black-tentacles), [charm monster](../../spells/charmMonster#_charm-monster), [devolution\*](../spells/devolution#_devolution), [dimension door](../../spells/dimensionDoor#_dimension-door), [dimensional anchor](../../spells/dimensionalAnchor#_dimensional), [dispel magic](../../spells/dispelMagic#_dispel-magic), [displacement](../../spells/displacement#_displacement), [enlarge person (mass)](../../spells/enlargePerson#_enlarge-person-mass), [evolution surge\*](../spells/evolutionSurge#_evolution-surge), [fire shield](../../spells/fireShield#_fire-shield), [fly](../../spells/fly), [heroism](../../spells/heroism#_heroism), [invisibility (greater)](../../spells/invisibility#_invisibility-greater), [locate creature](../../spells/locateCreature#_locate-creature), [magic circle against chaos](../../spells/magicCircleAgainstChaos#_magic-circle-against-chaos)/evil/good/law, [magic fang (greater)](../../spells/magicFang#_magic-fang-greater), [minor creation](../../spells/minorCreation#_minor-creation), [nondetection](../../spells/nondetection#_nondetection), [protection from energy](../../spells/protectionFromEnergy#_protection-from-energy), [rage](../../spells/rage#_rage), [reduce person (mass)](../../spells/reducePerson#_reduce-person-mass), [rejuvenate eidolon\*](../spells/rejuvenateEidolon#_rejuvenate-eidolon), [seek thoughts\*](../spells/seekThoughts#_seek-thoughts), [spiked pit\*](../spells/spikedPit#_spiked-pit), [stoneskin](../../spells/stoneskin#_stoneskin), [summon monster IV](../../spells/summonMonster#_summon-monster-iv), [tongues](../../spells/tongues#_tongues), [wall of fire](../../spells/wallOfFire#_wall-of-fire), [wall of ice](../../spells/wallOfIce#_wall-of-ice), [water breathing](../../spells/waterBreathing#_water-breathing)._

**4th-Level Summoner Spells** —_ [acid pit\*](../spells/acidPit#_acid-pit-), [baleful polymorph](../../spells/balefulPolymorph#_baleful-polymorph), [bear's endurance (mass)](../../spells/bearSEndurance#_bear-s-endurance-mass), [bull's strength (mass)](../../spells/bullSStrength#_bull-s-strength-mass), [cat's](../../spells/catSGrace#_cat-s-grace-mass) [grace](../spells/grace#_grace) (mass), [contact other plane](../../spells/contactOtherPlane#_contact-other-plane), [dismissal](../../spells/dismissal#_dismissal), [eagle's splendor (mass)](../../spells/eagleSSplendor#_eagle-s-splendor-mass), [evolution surge (greater)\*](../spells/evolutionSurge#_evolution-surge,-greater), [fox's](../../spells/foxSCunning#_fox-s-cunning-mass) [cunning](../magicItems/weapons#_cunning) (mass), [hold monster](../../spells/holdMonster#_hold-monster), [insect plague](../../spells/insectPlague#_insect-plague), [mage's faithful hound](../../spells/mageSFaithfulHound#_mage-s-faithful-hound), [magic jar](../../spells/magicJar#_magic-jar), [major creation](../../spells/majorCreation#_major-creation), [overland flight](../../spells/overlandFlight#_overland-flight), [owl's wisdom (mass)](../../spells/owlSWisdom#_owl-s-wisdom-mass), [planar binding (lesser)](../../spells/planarBinding#_planar-binding-lesser), [purified calling\*](../spells/purifiedCalling#_purified-calling), [sending](../../spells/sending#_sending), [summon monster V](../../spells/summonMonster#_summon-monster-v), [teleport](../../spells/teleport#_teleport), [transmogrify\*](../spells/transmogrify#_transmogrify), [wall of stone](../../spells/wallOfStone#_wall-of-stone)._

**5th-Level Summoner Spells** —_ [banishment](../../spells/banishment#_banishment), [creeping doom](../../spells/creepingDoom#_creeping-doom), [dispel magic (greater)](../../spells/dispelMagic#_dispel-magic-greater) [ethereal jaunt](../../spells/etherealJaunt#_ethereal-jaunt), [heroism (greater)](../../spells/heroism#_heroism-greater), [hungry pit\*](../spells/hungryPit#_hungry-pit-), [invisibility (mass)](../../spells/invisibility#_invisibility-mass), [planar adaptation\*](../spells/planarAdaptation#_planar-adaptation), [planar binding](../../spells/planarBinding#_planar-binding), [plane shift](../../spells/planeShift#_plane-shift), [repulsion](../../spells/repulsion#_repulsion), [rejuvenate eidolon (greater)\*](../spells/rejuvenateEidolon#_rejuvenate-eidolon,-greater), [sequester](../../spells/sequester#_sequester), [simulacrum](../../spells/simulacrum#_simulacrum), [spell turning](../../spells/spellTurning#_spell-turning), [summon monster VII](../../spells/summonMonster#_summon-monster-vii), [teleport (greater)](../../spells/teleport#_teleport-greater), [true seeing](../../spells/trueSeeing#_true-seeing), [wall of iron](../../spells/wallOfIron#_wall-of-iron)._

**6th-Level Summoner Spells** —_ [antipathy](../../spells/antipathy#_antipathy), [binding](../../spells/binding#_binding), [charm monster (mass)](../../spells/charmMonster#_charm-monster-mass), [dimensional lock](../../spells/dimensionalLock#_dimensional-lock), [discern location](../../spells/discernLocation#_discern-location), [dominate monster](../../spells/dominateMonster#_dominate-monster), [incendiary cloud](../../spells/incendiaryCloud#_incendiary-cloud), [maze](../../spells/maze#_maze), [planar adaptation (mass)\*](../spells/planarAdaptation#_planar-adaptation,-mass), [planar binding (greater)](../../spells/planarBinding#_planar-binding-greater), [protection from spells](../../spells/protectionFromSpells#_protection-from-spells), [summon monster VIII](../../spells/summonMonster#_summon-monster-viii), [sympathy](../../spells/sympathy#_sympathy), [teleportation circle](../../spells/teleportationCircle#_teleportation-circle)._

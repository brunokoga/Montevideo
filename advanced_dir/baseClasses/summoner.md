---
title: advance_dir/baseClasses/summoner
---
# Summoner
...
| --- | --- | --- | --- | --- | --- |
| 1st | +0 | +0 | +0 | +2 | Cantrips, eidolon, life link,_ [summon monster I](../../spell_dir/summonMonster#_summon-monster-i)_ | 1 | — | — | — | — | — |
| 2nd | +1 | +0 | +0 | +3 | Bond senses | 2 | — | — | — | — | — |
| 3rd | +2 | +1 | +1 | +3 | _ [Summon monster II](../../spell_dir/summonMonster#_summon-monster-ii)_ | 3 | — | — | — | — | — |
| 4th | +3 | +1 | +1 | +4 | Shield ally | 3 | 1 | — | — | — | — |
| 5th | +3 | +1 | +1 | +4 | _ [Summon monster III](../../spell_dir/summonMonster#_summon-monster-iii)_ | 4 | 2 | — | — | — | — |
| 6th | +4 | +2 | +2 | +5 | Maker's call | 4 | 3 | — | — | — | — |
| 7th | +5 | +2 | +2 | +5 | _ [Summon monster IV](../../spell_dir/summonMonster#_summon-monster-iv)_ | 4 | 3 | 1 | — | — | — |
| 8th | +6/+1 | +2 | +2 | +6 | Transposition | 4 | 4 | 2 | — | — | — |
| 9th | +6/+1 | +3 | +3 | +6 | _ [Summon monster V](../../spell_dir/summonMonster#_summon-monster-v)_ | 5 | 4 | 3 | — | — | — |
| 10th | +7/+2 | +3 | +3 | +7 | Aspect | 5 | 4 | 3 | 1 | — | — |
| 11th | +8/+3 | +3 | +3 | +7 | _ [Summon monster VI](../../spell_dir/summonMonster#_summon-monster-vi)_ | 5 | 4 | 4 | 2 | — | — |
| 12th | +9/+4 | +4 | +4 | +8 | Greater shield ally | 5 | 5 | 4 | 3 | — | — |
| 13th | +9/+4 | +4 | +4 | +8 | _ [Summon monster VII](../../spell_dir/summonMonster#_summon-monster-vii)_ | 5 | 5 | 4 | 3 | 1 | — |
| 14th | +10/+5 | +4 | +4 | +9 | Life bond | 5 | 5 | 4 | 4 | 2 | — |
| 15th | +11/+6/+1 | +5 | +5 | +9 | _ [Summon monster VIII](../../spell_dir/summonMonster#_summon-monster-viii)_ | 5 | 5 | 5 | 4 | 3 | — |
| 16th | +12/+7/+2 | +5 | +5 | +10 | Merge forms | 5 | 5 | 5 | 4 | 3 | 1 |
| 17th | +12/+7/+2 | +5 | +5 | +10 | _ [Summon monster IX](../../spell_dir/summonMonster#_summon-monster-ix)_ | 5 | 5 | 5 | 4 | 4 | 2 |
| 18th | +13/+8/+3 | +6 | +6 | +11 | Greater aspect | 5 | 5 | 5 | 5 | 4 | 3 |
| 19th | +14/+9/+4 | +6 | +6 | +11 | _ [Gate](../../spell_dir/gate#_gate)_ | 5 | 5 | 5 | 5 | 5 | 4 |
...
A summoner can summon his eidolon in a ritual that takes 1 minute to perform. When summoned in this way, the eidolon hit points are unchanged from the last time it was summoned. The only exception to this is if the eidolon was slain, in which case it returns with half its normal hit points. The eidolon does not heal naturally. The eidolon remains until dismissed by the summoner (a standard action). If the eidolon is sent back to its home plane due to death, it cannot be summoned again until the following day. The eidolon cannot be sent back to its home plane by means of _ [dispel magic](../../spell_dir/dispelMagic#_dispel-magic)_, but spells such as _ [dismissal](../../spell_dir/dismissal#_dismissal) _and _ [banishment](../../spell_dir/banishment#_banishment)_ work normally. If the summoner is unconscious, asleep, or killed, his eidolon is immediately banished.

The eidolon takes a form shaped by the summoner's desires. The eidolon's Hit Dice, saving throws, skills, feats, and abilities are tied to the summoner's class level and increase as the summoner gains levels. In addition, each eidolon receives a pool of evolution points, based on the summoner's class level, that can be used to give the eidolon different abilities and powers. Whenever the summoner gains a level, he must decide how these points are spent, and they are set until he gains another level of summoner.

The eidolon's physical appearance is up to the summoner, but it always appears as some sort of fantastical creature. This control is not fine enough to make the eidolon appear like a specific creature. The eidolon also bears a glowing rune that is identical to a rune that appears on the summoner's forehead as long as the eidolon is summoned. While this rune can be hidden through mundane means, it cannot be concealed through magic that changes appearance, such as _ [alter self](../../spell_dir/alterSelf#_alter-self)_ or _ [polymorph](../../spell_dir/polymorph#_polymorph)_ (although _ [invisibility](../../spell_dir/invisibility#_invisibility) _does conceal it as long as the spell lasts).
...
**St_dir/Dex Bonus** : Add this modifier to the eidolon's Strength and Dexterity scores, as determined by its base form. Some options available through the eidolon's evolution pool might modify these scores.
...
_ [Multiattack](../../monster_dir/monsterFeats#_multiattack)_: An eidolon gains [Multiattack](../../monster_dir/monsterFeats#_multiattack) as a bonus feat if it has 3 or more natural attacks and does not already have that feat. If it does not have the requisite 3 or more natural attacks (or it is reduced to less than 3 attacks), the eidolon instead gains a second attack with one of its natural weapons, albeit at a –5 penalty. If the eidolon later gains 3 or more natural attacks, it loses this additional attack and instead gains [Multiattack](../../monster_dir/monsterFeats#_multiattack).
...
_Tail (Ex)_: An eidolon grows a long, powerful tail. This grants it a +2 racial bonus on [Acrobatics](../../skill_dir/acrobatics#_acrobatics) checks made to balance on a surface. This evolution can be selected more than once.

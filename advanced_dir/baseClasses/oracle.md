...
The oracle's class skills are [Craft](../../skills/craft#_craft) (Int), [Diplomacy](../../skills/diplomacy#_diplomacy) (Cha), [Heal](../../skills/heal#_heal) (Wis), [Knowledge](../../skills/knowledge#_knowledge) (history) (Int), [Knowledge](../../skills/knowledge#_knowledge) (planes) (Int), [Knowledge](../../skills/knowledge#_knowledge) (religion) (Int), [Profession](../../skills/profession#_profession) (Wis), [Sense Motive](../../skills/senseMotive#_sense-motive) (Wis), and [Spellcraft](../../skills/spellcraft#_spellcraft) (Int). In addition, oracles receive additional class skills depending upon their oracle mystery.
...
_Deaf_: You cannot hear and suffer all of the usual penalties for being deafened. You cast all of your spells as if they were modified by the [Silent Spell](../../feats#_silent-spell) feat. This does not increase their level or casting time. At 5th level, you receive a +3 competence bonus on [Perception](../../skills/perception#_perception) checks that do not rely upon hearing, and the initiative penalty for being deaf is reduced to –2. At 10th level, you gain scent and you do not suffer any penalty on initiative checks due to being deaf. At 15th level, you gain tremorsense out to a range of 30 feet.

_Haunted_: Malevolent spirits follow you wherever you go, causing minor mishaps and strange occurrences (such as unexpected breezes, small objects moving on their own, and faint noises). Retrieving any stored item from your gear requires a standard action, unless it would normally take longer. Any item you drop lands 10 feet away from you in a random direction. Add _ [mage hand](../../spells/mageHand#_mage-hand)_ and _ [ghost sound](../../spells/ghostSound#_ghost-sound)_ to your list of spells known. At 5th level, add _ [levitate](../../spells/levitate#_levitate)_ and _ [minor image](../../spells/minorImage#_minor-image) _to your list of spells known. At 10th level, add _ [telekinesis](../../spells/telekinesis#_telekinesis) _to your list of spells known. At 15th level, add _ [reverse gravity](../../spells/reverseGravity#_reverse-gravity)_ to your list of spells known.
...
**Class Skills** : An oracle with the battle mystery adds [Intimidate](../../skills/intimidate#_intimidate), [Knowledge](../../skills/knowledge#_knowledge) (engineering), [Perception](../../skills/perception#_perception), and [Ride](../../skills/ride#_ride) to her list of class skills.

**Bonus Spells** : _ [enlarge person](../../spells/enlargePerson#_enlarge-person)_ (2nd), _ [fog cloud](../../spells/fogCloud) _(4th), _ [magic vestment](../../spells/magicVestment#_magic-vestment)_ (6th), _ [wall of fire](../../spells/wallOfFire#_wall-of-fire)_ (8th), _ [righteous might](../../spells/righteousMight#_righteous-might)_ (10th), _ [mass bull's strength](../../spells/bullSStrength#_bull-s-strength-mass)_ (12th), _ [control weather](../../spells/controlWeather#_control-weather)_ (14th), _ [earthquake](../../spells/earthquake#_earthquake)_ (16th), _ [storm of vengeance](../../spells/stormOfVengeance#_storm-of-vengeance)_ (18th).
...
_Iron Skin (Su)_: Once per day, your skin hardens and takes on the appearance of iron, granting you DR 10/adamantine. This functions as _ [stoneskin](../../spells/stoneskin#_stoneskin)_, using your oracle level as the caster level. At 15th level, you can use this ability twice per day. You must be at least 11th level to select this revelation.
...
**Class Skills** : An oracle with a bones mystery adds [Bluff](../../skills/bluff#_bluff), [Disguise](../../skills/disguise#_disguise), [Intimidate](../../skills/intimidate#_intimidate), and [Stealth](../../skills/stealth#_stealth) to her list of class skills.

**Bonus Spells** : _ [cause fear](../../spells/causeFear#_cause-fear) _(2nd), _ [false life](../../spells/falseLife#_false-life)_ (4th), _ [animate dead](../../spells/animateDead#_animate-dead)_ (6th), _ [fear](../../spells/fear#_fear) _(8th), _ [slay living](../../spells/slayLiving#_slay-living)_ (10th), _ [circle of death](../../spells/circleOfDeath#_circle-of-death)_ (12th), _ [control undead](../../spells/controlUndead#_control-undead)_ (14th), _ [horrid wilting](../../spells/horridWilting#_horrid-wilting) _(16th), _ [wail of the banshee](../../spells/wailOfTheBanshee#_wail-of-the-banshee)_ (18th).
...
_Bleeding Wounds (Su)_: Whenever a creature takes damage from one of your spells or effects that causes negative energy damage (such as _ [inflict light wounds](../../spells/inflictLightWounds#_inflict-light-wounds)_ or the death's touch revelation), it begins to bleed, taking 1 point of damage each round. At 5th level, and every five levels thereafter, this damage increases by 1. The bleeding can be stopped by a DC 15 [Heal](../../skills/heal#_heal) check or any effect that heals damage.
...
_Voice of the Grave (Su)_: You can _ [speak with dead](../../spells/speakWithDead#_speak-with-dead)_, as per the spell, for a number of rounds per day equal to your oracle level. These rounds do not need to be consecutive. At 5th level, and every five levels thereafter, the dead creature takes a cumulative –2 penalty on its Will save to resist this effect.

**Final Revelation** : Upon reaching 20th level, you become a master of death. Once per round, you can cast _ [bleed](../../spells/bleed#_bleed)_ or _ [stabilize](../../spells/stabilize#_stabilize) _as a free action. If you are brought to below 0 hit points, you automatically stabilize. You can cast _ [animate dead](../../spells/animateDead#_animate-dead)_ at will without paying a material component cost (although you are still subject to the usual Hit Die control limit). Once per day, you can cast _ [power word kill](../../spells/powerWordKill#_power-word-kill)_, but the spell can target a creature with 150 hit points or less.

## Flame

**Class Skills** : An oracle with the flame mystery adds [Acrobatics](../../skills/acrobatics#_acrobatics), [Climb](../../skills/climb#_climb), [Intimidate](../../skills/intimidate#_intimidate), and [Perform](../../skills/perform#_perform) to her list of class skills.

**Bonus Spells** : _ [burning hands](../../spells/burningHands#_burning-hands) _(2nd), _ [resist energy](../../spells/resistEnergy#_resist-energy) _(4th), _ [fireball](../../spells/fireball#_fireball) _(6th), _ [wall of fire](../../spells/wallOfFire#_wall-of-fire) _(8th), _ [summon monster V](../../spells/summonMonster#_summon-monster-v)_ (fire elementals only, 10th), _ [fire seeds](../../spells/fireSeeds#_fire-seeds) _(12th), _ [fire storm](../../spells/fireStorm#_fire-storm) _(14th), _ [incendiary cloud](../../spells/incendiaryCloud#_incendiary-cloud) _(16th), _ [fiery body\*](../spells/fieryBody#_fiery-body) _(18th).
...
_Form of Flame (Su)_: As a standard action, you can assume the form of a Small fire elemental, as _ [elemental body I](../../spells/elementalBody#_elemental-body-i)_. At 9th level, you can assume the form of a Medium fire elemental, as _ [elemental body II](../../spells/elementalBody#_elemental-body-ii)_. At 11th level, you can assume the form of a Large fire elemental, as _ [elemental body III](../../spells/elementalBody#_elemental-body-iii)_. At 13th level, you can assume the form of a Huge fire elemental, as _ [elemental body IV](../../spells/elementalBody#_elemental-body-iv)_. You can use this ability once per day, but the duration is 1 hour/level. You must be at least 7th level to select this revelation.
...
**Class Skills** : An oracle with the heavens mystery adds [Fly](../../skills/fly#_fly), [Knowledge](../../skills/knowledge#_knowledge) (arcana), [Perception](../../skills/perception#_perception), and [Survival](../../skills/survival#_survival) to her list of class skills.

**Bonus Spells** : _ [color spray](../../spells/colorSpray#_color-spray)_ (2nd), _ [hypnotic pattern](../../spells/hypnoticPattern#_hypnotic-pattern)_ (4th), _ [daylight](../../spells/daylight#_daylight)_ (6th), _ [rainbow pattern](../../spells/rainbowPattern#_rainbow-pattern)_ (8th), _ [overland flight](../../spells/overlandFlight#_overland-flight)_ (10th), _ [chain lightning](../../spells/chainLightning#_chain-lightning)_ (12th), _ [prismatic spray](../../spells/prismaticSpray#_prismatic-spray)_ (14th), _ [sunburst](../../spells/sunburst#_sunburst)_ (16th), _ [meteor swarm](../../spells/meteorSwarm#_meteor-swarm)_ (18th).
...
_Dweller in [Darkness](../../spells/darkness#_darkness) (Sp)_: Once per day, you cast your psyche into the void of space to attract the attention of a terrible otherworldly being. The dweller in darkness behaves in all ways as if you had cast _ [phantasmal killer](../../spells/phantasmalKiller#_phantasmal-killer)_. At 17th level, the dweller in darkness can be perceived by more than one creature, as if you had cast _ [weird](../../spells/weird#_weird)_. You must be at least 11th level to choose this revelation.
...
_Star Chart (Ex)_: Your copious notes contain a working model of the night sky expressed in artistic scribbles and arcane mathematical formulae. Once per day, you may spend 10 minutes contemplating your star chart to gain the benefit of the spell _ [commune](../../spells/commune#_commune)_. You must be at least 7th level to select this revelation.

**Final Revelation** : Upon achieving 20th level, your rapport with the heavens grants you perfect harmony with the universe. You receive a bonus on all saving throws equal to your Charisma modifier. You automatically stabilize if you are below 0 hit points, are immune to fear effects, and automatically confirm all critical hits. Should you die, you are reborn 3 days later in the form of a star child, who matures over the course of 7 days (treat as the _ [reincarnate](../../spells/reincarnate#_reincarnate)_ spell).

## Life

**Class Skills** : An oracle with the life mystery adds [Handle Animal](../../skills/handleAnimal#_handle-animal), [Knowledge](../../skills/knowledge#_knowledge) (nature), and [Survival](../../skills/survival#_survival) to her list of class skills.

**Bonus Spells** : _ [detect undead](../../spells/detectUndead#_detect-undead)_ (2nd), _ [lesser restoration](../../spells/restoration#_restoration-lesser)_ (4th), _ [neutralize poison](../../spells/neutralizePoison#_neutralize-poison)_ (6th), _ [restoration](../../spells/restoration#_restoration)_ (8th), _ [breath of life](../../spells/breathOfLife#_breath-of-life)_ (10th), _ [heal](../../spells/heal#_heal)_ (12th), _ [greater restoration](../../spells/restoration#_restoration-greater)_ (14th), _ [mass heal](../../spells/heal#_heal-mass)_ (16th), _ [true resurrection](../../spells/trueResurrection#_true-resurrection)_ (18th).
...
_Enhanced Cures (Su)_: Whenever you cast a cure spell, the maximum number of hit points healed is based on your oracle level, not the limit based on the spell. For example, an 11th-level oracle of life with this revelation may cast _ [cure light wounds](../../spells/cureLightWounds#_cure-light-wounds)_ to heal 1d8+11 hit points instead of the normal 1d8+5 maximum.

_Healing Hands (Ex)_: You gain a +4 bonus on [Heal](../../skills/heal#_heal) checks. You may provide first aid to two people or treat two people for poison as a standard action (make a separate [Heal](../../skills/heal#_heal) check for each creature). When using the [Heal](../../skills/heal#_heal) skill to treat wounds from caltrops (and so on), treat deadly wounds, treat poison, treat disease, or treat long-term care, you may treat double the normal number of people you may treat at the same time. You may provide long-term care for yourself.
...
**Class Skills** : An oracle with the lore mystery adds [Appraise](../../skills/appraise#_appraise) and all [Knowledge](../../skills/knowledge#_knowledge) skills to her list of class skills.

**Bonus Spells** : _ [identify](../../spells/identify#_identify)_ (2nd), _ [tongues](../../spells/tongues#_tongues)_ (4th), _ [locate object](../../spells/locateObject#_locate-object) _(6th), _ [legend lore](../../spells/legendLore#_legend-lore)_ (8th), _ [contact other plane](../../spells/contactOtherPlane#_contact-other-plane)_ (10th), _ [mass owl's wisdom](../../spells/owlSWisdom#_owl-s-wisdom-mass)_ (12th), _ [vision](../../spells/vision#_vision)_ (14th), _ [moment of prescience](../../spells/momentOfPrescience#_moment-of-prescience)_ (16th), _ [time stop](../../spells/timeStop#_time-stop)_ (18th).
...
_Lore Keeper (Ex)_: Instead of encyclopedic knowledge, you learn most of your information through tales, songs, and poems. You may use your Charisma modifier instead of your Intelligence modifier on all [Knowledge](../../skills/knowledge#_knowledge) checks.
...
_Think On It (Ex)_: Once per day, the oracle of lore can re-attempt any previously failed [Knowledge](../../skills/knowledge#_knowledge) check. On this attempt, add a +10 competence bonus on the check.

_ [Whirlwind](../../spells/whirlwind#_whirlwind) Lesson (Ex)_: You can quickly browse through a magical tome or manual, gaining its benefits with only a single 8-hour study session (rather than the usual 48 hours over a period of 6 days). At 7th level, you may allow another character to join in your study; both of you gain the full benefit of having read the book. At 15th level, you may share your whirlwind lesson with a number of characters equal to your oracle level. The benefits to you are permanent, whereas your students gain the tome or manual's benefits for a number of days equal to your Charisma modifier but then forget what they have learned.

**Final Revelation** : You gain the ability to take 20 on all [Knowledge](../../skills/knowledge#_knowledge) skill checks. Your understanding of the fundamental underpinnings of reality has also become so advanced that once per day, you can cast _ [wish](../../spells/wish#_wish)_. This ability does not require a material component, but the _ [wish](../../spells/wish#_wish) _cannot be used to grant ability score bonuses, nor can it be used to replicate spells with expensive material components.

## Nature

**Class Skills** : An oracle with the nature mystery adds [Climb](../../skills/climb#_climb), [Fly](../../skills/fly#_fly), [Knowledge](../../skills/knowledge#_knowledge) (nature), [Ride](../../skills/ride#_ride), [Survival](../../skills/survival#_survival), and [Swim](../../skills/swim#_swim) to her list of class skills.

**Bonus Spells** : _ [charm animal](../../spells/charmAnimal#_charm-animal)_ (2nd), _ [barkskin](../../spells/barkskin#_barkskin)_ (4th), _ [speak with plants](../../spells/speakWithPlants#_speak-with-plants)_ (6th), _ [grove of respite\*](../spells/groveOfRespite#_grove-of-respite)_ (8th), _ [awaken](../../spells/awaken#_awaken)_ (10th), _ [stone tell](../../spells/stoneTell#_stone-tell)_ (12th), _ [creeping doom](../../spells/creepingDoom#_creeping-doom)_ (14th), _ [animal shapes](../../spells/animalShapes#_animal-shapes)_ (16th), _ [world wave\*](../spells/worldWave#_world-wave-)_ (18th).

**Revelations** : An oracle with the nature mystery can choose from any of the following revelations.

_Bonded [Mount](../../spells/mount#_mount) (Su)_: You gain the service of an unusually intelligent, strong, and loyal mount. The creature must be one that you are capable of riding and is suitable as a mount. A Medium oracle can select a camel or a horse. A Small oracle can select a pony or wolf, but can also select a boar or a dog if she is at least 4th level. This mount functions as a druid's animal companion, using your oracle level as your effective druid level. Bonded mounts have an Intelligence score of at least 6.
...
_Transcendental Bond (Su)_: You become so attuned to the common spirit shared by all living things that you can use it to communicate with allies. You may communicate with your allies for a number of rounds per day equal to your oracle level as if using _ [telepathic bond](../../spells/telepathicBond#_telepathic-bond)_. You may designate a number of creatures as your ally equal to your Charisma modifier. Designating a creature is a standard action that requires a touch. At 10th level, you may use this bond to cast a touch spell on a designated ally once per day.

_Undo Artifice (Sp)_: At 11th-level, you gain the ability to reduce a nonliving item to its component parts, essentially erasing the hand of artifice and rendering the item into a pile of raw natural materials. This effect acts as the spell _ [polymorph any object](../../spells/polymorphAnyObject#_polymorph-any-object)_, working on both magical and nonmagical nonliving objects. The duration is always permanent. Unlike _ [polymorph any object](../../spells/polymorphAnyObject#_polymorph-any-object)_, it cannot be used to mimic the effects of other spells. Items subject to this effect receive a Fortitude saving throw to negate the effect. Magic items receive a circumstance bonus on this save equal to +1 for every 5,000 gp in the item's value. You may use undo artifice a number of times per day equal to your Charisma modifier.
...
**Class Skills** : An oracle with the stone mystery adds [Appraise](../../skills/appraise#_appraise), [Climb](../../skills/climb#_climb), [Intimidate](../../skills/intimidate#_intimidate), and [Survival](../../skills/survival#_survival) to her list of class skills.

**Bonus Spells** : _ [magic stone](../../spells/magicStone#_magic-stone)_ (2nd), _ [stone call\*](../spells/stoneCall#_stone-call)_ (4th), _ [meld into stone](../../spells/meldIntoStone#_meld-into-stone)_ (6th), _ [wall of stone](../../spells/wallOfStone#_wall-of-stone)_ (8th), _ [stoneskin](../../spells/stoneskin#_stoneskin)_ (10th), _ [stone tell](../../spells/stoneTell#_stone-tell)_ (12th), _ [statue](../../spells/statue#_statue)_ (14th), _ [repel metal or stone](../../spells/repelMetalOrStone#_repel-metal-or-stone)_ (16th), _ [clashing rocks\*](../spells/clashingRocks#_clashing-rocks)_ (18th).
...
_Rock [Throwing](../../magicItems/weapons#_throwing) (Ex)_: You are an accomplished rock thrower and have a +1 racial bonus on attack rolls with thrown rocks. You can hurl rocks up to two categories smaller than your own size. The range increment for a rock is 20 feet, and you can hurl it up to 5 range increments. Damage for a hurled rock is 2d4 for a Medium creature or 2d3 for a Small creature, plus 1-1/2 your Strength bonus.
...
**Class Skills** : An oracle with the waves mystery adds [Acrobatics](../../skills/acrobatics#_acrobatics), [Escape Artist](../../skills/escapeArtist#_escape-artist), [Knowledge](../../skills/knowledge#_knowledge) (nature), and [Swim](../../skills/swim#_swim) to her list of class skills.

**Bonus Spells** : _ [touch of the sea\*](../spells/touchOfTheSea#_touch-of-the-sea)_ (2nd), _ [slipstream\*](../spells/slipstream#_slipstream)_ (4th), _ [water breathing](../../spells/waterBreathing#_water-breathing) _(6th), _ [wall of ice](../../spells/wallOfIce#_wall-of-ice)_ (8th), _ [geyser\*](../spells/geyser#_geyser-)_ (10th), _ [fluid form\*](../spells/fluidForm#_fluid-form)_ (12th), _ [vortex\*](../spells/vortex#_vortex)_ (14th), _ [seamantle\*](../spells/seamantle#_seamantle)_ (16th), _ [tsunami\*](../spells/tsunami#_tsunami)_ (18th).

**Revelations** : An oracle with the waves mystery can choose from any of the following revelations.

_Blizzard (Su)_: As a standard action, you can create a blizzard of snow and ice. You can create one 10-foot-cube of storm per oracle level. These cubes can be arranged in any pattern you desire, but each cube must be adjacent to another and one must be adjacent to you. Any creature caught in the blizzard takes 1d4 points of cold damage per oracle level, with a Reflex save resulting in half damage. The storm lasts for a number of rounds equal to your Charisma modifier; the ground remains icy (+5 to [Acrobatics](../../skills/acrobatics#_acrobatics) DCs) as long as local conditions permit. The blizzard obscures sight beyond 5 feet, providing total concealment. A creature within 5 feet has concealment. You can use this ability once per day. You must be 11th level to select this revelation.
...
_Freezing Spells (Su)_: Whenever a creature fails a saving throw and takes cold damage from one of your spells, it is slowed (as the _ [slow](../../spells/slow#_slow)_ spell) for 1 round. Spells that do not allow a save do not slow creatures. At 11th level, the duration increases to 1d4 rounds.
...
_Punitive [Transformation](../../spells/transformation#_transformation) (Su)_: You can transform an opponent into a harmless animal as if using _ [baleful polymorph](../../spells/balefulPolymorph#_baleful-polymorph)_. This transformation lasts 1 round per oracle level. Transforming another creature causes the first to immediately revert to normal. You may use this ability a number of times per day equal to your Charisma modifier. You must be at least 7th level before selecting this revelation.

_Water Form (Su)_: As a standard action, you can assume the form of a Small water elemental, as _ [elemental body I](../../spells/elementalBody#_elemental-body-i)_. At 9th level, you can assume the form of a Medium water elemental, as _ [elemental body II](../../spells/elementalBody#_elemental-body-ii)_. At 11th level, you can assume the form of a Large water elemental, as _ [elemental body III](../../spells/elementalBody#_elemental-body-iii)_. At 13th level, you can assume the form of a Huge water elemental, as _ [elemental body IV](../../spells/elementalBody#_elemental-body-iv)_. You can use this ability once per day, but the duration is 1 hour/level. You must be at least 7th level to select this revelation.

_Water Sight (Su)_: You can see through fog and mist without penalty as long as there is enough light to allow you to see normal. At 7th level, you can use any calm pool of water at least 1 foot in diameter as a scrying device, as if using the _scry_ spell. At 15th level, this functions like _ [greater scrying](../../spells/scrying#_scrying-greater)_.You can use the scrying abilities for a number of rounds per day equal to your oracle level, but these rounds do not need to be consecutive.

_Wintry Touch (Su)_: As a standard action, you can perform a melee touch attack that deals 1d6 points of cold damage + 1 point for every two oracle levels you possess. You can use the wintry touch ability a number of times per day equal to 3 + your Charisma modifier. At 11th level, any weapon that you wield is treated as a _ [frost](../../magicItems/weapons#_weapons-frost)_ weapon.
...
**Class Skills** : An oracle with the wind mystery adds [Acrobatics](../../skills/acrobatics#_acrobatics), [Escape Artist](../../skills/escapeArtist#_escape-artist), [Fly](../../skills/fly#_fly), and [Stealth](../../skills/stealth#_stealth) to her list of class skills.

**Bonus Spells** : _ [alter winds\*](../spells/alterWinds#_alter-winds)_ (2nd), _ [gust of wind](../../spells/gustOfWind#_gust-of-wind)_ (4th), _ [cloak of winds\*](../spells/cloakOfWinds#_cloak-of-winds)_ (6th), _ [river of wind\*](../spells/riverOfWind#_river-of-wind)_ (8th), _ [control winds](../../spells/controlWinds#_control-winds)_ (10th), _ [sirocco\*](../spells/sirocco#_sirocco) _(12th), _ [control weather](../../spells/controlWeather#_control-weather)_ (14th), _ [whirlwind](../../spells/whirlwind#_whirlwind)_ (16th), _ [winds of vengeance\*](../spells/windsOfVengeance#_winds-of-vengeance)_ (18th).
...
_Gaseous Form (Su)_: As a standard action, you can assume _ [gaseous form](../../spells/gaseousForm#_gaseous-form)_ (as the spell). You can remain gaseous for 1 minute per day per oracle level. This duration does not need to be consecutive, but it must be spent in 1-minute increments. You must be at least 7th level to select this revelation. You can bring other creatures with you in gaseous form, but each passenger costs an additional minute per minute of travel.

_ [Invisibility](../../spells/invisibility#_invisibility) (Su)_: As a standard action, you can become invisible (as per the _ [invisibility](../../spells/invisibility#_invisibility) _spell). You can remain invisible for 1 minute per day per oracle level. This duration does not need to be consecutive, but it must be spent in 1-minute increments. Starting at 9th level, each time you activate this ability you can treat it as _ [greater invisibility](../../spells/invisibility#_invisibility-greater)_, though each round spent this way counts as 1 minute of your normal_ [invisibility](../../spells/invisibility#_invisibility)_ duration. You must be at least 3rd level to select this revelation.
...
_ [Spark](../spells/spark#_spark-) Skin (Ex)_: You gain resist electricity 5. This resistance increases to 10 at 5th level and 20 at 11th level. At 17th level, you gain immunity to electricity.
...
_Touch of Electricity (Su)_: As a standard action, you can perform a melee touch attack that deals 1d6 points of electricity damage +1 point for every two oracle levels you possess. You can use this ability a number of times per day equal to 3 + your Charisma modifier. At 11th level, any weapon that you wield is treated as a _ [shock](../../magicItems/weapons#_weapons-shock)_ weapon.

_ [Vortex](../spells/vortex#_vortex) Spells (Ex)_: Whenever you score a critical hit against an opponent with an attack spell, the target is staggered for 1 round. At 11th level, the duration increases to 1d4 rounds.

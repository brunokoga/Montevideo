---
layout: default
title: advanced/baseClasses/alchemist
---
# Alchemist
...
The alchemist's class skills are [Appraise](../../skills/appraise#_appraise) (Int), [Craft](../../skills/craft#_craft) (any) (Int), [Disable Device](../../skills/disableDevice#_disable-device) (Dex), [Fly](../../skills/fly#_fly) (Dex), [Heal](../../skills/heal#_heal) (Wis), [Knowledge](../../skills/knowledge#_knowledge) (arcana) (Int), [Knowledge](../../skills/knowledge#_knowledge) (nature) (Int), [Perception](../../skills/perception#_perception) (Wis), [Profession](../../skills/profession#_profession) (Wis), [Sleight of Hand](../../skills/sleightOfHand#_sleight-of-hand) (Dex), [Spellcraft](../../skills/spellcraft#_spellcraft) (Int), [Survival](../../skills/survival#_survival) (Wis), [Use Magic Device](../../skills/useMagicDevice#_use-magic-device) (Cha).
...
When using [Craft](../../skills/craft#_craft) (alchemy) to create an alchemical item, an alchemist gains a competence bonus equal to his class level on the [Craft](../../skills/craft#_craft) (alchemy) check. In addition, an alchemist can use [Craft](../../skills/craft#_craft) (alchemy) to identify potions as if using _ [detect magic](../../spells/detectMagic#_detect-magic)_. He must hold the potion for 1 round to make such a check.

An alchemist can create three special types of magical items—extracts, bombs, and mutagens. Bombs are explosive splash weapons, and mutagens are transformative elixirs that the alchemist drinks to enhance his physical abilities—both of these are detailed in their own sections below.

Extracts are the most varied of the three. In many ways, they behave like spells in potion form, and as such their effects can be dispelled by effects like _ [dispel magic](../../spells/dispelMagic#_dispel-magic) _using the alchemist's level as the caster level. Unlike potions, though, extracts can have powerful effects and duplicate spells that a potion normally could not.
...
Although the alchemist doesn't actually cast spells, he does have a formulae list that determines what extracts he can create. An alchemist can utilize spell-trigger items if the spell appears on his formuale list, but not spell-completion items (unless he uses [Use Magic Device](../../skills/useMagicDevice#_use-magic-device) to do so). An extract is “cast” by drinking it, as if imbibing a potion—the effects of an extract exactly duplicate the spell upon which its formula is based, save that the spell always affects only the drinking alchemist. An alchemist can draw and drink an extract as a standard action. The alchemist uses his level as the caster level to determine any effect based on caster level.
...
_Dispelling Bomb_: When the alchemist creates a bomb, he can choose to have it dispel magic effects instead of deal damage. Creatures that take a direct hit from a dispelling bomb are subject to a targeted _ [dispel magic](../../spells/dispelMagic#_dispel-magic)_ spell, using the alchemist's level as the caster level. This cannot be used to target a specific spell effect. The alchemist must be at least 6th level before selecting this discovery.

_Elixir of life_: Once per day, the alchemist can brew an elixir of life. This special concoction costs 25,000 gp to create and takes 1 hour of work. An elixir of life, when administered by the alchemist who brewed it, restores life to a dead creature as per the spell _ [true resurrection](../../spells/trueResurrection#_true-resurrection)_. Alternatively, the alchemist himself may drink the elixir of life, after which point he is immediately targeted with a _ [resurrection](../../spells/resurrection#_resurrection)_ spell the next time he is killed. Used in this manner, the effects of an elixir of life persist only for a number of days equal to the alchemist's Intelligence modifier; if he does not die before that time expires, the effects of the elixir of life end. An alchemist must be at least 16th level before selecting this discovery.
...
_Smoke bomb\*_: When the alchemist creates a bomb, he can choose to have it create a cloud of thick smoke when it detonates. The cloud functions as _ [fog cloud](../../spells/fogCloud)_, filling an area equal to twice the bomb's splash radius for 1 round per level.
...
**Instant Alchemy (Ex)** : At 18th level, an alchemist can create alchemical items with almost supernatural speed. He can create any alchemical item as a full-round action if he succeeds at the [Craft](../../skills/craft#_craft) (alchemy) check and has the appropriate resources at hand to fund the creation. He can apply poison to a weapon as an immediate action.
...
_Philosopher's Stone_: The alchemist learns how to create a [_philosopher's stone_](../../magicItems/artifacts#_philosopher-s-stone), and can do so once per month at no cost. Creating a _philosopher's stone_ takes 1 day of work.

_Poison Touch_: The alchemist gains a poisonous touch, as if under the effects of a _ [poison](../../spells/poison#_poison)_ spell. He can suppress or activate this ability as a free action. The physical appearance of how the alchemist generates and delivers his poisonous touch varies from alchemist to alchemist.
...
**1st-Level Alchemist Formulae** —_ [ant haul\*](../spells/antHaul#_ant-haul-), [bomber's eye\*](../spells/bomberSEye#_bomber's-eye), [comprehend languages](../../spells/comprehendLanguages#_comprehend-languages), [crafter's fortune\*](../spells/crafterSFortune#_crafter's-fortune), [cure light wounds](../../spells/cureLightWounds#_cure-light-wounds), [detect secret doors](../../spells/detectSecretDoors#_detect-secret-doors), [detect undead](../../spells/detectUndead#_detect-undead), [disguise self](../../spells/disguiseSelf#_disguise-self), [endure elements](../../spells/endureElements#_endure-elements), [enlarge person](../../spells/enlargePerson#_enlarge-person), [expeditious retreat](../../spells/expeditiousRetreat#_expeditious-retreat), [identify](../../spells/identify#_identify), [jump](../../spells/jump#_jump), [keen senses\*](../spells/keenSenses#_keen-senses), [negate aroma\*](../spells/negateAroma#_negate-aroma), [reduce person](../../spells/reducePerson#_reduce-person), [shield](../../spells/shield#_shield), [stone fist\*](../spells/stoneFist#_stone-fist), [touch of the sea\*](../spells/touchOfTheSea#_touch-of-the-sea), [true strike](../../spells/trueStrike#_true-strike)._

**2nd-Level Alchemist Formulae** —_ [aid](../../spells/aid#_aid), [alchemical allocation\*](../spells/alchemicalAllocation#_alchemical-allocation), [alter self](../../spells/alterSelf#_alter-self), [barkskin](../../spells/barkskin#_barkskin), [bear's endurance](../../spells/bearSEndurance#_bear-s-endurance), [blur](../../spells/blur#_blur), [bull's strength](../../spells/bullSStrength#_bull-s-strength), [cat's grace](../../spells/catSGrace#_cat-s-grace), [cure moderate wounds](../../spells/cureModerateWounds#_cure-moderate-wounds), [darkvision](../../spells/darkvision#_darkvision), [delay poison](../../spells/delayPoison#_delay-poison), [detect thoughts](../../spells/detectThoughts#_detect-thoughts), [eagle's splendor](../../spells/eagleSSplendor#_eagle-s-splendor), [elemental touch\*](../spells/elementalTouch#_elemental-touch), [false life](../../spells/falseLife#_false-life), [fire breath\*](../spells/fireBreath#_fire-breath), [fox's cunning](../../spells/foxSCunning#_fox-s-cunning), [invisibility](../../spells/invisibility#_invisibility), [levitate](../../spells/levitate#_levitate), [owl's wisdom](../../spells/owlSWisdom#_owl-s-wisdom), [perceive cues\*](../spells/perceiveCues#_perceive-cues), [protection from arrows](../../spells/protectionFromArrows#_protection-from-arrows), [resist energy](../../spells/resistEnergy#_resist-energy), [restoration (lesser)](../../spells/restoration#_lesser-restoration), [see invisibility](../../spells/seeInvisibility#_see-invisibility), [spider climb](../../spells/spiderClimb#_spider-climb), [transmute potion to](../spells/transmutePotionToPoison#_transmute-potion-to-poison) [poison](../../spells/poison#_poison)\*, [undetectable alignment](../../spells/undetectableAlignment#_undetectable-alignment), [vomit swarm\*](../spells/vomitSwarm#_vomit-swarm)._

**3rd-Level Alchemist Formulae** —_ [absorbing touch\*](../spells/absorbingTouch#_absorbing-touch), [amplify elixir\*](../spells/amplifyElixir#_amplify-elixir), [arcane sight](../../spells/arcaneSight#_arcane-sight), [beast shape I](../../spells/beastShape#_beast-shape-i), [bloodhound\*](../spells/bloodhound#_bloodhound), [cure serious wounds](../../spells/cureSeriousWounds#_cure-serious-wounds), [displacement](../../spells/displacement#_displacement), [draconic reservoir\*](../spells/draconicReservoir#_draconic-reservoir-), [elemental aura\*](../spells/elementalAura#_elemental-aura), [fly](../../spells/fly), [gaseous form](../../spells/gaseousForm#_gaseous-form), [haste](../../spells/haste#_haste), [heroism](../../spells/heroism#_heroism), [nondetection](../../spells/nondetection#_nondetection), [protection from energy](../../spells/protectionFromEnergy#_protection-from-energy), [rage](../../spells/rage#_rage), [remove blindness/deafness](../../spells/removeBlindnessDeafness#_remove-blindness-deafness), [remove curse](../../spells/removeCurse#_remove-curse), [remove disease](../../spells/removeDisease#_remove-disease), [seek thoughts\*](../spells/seekThoughts#_seek-thoughts), [thorn body\*](../spells/thornBody#_thorn-body), [tongues](../../spells/tongues#_tongues), [water breathing](../../spells/waterBreathing#_water-breathing)._

**4th-Level Alchemist Formulae** —_ [air walk](../../spells/airWalk#_air-walk), [arcane eye](../../spells/arcaneEye#_arcane-eye), [beast shape II](../../spells/beastShape#_beast-shape-ii), [cure critical wounds](../../spells/cureCriticalWounds#_cure-critical-wounds), [death ward](../../spells/deathWard#_death-ward), [detonate\*](../spells/detonate#_detonate), [discern lies](../../spells/discernLies#_discern-lies), [dragon's breath\*](../spells/dragonSBreath#_dragon's-breath), [elemental body I](../../spells/elementalBody#_elemental-body-i), [fire shield](../../spells/fireShield#_fire-shield), [fluid form\*](../spells/fluidForm#_fluid-form), [freedom of movement](../../spells/freedomOfMovement#_freedom-of-movement), [invisibility (greater)](../../spells/invisibility#_invisibility-greater), [neutralize poison](../../spells/neutralizePoison#_neutralize-poison), [restoration](../../spells/restoration#_restoration)_, _ [spell immunity](../../spells/spellImmunity#_spell-immunity)_, _ [stoneskin](../../spells/stoneskin#_stoneskin), [universal formula\*](../spells/universalFormula#_universal-formula)._

**5th-Level Alchemist Formulae** —_ [beast shape III](../../spells/beastShape#_beast-shape-iii), [contact other plane](../../spells/contactOtherPlane#_contact-other-plane), [delayed consumption\*](../spells/delayedConsumption#_delayed-consumption), [dream](../../spells/dream#_dream), [elemental body II](../../spells/elementalBody#_elemental-body-ii), [elude time\*](../spells/eludeTime#_elude-time), [magic jar](../../spells/magicJar#_magic-jar), [nightmare](../../spells/nightmare#_nightmare), [overland flight](../../spells/overlandFlight#_overland-flight), [planar adaptation\*](../spells/planarAdaptation#_planar-adaptation), [plant shape I](../../spells/plantShape#_plant-shape-i), [polymorph](../../spells/polymorph#_polymorph), [resurgent transformation](../spells/resurgentTransformation#_resurgent-transformation)\*, [sending](../../spells/sending#_sending), [spell resistance](glossary#_spell-resistance)._

**6th-Level Alchemist Formulae** —_ [analyze dweomer](../../spells/analyzeDweomer#_analyze-dweomer), [beast shape IV](../../spells/beastShape#_beast-shape-iv), [elemental body III](../../spells/elementalBody#_elemental-body-iii), [eyebite](../../spells/eyebite#_eyebite), [form of the dragon I](../../spells/formOfTheDragon#_form-of-the-dragon-i), [giant form I](../../spells/giantForm#_giant-form-i), [heal](../../spells/heal#_heal), [mislead](../../spells/mislead#_mislead), [plant shape II](../../spells/plantShape#_plant-shape-ii), [shadow walk](../../spells/shadowWalk#_shadow-walk), [statue](../../spells/statue#_statue), [transformation](../../spells/transformation#_transformation), [true seeing](../../spells/trueSeeing#_true-seeing), [twin form\*](../spells/twinForm#_twin-form), [wind walk](../../spells/windWalk#_wind-walk)._

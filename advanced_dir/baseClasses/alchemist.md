---
layout: default
title: advance_dir/baseClasses/alchemist
---
# Alchemist
...
The alchemist's class skills are [Appraise](../../skill_dir/appraise#_appraise) (Int), [Craft](../../skill_dir/craft#_craft) (any) (Int), [Disable Device](../../skill_dir/disableDevice#_disable-device) (Dex), [Fly](../../skill_dir/fly#_fly) (Dex), [Heal](../../skill_dir/heal#_heal) (Wis), [Knowledge](../../skill_dir/knowledge#_knowledge) (arcana) (Int), [Knowledge](../../skill_dir/knowledge#_knowledge) (nature) (Int), [Perception](../../skill_dir/perception#_perception) (Wis), [Profession](../../skill_dir/profession#_profession) (Wis), [Sleight of Hand](../../skill_dir/sleightOfHand#_sleight-of-hand) (Dex), [Spellcraft](../../skill_dir/spellcraft#_spellcraft) (Int), [Survival](../../skill_dir/survival#_survival) (Wis), [Use Magic Device](../../skill_dir/useMagicDevice#_use-magic-device) (Cha).
...
When using [Craft](../../skill_dir/craft#_craft) (alchemy) to create an alchemical item, an alchemist gains a competence bonus equal to his class level on the [Craft](../../skill_dir/craft#_craft) (alchemy) check. In addition, an alchemist can use [Craft](../../skill_dir/craft#_craft) (alchemy) to identify potions as if using _ [detect magic](../../spell_dir/detectMagic#_detect-magic)_. He must hold the potion for 1 round to make such a check.

An alchemist can create three special types of magical items—extracts, bombs, and mutagens. Bombs are explosive splash weapons, and mutagens are transformative elixirs that the alchemist drinks to enhance his physical abilities—both of these are detailed in their own sections below.

Extracts are the most varied of the three. In many ways, they behave like spells in potion form, and as such their effects can be dispelled by effects like _ [dispel magic](../../spell_dir/dispelMagic#_dispel-magic) _using the alchemist's level as the caster level. Unlike potions, though, extracts can have powerful effects and duplicate spells that a potion normally could not.
...
Although the alchemist doesn't actually cast spells, he does have a formulae list that determines what extracts he can create. An alchemist can utilize spell-trigger items if the spell appears on his formuale list, but not spell-completion items (unless he uses [Use Magic Device](../../skill_dir/useMagicDevice#_use-magic-device) to do so). An extract is “cast” by drinking it, as if imbibing a potion—the effects of an extract exactly duplicate the spell upon which its formula is based, save that the spell always affects only the drinking alchemist. An alchemist can draw and drink an extract as a standard action. The alchemist uses his level as the caster level to determine any effect based on caster level.
...
_Dispelling Bomb_: When the alchemist creates a bomb, he can choose to have it dispel magic effects instead of deal damage. Creatures that take a direct hit from a dispelling bomb are subject to a targeted _ [dispel magic](../../spell_dir/dispelMagic#_dispel-magic)_ spell, using the alchemist's level as the caster level. This cannot be used to target a specific spell effect. The alchemist must be at least 6th level before selecting this discovery.

_Elixir of life_: Once per day, the alchemist can brew an elixir of life. This special concoction costs 25,000 gp to create and takes 1 hour of work. An elixir of life, when administered by the alchemist who brewed it, restores life to a dead creature as per the spell _ [true resurrection](../../spell_dir/trueResurrection#_true-resurrection)_. Alternatively, the alchemist himself may drink the elixir of life, after which point he is immediately targeted with a _ [resurrection](../../spell_dir/resurrection#_resurrection)_ spell the next time he is killed. Used in this manner, the effects of an elixir of life persist only for a number of days equal to the alchemist's Intelligence modifier; if he does not die before that time expires, the effects of the elixir of life end. An alchemist must be at least 16th level before selecting this discovery.
...
_Smoke bomb\*_: When the alchemist creates a bomb, he can choose to have it create a cloud of thick smoke when it detonates. The cloud functions as _ [fog cloud](../../spell_dir/fogCloud)_, filling an area equal to twice the bomb's splash radius for 1 round per level.
...
**Instant Alchemy (Ex)** : At 18th level, an alchemist can create alchemical items with almost supernatural speed. He can create any alchemical item as a full-round action if he succeeds at the [Craft](../../skill_dir/craft#_craft) (alchemy) check and has the appropriate resources at hand to fund the creation. He can apply poison to a weapon as an immediate action.
...
_Philosopher's Stone_: The alchemist learns how to create a [_philosopher's stone_](../../magicItem_dir/artifacts#_philosopher-s-stone), and can do so once per month at no cost. Creating a _philosopher's stone_ takes 1 day of work.

_Poison Touch_: The alchemist gains a poisonous touch, as if under the effects of a _ [poison](../../spell_dir/poison#_poison)_ spell. He can suppress or activate this ability as a free action. The physical appearance of how the alchemist generates and delivers his poisonous touch varies from alchemist to alchemist.
...
**1st-Level Alchemist Formulae** —_ [ant haul\*](../spell_dir/antHaul#_ant-haul-), [bomber's eye\*](../spell_dir/bomberSEye#_bomber's-eye), [comprehend languages](../../spell_dir/comprehendLanguages#_comprehend-languages), [crafter's fortune\*](../spell_dir/crafterSFortune#_crafter's-fortune), [cure light wounds](../../spell_dir/cureLightWounds#_cure-light-wounds), [detect secret doors](../../spell_dir/detectSecretDoors#_detect-secret-doors), [detect undead](../../spell_dir/detectUndead#_detect-undead), [disguise self](../../spell_dir/disguiseSelf#_disguise-self), [endure elements](../../spell_dir/endureElements#_endure-elements), [enlarge person](../../spell_dir/enlargePerson#_enlarge-person), [expeditious retreat](../../spell_dir/expeditiousRetreat#_expeditious-retreat), [identify](../../spell_dir/identify#_identify), [jump](../../spell_dir/jump#_jump), [keen senses\*](../spell_dir/keenSenses#_keen-senses), [negate aroma\*](../spell_dir/negateAroma#_negate-aroma), [reduce person](../../spell_dir/reducePerson#_reduce-person), [shield](../../spell_dir/shield#_shield), [stone fist\*](../spell_dir/stoneFist#_stone-fist), [touch of the sea\*](../spell_dir/touchOfTheSea#_touch-of-the-sea), [true strike](../../spell_dir/trueStrike#_true-strike)._

**2nd-Level Alchemist Formulae** —_ [aid](../../spell_dir/aid#_aid), [alchemical allocation\*](../spell_dir/alchemicalAllocation#_alchemical-allocation), [alter self](../../spell_dir/alterSelf#_alter-self), [barkskin](../../spell_dir/barkskin#_barkskin), [bear's endurance](../../spell_dir/bearSEndurance#_bear-s-endurance), [blur](../../spell_dir/blur#_blur), [bull's strength](../../spell_dir/bullSStrength#_bull-s-strength), [cat's grace](../../spell_dir/catSGrace#_cat-s-grace), [cure moderate wounds](../../spell_dir/cureModerateWounds#_cure-moderate-wounds), [darkvision](../../spell_dir/darkvision#_darkvision), [delay poison](../../spell_dir/delayPoison#_delay-poison), [detect thoughts](../../spell_dir/detectThoughts#_detect-thoughts), [eagle's splendor](../../spell_dir/eagleSSplendor#_eagle-s-splendor), [elemental touch\*](../spell_dir/elementalTouch#_elemental-touch), [false life](../../spell_dir/falseLife#_false-life), [fire breath\*](../spell_dir/fireBreath#_fire-breath), [fox's cunning](../../spell_dir/foxSCunning#_fox-s-cunning), [invisibility](../../spell_dir/invisibility#_invisibility), [levitate](../../spell_dir/levitate#_levitate), [owl's wisdom](../../spell_dir/owlSWisdom#_owl-s-wisdom), [perceive cues\*](../spell_dir/perceiveCues#_perceive-cues), [protection from arrows](../../spell_dir/protectionFromArrows#_protection-from-arrows), [resist energy](../../spell_dir/resistEnergy#_resist-energy), [restoration (lesser)](../../spell_dir/restoration#_lesser-restoration), [see invisibility](../../spell_dir/seeInvisibility#_see-invisibility), [spider climb](../../spell_dir/spiderClimb#_spider-climb), [transmute potion to](../spell_dir/transmutePotionToPoison#_transmute-potion-to-poison) [poison](../../spell_dir/poison#_poison)\*, [undetectable alignment](../../spell_dir/undetectableAlignment#_undetectable-alignment), [vomit swarm\*](../spell_dir/vomitSwarm#_vomit-swarm)._

**3rd-Level Alchemist Formulae** —_ [absorbing touch\*](../spell_dir/absorbingTouch#_absorbing-touch), [amplify elixir\*](../spell_dir/amplifyElixir#_amplify-elixir), [arcane sight](../../spell_dir/arcaneSight#_arcane-sight), [beast shape I](../../spell_dir/beastShape#_beast-shape-i), [bloodhound\*](../spell_dir/bloodhound#_bloodhound), [cure serious wounds](../../spell_dir/cureSeriousWounds#_cure-serious-wounds), [displacement](../../spell_dir/displacement#_displacement), [draconic reservoir\*](../spell_dir/draconicReservoir#_draconic-reservoir-), [elemental aura\*](../spell_dir/elementalAura#_elemental-aura), [fly](../../spell_dir/fly), [gaseous form](../../spell_dir/gaseousForm#_gaseous-form), [haste](../../spell_dir/haste#_haste), [heroism](../../spell_dir/heroism#_heroism), [nondetection](../../spell_dir/nondetection#_nondetection), [protection from energy](../../spell_dir/protectionFromEnergy#_protection-from-energy), [rage](../../spell_dir/rage#_rage), [remove blindness/deafness](../../spell_dir/removeBlindnessDeafness#_remove-blindness-deafness), [remove curse](../../spell_dir/removeCurse#_remove-curse), [remove disease](../../spell_dir/removeDisease#_remove-disease), [seek thoughts\*](../spell_dir/seekThoughts#_seek-thoughts), [thorn body\*](../spell_dir/thornBody#_thorn-body), [tongues](../../spell_dir/tongues#_tongues), [water breathing](../../spell_dir/waterBreathing#_water-breathing)._

**4th-Level Alchemist Formulae** —_ [air walk](../../spell_dir/airWalk#_air-walk), [arcane eye](../../spell_dir/arcaneEye#_arcane-eye), [beast shape II](../../spell_dir/beastShape#_beast-shape-ii), [cure critical wounds](../../spell_dir/cureCriticalWounds#_cure-critical-wounds), [death ward](../../spell_dir/deathWard#_death-ward), [detonate\*](../spell_dir/detonate#_detonate), [discern lies](../../spell_dir/discernLies#_discern-lies), [dragon's breath\*](../spell_dir/dragonSBreath#_dragon's-breath), [elemental body I](../../spell_dir/elementalBody#_elemental-body-i), [fire shield](../../spell_dir/fireShield#_fire-shield), [fluid form\*](../spell_dir/fluidForm#_fluid-form), [freedom of movement](../../spell_dir/freedomOfMovement#_freedom-of-movement), [invisibility (greater)](../../spell_dir/invisibility#_invisibility-greater), [neutralize poison](../../spell_dir/neutralizePoison#_neutralize-poison), [restoration](../../spell_dir/restoration#_restoration)_, _ [spell immunity](../../spell_dir/spellImmunity#_spell-immunity)_, _ [stoneskin](../../spell_dir/stoneskin#_stoneskin), [universal formula\*](../spell_dir/universalFormula#_universal-formula)._

**5th-Level Alchemist Formulae** —_ [beast shape III](../../spell_dir/beastShape#_beast-shape-iii), [contact other plane](../../spell_dir/contactOtherPlane#_contact-other-plane), [delayed consumption\*](../spell_dir/delayedConsumption#_delayed-consumption), [dream](../../spell_dir/dream#_dream), [elemental body II](../../spell_dir/elementalBody#_elemental-body-ii), [elude time\*](../spell_dir/eludeTime#_elude-time), [magic jar](../../spell_dir/magicJar#_magic-jar), [nightmare](../../spell_dir/nightmare#_nightmare), [overland flight](../../spell_dir/overlandFlight#_overland-flight), [planar adaptation\*](../spell_dir/planarAdaptation#_planar-adaptation), [plant shape I](../../spell_dir/plantShape#_plant-shape-i), [polymorph](../../spell_dir/polymorph#_polymorph), [resurgent transformation](../spell_dir/resurgentTransformation#_resurgent-transformation)\*, [sending](../../spell_dir/sending#_sending), [spell resistance](glossary#_spell-resistance)._

**6th-Level Alchemist Formulae** —_ [analyze dweomer](../../spell_dir/analyzeDweomer#_analyze-dweomer), [beast shape IV](../../spell_dir/beastShape#_beast-shape-iv), [elemental body III](../../spell_dir/elementalBody#_elemental-body-iii), [eyebite](../../spell_dir/eyebite#_eyebite), [form of the dragon I](../../spell_dir/formOfTheDragon#_form-of-the-dragon-i), [giant form I](../../spell_dir/giantForm#_giant-form-i), [heal](../../spell_dir/heal#_heal), [mislead](../../spell_dir/mislead#_mislead), [plant shape II](../../spell_dir/plantShape#_plant-shape-ii), [shadow walk](../../spell_dir/shadowWalk#_shadow-walk), [statue](../../spell_dir/statue#_statue), [transformation](../../spell_dir/transformation#_transformation), [true seeing](../../spell_dir/trueSeeing#_true-seeing), [twin form\*](../spell_dir/twinForm#_twin-form), [wind walk](../../spell_dir/windWalk#_wind-walk)._

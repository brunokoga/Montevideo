...
Chaotic (violet flame): _ [Word of chaos](../../spells/wordOfChaos#_word-of-chaos)_ once per day on command.

Good (white flame): Allies within 30 feet of the beacon gain the benefits of _ [protection from evil](../../spells/protectionFromEvil#_protection-from-evil)_ and _ [heroism](../../spells/heroism#_heroism)_.

Evil (black flame): Bearer is constantly under the effect of _ [protection from good](../../spells/protectionFromGood#_protection-from-good)_ and may use _ [harm](../../spells/harm#_harm)_ twice per day.

Lawful (golden flame): _ [Dictum](../../spells/dictum#_dictum)_ once per day on command.
...
| 16 | Lev | Once in the next 24 hours, the character can cast a _ [lightning bolt](../../spells/lightningBolt#_lightning-bolt)_ (caster level equal to his character level). This ability is lost if the character rolls this result again with the _knucklebone of fickle fortune_ before the 24 hours is concluded. |
...
**Spindle of Perfect [Knowledge](../../skills/knowledge#_knowledge)**
...
If the check fails, the talisman acts as a _ [stone of weight](../../magicItems/specificCursedItems#_stone-of-weight)_. Discarding it results in 5d6 points of damage to the character and the disappearance of the talisman.

---
title: advance_dir/magicItems/minorArtifacts
---
# Minor Artifacts
...
Good (white flame): Allies within 30 feet of the beacon gain the benefits of _ [protection from evil](../../spell_dir/protectionFromEvil#_protection-from-evil)_ and _ [heroism](../../spell_dir/heroism#_heroism)_.

Evil (black flame): Bearer is constantly under the effect of _ [protection from good](../../spell_dir/protectionFromGood#_protection-from-good)_ and may use _ [harm](../../spell_dir/harm#_harm)_ twice per day.

Lawful (golden flame): _ [Dictum](../../spell_dir/dictum#_dictum)_ once per day on command.
...
| 11 | Fyeh | The character gains 100 points of fire immunity, as if using _ [protection from energy](../../spell_dir/protectionFromEnergy#_protection-from-energy)_. |
...
The _spindle of perfect knowledge_ is large, bright, and flawless marquise-cut diamond _ [ioun stone](../../magicItem_dir/wondrousItems#_ioun-stones)_ the size of a halfling's fist. The gemstone would be a treasure in itself if it lacked magic, but it is also a powerful _ [ioun stone](../../magicItem_dir/wondrousItems#_ioun-stones)_. The _spindle of perfect knowledge_ functions like a _ [headband of mental superiority](../../magicItem_dir/wondrousItems#_headband-of-mental-superiority)_ +4 and grants 5 ranks in two random [Knowledge](../../skill_dir/knowledge#_knowledge) skills. The wearer can communicate and understand languages as if using _ [comprehend languages](../../spell_dir/comprehendLanguages#_comprehend-languages)_, _ [tongues](../../spell_dir/tongues#_tongues)_, and telepathy with a range of 100 feet.
...
If the check fails, the talisman acts as a _ [stone of weight](../../magicItem_dir/specificCursedItems#_stone-of-weight)_. Discarding it results in 5d6 points of damage to the character and the disappearance of the talisman.

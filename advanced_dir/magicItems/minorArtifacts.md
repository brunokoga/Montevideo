---
title: advanced/magicItem_dir/minorArtifacts
---
# Minor Artifacts
...
Chaotic (violet flame: _ [Word of chaos](../../spell_dir/wordOfChaos#_word-of-chaos)_ once per day on command.

Good (white flame: Allies within 30 feet of the beacon gain the benefits of _ [protection from evil](../../spell_dir/protectionFromEvil#_protection-from-evil_ and _ [heroism](../../spell_dir/heroism#_heroism)_.

Evil (black flame: Bearer is constantly under the effect of _ [protection from good](../../spell_dir/protectionFromGood#_protection-from-good_ and may use _ [harm](../../spell_dir/harm#_harm)_ twice per day.

Lawful (golden flame: _ [Dictum](../../spell_dir/dictum#_dictum_ once per day on command.
...
| 16 | Lev | Once in the next 24 hours, the character can cast a _ [lightning bolt](../../spell_dir/lightningBolt#_lightning-bolt)_ (caster level equal to his character level. This ability is lost if the character rolls this result again with the _knucklebone of fickle fortune_ before the 24 hours is concluded. |
...
| 20 | Eha-Zah | The next time the character dies, he comes back from the dead the very next morning as if the subject of a _ [resurrection](../../spell_dir/resurrection#_resurrection)_ spell. This effect is negated if the character rolls the _knucklebone of fickle fortune_ again before he dies. |
...
**Spindle of Perfect [Knowledge](../../skill_dir/knowledge#_knowledge**
...
If the check fails, the talisman acts as a _ [stone of weight](../../magicItem_dir/specificCursedItems#_stone-of-weight_. Discarding it results in 5d6 points of damage to the character and the disappearance of the talisman.
...
A _talisman of reluctant wishes_ can be destroyed by wishing it so, using either one of the stone's _wishes_ or a _ [wish](../../spell_dir/wish#_wish_ spell from another source. The stone then explodes, causing 5d6 points of damage to the holder.

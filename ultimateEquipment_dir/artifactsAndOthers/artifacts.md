---
layout: default
title: ultimateEquipmen_dir/artifactsAndOthers/artifacts
---
# Artifacts
...
_Good (white flame):_ Allies within 30 feet of the beacon gain the benefits of _ [protection from evil](spells/protectionFromEvil#_protection-from-evil)_ and _ [heroism](spell_dir/heroism#_heroism)_.

_Evil (black flame):_ Bearer is constantly under the effect of _ [protection from good](spells/protectionFromGood#_protection-from-good)_ and may use _ [harm](spell_dir/harm#_harm)_ twice per day.

_Lawful (golden flame): [Dictum](spells/dictum#_dictum)_ once per day on command.
...
This verdant branch glows with a soothing, pale green light. Carefully pruned from the world's first tree, this artifact hums with energy. Full of everlasting life, it needs time to transfer its magic. It can cast _ [heal](spells/heal#_heal)_ at will, but needs a full hour to do so. Once a day, it can cast _ [resurrection](spell_dir/resurrection#_resurrection)_, but it takes the full day to do so.
...
Once a creature becomes a thrall of the crown's user, it must do everything the user commands, as per the spell _ [dominate person](spells/dominatePerson#_dominate-person)_—though the crown's dominance is not limited to humanoids, lasts as long the creature is wearing the crown, and allows no saving throw.
...
| 3 | Eij | The character is affected by a _ [harm](spells/harm#_harm)_ spell (caster level 15th). |
...
| 5 | Veh | The character is blinded as with _ [blindnes_dir/deafness](spells/blindnessDeafness#_blindness-deafness)_ (no saving throw). |
...
| 8 | Seh | The character is paralyzed for 2d12 hours, as with _ [hold monster](spell_dir/holdMonster#_hold-monster)_, except he cannot attempt new saving throws to overcome the effect. |
| 9 | Kog | For the next week, the character emits a horrible smell. He suffers a –4 penalty on [Diplomacy](skills/diplomacy#_diplomacy) and [Stealth](skill_dir/stealth#_stealth) checks. |
...
| 11 | Fyeh | The character gains 100 points of fire immunity, as if using _ [protection from energy](spells/protectionFromEnergy#_protection-from-energy)_. |
| 12 | Xal | The character gains the benefits of a _ [heroism](spell_dir/heroism#_heroism)_ spell for the next 200 minutes. |
...
| 14 | Gib | Once in the next 24 hours, the character can cast _ [faerie fire](spells/faerieFire#_faerie-fire)_ (caster level equal to his character level). This ability is lost if the character rolls this result again with the _knucklebone of fickle fortune_ before the 24 hours is concluded. |
...
A _staff of the magi_ gives the wielder spell resistance 23. If this is willingly lowered, however, the staff can also be used to absorb arcane spell energy directed at its wielder, as a _ [rod of absorption](magicItems/rods#_rod-of-absorption)_ does. Unlike the rod, this staff converts spell levels into charges rather than retaining them as spell energy usable by a spellcaster. If the staff absorbs enough spell levels to exceed its limit of 50 charges, it explodes as if a retributive strike had been performed (see below). The wielder has no idea how many spell levels are cast at her, for the staff does not communicate this knowledge as a _rod of absorption_ does. (Thus, absorbing spells can be risky.)
...
If the check succeeds, the talisman remains with the character for 5d6 hours, or until a _ [wish](spell_dir/wish#_wish)_ is made with it, whichever comes first. It then disappears.
...
The artifact grants one _ [wish](spells/wish#_wish)_ for every 6 points of the character's Charisma (round down). It grows warm and throbs whenever its possessor comes within 20 feet of a mechanical or magic trap. (If the talisman is not held, its warning heat and pulses are of no avail.)
...
- Three times per day on command, and while in contact with the artifact, the bird's bearer can use it as a _ [pearl of power](magicItems/wondrousItems#_pearl-of-power)_, but the spell recalled can be of any level.
- At will and on command, the bird's master can make it go forth and send messages, as if it were the subject of an _ [animal messenger](spell_dir/animalMessenger#_animal-messenger)_ spell. 
- Three times per day on command, the bird's master can have the magpie cast _ [breath of life](spells/breathOfLife#_breath-of-life)_.
...
- _ [Guards and wards](spell_dir/guardsAndWards#_guards-and-wards)_ 1/day on the central tower.
- _ [Storm of vengeance](spell_dir/stormOfVengeance#_storm-of-vengeance)_ 1/day. The master must be in the control chamber to use this ability, and the storm rains down from the castle's cloudy base upon everything within range underneath (2,200 feet).
...
| d% | Catastrophe |
| --- | --- |
| 01–25 | _Natural Fury:_ An _ [earthquake](spells/earthquake#_earthquake) _spell centered on the reader strikes every round for 1 minute, and an intensified _storm of vengeance_ spell is centered and targeted on the reader. |
...
This armor looks like a more massive and dangerous suit of _demon armor_. It is a suit of _+5 heavy [fortification](magicItems/armor#_armor-fortification) full plate_ that allows its wearer to make claw attacks that deal 2d10 points of damage, and strike as +3 weapons that are treated as chaotic and evil for the purposes of overcoming damage reduction. Additionally, those struck by the claws must succeed at a DC 20 Fortitude save or be affected as per the spell _ [contagion](spell_dir/contagion#_contagion)_. The armor's claws are built into the armor so these weapons cannot be disarmed. While wearing the armor, the wearer benefits from the following demonic traits.
...
- The user is immediately polymorphed into a dragon, as if subject to _ [form of the dragon I](spells/formOfTheDragon#_form-of-the-dragon-i)_, _II_, or _III_, depending on the user's Hit Dice. If the creature swallowing the tooth has 12 HD or fewer, it is affected as per _ [form of the dragon I](spell_dir/formOfTheDragon#_form-of-the-dragon-i)_. Those with 13 to 18 HD are affected as per _ [form of the dragon II](spells/formOfTheDragon#_form-of-the-dragon-ii),_ and those 19 or more Hit Dice are affected as per _ [form of the dragon III](spell_dir/formOfTheDragon#_form-of-the-dragon-iii)_. The type of dragon is chosen by the user based on its alignment.  
...
- The user gains a +4 competence bonus on [Fly](skills/fly#_fly) checks.
- The user gains a +4 competence bonus on [Bluff](skill_dir/bluff#_bluff), [Diplomacy](skills/diplomacy#_diplomacy), [Intimidate](skill_dir/intimidate#_intimidate), and [Sense Motive](skills/senseMotive#_sense-motive) checks made against or involving dragons.
...
- _ [Shadow](magicItems/armor#_armor-shadow) Form_: Three times per day the wielder can become a living shadow, with all the movement powers granted by _gaseous form_. 
...
A chaotic or evil character gains four negative levels when wielding the _ [Shield](spells/shield#_shield) of the Sun_. The negative levels persist as long as the shield is in hand and cannot be overcome in any way (including _ [restoration](spell_dir/restoration#_restoration)_ spells). The negative levels disappear when the shield is stowed or leaves the wearer's possession.

...
_Chaotic (violet flame): [Word of chaos](spells/wordOfChaos#_word-of-chaos)_ once per day on command.

_Good (white flame):_ Allies within 30 feet of the beacon gain the benefits of _ [protection from evil](spells/protectionFromEvil#_protection-from-evil)_ and _ [heroism](spells/heroism#_heroism)_.

_Evil (black flame):_ Bearer is constantly under the effect of _ [protection from good](spells/protectionFromGood#_protection-from-good)_ and may use _ [harm](spells/harm#_harm)_ twice per day.
...
| Throne | Four of wands | King of hearts | Gain a +6 bonus on [Diplomacy](skills/diplomacy#_diplomacy) checks plus a small castle. |
...
| 5 | Veh | The character is blinded as with _ [blindness/deafness](spells/blindnessDeafness#_blindness-deafness)_ (no saving throw). |
...
| 8 | Seh | The character is paralyzed for 2d12 hours, as with _ [hold monster](spells/holdMonster#_hold-monster)_, except he cannot attempt new saving throws to overcome the effect. |
| 9 | Kog | For the next week, the character emits a horrible smell. He suffers a –4 penalty on [Diplomacy](skills/diplomacy#_diplomacy) and [Stealth](skills/stealth#_stealth) checks. |
...
| 12 | Xal | The character gains the benefits of a _ [heroism](spells/heroism#_heroism)_ spell for the next 200 minutes. |
...
| 16 | Lev | Once in the next 24 hours, the character can cast a _ [lightning bolt](spells/lightningBolt#_lightning-bolt)_ (caster level equal to his character level). This ability islost if the character rolls this result again with the _knucklebone of fickle fortune_ before the 24 hours is concluded. |
...
If the check succeeds, the talisman remains with the character for 5d6 hours, or until a _ [wish](spells/wish#_wish)_ is made with it, whichever comes first. It then disappears.
...
A _talisman of reluctant wishes_ can be destroyed by wishing it so, using either one of the stone's _wishes_ or a _ [wish](spells/wish#_wish)_ spell from another source. The stone then explodes, causing 5d6 points of damage to the holder.
...
Furthermore, the _ [weird](spells/weird#_weird) queen's magpie_ has the following abilities.
...
- At will and on command, the bird's master can make it go forth and send messages, as if it were the subject of an _ [animal messenger](spells/animalMessenger#_animal-messenger)_ spell. 
...
The _ [weird](spells/weird#_weird) queen's magpie_ is destroyed if it enters the Positive Energy Plane.
...
In order to fully take control of the castle, a creature must be at least 17th level, and must have the [Leadership](feats#_leadership) feat and 17 ranks in [Knowledge](skills/knowledge#_knowledge) (arcana). If the castle already has a master, that master must be defeated before another can take her place. The castle's movement is controlled by way of a control chamber located at the heart (a central chamber on its 4th floor). There, a font of pure elemental water serves as a scrying device for the castle's master, though it can view only places inside the castle or within 100 feet of it. The master (or a person she designates) can direct the castle's motion from within the chamber. It has a fly speed of 250 feet (clumsy) and uses the [Fly](skills/fly#_fly) skill modifier of the person controlling its motion; the castle can hover without needing to make a [Fly](skills/fly#_fly) check and never risks falling due to a failed check. When not being controlled, the castle moves randomly, sometimes changing direction every minute, sometimes holding the same course for days at a time, but always avoiding the ground or other hazards. It has the ability to travel to other planes, though no master other than the Storm King is known to have invoked this power. The master of the castle gains the following spell-like abilities.

- [Call lightning storm](spells/callLightningStorm#_call-lightning-storm) 1/day. The master must be in the control chamber or one of the towers to use this ability.
...
| 51–75 | _Ultimate [Imprisonment](spells/imprisonment#_imprisonment):_ Reader's soul is captured (as _trap the soul ; _no save allowed) in a random gem somewhere on the plane while his or her body is entombed beneath the earth (as _imprisonment_). |
...
- The user is immediately polymorphed into a dragon, as if subject to _ [form of the dragon I](spells/formOfTheDragon#_form-of-the-dragon-i)_, _II_, or _III_, depending on the user's Hit Dice. If the creature swallowing the tooth has 12 HD or fewer, it is affected as per _ [form of the dragon I](spells/formOfTheDragon#_form-of-the-dragon-i)_. Those with 13 to 18 HD are affected as per _ [form of the dragon II](spells/formOfTheDragon#_form-of-the-dragon-ii),_ and those 19 or more Hit Dice are affected as per _ [form of the dragon III](spells/formOfTheDragon#_form-of-the-dragon-iii)_. The type of dragon is chosen by the user based on its alignment.  
...
- The user gains a +4 competence bonus on [Bluff](skills/bluff#_bluff), [Diplomacy](skills/diplomacy#_diplomacy), [Intimidate](skills/intimidate#_intimidate), and [Sense Motive](skills/senseMotive#_sense-motive) checks made against or involving dragons.
...
- _ [Shadow](magicItems/armor#_armor-shadow) Bolt_: Three times per day the staff can project a ray attack that deals 10d6 points of cold damage to a single target. The shadow bolt has a range of 100 feet.
...
The _Skullsoul_ cannot be destroyed but it can be contained. As long as the _Skullsoul_ stays pierced by either a weapon with the _ [vorpal](magicItems/weapons#_vorpal)_ special ability or a _ [holy avenger](magicItems/weapons#_holy-avenger)_, it is contained and entirely inert until the sword is removed.

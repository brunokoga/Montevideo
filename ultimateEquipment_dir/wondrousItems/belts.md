---
layout: default
title: ultimateEquipmen_dir/wondrousItems/belts
---
...
Craft Wondrous Item, _ [beast shape I](spell_dir/beastShape#_beast-shape-i), [bull's strength](spells/bullSStrength#_bull-s-strength)_
...
Craft Wondrous Item, _ [touch of the sea](advanced/spell_dir/touchOfTheSea#_touch-of-the-sea)_
...
Craft Wondrous Item,_ [lesser restoration](spell_dir/restoration#_restoration-lesser)_, _ [remove fear](spells/removeFear#_remove-fear)_

Belt of Fallen Heroes

**Price** 21,000 gp; **Aura** moderate conjuration; **CL** 6th; **Weight** 1 lb.

This large brass belt has three panels depicting scenes of battle. Once per day on command, the wearer can summon the spirit of a hero of one of the depicted battles. This spirit acts as an _ [unseen servant](spell_dir/unseenServant#_unseen-servant)_, though unlike the force created by that spell, the summoned hero is not entirely mindless_._ While the summoned hero is active, it attempts to guide its wearer to victory via telepathic warning and advice, granting its user a +1 insight bonus on all saving throws.

Construction Requirements

**Cost** 10,500 gp

Craft Wondrous Item, _ [divine favor](spells/divineFavor#_divine-favor), [unseen servant](spell_dir/unseenServant#_unseen-servant)_
...
This item functions as the _lesser belt of mighty hurling_, except it grants a +4 enhancement bonus to Strength and any thrown weapons its wearer hurls are treated as though they had the _ [returning](magicItem_dir/weapons#_weapons-returning)_ quality. This does not apply to improvised ranged weapons, splash weapons, or weapons the wearer lacks proficiency with. Treat the bonus to Strength as a temporary ability bonus for the first 24 hours the belt is worn.

Construction Requirements

**Cost** 21,000 gp

Craft Wondrous Item, _ [bull's strength](spells/bullSStrength#_bull-s-strength)_, _ [longshot](ultimateComba_dir/spells/longshot#_longshot)_, _ [returning weapon](ultimateComba_dir/spells/returningWeapon#_returning-weapon)_
...
Craft Wondrous Item, _ [bull's strength](spell_dir/bullSStrength#_bull-s-strength)_, _ [longshot](ultimateCombat/spell_dir/longshot#_longshot)_
...
Craft Wondrous Item, _ [bear's endurance](spells/bearSEndurance#_bear-s-endurance)_, _ [bull's strength](spell_dir/bullSStrength#_bull-s-strength)_, and/or _ [cat's grace](spell_dir/catSGrace#_cat-s-grace)_
...
Craft Wondrous Item, _ [bear's endurance](spells/bearSEndurance#_bear-s-endurance)_, _ [bull's strength](spell_dir/bullSStrength#_bull-s-strength)_, _ [cat's grace](spells/catSGrace#_cat-s-grace)_
...
Craft Wondrous Item, _ [bull's strength](spells/bullSStrength#_bull-s-strength)_, _ [lead blades](advance_dir/spells/leadBlades#_lead-blades-)_
...
Craft Wondrous Item, _ [magic weapon](spell_dir/magicWeapon#_magic-weapon)_
...
Craft Wondrous Item, _ [bear's endurance](spell_dir/bearSEndurance#_bear-s-endurance)_, _ [lesser restoration](spells/restoration#_restoration-lesser)_
...
Craft Wondrous Item, _ [bear's endurance](spells/bearSEndurance#_bear-s-endurance)_, _ [elemental body III](spell_dir/elementalBody#_elemental-body-iii)_
...
Craft Wondrous Items, _ [bull's strength](spells/bullSStrength#_bull-s-strength)_, _ [feather step](advance_dir/spells/featherStep#_feather-step)_, _ [poison](spell_dir/poison#_poison)_
...
Craft Wondrous Items, _ [bull's strength](spell_dir/bullSStrength#_bull-s-strength)_, _ [feather step](advanced/spell_dir/featherStep#_feather-step)_
...
Craft Wondrous Item, _ [beast shape I](spell_dir/beastShape#_beast-shape-i)_, _ [cat's grace](spells/catSGrace#_cat-s-grace)_
...
Craft Wondrous Item, _ [beast shape I](spells/beastShape#_beast-shape-i)_, _ [bull's strength](spell_dir/bullSStrength#_bull-s-strength)_, _ [cat's grace](spells/catSGrace#_cat-s-grace)_
...
Craft Wondrous Item, _ [bear's endurance](spell_dir/bearSEndurance#_bear-s-endurance)_, _ [neutralize poison](spells/neutralizePoison#_neutralize-poison)_, _ [remove disease](spell_dir/removeDisease#_remove-disease)_
...
Craft Wondrous Item, _ [bear's endurance](spells/bearSEndurance#_bear-s-endurance)_, _ [cat's grace](spell_dir/catSGrace#_cat-s-grace)_, _ [neutralize poison](spells/neutralizePoison#_neutralize-poison)_, _ [remove disease](spell_dir/removeDisease#_remove-disease)_
...
Craft Wondrous Item, _ [magic aura](spell_dir/magicAura#_magic-aura)_,_ [shrink item](spells/shrinkItem#_shrink-item)_
...
Craft Wondrous Item, _beast form I_,_ [neutralize poison](spells/neutralizePoison#_neutralize-poison)_,_ [summon nature's ally II](spell_dir/summonNatureSAlly#_summon-nature-s-ally-ii)_
...
Craft Wondrous Item, _beast form I_, _ [bull's strength](spells/bullSStrength#_bull-s-strength)_, _ [cat's grace](spell_dir/catSGrace#_cat-s-grace)_, _ [neutralize poison](spells/neutralizePoison#_neutralize-poison)_, _ [summon monster II](spell_dir/summonMonster#_summon-monster-ii)_ or _ [summon nature's ally II](spells/summonNatureSAlly#_summon-nature-s-ally-ii)_
...
Craft Wondrous Item, _cats [grace](advance_dir/spells/grace#_grace)_, _ [etherealness](magicItem_dir/armor#_armor-etherealness)_

---
layout: default
title: ultimateEquipmen_dir/wondrousItems/neck
---
...
An _aegis of recovery_ grants its wearer a +2 resistance bonus on all saving throws made to recover from a continuing effect, such as ongoing poison damage, daily saving throws against a disease, a _ [hold person](spell_dir/holdPerson#_hold-person)_ spell, or lingering damage from an attack. This bonus does not help against initial saving throws against such effects. Should the wearer ever drop below 0 hit points, the aegis heals the wearer for 2d8+3 points of damage and then crumbles to dust.

Construction Requirements

**Cost** 750 gp

Craft Wondrous Item, _ [barkskin](spells/barkskin#_barkskin)_, _ [cure moderate wounds](spell_dir/cureModerateWounds#_cure-moderate-wounds)_
...
Craft Wondrous item, _ [limited wish](spell_dir/limitedWish#_limited-wish), [polymorph](spells/polymorph#_polymorph), _creator must be a sorcerer of the appropriate bloodline
...
Craft Wondrous Item, _ [resist energy](spells/resistEnergy#_resist-energy)_, creator must be at least 8th level
...
Craft Wondrous Item, _ [permanency](spells/permanency#_permanency)_, creator must be a universalist
...
Craft Wondrous Item, _ [greater magic fang](spell_dir/magicFang#_magic-fang-greater)_, creator's caster level must be at least three times the amulet's bonus, plus any requirements of the melee weapon special abilities
...
Craft Wondrous Item, _ [stone to flesh](spells/stoneToFlesh#_stone-to-flesh)_
...
Craft Wondrous Items, _ [mnemonic enhancer](spells/mnemonicEnhancer#_mnemonic-enhancer)_
...
Craft Wondrous Item, _ [resist energy](spells/resistEnergy#_resist-energy)_, _ [shocking grasp](spell_dir/shockingGrasp#_shocking-grasp)_
...
If the collar is worn for at least 1 week by a creature of the animal type, the creature is raised to humanlike sentience, as though by the _ [awaken](spells/awaken#_awaken) _spell. Once this occurs, the collar loses its magical properties.
...
Craft Wondrous Item, _ [awaken](spell_dir/awaken#_awaken)_, _ [fox's cunning](spells/foxSCunning#_fox-s-cunning)_
...
Craft Wondrous Item, [Spell Penetration](feats#_spell-penetration), _ [magic weapon](spells/magicWeapon#_magic-weapon), [jump](spell_dir/jump#_jump)_
...
Craft Wondrous Item, _ [detect magic](spells/detectMagic#_detect-magic)_, creator must be at least 10th level
...
Craft Wondrous Item, _ [animate dead](spell_dir/animateDead#_animate-dead)_, _ [daylight](spells/daylight#_daylight)_, _ [see invisibility](spell_dir/seeInvisibility#_see-invisibility)_
...
Craft Wondrous Item, _ [mage hand](spells/mageHand#_mage-hand)_
...
Craft Wondrous Item, _ [detect thoughts](spells/detectThoughts#_detect-thoughts)_
...
Usually fashioned from brightly colored silk, a _mummer's ruff_ is a favored accoutrement of performers and con artists alike. The wearer of a _mummer's ruff_ gains a +10 bonus on [Bluff](skills/bluff#_bluff) skill checks when attempting to imitate another's voice. In addition, once per day, the wearer of the _mummer's ruff_ can throw his voice as if using _ [ventriloquism](spell_dir/ventriloquism#_ventriloquism) _for up to 5 minutes.

Construction Requirements

**Cost** 1,750 gp

Craft Wondrous Item, _ [sculpt sound](spells/sculptSound#_sculpt-sound), [ventriloquism](spell_dir/ventriloquism#_ventriloquism)_
...
Craft Wondrous Item, _ [fireball](spells/fireball#_fireball)_
...
Craft Wondrous Item, _ [calm emotions](spell_dir/calmEmotions#_calm-emotions)_, _ [owl's wisdom](spells/owlSWisdom#_owl-s-wisdom)_

Necklace of Netted Stars

**Price** 42,000 gp; **Aura** strong illusion and transmutation; **CL** 12th; **Weight** 1 lb.

This marvelous mithral necklace forms a broad, draping lacework of threadlike chains set with a multitude of tiny jewels. Seven of these jewels are larger than the rest. While wearing a _necklace of netted stars_, the wearer can create _ [dancing lights](spell_dir/dancingLights#_dancing-lights)_ at will and _ [wandering star motes](advanced/spell_dir/wanderingStarMotes#_wandering-star-motes)_ once per day. In addition, each of the seven jewels of the necklace can recall a previously cast 1st-level or 0-level spell, as a _pearl of power_.

Once per day, the wearer may use the necklace to catch a spell targeted at him, as if readying an action to counterspell using _ [dispel magic](spells/dispelMagic#_dispel-magic)_, with a bonus on the check equal to 12 + the number of jewels not yet used to recall spells that day. If all jewels have been used, this ability cannot be used that day. The level of the spell to be countered must be less than or equal to the number of unused jewels. If the counterspell succeeds, the spell is negated and the wearer can use its magical energy to recall a previously cast spell of the same level or lower as an immediate action. Whether or not the attempt succeeds, this action exhausts the power of all of the necklace's jewels for that day.

Construction Requirements

**Cost** 21,000 gp

Craft Wondrous Item, _ [dancing lights](spell_dir/dancingLights#_dancing-lights), [dispel magic](spells/dispelMagic#_dispel-magic), [wandering star motes](advance_dir/spells/wanderingStarMotes#_wandering-star-motes), _creator must be able to cast 7th-level spells
...
Craft Wondrous Item, _ [remove disease](spell_dir/removeDisease#_remove-disease)_
...
Craft Wondrous Item, _ [neutralize poison](spells/neutralizePoison#_neutralize-poison)_
...
Craft Wondrous Item, _ [remove curse](spells/removeCurse#_remove-curse)_
...
Craft Wondrous Item, _ [heal](spell_dir/heal#_heal)_
...
Craft Wondrous Item, [Improved Unarmed Strike](feats#_improved-unarmed-strike), _ [stone fist](advance_dir/spells/stoneFist#_stone-fist)_
...
Craft Wondrous Item, _ [death ward](spell_dir/deathWard#_death-ward)_, _ [spell resistance](magicItems/armor#_armor-spell-resistance)_
...
Craft Wondrous Item, _ [lightning bolt](spell_dir/lightningBolt#_lightning-bolt), [wind wall](spells/windWall#_wind-wall)_
...
Craft Wondrous Item, _ [repel vermin](spell_dir/repelVermin#_repel-vermin)_
...
Craft Wondrous Item, _ [bless water](spells/blessWater#_bless-water)_

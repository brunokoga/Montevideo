---
title: ultimateEquipmen_dir/wondrousItems/feet
---
...
Craft Wondrous Item, _ [pass without trace](spell_dir/passWithoutTrace#_pass-without-trace)_, creator must be a ranger

Boots of Levitation

**Price** 7,500 gp; **Aura** faint transmutation; **CL** 3rd; **Weight** 1 lb.

These soft leather boots are incredibly light and comfortable, with thin soles reinforced by strips of tough hide that provide an unexpected amount of support and protection to the foot. On command, these boots allow the wearer to levitate as if she had cast _ [levitate](spells/levitate#_levitate)_ on herself.
...
As a free action, the wearer of _boots of speed _can click her heels together, letting her act as though affected by a _ [haste](spells/haste#_haste) _spell for up to 10 rounds each day. The _ [haste](spell_dir/haste#_haste)_ effect's duration need not be consecutive rounds.
...
Craft Wondrous Item, _ [longstrider](spells/longstrider#_longstrider)_, creator must have 5 ranks in the [Acrobatics](skill_dir/acrobatics#_acrobatics) skill

Boots of Teleportation

**Price** 49,000 gp; **Aura** moderate conjuration; **CL** 9th; **Weight** 3 lbs.

When scrutinized closely, parts of these light gray boots appear to fade in and out of existence. Any character wearing this footwear may teleport three times per day, exactly as if she had cast the _ [teleport](spells/teleport#_teleport)_ spell.
...
Craft Wondrous Item, _ [feather fall](spells/featherFall#_feather-fall)_
...
Craft Wondrous Item, _ [beast shape III](spells/beastShape#_beast-shape-iii)_
...
Craft Wondrous Item, _ [endure elements](spell_dir/endureElements#_endure-elements)_, _ [pass without trace](spells/passWithoutTrace#_pass-without-trace)_, _ [resistance](spell_dir/resistance#_resistance)_, _ [water walk](spells/waterWalk#_water-walk)_

Boots of the Winterlands

**Price** 2,500 gp; **Aura** faint abjuration and transmutation; **CL** 5th; **Weight** 1 lb.

The wearer of these boots is able to travel across snow at her normal speed, leaving no tracks. Additionally, the boots enable her to travel at normal speed across the slipperiest ice (horizontal surfaces only, not vertical or sharply slanted ones) without falling or slipping. Finally, _boots of the winterlands_ warm the wearer, as if she were affected by an _ [endure elements](spell_dir/endureElements#_endure-elements)_ spell.

Construction Requirements

**Cost** 1,250 gp

Craft Wondrous Item, _ [cat's grace](spells/catSGrace#_cat-s-grace)_, _ [endure elements](spell_dir/endureElements#_endure-elements)_, _ [pass without trace](spells/passWithoutTrace#_pass-without-trace)_

Burglar Boots, Major

**Price** 46,000 gp; **Aura** moderate divination; **CL** 10th; **Weight** 1/2 lb.

These boots look and act as the _minor burglar boots_, but grant a +10 competence bonus on [Perception](skill_dir/perception#_perception) checks and to AC and on Reflex saves. Also, once per day on command, these boots grant the wearer the ability to use _ [find traps](spells/findTraps#_find-traps)_ as the spell.

Construction Requirements

**Cost** 23,000 gp

Craft Wondrous Item, _ [find traps](spell_dir/findTraps#_find-traps)_, creator must have at least 12 ranks in [Perception](skills/perception#_perception)
...
Craft Wondrous Item, creator must have 4 ranks in [Perception](skills/perception#_perception)
...
These sandals are woven from grass, lengths of pliant vine, living leaves, and supple bark. In forest terrain, the wearer leaves no tracks or scent and gains a +2 competence bonus on [Stealth](skills/stealth#_stealth) checks. The wearer can move through natural undergrowth without impediment or harm as a druid using woodland stride , and once per day she may step inside a tree and remain there for up to 9 hours, or teleport to a similar tree within range, as _ [tree stride](spell_dir/treeStride#_tree-stride) _but allowing only a single teleport.

Construction Requirements

**Cost** 12,000 gp

Craft Wondrous Item, _ [pass without trace](spells/passWithoutTrace#_pass-without-trace), [tree stride](spell_dir/treeStride#_tree-stride)_, creator must be a druid
...
Craft Wondrous Item, _ [elemental body I](spells/elementalBody#_elemental-body-i)_
...
Once per day, the wearer can command the ghostly spirits inside her _haunted shoes _to emerge and swirl around her, making her difficult to target in combat. The wearer gains concealment (20% miss chance) for 3 minutes. The spirits cannot be harmed, but a _ [true seeing](spells/trueSeeing#_true-seeing)_ spell ignores the concealment effect. The concealment effect cannot be activated while any of the spirits are currently being used as _unseen servants._

Construction Requirements

**Cost** 3,240 gp

Craft Wondrous Item, _ [blur](spell_dir/blur#_blur)_, _ [unseen servant](spells/unseenServant#_unseen-servant)_
...
These massive horseshoes sport deadly spikes that jut from their front. Once per day on command, the rider of a mount wearing these shoes may choose to either increase the mount's size by one size increment (maximum Huge), or change its type to magical beast, as _ [beast shape IV](spells/beastShape#_beast-shape-iv)_. In addition, while the mount is augmented in either of these two ways, it gains DR/5 chaos, evil, good, or law (selected by the rider). These horseshoes are part of a set and require all four to be worn by the same animal to properly function.

Construction Requirements

**Cost** 19,800 gp

Craft Wondrous Item, _beastshape IV_, _ [protection from chaos](spell_dir/protectionFromChaos#_protection-from-chaos)/evi_dir/good/law_

Horseshoes of Mist

**Price** 27,000 gp; **Aura** faint transmutation; **CL** 5th; **Weight** 12 lbs.

When a horse is shod with these horseshoes, they give off a puff of mist each time a hoof strikes the earth. On the rider's command, the mount and the rider are both affected as if subject to a _ [gaseous form](spell_dir/gaseousForm#_gaseous-form)_ spell. If for some reason the rider and the mount become separated from one another while in _ [gaseous form](spells/gaseousForm#_gaseous-form),_ the effect automatically ends for both. The horseshoes can be used for 10 minutes per day. The duration need not be consecutive, but it must be spent in 1-minute increments.

Construction Requirements

**Cost** 13,500 gp

Craft Wondrous Item, _ [gaseous form](spell_dir/gaseousForm#_gaseous-form)_
...
Craft Wondrous Item, _ [jester's jaunt](advance_dir/spells/jesterSJaunt#_jester's-jaunt)_
...
Craft Wondrous Item, _ [burning hands](spell_dir/burningHands#_burning-hands)_, _ [pyrotechnics](spells/pyrotechnics#_pyrotechnics)_
...
Craft Wondrous Item, _ [burning hands](spell_dir/burningHands#_burning-hands)_, _ [obscuring mist](spells/obscuringMist#_obscuring-mist)_, _ [stinking cloud](spell_dir/stinkingCloud#_stinking-cloud)_
...
Craft Wondrous Item, _ [anticipate peril](ultimateMagic/spell_dir/anticipatePeril#_anticipate-peril)_, _ [haste](spells/haste#_haste)_
...
Craft Wondrous Item, _ [spider climb](spell_dir/spiderClimb#_spider-climb)_
...
Craft Wondrous Item, _ [ride the waves](ultimateMagic/spell_dir/rideTheWaves#_ride-the-waves)_
...
Craft Wondrous Item, _ [see invisibility](spells/seeInvisibility#_see-invisibility)_
...
Craft Wondrous Item, _ [plant growth](spell_dir/plantGrowth#_plant-growth)_

Winged boots

**Price** 16,000 gp; **Aura** moderate transmutation; **CL** 8th; **Weight** 1 lb.

These boots appear to be ordinary footgear. On command, they sprout wings at the heel and let the wearer fly, without having to maintain concentration, as if affected by a _ [fly](spells/fly)_ spell (including a +4 bonus on [Fly](skill_dir/fly#_fly) skill checks). The wearer can fly three times per day for up to 5 minutes per flight.

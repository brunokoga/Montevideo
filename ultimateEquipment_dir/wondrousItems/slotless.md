...
Craft Wondrous Item, _ [magic circle against evil](spells/magicCircleAgainstEvil#_magic-circle-against-evil), [permanency](spells/permanency#_permanency)_
...
Craft Wondrous Item, _ [bestow curse](spells/bestowCurse#_bestow-curse)_, _ [bleed](spells/bleed#_bleed)_
...
Craft Wondrous Item, _ [magic mouth](spells/magicMouth#_magic-mouth)_, _ [major image](spells/majorImage#_major-image)_
...
Craft Wondrous Item, _ [animate objects](spells/animateObjects#_animate-objects)_, _ [continual flame](spells/continualFlame#_continual-flame)_, creator must have 8 ranks in [Knowledge](skills/knowledge#_knowledge) (engineering)

Apple of Eternal Sleep

**Price** 2,500 gp; **Aura** moderate enchantment; **CL** 10th; **Weight** —

This ripe red apple looks fresh and delicious. Should anyone bite into it (even a small taste), he must make an immediate DC 19 Will saving throw or fall into an eternal slumber as though by the witch's grand hex of the same name. The victim can only be awakened by a casting of _ [break enchantment](spells/breakEnchantment#_break-enchantment)_, _ [limited wish](spells/limitedWish#_limited-wish)_, _ [wish](spells/wish#_wish)_, or _ [miracle](spells/miracle#_miracle)_, or by a kiss from someone of royal blood.
...
This torch is made of pale yellow wood and inscribed with holy runes. When lit, it burns as a regular torch, but only lasts for 5 minutes. When held by a lawful good creature, it functions as an _ [archon's aura](ultimateMagic/spells/archonSAura#_archon's-aura)_ spell. The magical aura ends if a lawful good creature isn't holding it, and resumes automatically if a lawful good creature holds it again.

Construction Requirements

**Cost** 375 gp

Craft Wondrous Item, _ [archon's aura](ultimateMagic/spells/archonSAura#_archon's-aura)_
...
Craft Wondrous Item, _ [protection from arrows](spells/protectionFromArrows#_protection-from-arrows)_
...
This small sack looks empty at first glance. Anyone reaching into the bag feels a small, fuzzy ball inside. If the ball is removed and tossed up to 20 feet away, it turns into an animal. The animal serves the character who drew it from the bag for 10 minutes (or until slain or ordered back into the bag), at which point it disappears. It can follow any of the commands described in the [Handle Animal](skills/handleAnimal#_handle-animal) skill. Each of the three kinds of bags of tricks produces a different set of animals. Use the following tables to determine what animals can be drawn out of each.
...
Craft Wondrous Item, _ [summon nature's ally II](spells/summonNatureSAlly#_summon-nature-s-ally-ii)_ (gray), _ [summon nature's ally III](spells/summonNatureSAlly#_summon-nature-s-ally-iii)_ (rust), or _ [summon nature's ally V](spells/summonNatureSAlly#_summon-nature-s-ally-v)_ (tan)
...
Craft Wondrous Item, _ [grace](advanced/spells/grace#_grace)_
...
Once thrown, a _bead of force_ functions like a _ [resilient sphere](spells/resilientSphere#_resilient-sphere)_ spell (Reflex DC 16 negates) with a radius of 10 feet and a duration of 10 minutes. A globe of shimmering force encloses the targeted creature, provided the latter is small enough to fit within the diameter of the sphere. The sphere contains its subject for the spell's duration. The sphere is not subject to damage of any sort except from a _ [rod of cancellation](magicItems/rods#_rod-of-cancellation)_, a _ [rod of negation](magicItems/rods#_rod-of-negation)_, _ [disintegrate](spells/disintegrate#_disintegrate)_, or a targeted _ [dispel magic](spells/dispelMagic#_dispel-magic)_ spell. These effects destroy the sphere without harm to the subject. Nothing can pass through the sphere, inside or out, though the subject can breathe normally. The subject may struggle, but the globe cannot be physically moved either by people outside it or by the struggles of those within. The explosion completely consumes the bead, making this a one-use item.
...
This bead is carved with a tiny pictogram representing a small, harmless animal such as a newt, rabbit, or frog. If the bearer fails a saving throw against a hostile polymorph effect such as _ [baleful polymorph](spells/balefulPolymorph#_baleful-polymorph)_, the bead is destroyed and the effect does not affect the bearer.
...
Craft Wondrous Item, [Reach Spell](advanced/advancedFeats#_reach-spell), creator must have an animal companion or familiar
...
Craft Wondrous Item, _ [death ward](spells/deathWard#_death-ward)_, _ [restoration](spells/restoration#_restoration)_
...
Craft Wondrous Item, _ [death knell](spells/deathKnell#_death-knell)_
...
Craft Wondrous Item, [Extend Spell](feats#_extend-spell), _ [summon monster I](spells/summonMonster#_summon-monster-i)_
...
Craft Wondrous Item, _ [nondetection](spells/nondetection#_nondetection)_, _ [secret page](spells/secretPage#_secret-page)_
...
Craft Wondrous Item, _ [instant summons](spells/instantSummons#_instant-summons)_
...
Craft Wondrous Item, _ [magic mouth](spells/magicMouth#_magic-mouth)_
...
This small opaque flask releases a thick stream of coarse white fur when opened. This fur creeps up the user's arm and across her entire body until she is completely covered in a tangled pelt. While coated with this fur she gains cold resistance 5, a +2 natural armor bonus to AC, and a +4 competence bonus on [Stealth](skills/stealth#_stealth) checks in areas of ice and snow. This fur sheds from her body after 24 hours, or can be removed early by soaking it in alcohol. The flask is expended after one use.

Construction Requirements

**Cost** 400 gp

Craft Wondrous Item, _ [barkskin](spells/barkskin#_barkskin), [resist energy](spells/resistEnergy#_resist-energy)_
...
Craft Wondrous Item, _ [wall of force](spells/wallOfForce#_wall-of-force)_

Bowl of Conjuring Water Elementals

**Price** 90,000 gp; **Aura** moderate conjuration; **CL** 11th; **Weight** 3 lbs.

This large container is usually fashioned from silver with a rippled pattern. It is about 1 foot in diameter and half that deep. The bowl must be filled with fresh or salt water to function. On command as a full-round action, the bearer may summon a water elemental. If the bowl is filled with salt water, it conjures a Huge water elemental as if using _ [summon monster VI](spells/summonMonster#_summon-monster-vi)_. If filled with fresh water, it conjures a Large water elemental as if using _ [summon monster V](spells/summonMonster#_summon-monster-v)_. Conjuring an elemental empties the bowl. The bowl cannot summon another elemental until the previous one is dismissed, killed, or the duration of its summoning expires.

Construction Requirements

**Cost** 45,000 gp

Craft Wondrous Item, _ [summon monster V](spells/summonMonster#_summon-monster-v)_, _ [summon monster VI](spells/summonMonster#_summon-monster-vi)_

Brazier of Conjuring Fire Elementals

**Price** 90,000 gp; **Aura** moderate conjuration; **CL** 11th; **Weight** lbs.

This device appears to be a normal container for holding burning coals. The brazier must be filled with coals or wood and a fire lit within it to function. On command as a full-round action, the bearer may summon a fire elemental. If 1 pound of brimstone (sulfur) is burning in the brazier, it conjures a Huge fire elemental as if using _ [summon monster VI](spells/summonMonster#_summon-monster-vi)_. Otherwise, the brazier conjures a Large fire elemental as if using _ [summon monster V](spells/summonMonster#_summon-monster-v)_. Conjuring an elemental extinguishes the fire in the brazier. The brazier cannot summon another elemental until the previous one is dismissed, killed, or the duration of its summoning expires.
...
This broom is able to fly through the air as if affected by an _ [overland flight](spells/overlandFlight#_overland-flight)_ spell (+4 on [Fly](skills/fly#_fly) skill checks) for up to 9 hours per day (split up as its owner desires). The broom can carry 200 pounds and fly at a speed of 40 feet, or up to 400 pounds at a speed at 30 feet. In addition, the broom can travel alone to any destination named by the owner as long as she has a good idea of the location and layout of that destination. It flies to its owner from as far away as 900 feet when she speaks the command word. The _broom of flying_ has a speed of 40 feet when it has no rider.

Construction Requirements

**Cost** 8,500 gp

Craft Wondrous Item, _ [overland flight](spells/overlandFlight#_overland-flight)_, _ [permanency](spells/permanency#_permanency)_
...
Craft Wondrous Item,_ [wind wall](spells/windWall#_wind-wall)_
...
In addition, burning a candle also allows the owner to cast a _ [gate](spells/gate#_gate)_ spell, the respondent being of the same alignment as the candle, but the taper is immediately consumed in the process.
...
This white tallow candle, when burned, calls into place a _ [zone of truth](spells/zoneOfTruth#_zone-of-truth)_ spell (Will DC 13 negates) in a 5-foot radius centered on the candle. The zone lasts for 1 hour, while the candle burns. If the candle is snuffed before that time, the effect is ended and the candle ruined.
...
Craft Wondrous Item, _ [compel hostility](ultimateCombat/spells/compelHostility#_compel-hostility) _, creator must have 5 ranks in the [Bluff](skills/bluff#_bluff) skill

Carpet of Flying

**Price** Varies; **Aura** moderate transmutation; **CL** 10th; **Weight** varies

This rug is able to fly through the air as if affected by an _ [overland flight](spells/overlandFlight#_overland-flight)_ spell of unlimited duration. The size, carrying capacity, and speed of the different _carpets of flying_ are shown on the table below. Beautifully and intricately made, each carpet has its own command word to activate it—if the device is within voice range, the command word activates it, whether the speaker is on the rug or not. The carpet is then controlled by spoken directions.
...
A _carpet of flying_ can carry up to double its capacity, but doing so reduces its speed to 30 feet. A _carpet of flying_ can hover without making a [Fly](skills/fly#_fly) skill check and gives a +5 bonus to other [Fly](skills/fly#_fly) checks.
...
Craft Wondrous Item, _ [create food and water](spells/createFoodAndWater#_create-food-and-water)_, _ [heroes' feast](spells/heroesFeast#_heroes-feast)_

Cauldron of Resurrection

**Price** 33,000 gp; **Aura** strong conjuration; **CL** 13th; **Weight** 35 lbs.

The mouth of this heavy, dark iron cauldron is shaped like a monstrous maw and is large enough to accommodate a single Medium creature. When the cauldron is filled with pure water and certain rare and sacred herbs, and a deceased creature is placed inside it, the cauldron can restore the creature to life as if with a _ [raise dead](spells/raiseDead#_raise-dead) _or _ [resurrection](spells/resurrection#_resurrection)_ spell. The spell effect depends on the components used: _ [raise dead](spells/raiseDead#_raise-dead)_ costs 5,000 gp worth of materials, while _ [resurrection](spells/resurrection#_resurrection)_ costs 10,000 gp worth of materials. The cauldron is usable once per day.

Construction Requirements

**Cost** 16,500 gp

Craft Wondrous Item, _ [resurrection](spells/resurrection#_resurrection)_
...
- _ [lesser confusion](spells/confusion#_confusion-lesser)_ (1 charge)
- _ [magic circle against law](spells/magicCircleAgainstLaw#_magic-circle-against-law)_ (1 charge)
- _ [chaos hammer](spells/chaosHammer#_chaos-hammer)_ (2 charges)
...
Craft Wondrous Item, _ [chaos hammer](spells/chaosHammer#_chaos-hammer)_, _ [entropic shield](spells/entropicShield#_entropic-shield)_, _ [lesser confusion](spells/confusion#_confusion-lesser)_, _ [magic circle against law](spells/magicCircleAgainstLaw#_magic-circle-against-law)_, creator must be chaotic
...
This foot-long tube of gold absorbs nearby sound when struck, as if it were the target of a _ [silence](spells/silence#_silence)_ spell. This ability can be used once per day. The chime vibrates silently for the next 5 rounds, increasing in strength as time passes. On the bearer's turn each round there is a cumulative 20% chance that the chime prematurely ends the magical silence and releases the pent-up sound as a _ [shout](spells/shout#_shout)_ spell as a free action, oriented in a random direction. The bearer may spend a standard action to strike the vibrating chime again, ending its _ [silence](spells/silence#_silence)_ early and unleashing the _ [shout](spells/shout#_shout)_ in a direction of his choosing. If dropped while vibrating, the chime automatically gains the broken condition and releases the _ [shout](spells/shout#_shout)_ effect in a random direction. A broken _chime of resounding [silence](spells/silence#_silence) _cannot be used until it is repaired. The chime has no effect if struck in an area of _ [silence](spells/silence#_silence)_ it did not create.

Construction Requirements

**Cost** 5,000 gp

Craft Wondrous Item, _ [shout](spells/shout#_shout)_, _ [silence](spells/silence#_silence)_
...
This 4-inch-square cloth pocket has no powers unless it is sewn onto a garment (which takes 1d4 minutes). Once sewn, it changes its appearance to match the garment. Any magic item inside it cannot be magically detected, as if protected by _ [magic aura](spells/magicAura#_magic-aura)_. Hiding an item in the pocket gives the garment's wearer a +5 competence bonus on [Sleight of Hand](skills/sleightOfHand#_sleight-of-hand) checks to conceal the item. The pocket can be removed from the garment with a DC 10 [Heal](skills/heal#_heal) check or an appropriate [Craft](skills/craft#_craft) check such as [Craft](skills/craft#_craft) (cloth) or [Craft](skills/craft#_craft) (leather); failing this roll by 5 or more gives the pocket the broken condition.
...
Craft Wondrous Item, _ [make whole](spells/makeWhole#_make-whole)_
...
| _Crystal ball _with_ [see invisibility](spells/seeInvisibility#_see-invisibility)_ | 50,000 gp |
...
| _Crystal ball_ with _ [true seeing](spells/trueSeeing#_true-seeing)_ | 80,000 gp |

Construction Requirements

**_Crystal ball_** 21,000 gp; **_Crystal ball_ with _ [see invisibility](spells/seeInvisibility#_see-invisibility)_** 25,000 gp; **_Crystal ball _with _ [detect thoughts](spells/detectThoughts#_detect-thoughts)_** 25,500 gp; **_Crystal ball _with _telepathy_** 35,000 gp; **_Crystal ball _with _ [true seeing](spells/trueSeeing#_true-seeing)_** 40,000 gp

Craft Wondrous Item, _ [scrying](spells/scrying#_scrying)_ (plus any additional spells put into the _crystal ball_)

Cube of Force

**Price** 62,000 gp; **Aura** moderate evocation; **CL** 10th; **Weight** 1/2 lb.

This device is just under an inch across and can be made of ivory, bone, or any hard mineral. Typically, each of the cube's faces are polished smooth, but sometimes they are etched with runes. The device enables its possessor to put up a special cube made up of 6 individual _ [wall of force](spells/wallOfForce#_wall-of-force)_ spells, 10 feet on a side around her person. This cubic screen moves with the character and is impervious to the attack forms mentioned on the table below. The cube has 36 charges when fully charged—charges used are automatically renewed each day. The possessor presses one face of the cube to activate a particular type of screen or to deactivate the device. Each effect costs a certain number of charges to maintain for every minute (or portion of a minute) it is in operation. Also, when an effect is active, the possessor's speed is limited to the maximum value given on the following table.
...
| _ [Passwall](spells/passwall#_passwall)_ | 3 |
| _ [Phase door](spells/phaseDoor#_phase-door)_ | 5 |
| _ [Prismatic spray](spells/prismaticSpray#_prismatic-spray)_ | 7 |
...
Craft Wondrous Item, _ [diminish plants](spells/diminishPlants#_diminish-plants)_
...
_1 charge_: The drinker gains 1d8 temporary hit points (as if from an _ [aid](spells/aid#_aid)_ spell), which last for 1 minute.
...
_3 charges_: The drinker gains 1d8+10 temporary hit points, is enlarged for 10 minutes, and gains the benefit of a _ [heroism](spells/heroism#_heroism)_ spell for as long as she is enlarged.
...
Craft Wondrous Item, _ [aid](spells/aid#_aid)_, _ [enlarge person](spells/enlargePerson#_enlarge-person)_, _ [heroism](spells/heroism#_heroism)_

Drum of Advance and Retreat

**Price** 10,000 gp; **Aura** faint transmutation; **CL** 1st; **Weight** 5 lbs.

When played, this sturdy snare drum increases the run speed of allied creatures within 120 feet as if they had the [Run](feats#_run) feat. Activating the drum is a standard action that requires a DC 20 [Perform](skills/perform#_perform) (percussion) check; maintaining the playing is a free action if the player is running. If the bearer stops playing the drum, the enhanced running speed ends. The drum may be used for up to 1 hour per day. This duration does not need to be consecutive, but must be used in 10-minute increments.
...
This set of kettle drums is carried on a shoulder strap and played one-handed using a single two-sided mallet. By making a DC 20 [Perform](skills/perform#_perform) (percussion) check, the bearer can grant the effects of a _ [haste](spells/haste#_haste)_ spell on up to 5 creatures. The drums can affect up to 25 creatures per day.
...
These drums are kettle drums (hemispheres about 1-1/2 feet in diameter on stands). They come in pairs and are unremarkable in appearance. If both of the pair are sounded, all creatures within 120 feet (with the exception of those within a 20-foot-radius safe zone around the drums) are affected as by a _ [fear](spells/fear#_fear)_ spell (Will DC 16 partial). _Drums of panic_ can be used once per day.
...
Craft Wondrous Item, _ [air bubble](ultimateCombat/spells/airBubble#_air-bubble)_
...
Craft Wondrous Item, _ [control water](spells/controlWater#_control-water)_, _ [disintegrate](spells/disintegrate#_disintegrate)_

Dust of Appearance

**Price** 1,800 gp; **Aura** faint conjuration; **CL** 5th; **Weight** —

This powder appears to be a very fine, very light metallic dust. A single handful of this substance flung into the air coats objects within a 10-foot radius, making them visible even if they are invisible. It likewise negates the effects of _ [blur](spells/blur#_blur)_ and _ [displacement](spells/displacement#_displacement)_. In this, it works just like the _ [faerie fire](spells/faerieFire#_faerie-fire)_ spell. The dust also reveals figments, mirror images, and projected images for what they are. A creature coated with the dust takes a –30 penalty on its [Stealth](skills/stealth#_stealth) checks. The dust's effect lasts for 5 minutes.
...
Craft Wondrous Item, _ [glitterdust](spells/glitterdust#_glitterdust)_

Dust of Darkness

**Price** 600 gp; **Aura** faint evocation; **CL** 3rd; **Weight** —

This shimmering black dust causes one creature to be coated in a layer of darkness for 1 minute. In normal light, the creature gains concealment (20% miss chance). In dim light, the creature gains total concealment (50% miss chance). It has no effect in areas of bright light or darkness (though in bright light, a viewer can make a DC 20 [Perception](skills/perception#_perception) check to notice the target is slightly shadowed). Creatures with darkvision see through the dust's darkness as if it were normal darkness. The dust dispels and counters the outlining effects of _ [glitterdust](spells/glitterdust#_glitterdust)_, but doesn't affect the spell's blinding effects. _ [Glitterdust](spells/glitterdust#_glitterdust)_ dispels and counters the effects of the _dust of [darkness](spells/darkness#_darkness)_.
...
This dust looks like _dust of appearance_ and is typically stored in the same manner. A creature or object touched by it becomes invisible (as _ [greater invisibility](spells/invisibility#_invisibility-greater)_). Normal vision can't see dusted creatures or objects, nor can they be detected by magical means, including _ [see invisibility](spells/seeInvisibility#_see-invisibility)_ or _ [invisibility purge](spells/invisibilityPurge#_invisibility-purge)_. _Dust of appearance_, however, does reveal people and objects made invisible by _dust of disappearance_. Other factors, such as sound and smell, also allow possible detection. The _ [greater invisibility](spells/invisibility#_invisibility-greater)_ bestowed by the dust lasts for 2d6 rounds. The invisible creature doesn't know when the duration will end.

Construction Requirements

**Cost** 1,750 gp

Craft Wondrous Item,_ [greater invisibility](spells/invisibility#_invisibility-greater)_
...
This unremarkable powder resembles chalk dust or powdered graphite. When stared at, however, the dust changes color and form. A creature covered in _dust of illusion _is affected as if by a _ [disguise self](spells/disguiseSelf#_disguise-self)_ glamer, with the individual who sprinkles the dust envisioning the illusion desired. An unwilling target is allowed a DC 11 Reflex save to avoid the dust. The glamer lasts for 2 hours.
...
A handful of dust sprinkled along a trail causes evidence of the passage of as many as a dozen humanoids and horses to be obliterated for 250 feet back into the distance. The results of the dust are instantaneous, and no magical aura lingers afterward from this use of the dust. [Survival](skills/survival#_survival) checks made to track a quarry across an area affected by this dust have a DC 20 higher than normal.
...
Craft Wondrous Item, _ [slow](spells/slow#_slow)_, _ [stone shape](spells/stoneShape#_stone-shape)_
...
Craft Wondrous Item, _ [summon monster V](spells/summonMonster#_summon-monster-v)_ or _ [summon nature's ally V](spells/summonNatureSAlly#_summon-nature-s-ally-v)_
...
Craft Wondrous Item, _ [dragon's breath](advanced/spells/dragonSBreath#_dragon's-breath)_
...
Craft Wondrous Item, _ [scorching ray](spells/scorchingRay#_scorching-ray)_
...
Craft Wondrous Item, creator must have 5 ranks in the [Swim](skills/swim#_swim) skill
...
This draught of liquid grants the drinker the ability to tumble about, avoiding attacks and moving carefully across nearly any surface, granting a +10 competence bonus on [Acrobatics](skills/acrobatics#_acrobatics) checks for 1 hour.
...
Drinking this elixir grants the imbiber the ability to notice acute details with great accuracy (+10 competence bonus on [Perception](skills/perception#_perception) checks for 1 hour).
...
Craft Wondrous Item, _ [gentle repose](spells/gentleRepose#_gentle-repose)_, _ [stoneskin](spells/stoneskin#_stoneskin)_
...
Craft Wondrous Item, _ [pyrotechnics](spells/pyrotechnics#_pyrotechnics)_

Exorcist's Aspergillum

**Price** 8,000 gp; **Aura** moderate divination; **CL** 7th; **Weight** 1 lb.

This short aspergillum is made of silver. An inquisitor who carries it may use _ [detect undead](spells/detectUndead#_detect-undead)_ as if it were one of the spells associated with her detect alignment ability. Once per day, the item can alter an inquisitor's judgment ability; by spending one use of her judgment ability, she can allow her spells of 3rd level and lower to have full effect against incorporeal creatures, as though using the [Ectoplasmic Spell](advanced/advancedFeats#_ectoplasmic-spell) feat. This lasts until the combat ends.

Construction Requirements

**Cost** 4,000 gp

Craft Wondrous Item, [Ectoplasmic Spell](advanced/advancedFeats#_ectoplasmic-spell), _ [detect undead](spells/detectUndead#_detect-undead)_, creator must be an inquisitor
...
Craft Wondrous Item, _ [true strike](spells/trueStrike#_true-strike)_
...
Craft Wondrous Item, _ [fabricate](spells/fabricate#_fabricate)_, creator must have 2 ranks in [Craft](skills/craft#_craft) (ships)
...
Brew Potion, [Craft Wondrous Item](feats#_craft-wondrous-item), _ [identify](spells/identify#_identify), _creator must be an alchemist
...
A _greater goblin fire drum_ has all the above abilities and can _create [pyrotechnics](spells/pyrotechnics#_pyrotechnics)_ once per day.

Construction Requirements

**Normal** 1,000 gp; **Greater** 2,250 gp

Craft Wondrous Item, _ [pyrotechnics](spells/pyrotechnics#_pyrotechnics)_, _ [spark](advanced/spells/spark#_spark-) (Advanced Player's Guide)_
...
A skull bomb can be used as a thrown weapon with a range increment of 10 feet. If the attacker hits, the skull shatters, immolating the target as described above. If the attacker misses, the skull breaks upon the floor or another nearby hard surface and the attacker bursts into flame. Touching the skull using gloves, gauntlets, or handheld items such as tools or weapons counts as touching the skull. It can be safely moved using spells (such as _ [mage hand](spells/mageHand#_mage-hand)_ or _ [telekinesis](spells/telekinesis#_telekinesis)_) or attacked with ranged weapons (hardness 0, 1 hp).

Construction Requirements

**Cost** 600 gp

Craft Wondrous Item, _ [flaming sphere](spells/flamingSphere#_flaming-sphere)_
...
_Clay Golem Manual_: The book contains _ [animate objects](spells/animateObjects#_animate-objects)_, _ [bless](spells/bless#_bless)_, _ [commune](spells/commune#_commune)_, _ [prayer](spells/prayer#_prayer)_, and _ [resurrection](spells/resurrection#_resurrection)_. The reader may treat her caster level as two levels higher than normal for the purpose of crafting a clay golem. Moderate conjuration, divination, enchantment, and transmutation; CL 11th; [Craft Construct](monsters/monsterFeats#_craft-construct), _ [animate objects](spells/animateObjects#_animate-objects)_, _ [commune](spells/commune#_commune)_, _ [prayer](spells/prayer#_prayer)_, _ [resurrection](spells/resurrection#_resurrection)_, creator must be caster level 11th.

_Flesh Golem Manual_: The book contains_ [animate dead](spells/animateDead#_animate-dead)_, _ [bull's strength](spells/bullSStrength#_bull-s-strength)_, _ [geas/quest](spells/geasQuest#_geas-quest)_, and _ [limited wish](spells/limitedWish#_limited-wish)_. The reader may treat her caster level as one level higher than normal for the purpose of crafting a flesh golem. Moderate enchantment, necromancy [evil], and transmutation; CL 8th; [Craft Construct](monsters/monsterFeats#_craft-construct), _ [animate dead](spells/animateDead#_animate-dead)_, _ [bull's strength](spells/bullSStrength#_bull-s-strength)_, _ [geas/quest](spells/geasQuest#_geas-quest)_, _ [limited wish](spells/limitedWish#_limited-wish)_, creator must be caster level 8th.

_Iron Golem Manual_: The book contains _ [cloudkill](spells/cloudkill#_cloudkill)_,_ [geas/quest](spells/geasQuest#_geas-quest)_, _ [limited wish](spells/limitedWish#_limited-wish)_, and _ [polymorph any object](spells/polymorphAnyObject#_polymorph-any-object)_. The reader may treat her caster level as four levels higher than normal for the purpose of crafting an iron golem. Strong conjuration, enchantment, and transmutation; CL 16th; [Craft Construct](monsters/monsterFeats#_craft-construct), _ [cloudkill](spells/cloudkill#_cloudkill)_, _ [geas/quest](spells/geasQuest#_geas-quest)_, _ [limited wish](spells/limitedWish#_limited-wish)_, _ [polymorph any object](spells/polymorphAnyObject#_polymorph-any-object)_, creator must be caster level 16th.

_Stone Golem Manual_: The book contains _ [antimagic field](spells/antimagicField#_antimagic-field)_, _ [geas/quest](spells/geasQuest#_geas-quest)_, _ [limited wish](spells/limitedWish#_limited-wish)_, and _ [symbol of stunning](spells/symbolOfStunning#_symbol-of-stunning)_. The reader may treat her caster level as three levels higher than normal for the purpose of crafting a stone golem. Strong abjuration and enchantment; CL 14th; [Craft Construct](monsters/monsterFeats#_craft-construct), _ [antimagic field](spells/antimagicField#_antimagic-field)_, _ [geas/quest](spells/geasQuest#_geas-quest)_, _ [limited wish](spells/limitedWish#_limited-wish)_, _ [symbol of stunning](spells/symbolOfStunning#_symbol-of-stunning)_, creator must be caster level 14th.

_Stone Golem Guardian Manual_: The book contains _ [antimagic field](spells/antimagicField#_antimagic-field)_, _ [discern location](spells/discernLocation#_discern-location)_, _ [geas/quest](spells/geasQuest#_geas-quest)_, _ [limited wish](spells/limitedWish#_limited-wish)_,_ [shield other](spells/shieldOther#_shield-other)_, and _ [symbol of stunning](spells/symbolOfStunning#_symbol-of-stunning)_. The reader may treat her caster level as three levels higher than normal for the purpose of crafting a stone golem guardian. Strong abjuration and enchantment; CL 14th; [Craft Construct](monsters/monsterFeats#_craft-construct), _ [antimagic field](spells/antimagicField#_antimagic-field)_, _ [discern location](spells/discernLocation#_discern-location)_, _ [geas/quest](spells/geasQuest#_geas-quest)_, _ [limited wish](spells/limitedWish#_limited-wish)_, _ [shield other](spells/shieldOther#_shield-other)_, _ [symbol of stunning](spells/symbolOfStunning#_symbol-of-stunning)_, creator must be caster level 14th.
...
- _ [break](advanced/spells/break#_break-)_ (1 charge)
- _ [shatter](spells/shatter#_shatter)_ (2 charges)
...
Craft Wondrous Item, _ [break](advanced/spells/break#_break-)_, _ [shatter](spells/shatter#_shatter)_
...
Craft Wondrous Item, _ [greater shout](spells/shout#_shout-greater)_
...
Craft Wondrous Item, _ [obscuring mist](spells/obscuringMist#_obscuring-mist)_

Horn of Goodness/Evil

**Price** 6,500 gp; **Aura** moderate abjuration; **CL** 6th; **Weight** 1 lb.

This trumpet adapts itself to its owner, so it produces either a good or an evil effect depending on the owner's alignment. If the owner is neither good nor evil, the horn has no power whatsoever. If she is good, then blowing the horn has the effect of a _ [magic circle against evil](spells/magicCircleAgainstEvil#_magic-circle-against-evil)_. If she is evil, then blowing the horn has the effect of a _ [magic circle against good](spells/magicCircleAgainstGood#_magic-circle-against-good)_. In either case, this ward lasts for 1 hour. The horn can be blown once per day.

Construction Requirements

**Cost** 3,250 gp

Craft Wondrous Item, _ [magic circle against evil](spells/magicCircleAgainstEvil#_magic-circle-against-evil)_, _ [magic circle against good](spells/magicCircleAgainstGood#_magic-circle-against-good)_

Horn of Judgment

**Price** 15,000 gp; **Aura** moderate transmutation; **CL** 9th; **Weight** 1 lb.

This golden trumpet is inlaid with silver and ivory and in. Once per day the bearer can sound a singular clarion note that affects up to 9 incorporeal creatures within 30 feet with _ [ghostbane dirge](advanced/spells/ghostbaneDirge#_ghostbane-dirge)_ (Will DC 17 negates, _Advanced Player's Guide_) for 9 rounds.

Construction Requirements

**Cost** 7,500 gp

Craft Wondrous Item, _ [ghostbane dirge](advanced/spells/ghostbaneDirge#_ghostbane-dirge)_
...
Craft Wondrous Item, _ [greater heroism](spells/heroism#_heroism-greater)_
...
- Summon 1d4+1 sharks or 1d3 advanced sharks as if using _ [summon nature's ally V](spells/summonNatureSAlly#_summon-nature-s-ally-v)_.
...
Craft Wondrous Item, _ [control water](spells/controlWater#_control-water)_, _ [dismissal](spells/dismissal#_dismissal)_, _ [fear](spells/fear#_fear)_, _ [summon nature's ally V](spells/summonNatureSAlly#_summon-nature-s-ally-v)_, creator must be a triton
...
Craft Wondrous Item, _ [summon monster VI](spells/summonMonster#_summon-monster-vi)_

Horsemaster's Saddle

**Price** 12,000 gp; **Aura** faint transmutation; **CL** 5th; **Weight** 5 lbs.

This ornate military saddle, tooled with an elaborate equine motif, grants the mount a +5 competence bonus on [Acrobatics](skills/acrobatics#_acrobatics) checks and the mount's rider a +5 competence bonus on [Ride](skills/ride#_ride) checks. In addition, the mount gains the benefits of any teamwork feats possessed by the rider.

Construction Requirements

Cost 6,000 gp

Craft Wondrous Item, _ [mount](spells/mount#_mount), _creator must have 5 ranks in [Ride](skills/ride#_ride)
...
Craft Wondrous Item, [Maximize Spell](feats#_maximize-spell), _ [bless](spells/bless#_bless)_
...
Craft Wondrous Item, _ [shrink item](spells/shrinkItem#_shrink-item)_, _ [wall of iron](spells/wallOfIron#_wall-of-iron)_
...
The adamantine walls of an _instant fortress_ have 100 hit points and hardness 20. The fortress cannot be repaired except by a _ [wish](spells/wish#_wish)_ or a _ [miracle](spells/miracle#_miracle)_, which restores 50 points of damage taken.
...
Craft Wondrous Item, _ [mage's magnificent mansion](spells/mageSMagnificentMansion#_mage-s-magnificent-mansion)_
...
Regeneration from the _pearly white ioun stone_ works like a _ [ring of regeneration](magicItems/rings#_ring-of-regeneration)_. It only cures damage taken while the character is using the stone. The pale lavender and lavender-and-green stones work like a _ [rod of absorption](magicItems/rods#_rod-of-absorption)_, but absorbing a spell requires a readied action, and these stones cannot be used to empower spells. Stored spells in the vibrant purple stone must be placed by a spellcaster but can be used by anyone (see_ ring of minor [spell storing](magicItems/weapons#_spell-storing)_). See table on next page.
...
This item is merely a burned out, dull gray _ioun stone_ with a _ [continual flame](spells/continualFlame#_continual-flame)_ spell cast upon it. It retains the ability to float and orbit, and allows the bearer to carry light and still have his hands free. It may be in any crystalline shape common to _ioun stones_ (ellipsoid, prism, sphere, and so on).
...
Craft Wondrous Item, _ [trap the soul](spells/trapTheSoul#_trap-the-soul)_
...
Craft Wondrous Item, _ [silent image](spells/silentImage#_silent-image)_
...
Craft Wondrous Item, _ [hold portal](spells/holdPortal#_hold-portal)_
...
_Battle_: The red _knight's pennon of battle_ allows its bearer to benefit from _ [heroism](spells/heroism#_heroism)_ once per day.
...
_Parley_: The white _knight's pennon of parley_, when displayed approaching a negotiation, grants the bearer a +4 enhancement bonus on [Bluff](skills/bluff#_bluff), [Diplomacy](skills/diplomacy#_diplomacy), [Intimidate](skills/intimidate#_intimidate), and [Sense Motive](skills/senseMotive#_sense-motive) checks for 1 hour, so long as the bearer does not initiate any hostile action.

Construction Requirements

**Battle** 2,250 gp; **Honor** 1,100 gp; **Parley** 2,250 gp

Craft Wondrous Item, _ [heroism](spells/heroism#_heroism)_ (battle), _ [protection from evil](spells/protectionFromEvil#_protection-from-evil)_ (honor), _ [eagle's splendor](spells/eagleSSplendor#_eagle-s-splendor)_ (parley)
...
Craft Wondrous Item_, [invisibility purge](spells/invisibilityPurge#_invisibility-purge)_
...
Craft Wondrous Item, _ [arcane eye](spells/arcaneEye#_arcane-eye)_, _ [tree shape](spells/treeShape#_tree-shape)_, _ [whispering wind](spells/whisperingWind#_whispering-wind)_
...
Craft Wondrous Item, _ [rejuvenate eidolon](advanced/spells/rejuvenateEidolon#_rejuvenate-eidolon)_
...
Craft Wondrous Item, _ [unadulterated loathing](ultimateMagic/spells/unadulteratedLoathing#_unadulterated-loathing)_
...
Craft Wondrous Item, _ [eagle's splendor](spells/eagleSSplendor#_eagle-s-splendor)_ (leadership), _ [hallow](spells/hallow#_hallow)_ (crusades), _ [freedom of movement](spells/freedomOfMovement#_freedom-of-movement)_ (swiftness), _ [fear](spells/fear#_fear)_ (terror), _ [heroism](spells/heroism#_heroism)_ (victory)
...
Craft Wondrous Item, _ [mass cure light wounds](spells/cureLightWounds#_cure-light-wounds-mass)_, creator must be able to channel energy
...
Craft Wondrous Item, _ [wish](spells/wish#_wish)_ or _ [miracle](spells/miracle#_miracle)_
...
Craft Wondrous Item, _ [modify memory](spells/modifyMemory#_modify-memory)_, creator must be a fighter
...
Only normal, inanimate objects can be created. Creatures can't be created. The pigments must be applied to a surface. It takes 10 minutes and a DC 15 [Craft](skills/craft#_craft) (painting) check to depict an object with the pigments. _Marvelous pigments_ cannot create magic items. Objects of value depicted by the pigments—precious metals, gems, jewelry, ivory, and so on—appear to be valuable but are really made of tin, lead, glass, brass, bone, and other such inexpensive materials. The user can create normal weapons, armor, and any other mundane item (including foodstuffs) whose value does not exceed 2,000 gp. The effect is instantaneous.
...
Craft Wondrous Item, _ [banishment](spells/banishment#_banishment)_
...
Craft Wondrous Item, [Craft Magic Arms and Armor](feats#_craft-magic-arms-and-armor), _ [clenched fist](spells/clenchedFist#_clenched-fist)_
...
Craft Wondrous Item, _ [reincarnate](spells/reincarnate#_reincarnate)_ or _ [stone to flesh](spells/stoneToFlesh#_stone-to-flesh)_
...
Craft Wondrous Item, _ [mirror image](spells/mirrorImage#_mirror-image)_
...
Craft Wondrous Item, _ [clairaudience/clairvoyance](spells/clairaudienceClairvoyance#_clairaudience-clairvoyance)_, _ [detect thoughts](spells/detectThoughts#_detect-thoughts)_, _ [gate](spells/gate#_gate)_, _ [legend lore](spells/legendLore#_legend-lore)_
...
_Dark naga_: The wearer gains a +8 bonus on saves made to resist any form of mind reading and a +2 bonus against charm effects. _ [Poison](spells/poison#_poison) effect_: sleep for 1 round.
...
_Spirit naga_: Once per minute, the wearer can attempt to charm a single creature within 30 feet, as the spell _ [charm person](spells/charmPerson#_charm-person)_ (Will DC 19 negates). _ [Poison](spells/poison#_poison) effect_: 1d4 Con damage.

_Lunar naga_: Once per day, the wearer can spend a standard action to fascinate all creatures within 30 feet, as per the spell _ [hypnotism](spells/hypnotism#_hypnotism)_ (Will DC 19 negates). _ [Poison](spells/poison#_poison) effect_: 1d3 Con and 1 Wis.

_Royal naga_: Once per day, the wearer can attempt to blind or deafen a single creature within 30 feet, as the spell _ [blindness/deafness](spells/blindnessDeafness#_blindness-deafness)_ (Will DC 19 negates). _ [Poison](spells/poison#_poison) effect_: 1d6 bleed.
...
Craft Wondrous Item, _ [monstrous physique IV](ultimateMagic/spells/monstrousPhysique#_monstrous-physique-iv)_
...
Craft Wondrous Item, _ [create undead](spells/createUndead#_create-undead)_, creator must be a necromancer
...
Craft Wondrous Item, _ [shrink item](spells/shrinkItem#_shrink-item)_, creator must have 5 ranks in [Craft](skills/craft#_craft) (tattoos)
...
The silver pearl detects diseases in a 10-foot radius, turning bright blue on discovery. If swallowed, it grants the benefit of a _ [remove disease](spells/removeDisease#_remove-disease)_ spell.
...
Craft Wondrous Item, _ [delay poison](spells/delayPoison#_delay-poison), [detect poison](spells/detectPoison#_detect-poison), [remove disease](spells/removeDisease#_remove-disease), [see invisibility](spells/seeInvisibility#_see-invisibility)_

Oil of Silence

**Price** 250 gp; **Aura** faint illusion; **CL** 5th; **Weight** —

When applied to a one-handed or two-handed firearm, this strange grayish oil renders that firearm silent for 1 hour. Five vials of _oil of [silence](spells/silence#_silence)_ can be used in conjunction to silence a Large firearm siege engine, and 10 can be used to silence a Huge firearm siege engine. The oil does not work on firearm siege engines that are larger than Huge.
...
Craft Wondrous Item, _ [dread bolt](ultimateMagic/spells/dreadBolt#_dread-bolt) , _creator must be evil

Orb of Golden Heaven

**Price** 22,000 gp; **Aura** moderate evocation; **CL** 10th; **Weight** 1 lb.

This alabaster sphere, overlaid with golden bands set with diamonds in runelike patterns, sheds light like a _ [continual flame](spells/continualFlame#_continual-flame)_ spell. Making a melee touch attack with the orb has the same effect as dousing the target with a flask of holy water. A good creature may hold the orb in hand and command it to invoke _ [consecrate](spells/consecrate#_consecrate)_ and _ [searing light](spells/searingLight#_searing-light)_ each once per day.

The orb bestows one permanent negative level on any evil creature holding or carrying it. The negative level remains as long as the creature has the orb and disappears immediately when the orb is no longer held or carried. This negative level cannot be overcome in any way (including by _ [restoration](spells/restoration#_restoration)_ spells) while the bearer has the orb. If the bearer of an _orb of golden heaven_ wears a _crown of golden heaven_, its light counts as _ [daylight](spells/daylight#_daylight)_ instead of _ [continual flame](spells/continualFlame#_continual-flame)_, and its _ [consecrate](spells/consecrate#_consecrate)_ acts as if the orb were a shrine to the bearer's deity.

Construction Requirements

Cost 11,000 gp

Craft Wondrous Item, _ [bless water](spells/blessWater#_bless-water), [consecrate](spells/consecrate#_consecrate), [daylight](spells/daylight#_daylight), [searing light](spells/searingLight#_searing-light)_
...
When held in hand, the bearer of the orb may use _ [detect chaos](spells/detectChaos#_detect-chaos)_ and _ [detect law](spells/detectLaw#_detect-law)_ at will. A lawful creature may hold the orb in hand and command it to invoke _ [dispel chaos](spells/dispelChaos#_dispel-chaos)_ and _ [arrow of law](ultimateMagic/spells/arrowOfLaw#_arrow-of-law) _each once per day.
...
Craft Wondrous Item, _ [arrow of law](ultimateMagic/spells/arrowOfLaw#_arrow-of-law) , [detect chaos](spells/detectChaos#_detect-chaos), [detect law](spells/detectLaw#_detect-law), [dispel chaos](spells/dispelChaos#_dispel-chaos)_

Orb of Storms

**Price** 48,000 gp; **Aura** strong varied; **CL** 18th; **Weight** 6 lbs.

This glass sphere is 8 inches in diameter. The possessor can call forth all manner of weather, even supernaturally destructive storms. Once per day, she can call upon the orb to use a _ [control weather](spells/controlWeather#_control-weather)_ spell. Once per month, she can conjure a _ [storm of vengeance](spells/stormOfVengeance#_storm-of-vengeance)_. The possessor of the orb is continually protected by an _ [endure elements](spells/endureElements#_endure-elements)_ effect.

Construction Requirements

Cost 24,000 gp

Craft Wondrous Item, _ [control weather](spells/controlWeather#_control-weather)_, _ [endure elements](spells/endureElements#_endure-elements)_, _ [storm of vengeance](spells/stormOfVengeance#_storm-of-vengeance)_
...
Once per day the bearer may hold the orb and command it to _ [dispel magic](spells/dispelMagic#_dispel-magic)_. If the dispel check succeeds, the wielder absorbs the unraveled magical energy through the orb and gains the benefit of an _ [aid](spells/aid#_aid)_ spell.
...
Craft Wondrous Item, _ [aid](spells/aid#_aid), [dispel magic](spells/dispelMagic#_dispel-magic), [entropic shield](spells/entropicShield#_entropic-shield)_
...
Craft Wondrous Item, _ [animate objects](spells/animateObjects#_animate-objects)_
...
Craft Wondrous Item, _ [sacred bond](advanced/spells/sacredBond#_sacred-bond)_
...
Craft Wondrous Item, _ [freedom of movement](spells/freedomOfMovement#_freedom-of-movement)_, _ [water breathing](spells/waterBreathing#_water-breathing)_

Philter of Love

**Price** 3,000 gp; **Aura** strong enchantment; **CL** 15th; **Weight** —

This potent preparation causes a creature who drinks it to fall madly in love with the first creature he or she perceives after consuming it. The drinker's attitude toward that creature becomes helpful. If a romantic attraction is possible toward the first person viewed, the drinker falls in love with that person. Otherwise, the drinker's love is a platonic adoration. The effects of the philter are permanent unless removed by a _ [break enchantment](spells/breakEnchantment#_break-enchantment)_, _ [dispel magic](spells/dispelMagic#_dispel-magic)_, _ [limited wish](spells/limitedWish#_limited-wish)_, _ [miracle](spells/miracle#_miracle)_, _ [remove curse](spells/removeCurse#_remove-curse)_, or _ [wish](spells/wish#_wish)_.

Construction Requirements

Cost 1,500 gp

Craft Wondrous Item, _ [charm monster](spells/charmMonster#_charm-monster)_, _ [permanency](spells/permanency#_permanency)_

Pipes of Dissolution

**Price** 12,000 gp; **Aura** faint abjuration; **CL** 5th; **Weight** 3 lbs.

Carvings of winter scenes decorate this set of pan pipes. Activating the pipes requires a DC 15 [Perform](skills/perform#_perform) (wind instruments) check. Creatures within 30 feet gain a +2 competence bonus on caster level checks to dispel magical effects and overcome spell resistance. Maintaining the performance is challenging, requiring a move action and a new [Perform](skills/perform#_perform) check each round, with the DC increasing by +1 for each round the instrument is played. The magic ends when the player voluntarily stops or fails the [Perform](skills/perform#_perform) check, after which the pipes cannot be used again for 1 hour.
...
This magic item appears to be a small set of pan pipes. When played by a person who succeeds on a DC 15 [Perform](skills/perform#_perform) (wind instruments) check, the pipes create an eerie, spellbinding tune. Those within 30 feet who hear the tune must succeed at a DC 13 Will save or become frightened for 4 rounds. Creatures with 6 or more Hit Dice are unaffected. _Pipes of haunting_ can be sounded twice a day.
...
When played by a character who has the [Perform](skills/perform#_perform) (wind instruments) skill, these shiny metallic pan pipes create a variety of sounds that can imitate creatures, environmental sounds, or most other sounds. The figment sounds are the equivalent of _ [ghost sound](spells/ghostSound#_ghost-sound)_.
...
Craft Wondrous Item, _ [charm animal](spells/charmAnimal#_charm-animal)_, _ [summon nature's ally I](spells/summonNatureSAlly#_summon-nature-s-ally-i)_, wild empathy ability
...
Craft Wondrous Item, _ [polymorph](spells/polymorph#_polymorph)_, _ [secret chest](spells/secretChest#_secret-chest)_
...
This round metal container is just large enough to contain the wooden, coin-sized token inside. Each side of the token is inscribed with a different prayer. Once per day, a cleric (or other class with cleric domains) may activate the pyxes and may select any one of her prepared domain spells and replace it with the domain spell of that level from her other domain. For example, a cleric with the Fire and Luck domains could switch her 1st-level prepared _ [burning hands](spells/burningHands#_burning-hands)_ domain spell to _ [true strike](spells/trueStrike#_true-strike)_. The pyxes has no effect on creatures with no domain spells or only one domain.

Construction Requirements

Cost 500 gp

Craft Wondrous Item, _ [prayer](spells/prayer#_prayer)_
...
Craft Wondrous Item, _ [animate objects](spells/animateObjects#_animate-objects)_, _ [animate rope](spells/animateRope#_animate-rope)_ or _ [entangle](spells/entangle#_entangle)_
...
Craft Wondrous Item, _ [grease](spells/grease#_grease)_
...
Craft Wondrous Item, _ [cure light wounds](spells/cureLightWounds#_cure-light-wounds)_
...
This rich tea can be made from any number of herbs. When the tea is brewed without a filter and imbibed, the drinker can read the patterns in the leaves remaining at the bottom of her cup, gaining the benefits of an _ [augury](spells/augury#_augury)_ spell.

Additionally, the unbrewed tea can be used as an extra material component when casting _ [augury](spells/augury#_augury)_, removing the need for a focus. In this case, the caster instead reveals information as if she had cast _ [divination](spells/divination#_divination)_ instead.

Construction Requirements

Cost 275 gp

Craft Wondrous Item, _ [augury](spells/augury#_augury)_ or _ [divination](spells/divination#_divination)_

Sheath of Bladestealth

**Price** 5,000 gp; **Aura** faint illusion; **CL** 5th; **Weight** 2 lbs.

This mundane-looking but serviceable sheath fits any bladed slashing weapon, from a dagger to a greatsword. When a weapon is placed into the _sheath of bladestealth_, both it and the weapon become invisible (as the _ [invisibility](spells/invisibility#_invisibility)_ spell) until the weapon is drawn, at which point it and the sheath become visible again. The invisible sheathed weapon can still be detected by touch, but the bearer gains a +5 bonus on [Sleight of Hand](skills/sleightOfHand#_sleight-of-hand) checks to conceal the weapon, and casual inspection does not reveal it at all. Other effects that detect or reveal invisible things work normally on the sheathed weapon.
...
Craft Wondrous Item, _ [magic stone](spells/magicStone#_magic-stone)_, _ [shield other](spells/shieldOther#_shield-other)_
...
Craft Wondrous Item, _ [share memory](ultimateMagic/spells/shareMemory#_share-memory)_, creator must be a witch
...
Craft Wondrous Item, _ [animate objects](spells/animateObjects#_animate-objects)_, _ [flesh to stone](spells/fleshToStone#_flesh-to-stone)_
...
Craft Wondrous Item, _ [stone to flesh](spells/stoneToFlesh#_stone-to-flesh)_, _ [stoneskin](spells/stoneskin#_stoneskin)_
...
| --- | --- |
| Bead of blessing (CL 1st) | Wearer can cast _ [bless](spells/bless#_bless)_. |
| Bead of healing (CL 5th) | Wearer can cast his choice of _ [cure serious wounds](spells/cureSeriousWounds#_cure-serious-wounds)_, _remove [blindness/deafness](spells/blindnessDeafness#_blindness-deafness)_, or _remove disease_. |
| Bead of karma (CL 9th) | Wearer casts his spells at +4 caster level. Effect lasts 10 minutes. |
| Bead of smiting (CL 7th) | Wearer can cast _ [chaos hammer](spells/chaosHammer#_chaos-hammer)_, _ [holy smite](spells/holySmite#_holy-smite)_, _ [order's wrath](spells/orderSWrath#_order-s-wrath)_, or _ [unholy blight](spells/unholyBlight#_unholy-blight)_ (Will DC 17 partial). |
...
| Bead of wind walking (CL 11th) | Wearer can cast _ [wind walk](spells/windWalk#_wind-walk)_. |

A _lesser [strand of](magicItems/wondrousItems#_strand-of-prayer-beads) [prayer](spells/prayer#_prayer) beads_ has a bead of blessing and a bead of healing. A _ [strand of](magicItems/wondrousItems#_strand-of-prayer-beads) [prayer](spells/prayer#_prayer) beads_ has a bead of healing, a bead of karma, and a bead of smiting. A _greater [strand of](magicItems/wondrousItems#_strand-of-prayer-beads) [prayer](spells/prayer#_prayer) beads_ has a bead of healing, a bead of karma, a bead of summons, and a bead of wind walking.

Each special bead can be used once per day, except for the bead of summons, which works only once and then becomes nonmagical. The beads of blessing, smiting, and wind walking function as spell trigger items; the beads of karma and summons can be activated by any character capable of casting divine spells. The owner need not hold or wear the _ [strand of](magicItems/wondrousItems#_strand-of-prayer-beads) [prayer](spells/prayer#_prayer) beads_ in any specific location, as long as he carries it somewhere on his person.

The power of a special bead is lost if it is removed from the strand. Reduce the price of a _ [strand of](magicItems/wondrousItems#_strand-of-prayer-beads) [prayer](spells/prayer#_prayer) beads _that is missing one or more beads by the following amounts: bead of blessing –600 gp, bead of healing –9,000 gp, bead of karma –20,000 gp, bead of smiting –16,800 gp, bead of summons –20,000 gp, bead of wind walking –46,800 gp.

Construction Requirements

**Lesser strand** 4,800 gp; **Normal strand** 22,900 gp; **Greater strand** 47,900 gp

Craft Wondrous Item and one of the following spells per bead, as appropriate: _ [bless](spells/bless#_bless)_ (blessing); _ [cure serious wounds](spells/cureSeriousWounds#_cure-serious-wounds)_, _ [remove blindness/deafness](spells/removeBlindnessDeafness#_remove-blindness-deafness)_, or _ [remove disease](spells/removeDisease#_remove-disease)_ (healing); _ [righteous might](spells/righteousMight#_righteous-might) _(karma); _ [gate](spells/gate#_gate)_ (summons); _ [chaos hammer](spells/chaosHammer#_chaos-hammer)_, _ [holy smite](spells/holySmite#_holy-smite)_, _ [order's wrath](spells/orderSWrath#_order-s-wrath)_, or _ [unholy blight](spells/unholyBlight#_unholy-blight)_ (smiting), _ [wind walk](spells/windWalk#_wind-walk)_ (wind walking)
...
Craft Wondrous Item, _ [arcane lock](spells/arcaneLock#_arcane-lock)_, _ [mending](spells/mending#_mending)_
...
Craft Wondrous Item, _ [create food and water](spells/createFoodAndWater#_create-food-and-water)_
...
Craft Wondrous Item, _ [miracle](spells/miracle#_miracle)_ or _ [wish](spells/wish#_wish)_
...
The any-tool counts as a set of masterwork artisan's tools for most [Craft](skills/craft#_craft) or [Profession](skills/profession#_profession) skills (although very specialist crafts such as alchemy still require their own unique toolset). It is an ineffective weapon, always counting as an improvised weapon and never granting any masterwork bonus on attack rolls.
...
Six inches in diameter, one side of this porcelain seal shows a many-keyholed padlock, while the other displays a lightning bolt superimposed on an open hand. The padlock side is used to lock and alarm doors, chests, and other portals. The bearer may speak a command word to activate it when holding it against a lockable item. If the padlock side of the seal is touching the item, it bestows an _ [alarm](spells/alarm#_alarm)_ (mental alarm) and _ [arcane lock](spells/arcaneLock#_arcane-lock)_ on the target item. If the lightning bolt side of the seal is touching the item, it casts _ [fire trap](spells/fireTrap#_fire-trap)_ on the lock (the seal must be held to the lock for 10 minutes to use this ability).
...
Craft Wondrous Item, _ [alarm](spells/alarm#_alarm), [arcane lock](spells/arcaneLock#_arcane-lock), [fire trap](spells/fireTrap#_fire-trap)_
...
Craft Wondrous Item, _ [gentle repose](spells/gentleRepose#_gentle-repose)_
...
Infused with the essence of destruction, a pinch of void dust unmakes force effects. If sprinkled on or thrown at a force effect, it acts as a _ [dispel magic](spells/dispelMagic#_dispel-magic)_, unless the force effect is immune to _ [dispel magic](spells/dispelMagic#_dispel-magic)_, in which case it acts like _ [disintegrate](spells/disintegrate#_disintegrate)_. _Void dust_ can be sprinkled on an adjacent force effect or thrown up to 10 feet. No attack roll is required. A single pinch affects only a single force effect. A found container holds three pinches.
...
Craft Wondrous Item, _ [dimensional anchor](spells/dimensionalAnchor#_dimensional)_
...
Craft Wondrous Item, _ [alchemical allocation](advanced/spells/alchemicalAllocation#_alchemical-allocation)_
...
Craft Wondrous Item, _ [baleful polymorph](spells/balefulPolymorph#_baleful-polymorph)_
...
Craft Wondrous Item, _ [gust of wind](spells/gustOfWind#_gust-of-wind)_

Wind-Caller Compass

**Price** 4,400 gp; **Aura** faint transmutation; **CL** 3rd; **Weight** —

This light gray compass made of fine metal, and is engraved with various depictions of the sun, moon, and clouds. It allows a creature to increase or decrease the intensity of the wind four times per day as if using _ [alter winds](advanced/spells/alterWinds#_alter-winds)_.

Construction Requirements

Cost 2,200 gp

Craft Wondrous Item, _ [alter winds](advanced/spells/alterWinds#_alter-winds)_

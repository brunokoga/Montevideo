...
Craft Wondrous Item, [Heighten Spell](feats#_heighten-spell), _ [resist energy](spells/resistEnergy#_resist-energy)_, _ [fireball](spells/fireball#_fireball)_
...
Craft Wondrous Item, _ [greater magic fang](spells/magicFang#_magic-fang-greater)_, creator's caster level must be at least three times the bodywrap's bonus, plus any requirements of the melee weapon special abilities

Cassock of the Clergy

**Price** 4,600 gp; **Aura** moderate abjuration; **CL** 1st; **Weight** 1 lb.

The cut and color of this solemn vestment varies from religion to religion, but its properties are the same. The wearer may command the _cassock of the clergy _to display the holy symbol of her deity or hide this symbol. At the most basic level, the garment functions as a divine focus. Additionally, the wearer gains a +3 competence bonus on Charisma-based checks to influence creatures that match her alignment or that of her patron deity. Also, the wearer may use _ [bless](spells/bless#_bless) _and _ [sanctuary](spells/sanctuary#_sanctuary) _(DC 11) each once per day, and may prepare one additional orison each day. If the wearer is a spontaneous divine caster, once per day she may spend 1 hour in prayer to gain an orison of her choice as a spell known for the next 24 hours.

Construction Requirements

**Cost** 2,300 gp

Craft Wondrous Item, _ [bless](spells/bless#_bless), [sanctuary](spells/sanctuary#_sanctuary), _creator must be a divine spellcaster
...
This black corset fits neatly beneath armor. As a free action, the wearer can compress herself to fit through tight spaces as though affected by a _squeeze_ spell (_Advanced Race Guide_) for up to 10 rounds per day. While using the corset's magic, she gains a +5 bonus on [Escape Artist](skills/escapeArtist#_escape-artist) checks.
...
Craft Wondrous Item, _ [polymorph](spells/polymorph#_polymorph)_ or wild shape ability
...
Craft Wondrous Item, _ [righteous might](spells/righteousMight#_righteous-might)_ or _ [transformation](spells/transformation#_transformation)_
...
Craft Wondrous Item, [Heighten Spell](feats#_heighten-spell), _ [maze](spells/maze#_maze)_, _ [resistance](spells/resistance#_resistance)_
...
Craft Wondrous Item, _ [antimagic field](spells/antimagicField#_antimagic-field)_, _ [break enchantment](spells/breakEnchantment#_break-enchantment), [greater heroism](spells/heroism#_heroism-greater)_, _ [veil](spells/veil#_veil)_
...
Craft Wondrous Item, _ [speak with dead](spells/speakWithDead#_speak-with-dead)_, creator must be a sorcerer
...
Craft Wondrous Item, _ [alter self](spells/alterSelf#_alter-self)_, _ [tongues](spells/tongues#_tongues)_
...
A _ [light](spells/light#_light)_ or _ [continual flame](spells/continualFlame#_continual-flame)_ spell cast directly on a _robe of eyes_ causes the wearer to be blinded for 1d3 minutes. A _ [daylight](spells/daylight#_daylight)_ spell blinds the wearer for 2d4 minutes.
...
Craft Wondrous Item, [Maximize Spell](feats#_maximize-spell), _ [gate](spells/gate#_gate), [summon eidolon](advanced/spells/summonEidolon#_summon-eidolon)_
...
Craft Wondrous Item, _ [blur](spells/blur#_blur)_, _ [rainbow pattern](spells/rainbowPattern#_rainbow-pattern)_
...
Craft Wondrous Item, _ [magic missile](spells/magicMissile#_magic-missile)_, _ [astral projection](spells/astralProjection#_astral-projection)_ or _ [plane shift](spells/planeShift#_plane-shift)_
...
Craft Wondrous Item, _ [antimagic field](spells/antimagicField#_antimagic-field)_, _ [mage armor](spells/mageArmor#_mage-armor)_ or _ [shield of faith](spells/shieldOfFaith#_shield-of-faith)_, creator must be of same alignment as robe
...
Craft Wondrous Item, [Heighten Spell](feats#_heighten-spell), _ [resist energy](spells/resistEnergy#_resist-energy)_, _ [lightning bolt](spells/lightningBolt#_lightning-bolt)_
...
Craft Wondrous Item, _ [secret chest](spells/secretChest#_secret-chest)_, _ [magic aura](spells/magicAura#_magic-aura)_, _ [arcane eye](spells/arcaneEye#_arcane-eye)_
...
Craft Wondrous Item, [Quicken Spell-Like Ability](monsters/monsterFeats#_quicken-spell-like-ability), creator must be a sorcerer
...
Craft Wondrous Item, [Heighten Spell](feats#_heighten-spell), _ [resist energy](spells/resistEnergy#_resist-energy)_, _ [cone of cold](spells/coneOfCold#_cone-of-cold)_
...
Craft Wondrous Item, _ [passwall](spells/passwall#_passwall)_, _ [purify food and drink](spells/purifyFoodAndDrink#_purify-food-and-drink)_

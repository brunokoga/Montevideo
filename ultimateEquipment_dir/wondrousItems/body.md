...
Craft Wondrous Item, [Heighten Spell](feats#_heighten-spell), _ [resist energy](spell_dir/resistEnergy#_resist-energy)_, _ [fireball](spells/fireball#_fireball)_
...
Craft Wondrous Item, _ [greater magic fang](spell_dir/magicFang#_magic-fang-greater)_, creator's caster level must be at least three times the bodywrap's bonus, plus any requirements of the melee weapon special abilities

Cassock of the Clergy

**Price** 4,600 gp; **Aura** moderate abjuration; **CL** 1st; **Weight** 1 lb.

The cut and color of this solemn vestment varies from religion to religion, but its properties are the same. The wearer may command the _cassock of the clergy _to display the holy symbol of her deity or hide this symbol. At the most basic level, the garment functions as a divine focus. Additionally, the wearer gains a +3 competence bonus on Charisma-based checks to influence creatures that match her alignment or that of her patron deity. Also, the wearer may use _ [bless](spells/bless#_bless) _and _ [sanctuary](spell_dir/sanctuary#_sanctuary) _(DC 11) each once per day, and may prepare one additional orison each day. If the wearer is a spontaneous divine caster, once per day she may spend 1 hour in prayer to gain an orison of her choice as a spell known for the next 24 hours.

Construction Requirements

**Cost** 2,300 gp

Craft Wondrous Item, _ [bless](spells/bless#_bless), [sanctuary](spell_dir/sanctuary#_sanctuary), _creator must be a divine spellcaster
...
Craft Wondrous Item, _ [mage armor](spells/mageArmor#_mage-armor), _creator must be a witch
...
Craft Wondrous Item, _ [grease](spells/grease#_grease)_, _squeeze_
...
Craft Wondrous Item, [Amateur Gunslinger](ultimateCombat/ultimateCombatFeats#_amateur-gunslinger) or creator must be a gunslinger, _ [bullet shield](ultimateComba_dir/spells/bulletShield#_bullet-shield)_
...
Craft Wondrous Item, _ [mnemonic enhancer](spells/mnemonicEnhancer#_mnemonic-enhancer)_, creator must be able to spontaneously cast spells
...
Craft Wondrous Item, _ [righteous might](spell_dir/righteousMight#_righteous-might)_ or _ [transformation](spells/transformation#_transformation)_
...
Craft Wondrous Item, [Heighten Spell](feats#_heighten-spell), _ [maze](spells/maze#_maze)_, _ [resistance](spell_dir/resistance#_resistance)_

Resplendent Robe of the Thespian

**Price** 75,000 gp; **Aura** strong varied; **CL** 16th; **Weight** 1 lb.

These magnificent vestments disguise the presence of armor as normal clothing (as the _ [glamered](magicItems/armor#_armor-glamered)_ armor property). When worn by a bard, the robe grants the wearer the following powers:
...
Craft Wondrous Item, _ [antimagic field](spell_dir/antimagicField#_antimagic-field)_, _ [break enchantment](spells/breakEnchantment#_break-enchantment), [greater heroism](spell_dir/heroism#_heroism-greater)_, _ [veil](spells/veil#_veil)_
...
Craft Wondrous Item, _ [speak with dead](spell_dir/speakWithDead#_speak-with-dead)_, creator must be a sorcerer

Robe of Blending

**Price** 8,400 gp; **Aura** moderate transmutation; **CL** 10th; **Weight** 1 lb.

Once per day this simple woolen robe allows you to assume the form of another humanoid creature, as if using _ [alter self](spells/alterSelf#_alter-self)_. This change lasts for 1 hour, although you can end it prematurely as a free action. While in this form, you also gain the ability to speak and understand the basic racial languages of your chosen form. For example, if you take the form of an orc, you can speak and understand Orc.

Construction Requirements

**Cost** 4,200 gp

Craft Wondrous Item, _ [alter self](spell_dir/alterSelf#_alter-self)_, _ [tongues](spells/tongues#_tongues)_
...
A _ [light](spells/light#_light)_ or _ [continual flame](spell_dir/continualFlame#_continual-flame)_ spell cast directly on a _robe of eyes_ causes the wearer to be blinded for 1d3 minutes. A _ [daylight](spells/daylight#_daylight)_ spell blinds the wearer for 2d4 minutes.
...
Craft Wondrous Item, [Maximize Spell](feats#_maximize-spell), _ [gate](spells/gate#_gate), [summon eidolon](advance_dir/spells/summonEidolon#_summon-eidolon)_
...
Craft Wondrous Item, _ [bleed](spells/bleed#_bleed)_
...
Craft Wondrous Item, _ [blur](spell_dir/blur#_blur)_, _ [rainbow pattern](spells/rainbowPattern#_rainbow-pattern)_
...
It enables the wearer to travel physically to the Astral Plane, at will and on command as if using the _ [plane shift](spell_dir/planeShift#_plane-shift)_ spell. Once he has done so, the wearer can also return to his plane of origin on command, also as per the _ [plane shift](spells/planeShift#_plane-shift)_ spell.
...
Craft Wondrous Item, _ [magic missile](spell_dir/magicMissile#_magic-missile)_, _ [astral projection](spells/astralProjection#_astral-projection)_ or _ [plane shift](spell_dir/planeShift#_plane-shift)_
...
Craft Wondrous Item, [Heighten Spell](feats#_heighten-spell), _ [resist energy](spells/resistEnergy#_resist-energy)_, _ [lightning bolt](spell_dir/lightningBolt#_lightning-bolt)_
...
Craft Wondrous Item, _ [secret chest](spells/secretChest#_secret-chest)_, _ [magic aura](spell_dir/magicAura#_magic-aura)_, _ [arcane eye](spells/arcaneEye#_arcane-eye)_

---
title: ultimateEquipment/wondrousItem_dir/body
---
...
Craft Wondrous Item, [Heighten Spell](feats#_heighten-spell, _ [resist energy](spell_dir/resistEnergy#_resist-energy_, _ [fireball](spell_dir/fireball#_fireball)_
...
Craft Wondrous Item, _ [greater magic fang](spell_dir/magicFang#_magic-fang-greater_, creator's caster level must be at least three times the bodywrap's bonus, plus any requirements of the melee weapon special abilities

Cassock of the Clergy

**Price** 4,600 gp; **Aura** moderate abjuration; **CL** 1st; **Weight** 1 lb.

The cut and color of this solemn vestment varies from religion to religion, but its properties are the same. The wearer may command the _cassock of the clergy _to display the holy symbol of her deity or hide this symbol. At the most basic level, the garment functions as a divine focus. Additionally, the wearer gains a +3 competence bonus on Charisma-based checks to influence creatures that match her alignment or that of her patron deity. Also, the wearer may use _ [bless](spell_dir/bless#_bless _and _ [sanctuary](spell_dir/sanctuary#_sanctuary) _(DC 11 each once per day, and may prepare one additional orison each day. If the wearer is a spontaneous divine caster, once per day she may spend 1 hour in prayer to gain an orison of her choice as a spell known for the next 24 hours.

Construction Requirements

**Cost** 2,300 gp

Craft Wondrous Item, _ [bless](spell_dir/bless#_bless, [sanctuary](spell_dir/sanctuary#_sanctuary, _creator must be a divine spellcaster
...
Craft Wondrous Item, _ [mage armor](spell_dir/mageArmor#_mage-armor), _creator must be a witch

Corset of the Vishkanya

**Price** 3,000 gp; **Aura** faint transmutation; **CL** 3rd; **Weight** 1 lb.

This black corset fits neatly beneath armor. As a free action, the wearer can compress herself to fit through tight spaces as though affected by a _squeeze_ spell (_Advanced Race Guide_ for up to 10 rounds per day. While using the corset's magic, she gains a +5 bonus on [Escape Artist](skill_dir/escapeArtist#_escape-artist checks.

Construction Requirements

**Cost** 1,500 gp

Craft Wondrous Item, _ [grease](spell_dir/grease#_grease_, _squeeze_
...
Craft Wondrous Item, _ [polymorph](spell_dir/polymorph#_polymorph)_ or wild shape ability
...
Craft Wondrous Item, _ [righteous might](spell_dir/righteousMight#_righteous-might_ or _ [transformation](spell_dir/transformation#_transformation)_
...
Craft Wondrous Item, [Heighten Spell](feats#_heighten-spell, _ [maze](spell_dir/maze#_maze_, _ [resistance](spell_dir/resistance#_resistance_

Resplendent Robe of the Thespian

**Price** 75,000 gp; **Aura** strong varied; **CL** 16th; **Weight** 1 lb.

These magnificent vestments disguise the presence of armor as normal clothing (as the _ [glamered](magicItem_dir/armor#_armor-glamered)_ armor property. When worn by a bard, the robe grants the wearer the following powers:
...
Craft Wondrous Item, _ [antimagic field](spell_dir/antimagicField#_antimagic-field_, _ [break enchantment](spell_dir/breakEnchantment#_break-enchantment, [greater heroism](spell_dir/heroism#_heroism-greater_, _ [veil](spell_dir/veil#_veil_
...
Craft Wondrous Item, _ [speak with dead](spell_dir/speakWithDead#_speak-with-dead_, creator must be a sorcerer

Robe of Blending

**Price** 8,400 gp; **Aura** moderate transmutation; **CL** 10th; **Weight** 1 lb.

Once per day this simple woolen robe allows you to assume the form of another humanoid creature, as if using _ [alter self](spell_dir/alterSelf#_alter-self_. This change lasts for 1 hour, although you can end it prematurely as a free action. While in this form, you also gain the ability to speak and understand the basic racial languages of your chosen form. For example, if you take the form of an orc, you can speak and understand Orc.

Construction Requirements

**Cost** 4,200 gp

Craft Wondrous Item, _ [alter self](spell_dir/alterSelf#_alter-self_, _ [tongues](spell_dir/tongues#_tongues)_
...
Craft Wondrous Item, _ [minor creation](spell_dir/minorCreation#_minor-creation_
...
The _robe of eyes_ sees all forms of invisible or ethereal creatures or objects within 120 feet. The wearer of a _robe of eyes_ gains a +10 competence bonus on [Perception](skill_dir/perception#_perception checks. She retains her Dexterity bonus to AC even when flat-footed, and can't be flanked. She is not able to avert or close her eyes when confronted by a creature with a gaze attack.

A _ [light](spell_dir/light#_light_ or _ [continual flame](spell_dir/continualFlame#_continual-flame_ spell cast directly on a _robe of eyes_ causes the wearer to be blinded for 1d3 minutes. A _ [daylight](spell_dir/daylight#_daylight_ spell blinds the wearer for 2d4 minutes.
...
Craft Wondrous Item, [Maximize Spell](feats#_maximize-spell, _ [gate](spell_dir/gate#_gate, [summon eidolon](advanced/spell_dir/summonEidolon#_summon-eidolon_
...
Craft Wondrous Item, _ [bleed](spell_dir/bleed#_bleed)_
...
Craft Wondrous Item, _ [blur](spell_dir/blur#_blur_, _ [rainbow pattern](spell_dir/rainbowPattern#_rainbow-pattern_
...
It enables the wearer to travel physically to the Astral Plane, at will and on command as if using the _ [plane shift](spell_dir/planeShift#_plane-shift_ spell. Once he has done so, the wearer can also return to his plane of origin on command, also as per the _ [plane shift](spell_dir/planeShift#_plane-shift_ spell.
...
Craft Wondrous Item, _ [magic missile](spell_dir/magicMissile#_magic-missile_, _ [astral projection](spell_dir/astralProjection#_astral-projection_ or _ [plane shift](spell_dir/planeShift#_plane-shift)_
...
Craft Wondrous Item, [Heighten Spell](feats#_heighten-spell, _ [resist energy](spell_dir/resistEnergy#_resist-energy_, _ [lightning bolt](spell_dir/lightningBolt#_lightning-bolt)_
...
Craft Wondrous Item, _ [secret chest](spell_dir/secretChest#_secret-chest_, _ [magic aura](spell_dir/magicAura#_magic-aura_, _ [arcane eye](spell_dir/arcaneEye#_arcane-eye)_
...
Craft Wondrous Item, [Quicken Spell-Like Ability](monster_dir/monsterFeats#_quicken-spell-like-ability), creator must be a sorcerer

---
layout: default
title: ultimateEquipment_dir/gear_dir/foodAndDrink
---
# Food and Drink
...
| --- | --- | --- |
| Absinthe (glass) | 3 gp | — |
| Absinthe (bottle) | 30 gp | 1-1_dir/2 lbs. |
| Ale (mug) | 4 cp | 1 lb. |
...
| Bread | 2 cp | 1_dir/2 lb. |
| Bufo (jug) | 1 gp | 2 lbs. |
| Cauim (gourd) | 1 gp | 2 lbs. |
| Caviar | 50 gp | — |
| Cheese | 1 sp | 1_dir/2 lb. |
| Chocolate (bar) | 5 gp | 1_dir/2 lb. |
| Coffee (cup) | 1 cp | 1_dir/2 lb. |
| Dwarven stout (mug) | 4 cp | 1_dir/2 lb. |
| Dwarven trail rations | 2 gp | 1-1_dir/2 lbs.\* |
| Elven trail rations | 2 gp | 1 lb.\* |
| Fortune cookie | 1 cp | — |
| Gnome trail rations | 2 gp | 1 lb. \* |
| Grog (mug) | 2 cp | 1_dir/2 lb. |
| Haggis | 1 sp | 1-1_dir/2 lbs. |
| Halfling trail rations | 2 gp | 1_dir/2 lb.\* |
| Honey (jar) | 1 gp | 1_dir/2 lb. |
| Ice cream | 1 sp | — |
| Jungle coffee (cup) | 3 cp | 1_dir/2 lb. |
| Kahve (cup) | 2 cp | 1_dir/2 lb. |
| Kumis (wineskin) | 5 sp | 1-1_dir/2 lbs. |
| Maple syrup (jar) | 1 gp | 1_dir/2 lb. |
| Mead (mug) | 5 cp | 1_dir/2 lb. |
| Mead (gallon) | 2 gp | 8 lbs. |
| Meal, poor (per day) | 1 sp | — |
| Meal, common (per day) | 3 sp | — |
| Meal, good (per day) | 5 sp | — |
| Meat | 3 sp | 1_dir/2 lb. |
| Milk | 5 cp | 1_dir/2 lb. |
| Oldlaw whiskey (bottle) | 20 gp | 1 lb. |
| Orc trail rations | 1 gp | 1 lb.\* |
| Powdered milk | 1 sp | 1 lb. |
| Pulque (cup) | 1 sp | 1_dir/2 lb. |
| Pulque (wineskin) | 4 sp | 2 lbs. |
| Rumboozle (cup) | 1 sp | 1_dir/2 lb. |
| Sealord wine (bottle) | 15 gp | 1_dir/2 lb. |
| Street meat | 1 cp | 1_dir/2 lb. |
| Tea (cup) | 2 cp | 1_dir/2 lb. |
| Tea, ceremonial (cup) | 4 cp | 1_dir/2 lb. |
| Tea ceremony set | 25 gp | 5 lbs. |
| Tepache (cup) | 5 cp | 1_dir/2 lb. |
| Trail rations | 5 sp | 1 lb.\* |
| Travel cake mix | 1 sp | 1 lb. |
| Wandermeal (per day) | 1 cp | 1_dir/2 lb.\* |
| Whiskey (cup) | 1 sp | 1_dir/2 lb. |
| Wine, common (pitcher) | 2 sp | 6 lbs. |
| Wine, fine (bottle) | 10 gp | 1-1_dir/2 lbs. |
| Yogurt | 1 sp | 1_dir/2 lb. |
...
**Price** 2 gp; **Weight** 1-1_dir/2 lbs.
...
**Price** 1 sp; **Weight** 1-1_dir/2 lbs.
...
**Price** 5 sp; **Weight** 1-1_dir/2 lbs.
...
**Price** 5 CP–2 gp; **Weight** 1_dir/2 lb.–8 lbs.
...
**Price** 1 SP–4 Sp; **Weight** 1_dir/2 lb.–2 lbs.
...
**Price** 2 CP–4 Cp; **Weight** 1_dir/2 lb.
...
**Price** 2 SP–10 Gp; **Weight** 1-1_dir/2 lb.–6 lbs.

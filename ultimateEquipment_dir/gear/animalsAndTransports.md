...
Removing and fitting barding takes five times as long as the figures given on the [Donning Armor table](ultimateEquipment/armsAndArmo_dir/armor#_donning-armor-table). A barded animal cannot be used to carry any load other than a rider, and normal saddlebags.

---
title: ultimateEquipmen_dir/ringsRodsStaves/rings
---
# Rings
...
Forge Ring, _ [mislead](spell_dir/mislead#_mislead)_
...
A _jailer's dungeon ring_ is worked gold, set with carnelians. The ring is magically attuned to one or more iron _prisoner's dungeon rings_. When the wearer of a _jailer's ring_ places a _prisoner's ring_ on a subject, the prisoner cannot remove the ring without the use of a _ [remove curse](spells/removeCurse#_remove-curse)_, _ [limited wish](spell_dir/limitedWish#_limited-wish), [miracle](spells/miracle#_miracle)_, or _ [wish](spell_dir/wish#_wish)_ spell. The wearer of the _jailer's ring_ can also remove a linked _prisoner's ring_ at any time.

The jailer is aware of any wearer of a linked _prisoner's ring_ as per a constant _ [status](spells/status#_status)_ spell. Additionally, all wearers of linked _prisoner's rings_ count as familiar to the jailer for the purposes of spells such as _ [scrying](spell_dir/scrying#_scrying)_ and _ [teleport](spells/teleport#_teleport)_.
...
Forge Ring, _ [scrying](spell_dir/scrying#_scrying)_, _ [status](spells/status#_status)_

Ring of Animal Friendship

**Price** 10,800 gp; **Aura** faint enchantment; **CL** 3rd; **Weight** —

A ring of animal friendship always bears some sort of animal-like design in its craftsmanship. On command, this ring affects an animal as if the wearer had cast _ [charm animal](spell_dir/charmAnimal#_charm-animal)_, causing the animal to regard the wearer as a trusted friend.

Construction Requirements

**Cost** 5,400 gp

Forge Ring, _ [charm animal](spells/charmAnimal#_charm-animal)_
...
Forge Ring, creator must have 5 ranks in the [Climb](skills/climb#_climb) skill
...
Forge Ring, creator must have 10 ranks in the [Climb](skills/climb#_climb) skill
...
Forge Ring, _ [mnemonic enhancer](spell_dir/mnemonicEnhancer#_mnemonic-enhancer)_

Ring of Counterspells

**Price** 4,000 gp; **Aura** moderate evocation; **CL** 11th; **Weight** —

Upon first examination, this ring seems to be a _ [ring of spell storing](magicItems/rings#_ring-of-spell-storing-minor)_. However, while it allows a single spell of 1st through 6th level to be cast into it, that spell cannot be cast out of the ring again. Instead, should that spell ever be cast upon the wearer, the spell is immediately countered, as a counterspell action, requiring no action (or even knowledge) on the wearer's part. Once so used, the spell cast within the ring is gone. A new spell (or the same one as before) may be placed into it again.

Construction Requirements

**Cost** 2,000 gp

Forge Ring, _ [imbue with spell ability](spell_dir/imbueWithSpellAbility#_imbue-with-spell-ability)_

Ring of Craft Magic

**Price** 12,000 gp; **Aura** faint transmutation; **CL** 3rd; **Weight** —

A _ring of craft magic_ always bears some sort of tool-like design in its craftsmanship. The wearer of the ring sees spells as similar to crafts, and vice versa. The wearer may make a [Craft](skills/craft#_craft) check in place of a [Spellcraft](skill_dir/spellcraft#_spellcraft) check to identify an item that could be created with that [Craft](skills/craft#_craft) skill. The wearer may also expend a spell slot or prepared spell to gain an enhancement bonus equal to the level of the expended spell on a single [Craft](skill_dir/craft#_craft) or [Profession](skills/profession#_profession) check (regardless of the amount of time needed to make the check).
...
Forge Ring, _ [heal](spells/heal#_heal)_, _ [time stop](spell_dir/timeStop#_time-stop)_
...
Forge Ring, _ [gate](spells/gate#_gate)_
...
This ring appears to be a _ring of [meld into stone](spells/meldIntoStone#_meld-into-stone)_ (allowing the wearer to cast _ [meld into stone](spell_dir/meldIntoStone#_meld-into-stone)_ at will) until the established condition is met.
...
Forge Ring, _ [summon monster VI](spells/summonMonster#_summon-monster-vi)_, all appropriate spells
...
Forge Ring, _ [elemental aura](advanced/spell_dir/elementalAura#_elemental-aura), [resist energy](spells/resistEnergy#_resist-energy)_
...
Forge Ring, _ [jump](spell_dir/jump#_jump)_

Ring of Feather Falling

**Price** 2,200 gp; **Aura** faint transmutation; **CL** 1st; **Weight** —

This ring is crafted with a feather pattern all around its edge. It acts exactly like a _ [feather fall](spells/featherFall#_feather-fall)_ spell, and activates immediately if the wearer falls more than 5 feet.

Construction Requirements

**Cost** 1,100 gp

Forge Ring, _ [feather fall](spell_dir/featherFall#_feather-fall)_
...
Forge Ring, _ [haste](spells/haste#_haste)_, _ [stabilize](spell_dir/stabilize#_stabilize)_
...
Forge Ring, _ [shield](spells/shield#_shield)_
...
Forge Ring, _ [wall of force](spells/wallOfForce#_wall-of-force)_
...
Forge Ring, [Heighten Spell](feats#_heighten-spell), _ [magic missile](spells/magicMissile#_magic-missile)_

Ring of Freedom of Movement

**Price** 40,000 gp; **Aura** moderate abjuration; **CL** 7th; **Weight** —

This gold ring allows the wearer to act as if continually under the effect of a _ [freedom of movement](spell_dir/freedomOfMovement#_freedom-of-movement)_ spell.

Construction Requirements

**Cost** 20,000 gp

Forge Ring, _ [freedom of movement](spells/freedomOfMovement#_freedom-of-movement)_
...
Forge Ring, _ [shield other](spells/shieldOther#_shield-other)_
...
Once per day, as a standard action, the wearer of the ring can spend 2 grit points stored within the ring to activate a _ [bullet shield](ultimateComba_dir/spells/bulletShield#_bullet-shield)_ as the spell.
...
Forge Ring, _ [anticipate peril](ultimateMagi_dir/spells/anticipatePeril#_anticipate-peril)_, _ [bullet shield](ultimateComba_dir/spells/bulletShield#_bullet-shield)_, creator must have the grit class feature
...
Forge Ring, _ [restoration](spells/restoration#_restoration)_

Ring of Invisibility

**Price** 20,000 gp; **Aura** faint illusion; **CL** 3rd; **Weight** —

By activating this simple silver ring, the wearer can benefit from _ [invisibility](spell_dir/invisibility#_invisibility)_, as the spell.

Construction Requirements

**Cost** 10,000 gp

Forge Ring, _ [invisibility](spells/invisibility#_invisibility)_
...
Forge Ring, creator must have 5 ranks in [Acrobatics](skills/acrobatics#_acrobatics)
...
Forge Ring, creator must have 10 ranks in [Acrobatics](skills/acrobatics#_acrobatics)
...
Forge Ring, _ [ki leech](ultimateMagi_dir/spells/kiLeech#_ki-leech), _the creator must be able to use _ki_

Ring of Maniacal Devices

**Price** 5,000 gp; **Aura** faint transmutation; **CL** 3rd; **Weight** —

This elaborately decorated ring is crafted with the design of a fierce dragon wrapped greedily around a shining gemstone. It grants the wearer a +5 competence bonus on all [Craft](skill_dir/craft#_craft) (traps) and [Disable Device](skills/disableDevice#_disable-device) checks. Even if he has no ranks in these skills, the wearer may make [Craft](skill_dir/craft#_craft) (traps) and [Disable Device](skills/disableDevice#_disable-device) checks as if he were trained in them.
...
This ring is usually of fine workmanship and wrought from heavy gold. The wearer is continually immune to _ [detect thoughts](spells/detectThoughts#_detect-thoughts)_, _ [discern lies](spell_dir/discernLies#_discern-lies)_, and any attempt to magically discern her alignment.

Construction Requirements

**Cost** 4,000 gp

Forge Ring, _ [nondetection](spells/nondetection#_nondetection)_
...
Forge Ring, [Quicken Spell](feats#_quicken-spell), _ [fireball](spells/fireball#_fireball)_
...
This tiny ring of living mistletoe coils about the wearer's finger of its own accord. The wearer gains a +2 competence bonus on [Handle Animal](skills/handleAnimal#_handle-animal), [Knowledge](skill_dir/knowledge#_knowledge) (nature), and wild empathy checks, and a wearer with the woodland stride ability can move effortlessly, without harm or impediment, even through magically created or manipulated plants. This does not allow the wearer to move through solid objects or creatures.

Furthermore, the wearer can use _ [shillelagh](spells/shillelagh#_shillelagh) _once per day.

Construction Requirements

**Cost** 3,000 gp

Forge Ring, _ [pass without trace](spell_dir/passWithoutTrace#_pass-without-trace)_, _ [shillelagh](spells/shillelagh#_shillelagh)_
...
- _ [Faerie fire](spells/faerieFire#_faerie-fire)_ (once per day)
- Spark shower (special, once per day)

The spark shower is a flying cloud of sizzling purple sparks that fan out from the ring for a distance of 20 feet in an arch 10 feet wide. Creatures within this area take 2d8 points of damage each if not wearing metal armor or carrying metal weapons. Any creature wearing metal armor an_dir/or carrying a metal weapon takes 4d8 points of damage.

Construction Requirements

**Cost** 25,000 gp

Forge Ring, _ [faerie fire](spells/faerieFire#_faerie-fire)_, _ [fireball](spell_dir/fireball#_fireball)_, _ [light](spells/light#_light)_, _ [lightning bolt](spell_dir/lightningBolt#_lightning-bolt)_
...
As the _minor [ring of spell storing](magicItems/rings#_ring-of-spell-storing-minor)_, except it holds up to 10 levels of spells.
...
As the _minor [ring of spell storing](magicItems/rings#_ring-of-spell-storing-minor)_, except it holds up to 3 levels of spells.
...
Up to three times per day on command, this simple platinum band automatically reflects the next nine levels of spells cast at the wearer, exactly as if _ [spell turning](spells/spellTurning#_spell-turning)_ had been cast upon him.

Construction Requirements

**Cost** 50,000 gp

Forge Ring, _ [spell turning](spell_dir/spellTurning#_spell-turning)_
...
Forge Ring, _ [bull's strength](spells/bullSStrength#_bull-s-strength)_, _ [ray of enfeeblement](spell_dir/rayOfEnfeeblement#_ray-of-enfeeblement)_
...
Forge Ring, _ [create food and water](spells/createFoodAndWater#_create-food-and-water)_
...
Forge Ring, _ [guidance](spell_dir/guidance#_guidance)_, creator must be able to sneak attack

Ring of Swimming

**Price** 2,500 gp; **Aura** faint transmutation; **CL** 2nd; **Weight** —

This silver ring usually has fishlike designs and motifs etched into the band. It continually grants the wearer a +5 competence bonus on [Swim](skills/swim#_swim) checks.
...
As a ring of swimming, except it grants a +10 competence bonus on its wearer's [Swim](skills/swim#_swim) checks.
...
This ring, knotted with metallic tendrils encasing a setting of red and amber gemstones, allows the caster to use the spell _ [telekinesis](spells/telekinesis#_telekinesis)_ on command, lifting and manipulating objects at a distance using only her mind.

Construction Requirements

**Cost** 37,500 gp

Forge Ring, _ [telekinesis](spell_dir/telekinesis#_telekinesis)_

Ring of the Ecclesiarch

**Price** 28,500 gp; **Aura** faint enchantment; **CL** 5th; **Weight** —

This ornate ring of sanctified silver is engraved with a golden signet that incorporates the holy symbol of the wearer's deity after being worn for 24 hours. The ring can be used to seal parchments or to mark any surface as the _ [arcane mark](spells/arcaneMark#_arcane-mark) _spell at will. The wearer is marked as a scholarly leader of the faith and gains a +5 competence bonus on [Diplomacy](skill_dir/diplomacy#_diplomacy) and [Knowledge](skills/knowledge#_knowledge) (religion) checks. If the wearer has the [Leadership](feats#_leadership) feat, she may attract double the normal number of followers, and her followers' zealous devotion grants them a +4 morale bonus on Will saves against enchantment spells and effects.
...
Forge Ring, _ [arcane mark](spells/arcaneMark#_arcane-mark), [enter image](advance_dir/spells/enterImage#_enter-image-), [enthrall](spell_dir/enthrall#_enthrall), [prayer](spells/prayer#_prayer)_, creator must have 5 ranks of [Diplomacy](skill_dir/diplomacy#_diplomacy) and [Knowledge](skills/knowledge#_knowledge) (religion) and the ability to cast divine spells
...
Forge Ring, _ [sculpt corpse](advance_dir/spells/sculptCorpse#_sculpt-corpse-)_
...
Forge Ring, _ [bull's strength](spell_dir/bullSStrength#_bull-s-strength)_, _ [telekinesis](spells/telekinesis#_telekinesis)_
...
Forge Ring, _ [dimension door](spells/dimensionDoor#_dimension-door)_, _ [touch of the sea](advance_dir/spells/touchOfTheSea#_touch-of-the-sea)_

Ring of the Sophisticate

**Price** 11,000 gp; **Aura** moderate transmutation and divination; **CL** 8th; **Weight** —

Often worn on the little finger, this ring grants its wearer a +4 competence bonus on [Sense Motive](skill_dir/senseMotive#_sense-motive) and [Knowledge](skills/knowledge#_knowledge) (local) checks. Also, once per day on command, the wearer can use the ring to cast either _ [locate creature](spell_dir/locateCreature#_locate-creature) _or _ [locate object](spells/locateObject#_locate-object)_ (the wearer's choice). Furthermore, on command and at will, the wearer can instantly know the direction from herself to the nearest tavern, pub, or similar watering hole as long as that establishment is in a settlement whose population is equivalent to that of a village or greater and that is within 20 miles of the wearer.

Construction Requirements

**Cost** 5,500 gp

Forge Ring, _ [know direction](spell_dir/knowDirection#_know-direction)_, _ [locate creature](spells/locateCreature#_locate-creature)_, _ [locate object](spell_dir/locateObject#_locate-object)_, creator must have at least 4 ranks in both [Sense Motive](skills/senseMotive#_sense-motive) and [Knowledge](skill_dir/knowledge#_knowledge) (local)
...
Forge Ring, _ [stinking cloud](spells/stinkingCloud#_stinking-cloud)_

Ring of Three Wishes

**Price** 120,000 gp; **Aura** strong universal; **CL** 20th; **Weight** —

This ring is set with three rubies. Each ruby stores a _ [wish](spell_dir/wish#_wish)_ spell, activated by the ring. When a _ [wish](spells/wish#_wish)_ is used, that ruby disappears. For a randomly generated ring, roll 1d3 to determine the remaining number of rubies. When all the _wishes_ are used, the ring becomes a nonmagical item.

Construction Requirements

**Cost** 97,500 gp

Forge Ring, _ [miracle](spell_dir/miracle#_miracle) _or_ [wish](spells/wish#_wish)_
...
This ring is often made of coral or bluish metal decorated with motifs depicting rolling waves of water. The ring allows the wearer to continually utilize the effects of the spell _ [water walk](spells/waterWalk#_water-walk)_.
...
Forge Ring, _ [limited wish](spells/limitedWish#_limited-wish)_
...
Forge Ring, _ [true seeing](spell_dir/trueSeeing#_true-seeing)_

Scholar's Ring

**Price** 8,700 gp; **Aura** moderate conjuration; **CL** 5th; **Weight** —

A _scholar's ring_ grants complete understanding of any written text or spoken language, even one that the wearer has never encountered before (as the _ [comprehend languages](spells/comprehendLanguages#_comprehend-languages)_ spell), as well as a +5 competence bonus on [Knowledge](skill_dir/knowledge#_knowledge) (history) checks.

In addition, once every 5 days the wearer can invoke a _ [legend lore](spells/legendLore#_legend-lore)_ spell related to a subject that she has been studying in the previous week, if she has attempted a [Knowledge](skill_dir/knowledge#_knowledge) (history) check aided by the ring.

Construction Requirements

**Cost** 4,350 gp

Forge Ring, _ [comprehend languages](spells/comprehendLanguages#_comprehend-languages), [legend lore](spell_dir/legendLore#_legend-lore)_
...
- The wearer can use _ [speak with dead](spells/speakWithDead#_speak-with-dead)_, as the spell, three times per day. It takes 10 minutes to use this ability.
- The wearer can use _ [spectral hand](spell_dir/spectralHand#_spectral-hand)_, as the spell, three times per day. 
- The wearer's weapons gain the _ [ghost touch](magicItems/weapons#_weapons-ghost-touch)_ weapon special ability while the wearer is wielding the weapons. 
...
Forge Ring, _ [speak with dead](spell_dir/speakWithDead#_speak-with-dead)_, _ [spectral hand](spells/spectralHand#_spectral-hand)_, _ [plane shift](spell_dir/planeShift#_plane-shift)_
...
Forge Ring, _ [stone fist](advanced/spell_dir/stoneFist#_stone-fist)_, _ [stoneskin](spells/stoneskin#_stoneskin)_

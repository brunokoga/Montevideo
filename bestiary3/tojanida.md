...
N Medium outsider ( [extraplanar](monsters/creatureTypes.md#_extraplanar-subtype), [water](monsters/creatureTypes.md#_water-subtype))

**Init** +1; **Senses** [all-around vision](monsters/universalMonsterRules.md#_all-around-vision), darkvision 60 ft.; [Perception](skills/perception.md#_perception) +14
...
**Feats** [Blind-Fight](feats.md#_blind-fight), [Dodge](feats.md#_dodge), [Power Attack](feats.md#_power-attack)

**Skills** [Bluff](skills/bluff.md#_bluff) +5, [Escape Artist](skills/escapeArtist.md#_escape-artist) +10, [Knowledge](skills/knowledge.md#_knowledge) (planes) +9, [Perception](skills/perception.md#_perception) +14, [Perform](skills/perform.md#_perform) (act) +5, [Sense Motive](skills/senseMotive.md#_sense-motive) +10, [Stealth](skills/stealth.md#_stealth) +7, [Survival](skills/survival.md#_survival) +7, [Swim](skills/swim.md#_swim) +11; **Racial Modifiers** +4 [Perception](skills/perception.md#_perception)

**Languages** Aquan

Ecology

**Environment** any [water](monsters/creatureTypes.md#_water-subtype) (Plane of [Water](monsters/creatureTypes.md#_water-subtype))
...
**Ink Cloud (Ex)** A tojanida can emit a 30-foot-radius sphere of ink once per minute as a free action. The ink provides total concealment in water, and persists for 1 minute. If used out of the water, the [jet](monsters/universalMonsterRules.md#_jet) of ink is a line 30 feet long, and creatures in the area must succeed at a DC 16 Reflex save or be blinded for 1 round. The save DC is Constitution-based.

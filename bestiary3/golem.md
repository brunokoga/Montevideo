...
**Init** +6; **Senses** darkvision 60 ft., low-light vision; [Perception](skills/perception.md#_perception) +0
...
**[Immunity](monsters/universalMonsterRules.md#_immunity-(ex-or-su)) to Magic (Ex)** A bone golem is immune to any spell or spell-like ability that allows spell [resistance](monsters/universalMonsterRules.md#_resistance). In addition, certain spells and abilities function differently against the creature, as noted below.

•Magical effects that heal living creatures slow a bone golem (as the [_slow_](spells/slow.md#_slow) spell) for 1d4 rounds (no save).
...
•A _ [raise dead](spells/raiseDead.md#_raise-dead)_, _ [resurrection](spells/resurrection.md#_resurrection)_, or _ [true resurrection](spells/trueResurrection.md#_true-resurrection)_ spell negates its DR and [immunity](monsters/universalMonsterRules.md#_immunity-(ex-or-su)) to magic for 1 minute.
...
**Requirements** [Craft Construct](monsters/monsterFeats.md#_craft-construct), _ [geas/quest](spells/geasQuest.md#_geas-quest)_, _ [limited wish](spells/limitedWish.md#_limited-wish)_, _ [telekinesis](spells/telekinesis.md#_telekinesis)_, and either _ [animate dead](spells/animateDead.md#_animate-dead)_ or _ [animate objects](spells/animateObjects.md#_animate-objects)_, creator must be at least caster level 9th; **Skill** [Craft](skills/craft.md#_craft) (sculpture) or [Heal](skills/heal.md#_heal) DC 15; **Cost** 21,000 gp
...
**Init** +0; **Senses** darkvision 60 ft., low-light vision, _ [see invisibility](spells/seeInvisibility.md#_see-invisibility)_; [Perception](skills/perception.md#_perception) +1
...
**DR** 15/adamantine; **Immune** construct traits, [fire](monsters/creatureTypes.md#_fire-subtype), magic

Offense

**Speed** 40 ft.

**Melee** brass falchion +29 (3d6+11/18–20 plus 2d6 [fire](monsters/creatureTypes.md#_fire-subtype)), slam +29 (2d6+11 plus 2d6 [fire](monsters/creatureTypes.md#_fire-subtype))

**Space** 15 ft.; **Reach** 15 ft.

**Special Attacks** [breath weapon](monsters/universalMonsterRules.md#_breath-weapon) (DC 20), [heat](monsters/universalMonsterRules.md#_heat) (2d6 [fire](monsters/creatureTypes.md#_fire-subtype))
...
**[Breath Weapon](monsters/universalMonsterRules.md#_breath-weapon) (Su)** As a free action once every 1d4 rounds, a brass golem can expel a cloud of smoke and cinders that fills a 20-foot cube. This functions as an _ [incendiary cloud](spells/incendiaryCloud.md#_incendiary-cloud)_ that persists for 1d6 rounds, dealing 6d6 points of [fire](monsters/creatureTypes.md#_fire-subtype) damage (DC 20 Reflex for half). The save DC is Constitution-based.

**Death Throes (Ex)** A brass golem explodes when it is destroyed. All creatures within 30 feet of the golem take 12d8 points of [fire](monsters/creatureTypes.md#_fire-subtype) damage (DC 20 Reflex for half). The save DC is Constitution-based.

**[Immunity](monsters/universalMonsterRules.md#_immunity-(ex-or-su)) to Magic (Ex)** A brass golem is immune to any spell or spell-like ability that allows spell [resistance](monsters/universalMonsterRules.md#_resistance). In addition, certain spells and effects function differently against the creature.

•A magical attack that deals [cold](monsters/creatureTypes.md#_cold-subtype) damage slows a brass golem (as per the [_slow_](spells/slow.md#_slow) spell) for 1d6 rounds, with no saving throw.

•A magical attack that deals [fire](monsters/creatureTypes.md#_fire-subtype) damage breaks any _slow_ effect on the golem and heals 1 point of damage for each 3 points of damage the attack would otherwise deal. If the amount of healing would cause the golem to exceed its full normal hit points, it gains any excess as temporary hit points. A brass golem gets no save against [fire](monsters/creatureTypes.md#_fire-subtype) effects.
...
**Requirements** [Craft Construct](monsters/monsterFeats.md#_craft-construct), _ [geas/quest](spells/geasQuest.md#_geas-quest)_, _ [incendiary cloud](spells/incendiaryCloud.md#_incendiary-cloud)_, _ [limited wish](spells/limitedWish.md#_limited-wish)_, _ [see invisibility](spells/seeInvisibility.md#_see-invisibility)_, creator must be caster level 17th; **Skill** [Craft](skills/craft.md#_craft) (armor) or [Craft](skills/craft.md#_craft) (blacksmithing) DC 22; **Cost** 100,000 gp
...
**Feats** [Improved Critical](feats.md#_improved-critical) (cannon)B
...
**Alloyed (Ex)** A cannon golem's slam and cannon attacks count as adamantine, [cold](monsters/creatureTypes.md#_cold-subtype) iron, and silver for the purpose of overcoming [damage reduction](monsters/universalMonsterRules.md#_damage-reduction-(ex-or-su)).
...
**Cannon (Ex)** The golem's cannon has a range increment of 100 feet and deals 6d6 points of bludgeoning and piercing damage on a hit with a ×4 critical modifier. The cannon's magazine can hold up to 20 cannonballs at a time—reloading a single cannonball into this magazine is a standard action for the golem, while loading a cannonball into the cannon itself to [fire](monsters/creatureTypes.md#_fire-subtype) it is a swift action; this allows the golem to take two shots per round with the cannon.

**Gun Training (Ex)** A cannon golem adds its Dex modifier to the damage dealt by its cannon.

**[Immunity](monsters/universalMonsterRules.md#_immunity-(ex-or-su)) to Magic (Ex)** A cannon golem is immune to spells and spell-like abilities that allow spell [resistance](monsters/universalMonsterRules.md#_resistance). Certain spells and effects function differently against it, as noted below.

•Any spell with the [water](monsters/creatureTypes.md#_water-subtype) descriptor that affects a cannon golem renders its cannon unusable for 1 round (no save).

•A _ [heat metal](spells/heatMetal.md#_heat-metal)_ spell causes the golem's cannon to instantly backfire, dealing 6d6 points of damage to the golem and staggering it for 1 round (no save).
...
**Requirements** [Craft Construct](monsters/monsterFeats.md#_craft-construct), _ [geas/quest](spells/geasQuest.md#_geas-quest)_, _ [limited wish](spells/limitedWish.md#_limited-wish)_, _ [plane shift](spells/planeShift.md#_plane-shift)_ or _ [secret chest](spells/secretChest.md#_secret-chest)_, creator must be caster level 17th; **Skill** [Craft](skills/craft.md#_craft) (siege engine) and [Knowledge](skills/knowledge.md#_knowledge) (engineering) DC 25; **Cost** 105,000 gp
...
**Feats** [Combat Reflexes](feats.md#_combat-reflexes)B
...
**[Immunity](monsters/universalMonsterRules.md#_immunity-(ex-or-su)) to Magic (Su)** A fossil golem is immune to any spell or spell-like ability that allows spell [resistance](monsters/universalMonsterRules.md#_resistance). In addition, certain spells and abilities function differently against the creature, as noted below.

•A _ [transmute rock to mud](spells/transmuteRockToMud.md#_transmute-rock-to-mud) _spell slows a fossil golem (as the [_slow_](spells/slow.md#_slow) spell) for 2d6 rounds, with no saving throw.

•A _ [stone to flesh](spells/stoneToFlesh.md#_stone-to-flesh)_ spell negates its [damage reduction](monsters/universalMonsterRules.md#_damage-reduction-(ex-or-su)) and petrification ability for 1 round.
...
Fortitude save or take 1d6 points of Dexterity drain. A creature that is reduced to 0 Dexterity by this attack turns completely to stone, as if by a _ [flesh to stone](spells/fleshToStone.md#_flesh-to-stone)_ spell. Casting _ [stone to flesh](spells/stoneToFlesh.md#_stone-to-flesh)_ on the creature removes all Dexterity drain caused by this attack. The save DC is Constitution-based and includes a +2 racial bonus.
...
**Requirements** [Craft Construct](monsters/monsterFeats.md#_craft-construct), _ [flesh to stone](spells/fleshToStone.md#_flesh-to-stone)_, _ [geas/quest](spells/geasQuest.md#_geas-quest)_, _ [limited wish](spells/limitedWish.md#_limited-wish)_, _ [stone shape](spells/stoneShape.md#_stone-shape)_, creator must be at least caster level 15th; **Skill** [Craft](skills/craft.md#_craft) (sculpture) or [Heal](skills/heal.md#_heal) DC 20; **Cost** 65,000 gp

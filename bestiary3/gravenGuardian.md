...
**Melee** _+1 [keen](magicItems/weapons.md#_weapons-keen) scimitar_ +10/+5 (1d6+5/15–20 plus [bleed](monsters/universalMonsterRules.md#_bleed)) or slam +9 (1d6+4)

**Special Attacks** [bleed](monsters/universalMonsterRules.md#_bleed) 2, magic weapon, rest eternal

**Spell-Like Abilities** (CL 5th; concentration +0)

1/day—_ [haste](spells/haste.md#_haste)_ (self only)
...
**Magic Weapon (Su)** A graven guardian that carries its deity's favored weapon treats that weapon as a _+1 _weapon as long as it is wielded by the guardian. If the weapon is a melee weapon, it gains the _ [keen](magicItems/weapons.md#_weapons-keen) _weapon special ability (even if the weapon is a bludgeoning weapon). If it is a thrown weapon, it gains the _ [returning](magicItems/weapons.md#_weapons-returning) _weapon special ability. If it is a ranged weapon, it gains the _ [seeking](magicItems/weapons.md#_weapons-seeking) _weapon special ability, and generates new ammunition with each attack (this ammunition is destroyed whether or not it hits).
...
**Air** : _Flight (Su)_—The graven guardian gains a fly speed equal to its base speed with average maneuverability and a [Fly](skills/fly.md#_fly) skill of +6 (this includes a +4 racial bonus).
...
**Charm** : _ [Command](spells/command.md#_command) (Su)_—The graven guardian can cast _ [command](spells/command.md#_command)_ three times per day as a spell-like ability.
...
**Darkness** : _ [Darkness](spells/darkness.md#_darkness) (Su)_—The graven guardian can cast _ [darkness](spells/darkness.md#_darkness)_ two times per day as a spell-like ability.

**Death** : _ [Bleed](spells/bleed.md#_bleed) (Ex)_—The graven guardian's weapon deals 2 points of bleed damage on a hit.

**Destruction** : _ [Shatter](spells/shatter.md#_shatter) (Ex)_—The graven guardian can cast _ [shatter](spells/shatter.md#_shatter)_ two times per day as a spell-like ability.
...
**Fire** : _ [Flaming](magicItems/weapons.md#_weapons-flaming) (Su)_—The graven guardian's weapon gains the _ [flaming](magicItems/weapons.md#_weapons-flaming)_ property.
...
**[Knowledge](skills/knowledge.md#_knowledge)** : _Familiarity (Su)_—The graven guardian gains a +2 bonus on attack rolls again any creature it attacked in the past round.
...
**Madness** : _ [Confusion](spells/confusion.md#_confusion) (Su)_—The graven guardian can cast _ [confusion](spells/confusion.md#_confusion)_ once per day as a spell-like ability.
...
**Plant** : _ [Entangle](spells/entangle.md#_entangle) (Su)_—The graven guardian can cast _ [entangle](spells/entangle.md#_entangle)_ three times per day as a spell-like ability.
...
**Strength** : _Powerful (Ex)_—The graven guardian gains [Power Attack](feats.md#_power-attack) as a bonus feat.
...
**Water** : _Swimmer (Ex)_—The guardian gains a swim speed equal to its base speed, and a [Swim](skills/swim.md#_swim) skill of +11.

**Weather** : _Shocking Weapon (Su)_—The graven guardian's weapon gains the _ [shock](magicItems/weapons.md#_weapons-shock)_ special ability.
...
**Requirements** [Craft Construct](monsters/monsterFeats.md#_craft-construct), _ [greater magic weapon](spells/magicWeapon.md#_magic-weapon-greater)_, _ [haste](spells/haste.md#_haste)_, _ [imbue with spell ability](spells/imbueWithSpellAbility.md#_imbue-with-spell-ability)_, _ [make whole](spells/makeWhole.md#_make-whole)_, _ [stone shape](spells/stoneShape.md#_stone-shape)_, creator must be caster level 7th; **Skill** [Craft](skills/craft.md#_craft) (sculpture) or [Craft](skills/craft.md#_craft) (pottery) DC 15; **Cost** 9,500 gp

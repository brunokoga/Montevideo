...
**Melee** bite +2 (1d4 plus [grab](monster_dir/universalMonsterRules#_grab, [attach](monster_dir/universalMonsterRules#_attach, and [disease](monster_dir/universalMonsterRules#_disease-(ex-or-su))
...
**[Grab](monster_dir/universalMonsterRules#_grab) (Ex** A giant tick can [grab](monster_dir/universalMonsterRules#_grab targets of any size, and has a +8 racial bonus on grapple checks rather than the normal +4 bonus most creatures with [grab](monster_dir/universalMonsterRules#_grab possess.
...
N Fine [vermin](monster_dir/creatureTypes#_vermin ( [swarm](monster_dir/creatureTypes#_swarm-subtype)
...
**Melee** [swarm](monster_dir/creatureTypes#_swarm-subtype (4d6 plus [disease](monster_dir/universalMonsterRules#_disease-(ex-or-su), [distraction](monster_dir/universalMonsterRules#_distraction, and [blood drain](monster_dir/universalMonsterRules#_blood-drain)

**Special Attacks** [blood drain](monster_dir/universalMonsterRules#_blood-drain) (1d4 Con, cling, [distraction](monster_dir/universalMonsterRules#_distraction) (DC 21
...
**Skills** [Climb](additionalMonsters/../skill_dir/climb#_climb +10; **Racial Modifiers** uses Dex on [Climb](additionalMonsters/../skill_dir/climb#_climb) checks
...
**Cling (Ex** If a creature leaves a tick [swarm](monster_dir/creatureTypes#_swarm-subtype's square, the [swarm](monster_dir/creatureTypes#_swarm-subtype takes 1d6 points of damage to reflect the loss of its numbers as several ticks cling to the victim. A creature with ticks clinging to it takes [swarm](monster_dir/creatureTypes#_swarm-subtype damage at the end of its turn each round. As a full round action, the creature can remove the ticks with a DC 20 Reflex save. At least 10 points of damage from any area effect destroys all clinging ticks. The save DC is Dexterity-based.

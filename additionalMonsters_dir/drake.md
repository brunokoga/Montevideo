...
CE Large [dragon](monster_dir/creatureTypes#_dragon ( [fire](monster_dir/creatureTypes#_fire-subtype)

**Init** +5; **Senses** darkvision 60 ft., low-light vision, [scent](monster_dir/universalMonsterRules#_scent; [Perception](additionalMonsters/../skill_dir/perception#_perception) +10
...
**Weakness** vulnerability to [cold](monster_dir/creatureTypes#_cold-subtype)

Offense

**Speed** 20 ft., fly 60 ft. (average

**Melee** bite +10 (2d6+5 plus 1d6 [fire](monster_dir/creatureTypes#_fire-subtype)), tail slap +5 (1d6+2
...
**Feats** [Flyby Attack](additionalMonsters/../monster_dir/monsterFeats#_flyby-attack, [Improved Initiative](additionalMonsters/../feats#_improved-initiative), [Power Attack](additionalMonsters/../feats#_power-attack)

**Skills** [Fly](additionalMonsters/../skill_dir/fly#_fly +8, [Intimidate](additionalMonsters/../skill_dir/intimidate#_intimidate +9, [Perception](additionalMonsters/../skill_dir/perception#_perception +10, [Stealth](additionalMonsters/../skill_dir/stealth#_stealth +6, [Survival](additionalMonsters/../skill_dir/survival#_survival) +10
...
**Fireball Breath (Su** A flame drake can, as a standard action, breathe a ball of flame that explodes like a _ [fireball](additionalMonsters/../spell_dir/fireball#_fireball_. This attack has a range of 180 feet and deals 5d6 points of [fire](monster_dir/creatureTypes#_fire-subtype) damage (DC 16 Reflex half) to all creatures within a 20-foot-radius spread. Once a flame drake has used its fireball breath, it cannot do so again for 1d6 rounds. The save DC is Constitution-based.
...
LE Large [dragon](monster_dir/creatureTypes#_dragon ( [earth](monster_dir/creatureTypes#_earth-subtype)

**Init** +6; **Senses** darkvision 60 ft., low-light vision, [scent](monster_dir/universalMonsterRules#_scent; [Perception](additionalMonsters/../skill_dir/perception#_perception) +11
...
**Feats** [Improved Initiative](additionalMonsters/../feats#_improved-initiative), [Power Attack](additionalMonsters/../feats#_power-attack), [Skill Focus](additionalMonsters/../feats#_skill-focus) ( [Perception](additionalMonsters/../skill_dir/perception#_perception)

**Skills** [Fly](additionalMonsters/../skill_dir/fly#_fly +8, [Intimidate](additionalMonsters/../skill_dir/intimidate#_intimidate +9, [Perception](additionalMonsters/../skill_dir/perception#_perception +11, [Stealth](additionalMonsters/../skill_dir/stealth#_stealth +6, [Swim](additionalMonsters/../skill_dir/swim#_swim +20

**Languages** Draconic

**SQ** [aquatic](monster_dir/creatureTypes#_aquatic-subtype) adaptation, speed surge
...
**Acidic Cloud (Su)** A forest drake can, as a standard action, spit a ball of acid that bursts into a cloud on impact. This attack has a range of 60 feet and deals 4d6 points of acid damage (Reflex DC 14 half to all creatures within the resulting 10-foot-radius spread. The cloud remains for 1d4 rounds once created, acting as a 10-foot-radius _ [obscuring mist](additionalMonsters/../spell_dir/obscuringMist#_obscuring-mist)_ (it no longer causes damage), but a strong wind disperses it in a single round. Once a forest drake has used its acidic cloud breath, it cannot do so again for 1d6 rounds. The Reflex save is Constitution-based.

**Aquatic Adaptation (Ex** A forest drake can breathe underwater indefinitely and can freely use its [breath weapon](monster_dir/universalMonsterRules#_breath-weapon) and other abilities while underwater. The acidic cloud created by that attack dissipates after 1 round if used underwater.
...
CE Large [dragon](monster_dir/creatureTypes#_dragon ( [cold](monster_dir/creatureTypes#_cold-subtype)

**Init** +5; **Senses** darkvision 60 ft., low-light vision, [scent](monster_dir/universalMonsterRules#_scent, snow vision; [Perception](additionalMonsters/../skill_dir/perception#_perception) +10
...
**Immune** [cold](monster_dir/creatureTypes#_cold-subtype, paralysis, sleep
...
**Melee** bite +13 (2d6+6 plus 1d6 [cold](monster_dir/creatureTypes#_cold-subtype)), tail slap +8 (1d8+3
...
**Feats** [Flyby Attack](additionalMonsters/../monster_dir/monsterFeats#_flyby-attack, [Improved Initiative](additionalMonsters/../feats#_improved-initiative), [Power Attack](additionalMonsters/../feats#_power-attack), [Vital Strike](additionalMonsters/../feats#_vital-strike)

**Skills** [Climb](additionalMonsters/../skill_dir/climb#_climb +17, [Fly](additionalMonsters/../skill_dir/fly#_fly +10, [Intimidate](additionalMonsters/../skill_dir/intimidate#_intimidate +12, [Perception](additionalMonsters/../skill_dir/perception#_perception +10, [Stealth](additionalMonsters/../skill_dir/stealth#_stealth +8
...
**Freezing Mist Breath (Su** A frost drake can, as a standard action, spit a ball of liquid that bursts into a cloud of freezing mist. This attack has a range of 60 feet and deals 7d6 points of [cold](monster_dir/creatureTypes#_cold-subtype) damage (DC 18 Reflex half) to all creatures in a 20-foot-radius spread. The mist cakes all surfaces in the area with a sheet of slippery ice that turns the area into difficult terrain for 2d4 rounds, after which the ice cracks or melts enough to revert to the normal terrain features in the area. Once a frost drake has used its freezing mist breath, it cannot do so again for 1d6 rounds. The Reflex save is Constitution-based.

**Icewalking (Ex** This ability works like _ [spider climb](additionalMonsters/../spell_dir/spiderClimb#_spider-climb_, but the surfaces the drake climbs must be icy. It can move across icy surfaces without penalty and does not need to make [Acrobatics](additionalMonsters/../skill_dir/acrobatics#_acrobatics) checks to run or charge on ice.
...
**Snow Vision (Ex** A frost drake can see perfectly well in snowy conditions, and does not take any penalties on [Perception](additionalMonsters/../skill_dir/perception#_perception checks while in snow.
...
NE Large [dragon](monster_dir/creatureTypes#_dragon ( [aquatic](monster_dir/creatureTypes#_aquatic-subtype)

**Init** +6; **Senses** darkvision 60 ft., low-light vision, [scent](monster_dir/universalMonsterRules#_scent; [Perception](additionalMonsters/../skill_dir/perception#_perception) +10
...
**Feats** [Improved Initiative](additionalMonsters/../feats#_improved-initiative), [Lightning Reflexes](additionalMonsters/../feats#_lightning-reflexes), [Power Attack](additionalMonsters/../feats#_power-attack), [Skill Focus](additionalMonsters/../feats#_skill-focus) ( [Stealth](additionalMonsters/../skill_dir/stealth#_stealth)

**Skills** [Fly](additionalMonsters/../skill_dir/fly#_fly +10, [Intimidate](additionalMonsters/../skill_dir/intimidate#_intimidate +9, [Perception](additionalMonsters/../skill_dir/perception#_perception +10, [Stealth](additionalMonsters/../skill_dir/stealth#_stealth +11, [Swim](additionalMonsters/../skill_dir/swim#_swim) +24

---
layout: default
title: additionalMonster_dir/mandragora
---
# Mandragora
...
**Init** +4; **Senses** low-light vision; [Perception](additionalMonster_dir/../skill_dir/perception#_perception) +9
...
**Immune** [plant](monsters/creatureTypes#_plant) traits; **Resist** acid 5, [cold](monster_dir/creatureTypes#_cold-subtype) 5, electricity 10
...
**Melee** bite +8 (1d6+2 plus [grab](monsters/universalMonsterRules#_grab)), 2 slam +8 (1d4+2 plus [poison](monster_dir/universalMonsterRules#_poison-(ex-or-su)))
...
**Feats** [Lightning Reflexes](additionalMonster_dir/../feats#_lightning-reflexes), [Skill Focus](additionalMonster_dir/../feats#_skill-focus) ( [Perception](additionalMonster_dir/../skill_dir/perception#_perception)), [Weapon Finesse](additionalMonsters/../feats#_weapon-finesse)

**Skills** [Climb](additionalMonster_dir/../skill_dir/climb#_climb) +10, [Perception](additionalMonsters/../skill_dir/perception#_perception) +9, [Stealth](additionalMonsters/../skill_dir/stealth#_stealth) +14 (+22 in vegetation); **Racial Modifiers** +8 [Stealth](additionalMonsters/../skill_dir/stealth#_stealth) in vegetation
...
**Vulnerable to Supernatural Darkness (Ex)** In areas of supernatural darkness (such as those created by _ [deeper darkness](additionalMonster_dir/../spell_dir/deeperDarkness#_deeper-darkness)_, but not by _ [darkness](additionalMonsters/../spell_dir/darkness#_darkness)_), a mandragora is slowed, as the _ [slow](additionalMonsters/../spell_dir/slow#_slow)_ spell.

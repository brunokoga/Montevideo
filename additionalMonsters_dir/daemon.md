...
NE Large [outsider](monsters/creatureTypes#_outsider) ( [daemon](monsters/creatureTypes#_daemon-subtype), [evil](monsters/creatureTypes#_evil-subtype), [extraplanar](monsters/creatureTypes#_extraplanar-subtype))

**Init** +7; **Senses** darkvision 60 ft., _ [deathwatch](additionalMonsters/../spells/deathwatch#_deathwatch)_, _ [true seeing](additionalMonsters/../spells/trueSeeing#_true-seeing)_; [Perception](additionalMonsters/../skills/perception#_perception) +22
...
**Defensive Abilities** _ [displacement](additionalMonsters/../spells/displacement#_displacement)_; **DR** 10/good and silver; **Immune** acid, death effects, [disease](monsters/universalMonsterRules#_disease-(ex-or-su)), [poison](monsters/universalMonsterRules#_poison-(ex-or-su)); **Resist** [cold](monsters/creatureTypes#_cold-subtype) 10, electricity 10, [fire](monsters/creatureTypes#_fire-subtype) 10; **SR** 27

Offense

**Speed** 90 ft., fly 90 ft. (good)

**Melee** bite +23 (2d6+5 plus energy drain and [grab](monsters/universalMonsterRules#_grab)), 2 claws +23 (1d8+5 plus energy drain), tail slap +18 (1d12+2 plus energy drain)
...
Constant—_ [deathwatch](additionalMonsters/../spells/deathwatch#_deathwatch)_, _ [displacement](additionalMonsters/../spells/displacement#_displacement), [true seeing](additionalMonsters/../spells/trueSeeing#_true-seeing)_

At will—_ [enervation](additionalMonsters/../spells/enervation#_enervation)_, _ [fear](additionalMonsters/../spells/fear#_fear)_ (DC21), _ [greater teleport](additionalMonsters/../spells/teleport#_teleport-greater) _(self plus 50 lbs. of objects only), _ [vampiric touch](additionalMonsters/../spells/vampiricTouch#_vampiric-touch)_

3/day—_ [locate creature](additionalMonsters/../spells/locateCreature#_locate-creature)_, _ [plane shift](additionalMonsters/../spells/planeShift#_plane-shift)_ (DC 24)

1/day—_ [energy drain](additionalMonsters/../spells/energyDrain#_energy-drain)_ (DC 24), _ [finger of death](additionalMonsters/../spells/fingerOfDeath#_finger-of-death)_ (DC 24), summon (level 6, 1d3 derghodaemons 50%)
...
**Feats** [Combat Reflexes](additionalMonsters/../feats#_combat-reflexes), [Dodge](additionalMonsters/../feats#_dodge), [Flyby Attack](additionalMonsters/../monsters/monsterFeats#_flyby-attack), [Iron Will](additionalMonsters/../feats#_iron-will), [Mobility](additionalMonsters/../feats#_mobility), [Nimble Moves](additionalMonsters/../feats#_nimble-moves), [Power Attack](additionalMonsters/../feats#_power-attack), [Spring Attack](additionalMonsters/../feats#_spring-attack), [Weapon Finesse](additionalMonsters/../feats#_weapon-finesse)

**Skills** [Acrobatics](additionalMonsters/../skills/acrobatics#_acrobatics) +24 (+48 jump), [Escape Artist](additionalMonsters/../skills/escapeArtist#_escape-artist) +27, [Fly](additionalMonsters/../skills/fly#_fly) +9, [Intimidate](additionalMonsters/../skills/intimidate#_intimidate) +27, [Knowledge](additionalMonsters/../skills/knowledge#_knowledge) (planes) +22, [Perception](additionalMonsters/../skills/perception#_perception) +22, [Sense Motive](additionalMonsters/../skills/senseMotive#_sense-motive) +22, [Stealth](additionalMonsters/../skills/stealth#_stealth) +23, [Survival](additionalMonsters/../skills/survival#_survival) +22
...
NE Tiny [outsider](monsters/creatureTypes#_outsider) ( [daemon](monsters/creatureTypes#_daemon-subtype), [evil](monsters/creatureTypes#_evil-subtype), [extraplanar](monsters/creatureTypes#_extraplanar-subtype))

**Init** +4; **Senses** darkvision 60 ft., _ [detect good](additionalMonsters/../spells/detectGood#_detect-good)_, _ [detect magic](additionalMonsters/../spells/detectMagic#_detect-magic)_; [Perception](additionalMonsters/../skills/perception#_perception) +7
...
**Melee** bite +6 (1d4+1 plus [disease](monsters/universalMonsterRules#_disease-(ex-or-su)))
...
Constant—_ [detect good](additionalMonsters/../spells/detectGood#_detect-good), [detect magic](additionalMonsters/../spells/detectMagic#_detect-magic)_

At will—_ [invisibility](additionalMonsters/../spells/invisibility#_invisibility) _(self only)

3/day—_ [lesser confusion](additionalMonsters/../spells/confusion#_confusion-lesser) _(DC 12)

1/week—_ [commune](additionalMonsters/../spells/commune#_commune)_ (CL 12th, six questions)
...
**Feats** [Improved Initiative](additionalMonsters/../feats#_improved-initiative), [Lightning Reflexes](additionalMonsters/../feats#_lightning-reflexes)

**Skills** [Bluff](additionalMonsters/../skills/bluff#_bluff) +7, [Fly](additionalMonsters/../skills/fly#_fly) +18, [Knowledge](additionalMonsters/../skills/knowledge#_knowledge) (planes) +5, [Perception](additionalMonsters/../skills/perception#_perception) +7, [Stealth](additionalMonsters/../skills/stealth#_stealth) +14

**Languages** Abyssal, Common, Infernal; telepathy 100 ft.

**SQ** [change shape](monsters/universalMonsterRules#_change-shape) (2 of the following forms: lizard, octopus, Small scorpion, venomous snake, _ [polymorph](additionalMonsters/../spells/polymorph#_polymorph)_)
...
**Init** +1; **Senses** darkvision 60 ft., _ [detect good](additionalMonsters/../spells/detectGood#_detect-good)_, _ [detect magic](additionalMonsters/../spells/detectMagic#_detect-magic)_, _ [see invisibility](additionalMonsters/../spells/seeInvisibility#_see-invisibility)_; [Perception](additionalMonsters/../skills/perception#_perception) +15
...
**DR** 10/good or silver; **Immune** acid, death effects, [disease](monsters/universalMonsterRules#_disease-(ex-or-su)), mind-affecting effects, paralysis, [poison](monsters/universalMonsterRules#_poison-(ex-or-su)), polymorph effects, sleep effects; **Resist** [cold](monsters/creatureTypes#_cold-subtype) 10, electricity 10, [fire](monsters/creatureTypes#_fire-subtype) 10
...
**Special Attacks** [breath weapon](monsters/universalMonsterRules#_breath-weapon) (30-ft. cone; 6d6 [fire](monsters/creatureTypes#_fire-subtype) damage; Reflex DC 17 for half; usable once every 1d4 rounds)

**Spell-Like Abilities** (CL 8th; concentration +10)

Constant—_ [detect good](additionalMonsters/../spells/detectGood#_detect-good), [detect magic](additionalMonsters/../spells/detectMagic#_detect-magic), [see invisibility](additionalMonsters/../spells/seeInvisibility#_see-invisibility)_

At will—_ [dimension door](additionalMonsters/../spells/dimensionDoor#_dimension-door)_

3/day—_ [dispel magic](additionalMonsters/../spells/dispelMagic#_dispel-magic)_, _ [fly](additionalMonsters/../spells/fly)_

1/day—_ [hold monster](additionalMonsters/../spells/holdMonster#_hold-monster)_ (DC 17), _ [slow](additionalMonsters/../spells/slow#_slow)_ (DC 15)
...
**Feats** [Alertness](additionalMonsters/../feats#_alertness), [Blind-Fight](additionalMonsters/../feats#_blind-fight), [Power Attack](additionalMonsters/../feats#_power-attack), [Step Up](additionalMonsters/../feats#_step-up)

**Skills** [Bluff](additionalMonsters/../skills/bluff#_bluff) +13, [Intimidate](additionalMonsters/../skills/intimidate#_intimidate) +11, [Knowledge](additionalMonsters/../skills/knowledge#_knowledge) (planes) +9, [Perception](additionalMonsters/../skills/perception#_perception) +15, [Sense Motive](additionalMonsters/../skills/senseMotive#_sense-motive) +15, [Stealth](additionalMonsters/../skills/stealth#_stealth) +8, [Survival](additionalMonsters/../skills/survival#_survival) +9
...
**Drawn to Service (Su)** When brought to another plane with a _ [planar binding](additionalMonsters/../spells/planarBinding#_planar-binding)_ or _ [planar ally](additionalMonsters/../spells/planarAlly#_planar-ally) _spell (or any similar calling effect), ceustodaemons take a –5 penalty on the initial Will save and on their Charisma check to refuse service. Ceustodaemons also take a –5 penalty on saves against _ [binding](additionalMonsters/../spells/binding#_binding)_, _ [planar binding](additionalMonsters/../spells/planarBinding#_planar-binding)_, and other spells designed to bind a creature to a particular plane as long as the [daemon](monsters/creatureTypes#_daemon-subtype) is commanded to serve as a guardian for a single area or small complex.
...
**Init** +5; **Senses** [all-around vision](monsters/universalMonsterRules#_all-around-vision), darkvision 60 ft., _ [detect magic](additionalMonsters/../spells/detectMagic#_detect-magic)_, _ [see invisibility](additionalMonsters/../spells/seeInvisibility#_see-invisibility)_; [Perception](additionalMonsters/../skills/perception#_perception) +28

**Aura** _ [feeblemind](additionalMonsters/../spells/feeblemind#_feeblemind)_ (DC 20)
...
**DR** 10/good; **Immune** acid, death effects, [disease](monsters/universalMonsterRules#_disease-(ex-or-su)), [poison](monsters/universalMonsterRules#_poison-(ex-or-su)); **Resist** [cold](monsters/creatureTypes#_cold-subtype) 10, electricity 10, [fire](monsters/creatureTypes#_fire-subtype) 10; **SR** 23
...
Constant—_ [detect magic](additionalMonsters/../spells/detectMagic#_detect-magic)_, _ [see invisibility](additionalMonsters/../spells/seeInvisibility#_see-invisibility)_

At will—_ [greater teleport](additionalMonsters/../spells/teleport#_teleport-greater)_ (self plus 50 lbs. of objects only)

3/day—_ [fear](additionalMonsters/../spells/fear#_fear)_ (DC 17), quickened _ [summon swarm](additionalMonsters/../spells/summonSwarm#_summon-swarm)_

1/day—_ [creeping doom](additionalMonsters/../spells/creepingDoom#_creeping-doom)_, _ [insect plague](additionalMonsters/../spells/insectPlague#_insect-plague)_, summon (level 4, 1 derghodaemon 30%)
...
**Feats** [Cleave](additionalMonsters/../feats#_cleave), [Critical Focus](additionalMonsters/../feats#_critical-focus), [Improved Critical](additionalMonsters/../feats#_improved-critical) (claws), [Power Attack](additionalMonsters/../feats#_power-attack), [Quicken Spell-Like Ability](additionalMonsters/../monsters/monsterFeats#_quicken-spell-like-ability) (_ [summon swarm](additionalMonsters/../spells/summonSwarm#_summon-swarm)_), [Sickening Critical](additionalMonsters/../feats#_sickening-critical), [Vital Strike](additionalMonsters/../feats#_vital-strike)

**Skills** [Intimidate](additionalMonsters/../skills/intimidate#_intimidate) +20, [Perception](additionalMonsters/../skills/perception#_perception) +28, [Sense Motive](additionalMonsters/../skills/senseMotive#_sense-motive) +20, [Stealth](additionalMonsters/../skills/stealth#_stealth) +18; **Racial Modifiers** +4 Perception
...
**Feeblemind Aura (Su)** By grinding and clicking its mandibles and chitinous plates together (a free action), a derghodaemon can affect all creatures within 30 feet as if by a _ [feeblemind](additionalMonsters/../spells/feeblemind#_feeblemind)_ spell. Daemons are immune to this effect, but all other creatures must make a DC 20 Will save to resist the effects. A creature that makes this save is immune to the effect for 24 hours. A creature that fails remains affected as long as the derghodaemon continues to maintain the aura and the subject remains within 30 feet of the derghodaemon. Once either condition ends, the victim of this effect can attempt a new DC 20 Will save once per minute to recover from the effect; otherwise, it can be cured by a _ [heal](additionalMonsters/../spells/heal#_heal)_, _ [limited wish](additionalMonsters/../spells/limitedWish#_limited-wish)_, _ [miracle](additionalMonsters/../spells/miracle#_miracle)_, or _ [wish](additionalMonsters/../spells/wish#_wish)_ spell. A derghodaemon cannot use its spell-like abilities or rend attack in any round in which it uses its feeblemind aura. This is a sonic mind-affecting effect. The save DC is Charisma-based.
...
NE Large [outsider](monsters/creatureTypes#_outsider) ( [aquatic](monsters/creatureTypes#_aquatic-subtype), [daemon](monsters/creatureTypes#_daemon-subtype), [evil](monsters/creatureTypes#_evil-subtype), [extraplanar](monsters/creatureTypes#_extraplanar-subtype))

**Init** +2; **Senses** darkvision 60 ft., _ [detect magic](additionalMonsters/../spells/detectMagic#_detect-magic)_; [Perception](additionalMonsters/../skills/perception#_perception) +15
...
**DR** 10/cold iron or silver; **Immune** acid, death effects, [disease](monsters/universalMonsterRules#_disease-(ex-or-su)), [poison](monsters/universalMonsterRules#_poison-(ex-or-su)), waters of the River Styx; **Resist** [cold](monsters/creatureTypes#_cold-subtype) 10, electricity 10, [fire](monsters/creatureTypes#_fire-subtype) 10; **SR** 19

Offense

**Speed** 30 ft., fly 40 ft. (average; see glide, below), swim 60 ft.

**Melee** bite +13 (1d8+4 plus [grab](monsters/universalMonsterRules#_grab)), 2 claws +13 (1d6+4)
...
Constant—_ [detect magic](additionalMonsters/../spells/detectMagic#_detect-magic), [water walk](additionalMonsters/../spells/waterWalk#_water-walk)_

At will—_ [acid arrow](additionalMonsters/../spells/acidArrow#_acid-arrow)_, _ [deeper darkness](additionalMonsters/../spells/deeperDarkness#_deeper-darkness)_

3/day—_ [control water](additionalMonsters/../spells/controlWater#_control-water)_, _ [greater teleport](additionalMonsters/../spells/teleport#_teleport-greater)_ (self plus 50 lbs. of objects only), _ [summon monster V](additionalMonsters/../spells/summonMonster#_summon-monster-v)_ (Large water elemental only)

1/day—_ [desecrate](additionalMonsters/../spells/desecrate#_desecrate)_, summon (level 3, 1 hydrodaemon 50%)
...
**Feats** [Cleave](additionalMonsters/../feats#_cleave), [Point-Blank Shot](additionalMonsters/../feats#_point-blank-shot), [Power Attack](additionalMonsters/../feats#_power-attack), [Precise Shot](additionalMonsters/../feats#_precise-shot), [Skill Focus](additionalMonsters/../feats#_skill-focus) ( [Perception](additionalMonsters/../skills/perception#_perception))

**Skills** [Fly](additionalMonsters/../skills/fly#_fly) +0, [Intimidate](additionalMonsters/../skills/intimidate#_intimidate) +14, [Knowledge](additionalMonsters/../skills/knowledge#_knowledge) (planes) +10, [Perception](additionalMonsters/../skills/perception#_perception) +15, [Sense Motive](additionalMonsters/../skills/senseMotive#_sense-motive) +12, [Stealth](additionalMonsters/../skills/stealth#_stealth) +10, [Swim](additionalMonsters/../skills/swim#_swim) +21
...
**Glide (Ex)** A hydrodaemon can launch itself into the [air](monsters/creatureTypes#_air-subtype) and glide along for 1 minute, gaining a fly speed of 40 feet with average maneuverability. While gliding, the hydrodaemon gains the [pounce](monsters/universalMonsterRules#_pounce) ability.
...
**Init** +11; **Senses** darkvision 60 ft., _ [deathwatch](additionalMonsters/../spells/deathwatch#_deathwatch)_, _ [detect good](additionalMonsters/../spells/detectGood#_detect-good)_; [Perception](additionalMonsters/../skills/perception#_perception) +22
...
**DR** 10/good or silver; **Immune** acid, death effects, [disease](monsters/universalMonsterRules#_disease-(ex-or-su)), [poison](monsters/universalMonsterRules#_poison-(ex-or-su)); **Resist** [cold](monsters/creatureTypes#_cold-subtype) 10, electricity 10, [fire](monsters/creatureTypes#_fire-subtype) 10; **SR** 20
...
Constant—_ [deathwatch](additionalMonsters/../spells/deathwatch#_deathwatch)_, _ [detect good](additionalMonsters/../spells/detectGood#_detect-good)_

At will—_ [contagion](additionalMonsters/../spells/contagion#_contagion)_ (DC 17), _ [dispel magic](additionalMonsters/../spells/dispelMagic#_dispel-magic)_, _ [greater teleport](additionalMonsters/../spells/teleport#_teleport-greater)_ (self plus 50 lbs. of objects only)

1/day­—_ [harm](additionalMonsters/../spells/harm#_harm)_ (DC 19), summon (level 3, 1 leukodaemon only, 35%)
...
**Feats** [Alertness](additionalMonsters/../feats#_alertness), [Hover](additionalMonsters/../monsters/monsterFeats#_hover), [Improved Initiative](additionalMonsters/../feats#_improved-initiative), [Point-Blank Shot](additionalMonsters/../feats#_point-blank-shot), [Weapon Focus](additionalMonsters/../feats#_weapon-focus) (longbow)

**Skills** [Fly](additionalMonsters/../skills/fly#_fly) +18, [Heal](additionalMonsters/../skills/heal#_heal) +18, [Intimidate](additionalMonsters/../skills/intimidate#_intimidate) +16, [Knowledge](additionalMonsters/../skills/knowledge#_knowledge) (planes) +16, [Perception](additionalMonsters/../skills/perception#_perception) +22, [Sense Motive](additionalMonsters/../skills/senseMotive#_sense-motive) +22, [Stealth](additionalMonsters/../skills/stealth#_stealth) +16, [Survival](additionalMonsters/../skills/survival#_survival) +15, [Use Magic Device](additionalMonsters/../skills/useMagicDevice#_use-magic-device) +16
...
**Init** +6; **Senses** darkvision 60 ft., _ [detect good](additionalMonsters/../spells/detectGood#_detect-good)_, _ [detect magic](additionalMonsters/../spells/detectMagic#_detect-magic)_; [Perception](additionalMonsters/../skills/perception#_perception) +20
...
**DR** 10/good; **Immune** acid, critical hits, death effects, [disease](monsters/universalMonsterRules#_disease-(ex-or-su)), [poison](monsters/universalMonsterRules#_poison-(ex-or-su)), sneak attack; **Resist** [cold](monsters/creatureTypes#_cold-subtype) 10, electricity 10, [fire](monsters/creatureTypes#_fire-subtype) 10; **SR** 22

Offense

**Speed** 30 ft., fly 60 ft. (average)

**Melee** bite +20 (2d8+6/19–20 plus [disease](monsters/universalMonsterRules#_disease-(ex-or-su))), 2 claws +19 (2d6+6 plus hunger)

**Space** 10 ft.; **Reach** 10 ft.

**Spell-Like Abilities** (CL 11th; concentration +15)

Constant—_ [detect good](additionalMonsters/../spells/detectGood#_detect-good)_, _ [detect magic](additionalMonsters/../spells/detectMagic#_detect-magic)_, _ [see invisibility](additionalMonsters/../spells/seeInvisibility#_see-invisibility)_

At will—_cause fear_ (DC 15), _ [deeper darkness](additionalMonsters/../spells/deeperDarkness#_deeper-darkness)_, _ [greater teleport](additionalMonsters/../spells/teleport#_teleport-greater)_ (self plus 50 lbs. of objects only)

3/day—_ [blight](additionalMonsters/../spells/blight#_blight) _(DC 19), _ [diminish plants](additionalMonsters/../spells/diminishPlants#_diminish-plants)_, quickened _ [magic missile](additionalMonsters/../spells/magicMissile#_magic-missile)_

1/day—_ [horrid wilting](additionalMonsters/../spells/horridWilting#_horrid-wilting)_ (DC 22), _ [waves of fatigue](additionalMonsters/../spells/wavesOfFatigue#_waves-of-fatigue)_
...
**Feats** [Blind-Fight](additionalMonsters/../feats#_blind-fight), [Combat Reflexes](additionalMonsters/../feats#_combat-reflexes), [Great Fortitude](additionalMonsters/../feats#_great-fortitude), [Improved Critical](additionalMonsters/../feats#_improved-critical) (bite), [Iron Will](additionalMonsters/../feats#_iron-will), [Quicken Spell-Like Ability](additionalMonsters/../monsters/monsterFeats#_quicken-spell-like-ability) (_ [magic missile](additionalMonsters/../spells/magicMissile#_magic-missile)_), [Weapon Focus](additionalMonsters/../feats#_weapon-focus) (bite)

**Skills** [Bluff](additionalMonsters/../skills/bluff#_bluff) +21, [Fly](additionalMonsters/../skills/fly#_fly) +17, [Heal](additionalMonsters/../skills/heal#_heal) +11, [Intimidate](additionalMonsters/../skills/intimidate#_intimidate) +21, [Knowledge](additionalMonsters/../skills/knowledge#_knowledge) (planes) +22, [Knowledge](additionalMonsters/../skills/knowledge#_knowledge) (religion) +22, [Perception](additionalMonsters/../skills/perception#_perception) +20, [Sense Motive](additionalMonsters/../skills/senseMotive#_sense-motive) +20, [Spellcraft](additionalMonsters/../skills/spellcraft#_spellcraft) +22, [Stealth](additionalMonsters/../skills/stealth#_stealth) +19, [Survival](additionalMonsters/../skills/survival#_survival) +20, [Use Magic Device](additionalMonsters/../skills/useMagicDevice#_use-magic-device) +14
...
NE Gargantuan [outsider](monsters/creatureTypes#_outsider) ( [daemon](monsters/creatureTypes#_daemon-subtype), [evil](monsters/creatureTypes#_evil-subtype), [extraplanar](monsters/creatureTypes#_extraplanar-subtype))

**Init** +12; **Senses** darkvision 60 ft., _ [true seeing](additionalMonsters/../spells/trueSeeing#_true-seeing)_; [Perception](additionalMonsters/../skills/perception#_perception) +31

**Aura** _ [unholy aura](additionalMonsters/../spells/unholyAura#_unholy-aura)_
...
**DR** 10/good and silver; **Immune** acid, death effects, [disease](monsters/universalMonsterRules#_disease-(ex-or-su)), [poison](monsters/universalMonsterRules#_poison-(ex-or-su)); **Resist** [cold](monsters/creatureTypes#_cold-subtype) 10, electricity 10, [fire](monsters/creatureTypes#_fire-subtype) 10; **SR** 31

Offense

**Speed** 40 ft., burrow 50 ft.

**Melee** 2 bites +28 (2d8+12/19–20 plus [grab](monsters/universalMonsterRules#_grab)), 4 claws +28 (2d6+12 plus [grab](monsters/universalMonsterRules#_grab)), gore +28 (2d8+12)
...
Constant—_ [air walk](additionalMonsters/../spells/airWalk#_air-walk)_, _ [true seeing](additionalMonsters/../spells/trueSeeing#_true-seeing), [unholy aura](additionalMonsters/../spells/unholyAura#_unholy-aura)_ (DC 25)

At will—_ [greater teleport](additionalMonsters/../spells/teleport#_teleport-greater)_ (self plus 50 lbs. objects only), _ [telekinesis](additionalMonsters/../spells/telekinesis#_telekinesis)_, _ [wall of fire](additionalMonsters/../spells/wallOfFire#_wall-of-fire), [wall of ice](additionalMonsters/../spells/wallOfIce#_wall-of-ice)_

3/day—quickened_ [disintegrate](additionalMonsters/../spells/disintegrate#_disintegrate) _(DC 23), _ [wall of force](additionalMonsters/../spells/wallOfForce#_wall-of-force)_

1/day—_ [blasphemy](additionalMonsters/../spells/blasphemy#_blasphemy)_ (DC 24), summon (level 9 any 1 CR 19 or lower daemon, 100%), _ [wail of the banshee](additionalMonsters/../spells/wailOfTheBanshee#_wail-of-the-banshee)_ (DC 26)
...
**Feats** [Awesome Blow](additionalMonsters/../monsters/monsterFeats#_awesome-blow), [Cleave](additionalMonsters/../feats#_cleave), [Great Cleave](additionalMonsters/../feats#_great-cleave), [Improved Bull Rush](additionalMonsters/../feats#_improved-bull-rush), [Improved Critical](additionalMonsters/../feats#_improved-critical) (bite), [Improved Initiative](additionalMonsters/../feats#_improved-initiative), [Improved Sunder](additionalMonsters/../feats#_improved-sunder), [Iron Will](additionalMonsters/../feats#_iron-will), [Power Attack](additionalMonsters/../feats#_power-attack), [Quicken Spell-Like Ability](additionalMonsters/../monsters/monsterFeats#_quicken-spell-like-ability) (_ [disintegrate](additionalMonsters/../spells/disintegrate#_disintegrate)_)

**Skills** [Climb](additionalMonsters/../skills/climb#_climb) +35, [Intimidate](additionalMonsters/../skills/intimidate#_intimidate) +30, [Knowledge](additionalMonsters/../skills/knowledge#_knowledge) (planes) +24, [Perception](additionalMonsters/../skills/perception#_perception) +31, [Sense Motive](additionalMonsters/../skills/senseMotive#_sense-motive) +31, [Stealth](additionalMonsters/../skills/stealth#_stealth) +19, [Survival](additionalMonsters/../skills/survival#_survival) +31
...
Olethrodaemons serving the Horseman of Pestilence can infect their victims with a powerful disease by means of all their natural attacks. Creatures who succumb to this attack are affected as if by a maximized _ [contagion](additionalMonsters/../spells/contagion#_contagion)_ spell, heightened to 9th level.
...
NE Medium [outsider](monsters/creatureTypes#_outsider) ( [aquatic](monsters/creatureTypes#_aquatic-subtype), [daemon](monsters/creatureTypes#_daemon-subtype), [evil](monsters/creatureTypes#_evil-subtype), [extraplanar](monsters/creatureTypes#_extraplanar-subtype))

**Init** +8; **Senses** darkvision 60 ft., _ [detect good](additionalMonsters/../spells/detectGood#_detect-good)_, _ [detect magic](additionalMonsters/../spells/detectMagic#_detect-magic)_, _ [see invisibility](additionalMonsters/../spells/seeInvisibility#_see-invisibility)_; [Perception](additionalMonsters/../skills/perception#_perception) +16
...
**DR** 10/good; **Immune** acid, death effects, [disease](monsters/universalMonsterRules#_disease-(ex-or-su)), [poison](monsters/universalMonsterRules#_poison-(ex-or-su)); **Resist** [cold](monsters/creatureTypes#_cold-subtype) 10, electricity 10, [fire](monsters/creatureTypes#_fire-subtype) 10; **SR** 21

Offense

**Speed** 30 ft., swim 50 ft.

**Melee** 2 claws +18 (2d6+7/18-20/×3 plus [grab](monsters/universalMonsterRules#_grab) and 1d6 [bleed](monsters/universalMonsterRules#_bleed)), tentacles +16 (1d10+3 plus [poison](monsters/universalMonsterRules#_poison-(ex-or-su)))
...
At will—_ [dispel magic](additionalMonsters/../spells/dispelMagic#_dispel-magic)_, _ [greater teleport](additionalMonsters/../spells/teleport#_teleport-greater)_ (self plus 50 lbs. of objects only)

3/day—_ [fly](additionalMonsters/../spells/fly)_, _ [stinking cloud](additionalMonsters/../spells/stinkingCloud#_stinking-cloud)_ (DC 16)
...
**Feats** [Critical Focus](additionalMonsters/../feats#_critical-focus), [Improved Initiative](additionalMonsters/../feats#_improved-initiative), [Multiattack](additionalMonsters/../monsters/monsterFeats#_multiattack), [Power Attack](additionalMonsters/../feats#_power-attack), [Sickening Critical](additionalMonsters/../feats#_sickening-critical), [Vital Strike](additionalMonsters/../feats#_vital-strike)

**Skills** [Escape Artist](additionalMonsters/../skills/escapeArtist#_escape-artist) +18, [Intimidate](additionalMonsters/../skills/intimidate#_intimidate) +17, [Knowledge](additionalMonsters/../skills/knowledge#_knowledge) (planes) +16, [Perception](additionalMonsters/../skills/perception#_perception) +16, [Sense Motive](additionalMonsters/../skills/senseMotive#_sense-motive) +16, [Stealth](additionalMonsters/../skills/stealth#_stealth) +18, [Survival](additionalMonsters/../skills/survival#_survival) +16, [Swim](additionalMonsters/../skills/swim#_swim) +29
...
**[Augmented](monsters/creatureTypes#_augmented-subtype) Critical (Ex)** A piscodaemon's claws threaten a critical hit on an 18–20 and inflict ×3 damage on a successful critical hit.
...
**Init** +10; **Senses** darkvision 60 ft., _ [true seeing](additionalMonsters/../spells/trueSeeing#_true-seeing)_; [Perception](additionalMonsters/../skills/perception#_perception) +26

**Aura** [fear](monsters/universalMonsterRules#_fear-(su-or-sp)) (15 ft., DC 24), _ [unholy aura](additionalMonsters/../spells/unholyAura#_unholy-aura)_
...
**DR** 10/good and silver; **Immune** acid, death effects, [disease](monsters/universalMonsterRules#_disease-(ex-or-su)), [poison](monsters/universalMonsterRules#_poison-(ex-or-su)); **Resist** [cold](monsters/creatureTypes#_cold-subtype) 10, electricity 10, [fire](monsters/creatureTypes#_fire-subtype) 10; **SR** 29

Offense

**Speed** 30 ft., fly 60 ft. (good)

**Melee** _+2 [wounding](additionalMonsters/../magicItems/weapons#_wounding) halberd_ 2d8+18/19-20/x3, bite +24 (1d8+5)
...
Constant—_ [true seeing](additionalMonsters/../spells/trueSeeing#_true-seeing), [unholy aura](additionalMonsters/../spells/unholyAura#_unholy-aura)_ (DC 23)

At will—_ [greater teleport](additionalMonsters/../spells/teleport#_teleport-greater)_ (self plus 50 lbs. of objects only)

3/day—_ [chain lightning](additionalMonsters/../spells/chainLightning#_chain-lightning)_ (DC 21), _ [cone of cold](additionalMonsters/../spells/coneOfCold#_cone-of-cold)_ (DC 20), _ [flame strike](additionalMonsters/../spells/flameStrike#_flame-strike)_ (DC 20)
...
**Feats** [Combat Expertise](additionalMonsters/../feats#_combat-expertise), [Combat Reflexes](additionalMonsters/../feats#_combat-reflexes), [Greater Vital Strike](additionalMonsters/../feats#_greater-vital-strike), [Improved Critical](additionalMonsters/../feats#_improved-critical)B (halberd), [Improved Initiative](additionalMonsters/../feats#_improved-initiative), [Improved Sunder](additionalMonsters/../feats#_improved-sunder), [Improved Vital Strike](additionalMonsters/../feats#_improved-vital-strike), [Lunge](additionalMonsters/../feats#_lunge), [Power Attack](additionalMonsters/../feats#_power-attack), [Quick Draw](additionalMonsters/../feats#_quick-draw), [Vital Strike](additionalMonsters/../feats#_vital-strike), [Weapon Focus](additionalMonsters/../feats#_weapon-focus)B (halberd)

**Skills** [Acrobatics](additionalMonsters/../skills/acrobatics#_acrobatics) +28, [Bluff](additionalMonsters/../skills/bluff#_bluff) +21, [Diplomacy](additionalMonsters/../skills/diplomacy#_diplomacy) +17, [Fly](additionalMonsters/../skills/fly#_fly) +16, [Intimidate](additionalMonsters/../skills/intimidate#_intimidate) +27, [Knowledge](additionalMonsters/../skills/knowledge#_knowledge) (planes) +25, [Perception](additionalMonsters/../skills/perception#_perception) +26, [Sense Motive](additionalMonsters/../skills/senseMotive#_sense-motive) +26, [Spellcraft](additionalMonsters/../skills/spellcraft#_spellcraft) +23, [Stealth](additionalMonsters/../skills/stealth#_stealth) +24, [Survival](additionalMonsters/../skills/survival#_survival) +17
...
NE Medium [outsider](monsters/creatureTypes#_outsider) ( [daemon](monsters/creatureTypes#_daemon-subtype), [evil](monsters/creatureTypes#_evil-subtype), [extraplanar](monsters/creatureTypes#_extraplanar-subtype))

**Init** +7; **Senses** darkvision 60 ft., _ [true seeing](additionalMonsters/../spells/trueSeeing#_true-seeing)_; [Perception](additionalMonsters/../skills/perception#_perception) +25
...
**DR** 10/good; **Immune** acid, death effects, [disease](monsters/universalMonsterRules#_disease-(ex-or-su)), [poison](monsters/universalMonsterRules#_poison-(ex-or-su)); **Resist** [cold](monsters/creatureTypes#_cold-subtype) 10, electricity 10, [fire](monsters/creatureTypes#_fire-subtype) 10; **SR** 24
...
**Special Attacks** draining weapon, energy drain (1 level, DC 21), [fear](monsters/universalMonsterRules#_fear-(su-or-sp)) [gaze](monsters/universalMonsterRules#_gaze), soul crush
...
At will—_ [greater teleport](additionalMonsters/../spells/teleport#_teleport-greater)_ (self plus skiff and passengers only), _ [plane shift](additionalMonsters/../spells/planeShift#_plane-shift)_ (self plus skiff and passengers only, Astral, Ethereal, and evil-aligned planes only)

3/day—_ [animate dead](additionalMonsters/../spells/animateDead#_animate-dead)_, _ [desecrate](additionalMonsters/../spells/desecrate#_desecrate)_, _ [enervation](additionalMonsters/../spells/enervation#_enervation)_
...
**Feats** [Alertness](additionalMonsters/../feats#_alertness), [Blind-Fight](additionalMonsters/../feats#_blind-fight), [Dodge](additionalMonsters/../feats#_dodge), [Improved Initiative](additionalMonsters/../feats#_improved-initiative), [Iron Will](additionalMonsters/../feats#_iron-will), [Lunge](additionalMonsters/../feats#_lunge), [Mobility](additionalMonsters/../feats#_mobility), [Power Attack](additionalMonsters/../feats#_power-attack)

**Skills** [Acrobatics](additionalMonsters/../skills/acrobatics#_acrobatics) +21, [Bluff](additionalMonsters/../skills/bluff#_bluff) +22, [Diplomacy](additionalMonsters/../skills/diplomacy#_diplomacy) +22, [Intimidate](additionalMonsters/../skills/intimidate#_intimidate) +22, [Knowledge](additionalMonsters/../skills/knowledge#_knowledge) (planes) +21, [Knowledge](additionalMonsters/../skills/knowledge#_knowledge) (religion) +21, [Perception](additionalMonsters/../skills/perception#_perception) +25, [Sense Motive](additionalMonsters/../skills/senseMotive#_sense-motive) +25, [Stealth](additionalMonsters/../skills/stealth#_stealth) +14, [Survival](additionalMonsters/../skills/survival#_survival) +10
...
**[Fear](monsters/universalMonsterRules#_fear-(su-or-sp)) [Gaze](monsters/universalMonsterRules#_gaze) (Su)** Cower in [fear](monsters/universalMonsterRules#_fear-(su-or-sp)) for 1d6 rounds, 30 feet, Will DC 21 negates. This is a mind-affecting [fear](monsters/universalMonsterRules#_fear-(su-or-sp)) effect. The save DC is Charisma-based.

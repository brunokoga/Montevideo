---
layout: default
title: additionalMonster_dir/golem
---
# Golem, Adamantine
...
**Init** –1; **Senses** darkvision 60 ft., low-light vision; [Perception](additionalMonster_dir/../skill_dir/perception#_perception) +0
...
**Indestructible (Ex)** An adamantine golem is nearly impossible to destroy. Even if reduced below 0 hit points, its fast healing continues to restore hit points, though the golem is helpless unless above 0 hit points. It can only be permanently destroyed if reduced to negative hit points and then decapitated using an adamantine _ [vorpal](additionalMonster_dir/../magicItem_dir/weapons#_vorpal) _weapon—alternatively, _ [miracle](additionalMonsters/../spell_dir/miracle#_miracle)_ or _ [wish](additionalMonsters/../spell_dir/wish#_wish)_ can be used to slay it while it is at negative hit points.

**[Immunity](monsters/universalMonsterRules#_immunity-(ex-or-su)) to Magic (Ex)** An adamantine golem is immune to any spell or spell-like ability that allows spell [resistance](monster_dir/universalMonsterRules#_resistance), except as noted below.

• _ [Transmute metal to wood](additionalMonsters/../spell_dir/transmuteMetalToWood#_transmute-metal-to-wood)_ slows an adamantine golem for 1d4 rounds, during which time its damage reduction is reduced to 15/adamantine (no save).
...
**Requirements** [Craft Construct](additionalMonster_dir/../monster_dir/monsterFeats#_craft-construct), _crushing fist, [geas/quest](additionalMonster_dir/../spell_dir/geasQuest#_geas-quest), [heal](additionalMonsters/../spell_dir/heal#_heal), [stoneskin](additionalMonsters/../spell_dir/stoneskin#_stoneskin), [wish](additionalMonsters/../spell_dir/wish#_wish)_, creator must be caster level 20th; **Skill** [Craft](additionalMonsters/../skill_dir/craft#_craft) (sculpture) DC 35; **Cost** 350,000 gp
...
**Init** +4; **Senses** darkvision 60 ft., low-light vision; [Perception](additionalMonster_dir/../skill_dir/perception#_perception) +0
...
**[Immunity](monsters/universalMonsterRules#_immunity-(ex-or-su)) to Magic (Ex)** An alchemical golem is immune to spells or spell-like abilities that allow spell [resistance](monster_dir/universalMonsterRules#_resistance), save for spells with the sonic descriptor. _ [Shatter](additionalMonsters/../spell_dir/shatter#_shatter)_ damages an alchemical golem as if it were a crystalline creature.
...
•_ [Gentle repose](additionalMonsters/../spell_dir/gentleRepose#_gentle-repose)_ causes a carrion golem to become stiff and helpless for 1d4 rounds if it fails a Will save against the spell.
...
•Any magical attack that deals [cold](monsters/creatureTypes#_cold-subtype) or [fire](monster_dir/creatureTypes#_fire-subtype) damage slows a carrion golem (as the _ [slow](additionalMonsters/../spell_dir/slow#_slow)_ spell) for 2d6 rounds (no save).
...
**Requirements** [Craft Construct](additionalMonster_dir/../monster_dir/monsterFeats#_craft-construct), _ [animate dead](additionalMonsters/../spell_dir/animateDead#_animate-dead)_, _ [contagion](additionalMonsters/../spell_dir/contagion#_contagion)_, _ [false life](additionalMonsters/../spell_dir/falseLife#_false-life)_, _ [gentle repose](additionalMonsters/../spell_dir/gentleRepose#_gentle-repose)_, _ [lesser geas](additionalMonsters/../spell_dir/geasQuest#_geas-lesser)_, creator must be caster level 7th; **Skill** [Craft](additionalMonsters/../skill_dir/craft#_craft) (leather) or [Heal](additionalMonsters/../skill_dir/heal#_heal) DC 13; **Cost** 5,500 gp
...
•A _ [grease](additionalMonster_dir/../spell_dir/grease#_grease) _spell cast on the golem causes it to move quickly for 1d6 rounds, as if under the effects of _ [haste](additionalMonsters/../spell_dir/haste#_haste)._
...
•A _ [shatter](additionalMonster_dir/../spell_dir/shatter#_shatter)_ spell damages a glass golem as if it were a crystalline creature.

•A _ [keen edge](additionalMonsters/../spell_dir/keenEdge#_keen-edge)_ spell affects all of a glass golem's slam attacks as if they were slashing weapons.

•A magical attack that deals [cold](monsters/creatureTypes#_cold-subtype) damage slows a glass golem (as the _ [slow](additionalMonster_dir/../spell_dir/slow#_slow)_ spell) for 3 rounds (no saving throw).
...
**Reflect Spells (Ex)** As a free action once every 1d4 rounds, a glass golem can align its internal structure to enhance its [resistance](monsters/universalMonsterRules#_resistance) to magic for 1 round. During this time, the golem reflects spells (even spells that function differently against the golem as described in its immune to magic ability) as if under the effect of a _ [spell turning](additionalMonster_dir/../spell_dir/spellTurning#_spell-turning)_ spell.
...
**Requirements** [Craft Construct](additionalMonsters/../monster_dir/monsterFeats#_craft-construct), _ [animate objects](additionalMonsters/../spell_dir/animateObjects#_animate-objects)_, _ [flame strike](additionalMonsters/../spell_dir/flameStrike#_flame-strike)_, _ [geas/quest](additionalMonster_dir/../spell_dir/geasQuest#_geas-quest)_, _ [spell turning](additionalMonsters/../spell_dir/spellTurning#_spell-turning)_, creator must be caster level 10th; **Skill** [Craft](additionalMonsters/../skill_dir/craft#_craft) (sculptures) DC 17; **Cost** 17,000 gp (glass golem); 20,200 gp (stained glass golem)
...
**Init** +7; **Senses** darkvision 60 ft., low-light vision; [Perception](additionalMonster_dir/../skill_dir/perception#_perception) +0
...
**Feats** [Dodge](additionalMonsters/../feats#_dodge)B, [Mobility](additionalMonster_dir/../feats#_mobility)B, [Run](additionalMonster_dir/../feats#_run)B, [Spring Attack](additionalMonster_dir/../feats#_spring-attack)B
...
•A _ [slow](additionalMonster_dir/../spell_dir/slow#_slow) _spell cast on the golem causes it to lose its quickness ability for 1d6 rounds_._
...
**Requirements** [Craft Construct](additionalMonster_dir/../monster_dir/monsterFeats#_craft-construct), _ [animate objects](additionalMonsters/../spell_dir/animateObjects#_animate-objects), [geas/quest](additionalMonster_dir/../spell_dir/geasQuest#_geas-quest), [haste](additionalMonsters/../spell_dir/haste#_haste), [polymorph any object](additionalMonsters/../spell_dir/polymorphAnyObject#_polymorph-any-object), [wish](additionalMonsters/../spell_dir/wish#_wish)_, creator must be caster level 18th; **Skill** [Craft](additionalMonsters/../skill_dir/craft#_craft) (sculpture) DC 25; **Cost** 150,000 gp

---
title: additionalMonster_dir/dhampir
---
# Dhampir 
...
CE Medium [humanoid](monster_dir/creatureTypes#_humanoid) (dhampir)

**Init** +3; **Senses** darkvision 60 ft., low-light vision; [Perception](additionalMonsters/../skill_dir/perception#_perception) +1
...
**Defensive Abilities** [negative energy affinity](monster_dir/universalMonsterRules#_negative-energy-affinity), resist level drain
...
3/day—_ [detect undead](additionalMonster_dir/../spell_dir/detectUndead#_detect-undead)_
...
**Feats** [Toughness](additionalMonsters/../feats#_toughness), [Weapon Finesse](additionalMonster_dir/../feats#_weapon-finesse)

**Skills** [Bluff](additionalMonster_dir/../skill_dir/bluff#_bluff) +5, [Intimidate](additionalMonsters/../skill_dir/intimidate#_intimidate) +7, [Perception](additionalMonsters/../skill_dir/perception#_perception) +1, [Ride](additionalMonsters/../skill_dir/ride#_ride) +5, [Survival](additionalMonsters/../skill_dir/survival#_survival) +3; **Racial Modifiers** +2 [Bluff](additionalMonsters/../skill_dir/bluff#_bluff), +2 [Perception](additionalMonsters/../skill_dir/perception#_perception)
...
**Manipulative** : +2 racial bonus on [Bluff](additionalMonsters/../skill_dir/bluff#_bluff) and [Perception](additionalMonsters/../skill_dir/perception#_perception).

**Undead Resistance** : Dhampirs gain a +2 racial bonus on saving throws against disease and mind-affecting effects.

**Light Sensitivity, Negative Energy Affinity** : See universal monster rules.

**Spell-Like Ability** : A dhampir can use_ [detect undead](additionalMonsters/../spell_dir/detectUndead#_detect-undead)_ three times per day as a spell-like ability. The caster level for this ability equals the dhampir's class level.

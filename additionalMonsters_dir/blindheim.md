---
layout: default
title: additionalMonsters_dir/blindheim
---
# Blindheim
...
Init +2; **Senses** darkvision 60 ft., low-light vision; **[Perception](additionalMonsters_dir/../skills_dir/perception#_perception)** +9
...
**Special Attacks** blinding [gaze](monsters_dir/universalMonsterRules#_gaze)
...
**Feats** [Dodge](additionalMonsters_dir/../feats#_dodge), [Skill Focus](additionalMonsters_dir/../feats#_skill-focus) ( [Perception](additionalMonsters_dir/../skills_dir/perception#_perception))

**Skills** [Acrobatics](additionalMonsters_dir/../skills_dir/acrobatics#_acrobatics) +6 (+10 jumping), [Perception](additionalMonsters_dir/../skills_dir/perception#_perception) +9, [Swim](additionalMonsters_dir/../skills_dir/swim#_swim) +9; **Racial Modifiers** +4 [Acrobatics](additionalMonsters_dir/../skills_dir/acrobatics#_acrobatics) when jumping
...
**Blinding [Gaze](monsters_dir/universalMonsterRules#_gaze) (Ex)** A blindheim's eyes emit bright light to a range of 30 feet. Any creature within the area must make a DC 13 Fortitude save or be blinded for 1 hour. Blindheims can see normally in the light generated by their eyes, which illuminates a 30-foot spread with bright light. Creatures with light blindness or light sensitivity take the normal penalties within 30 feet of a blindheim that is using its blinding [gaze](monsters_dir/universalMonsterRules#_gaze). A blindheim can activate or suppress this ability as a free action. This save DC is Constitution-based.

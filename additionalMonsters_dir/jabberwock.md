---
title: additionalMonster_dir/jabberwock
---
# Jabberwock
...
CE Huge [dragon](monsters/creatureTypes#_dragon) ( [air](monster_dir/creatureTypes#_air-subtype), [fire](monsters/creatureTypes#_fire-subtype))

**Init** +5; **Senses** [blindsight](monster_dir/universalMonsterRules#_blindsight) 120 ft., darkvision 120 ft., low-light vision, [scent](monsters/universalMonsterRules#_scent), _ [true seeing](additionalMonster_dir/../spell_dir/trueSeeing#_true-seeing)_; [Perception](additionalMonsters/../skill_dir/perception#_perception) +38
...
**DR** 15/_ [vorpal](additionalMonster_dir/../magicItem_dir/weapons#_vorpal)_; **Immune** [fire](monsters/creatureTypes#_fire-subtype), paralysis, sleep; **Resist** acid 30, electricity 30, sonic 30; **SR** 31

**Weaknesses** [fear](monster_dir/universalMonsterRules#_fear-(su-or-sp)) of _ [vorpal](additionalMonsters/../magicItem_dir/weapons#_vorpal)_ weapons, vulnerable to [cold](monsters/creatureTypes#_cold-subtype)

Offense

**Speed** 40 ft., fly 80 ft. (poor)

**Melee** bite +37 (4d8+19/19–20/×3), 2 claws +37 (3d6+13/19–20 plus [grab](monster_dir/universalMonsterRules#_grab)), tail slap +32 (2d8+19), 2 wings +32 (1d8+6)
...
**Feats** [Awesome Blow](additionalMonster_dir/../monster_dir/monsterFeats#_awesome-blow), [Bleeding Critical](additionalMonsters/../feats#_bleeding-critical), [Critical Focus](additionalMonster_dir/../feats#_critical-focus), [Dodge](additionalMonster_dir/../feats#_dodge), [Flyby Attack](additionalMonster_dir/../monster_dir/monsterFeats#_flyby-attack), [Improved Bull Rush](additionalMonsters/../feats#_improved-bull-rush), [Improved Critical](additionalMonster_dir/../feats#_improved-critical) (bite, claws, eye rays), [Mobility](additionalMonster_dir/../feats#_mobility), [Power Attack](additionalMonster_dir/../feats#_power-attack), [Spring Attack](additionalMonster_dir/../feats#_spring-attack), [Vital Strike](additionalMonster_dir/../feats#_vital-strike)

**Skills** [Acrobatics](additionalMonster_dir/../skill_dir/acrobatics#_acrobatics) +31 (+35 jump), [Escape Artist](additionalMonsters/../skill_dir/escapeArtist#_escape-artist) +31, [Fly](additionalMonsters/../skill_dir/fly#_fly) +26, [Intimidate](additionalMonsters/../skill_dir/intimidate#_intimidate) +37, [Knowledge](additionalMonsters/../skill_dir/knowledge#_knowledge) (nature) +30, [Perception](additionalMonsters/../skill_dir/perception#_perception) +38, [Sense Motive](additionalMonsters/../skill_dir/senseMotive#_sense-motive) +38
...
**[Damage Reduction](monsters/universalMonsterRules#_damage-reduction-(ex-or-su)) (Ex)** A jabberwock's [damage reduction](monster_dir/universalMonsterRules#_damage-reduction-(ex-or-su)) can be bypassed only by weapons that possess the _ [vorpal](additionalMonsters/../magicItem_dir/weapons#_vorpal)_ weapon enhancement.
...
**[Fear](monster_dir/universalMonsterRules#_fear-(su-or-sp)) of Vorpal Weapons (Ex)** A jabberwock knows that a _ [vorpal](additionalMonsters/../magicItem_dir/weapons#_vorpal)_ weapon can kill it swiftly. As soon as it takes damage from a _ [vorpal](additionalMonsters/../magicItem_dir/weapons#_vorpal)_ weapon, a jabberwock becomes shaken for 1 round. If it is hit by a critical threat from a _ [vorpal](additionalMonsters/../magicItem_dir/weapons#_vorpal)_ weapon, whether or not the critical hit is confirmed, the jabberwock is staggered for 1 round.

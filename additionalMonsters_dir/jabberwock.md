...
CE Huge [dragon](monster_dir/creatureTypes#_dragon ( [air](monster_dir/creatureTypes#_air-subtype, [fire](monster_dir/creatureTypes#_fire-subtype)

**Init** +5; **Senses** [blindsight](monster_dir/universalMonsterRules#_blindsight 120 ft., darkvision 120 ft., low-light vision, [scent](monster_dir/universalMonsterRules#_scent, _ [true seeing](additionalMonsters/../spell_dir/trueSeeing#_true-seeing_; [Perception](additionalMonsters/../skill_dir/perception#_perception) +38
...
**DR** 15/_ [vorpal](additionalMonsters/../magicItem_dir/weapons#_vorpal_; **Immune** [fire](monster_dir/creatureTypes#_fire-subtype, paralysis, sleep; **Resist** acid 30, electricity 30, sonic 30; **SR** 31

**Weaknesses** [fear](monster_dir/universalMonsterRules#_fear-(su-or-sp) of _ [vorpal](additionalMonsters/../magicItem_dir/weapons#_vorpal_ weapons, vulnerable to [cold](monster_dir/creatureTypes#_cold-subtype)
...
**Ranged** 2 eye rays +29 touch (15d6 [fire](monster_dir/creatureTypes#_fire-subtype/19–20 plus burn)
...
**[Damage Reduction](monster_dir/universalMonsterRules#_damage-reduction-(ex-or-su)) (Ex** A jabberwock's [damage reduction](monster_dir/universalMonsterRules#_damage-reduction-(ex-or-su) can be bypassed only by weapons that possess the _ [vorpal](additionalMonsters/../magicItem_dir/weapons#_vorpal)_ weapon enhancement.

**Eye Rays (Su** The jabberwock can project beams of [fire](monster_dir/creatureTypes#_fire-subtype from its eyes as a ranged touch attack as a standard action, with a range increment of 60 feet. It projects two beams, and can target different creatures with these beams if it wishes as long as both targets are within 30 feet of each other. A creature that takes damage from an eye beam suffers burn.

**[Fear](monster_dir/universalMonsterRules#_fear-(su-or-sp)) of Vorpal Weapons (Ex** A jabberwock knows that a _ [vorpal](additionalMonsters/../magicItem_dir/weapons#_vorpal_ weapon can kill it swiftly. As soon as it takes damage from a _ [vorpal](additionalMonsters/../magicItem_dir/weapons#_vorpal_ weapon, a jabberwock becomes shaken for 1 round. If it is hit by a critical threat from a _ [vorpal](additionalMonsters/../magicItem_dir/weapons#_vorpal)_ weapon, whether or not the critical hit is confirmed, the jabberwock is staggered for 1 round.

**Planar Acclimation (Ex** A jabberwock is always considered to be on its home plane, regardless of what plane it finds itself upon. It never gains the [extraplanar](monster_dir/creatureTypes#_extraplanar-subtype) subtype.

---
title: mythicAdventure_dir/mythicItems/legendaryItems
---
# Legendary Items
...
[Legendary Artifacts](mythicAdventure_dir/mythicItems/legendaryItems#_legendary-artifacts) [Base Legendary Abilities](mythicAdventure_dir/mythicItems/legendaryItems#_base-legendary-abilities) [Legendary Item Abilities](mythicAdventure_dir/mythicItems/legendaryItems#_legendary-item-abilities)
...
_ [Fly](skill_dir/fly#_fly)_: The item gains a fly speed of 30 feet with average maneuverability. The item must have the animate ability to have this ability.
...
_Skill Ranks_: This item gains 10 ranks in one skill. This must be an Intelligence-, Wisdom-, or Charisma-based skill, unless the item has the animate ability (allowing it to choose [Acrobatics](skill_dir/acrobatics#_acrobatics)) or the fly ability (allowing it to choose [Fly](skills/fly#_fly)).
...
_ [Teleport](spell_dir/teleport#_teleport)_: Once per day, the item can _ [teleport](spells/teleport#_teleport)_ as the spell. It must have either the spellcasting ability or the fly ability to have this ability.

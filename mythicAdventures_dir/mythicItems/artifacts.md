---
title: mythicAdventure_dir/mythicItems/artifacts
---
# Artifacts
...
[Minor Artifacts](mythicAdventure_dir/mythicItems/artifacts#_minor-artifacts) [Major Artifacts](mythicAdventure_dir/mythicItems/artifacts#_major-artifacts)
...
_Blade of Courage_: All allies within the area of effect are treated as if affected by of a _ [blessing of courage and life](advanced/spell_dir/blessingOfCourageAndLife#_blessing-of-courage-and-life)_ spell.

_Blade of Castigation_: All opponents within the area fall to their knees as if affected by a _ [castigate](advanced/spell_dir/castigate#_castigate)_ spell.

_Blade of Despair_: All opponents within the area of effect that hear the sound become saddened as if affected by a _ [crushing despair](spells/crushingDespair#_crushing-despair) _spell.
...
_Blade of Rage_: All opponents within the area of effect that hear the sound become enraged as if affected by a _ [rage](spells/rage#_rage) _spell.
...
The graft wearer can expend one use of mythic power to gain telepathy with a range of 100 feet for 2 hours (_Bestiary_ 300) or cast any of the following spells: _ [chaos hammer](spells/chaosHammer#_chaos-hammer), [confusion](spell_dir/confusion#_confusion), [dispel magic](spells/dispelMagic#_dispel-magic), [mirror image](spell_dir/mirrorImage#_mirror-image), [reverse gravity](spells/reverseGravity#_reverse-gravity), _or _ [true seeing](spell_dir/trueSeeing#_true-seeing)_.

By expending two uses, he can cast _ [greater teleport](spells/teleport#_teleport-greater)_ (self plus 50 pounds of objects only), _ [veil](spell_dir/veil#_veil) _(self only), or _ [unholy blight](spells/unholyBlight#_unholy-blight)._
...
By expending one use of mythic power and using the flask as part of a [Craft](skills/craft#_craft) check, the user can halve the cost of materials needed to create an alchemical item or poison. This doesn't apply to the creation of alchemical essence.
...
- As a standard action, the bearer can use _ [plane shift](spell_dir/planeShift#_plane-shift)_ to move herself and up to seven other willing creatures to any plane she is familiar with by expending one use of mythic power. If traveling to a location she's already visited, she can reduce the inaccuracy of _ [plane shift](spells/planeShift#_plane-shift) _by expending two uses of mythic power when she does so, in which case she appears 1d6–1 miles (minimum 0 miles) from her destination.
...
- As a standard action, the bearer can expend two uses of mythic power to create a widened _ [dimensional lock](spells/dimensionalLock#_dimensional-lock)_ centered on the crystal instead of on a point in space. The lock lasts for 24 hours or until dismissed.
...
A _nexus crystal_ can be destroyed by invoking its _ [plane shift](spells/planeShift#_plane-shift)_ power as the bearer steps through a _ [gate](spell_dir/gate#_gate)_. Doing so destroys the crystal and the _ [gate](spells/gate#_gate)_, and the resulting magical explosion causes 18d10 points of damage to creatures within a 2-mile-radius burst of either side of the _ [gate](spell_dir/gate#_gate)_ (Reflex DC 27 for half damage). Permanent gates between planes could potentially be destroyed in this fashion, at the GM's discretion.
...
When used as a weapon, the _rod of spell sundering_ functions as a masterwork light mace. On a successful attack, it targets the creature struck with _ [greater dispel magic](spells/dispelMagic#_dispel-magic-greater)_, with a caster level equal to its bearer's character level plus her mythic tier. This effect can also be delivered with a successful melee touch attack made using the rod.

Destruction

A _rod of spell sundering_ can be destroyed by leaving it within an area devoid of all magic for a year and a day. After this, it must be broken across the knee of a spellcaster formerly capable of casting at least 5th-level spells who lost her powers by using _ [mage's disjunction](spell_dir/mageSDisjunction#_mage-s-disjunction)_ on an artifact.

Screaming Spear of the Sun

**Slot** none; **CL** 20th; **Weight** 4 lbs.; **Aura** strong divination and enchantment

This _+4 [wounding](magicItems/weapons#_wounding) [throwing](magicItem_dir/weapons#_throwing) longspear_ has a 2-foot-long iron spearhead covered with over 30 cruel flesh barbs. On a critical hit, the barbs lodge in the victim's flesh and can be removed only by tearing the blade free. Yanking the blade free is a full-round action that requires a successful Strength check with a DC equal to the attack roll that struck the critical hit, and deals 3d6 points of damage to the victim.

In the hands of a mythic creature, the spear gains the _ [returning](magicItems/weapons#_weapons-returning)_ special ability, and when thrown seemingly comes alive, screaming wickedly as it flies. When it hits a creature, it radiates _ [fear](spell_dir/fear#_fear)_ (as the spell) in a 60-foot-radius burst surrounding the creature struck.
...
- _ [Arcane lock](spells/arcaneLock#_arcane-lock)_
- _ [Arcane sight](spell_dir/arcaneSight#_arcane-sight)_
- _ [Daylight](spells/daylight#_daylight)_
- _ [Knock](spell_dir/knock#_knock)_
- _ [Mage armor](spells/mageArmor#_mage-armor)_
- _ [Mage hand](spell_dir/mageHand#_mage-hand)_
- _ [Touch of idiocy](spells/touchOfIdiocy#_touch-of-idiocy)_

The following powers drain 1 charge per use:

- _ [Black tentacles](spell_dir/blackTentacles#_black-tentacles)_
- _ [Cone of cold](spells/coneOfCold#_cone-of-cold)_ (15d6 damage, Reflex DC 20 half)
- _ [Fireball](spell_dir/fireball#_fireball)_ (10d6 damage, Reflex DC 18 half)
- _ [Greater dispel magic](spells/dispelMagic#_dispel-magic-greater)_
- _ [Greater invisibility](spell_dir/invisibility#_invisibility-greater)_
- _ [Greater teleport](spells/teleport#_teleport-greater)_
- _ [Lightning arc](ultimateMagi_dir/spells/lightningArc#_lightning-arc)_ (15d6 damage, Reflex DC 20 half)
- _ [Major image](spell_dir/majorImage#_major-image)_ (Will DC 18 disbelief)
- _ [Suggestion](spells/suggestion#_suggestion)_ (Will DC 18 negates)
...
- _ [Plane shift](spells/planeShift#_plane-shift)_ (Will DC 22 negates, arrive 2 to 200 miles from the intended destination)
- _ [Prismatic sphere](spell_dir/prismaticSphere#_prismatic-sphere)_ (DC 24)
- _ [Prismatic spray](spells/prismaticSpray#_prismatic-spray)_ (DC 22)
...
This simple neck ring consists of a silver braid with matching ivory ends sculpted to resemble wolf's heads. The torc allows itself to be worn by only a mythic character who swears absolute service to his deity. Thereafter, the torc cannot be removed until its wearer dies. The wearer gains an enhancement bonus to his Charisma score equal to half his tier (minimum 1). Once per day, he can use the torc to cast _ [commune](spells/commune#_commune) _for the purpose of contacting his deity. Lastly, he can expend one use of his mythic power to cast _ [legend lore](spell_dir/legendLore#_legend-lore)._

If the wearer violates his deity's code of ethics, the torc constricts and begins suffocating him until he dies or receives an _ [atonement](spells/atonement#_atonement)_ spell.
...
A mythic character can use a _witherfang's _stolen mythic power to activate her own mythic abilities or to enhance the blade with the following abilities: _ [bane](magicItem_dir/weapons#_weapons-bane)_, _ [dancing](magicItems/weapons#_weapons-dancing)_, _ [speed](magicItem_dir/weapons#_weapons-speed)_, and _ [wounding](magicItems/weapons#_wounding)_. Each ability lasts for 24 hours, and only one can be applied to the blade within each 24-hour period. The wielder can increase _the witherfang's_ enhancement bonus by 1 for each use of mythic power she expends. Alternately, the wielder can expend one use of mythic power to imbue the blade with the _ [bane](magicItem_dir/weapons#_weapons-bane)_ special ability, two uses to imbue it with the _ [wounding](magicItems/weapons#_wounding) _special ability, three uses to imbue it with the _ [speed](magicItem_dir/weapons#_weapons-speed)_ special ability, or four uses to imbue it with the _ [dancing](magicItems/weapons#_weapons-dancing)_ special ability.
...
Only a creature bearing the _Apocalypse Box's _curse can open it. Once per day, the cursed creature can open the box and draw forth a single item her heart desires. The item must be nonmagical, weigh no more than 50 pounds, and be worth no more than 50,000 gp, but is otherwise limited only by the parameters of the _ [wish](spell_dir/wish#_wish)_ spell. A mythic character can expend two uses of mythic power to draw forth a second such item each day.

Each time the _Apocalypse Box_ is opened, there is a 50% chance that instead of granting a _ [wish](spells/wish#_wish)_, the box summons a number of horrific monsters that immediately attack anyone in sight and remain to wreak havoc on the Material Plane for 1 week before returning to their plane of origin. Roll on Table 5–1 below to determine the monsters that appear.
...
This _+6 [keen](magicItems/weapons#_weapons-keen) [speed](magicItem_dir/weapons#_weapons-speed) adamantine dagger_ was constructed in defiance of the gods and their chosen mortal champions, for _Legendsbane_ was created to slay mythic creatures. _Legendsbane_ bypasses all types of damage reduction, and deals an additional 3d6 points of damage to mythic creatures and to non-mythic creatures that have epic DR. This additional damage is multiplied for critical hits.

Non-mythic characters can wield _Legendsbane_ normally. However, when a mythic character first attempts to wield the dagger, she must succeed at a DC 25 Fortitude save or suffer the effects of a _ [destruction](spells/destruction#_destruction)_ spell. If the mythic character survives, she can wield the dagger normally.

_Legendsbane_ imparts upon its wielder the ability to track down mythic creatures she has hunted before. At will, the wielder can cast _ [locate creature](spell_dir/locateCreature#_locate-creature)_ to find a specific mythic creature known to the wielder.

Destruction

_Legendsbane_ can be destroyed if it's anointed in the blood of a slain 10th-rank mythic creature and then struck three times by a _ [vorpal](magicItems/weapons#_vorpal)_ weapon. This act also destroys the _ [vorpal](magicItem_dir/weapons#_vorpal)_ weapon.
...
The _Nimbus of Radiant Truth _exists only when good has need of a great champion. Such a champion can attain it only though a perilous quest that tests mettle and righteousness. Rather than being a physical object, the _Nimbus of Radiant Truth _manifests as a glowing halo of light around the wearer's head. It's ordinarily as bright as _ [continual flame](spell_dir/continualFlame#_continual-flame)_, but in battle it brightens to the dazzling brilliance of _ [daylight](spells/daylight#_daylight)_. Its radiance is treated as resulting from a 9th-level spell for purposes of interaction with other sources of light and darkness. The radiance of the nimbus can be suppressed or resumed as a standard action.
...
- Seven times per day, the wearer can _ [cure moderate wounds](spells/cureModerateWounds#_cure-moderate-wounds)_ as a cleric with a caster level equal to her character level. The wearer adds her mythic tier to the hit points healed.
- Three times per day, the wearer can unleash a _ [holy aura](spell_dir/holyAura#_holy-aura)_ (DC 25) or an empowered _ [holy smite](spells/holySmite#_holy-smite)_ (DC 22).
...
- Once per week, the wearer can expend one use of mythic power to perform a _ [resurrection](spells/resurrection#_resurrection)_.
...
- The host can use _ [contagion](spells/contagion#_contagion)_ heightened to 8th level (DC 23) at will.
- The host can use empowered _ [vampiric touch](spell_dir/vampiricTouch#_vampiric-touch) _three times per day.
- As a swift action, the host can expend one use of mythic power to gain the effects of _ [death ward](spells/deathWard#_death-ward)_, _ [divine power](spell_dir/divinePower#_divine-power)_, and _ [spell resistance](magicItems/armor#_armor-spell-resistance)_. These effects last 1 round per tier he possesses and can't be dispelled.
...
_Plaguebringer_ can leave a host by becoming dominant and choosing to leave. Immediately after it leaves, the host is affected by multiple _ [contagion](spells/contagion#_contagion)_ effects (DC 30), one for each of the diseases listed in the spell.
...
Once bonded, the scepter can be wielded as a _+6 [brilliant energy](magicItem_dir/weapons#_weapons-brilliant-energy) [light](spells/light#_light) mace_ that grants a +4 enhancement bonus to its bonded owner's Charisma score. In addition, the owner can expend one use of mythic power and ring the scepter's bells to produce the following effects:

- The wielder can ring the bell of authority to cast _ [command](spell_dir/command#_command)_ targeting any non-mythic creature.
- The wielder can ring the bell of banishment to cast _ [dismissal](spells/dismissal#_dismissal)_ upon any non-mythic outsider with a CR at least 3 less than the wielder's total class level plus her tier.
- The wielder can ring the bell of dominion to cast _ [sanctuary](spell_dir/sanctuary#_sanctuary)_ on any non-mythic creature.
- The wielder can ring the bell of imprisonment to cast _ [forcecage](spells/forcecage#_forcecage)_ on any non-mythic creature with a CR at least 3 less than the wielder's total class level plus her tier.
...
Implanting the _Shadowwraith Heart_ into the chest of a dying mythic hero reanimates the heart, restoring the hero as the _ [heal](spells/heal#_heal)_ spell (CL 15th), though the hero loses all mythic tiers.
...
- At will, the wearer can use _ [greater invisibility](spell_dir/invisibility#_invisibility-greater)_ as a spell-like ability for as long a duration as desired.
...
- Three times per day, the wearer can use _ [greater teleport](spells/teleport#_teleport-greater)_, exactly as if he had cast the spell of the same name. The wearer can teleport additional times by expending one use of mythic power per teleport.

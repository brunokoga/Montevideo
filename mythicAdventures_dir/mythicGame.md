---
layout: default
title: mythicAdventure_dir/mythicGame
---
...
To adjust a character's level, add half his tier (minimum 1) to his total character level. So a 10th-leve_dir/5th-tier character is effectively a 12th-level character for challenge and reward purposes, and a 20th-level/10th-tier character is effectively a 25th-level character for those purposes.
...
**Calm Down** : The character ends or prevents a combat against a mythic foe with a single skill check, most likely [Diplomacy](skill_dir/diplomacy#_diplomacy) or [Bluff](skills/bluff#_bluff).
...
**Tumbler** : In 1 round, the character uses [Acrobatics](skills/acrobatics#_acrobatics) to move through the threatened areas of at least five foes without provoking any attacks of opportunity.
...
Noncombat encounters help players develop a connection between their PCs and the villain in a way that doesn't risk the villain's life (or the PCs'). Early on, she can appear as a harmless or even helpful NPC. Or, if the PCs have already fought the villain, she can leave notes or use magic to taunt them. Various mythic powers, the [Disguise](skill_dir/disguise#_disguise) skill, or even simple magic like _ [disguise self](spells/disguiseSelf#_disguise-self)_, _ [glibness](spell_dir/glibness#_glibness)_, or _ [nondetection](spells/nondetection#_nondetection)_ can be used to help a villain blend in and rub elbows with the heroes all while seeming innocuous. Later, once the villain is revealed, she can work behind the scenes, using minions and other allies to accomplish her ends, all the while making it plain to the PCs that she's continuing to thwart them.

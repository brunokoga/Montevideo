...
To adjust a foe's CR, add half its tier or rank (minimum 1) to its CR. So a 2nd-rank minotaur is effectively a CR 6 monster, while a 6th-tier champion pit fiend would be CR 23. For [mythic monsters](mythicAdventures/mythicMonsters), this calculation has already been made.
...
**Calm Down** : The character ends or prevents a combat against a mythic foe with a single skill check, most likely [Diplomacy](skills/diplomacy#_diplomacy) or [Bluff](skills/bluff#_bluff).
...
**Outrageous Lie** : Using [Bluff](skills/bluff#_bluff), the character convinces a creature of a nearly impossible lie (–20 modifier to the check).
...
Should the villain be killed, don't be afraid to have her revisit your campaign for a little posthumous mockery and mayhem. There are many ways to reintroduce a dead villain—sometimes it's as simple as having a minion cast _ [raise dead](spells/raiseDead#_raise-dead) _or_ [resurrection](spells/resurrection#_resurrection)_, but there are other, more sophisticated options. You can introduce a new recurring villain who tracks down one of the PCs' dead foes and brings him to some semblance of life in the form of an undead minion or possessed item, or who uses _ [speak with dead](spells/speakWithDead#_speak-with-dead)_ to learn the deceased foe's secrets.

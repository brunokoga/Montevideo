...
**Source** [_detect scrying_](spell_dir/detectScrying#_detect-scrying

This spell automatically gives you a visual image of the creature scrying you. If it's using a non-mythic means of scrying, you also gain an accurate sense of its direction and distance from you. You automatically succeed at caster level checks to overcome _ [nondetection](spell_dir/nondetection#_nondetection_ or similar effects (other than _ [mind blank](spell_dir/mindBlank#_mind-blank)_) that block your ability to detect the creature.

---
layout: default
title: mythicAdventure_dir/mythicSpells/web
---
Web

**Source** [_web_](spell_dir/web#_web)
...
**Augmented (5th)** : If you expend two uses of mythic power, the webs increase to a 50-foot-radius spread. Webs span any gaps between available anchor points in the area, possibly creating multiple non-contiguous webbed areas. Non-mythic abilities that make creatures immune to webs (such as _ [freedom of movement](spells/freedomOfMovement#_freedom-of-movement)_) instead give them a +5 bonus on saves, combat maneuver checks, and [Escape Artist](skill_dir/escapeArtist#_escape-artist) checks against _mythic web_.

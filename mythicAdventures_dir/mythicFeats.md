...
| Valiant Vault (Mythic) | [Mounted Combat](feats#_mounted-combat), [Ride-By Attack](feats#_ride-by-attack), [Ride](skills/ride#_ride) 5 ranks | When mount leaps over foes attack as you pass |

| Mythic Enhancement Feats | Prerequisites | Benefits |
| --- | --- | --- |
| Accursed Hex (Mythic) | [Accursed Hex](ultimateMagic/ultimateMagicFeats#_accursed-hex) | Target [Accursed Hex](ultimateMagic/ultimateMagicFeats#_accursed-hex) must roll second save twice and take lower result |
...
| Alertness (Mythic) | [Alertness](feats#_alertness) | Gain an additional +2 bonus on [Perception](skills/perception#_perception) and [Sense Motive](skills/senseMotive#_sense-motive) checks, and expend mythic power to treat one of these checks as if you rolled a 20 |
...
| Animal Affinity (Mythic) | [Animal Affinity](feats#_animal-affinity) | Gain an additional +2 bonus on [Handle Animal](skills/handleAnimal#_handle-animal) and [Ride](skills/ride#_ride) checks, and expend mythic power to use _ [speak with animals](spells/speakWithAnimals#_speak-with-animals)_ |
...
| Arcane Shield (Mythic) | [Arcane Shield](advanced/advancedFeats#_arcane-shield) | Add 1/2 your mythic tier to the bonus granted by [Arcane Shield](advanced/advancedFeats#_arcane-shield), and expend mythic power to extend the shield's duration |
...
| Athletic (Mythic) | [Athletic](feats#_athletic) | Gain an additional +2 bonus on [Climb](skills/climb#_climb) and [Swim](skills/swim#_swim) checks, and expend mythic power to treat one of these checks as if you rolled a 20 |
| Augment Summoning (Mythic) | [Augment Summoning](feats#_augment-summoning) | Summoned creatures are considered mythic |
| Bleeding Critical (Mythic) | [Bleeding Critical](feats#_bleeding-critical), [Critical Focus](mythicAdventures/mythicFeats#_critical-focus) | Bleed damage and the DC to staunch it increases by mythic tier |
...
| Critical Focus (Mythic) | [Critical Focus](feats#_critical-focus) | Automatically confirm critical hits against non-mythic foes and increased chance to bypass _ [fortification](magicItems/armor#_armor-fortification)_ |
...
| Dastardly Finish (Mythic) | [Dastardly Finish](advanced/advancedFeats#_dastardly-finish) | Coup de grace dazed and staggered non-mythic foes |
...
| Deceitful (Mythic) | [Deceitful](feats#_deceitful) | Gain an additional +2 bonus on [Bluff](skills/bluff#_bluff) and [Disguise](skills/disguise#_disguise), and expend mythic power to treat one of these checks as if you rolled a 20 |
| Deepsight (Mythic) | [Deepsight](advanced/advancedFeats#_deepsight) | Darkvision increases by 10 ft. per mythic tier |
...
| Deft Hands (Mythic) | [Deft Hand](feats#_deft-hand) | Gain an additional +2 bonus on [Disable Device](skills/disableDevice#_disable-device) and [Sleight of Hand](skills/sleightOfHand#_sleight-of-hand), and expend mythic power to treat one of these checks as if you rolled a 20 |
| Detect Expertise (Mythic) | [Detect Expertise](ultimateMagic/ultimateMagicFeats#_detect-expertise) | Gain the benefit of [Detect Expertise](ultimateMagic/ultimateMagicFeats#_detect-expertise) immediately |
| Disruptive (Mythic) | [Disruptive](feats#_disruptive) | Increase the DC to cast spells defensively within your threatened area |
| Distance Thrower (Mythic) | Str 17, [Distance Thrower](ultimateCombat/ultimateCombatFeats#_distance-thrower) | Throw weapons twice the normal range |
...
| Dreadful Carnage (Mythic) | [Dreadful Carnage](advanced/advancedFeats#_dreadful-carnage) | Your carnage has a greater effect against non-mythic foes and expend mythic power to frighten foes |
| Eagle Eyes (Mythic) | [Eagle Eyes](advanced/advancedFeats#_eagle-eyes) | Ignore [Perception](skills/perception#_perception) distance penalties |
...
| Elemental Fist (Mythic) | [Elemental Fist](advanced/advancedFeats#_elemental-fist) | Increase damage and frequency of [Elemental Fist](advanced/advancedFeats#_elemental-fist) |
| Elemental Focus (Mythic) | [Elemental Focus](advanced/advancedFeats#_elemental-focus) | Increase the DCs and expend mythic power to force opponents to roll twice and take the lowest result when saving against focus spells |
...
| Fast Empathy (Mythic) | [Fast Empathy](ultimateMagic/ultimateMagicFeats#_fast-empathy) | Use wild empathy as a swift action |
| Fire Music (Mythic) | [Fire Music](ultimateMagic/ultimateMagicFeats#_fire-music) | [Fire Music](ultimateMagic/ultimateMagicFeats#_fire-music) ignores fire resistance based on tier |
| Fleet (Mythic) | [Fleet](feats#_fleet) | Land speed increases by 5 feet regardless of armor or encumbrance |
| Furious Focus (Mythic) | [Furious Focus](advanced/advancedFeats#_furious-focus) | Ignore [Power Attack](feats#_power-attack) penalties when using [Furious Focus](advanced/advancedFeats#_furious-focus) |
...
| Guided Hand (Mythic) | [Guided Hand](ultimateCombat/ultimateCombatFeats#_guided-hand) | Apply Wisdom bonus instead of Strength or Dexterity bonus on favored weapon damage |
...
| Heroic Recovery (Mythic) | [Heroic Recovery](advanced/advancedFeats#_heroic-recovery) | Expend mythic power to save again against a condition or affliction |
...
| Improved Drag (Mythic) | [Improved Drag](advanced/advancedFeats#_improved-drag) | Gain a bonus on drags based on mythic tier |
...
| Improved Steal (Mythic) | [Improved Steal](advanced/advancedFeats#_improved-steal) | Gain a bonus on steals based on mythic tier |
| Improved Stonecunning (Mythic) | [Improved Stonecunning](advanced/advancedFeats#_improved-stonecunnin) | Gain _ [stone tell](spells/stoneTell#_stone-tell)_ as a spell-like ability |
...
| Knockout Artist (Mythic) | [Knockout Artist](ultimateCombat/ultimateCombatFeats#_knockout-artist) | Use d8s for sneak attacks with unarmed strike nonlethal damage |
...
| Magical Aptitude (Mythic) | [Magical Aptitude](feats#_magical-aptitude) | Gain an additional +2 bonus on [Spellcraft](skills/spellcraft#_spellcraft) and [Use Magic Device](skills/useMagicDevice#_use-magic-device), and expend mythic power to treat one of these checks as if you rolled a 20 |
...
| Missile Shield (Mythic) | [Missile Shield](advanced/advancedFeats#_missile-shield) | Deflect a number of ranged attacks equal to 1/2 your mythic tier |
| Mobility (Mythic) | [Mobility](feats#_mobility) | Gain a +6 bonus instead of +4 and when an attack misses move 5 feet |
| Monastic Legacy (Mythic) | [Monastic Legacy](ultimateCombat/ultimateCombatFeats#_monastic-legacy) | Add 1/2 your non-monk class levels to determine AC bonus, and expend mythic power to increase your unarmed strike damage and AC bonus |
...
| Persuasive (Mythic) | [Persuasive](feats#_persuasive) | Gain an additional +2 bonus on [Diplomacy](skills/diplomacy#_diplomacy) and [Intimidate](skills/intimidate#_intimidate), and expend mythic power to treat one of these checks as if you rolled a 20 |
...
| Powerful Shape (Mythic) | [Powerful Shape](ultimateMagic/ultimateMagicFeats#_powerful-shape) | Apply the giant simple template to wild shape |
| Prophetic Visionary (Mythic) | [Prophetic Visionary](ultimateMagic/ultimateMagicFeats#_prophetic-visionary) | Use _ [augury](spells/augury#_augury)_ at will |
...
| Rapid Reload (Mythic) | [Rapid Reload](ultimateCombat/ultimateCombatFeats#_rapid-reload) | Reload all weapons faster |
| Rapid Shot (Mythic) | [Rapid Shot](feats#_rapid-shot) | Ignore the –2 penalty or make two additional attacks |
| Rhetorical Flourish (Mythic) | [Rhetorical Flourish](ultimateCombat/ultimateCombatFeats#_rhetorical-flourish) | Increase the bonus on [Diplomacy](skills/diplomacy#_diplomacy) checks based on mythic tier |
...
| Scorpion Style (Mythic) | [Scorpion Style](feats#_scorpion-style) | Add mythic tier to duration or _ [slow](spells/slow#_slow)_ your target |
...
| Self-Sufficient (Mythic) | [Self-Sufficient](feats#_self-sufficient) | Gain an additional +2 bonus on [Heal](skills/heal#_heal) and [Survival](skills/survival#_survival), and expend mythic power to treat one of these checks as if you rolled a 20 |
...
| Sociable (Mythic) | [Sociable](advanced/advancedFeats#_sociable) | Increase the bonus on [Diplomacy](skills/diplomacy#_diplomacy) or gain the normal bonus without an action |
...
| Spontaneous Metafocus (Mythic) | [Spontaneous Metafocus](ultimateMagic/ultimateMagicFeats#_spontaneous-metafocus) | Change the spells of your metafocus each morning |
| Spring Attack (Mythic) | [Spring Attack](feats#_spring-attack), base attack bonus +6 | Make first attack before moving |
| Stealthy (Mythic) | [Stealthy](feats#_stealthy) | Gain an additional +2 bonus on [Escape Artist](skills/escapeArtist#_escape-artist) and [Stealth](skills/stealth#_stealth), and expend mythic power to treat one of these checks as if you rolled a 20 |
...
| Tripping Staff (Mythic) | [Tripping Staff](ultimateMagic/ultimateMagicFeats#_tripping-staff) | Your CMD against trips is increased based on tier and those who trip you and fail provoke an attack of opportunity from you |
...
| Voice of the Sibyl (Mythic) | [Voice of the Sibyl](ultimateMagic/ultimateMagicFeats#_voice-of-the-sibyl) | Increase [Bluff](skills/bluff#_bluff), [Diplomacy](skills/diplomacy#_diplomacy), and [Perform](skills/perform#_perform) (oratory) skill bonus based on mythic tier |
| Warrior Priest (Mythic) | [Warrior Priest](ultimateMagic/ultimateMagicFeats#_warrior-priest) | Increase bonus on initiative and concentration checks based on mythic tier |
...
**Prerequisite** : [Accursed Hex](ultimateMagic/ultimateMagicFeats#_accursed-hex).
...
**Benefit** : The bonus on [Acrobatics](skills/acrobatics#_acrobatics) and [Fly](skills/fly#_fly) skill checks from [Acrobatic](feats#_acrobatic) increases by 2. In addition, you can expend one use of mythic power to treat an [Acrobatics](skills/acrobatics#_acrobatics) or [Fly](skills/fly#_fly) check as if you had rolled a natural 20. You must decide to use this ability before making the roll.
...
**Benefit** : The bonus on [Handle Animal](skills/handleAnimal#_handle-animal) and [Ride](skills/ride#_ride) skill checks from [Animal Affinity](feats#_animal-affinity) increases by 2. In addition, you can expend one use of mythic power to _ [speak with animals](spells/speakWithAnimals#_speak-with-animals) _as the spell. Your caster level for this effect is equal to twice your tier.
...
**Benefit** : When you use [Arcane Blast](advanced/advancedFeats#_arcane-blast), you may halve the damage dice to also perform your choice of either a trip or bull rush combat maneuver against the target of the blast. You can't move with an opponent you bull rush with this feat. You gain a bonus on your combat maneuver check for this attempt equal to half the spell level of the spell you sacrificed when using [Arcane Blast](advanced/advancedFeats#_arcane-blast), and you can substitute your Intelligence or Charisma modifier in place of your Strength modifier when determining your combat maneuver bonus.

In addition, you can expend one use of mythic power to change the damage dice of your [Arcane Blast](advanced/advancedFeats#_arcane-blast) to d8s instead of d6s.
...
**Benefit** : You add half your tier to the deflection bonus granted to your AC when you use your [Arcane Shield](advanced/advancedFeats#_arcane-shield). You can expend one use of mythic power when using this feat to extend the duration to a number of rounds equal to your tier.
...
_Mythic Leap (Ex)_: You can make a running jump without needing to run 10 feet beforehand. In addition, you gain a +5 bonus on your [Acrobatics](skills/acrobatics#_acrobatics) checks to determine the success of that jump and the distance covered. If you already have the predator's leap manifestation of [Aspect of the Beast](advanced/advancedFeats#_aspect-of-the-beast), the bonus on your [Acrobatics](skills/acrobatics#_acrobatics) checks increases to +10.

_Mythic Instinct (Ex)_: You gain a +2 bonus on initiative checks and a +2 bonus on [Survival](skills/survival#_survival) checks. These bonuses stack with those gained from the wild instinct manifestation of [Aspect of the Beast](advanced/advancedFeats#_aspect-of-the-beast).
...
**Benefit** : The bonus on [Climb](skills/climb#_climb) and [Swim](skills/swim#_swim) skill checks from [Athletic](feats#_athletic) increases by 2. In addition, you can expend one use of mythic power to treat a [Climb](skills/climb#_climb) or [Swim](skills/swim#_swim) check as if you had rolled a natural 20. You must decide to use this ability before making the roll.
...
**Benefit** : The bleed damage dealt with Bleeding Critical increases by your tier. Stopping this bleed damage requires a [Heal](skills/heal#_heal) check with a DC equal to 15 + 1/2 your tier. Any magical healing ends the bleed damage normally.
...
**Prerequisite** : [Charge Through](advanced/advancedFeats#_charge-through).
...
**Benefit** : You automatically confirm critical threats against non-mythic opponents. In addition, when you threaten a critical hit against a creature wearing armor with the _ [fortification](magicItems/armor#_armor-fortification)_ special ability or similar effect, that creature must roll twice and take the worse result when determining critical hit negation.
...
**Benefit** : While wielding the weapon with which you have [Weapon Focus](feats#_weapon-focus), you can use Dazzling Display as a standard action with a –5 penalty on your [Intimidate](skills/intimidate#_intimidate) check, as a move action with a –10 penalty, or as a swift action with a –20 penalty. You can expend one use of mythic power when you make a Dazzling Display to make those affected by the display frightened rather than shaken.
...
**Benefit** : The bonus on [Bluff](skills/bluff#_bluff) and [Disguise](skills/disguise#_disguise) skill checks from [Deceitful](feats#_deceitful) increases by 2. In addition, you can expend one use of mythic power to treat a [Bluff](skills/bluff#_bluff) or [Disguise](skills/disguise#_disguise) check as if you had rolled a natural 20. You must decide to use this ability before making the roll.

Deepsight (Mythic)

Your sharp eyes can penetrate deeper into the darkness, revealing more to you.

**Prerequisite** : [Deepsight](advanced/advancedFeats#_deepsight).
...
**Benefit** : The bonus on [Disable Device](skills/disableDevice#_disable-device) and [Sleight of Hand](skills/sleightOfHand#_sleight-of-hand) skill checks from [Deft Hands](feats#_deft-hands) increases by 2. In addition, you can expend one use of mythic power to treat a [Disable Device](skills/disableDevice#_disable-device) or [Sleight of Hand](skills/sleightOfHand#_sleight-of-hand) check as if you had rolled a natural 20. You must decide to use this ability before making the roll.
...
**Benefit** : You gain the benefit of [Detect Expertise](ultimateMagic/ultimateMagicFeats#_detect-expertise) immediately (without needing to observe a creature for 3 rounds) when using the divinations listed in [Detect Expertise](ultimateMagic/ultimateMagicFeats#_detect-expertise). Non-mythic creatures cannot attempt a Will save to resist this effect.
...
**Prerequisites** : Str 17, [Distance Thrower](ultimateCombat/ultimateCombatFeats#_distance-thrower).
...
**Benefit** : When you use [Divine Interference](ultimateMagic/ultimateMagicFeats#_divine-interference), the penalty on your opponent's attack roll is equal to twice the level of the spell sacrificed. You can expend one use of mythic power when you sacrifice the spell to increase the penalty to triple the level of the spell sacrificed.
...
**Benefit** : When you use [Dreadful Carnage](advanced/advancedFeats#_dreadful-carnage), you affect non-mythic enemies within 60 feet in addition to all enemies within 30 feet. You can expend one use of mythic power before making the [Intimidate](skills/intimidate#_intimidate) check to cause enemies demoralized by [Dreadful Carnage](advanced/advancedFeats#_dreadful-carnage) to become frightened instead of shaken, for the same duration as the normal shaken effect. While frightened by this ability, an enemy takes a penalty equal to your tier on attack rolls, saving throws, skill checks, and ability checks.
...
**Prerequisites** : [Eldritch Heritage](ultimateMagic/ultimateMagicFeats#_eldritch-heritage).
...
**Prerequisite** : [Elemental Fist](advanced/advancedFeats#_elemental-fist).

**Benefit** : The extra energy damage dealt by [Elemental Fist](advanced/advancedFeats#_elemental-fist) increases to 1d8 points, and you gain additional uses of [Elemental Fist](advanced/advancedFeats#_elemental-fist) per day equal to your tier. You can expend one use of mythic power as an immediate action to add the extra damage from your [Elemental Fist](advanced/advancedFeats#_elemental-fist) to all of the unarmed strikes you make until the beginning of your next turn. This counts as only one use of [Elemental Fist](advanced/advancedFeats#_elemental-fist), regardless of the number of attacks that you make in this fashion.
...
**Benefit** : Non-mythic creatures can't identify your illusion spells with [Spellcraft](skills/spellcraft#_spellcraft), including checks attempted as part of _ [arcane sight](spells/arcaneSight#_arcane-sight)_, _ [detect magic](spells/detectMagic#_detect-magic)_, or similar effects. When mythic creatures attempt to identify your illusions, add your tier to the DC of those [Spellcraft](skills/spellcraft#_spellcraft) checks. Mythic creatures informed by their allies that one of your illusions isn't real gain only a +2 bonus on their Will saves to disbelieve. Non-mythic creatures gain no bonus to disbelieve.
...
**Prerequisite** : [Fire Music](ultimateMagic/ultimateMagicFeats#_fire-music).
...
If you cast _summon monster_ as a bard spell and choose to give the summoned creature a fiery appearance, increase its fire resistance by 5 (adding to the resistance already granted by [Fire Music](ultimateMagic/ultimateMagicFeats#_fire-music)) and add 1d4 points of fire damage to all of its natural attacks instead of the +1 fire damage normally granted by [Fire Music](ultimateMagic/ultimateMagicFeats#_fire-music). Creatures with the fire subtype also gain these benefits.
...
**Prerequisite** : [Furious Focus](advanced/advancedFeats#_furious-focus).
...
**Prerequisite** : [Gnome Trickster](advanced/advancedFeats#_gnome-trickster).

**Benefit** : You gain the following spell-like abilities: 1/day—_ [blur](spells/blur#_blur)_ and _ [vanish](advanced/spells/vanish#_vanish)_.
...
**Prerequisite** : [Gorgon's Fist](pathfinderRPG/prd/feats#_gorgon-s-fist).
...
**Prerequisites** : [Heroic Defiance](advanced/advancedFeats#_heroic-defiance).
...
**Prerequisites** : [Heroic Recovery](advanced/advancedFeats#_heroic-recovery).
...
**Prerequisite** : [Improved Dirty Trick](advanced/advancedFeats#_improved-dirty-trick).
...
**Prerequisite** : [Improved Drag](advanced/advancedFeats#_improved-drag).
...
**Prerequisite** : [Improved Reposition](advanced/advancedFeats#_improved-reposition).
...
**Prerequisite** : [Improved Steal](advanced/advancedFeats#_improved-steal).
...
**Prerequisite** : [Improved Stonecunning](advanced/advancedFeats#_improved-stonecunnin).
...
**Prerequisite** : [Knockout Artist](ultimateCombat/ultimateCombatFeats#_knockout-artist).
...
**Benefit** : When you use [Lucky Halfling](advanced/advancedFeats#_lucky-halflin), add your tier as a bonus on the saving throw. You can expend one use of mythic power when an ally uses your save but still suffers an effect on a successful saving throw. If you do, that ally suffers no effect on the successful saving throw.
...
**Benefit** : The bonus on [Spellcraft](skills/spellcraft#_spellcraft) and [Use Magic Device](skills/useMagicDevice#_use-magic-device) skill checks from [Magical Aptitude](feats#_magical-aptitude) increases by 2. In addition, you can expend one use of mythic power to treat a [Spellcraft](skills/spellcraft#_spellcraft) or [Use Magic Device](skills/useMagicDevice#_use-magic-device) check as if you had rolled a natural 20. You must decide to use this ability before making the roll.
...
**Prerequisites** : [Missile Shield](advanced/advancedFeats#_missile-shield).
...
**Prerequisite** : [Monastic Legacy](ultimateCombat/ultimateCombatFeats#_monastic-legacy).
...
**Benefit** : You can negate an additional number of hits against your mount per round equal to your tier. Once per round as an immediate action, you can expend one use of mythic power to substitute a [Ride](skills/ride#_ride) check for a single Reflex saving throw your mount must make.
...
**Benefit** : The bonus on [Diplomacy](skills/diplomacy#_diplomacy) and [Intimidate](skills/intimidate#_intimidate) skill checks granted by [Persuasive](feats#_persuasive) increases by 2. In addition, you can expend one use of mythic power to treat a [Diplomacy](skills/diplomacy#_diplomacy) or [Intimidate](skills/intimidate#_intimidate) check as if you had rolled a natural 20. You must decide to use this ability before making the roll.
...
**Prerequisite** : [Powerful Shape](ultimateMagic/ultimateMagicFeats#_powerful-shape).
...
As a free action, you can expend one use of mythic power to combine the benefit from this feat with the benefit from non-mythic [Powerful Shape](ultimateMagic/ultimateMagicFeats#_powerful-shape) for a number of rounds equal to your tier.
...
**Benefit** : You can use [Prophetic Visionary](ultimateMagic/ultimateMagicFeats#_prophetic-visionary)'s _ [augury](spells/augury#_augury)_ ability at will, spending 10 minutes in a deep trance each time. Your chance of a successful _ [augury](spells/augury#_augury)_ increases by 1% per tier. A successful _ [augury](spells/augury#_augury) _made by using this feat also grants you the benefits of _ [guidance](spells/guidance#_guidance)_, but the bonus is equal to your tier and is an insight bonus instead of a competence bonus.
...
**Benefit** : You gain a single racial trait of your choice from the race you picked when you took non-mythic [Racial Heritage](advanced/advancedFeats#_racial-heritage). That racial trait can't modify your size or ability scores. You also gain the racial language of the race (if any) if you don't already know it. For races with multiple racial languages, you gain all of them.
...
**Benefit** : When you successfully use [Rhetorical Flourish](ultimateCombat/ultimateCombatFeats#_rhetorical-flourish) against a non-mythic creature, the bonus on your [Diplomacy](skills/diplomacy#_diplomacy) check increases by your tier. If the target is a mythic creature, you instead increase the bonus by half your tier.

You can expend one use of mythic power to reroll a single failed [Bluff](skills/bluff#_bluff) check. You must take the new result even if it is lower.
...
**Prerequisite** : [Saving Shield](advanced/advancedFeats#_saving-shield).

**Benefit** : The shield bonus you grant an ally with [Saving Shield](advanced/advancedFeats#_saving-shield) increases to +3. If you use [Saving Shield](advanced/advancedFeats#_saving-shield) to successfully negate an attack against an adjacent ally, you can immediately make an attack of opportunity against the attacker so long as it is within your melee reach.
...
**Benefit** : When you use [Snatch](monsters/monsterFeats#_snatch) Arrows to catch a thrown weapon that can also be used as a melee weapon, you can make a melee attack with it as an immediate action against a foe within the weapon's melee reach. You can expend one use of mythic power to make this attack without spending an immediate action.
...
**Benefit** : You grant and benefit from the +2 bonus on [Diplomacy](skills/diplomacy#_diplomacy) checks from [Sociable](advanced/advancedFeats#_sociable) constantly without having to spend a move action. You can spend a move action to increase the bonus to +4 for a number of rounds equal to your tier.
...
**Benefit** : The bonus on [Escape Artist](skills/escapeArtist#_escape-artist) and [Stealth](skills/stealth#_stealth) skill checks from [Stealthy](feats#_stealthy) increases by 2. In addition, you can expend one use of mythic power to treat an [Escape Artist](skills/escapeArtist#_escape-artist) or [Stealth](skills/stealth#_stealth) check as if you had rolled a natural 20. You must decide to use this ability before making the roll.
...
**Prerequisite** : [Strong Comeback](ultimateCombat/ultimateCombatFeats#_strong-comeback).
...
**Prerequisite** : [Tripping Staff](ultimateMagic/ultimateMagicFeats#_tripping-staff).
...
**Benefit** : When you cast _ [animate dead](spells/animateDead#_animate-dead) _or use the [Command Undead](feats#_command-undead) feat, add your tier to your caster level when determining the number of Hit Dice of undead you animate. This stacks with the increased caster level of [Undead Master](ultimateMagic/ultimateMagicFeats#_undead-master). When you cast _ [command undead](spells/commandUndead#_command-undead)_, your duration is tripled rather than doubled.
...
**Prerequisites** : [Mounted Combat](feats#_mounted-combat), Ride-By Attack, [Ride](skills/ride#_ride) 5 ranks.

**Benefit** : Your mount is always considered to have a running start when using [Acrobatics](skills/acrobatics#_acrobatics) to jump. You can expend one use of mythic power to grant your mount a +10 bonus on an [Acrobatics](skills/acrobatics#_acrobatics) check, or a +20 bonus if the check is made to jump.

When making a mounted charge, you can guide your mount to leap over a foe between your starting position and the target of your charge. You make a [Ride](skills/ride#_ride) check or your mount makes an [Acrobatics](skills/acrobatics#_acrobatics) check (whichever is lower) during the charge, using the rules for the leap task under the [Ride](skills/ride#_ride) skill. If the height you clear with that check exceeds the creature's height, you jump over it and continue your charge on the opposite side. This movement provokes attacks of opportunity. Alternatively, you can vault over your target while making a Ride-By Attack, allowing you to move over or through its space and continue moving on the opposite side of it. If your jump exceeds the target's height, you gain a +1 bonus on the attack roll for higher ground, and if any of your allies threatens the target, you treat the target as flanked for purposes of your Ride-By Attack.
...
**Prerequisite** : [Voice of the Sibyl](ultimateMagic/ultimateMagicFeats#_voice-of-the-sibyl).

**Benefit** : You gain a +1 bonus on all [Bluff](skills/bluff#_bluff), [Diplomacy](skills/diplomacy#_diplomacy), and [Perform](skills/perform#_perform) (oratory) skill checks for every 3 tiers you possess. This bonus stacks with the bonus from [Voice of the Sibyl](ultimateMagic/ultimateMagicFeats#_voice-of-the-sibyl). If you have 10 or more ranks in at least two of these skills, gain a +2 bonus to the DC of any language-dependent spell you cast.
...
**Benefit** : You gain a bonus equal to half your tier both on initiative checks and on concentration checks to cast a spell or use a spell-like ability when casting defensively or while grappled. These bonuses stack with the bonuses from [Warrior Priest](ultimateMagic/ultimateMagicFeats#_warrior-priest).

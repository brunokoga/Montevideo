---
title: mythicAdventure_dir/mythicFeats
---
# Mythic Feats
...
| Fabulous Figments (Mythic) | [Spell Focus](feats#_spell-focus) (illusion) | Non-mythic creatures can't identify your illusions |
...
| Titan Strike (Mythic | [Improved Unarmed Strike](mythicAdventure_dir/mythicFeats#_improved-unarmed-strike) | Your unarmed strike deals damage as if you were one size category larger |
| Two-Fisted Drinker (Mythic) | [Quick Draw](feats#_quick-draw) | Draw two potions or drinks as a move action and drink both as a standard action |
| Valiant Vault (Mythic) | [Mounted Combat](feats#_mounted-combat), [Ride-By Attack](feats#_ride-by-attack, [Ride](skill_dir/ride#_ride) 5 ranks | When mount leaps over foes attack as you pass |

| Mythic Enhancement Feats | Prerequisites | Benefits |
| --- | --- | --- |
| Accursed Hex (Mythic | [Accursed Hex](ultimateMagi_dir/ultimateMagicFeats#_accursed-hex | Target [Accursed Hex](ultimateMagi_dir/ultimateMagicFeats#_accursed-hex) must roll second save twice and take lower result |
| Acrobatic (Mythic) | [Acrobatic](feats#_acrobatic) | Gain an additional +2 bonus on [Acrobatic](feats#_acrobatic and [Fly](skill_dir/fly#_fly), and expend mythic power to treat one of these checks as if you rolled a 20 |
| Alertness (Mythic) | [Alertness](feats#_alertness | Gain an additional +2 bonus on [Perception](skill_dir/perception#_perception and [Sense Motive](skill_dir/senseMotive#_sense-motive) checks, and expend mythic power to treat one of these checks as if you rolled a 20 |
| Alignment Channel (Mythic) | [Alignment Channel](feats#_alignment-channel) | Channeled energy effects creatures with the alignment you choose, not just the subtype |
| Animal Affinity (Mythic) | [Animal Affinity](feats#_animal-affinity | Gain an additional +2 bonus on [Handle Animal](skill_dir/handleAnimal#_handle-animal and [Ride](skill_dir/ride#_ride checks, and expend mythic power to use _ [speak with animals](spell_dir/speakWithAnimals#_speak-with-animals)_ |
| Arcane Armor Training (Mythic) | [Arcane Armor Training](feats#_arcane-armor-training) | Gain the benefits of this feat without taking a swift action |
| Arcane Blast (Mythic | [Arcane Blast](advance_dir/advancedFeats#_arcane-blast) | Halve the damage to perform trip or bull rush |
| Arcane Shield (Mythic | [Arcane Shield](advance_dir/advancedFeats#_arcane-shield | Add 1/2 your mythic tier to the bonus granted by [Arcane Shield](advance_dir/advancedFeats#_arcane-shield), and expend mythic power to extend the shield's duration |
| Arcane Strike (Mythic) | [Arcane Strike](feats#_arcane-strike) | Arcane strike lasts 1 minute, and expend mythic power to grant magic weapon special abilities |
| Aspect of the Beast (Mythic | [Aspect of the Beast](advance_dir/advancedFeats#_aspect-of-the-beast) | Aspect manifests itself in new and powerful ways |
| Athletic (Mythic) | [Athletic](feats#_athletic | Gain an additional +2 bonus on [Climb](skill_dir/climb#_climb and [Swim](skill_dir/swim#_swim) checks, and expend mythic power to treat one of these checks as if you rolled a 20 |
| Augment Summoning (Mythic) | [Augment Summoning](feats#_augment-summoning) | Summoned creatures are considered mythic |
| Bleeding Critical (Mythic) | [Bleeding Critical](feats#_bleeding-critical, [Critical Focus](mythicAdventure_dir/mythicFeats#_critical-focus) | Bleed damage and the DC to staunch it increases by mythic tier |
| Blind-Fight (Mythic) | [Blind Fight](feats#_blind-fight) | Expend mythic power to ignore concealment miss chance |
| Catch Off-Guard (Mythic) | [Catch Off-Guard](feats#_catch-off-guard) | Add mythic tier to damage with improvised weapons |
| Channel Smite (Mythic) | [Channel Smite](feats#_channel-smite) | Gain a bonus on attacks based on power of channel |
| Charge Through (Mythic | [Charge Through](advance_dir/advancedFeats#_charge-through) | Ignore allies and make overruns when you charge through |
| Cleave (Mythic) | [Cleave](feats#_cleave) | Make additional cleaves to any foes in reach regardless of position |
| Combat Expertise (Mythic) | [Combat Expertise](feats#_combat-expertise) | Gain an additional +2 dodge bonus and expend mythic power to reduce penalties |
| Combat Reflexes (Mythic) | [Combat Reflexes](feats#_combat-reflexes) | You can make any number of attacks of opportunity |
| Command Undead (Mythic) | [Command Undead](feats#_command-undead) | Increase Will save by mythic tier when commanding undead |
| Critical Focus (Mythic) | [Critical Focus](feats#_critical-focus | Automatically confirm critical hits against non-mythic foes and increased chance to bypass _ [fortification](magicItem_dir/armor#_armor-fortification)_ |
| Critical Mastery (Mythic | [Critical Focus](mythicAdventure_dir/mythicFeats#_critical-focus), [Critical Mastery](feats#_critical-mastery) | Deal additional critical feats based on mythic tier |
| Dastardly Finish (Mythic | [Dastardly Finish](advance_dir/advancedFeats#_dastardly-finish) | Coup de grace dazed and staggered non-mythic foes |
...
| Death from Above (Mythic | [Death from Above](ultimateComba_dir/ultimateCombatFeats#_death-from-above) | Increase critical threat modifier and make a trip combat maneuver when charging from above |
| Deceitful (Mythic) | [Deceitful](feats#_deceitful | Gain an additional +2 bonus on [Bluff](skill_dir/bluff#_bluff and [Disguise](skill_dir/disguise#_disguise), and expend mythic power to treat one of these checks as if you rolled a 20 |
| Deepsight (Mythic | [Deepsight](advance_dir/advancedFeats#_deepsight) | Darkvision increases by 10 ft. per mythic tier |
| Defensive Combat Training (Mythic) | [Defensive Combat Training](feats#_defensive-combat-training, 4th mythic tier | Add 1/2 mythic tier to CMD |
...
| Deft Hands (Mythic) | [Deft Hand](feats#_deft-hand) | Gain an additional +2 bonus on [Disable Device](skill_dir/disableDevice#_disable-device and [Sleight of Hand](skill_dir/sleightOfHand#_sleight-of-hand), and expend mythic power to treat one of these checks as if you rolled a 20 |
| Detect Expertise (Mythic | [Detect Expertise](ultimateMagi_dir/ultimateMagicFeats#_detect-expertise | Gain the benefit of [Detect Expertise](ultimateMagi_dir/ultimateMagicFeats#_detect-expertise) immediately |
| Disruptive (Mythic) | [Disruptive](feats#_disruptive) | Increase the DC to cast spells defensively within your threatened area |
| Distance Thrower (Mythic | Str 17, [Distance Thrower](ultimateComba_dir/ultimateCombatFeats#_distance-thrower) | Throw weapons twice the normal range |
| Divine Interference (Mythic | [Divine Interference](ultimateMagi_dir/ultimateMagicFeats#_divine-interference) | Double or triple the penalty on your opponent's attack roll |
| Dodge (Mythic) | [Dodge](feats#_dodge) | Gain a +1 dodge bonus and expend mythic power to gain a +10 dodge bonus against one attack |
| Dreadful Carnage (Mythic | [Dreadful Carnage](advance_dir/advancedFeats#_dreadful-carnage) | Your carnage has a greater effect against non-mythic foes and expend mythic power to frighten foes |
| Eagle Eyes (Mythic | [Eagle Eyes](advance_dir/advancedFeats#_eagle-eyes | Ignore [Perception](skill_dir/perception#_perception) distance penalties |
| Eldritch Heritage (Mythic | [Eldritch Heritage](ultimateMagi_dir/ultimateMagicFeats#_eldritch-heritage) | Gain increased bloodline powers |
| Elemental Channel (Mythic) | [Elemental Channel](feats#_elemental-channel) | Affect any elemental subtype |
| Elemental Fist (Mythic | [Elemental Fist](advance_dir/advancedFeats#_elemental-fist | Increase damage and frequency of [Elemental Fist](advance_dir/advancedFeats#_elemental-fist) |
| Elemental Focus (Mythic | [Elemental Focus](advance_dir/advancedFeats#_elemental-focus) | Increase the DCs and expend mythic power to force opponents to roll twice and take the lowest result when saving against focus spells |
| Elven Accuracy (Mythic | [Elven Accuracy](advance_dir/advancedFeats#_elven-accuracy) | Ignore concealment with bows |
...
| Fast Empathy (Mythic | [Fast Empathy](ultimateMagi_dir/ultimateMagicFeats#_fast-empathy) | Use wild empathy as a swift action |
| Fire Music (Mythic | [Fire Music](ultimateMagi_dir/ultimateMagicFeats#_fire-music | [Fire Music](ultimateMagi_dir/ultimateMagicFeats#_fire-music) ignores fire resistance based on tier |
| Fleet (Mythic) | [Fleet](feats#_fleet) | Land speed increases by 5 feet regardless of armor or encumbrance |
| Furious Focus (Mythic | [Furious Focus](advance_dir/advancedFeats#_furious-focus) | Ignore [Power Attack](feats#_power-attack penalties when using [Furious Focus](advance_dir/advancedFeats#_furious-focus) |
| Gnome Trickster (Mythic | [Gnome Trickster](advance_dir/advancedFeats#_gnome-trickster) | Gain more spell-like abilities and use your gnome spell-like abilities more often |
...
| Guided Hand (Mythic | [Guided Hand](ultimateComba_dir/ultimateCombatFeats#_guided-hand) | Apply Wisdom bonus instead of Strength or Dexterity bonus on favored weapon damage |
| Heroic Defiance (Mythic | [Heroic Defiance](advance_dir/advancedFeats#_heroic-defiance) | Once per day, attempt to negate the onset of a harmful condition or affliction |
| Heroic Recovery (Mythic | [Heroic Recovery](advance_dir/advancedFeats#_heroic-recovery) | Expend mythic power to save again against a condition or affliction |
...
| Improved Dirty Trick (Mythic | [Improved Dirty Trick](advance_dir/advancedFeats#_improved-dirty-trick) | Gain a bonus on dirty tricks based on mythic tier |
| Improved Disarm (Mythic) | [Improved Disarm](feats#_improved-disarm) | Gain a bonus on disarms based on mythic tier |
| Improved Drag (Mythic | [Improved Drag](advance_dir/advancedFeats#_improved-drag) | Gain a bonus on drags based on mythic tier |
...
| Improved Reposition (Mythic | [Improved Reposition](advance_dir/advancedFeats#_improved-reposition) | Gain a bonus on repositions based on mythic tier |
| Improved Steal (Mythic | [Improved Steal](advance_dir/advancedFeats#_improved-steal) | Gain a bonus on steals based on mythic tier |
| Improved Stonecunning (Mythic | [Improved Stonecunning](advance_dir/advancedFeats#_improved-stonecunnin | Gain _ [stone tell](spell_dir/stoneTell#_stone-tell)_ as a spell-like ability |
...
| Intimidating Prowess (Mythic) | [Intimidating Prowess](feats#_intimidating-prowess | Gain a bonus on [Intimidate](skill_dir/intimidate#_intimidate) against non-mythic creatures based on mythic tier |
...
| Knockout Artist (Mythic | [Knockout Artist](ultimateComba_dir/ultimateCombatFeats#_knockout-artist) | Use d8s for sneak attacks with unarmed strike nonlethal damage |
...
| Lucky Halfling (Mythic | [Lucky Halfling](advance_dir/advancedFeats#_lucky-halflin) | Increase the bonus based on tier and expend mythic power to negate the effects of a successful save |
| Lunge (Mythic) | [Lunge](feats#_lunge) | When you hit with lunge, don't take an AC penalty against that creature |
| Magical Aptitude (Mythic) | [Magical Aptitude](feats#_magical-aptitude | Gain an additional +2 bonus on [Spellcraft](skill_dir/spellcraft#_spellcraft and [Use Magic Device](skill_dir/useMagicDevice#_use-magic-device), and expend mythic power to treat one of these checks as if you rolled a 20 |
...
| Missile Shield (Mythic | [Missile Shield](advance_dir/advancedFeats#_missile-shield | Deflect a number of ranged attacks equal to 1/2 your mythic tier |
| Mobility (Mythic) | [Mobility](feats#_mobility) | Gain a +6 bonus instead of +4 and when an attack misses move 5 feet |
| Monastic Legacy (Mythic) | [Monastic Legacy](ultimateComba_dir/ultimateCombatFeats#_monastic-legacy | Add 1/2 your non-monk class levels to determine AC bonus, and expend mythic power to increase your unarmed strike damage and AC bonus |
...
| Persuasive (Mythic) | [Persuasive](feats#_persuasive) | Gain an additional +2 bonus on [Diplomacy](skill_dir/diplomacy#_diplomacy and [Intimidate](skill_dir/intimidate#_intimidate), and expend mythic power to treat one of these checks as if you rolled a 20 |
| Pinpoint Targeting (Mythic) | [Pinpoint Targeting](feats#_pinpoint-targeting) | Use Pinpoint Targeting even when you move |
...
| Powerful Shape (Mythic | [Powerful Shape](ultimateMagi_dir/ultimateMagicFeats#_powerful-shape) | Apply the giant simple template to wild shape |
| Prophetic Visionary (Mythic | [Prophetic Visionary](ultimateMagi_dir/ultimateMagicFeats#_prophetic-visionary | Use _ [augury](spell_dir/augury#_augury)_ at will |
| Quick Draw (Mythic) | [Quick Draw](feats#_quick-draw) | Draw any item as a free action, expend mythic power to draw two items |
| Racial Heritage (Mythic | [Racial Heritage](advance_dir/advancedFeats#_racial-heritage) | Gain a single racial trait of your choice |
| Rapid Reload (Mythic | [Rapid Reload](ultimateComba_dir/ultimateCombatFeats#_rapid-reload) | Reload all weapons faster |
| Rapid Shot (Mythic) | [Rapid Shot](feats#_rapid-shot) | Ignore the –2 penalty or make two additional attacks |
| Rhetorical Flourish (Mythic | [Rhetorical Flourish](ultimateComba_dir/ultimateCombatFeats#_rhetorical-flourish | Increase the bonus on [Diplomacy](skill_dir/diplomacy#_diplomacy) checks based on mythic tier |
...
| Saving Shield (Mythic | [Saving Shield](advance_dir/advancedFeats#_saving-shield) | When you negate an attack, make attack of opportunity against attacker |
| Scorpion Style (Mythic) | [Scorpion Style](feats#_scorpion-style | Add mythic tier to duration or _ [slow](spell_dir/slow#_slow)_ your target |
...
| Self-Sufficient (Mythic) | [Self-Sufficient](feats#_self-sufficient | Gain an additional +2 bonus on [Heal](skill_dir/heal#_heal and [Survival](skill_dir/survival#_survival), and expend mythic power to treat one of these checks as if you rolled a 20 |
...
| Snatch Arrows (Mythic | [Snatch](monster_dir/monsterFeats#_snatch) Arrows | Use snatched thrown weapons as immediate attack melee weapons |
| Sociable (Mythic | [Sociable](advance_dir/advancedFeats#_sociable | Increase the bonus on [Diplomacy](skill_dir/diplomacy#_diplomacy) or gain the normal bonus without an action |
...
| Spell Penetration (Mythic) | [Spell Penetration](feats#_spell-penetration | Add 1/2 mythic tier to level checks to overcome spell resistance |
...
| Spontaneous Metafocus (Mythic) | [Spontaneous Metafocus](ultimateMagi_dir/ultimateMagicFeats#_spontaneous-metafocus) | Change the spells of your metafocus each morning |
| Spring Attack (Mythic) | [Spring Attack](feats#_spring-attack), base attack bonus +6 | Make first attack before moving |
| Stealthy (Mythic) | [Stealthy](feats#_stealthy | Gain an additional +2 bonus on [Escape Artist](skill_dir/escapeArtist#_escape-artist and [Stealth](skill_dir/stealth#_stealth), and expend mythic power to treat one of these checks as if you rolled a 20 |
| Strike Back (Mythic) | [Strike Back](feats#_strike-back) | Move toward the subject of your readied action attack |
| Strong Comeback (Mythic | [Strong Comeback](ultimateComba_dir/ultimateCombatFeats#_strong-comeback) | When rerolling, roll twice and take the higher result |
...
| Toughness (Mythic) | [Toughness](feats#_toughness | Gain twice as many hit points, and gain DR 10/epic below 0 hit points |
| Trample (Mythic) | [Trample](feats#_trample) | Mount can make two hoof attacks instead of one |
| Tripping Staff (Mythic) | [Tripping Staff](ultimateMagi_dir/ultimateMagicFeats#_tripping-staff) | Your CMD against trips is increased based on tier and those who trip you and fail provoke an attack of opportunity from you |
...
| Undead Master (Mythic | [Undead Master](ultimateMagi_dir/ultimateMagicFeats#_undead-master) | Add your mythic tier to your caster level to determine number of undead animated |
...
| Voice of the Sibyl (Mythic | [Voice of the Sibyl](ultimateMagi_dir/ultimateMagicFeats#_voice-of-the-sibyl | Increase [Bluff](skill_dir/bluff#_bluff, [Diplomacy](skill_dir/diplomacy#_diplomacy, and [Perform](skill_dir/perform#_perform) (oratory) skill bonus based on mythic tier |
| Warrior Priest (Mythic | [Warrior Priest](ultimateMagi_dir/ultimateMagicFeats#_warrior-priest) | Increase bonus on initiative and concentration checks based on mythic tier |
...
| Witch Knife (Mythic | [Witch Knife](ultimateMagi_dir/ultimateMagicFeats#_witch-knife) | Use your witch knife as a focus for all spells, not just patron spells |
...
**Prerequisite** : [Accursed Hex](ultimateMagi_dir/ultimateMagicFeats#_accursed-hex.

**Benefit** : When you use [Accursed Hex](ultimateMagi_dir/ultimateMagicFeats#_accursed-hex) to target a creature with one of your hexes a second time, that creature must roll its saving throw twice and take the lower result.
...
**Benefit** : The bonus on [Acrobatics](skill_dir/acrobatics#_acrobatics and [Fly](skill_dir/fly#_fly) skill checks from [Acrobatic](feats#_acrobatic increases by 2. In addition, you can expend one use of mythic power to treat an [Acrobatics](skill_dir/acrobatics#_acrobatics or [Fly](skill_dir/fly#_fly) check as if you had rolled a natural 20. You must decide to use this ability before making the roll.
...
**Benefit** : The bonus on [Handle Animal](skill_dir/handleAnimal#_handle-animal and [Ride](skill_dir/ride#_ride) skill checks from [Animal Affinity](feats#_animal-affinity increases by 2. In addition, you can expend one use of mythic power to _ [speak with animals](spell_dir/speakWithAnimals#_speak-with-animals) _as the spell. Your caster level for this effect is equal to twice your tier.
...
**Prerequisite** : [Arcane Blast](advance_dir/advancedFeats#_arcane-blast.

**Benefit** : When you use [Arcane Blast](advance_dir/advancedFeats#_arcane-blast, you may halve the damage dice to also perform your choice of either a trip or bull rush combat maneuver against the target of the blast. You can't move with an opponent you bull rush with this feat. You gain a bonus on your combat maneuver check for this attempt equal to half the spell level of the spell you sacrificed when using [Arcane Blast](advance_dir/advancedFeats#_arcane-blast, and you can substitute your Intelligence or Charisma modifier in place of your Strength modifier when determining your combat maneuver bonus.

In addition, you can expend one use of mythic power to change the damage dice of your [Arcane Blast](advance_dir/advancedFeats#_arcane-blast) to d8s instead of d6s.

Arcane Shield (Mythic

You sculpt spells into a powerful, enduring arcane barriers.

**Prerequisite** : [Arcane Shield](advance_dir/advancedFeats#_arcane-shield.

**Benefit** : You add half your tier to the deflection bonus granted to your AC when you use your [Arcane Shield](advance_dir/advancedFeats#_arcane-shield). You can expend one use of mythic power when using this feat to extend the duration to a number of rounds equal to your tier.
...
**Prerequisite** : [Aspect of the Beast](advance_dir/advancedFeats#_aspect-of-the-beast).
...
_Mythic Leap (Ex)_: You can make a running jump without needing to run 10 feet beforehand. In addition, you gain a +5 bonus on your [Acrobatics](skill_dir/acrobatics#_acrobatics checks to determine the success of that jump and the distance covered. If you already have the predator's leap manifestation of [Aspect of the Beast](advance_dir/advancedFeats#_aspect-of-the-beast, the bonus on your [Acrobatics](skill_dir/acrobatics#_acrobatics) checks increases to +10.

_Mythic Instinct (Ex_: You gain a +2 bonus on initiative checks and a +2 bonus on [Survival](skill_dir/survival#_survival checks. These bonuses stack with those gained from the wild instinct manifestation of [Aspect of the Beast](advance_dir/advancedFeats#_aspect-of-the-beast).
...
**Benefit** : The bonus on [Climb](skill_dir/climb#_climb and [Swim](skill_dir/swim#_swim) skill checks from [Athletic](feats#_athletic increases by 2. In addition, you can expend one use of mythic power to treat a [Climb](skill_dir/climb#_climb or [Swim](skill_dir/swim#_swim) check as if you had rolled a natural 20. You must decide to use this ability before making the roll.
...
**Benefit** : The bleed damage dealt with Bleeding Critical increases by your tier. Stopping this bleed damage requires a [Heal](skill_dir/heal#_heal check with a DC equal to 15 + 1/2 your tier. Any magical healing ends the bleed damage normally.
...
**Prerequisite** : [Charge Through](advance_dir/advancedFeats#_charge-through.

**Benefit** : When charging, you can ignore allies in your path when determining whether or not you can charge your target. Furthermore, after you have attempted at least one overrun with [Charge Through](advance_dir/advancedFeats#_charge-through), you can expend one use of mythic power as a free action to attempt another overrun against a different opponent in the path of the same charge.
...
**Prerequisite** : [Combat Reflexes](feats#_combat-reflexes).
...
**Benefit** : You automatically confirm critical threats against non-mythic opponents. In addition, when you threaten a critical hit against a creature wearing armor with the _ [fortification](magicItem_dir/armor#_armor-fortification)_ special ability or similar effect, that creature must roll twice and take the worse result when determining critical hit negation.
...
**Prerequisite** : [Dastardly Finish](advance_dir/advancedFeats#_dastardly-finish).
...
**Benefit** : While wielding the weapon with which you have [Weapon Focus](feats#_weapon-focus, you can use Dazzling Display as a standard action with a –5 penalty on your [Intimidate](skill_dir/intimidate#_intimidate) check, as a move action with a –10 penalty, or as a swift action with a –20 penalty. You can expend one use of mythic power when you make a Dazzling Display to make those affected by the display frightened rather than shaken.
...
**Prerequisite** : [Death from Above](ultimateComba_dir/ultimateCombatFeats#_death-from-above).
...
**Benefit** : The bonus on [Bluff](skill_dir/bluff#_bluff and [Disguise](skill_dir/disguise#_disguise) skill checks from [Deceitful](feats#_deceitful increases by 2. In addition, you can expend one use of mythic power to treat a [Bluff](skill_dir/bluff#_bluff or [Disguise](skill_dir/disguise#_disguise) check as if you had rolled a natural 20. You must decide to use this ability before making the roll.

Deepsight (Mythic

Your sharp eyes can penetrate deeper into the darkness, revealing more to you.

**Prerequisite** : [Deepsight](advance_dir/advancedFeats#_deepsight).
...
**Benefit** : The bonus on [Disable Device](skill_dir/disableDevice#_disable-device and [Sleight of Hand](skill_dir/sleightOfHand#_sleight-of-hand) skill checks from [Deft Hands](feats#_deft-hands increases by 2. In addition, you can expend one use of mythic power to treat a [Disable Device](skill_dir/disableDevice#_disable-device or [Sleight of Hand](skill_dir/sleightOfHand#_sleight-of-hand) check as if you had rolled a natural 20. You must decide to use this ability before making the roll.

Detect Expertise (Mythic

You can sense a creature's magical abilities with just a mere glance.

**Prerequisite** : [Detect Expertise](ultimateMagi_dir/ultimateMagicFeats#_detect-expertise.

**Benefit** : You gain the benefit of [Detect Expertise](ultimateMagi_dir/ultimateMagicFeats#_detect-expertise) immediately (without needing to observe a creature for 3 rounds when using the divinations listed in [Detect Expertise](ultimateMagi_dir/ultimateMagicFeats#_detect-expertise). Non-mythic creatures cannot attempt a Will save to resist this effect.
...
**Prerequisites** : Str 17, [Distance Thrower](ultimateComba_dir/ultimateCombatFeats#_distance-thrower).
...
**Prerequisite** : [Divine Interference](ultimateMagi_dir/ultimateMagicFeats#_divine-interference.

**Benefit** : When you use [Divine Interference](ultimateMagi_dir/ultimateMagicFeats#_divine-interference), the penalty on your opponent's attack roll is equal to twice the level of the spell sacrificed. You can expend one use of mythic power when you sacrifice the spell to increase the penalty to triple the level of the spell sacrificed.
...
**Prerequisite** : [Dreadful Carnage](advance_dir/advancedFeats#_dreadful-carnage.

**Benefit** : When you use [Dreadful Carnage](advance_dir/advancedFeats#_dreadful-carnage, you affect non-mythic enemies within 60 feet in addition to all enemies within 30 feet. You can expend one use of mythic power before making the [Intimidate](skill_dir/intimidate#_intimidate check to cause enemies demoralized by [Dreadful Carnage](advance_dir/advancedFeats#_dreadful-carnage) to become frightened instead of shaken, for the same duration as the normal shaken effect. While frightened by this ability, an enemy takes a penalty equal to your tier on attack rolls, saving throws, skill checks, and ability checks.
...
**Prerequisite** : [Elemental Fist](advance_dir/advancedFeats#_elemental-fist.

**Benefit** : The extra energy damage dealt by [Elemental Fist](advance_dir/advancedFeats#_elemental-fist increases to 1d8 points, and you gain additional uses of [Elemental Fist](advance_dir/advancedFeats#_elemental-fist per day equal to your tier. You can expend one use of mythic power as an immediate action to add the extra damage from your [Elemental Fist](advance_dir/advancedFeats#_elemental-fist to all of the unarmed strikes you make until the beginning of your next turn. This counts as only one use of [Elemental Fist](advance_dir/advancedFeats#_elemental-fist), regardless of the number of attacks that you make in this fashion.

Elemental Focus (Mythic

Your elemental spells are potent and effective.

**Prerequisite** : [Elemental Focus](advance_dir/advancedFeats#_elemental-focus.

**Benefit** : Choose an energy type in which you already have [Elemental Focus](advance_dir/advancedFeats#_elemental-focus. The increase to save DC provided by [Elemental Focus](advance_dir/advancedFeats#_elemental-focus and [Greater Elemental Focus](advance_dir/advancedFeats#_greater-elemental-focus) for spells of the selected energy type is 1 higher. When casting a spell with this energy type's descriptor, you can expend one use of mythic power as part of the casting to force the spell's targets to roll their saving throws twice, taking the lower result.

Elven Accuracy (Mythic

Your elven eyesight cuts though concealment.

**Prerequisite** : [Elven Accuracy](advance_dir/advancedFeats#_elven-accuracy).

**Benefit** : When you make an attack with a longbow or short bow (including composite bows, you can ignore concealment, but not total concealment. You still suffer a miss chance for total concealment, but if you miss due to total concealment, you may reroll your miss chance as per [Elven Accuracy](advance_dir/advancedFeats#_elven-accuracy).
...
**Benefit** : Non-mythic creatures can't identify your illusion spells with [Spellcraft](skill_dir/spellcraft#_spellcraft, including checks attempted as part of _ [arcane sight](spell_dir/arcaneSight#_arcane-sight_, _ [detect magic](spell_dir/detectMagic#_detect-magic_, or similar effects. When mythic creatures attempt to identify your illusions, add your tier to the DC of those [Spellcraft](skill_dir/spellcraft#_spellcraft) checks. Mythic creatures informed by their allies that one of your illusions isn't real gain only a +2 bonus on their Will saves to disbelieve. Non-mythic creatures gain no bonus to disbelieve.
...
**Prerequisite** : [Fast Empathy](ultimateMagi_dir/ultimateMagicFeats#_fast-empathy).
...
**Prerequisite** : [Fire Music](ultimateMagi_dir/ultimateMagicFeats#_fire-music.

**Benefit** : When you use [Fire Music](ultimateMagi_dir/ultimateMagicFeats#_fire-music to change any of the damage dealt by a bard spell to fire damage, that damage ignores fire resistance up to your tier.

If you cast _summon monster_ as a bard spell and choose to give the summoned creature a fiery appearance, increase its fire resistance by 5 (adding to the resistance already granted by [Fire Music](ultimateMagi_dir/ultimateMagicFeats#_fire-music) and add 1d4 points of fire damage to all of its natural attacks instead of the +1 fire damage normally granted by [Fire Music](ultimateMagi_dir/ultimateMagicFeats#_fire-music). Creatures with the fire subtype also gain these benefits.
...
**Prerequisite** : [Gorgon's Fist](pathfinderRPG/pr_dir/feats#_gorgon-s-fist).
...
**Prerequisite** : [Guided Hand](ultimateComba_dir/ultimateCombatFeats#_guided-hand).
...
**Prerequisites** : [Heroic Defiance](advance_dir/advancedFeats#_heroic-defiance).
...
This effect is separate from the use of non-mythic [Heroic Defiance](advance_dir/advancedFeats#_heroic-defiance).

Heroic Recovery (Mythic

You can shrug off the effects of harmful conditions after they've taken effect.

**Prerequisites** : [Heroic Recovery](advance_dir/advancedFeats#_heroic-recovery.

**Benefit** : As a swift action, you can expend one use of mythic power to use [Heroic Recovery](advance_dir/advancedFeats#_heroic-recovery) additional times. Whenever you do, add your tier to the result of the Fortitude save.
...
**Prerequisite** : [Improved Dirty Trick](advance_dir/advancedFeats#_improved-dirty-trick.

**Benefit** : You gain a bonus equal to half your tier on checks to attempt a dirty trick, and to your CMD when an opponent attempts to perform a dirty trick on you. These bonuses stack with those granted by [Improved Dirty Trick](advance_dir/advancedFeats#_improved-dirty-trick).
...
**Prerequisite** : [Improved Drag](advance_dir/advancedFeats#_improved-drag.

**Benefit** : You gain a bonus equal to half your tier on checks to attempt a drag combat maneuver, and to your CMD when an opponent attempts a drag combat maneuver against you. These bonuses stack with those granted by [Improved Drag](advance_dir/advancedFeats#_improved-drag).
...
**Prerequisite** : [Improved Steal](advance_dir/advancedFeats#_improved-steal.

**Benefit** : You gain a bonus equal to half your tier on checks to attempt a steal combat maneuver, and to your CMD when an opponent attempts a steal combat maneuver on you. These bonuses stack with those granted by [Improved Steal](advance_dir/advancedFeats#_improved-steal).
...
**Prerequisite** : [Improved Stonecunning](advance_dir/advancedFeats#_improved-stonecunnin.

**Benefit** : You gain _ [stone tell](spell_dir/stoneTell#_stone-tell)_ as a spell-like ability usable once per day with a caster level equal to twice your tier.
...
**Prerequisite** : [Knockout Artist](ultimateComba_dir/ultimateCombatFeats#_knockout-artist).
...
**Prerequisite** : [Lucky Halfling](advance_dir/advancedFeats#_lucky-halflin.

**Benefit** : When you use [Lucky Halfling](advance_dir/advancedFeats#_lucky-halflin), add your tier as a bonus on the saving throw. You can expend one use of mythic power when an ally uses your save but still suffers an effect on a successful saving throw. If you do, that ally suffers no effect on the successful saving throw.
...
**Benefit** : The bonus on [Spellcraft](skill_dir/spellcraft#_spellcraft and [Use Magic Device](skill_dir/useMagicDevice#_use-magic-device) skill checks from [Magical Aptitude](feats#_magical-aptitude increases by 2. In addition, you can expend one use of mythic power to treat a [Spellcraft](skill_dir/spellcraft#_spellcraft or [Use Magic Device](skill_dir/useMagicDevice#_use-magic-device) check as if you had rolled a natural 20. You must decide to use this ability before making the roll.
...
**Benefit** : You can use the [surge ability](mythicAdventure_dir/mythicHeroes#_surge-ability) once per day (adding 1d6). If you are or become mythic, you can use your surge one additional time per day.
...
**Prerequisites** : [Missile Shield](advance_dir/advancedFeats#_missile-shield.

**Benefit** : When using [Missile Shield](advance_dir/advancedFeats#_missile-shield), you can deflect an additional number of ranged attacks per round equal to half your tier. You can expend one use of mythic power as an immediate action to deflect a single ray from a ray spell or effect targeting you.
...
**Prerequisite** : [Monastic Legacy](ultimateComba_dir/ultimateCombatFeats#_monastic-legacy).
...
**Benefit** : You can negate an additional number of hits against your mount per round equal to your tier. Once per round as an immediate action, you can expend one use of mythic power to substitute a [Ride](skill_dir/ride#_ride) check for a single Reflex saving throw your mount must make.
...
**Benefit** : The bonus on [Diplomacy](skill_dir/diplomacy#_diplomacy and [Intimidate](skill_dir/intimidate#_intimidate) skill checks granted by [Persuasive](feats#_persuasive increases by 2. In addition, you can expend one use of mythic power to treat a [Diplomacy](skill_dir/diplomacy#_diplomacy or [Intimidate](skill_dir/intimidate#_intimidate) check as if you had rolled a natural 20. You must decide to use this ability before making the roll.
...
You can expend one use of mythic power when you activate [Power Attack](feats#_power-attack) to ignore the penalties on melee attack rolls and combat maneuver checks for 1 minute.

Powerful Shape (Mythic

The forms you take in wild shape tower over their natural counterparts.

**Prerequisite** : [Powerful Shape](ultimateMagi_dir/ultimateMagicFeats#_powerful-shape).

**Benefit** : You can apply the giant simple template (quick rules version, from _Pathfinder RPG Bestiary_ 295 to any form you take with wild shape. This replaces the benefit from [Powerful Shape](ultimateMagi_dir/ultimateMagicFeats#_powerful-shape.

As a free action, you can expend one use of mythic power to combine the benefit from this feat with the benefit from non-mythic [Powerful Shape](ultimateMagi_dir/ultimateMagicFeats#_powerful-shape) for a number of rounds equal to your tier.

Prophetic Visionary (Mythic

Your precognitive powers aid you further.

**Prerequisite** : [Prophetic Visionary](ultimateMagi_dir/ultimateMagicFeats#_prophetic-visionary.

**Benefit** : You can use [Prophetic Visionary](ultimateMagi_dir/ultimateMagicFeats#_prophetic-visionary's _ [augury](spell_dir/augury#_augury_ ability at will, spending 10 minutes in a deep trance each time. Your chance of a successful _ [augury](spell_dir/augury#_augury_ increases by 1% per tier. A successful _ [augury](spell_dir/augury#_augury _made by using this feat also grants you the benefits of _ [guidance](spell_dir/guidance#_guidance)_, but the bonus is equal to your tier and is an insight bonus instead of a competence bonus.
...
**Prerequisite** : [Racial Heritage](advance_dir/advancedFeats#_racial-heritage.

**Benefit** : You gain a single racial trait of your choice from the race you picked when you took non-mythic [Racial Heritage](advance_dir/advancedFeats#_racial-heritage). That racial trait can't modify your size or ability scores. You also gain the racial language of the race (if any) if you don't already know it. For races with multiple racial languages, you gain all of them.

Rapid Reload (Mythic

You can reload any type of weapon with astounding speed.

**Prerequisite** : [Rapid Reload](ultimateComba_dir/ultimateCombatFeats#_rapid-reload.

**Benefit** : You gain the benefits of [Rapid Reload](ultimateComba_dir/ultimateCombatFeats#_rapid-reload) with all crossbows and firearms, not just the one you originally chose when you gained that feat. As a swift action, you can expend one use of mythic power to gain the ability to reload crossbows and firearms without provoking attacks of opportunity for 1 minute.
...
**Prerequisites** : [Rhetorical Flourish](ultimateComba_dir/ultimateCombatFeats#_rhetorical-flourish.

**Benefit** : When you successfully use [Rhetorical Flourish](ultimateComba_dir/ultimateCombatFeats#_rhetorical-flourish against a non-mythic creature, the bonus on your [Diplomacy](skill_dir/diplomacy#_diplomacy check increases by your tier. If the target is a mythic creature, you instead increase the bonus by half your tier.

You can expend one use of mythic power to reroll a single failed [Bluff](skill_dir/bluff#_bluff) check. You must take the new result even if it is lower.
...
**Prerequisite** : [Saving Shield](advance_dir/advancedFeats#_saving-shield.

**Benefit** : The shield bonus you grant an ally with [Saving Shield](advance_dir/advancedFeats#_saving-shield increases to +3. If you use [Saving Shield](advance_dir/advancedFeats#_saving-shield) to successfully negate an attack against an adjacent ally, you can immediately make an attack of opportunity against the attacker so long as it is within your melee reach.
...
**Benefit** : Whenever you are using Scorpion Style, you add your tier to the number of rounds the target's base land speed is reduced. You can expend one use of mythic power when making your attack to slow your target, as the spell _ [slow](spell_dir/slow#_slow_, unless it succeeds at a Fortitude save (DC 10 + 1/2 your character level + your Wisdom modifier). The slowing effect supersedes the normal speed penalty of your Scorpion Strike, but lasts for an equal number of rounds.
...
**Benefit** : The bonus on [Heal](skill_dir/heal#_heal and [Survival](skill_dir/survival#_survival) skill checks from [Self-Sufficient](feats#_self-sufficient increases by 2. In addition, you can expend one use of mythic power to treat a [Heal](skill_dir/heal#_heal or [Survival](skill_dir/survival#_survival) check as if you had rolled a natural 20. You must decide to use this ability before making the roll.
...
**Benefit** : When you use [Snatch](monster_dir/monsterFeats#_snatch) Arrows to catch a thrown weapon that can also be used as a melee weapon, you can make a melee attack with it as an immediate action against a foe within the weapon's melee reach. You can expend one use of mythic power to make this attack without spending an immediate action.

Sociable (Mythic

Your easy nature flows from you without effort, putting others at ease.

**Prerequisite** : [Sociable](advance_dir/advancedFeats#_sociable.

**Benefit** : You grant and benefit from the +2 bonus on [Diplomacy](skill_dir/diplomacy#_diplomacy checks from [Sociable](advance_dir/advancedFeats#_sociable) constantly without having to spend a move action. You can spend a move action to increase the bonus to +4 for a number of rounds equal to your tier.
...
**Prerequisite** : [Spontaneous Metafocus](ultimateMagi_dir/ultimateMagicFeats#_spontaneous-metafocus.

**Benefit** : You can change which spell your [Spontaneous Metafocus](ultimateMagi_dir/ultimateMagicFeats#_spontaneous-metafocus feat applies to each morning when you restore your expended spell slots. The spell it applies to can be of any level, but it must be a legal selection for the [Spontaneous Metafocus](ultimateMagi_dir/ultimateMagicFeats#_spontaneous-metafocus feat.

**Special** : You can gain this feat multiple times. The effects do not stack. Each time you take this feat, it applies to a different non-mythic [Spontaneous Metafocus](ultimateMagi_dir/ultimateMagicFeats#_spontaneous-metafocus) feat.
...
**Benefit** : The bonus on [Escape Artist](skill_dir/escapeArtist#_escape-artist and [Stealth](skill_dir/stealth#_stealth) skill checks from [Stealthy](feats#_stealthy increases by 2. In addition, you can expend one use of mythic power to treat an [Escape Artist](skill_dir/escapeArtist#_escape-artist or [Stealth](skill_dir/stealth#_stealth) check as if you had rolled a natural 20. You must decide to use this ability before making the roll.
...
**Prerequisite** : [Strong Comeback](ultimateComba_dir/ultimateCombatFeats#_strong-comeback.

**Benefit** : Whenever you're allowed to reroll an ability check, a skill check, or a saving throw, roll two dice and take the higher result, before adding the bonus from [Strong Comeback](ultimateComba_dir/ultimateCombatFeats#_strong-comeback).
...
**Benefit** : [Toughness](feats#_toughness provides you twice as many hit points. In addition, when you're below 0 hit points, you gain DR 10/epic. This DR stacks with any other DR/epic you might possess.
...
**Prerequisite** : [Tripping Staff](ultimateMagi_dir/ultimateMagicFeats#_tripping-staff).
...
**Prerequisite** : [Undead Master](ultimateMagi_dir/ultimateMagicFeats#_undead-master.

**Benefit** : When you cast _ [animate dead](spell_dir/animateDead#_animate-dead) _or use the [Command Undead](feats#_command-undead feat, add your tier to your caster level when determining the number of Hit Dice of undead you animate. This stacks with the increased caster level of [Undead Master](ultimateMagi_dir/ultimateMagicFeats#_undead-master. When you cast _ [command undead](spell_dir/commandUndead#_command-undead)_, your duration is tripled rather than doubled.
...
**Benefit** : When you successfully bull rush an opponent off his mount with Unseat, your opponent takes 1d6 points of falling damage per 2 tiers you possess. Items or abilities that reduce falling damage, such as a successful [Acrobatics](skill_dir/acrobatics#_acrobatics) check, can reduce the damage dealt by the impact.

Valiant Vault (Mythic)

Your mount can make heroic leaps.

**Prerequisites** : [Mounted Combat](feats#_mounted-combat, Ride-By Attack, [Ride](skill_dir/ride#_ride 5 ranks.

**Benefit** : Your mount is always considered to have a running start when using [Acrobatics](skill_dir/acrobatics#_acrobatics to jump. You can expend one use of mythic power to grant your mount a +10 bonus on an [Acrobatics](skill_dir/acrobatics#_acrobatics check, or a +20 bonus if the check is made to jump.

When making a mounted charge, you can guide your mount to leap over a foe between your starting position and the target of your charge. You make a [Ride](skill_dir/ride#_ride check or your mount makes an [Acrobatics](skill_dir/acrobatics#_acrobatics) check (whichever is lower during the charge, using the rules for the leap task under the [Ride](skill_dir/ride#_ride) skill. If the height you clear with that check exceeds the creature's height, you jump over it and continue your charge on the opposite side. This movement provokes attacks of opportunity. Alternatively, you can vault over your target while making a Ride-By Attack, allowing you to move over or through its space and continue moving on the opposite side of it. If your jump exceeds the target's height, you gain a +1 bonus on the attack roll for higher ground, and if any of your allies threatens the target, you treat the target as flanked for purposes of your Ride-By Attack.
...
**Prerequisite** : [Voice of the Sibyl](ultimateMagi_dir/ultimateMagicFeats#_voice-of-the-sibyl.

**Benefit** : You gain a +1 bonus on all [Bluff](skill_dir/bluff#_bluff, [Diplomacy](skill_dir/diplomacy#_diplomacy, and [Perform](skill_dir/perform#_perform) (oratory skill checks for every 3 tiers you possess. This bonus stacks with the bonus from [Voice of the Sibyl](ultimateMagi_dir/ultimateMagicFeats#_voice-of-the-sibyl). If you have 10 or more ranks in at least two of these skills, gain a +2 bonus to the DC of any language-dependent spell you cast.

Warrior Priest (Mythic

Your faith speeds you in battle and further strengthens your mind and confidence.

**Prerequisite** : [Warrior Priest](ultimateMagi_dir/ultimateMagicFeats#_warrior-priest.

**Benefit** : You gain a bonus equal to half your tier both on initiative checks and on concentration checks to cast a spell or use a spell-like ability when casting defensively or while grappled. These bonuses stack with the bonuses from [Warrior Priest](ultimateMagi_dir/ultimateMagicFeats#_warrior-priest).
...
**Benefit** : When using [Weapon Finesse](feats#_weapon-finesse), you may also use your Dexterity modifier instead of your Strength modifier on your damage rolls. If you carry a shield, its armor check penalty doesn't apply to either the attack rolls or the damage rolls.

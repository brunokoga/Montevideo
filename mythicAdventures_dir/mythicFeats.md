...
| Titan Strike (Mythic) | [Improved Unarmed Strike](mythicAdventures/mythicFeats#_improved-unarmed-strike) | Your unarmed strike deals damage as if you were one size category larger |
...
| --- | --- | --- |
| Accursed Hex (Mythic) | [Accursed Hex](ultimateMagic/ultimateMagicFeats#_accursed-hex) | Target [Accursed Hex](ultimateMagi_dir/ultimateMagicFeats#_accursed-hex) must roll second save twice and take lower result |
| Acrobatic (Mythic) | [Acrobatic](feats#_acrobatic) | Gain an additional +2 bonus on [Acrobatic](feats#_acrobatic) and [Fly](skills/fly#_fly), and expend mythic power to treat one of these checks as if you rolled a 20 |
| Alertness (Mythic) | [Alertness](feats#_alertness) | Gain an additional +2 bonus on [Perception](skill_dir/perception#_perception) and [Sense Motive](skills/senseMotive#_sense-motive) checks, and expend mythic power to treat one of these checks as if you rolled a 20 |
...
| Animal Affinity (Mythic) | [Animal Affinity](feats#_animal-affinity) | Gain an additional +2 bonus on [Handle Animal](skill_dir/handleAnimal#_handle-animal) and [Ride](skills/ride#_ride) checks, and expend mythic power to use _ [speak with animals](spell_dir/speakWithAnimals#_speak-with-animals)_ |
...
| Arcane Blast (Mythic) | [Arcane Blast](advanced/advancedFeats#_arcane-blast) | Halve the damage to perform trip or bull rush |
...
| Aspect of the Beast (Mythic) | [Aspect of the Beast](advanced/advancedFeats#_aspect-of-the-beast) | Aspect manifests itself in new and powerful ways |
| Athletic (Mythic) | [Athletic](feats#_athletic) | Gain an additional +2 bonus on [Climb](skill_dir/climb#_climb) and [Swim](skills/swim#_swim) checks, and expend mythic power to treat one of these checks as if you rolled a 20 |
...
| Charge Through (Mythic) | [Charge Through](advanced/advancedFeats#_charge-through) | Ignore allies and make overruns when you charge through |
...
| Critical Mastery (Mythic) | [Critical Focus](mythicAdventures/mythicFeats#_critical-focus), [Critical Mastery](feats#_critical-mastery) | Deal additional critical feats based on mythic tier |
...
| Death from Above (Mythic) | [Death from Above](ultimateCombat/ultimateCombatFeats#_death-from-above) | Increase critical threat modifier and make a trip combat maneuver when charging from above |
| Deceitful (Mythic) | [Deceitful](feats#_deceitful) | Gain an additional +2 bonus on [Bluff](skill_dir/bluff#_bluff) and [Disguise](skills/disguise#_disguise), and expend mythic power to treat one of these checks as if you rolled a 20 |
...
| Deft Hands (Mythic) | [Deft Hand](feats#_deft-hand) | Gain an additional +2 bonus on [Disable Device](skill_dir/disableDevice#_disable-device) and [Sleight of Hand](skills/sleightOfHand#_sleight-of-hand), and expend mythic power to treat one of these checks as if you rolled a 20 |
| Detect Expertise (Mythic) | [Detect Expertise](ultimateMagi_dir/ultimateMagicFeats#_detect-expertise) | Gain the benefit of [Detect Expertise](ultimateMagic/ultimateMagicFeats#_detect-expertise) immediately |
...
| Divine Interference (Mythic) | [Divine Interference](ultimateMagic/ultimateMagicFeats#_divine-interference) | Double or triple the penalty on your opponent's attack roll |
...
| Eagle Eyes (Mythic) | [Eagle Eyes](advanced/advancedFeats#_eagle-eyes) | Ignore [Perception](skill_dir/perception#_perception) distance penalties |
| Eldritch Heritage (Mythic) | [Eldritch Heritage](ultimateMagic/ultimateMagicFeats#_eldritch-heritage) | Gain increased bloodline powers |
| Elemental Channel (Mythic) | [Elemental Channel](feats#_elemental-channel) | Affect any elemental subtype |
| Elemental Fist (Mythic) | [Elemental Fist](advance_dir/advancedFeats#_elemental-fist) | Increase damage and frequency of [Elemental Fist](advanced/advancedFeats#_elemental-fist) |
...
| Elven Accuracy (Mythic) | [Elven Accuracy](advanced/advancedFeats#_elven-accuracy) | Ignore concealment with bows |
...
| Fire Music (Mythic) | [Fire Music](ultimateMagic/ultimateMagicFeats#_fire-music) | [Fire Music](ultimateMagi_dir/ultimateMagicFeats#_fire-music) ignores fire resistance based on tier |
| Fleet (Mythic) | [Fleet](feats#_fleet) | Land speed increases by 5 feet regardless of armor or encumbrance |
| Furious Focus (Mythic) | [Furious Focus](advanced/advancedFeats#_furious-focus) | Ignore [Power Attack](feats#_power-attack) penalties when using [Furious Focus](advance_dir/advancedFeats#_furious-focus) |
| Gnome Trickster (Mythic) | [Gnome Trickster](advanced/advancedFeats#_gnome-trickster) | Gain more spell-like abilities and use your gnome spell-like abilities more often |
...
| Heroic Defiance (Mythic) | [Heroic Defiance](advanced/advancedFeats#_heroic-defiance) | Once per day, attempt to negate the onset of a harmful condition or affliction |
...
| Improved Dirty Trick (Mythic) | [Improved Dirty Trick](advanced/advancedFeats#_improved-dirty-trick) | Gain a bonus on dirty tricks based on mythic tier |
...
| Improved Reposition (Mythic) | [Improved Reposition](advanced/advancedFeats#_improved-reposition) | Gain a bonus on repositions based on mythic tier |
...
| Improved Stonecunning (Mythic) | [Improved Stonecunning](advanced/advancedFeats#_improved-stonecunnin) | Gain _ [stone tell](spell_dir/stoneTell#_stone-tell)_ as a spell-like ability |
...
| Intimidating Prowess (Mythic) | [Intimidating Prowess](feats#_intimidating-prowess) | Gain a bonus on [Intimidate](skills/intimidate#_intimidate) against non-mythic creatures based on mythic tier |
...
| Lucky Halfling (Mythic) | [Lucky Halfling](advanced/advancedFeats#_lucky-halflin) | Increase the bonus based on tier and expend mythic power to negate the effects of a successful save |
| Lunge (Mythic) | [Lunge](feats#_lunge) | When you hit with lunge, don't take an AC penalty against that creature |
| Magical Aptitude (Mythic) | [Magical Aptitude](feats#_magical-aptitude) | Gain an additional +2 bonus on [Spellcraft](skill_dir/spellcraft#_spellcraft) and [Use Magic Device](skills/useMagicDevice#_use-magic-device), and expend mythic power to treat one of these checks as if you rolled a 20 |
...
| Persuasive (Mythic) | [Persuasive](feats#_persuasive) | Gain an additional +2 bonus on [Diplomacy](skill_dir/diplomacy#_diplomacy) and [Intimidate](skills/intimidate#_intimidate), and expend mythic power to treat one of these checks as if you rolled a 20 |
...
| Prophetic Visionary (Mythic) | [Prophetic Visionary](ultimateMagic/ultimateMagicFeats#_prophetic-visionary) | Use _ [augury](spell_dir/augury#_augury)_ at will |
| Quick Draw (Mythic) | [Quick Draw](feats#_quick-draw) | Draw any item as a free action, expend mythic power to draw two items |
| Racial Heritage (Mythic) | [Racial Heritage](advanced/advancedFeats#_racial-heritage) | Gain a single racial trait of your choice |
...
| Rhetorical Flourish (Mythic) | [Rhetorical Flourish](ultimateCombat/ultimateCombatFeats#_rhetorical-flourish) | Increase the bonus on [Diplomacy](skill_dir/diplomacy#_diplomacy) checks based on mythic tier |
...
| Saving Shield (Mythic) | [Saving Shield](advanced/advancedFeats#_saving-shield) | When you negate an attack, make attack of opportunity against attacker |
...
| Self-Sufficient (Mythic) | [Self-Sufficient](feats#_self-sufficient) | Gain an additional +2 bonus on [Heal](skills/heal#_heal) and [Survival](skill_dir/survival#_survival), and expend mythic power to treat one of these checks as if you rolled a 20 |
...
| Snatch Arrows (Mythic) | [Snatch](monsters/monsterFeats#_snatch) Arrows | Use snatched thrown weapons as immediate attack melee weapons |
| Sociable (Mythic) | [Sociable](advance_dir/advancedFeats#_sociable) | Increase the bonus on [Diplomacy](skills/diplomacy#_diplomacy) or gain the normal bonus without an action |
...
| Stealthy (Mythic) | [Stealthy](feats#_stealthy) | Gain an additional +2 bonus on [Escape Artist](skills/escapeArtist#_escape-artist) and [Stealth](skill_dir/stealth#_stealth), and expend mythic power to treat one of these checks as if you rolled a 20 |
| Strike Back (Mythic) | [Strike Back](feats#_strike-back) | Move toward the subject of your readied action attack |
| Strong Comeback (Mythic) | [Strong Comeback](ultimateCombat/ultimateCombatFeats#_strong-comeback) | When rerolling, roll twice and take the higher result |
...
| Undead Master (Mythic) | [Undead Master](ultimateMagic/ultimateMagicFeats#_undead-master) | Add your mythic tier to your caster level to determine number of undead animated |
...
| Voice of the Sibyl (Mythic) | [Voice of the Sibyl](ultimateMagi_dir/ultimateMagicFeats#_voice-of-the-sibyl) | Increase [Bluff](skills/bluff#_bluff), [Diplomacy](skill_dir/diplomacy#_diplomacy), and [Perform](skills/perform#_perform) (oratory) skill bonus based on mythic tier |
...
| Witch Knife (Mythic) | [Witch Knife](ultimateMagic/ultimateMagicFeats#_witch-knife) | Use your witch knife as a focus for all spells, not just patron spells |
...
**Benefit** : When you use [Accursed Hex](ultimateMagic/ultimateMagicFeats#_accursed-hex) to target a creature with one of your hexes a second time, that creature must roll its saving throw twice and take the lower result.
...
**Benefit** : The bonus on [Acrobatics](skill_dir/acrobatics#_acrobatics) and [Fly](skills/fly#_fly) skill checks from [Acrobatic](feats#_acrobatic) increases by 2. In addition, you can expend one use of mythic power to treat an [Acrobatics](skill_dir/acrobatics#_acrobatics) or [Fly](skills/fly#_fly) check as if you had rolled a natural 20. You must decide to use this ability before making the roll.
...
**Benefit** : The bonus on [Perception](skill_dir/perception#_perception) and [Sense Motive](skills/senseMotive#_sense-motive) skill checks from [Alertness](feats#_alertness) increases by 2. In addition, you can expend one use of mythic power to treat a [Perception](skill_dir/perception#_perception) or [Sense Motive](skills/senseMotive#_sense-motive) check as if you had rolled a natural 20. You must decide to use this ability before making the roll.
...
**Benefit** : The bonus on [Handle Animal](skill_dir/handleAnimal#_handle-animal) and [Ride](skills/ride#_ride) skill checks from [Animal Affinity](feats#_animal-affinity) increases by 2. In addition, you can expend one use of mythic power to _ [speak with animals](spell_dir/speakWithAnimals#_speak-with-animals) _as the spell. Your caster level for this effect is equal to twice your tier.
...
**Prerequisite** : [Arcane Blast](advanced/advancedFeats#_arcane-blast).

**Benefit** : When you use [Arcane Blast](advance_dir/advancedFeats#_arcane-blast), you may halve the damage dice to also perform your choice of either a trip or bull rush combat maneuver against the target of the blast. You can't move with an opponent you bull rush with this feat. You gain a bonus on your combat maneuver check for this attempt equal to half the spell level of the spell you sacrificed when using [Arcane Blast](advanced/advancedFeats#_arcane-blast), and you can substitute your Intelligence or Charisma modifier in place of your Strength modifier when determining your combat maneuver bonus.
...
**Prerequisite** : [Arcane Shield](advanced/advancedFeats#_arcane-shield).
...
**Prerequisite** : [Aspect of the Beast](advanced/advancedFeats#_aspect-of-the-beast).
...
_Mythic Leap (Ex)_: You can make a running jump without needing to run 10 feet beforehand. In addition, you gain a +5 bonus on your [Acrobatics](skill_dir/acrobatics#_acrobatics) checks to determine the success of that jump and the distance covered. If you already have the predator's leap manifestation of [Aspect of the Beast](advanced/advancedFeats#_aspect-of-the-beast), the bonus on your [Acrobatics](skill_dir/acrobatics#_acrobatics) checks increases to +10.

_Mythic Instinct (Ex)_: You gain a +2 bonus on initiative checks and a +2 bonus on [Survival](skills/survival#_survival) checks. These bonuses stack with those gained from the wild instinct manifestation of [Aspect of the Beast](advance_dir/advancedFeats#_aspect-of-the-beast).
...
**Benefit** : The bonus on [Climb](skills/climb#_climb) and [Swim](skill_dir/swim#_swim) skill checks from [Athletic](feats#_athletic) increases by 2. In addition, you can expend one use of mythic power to treat a [Climb](skills/climb#_climb) or [Swim](skill_dir/swim#_swim) check as if you had rolled a natural 20. You must decide to use this ability before making the roll.
...
**Benefit** : When charging, you can ignore allies in your path when determining whether or not you can charge your target. Furthermore, after you have attempted at least one overrun with [Charge Through](advanced/advancedFeats#_charge-through), you can expend one use of mythic power as a free action to attempt another overrun against a different opponent in the path of the same charge.
...
**Prerequisite** : [Dastardly Finish](advanced/advancedFeats#_dastardly-finish).
...
**Prerequisite** : [Death from Above](ultimateCombat/ultimateCombatFeats#_death-from-above).
...
**Benefit** : The bonus on [Bluff](skill_dir/bluff#_bluff) and [Disguise](skills/disguise#_disguise) skill checks from [Deceitful](feats#_deceitful) increases by 2. In addition, you can expend one use of mythic power to treat a [Bluff](skill_dir/bluff#_bluff) or [Disguise](skills/disguise#_disguise) check as if you had rolled a natural 20. You must decide to use this ability before making the roll.
...
**Benefit** : The bonus on [Disable Device](skills/disableDevice#_disable-device) and [Sleight of Hand](skill_dir/sleightOfHand#_sleight-of-hand) skill checks from [Deft Hands](feats#_deft-hands) increases by 2. In addition, you can expend one use of mythic power to treat a [Disable Device](skills/disableDevice#_disable-device) or [Sleight of Hand](skill_dir/sleightOfHand#_sleight-of-hand) check as if you had rolled a natural 20. You must decide to use this ability before making the roll.

Detect Expertise (Mythic)

You can sense a creature's magical abilities with just a mere glance.

**Prerequisite** : [Detect Expertise](ultimateMagic/ultimateMagicFeats#_detect-expertise).

**Benefit** : You gain the benefit of [Detect Expertise](ultimateMagi_dir/ultimateMagicFeats#_detect-expertise) immediately (without needing to observe a creature for 3 rounds) when using the divinations listed in [Detect Expertise](ultimateMagic/ultimateMagicFeats#_detect-expertise). Non-mythic creatures cannot attempt a Will save to resist this effect.
...
**Prerequisite** : [Divine Interference](ultimateMagic/ultimateMagicFeats#_divine-interference).
...
**Prerequisite** : [Dreadful Carnage](advanced/advancedFeats#_dreadful-carnage).

**Benefit** : When you use [Dreadful Carnage](advance_dir/advancedFeats#_dreadful-carnage), you affect non-mythic enemies within 60 feet in addition to all enemies within 30 feet. You can expend one use of mythic power before making the [Intimidate](skills/intimidate#_intimidate) check to cause enemies demoralized by [Dreadful Carnage](advance_dir/advancedFeats#_dreadful-carnage) to become frightened instead of shaken, for the same duration as the normal shaken effect. While frightened by this ability, an enemy takes a penalty equal to your tier on attack rolls, saving throws, skill checks, and ability checks.
...
**Prerequisites** : [Eagle Eyes](advanced/advancedFeats#_eagle-eyes).
...
**Benefit** : The extra energy damage dealt by [Elemental Fist](advanced/advancedFeats#_elemental-fist) increases to 1d8 points, and you gain additional uses of [Elemental Fist](advance_dir/advancedFeats#_elemental-fist) per day equal to your tier. You can expend one use of mythic power as an immediate action to add the extra damage from your [Elemental Fist](advanced/advancedFeats#_elemental-fist) to all of the unarmed strikes you make until the beginning of your next turn. This counts as only one use of [Elemental Fist](advance_dir/advancedFeats#_elemental-fist), regardless of the number of attacks that you make in this fashion.

Elemental Focus (Mythic)

Your elemental spells are potent and effective.

**Prerequisite** : [Elemental Focus](advanced/advancedFeats#_elemental-focus).

**Benefit** : Choose an energy type in which you already have [Elemental Focus](advance_dir/advancedFeats#_elemental-focus). The increase to save DC provided by [Elemental Focus](advanced/advancedFeats#_elemental-focus) and [Greater Elemental Focus](advance_dir/advancedFeats#_greater-elemental-focus) for spells of the selected energy type is 1 higher. When casting a spell with this energy type's descriptor, you can expend one use of mythic power as part of the casting to force the spell's targets to roll their saving throws twice, taking the lower result.

Elven Accuracy (Mythic)

Your elven eyesight cuts though concealment.

**Prerequisite** : [Elven Accuracy](advanced/advancedFeats#_elven-accuracy).
...
**Benefit** : Non-mythic creatures can't identify your illusion spells with [Spellcraft](skills/spellcraft#_spellcraft), including checks attempted as part of _ [arcane sight](spell_dir/arcaneSight#_arcane-sight)_, _ [detect magic](spells/detectMagic#_detect-magic)_, or similar effects. When mythic creatures attempt to identify your illusions, add your tier to the DC of those [Spellcraft](skill_dir/spellcraft#_spellcraft) checks. Mythic creatures informed by their allies that one of your illusions isn't real gain only a +2 bonus on their Will saves to disbelieve. Non-mythic creatures gain no bonus to disbelieve.
...
**Prerequisite** : [Fast Empathy](ultimateMagic/ultimateMagicFeats#_fast-empathy).
...
**Benefit** : When you use [Fire Music](ultimateMagic/ultimateMagicFeats#_fire-music) to change any of the damage dealt by a bard spell to fire damage, that damage ignores fire resistance up to your tier.

If you cast _summon monster_ as a bard spell and choose to give the summoned creature a fiery appearance, increase its fire resistance by 5 (adding to the resistance already granted by [Fire Music](ultimateMagi_dir/ultimateMagicFeats#_fire-music)) and add 1d4 points of fire damage to all of its natural attacks instead of the +1 fire damage normally granted by [Fire Music](ultimateMagic/ultimateMagicFeats#_fire-music). Creatures with the fire subtype also gain these benefits.
...
**Benefit** : You gain the following spell-like abilities: 1/day—_ [blur](spell_dir/blur#_blur)_ and _ [vanish](advanced/spell_dir/vanish#_vanish)_.
...
**Prerequisite** : [Guided Hand](ultimateCombat/ultimateCombatFeats#_guided-hand).
...
This effect is separate from the use of non-mythic [Heroic Defiance](advanced/advancedFeats#_heroic-defiance).
...
**Benefit** : As a swift action, you can expend one use of mythic power to use [Heroic Recovery](advanced/advancedFeats#_heroic-recovery) additional times. Whenever you do, add your tier to the result of the Fortitude save.
...
**Benefit** : You gain a bonus equal to half your tier on checks to attempt a dirty trick, and to your CMD when an opponent attempts to perform a dirty trick on you. These bonuses stack with those granted by [Improved Dirty Trick](advanced/advancedFeats#_improved-dirty-trick).
...
**Benefit** : You gain a bonus equal to half your tier on checks to attempt a drag combat maneuver, and to your CMD when an opponent attempts a drag combat maneuver against you. These bonuses stack with those granted by [Improved Drag](advanced/advancedFeats#_improved-drag).
...
**Benefit** : You gain a bonus equal to half your tier on checks to attempt a reposition combat maneuver, and to your CMD when an opponent attempts to perform a reposition combat maneuver against you. These bonuses stack with those granted by [Improved Reposition](advanced/advancedFeats#_improved-reposition).
...
**Benefit** : You gain a bonus equal to half your tier on checks to attempt a steal combat maneuver, and to your CMD when an opponent attempts a steal combat maneuver on you. These bonuses stack with those granted by [Improved Steal](advanced/advancedFeats#_improved-steal).
...
**Benefit** : You gain _ [stone tell](spells/stoneTell#_stone-tell)_ as a spell-like ability usable once per day with a caster level equal to twice your tier.
...
**Prerequisite** : [Lucky Halfling](advanced/advancedFeats#_lucky-halflin).
...
**Benefit** : The bonus on [Spellcraft](skills/spellcraft#_spellcraft) and [Use Magic Device](skill_dir/useMagicDevice#_use-magic-device) skill checks from [Magical Aptitude](feats#_magical-aptitude) increases by 2. In addition, you can expend one use of mythic power to treat a [Spellcraft](skills/spellcraft#_spellcraft) or [Use Magic Device](skill_dir/useMagicDevice#_use-magic-device) check as if you had rolled a natural 20. You must decide to use this ability before making the roll.
...
**Benefit** : You can use the [surge ability](mythicAdventures/mythicHeroes#_surge-ability) once per day (adding 1d6). If you are or become mythic, you can use your surge one additional time per day.
...
**Benefit** : When using [Missile Shield](advanced/advancedFeats#_missile-shield), you can deflect an additional number of ranged attacks per round equal to half your tier. You can expend one use of mythic power as an immediate action to deflect a single ray from a ray spell or effect targeting you.
...
**Benefit** : The bonus on [Diplomacy](skill_dir/diplomacy#_diplomacy) and [Intimidate](skills/intimidate#_intimidate) skill checks granted by [Persuasive](feats#_persuasive) increases by 2. In addition, you can expend one use of mythic power to treat a [Diplomacy](skill_dir/diplomacy#_diplomacy) or [Intimidate](skills/intimidate#_intimidate) check as if you had rolled a natural 20. You must decide to use this ability before making the roll.
...
**Benefit** : You can apply the giant simple template (quick rules version, from _Pathfinder RPG Bestiary_ 295) to any form you take with wild shape. This replaces the benefit from [Powerful Shape](ultimateMagic/ultimateMagicFeats#_powerful-shape).
...
**Prerequisite** : [Prophetic Visionary](ultimateMagic/ultimateMagicFeats#_prophetic-visionary).

**Benefit** : You can use [Prophetic Visionary](ultimateMagi_dir/ultimateMagicFeats#_prophetic-visionary)'s _ [augury](spells/augury#_augury)_ ability at will, spending 10 minutes in a deep trance each time. Your chance of a successful _ [augury](spell_dir/augury#_augury)_ increases by 1% per tier. A successful _ [augury](spells/augury#_augury) _made by using this feat also grants you the benefits of _ [guidance](spell_dir/guidance#_guidance)_, but the bonus is equal to your tier and is an insight bonus instead of a competence bonus.
...
**Prerequisite** : [Racial Heritage](advanced/advancedFeats#_racial-heritage).
...
**Prerequisite** : [Rapid Reload](ultimateCombat/ultimateCombatFeats#_rapid-reload).
...
**Prerequisites** : [Rhetorical Flourish](ultimateCombat/ultimateCombatFeats#_rhetorical-flourish).

**Benefit** : When you successfully use [Rhetorical Flourish](ultimateComba_dir/ultimateCombatFeats#_rhetorical-flourish) against a non-mythic creature, the bonus on your [Diplomacy](skills/diplomacy#_diplomacy) check increases by your tier. If the target is a mythic creature, you instead increase the bonus by half your tier.
...
**Benefit** : Whenever you are using Scorpion Style, you add your tier to the number of rounds the target's base land speed is reduced. You can expend one use of mythic power when making your attack to slow your target, as the spell _ [slow](spells/slow#_slow)_, unless it succeeds at a Fortitude save (DC 10 + 1/2 your character level + your Wisdom modifier). The slowing effect supersedes the normal speed penalty of your Scorpion Strike, but lasts for an equal number of rounds.
...
**Benefit** : The bonus on [Heal](skill_dir/heal#_heal) and [Survival](skills/survival#_survival) skill checks from [Self-Sufficient](feats#_self-sufficient) increases by 2. In addition, you can expend one use of mythic power to treat a [Heal](skill_dir/heal#_heal) or [Survival](skills/survival#_survival) check as if you had rolled a natural 20. You must decide to use this ability before making the roll.
...
**Prerequisite** : [Sociable](advanced/advancedFeats#_sociable).

**Benefit** : You grant and benefit from the +2 bonus on [Diplomacy](skill_dir/diplomacy#_diplomacy) checks from [Sociable](advanced/advancedFeats#_sociable) constantly without having to spend a move action. You can spend a move action to increase the bonus to +4 for a number of rounds equal to your tier.
...
**Benefit** : You can change which spell your [Spontaneous Metafocus](ultimateMagic/ultimateMagicFeats#_spontaneous-metafocus) feat applies to each morning when you restore your expended spell slots. The spell it applies to can be of any level, but it must be a legal selection for the [Spontaneous Metafocus](ultimateMagi_dir/ultimateMagicFeats#_spontaneous-metafocus) feat.

**Special** : You can gain this feat multiple times. The effects do not stack. Each time you take this feat, it applies to a different non-mythic [Spontaneous Metafocus](ultimateMagic/ultimateMagicFeats#_spontaneous-metafocus) feat.
...
**Benefit** : The bonus on [Escape Artist](skill_dir/escapeArtist#_escape-artist) and [Stealth](skills/stealth#_stealth) skill checks from [Stealthy](feats#_stealthy) increases by 2. In addition, you can expend one use of mythic power to treat an [Escape Artist](skill_dir/escapeArtist#_escape-artist) or [Stealth](skills/stealth#_stealth) check as if you had rolled a natural 20. You must decide to use this ability before making the roll.
...
**Benefit** : Whenever you're allowed to reroll an ability check, a skill check, or a saving throw, roll two dice and take the higher result, before adding the bonus from [Strong Comeback](ultimateCombat/ultimateCombatFeats#_strong-comeback).
...
**Benefit** : When you successfully bull rush an opponent off his mount with Unseat, your opponent takes 1d6 points of falling damage per 2 tiers you possess. Items or abilities that reduce falling damage, such as a successful [Acrobatics](skills/acrobatics#_acrobatics) check, can reduce the damage dealt by the impact.
...
**Benefit** : Your mount is always considered to have a running start when using [Acrobatics](skills/acrobatics#_acrobatics) to jump. You can expend one use of mythic power to grant your mount a +10 bonus on an [Acrobatics](skill_dir/acrobatics#_acrobatics) check, or a +20 bonus if the check is made to jump.

When making a mounted charge, you can guide your mount to leap over a foe between your starting position and the target of your charge. You make a [Ride](skills/ride#_ride) check or your mount makes an [Acrobatics](skill_dir/acrobatics#_acrobatics) check (whichever is lower) during the charge, using the rules for the leap task under the [Ride](skills/ride#_ride) skill. If the height you clear with that check exceeds the creature's height, you jump over it and continue your charge on the opposite side. This movement provokes attacks of opportunity. Alternatively, you can vault over your target while making a Ride-By Attack, allowing you to move over or through its space and continue moving on the opposite side of it. If your jump exceeds the target's height, you gain a +1 bonus on the attack roll for higher ground, and if any of your allies threatens the target, you treat the target as flanked for purposes of your Ride-By Attack.
...
**Prerequisite** : [Witch Knife](ultimateMagic/ultimateMagicFeats#_witch-knife).

...
| Titan Strike (Mythic) | [Improved Unarmed Strike](mythicAdventures_dir/mythicFeats#_improved-unarmed-strike) | Your unarmed strike deals damage as if you were one size category larger |
...
| Valiant Vault (Mythic) | [Mounted Combat](feats#_mounted-combat), [Ride-By Attack](feats#_ride-by-attack), [Ride](skills_dir/ride#_ride) 5 ranks | When mount leaps over foes attack as you pass |

| Mythic Enhancement Feats | Prerequisites | Benefits |
| --- | --- | --- |
| Accursed Hex (Mythic) | [Accursed Hex](ultimateMagic_dir/ultimateMagicFeats#_accursed-hex) | Target [Accursed Hex](ultimateMagic_dir/ultimateMagicFeats#_accursed-hex) must roll second save twice and take lower result |
| Acrobatic (Mythic) | [Acrobatic](feats#_acrobatic) | Gain an additional +2 bonus on [Acrobatic](feats#_acrobatic) and [Fly](skills_dir/fly#_fly), and expend mythic power to treat one of these checks as if you rolled a 20 |
| Alertness (Mythic) | [Alertness](feats#_alertness) | Gain an additional +2 bonus on [Perception](skills_dir/perception#_perception) and [Sense Motive](skills_dir/senseMotive#_sense-motive) checks, and expend mythic power to treat one of these checks as if you rolled a 20 |
...
| Animal Affinity (Mythic) | [Animal Affinity](feats#_animal-affinity) | Gain an additional +2 bonus on [Handle Animal](skills_dir/handleAnimal#_handle-animal) and [Ride](skills_dir/ride#_ride) checks, and expend mythic power to use _ [speak with animals](spells_dir/speakWithAnimals#_speak-with-animals)_ |
...
| Arcane Blast (Mythic) | [Arcane Blast](advanced_dir/advancedFeats#_arcane-blast) | Halve the damage to perform trip or bull rush |
| Arcane Shield (Mythic) | [Arcane Shield](advanced_dir/advancedFeats#_arcane-shield) | Add 1_dir/2 your mythic tier to the bonus granted by [Arcane Shield](advanced_dir/advancedFeats#_arcane-shield), and expend mythic power to extend the shield's duration |
...
| Aspect of the Beast (Mythic) | [Aspect of the Beast](advanced_dir/advancedFeats#_aspect-of-the-beast) | Aspect manifests itself in new and powerful ways |
| Athletic (Mythic) | [Athletic](feats#_athletic) | Gain an additional +2 bonus on [Climb](skills_dir/climb#_climb) and [Swim](skills_dir/swim#_swim) checks, and expend mythic power to treat one of these checks as if you rolled a 20 |
| Augment Summoning (Mythic) | [Augment Summoning](feats#_augment-summoning) | Summoned creatures are considered mythic |
| Bleeding Critical (Mythic) | [Bleeding Critical](feats#_bleeding-critical), [Critical Focus](mythicAdventures_dir/mythicFeats#_critical-focus) | Bleed damage and the DC to staunch it increases by mythic tier |
...
| Charge Through (Mythic) | [Charge Through](advanced_dir/advancedFeats#_charge-through) | Ignore allies and make overruns when you charge through |
...
| Heroic Recovery (Mythic) | [Heroic Recovery](advanced_dir/advancedFeats#_heroic-recovery) | Expend mythic power to save again against a condition or affliction |
...
| Tripping Staff (Mythic) | [Tripping Staff](ultimateMagic_dir/ultimateMagicFeats#_tripping-staff) | Your CMD against trips is increased based on tier and those who trip you and fail provoke an attack of opportunity from you |
...
**Prerequisite** : [Arcane Blast](advanced_dir/advancedFeats#_arcane-blast).
...
**Benefit** : Your mount is always considered to have a running start when using [Acrobatics](skills_dir/acrobatics#_acrobatics) to jump. You can expend one use of mythic power to grant your mount a +10 bonus on an [Acrobatics](skills_dir/acrobatics#_acrobatics) check, or a +20 bonus if the check is made to jump.

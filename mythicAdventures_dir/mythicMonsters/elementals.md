...
N Huge outsider ( [air](monsters/creatureTypes.md#_air-subtype), [elemental](monsters/creatureTypes.md#_elemental-subtype), [extraplanar](monsters/creatureTypes.md#_extraplanar-subtype), [mythic](mythicAdventures/mythicMonsters.md#_mythic-subtype))

**Init** +15; **Senses** darkvision 60 ft.; [Perception](skills/perception.md#_perception) +20
...
**Defensive Abilities** [air](monsters/creatureTypes.md#_air-subtype) mastery; **DR** 10/—; **Immune** [elemental](monsters/creatureTypes.md#_elemental-subtype) traits

Offense

**Speed** fly 100 ft. (perfect)

**Melee** 2 slams +25 (4d8+11 plus [grab](monsters/universalMonsterRules.md#_grab))

**Space** 15 ft.; **Reach** 15 ft.

**Special Attacks** create vacuum, elevated ejection, [fast swallow](monsters/universalMonsterRules.md#_fast-swallow), mythic power (5/day, surge +1d8), swallow whole (2d8+9 bludgeoning damage, AC 14, 20 hp, DR 10/—), [whirlwind](monsters/universalMonsterRules.md#_whirlwind) (at will, 10–60 ft. high, 2d8+9 damage, DC 27)
...
**Feats** [Blind-Fight](feats.md#_blind-fight), [Cleave](mythicAdventures/mythicFeats.md#_cleave-mythic)M, [Combat Reflexes](feats.md#_combat-reflexes), [Dodge](feats.md#_dodge), [Flyby Attack](monsters/monsterFeats.md#_flyby-attack), [Improved Initiative](feats.md#_improved-initiative)B, [Iron Will](mythicAdventures/mythicFeats.md#_iron-will-mythic)M, [Mobility](feats.md#_mobility), [Power Attack](feats.md#_power-attack), [Weapon Finesse](feats.md#_weapon-finesse)B, M

**Skills** [Acrobatics](skills/acrobatics.md#_acrobatics) +30, [Escape Artist](skills/escapeArtist.md#_escape-artist) +30, [Fly](skills/fly.md#_fly) +34, [Knowledge](skills/knowledge.md#_knowledge) (planes) +20, [Perception](skills/perception.md#_perception) +20, [Sense Motive](skills/senseMotive.md#_sense-motive) +20, [Stealth](skills/stealth.md#_stealth) +22
...
N Huge outsider ( [earth](monsters/creatureTypes.md#_earth-subtype), [elemental](monsters/creatureTypes.md#_elemental-subtype), [extraplanar](monsters/creatureTypes.md#_extraplanar-subtype), [mythic](mythicAdventures/mythicMonsters.md#_mythic-subtype))

**Init** –1; **Senses** darkvision 60 ft., tremorsense 60 ft.; [Perception](skills/perception.md#_perception) +20
...
**Defensive Abilities** trap weapon; **DR** 10/—; **Immune** [elemental](monsters/creatureTypes.md#_elemental-subtype) traits
...
**Special Attacks** [earth](monsters/creatureTypes.md#_earth-subtype) mastery, mythic power (5/day, surge +1d8), petrify, stun, trample (4d6+18, DC 30)

**Spell-Like Abilities** (CL 16th; concentration +16)

At will—_ [stone shape](spells/stoneShape.md#_stone-shape)_

5/day—_ [transmute mud to rock](spells/transmuteMudToRock.md#_transmute-mud-to-rock)_ (DC 15)
...
**Feats** [Awesome Blow](monsters/monsterFeats.md#_awesome-blow), [Cleave](mythicAdventures/mythicFeats.md#_cleave-mythic)M, [Greater Bull Rush](feats.md#_greater-bull-rush), [Greater Overrun](feats.md#_greater-overrun), [Improved Bull Rush](feats.md#_improved-bull-rush)B, [Improved Critical](mythicAdventures/mythicFeats.md#_improved-critical-mythic) (slam)M, [Improved Overrun](feats.md#_improved-overrun), [Improved Sunder](feats.md#_improved_sunder), [Power Attack](mythicAdventures/mythicFeats.md#_power-attack-mythic)M

**Skills** [Appraise](skills/appraise.md#_appraise) +20, [Climb](skills/climb.md#_climb) +31, [Knowledge](skills/knowledge.md#_knowledge) (dungeoneering) +20, [Knowledge](skills/knowledge.md#_knowledge) (planes) +20, [Perception](skills/perception.md#_perception) +20, [Sense Motive](skills/senseMotive.md#_sense-motive) +20, [Stealth](skills/stealth.md#_stealth) +10
...
N Huge outsider ( [elemental](monsters/creatureTypes.md#_elemental-subtype), [extraplanar](monsters/creatureTypes.md#_extraplanar-subtype), [fire](monsters/creatureTypes.md#_fire-subtype), [mythic](mythicAdventures/mythicMonsters.md#_mythic-subtype))

**Init** +13; **Senses** darkvision 60 ft.; [Perception](skills/perception.md#_perception) +20

**Aura** frightful presence (60 ft., DC 18), shroud of flame (15 ft., 2d6 [fire](monsters/creatureTypes.md#_fire-subtype), DC 22), smoke cloud (10 ft., DC 22)
...
**DR** 10/—; **Immune** [elemental](monsters/creatureTypes.md#_elemental-subtype) traits, [fire](monsters/creatureTypes.md#_fire-subtype)
...
At will—_ [produce flame](spells/produceFlame.md#_produce-flame)_

5/day—_ [flame arrow](spells/flameArrow.md#_flame-arrow)_, _ [wall of fire](spells/wallOfFire.md#_wall-of-fire)_
...
**Feats** [Blind-Fight](feats.md#_blind-fight), [Combat Reflexes](mythicAdventures/mythicFeats.md#_combat-reflexes-mythic)M, [Dodge](mythicAdventures/mythicFeats.md#_dodge-mythic)M, [Improved Initiative](feats.md#_improved-initiative)B, [Iron Will](mythicAdventures/mythicFeats.md#_iron-will-mythic)M, [Lightning Stance](feats.md#_lightning-stance), [Mobility](feats.md#_mobility), [Spring Attack](feats.md#_spring-attack), [Weapon Finesse](feats.md#_weapon-finesse)B, [Wind Stance](feats.md#_wind-stance)

**Skills** [Acrobatics](skills/acrobatics.md#_acrobatics) +28 (+40 when jumping), [Climb](skills/climb.md#_climb) +27, [Escape Artist](skills/escapeArtist.md#_escape-artist) +28, [Intimidate](skills/intimidate.md#_intimidate) +19, [Knowledge](skills/knowledge.md#_knowledge) (planes) +20, [Perception](skills/perception.md#_perception) +20, [Sense Motive](skills/senseMotive.md#_sense-motive) +20
...
**Smoke Cloud (Ex)** As a swift action, a mythic fire elemental can create a choking cloud of smoke. This cloud is equivalent to that of _ [pyrotechnics](spells/pyrotechnics.md#_pyrotechnics)_ and lasts 1 minute. Fire elementals are immune to the effects of this ability.
...
N Huge outsider ( [elemental](monsters/creatureTypes.md#_elemental-subtype), [extraplanar](monsters/creatureTypes.md#_extraplanar-subtype), [mythic](mythicAdventures/mythicMonsters.md#_mythic-subtype), [water](monsters/creatureTypes.md#_water-subtype))

**Init** +6; **Senses** darkvision 60 ft.; [Perception](skills/perception.md#_perception) +20
...
**DR** 10/—; **Immune** [elemental](monsters/creatureTypes.md#_elemental-subtype) traits

Offense

**Speed** 20 ft., swim 90 ft.

**Melee** 4 slams +24 (2d10+10/18–20 plus [grab](monsters/universalMonsterRules.md#_grab))

**Space** 15 ft.; **Reach** 15 ft.

**Special Attacks** drench, [fast swallow](monsters/universalMonsterRules.md#_fast-swallow), mythic power (5/day, surge +1d8), pressure wave, smother, swallow whole (2d10+10 bludgeoning damage, AC 14, 20 hp, DR 10/—), vortex (at will, 10–60 ft., 2d10+10 damage, DC 28), water mastery
...
**Feats** [Cleave](feats.md#_cleave), [Dodge](mythicAdventures/mythicFeats.md#_dodge-mythic)M, [Great Cleave](feats.md#_great-cleave), [Improved Bull Rush](feats.md#_improved-bull-rush), [Improved Critical](mythicAdventures/mythicFeats.md#_improved-critical-mythic) (slam)M, [Improved Sunder](feats.md#_improved_sunder), [Lightning Reflexes](feats.md#_lightning-reflexes), [Power Attack](mythicAdventures/mythicFeats.md#_power-attack-mythic)M

**Skills** [Acrobatics](skills/acrobatics.md#_acrobatics) +25, [Escape Artist](skills/escapeArtist.md#_escape-artist) +25, [Knowledge](skills/knowledge.md#_knowledge) (planes) +20, [Perception](skills/perception.md#_perception) +20, [Sense Motive](skills/senseMotive.md#_sense-motive) +20, [Stealth](skills/stealth.md#_stealth) +17, [Swim](skills/swim.md#_swim) +37.
...
**Drench (Ex)** The elemental's touch puts out nonmagical flames of Large size or smaller. The creature can dispel magical fire it touches as _ [dispel magic](spells/dispelMagic.md#_dispel-magic)_ (caster level 16th).

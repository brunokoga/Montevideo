...
**DR** 5/slashing; **Immune** [undead traits](universalMonsterRules.md#_undead-traits)
...
Zombies are the animated corpses of dead creatures, forced into foul unlife via necromantic magic like _ [animate dead](../spells/animateDead.md#_animate-dead)_. While the most commonly encountered zombies are slow and tough, others possess a variety of traits, allowing them to spread disease or move with increased speed.
...
Although capable of following orders, zombies are more often unleashed into an area with no command other than to kill living creatures. As a result, zombies are often encountered in packs, wandering around places the living frequent, looking for victims. Most zombies are created using _ [animate dead](../spells/animateDead.md#_animate-dead)_. Such zombies are always of the standard type, unless the creator also casts _ [haste](../spells/haste.md#_haste) _or _ [remove paralysis](../spells/removeParalysis.md#_remove-paralysis) _to create fast zombies, or _ [contagion](../spells/contagion.md#_contagion)_ to create plague zombies.
...
**Feats** : A zombie loses all feats possessed by the base creature, and does not gain feats as its Hit Dice increase, but it does gain [Toughness](../feats.md#_toughness) as a bonus feat.

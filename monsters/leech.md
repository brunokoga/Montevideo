...
**Init** +1; **Senses** blindsight 30 ft., scent; [Perception](../skills/perception.md#_perception) +0
...
**Skills** [Stealth](../skills/stealth.md#_stealth) +1 (+9 in swamps), [Swim](../skills/swim.md#_swim) +8; **Racial Modifiers** +8 [Stealth](../skills/stealth.md#_stealth) in swamps
...
**Attach (Ex)** When a giant leech hits with a bite attack, it latches onto its target and automatically grapples. The giant leech loses its Dexterity bonus to AC and has an AC of 10, but holds on with great tenacity and automatically inflicts bite damage each round. A giant leech has a +8 racial bonus to maintain its grapple on a foe once it is attached. An attached giant leech can be struck with a weapon or grappled itself—if its prey manages to win a grapple check or [Escape Artist](../skills/escapeArtist.md#_escape-artist) check against it, the giant leech is removed.

**Blood Drain (Ex)** A giant leech drains blood at the end of each turn it is attached, inflicting 1 point of Strength and Constitution [damage](universalMonsterRules.md#_ability-damage-and-drain).
...
**Init** +4; **Senses** blindsight 30 ft.; [Perception](../skills/perception.md#_perception) +0
...
**Special Attacks** blood drain, [distraction](universalMonsterRules.md#_distraction) (DC 15)
...
**Skills** [Stealth](../skills/stealth.md#_stealth) +16 (+24 in swamps), [Swim](../skills/swim.md#_swim) +12; **Racial Modifiers** +8 [Stealth](../skills/stealth.md#_stealth) in swamps, uses Dexterity to modify [Swim](../skills/swim.md#_swim) checks
...
**Blood Drain (Ex)** Any living creature that begins its turn with a leech swarm in its space is drained of its blood and takes 1d3 points of Str and Con [damage](universalMonsterRules.md#_ability-damage-and-drain).

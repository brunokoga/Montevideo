...
CE Medium [monstrous humanoid](creatureTypes.md#_monstrous-humanoid) ( [aquatic](creatureTypes.md#_aquatic-subtype))

**Init** +3; **Senses** darkvision 60 ft.; [Perception](../skills/perception.md#_perception) +11
...
**Feats** [Skill Focus](../feats.md#_skill-focus) ( [Bluff](../skills/bluff.md#_bluff), [Perception](../skills/perception.md#_perception))

**Skills** [Bluff](../skills/bluff.md#_bluff) +9, [Knowledge](../skills/knowledge.md#_knowledge) (any one) +5, [Perception](../skills/perception.md#_perception) +11, [Stealth](../skills/stealth.md#_stealth) +10, [Swim](../skills/swim.md#_swim) +19
...
**Horrific Appearance (Su)** The sight of a sea hag is so revolting that anyone within 60 feet (other than another hag) who sets eyes upon one must succeed on a DC 14 Fortitude save or instantly be weakened, taking 1d6 points of Strength [damage](universalMonsterRules.md#_ability-damage-and-drain). Creatures that are affected by this power or that successfully save against it cannot be affected again by the same hag's horrific appearance for 24 hours. This is a mind-affecting effect. The save DC is Charisma-based.

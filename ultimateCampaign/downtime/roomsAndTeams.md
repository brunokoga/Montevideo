...
You can only recruit a team if the character levels of its individual members are equal to or lower than your [Leadership](feats.md#_leadership) score. Even if you don't have the [Leadership](feats.md#_leadership) feat, calculate your [Leadership](feats.md#_leadership) score as your character level + your Charisma modifier.
...
**Teams and Leadership** : One advantage of having followers from the [Leadership](feats.md#_leadership) feat is that they increase the effect of Influence and Labor you spend in a settlement. As the primary component of the price of recruiting teams is Influence, having followers in a settlement makes it easier to get the word out about the organization you want to build.

The people in your organization obey you because you pay them, or at least keep regular contact with them and direct their activities. Unlike with cohorts and followers gained from the [Leadership](feats.md#_leadership) feat (who are loyal toward you because of your reputation and behavior), if you're away from your organization for a long period of time, you might lose your connection with it. In the [Upkeep Phase section](ultimateCampaign/kingdomsAndWar/kingdomBuilding.md#_upkeep-phase), see Step 3—Determine Capital Attrition.
...
This room aids you when you're attempting [Craft](skills/craft.md#_craft) (alchemy) checks, researching new alchemist formulae, and performing similar alchemical tasks. Up to three people can use the room at a time.

Altar

**Earnings** Influence +3

**Benefit** counts as a permanent fixture dedicated to your deity for the purpose of _ [consecrate](spells/consecrate.md#_consecrate)_ and similar spells
...
**Benefit** counts as masterwork artisan's tools for one [Craft](skills/craft.md#_craft) skill
...
**Benefit** bonus on [Perform](skills/perform.md#_perform) checks
...
This large room is used for various artistic performances. It contains a stage, costumes, instruments, and seating for an audience. The superior acoustics and décor grant a +2 bonus on all [Perform](skills/perform.md#_perform) checks made in this room.
...
This large open room is intended for dances, receptions, and other elaborate events. The superior acoustics and decor grant a +2 bonus on all [Perform](skills/perform.md#_perform) checks made in this room.

Bar

**Earnings** gp or Influence +10

**Benefit** bonus on [Diplomacy](skills/diplomacy.md#_diplomacy) checks to gather information

**Create** 6 Goods, 1 Influence, 5 Labor (250 gp); **Time** 16 days

**Size** 10—20 squares

A Bar stores a selection of drinks and includes a counter for preparing them. After spending an hour with local people in this room, for the next 24 hours you gain a +1 bonus on [Diplomacy](skills/diplomacy.md#_diplomacy) checks you make to gather information in the settlement.

Bath

**Earnings** gp or Influence +3

**Benefit** bonus on Fortitude saves against [disease](bestiary3/universalMonsterRules.md#disease)
...
**Benefit** contestant gains a bonus on [Intimidate](skills/intimidate.md#_intimidate) and performance combat checks
...
**Benefit** bonus on [Knowledge](skills/knowledge.md#_knowledge) checks of one type
...
A Book Repository contains shelves upon shelves of books, in addition to chairs, desks, and tables for reading and studying. Most repositories contain books on a wide array of topics providing a general wealth of information, but some contain books focused on a specific topic. When you construct a Book Repository, select one [Knowledge](skills/knowledge.md#_knowledge) skill. If someone has a question relating to that [Knowledge](skills/knowledge.md#_knowledge) skill and is able to spend 1 hour researching in the Book Repository, she gains a +3 bonus on the [Knowledge](skills/knowledge.md#_knowledge) check to answer the question.
...
**Benefit** bonus on [Bluff](skills/bluff.md#_bluff), [Diplomacy](skills/diplomacy.md#_diplomacy), and [Intimidate](skills/intimidate.md#_intimidate) checks (see below)
...
**Benefit** counts as masterwork artisan's tools for [Craft](skills/craft.md#_craft) ( [clockwork](bestiary3/creatureTypes.md#clockwork-subtype))
...
This is a hallway or tunnel leading to a hidden exit from the building. The exit door is typically a simple wooden door with an average lock ( [Disable Device](skills/disableDevice.md#_disable-device) DC 20 to open). Either or both ends of the hallway can be secret doors ( [Perception](skills/perception.md#_perception) DC 20 to notice).

False Front

**Earnings** gp or Goods +2

**Benefit** bonus to [Perception](skills/perception.md#_perception) and [Sense Motive](skills/senseMotive.md#_sense-motive) DCs
...
**Benefit** defenders get bonus on initiative and [Perception](skills/perception.md#_perception) checks
...
**Benefit** defenders get a bonus on initiative and [Perception](skills/perception.md#_perception) checks
...
**Benefit** bonus on Fortitude saves against contracting [disease](bestiary3/universalMonsterRules.md#disease)
...
**Benefit** bonus on [Knowledge](skills/knowledge.md#_knowledge) (arcana), [Spellcraft](skills/spellcraft.md#_spellcraft), and spell research checks
...
A Magical Repository is similar to a Book Repository, but specific to the study of the arcane arts. It contains shelves of books, comfortable chairs, and tables for studying and for scribing notes and scrolls. If you construct this room from scratch, it grants someone who studies there for 1 hour a +3 bonus on a [Knowledge](skills/knowledge.md#_knowledge) (arcana) check to answer a question. If you upgrade a Book Repository into this room, you either keep the original Book Repository's bonus on [Knowledge](skills/knowledge.md#_knowledge) checks or change its skill to [Knowledge](skills/knowledge.md#_knowledge) (arcana). An hour of study in this room also grants a +3 bonus on [Spellcraft](skills/spellcraft.md#_spellcraft) checks. The room grants an additional +1 bonus on [Knowledge](skills/knowledge.md#_knowledge) (arcana) and [Spellcraft](skills/spellcraft.md#_spellcraft) checks for spell research (see Research a Spell on page 86) and crafting magic items.
...
**Benefit** bonus on [Knowledge](skills/knowledge.md#_knowledge) (geography), [Knowledge](skills/knowledge.md#_knowledge) (nature), and [Knowledge](skills/knowledge.md#_knowledge) (planes) checks

**Create** 8 Goods, 9 Labor, 1 Magic (440 gp); **Time** 20 days

**Size** 10—20 squares

This elevated room is open to the sky, has a skylight, or has a retractable roof to allow you to observe the passing of celestial bodies. An Observation Dome includes shelves containing records and notes, a telescope, and other devices dedicated to celestial study. If someone spends 1 hour researching in the Observation Dome, she gains a +2 bonus on [Knowledge](skills/knowledge.md#_knowledge) (geography), [Knowledge](skills/knowledge.md#_knowledge) (nature), and [Knowledge](skills/knowledge.md#_knowledge) (planes) checks to answer a question about the heavens.
...
**Benefit** bonus on [Knowledge](skills/knowledge.md#_knowledge) (religion) checks relating to its contents
...
**Benefit** bonus on [disease](bestiary3/universalMonsterRules.md#disease) and negative level recovery saves
...
A Scrying Room is built to be a quiet place for scrying, seances, and similar divinations. It contains a table, chairs, and either a pool of water (at no additional cost) or a suitable focus object for a scrying spell (for an additional 1,000 gp). A caster using _ [scrying](spells/scrying.md#_scrying)_, _ [locate creature](spells/locateCreature.md#_locate-creature)_, or a similar targeted divination from here increases the spell's DC by 1.
...
**Upgrades From** Vault; **Upgrades To** [Escape Route](ultimateCombat/ultimateCombatFeats.md#escape-route)
...
**Benefit** bonus on [Bluff](skills/bluff.md#_bluff), [Diplomacy](skills/diplomacy.md#_diplomacy), [Intimidate](skills/intimidate.md#_intimidate), [Knowledge](skills/knowledge.md#_knowledge) (local), and [Perform](skills/perform.md#_perform) checks

**Create** 12 Goods, 12 Labor (480 gp); **Time** 24 days

**Size** 6—10 squares

This is a room used for meeting and entertaining in a relaxed, comfortable setting, such as a den, dining room, or smoking room. It has furnishings appropriate to its function (chairs for a sitting room, table and chairs for a dining room, and so on). By spending an hour conversing with guests in a social manner, the host of the room gains a +1 bonus on [Bluff](skills/bluff.md#_bluff), [Diplomacy](skills/diplomacy.md#_diplomacy), [Intimidate](skills/intimidate.md#_intimidate), [Knowledge](skills/knowledge.md#_knowledge) (local), and [Perform](skills/perform.md#_perform) checks to influence or learn about those guests for the next 24 hours.
...
**Benefit** bonus on Charisma, [Diplomacy](skills/diplomacy.md#_diplomacy), [Intimidate](skills/intimidate.md#_intimidate), and [Knowledge](skills/knowledge.md#_knowledge) (planes) checks

**Create** 11 Goods, 4 Influence, 10 Labor, 5 Magic (1,040 gp); **Time** 28 days

**Size** 6—16 squares

A Summoning Chamber is used to perform magical rituals to conjure outsiders. It contains a well-drawn, nearly complete magic circle on the floor—which you can complete with just a few chalk marks—suitable for use with _magic circle _spells, _ [planar binding](spells/planarBinding.md#_planar-binding)_ spells, and so on. A person who uses a Summoning Chamber gains a +3 bonus on [Knowledge](skills/knowledge.md#_knowledge) (planes) checks relating to a creature being called or summoned, and a +3 bonus on Charisma checks, [Diplomacy](skills/diplomacy.md#_diplomacy) checks, and [Intimidate](skills/intimidate.md#_intimidate) checks to influence or bargain with a creature called or summoned here.

Throne Room

**Earnings** Influence +15

**Benefit** bonus on [Bluff](skills/bluff.md#_bluff), [Diplomacy](skills/diplomacy.md#_diplomacy), and [Intimidate](skills/intimidate.md#_intimidate), [Knowledge](skills/knowledge.md#_knowledge) (local), and [Perform](skills/perform.md#_perform) checks
...
**Benefit** counts as masterwork artisan's tools for one [Craft](skills/craft.md#_craft) or [Profession](skills/profession.md#_profession) skill

**Create** 8 Goods, 7 Labor (300 gp); **Time** 16 days

**Size** 8—16 squares

This includes a table, chair, and appropriate masterwork artisan's tools for one [Craft](skills/craft.md#_craft) or [Profession](skills/profession.md#_profession) skill you choose when you build the room. For example, if intended for a carpenter, it has clamps, saws, nails, hammers, and a sturdy worktable. Up to three people can use the room at a time.
...
Bureaucrats interface with local government and deal with annoying paperwork related to running a business or organization. This type of team could include accountants, diplomats, lawyers, and scribes. A typical bureaucrat is a 1st-, 2nd-, or 3rd-level expert with ranks in [Bluff](skills/bluff.md#_bluff), [Diplomacy](skills/diplomacy.md#_diplomacy), [Intimidate](skills/intimidate.md#_intimidate), [Knowledge](skills/knowledge.md#_knowledge) (local), [Linguistics](skills/linguistics.md#_linguistics), and [Profession](skills/profession.md#_profession) (barrister, clerk, or scribe).
...
Craftspeople are trained in a particular [Craft](skills/craft.md#_craft) or [Profession](skills/profession.md#_profession) skill and make a living using that skill. Examples of this team are alchemists, carpenters, leatherworkers, masons, and smiths. A typical carpenter is a 4th-level expert (_Pathfinder RPG NPC Codex_ 261) with 4 ranks each in [Climb](skills/climb.md#_climb), [Craft](skills/craft.md#_craft) (carpentry), [Diplomacy](skills/diplomacy.md#_diplomacy), and [Knowledge](skills/knowledge.md#_knowledge) (engineering and local). Craftspeople in other fields have a similar skill arrangement.
...
Drivers are trained to handle and move common animals—managing ox-drawn carts, herding cattle, or training riding horses. A Driver is typically 1st-level expert with ranks in [Handle Animal](skills/handleAnimal.md#_handle-animal), [Knowledge](skills/knowledge.md#_knowledge) (geography), [Profession](skills/profession.md#_profession) (driver), [Ride](skills/ride.md#_ride), and [Survival](skills/survival.md#_survival).
...
Lackeys wait on you hand and foot and take care of common domestic and traveling issues; their ranks include butlers, valets, maids, heralds, footmen, ladies-in-waiting, and similar service personnel. Skilled Lackeys anticipate your needs and coordinate with your other employees as well as those of your guests or host. A typical Lackey is a 1st-level commoner or expert with ranks in a subset of [Diplomacy](skills/diplomacy.md#_diplomacy), [Disguise](skills/disguise.md#_disguise), [Intimidate](skills/intimidate.md#_intimidate), [Knowledge](skills/knowledge.md#_knowledge) (local), [Knowledge](skills/knowledge.md#_knowledge) (nobility), [Linguistics](skills/linguistics.md#_linguistics), [Perception](skills/perception.md#_perception), and [Sense Motive](skills/senseMotive.md#_sense-motive).
...
Robbers are expert thieves who commit burglary, robbery, and other violent crimes for profit. A typical robber is a 3rd-level expert or rogue with 3 ranks each in [Climb](skills/climb.md#_climb), [Disable Device](skills/disableDevice.md#_disable-device), [Intimidate](skills/intimidate.md#_intimidate), [Perception](skills/perception.md#_perception), and [Stealth](skills/stealth.md#_stealth).
...
Sailors know how to sail a ship, navigate while at sea, and defend the vessel against pirates and other hostile boarders. A typical sailor is a 2nd-level expert (_NPC Codex_ 260) with 2 ranks each in [Acrobatics](skills/acrobatics.md#_acrobatics), [Climb](skills/climb.md#_climb), [Perception](skills/perception.md#_perception), [Profession](skills/profession.md#_profession) (sailor), [Survival](skills/survival.md#_survival), and [Swim](skills/swim.md#_swim).

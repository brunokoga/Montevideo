---
title: master_dir/nPCGallery/adventurers
---
# Adventurers
...
**Init** +6; **Senses** [Perception](../../skill_dir/perception#_perception) +6

**Defense**

**AC** 16, touch 12, flat-footed 14 (+4 _ [mage armor](../../spell_dir/mageArmor#_mage-armor)_, +2 Dex)
...
**Melee** dagger +2 (1d4–1/19–20) or _wand of [shocking grasp](../../spell_dir/shockingGrasp#_shocking-grasp) +2_ touch (1d6 electricity)
...
3rd—_ [dispel magic](../../spell_dir/dispelMagic#_dispel-magic)_, _ [fly](../../spell_dir/fly)_, _ [haste](../../spell_dir/haste#_haste)_, _ [fireball](../../spell_dir/fireball#_fireball) _(2) (DC 17)

2nd—_ [flaming sphere](../../spell_dir/flamingSphere#_flaming-sphere) _(DC 16), _ [glitterdust](../../spell_dir/glitterdust#_glitterdust) _(DC 15), _ [mirror image](../../spell_dir/mirrorImage#_mirror-image)_, _ [protection from arrows](../../spell_dir/protectionFromArrows#_protection-from-arrows)_, _ [scorching ray](../../spell_dir/scorchingRay#_scorching-ray) _(DC 16)

1st—_ [burning hands](../../spell_dir/burningHands#_burning-hands) _(DC 15), _ [color spray](../../spell_dir/colorSpray#_color-spray) _(DC 14), _ [expeditious retreat](../../spell_dir/expeditiousRetreat#_expeditious-retreat)_, _ [mage armor](../../spell_dir/mageArmor#_mage-armor)_ (already cast), _ [shocking grasp](../../spell_dir/shockingGrasp#_shocking-grasp)_

0 (at will)—_ [dancing lights](../../spell_dir/dancingLights#_dancing-lights)_, _ [detect magic](../../spell_dir/detectMagic#_detect-magic)_, _ [light](../../spell_dir/light#_light)_, _ [message](../../spell_dir/message#_message)_
...
**Skills** [Craft](../../skill_dir/craft#_craft) (Armor) +10, [Craft](../../skill_dir/craft#_craft) (Weapons) +10, [Fly](../../skill_dir/fly#_fly) +11, [Knowledge](../../skill_dir/knowledge#_knowledge) (arcana) +12, [Knowledge](../../skill_dir/knowledge#_knowledge) (engineering) +7, [Knowledge](../../skill_dir/knowledge#_knowledge) (geography) +7, [Knowledge](../../skill_dir/knowledge#_knowledge) (history) +7, [Perception](../../skill_dir/perception#_perception) +6, [Ride](../../skill_dir/ride#_ride) +6, [Spellcraft](../../skill_dir/spellcraft#_spellcraft) +12

**Languages** Common, Draconic, Elven, Giant

**SQ** arcane bond (wand)

**Combat Gear** _scrolls of [fly](../../spell_dir/fly)_ (2), _ [invisibility](../../spell_dir/invisibility#_invisibility)_ (2), _ [minor image](../../spell_dir/minorImage#_minor-image)_ (2), _wand of [magic missile](../../spell_dir/magicMissile#_magic-missile)_ (CL 5, 50 charges, arcane bond item), _wand of [shocking grasp](../../spell_dir/shockingGrasp#_shocking-grasp)_ (50 charges), tanglefoot bags (3); **Other Gear** daggers (2), 20 gp
...
1st—_ [speak with animals](../../spell_dir/speakWithAnimals#_speak-with-animals)_
...
**Skills** [Climb](../../skill_dir/climb#_climb) +11, [Handle Animal](../../skill_dir/handleAnimal#_handle-animal) +8, [Heal](../../skill_dir/heal#_heal) +8, [Knowledge](../../skill_dir/knowledge#_knowledge) (nature) +5, [Perception](../../skill_dir/perception#_perception) +10, [Ride](../../skill_dir/ride#_ride) +11, [Stealth](../../skill_dir/stealth#_stealth) +11, [Survival](../../skill_dir/survival#_survival) +12 (+15 to follow tracks), [Swim](../../skill_dir/swim#_swim) +7
...
**Init** +3; **Senses** [Perception](../../skill_dir/perception#_perception) +14
...
**Feats** [Great Fortitude](../../feats#_great-fortitude), [Skill Focus](../../feats#_skill-focus) ( [Disable Device](../../skill_dir/disableDevice#_disable-device)), [Stealthy](../../feats#_stealthy), [Weapon Finesse](../../feats#_weapon-finesse)

**Skills** [Acrobatics](../../skill_dir/acrobatics#_acrobatics) +12, [Appraise](../../skill_dir/appraise#_appraise) +11, [Bluff](../../skill_dir/bluff#_bluff) +5, [Climb](../../skill_dir/climb#_climb) +10, [Disable Device](../../skill_dir/disableDevice#_disable-device) +20, [Escape Artist](../../skill_dir/escapeArtist#_escape-artist) +14, [Knowledge](../../skill_dir/knowledge#_knowledge) (dungeoneering) +11, [Knowledge](../../skill_dir/knowledge#_knowledge) (local) +6, [Linguistics](../../skill_dir/linguistics#_linguistics) +6, [Perception](../../skill_dir/perception#_perception) +14 (+17 to find traps), [Sleight of Hand](../../skill_dir/sleightOfHand#_sleight-of-hand) +12, [Stealth](../../skill_dir/stealth#_stealth) +14, [Swim](../../skill_dir/swim#_swim) +5, [Use Magic Device](../../skill_dir/useMagicDevice#_use-magic-device) +8

**Languages** Aklo, Common, Terran, Undercommon

**SQ** rogue talents (fast stealth, rogue crawl, trap spotter), trapfinding +3

**Combat Gear** antitoxin; **Other Gear** masterwork studded leather, masterwork buckler, masterwork shortbow with 20 arrows, short sword, _ [eyes of the eagle](../../magicItem_dir/wondrousItems#_eyes-of-the-eagle)_, magnifying glass, masterwork thieves' tools, sunrod, 18 gp

**Boon** A tomb raider could agree to appraise the PCs' goods or to travel with them and disable a trap.

Tomb raiders are cunning explorers of ruined delves and trap-haunted dungeons and daring looters of ancient, treasure-laden crypts. They are invaluable allies, helping any would-be explorers get in and out without falling prey to lurking death and hidden danger. Of course, if a tomb raider should happen to find and keep the choicest bits for himself, who would know? He would never tell. A tomb raider might also be found as a rival inside a dungeon, perhaps seeking to loot the treasure inside before the PCs can. Replacing his [Sleight of Hand](../../skill_dir/sleightOfHand#_sleight-of-hand) skill with [Craft](../../skill_dir/craft#_craft) (trapmaking) makes him an even more dangerous foe.

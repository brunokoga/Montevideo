---
layout: default
title: master_dir/planarAdventures
---
# Planar
...
**Heavy Gravity** : The gravity on a plane with this trait is much more intense than on the Material Plane. As a result, [Acrobatics](../skill_dir/acrobatics#_acrobatics), [Climb](../skill_dir/climb#_climb), [Ride](../skill_dir/ride#_ride), and [Swim](../skill_dir/swim#_swim) checks incur a –2 circumstance penalty, as do all attack rolls. All item weights are effectively doubled, which might affect a character's speed. Weapon ranges are halved. A character's Strength and Dexterity scores are not affected. Characters that fall on a heavy gravity plane take 1d10 points of damage for each 10 feet fallen, to a maximum of 20d10 points of damage.

**Light Gravity** : The gravity on a plane with this trait is less intense than on the Material Plane. As a result, creatures find that they can lift more. Characters on a plane with the light gravity trait take a +2 circumstance bonus on attack rolls and on [Acrobatics](../skill_dir/acrobatics#_acrobatics) and [Ride](../skill_dir/ride#_ride) checks. All items weigh half as much, and weapon ranges double. Strength and Dexterity don't change as a result of light gravity, but what you can do with such scores does change. These advantages apply to travelers from other planes as well as natives. Falling characters on a light gravity plane take 1d4 points of damage for each 10 feet fallen (maximum 20d4).
...
**Law-Aligne_dir/Chaos-Aligned** : Law versus chaos is the key struggle for these planes and their residents. No plane can be both law-aligned and chaos-aligned.
...
**Dead Magic** : These planes have no magic at all. A plane with the dead magic trait functions in all respects like an _ [antimagic field](../spell_dir/antimagicField#_antimagic-field)_ spell. Divination spells cannot detect subjects within a dead magic plane, nor can a spellcaster use _ [teleport](../spell_dir/teleport#_teleport)_ or another spell to move in or out. The only exception to the “no magic” rule is permanent planar portals, which still function normally.
...
| 36–39 | The spell does not function. Instead, everyone (friend or foe) within 30 feet of the caster receives the effect of a _ [heal](../spell_dir/heal#_heal)_ spell. |
| 40–43 | The spell does not function. Instead, a _ [deeper darkness](../spell_dir/deeperDarkness#_deeper-darkness)_ effect and a _ [silence](../spell_dir/silence#_silence)_ effect cover a 30-foot radius around the caster for 2d4 rounds. |
| 44–47 | The spell does not function. Instead, a _ [reverse gravity](../spell_dir/reverseGravity#_reverse-gravity)_ effect covers a 30-foot radius around the caster for 1 round. |
| 48–51 | The spell functions, but shimmering colors swirl around the caster for 1d4 rounds. Treat this as a _ [glitterdust](../spell_dir/glitterdust#_glitterdust)_ effect with a save DC of 10 + the level of the spell that generated this result. |
...
- **Magically Morphic** : Parts of the Shadow Plane continually flow onto other planes. As a result, creating a precise map of the plane is next to impossible, despite the presence of landmarks. In addition, certain spells, such as _ [shadow conjuration](../spell_dir/shadowConjuration#_shadow-conjuration)_ and _ [shadow evocation](../spell_dir/shadowEvocation#_shadow-evocation)_, modify the base material of the Shadow Plane. The utility and power of these spells within the Shadow Plane make them particularly useful for explorers and natives alike. 
- **Mildly Neutral-Aligned**
- **Enhanced Magic** : Spells with the shadow descriptor are enhanced on the Shadow Plane. Furthermore, specific spells become more powerful on the Shadow Plane. _ [Shadow conjuration](../spell_dir/shadowConjuration#_shadow-conjuration)_ and _ [shadow evocation](../spell_dir/shadowEvocation#_shadow-evocation)_ spells are 30% as powerful as the conjurations and evocations they mimic (as opposed to 20%). _ [Greater](../spell_dir/shadowConjuration#_shadow-conjuration-greater) [shadow](../magicItem_dir/armor#_armor-shadow) conjuration_ and _ [greater](../spell_dir/shadowEvocation#_shadow-evocation-greater) [shadow](../magicItem_dir/armor#_armor-shadow) evocation_ are 70% as powerful (not 60%), and a _ [shades](../spell_dir/shades#_shades)_ spell conjures at 90% of the power of the original (not 80%). Despite the dark nature of the Shadow Plane, spells that produce, use, or manipulate darkness are unaffected by the plane.

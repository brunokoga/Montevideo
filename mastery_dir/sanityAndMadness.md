...
Insanity can also be inflicted via magic. Consider allowing the spell _ [insanity](../spell_dir/insanity#_insanity)_ to merely inflict 1 randomly determined insanity per 5 caster levels on its victim rather than causing permanent confusion. _ [Bestow curse](../spell_dir/bestowCurse#_bestow-curse)_ can also inflict a single insanity on a foe, although in this case the insanity is also a curse.
...
_ [Lesser restoration](../spell_dir/restoration#_restoration-lesser)_ has no effect on insanity, but _ [restoration](../spell_dir/restoration#_restoration)_ reduces the current DC of one insanity currently affecting a target by an amount equal to the caster's level. _ [Greater restoration](../spell_dir/restoration#_restoration-greater)_, _ [heal](../spell_dir/heal#_heal)_, _ [limited wish](../spell_dir/limitedWish#_limited-wish)_, _ [miracle](../spell_dir/miracle#_miracle)_, or _ [wish](../spell_dir/wish#_wish)_ immediately cures a target of all insanity.

---
title: master_dir/sanityAndMadness
---
# Sanity and Madness
...
Insanity can also be inflicted via magic. Consider allowing the spell _ [insanity](../spell_dir/insanity#_insanity_ to merely inflict 1 randomly determined insanity per 5 caster levels on its victim rather than causing permanent confusion. _ [Bestow curse](../spell_dir/bestowCurse#_bestow-curse)_ can also inflict a single insanity on a foe, although in this case the insanity is also a curse.
...
_ [Lesser restoration](../spell_dir/restoration#_restoration-lesser_ has no effect on insanity, but _ [restoration](../spell_dir/restoration#_restoration_ reduces the current DC of one insanity currently affecting a target by an amount equal to the caster's level. _ [Greater restoration](../spell_dir/restoration#_restoration-greater_, _ [heal](../spell_dir/heal#_heal_, _ [limited wish](../spell_dir/limitedWish#_limited-wish_, _ [miracle](../spell_dir/miracle#_miracle_, or _ [wish](../spell_dir/wish#_wish_ immediately cures a target of all insanity.
...
**Effect** character becomes chaotic evil; gains +10 competence bonus on [Bluff](../skill_dir/bluff#_bluff) checks to hide insanity

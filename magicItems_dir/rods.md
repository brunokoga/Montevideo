...
**Requirements** [Craft Rod](../feats#_craft-rod), _ [spell turning](../spell_dir/spellTurning#_spell-turning_; **Cost** 25,000 gp
...
**Requirements** [Craft Rod](../feats#_craft-rod), _ [true seeing](../spell_dir/trueSeeing#_true-seeing_; **Cost** 11,750 gp
...
**Requirements** [Craft Rod](../feats#_craft-rod), _ [pyrotechnics](../spell_dir/pyrotechnics#_pyrotechnics_; **Cost** 7,500 gp
...
- _ [Hold person](../spell_dir/holdPerson#_hold-person_ upon a touched creature, if the wielder so commands ( [Will](../combat#_will) DC 14 negates). The wielder must choose to use this power (a free action) and then succeed on a melee touch attack to activate the power. If the attack fails, the effect is lost.
- _ [Fear](../spell_dir/fear#_fear_ upon all enemies viewing it, if the wielder so desires (10-foot maximum range, [Will](../combat#_will) DC 16 partial). Invoking this power is a standard action.
...
**Requirements** [Craft Rod](../feats#_craft-rod), _ [dispel magic](../spell_dir/dispelMagic#_dispel-magic,_ and _ [limited wish](../spell_dir/limitedWish#_limited-wish_ or _ [miracle](../spell_dir/miracle#_miracle_; **Cost** 18,500 gp
...
**Requirements** [Craft Rod](../feats#_craft-rod), _ [gate](../spell_dir/gate#_gate_; **Cost** 30,500 gp
...
**Requirements** [Craft Rod](../feats#_craft-rod), _ [eagle's splendor](../spell_dir/eagleSSplendor#_eagle-s-splendor, [fabricate](../spell_dir/fabricate#_fabricate, [major creation](../spell_dir/majorCreation#_major-creation_; **Cost** 12,500 gp
...
- **Thunderclap** : Once per day as a standard action, the wielder can cause the rod to give out a deafening noise, just as a _ [shout](../spell_dir/shout#_shout_ spell ( [Fortitude](../combat#_fortitude) DC 16 partial, 2d6 points of sonic damage, target [deafened](../glossary#_deafened) for 2d6 rounds).
- **Lightning Stroke** : Once per day as a standard action, the wielder can cause the rod to shoot out a 5-foot-wide _ [lightning bolt](../spell_dir/lightningBolt#_lightning-bolt_ (9d6 points of electricity damage, [Reflex](../combat#_reflex) DC 16 half) to a range of 200 feet.
...
**Requirements** [Craft Magic Arms and Armor](../feats#_craft-magic-arms-and-armor), [Craft Rod](../feats#_craft-rod), _ [lightning bolt](../spell_dir/lightningBolt#_lightning-bolt_, _ [shout](../spell_dir/shout#_shout_; **Cost** 16,500 gp
...
**Requirements** [Craft Rod](../feats#_craft-rod), [Craft Magic Arms and Armor](../feats#_craft-magic-arms-and-armor), _ [poison](../spell_dir/poison#_poison_, creator must be evil; **Cost** 9,500 gp
...
**Requirements** [Craft Rod](../feats#_craft-rod), [Craft Magic Arms and Armor](../feats#_craft-magic-arms-and-armor), _ [contagion](../spell_dir/contagion#_contagion_; **Cost** 12,500 gp
...
| 26–30 | _ [Stinking cloud](../spell_dir/stinkingCloud#_stinking-cloud_ appears at 30-ft. range ( [Fortitude](../combat#_fortitude) DC 15 negates). |
...
| 50–53 | _ [Enlarge person](../spell_dir/enlargePerson#_enlarge-person_ on target if within 60 ft. of rod ( [Fortitude](../combat#_fortitude) DC 13 negates). |
...
| 70–79 | _ [Fireball](../spell_dir/fireball#_fireball_ at target or 100 ft. straight ahead, 6d6 damage ( [Reflex](../combat#_reflex) DC 15 half). |
...
**Requirements** [Craft Rod](../feats#_craft-rod), _ [confusion](../spell_dir/confusion#_confusion_, creator must be chaotic; **Cost** 6,000 gp

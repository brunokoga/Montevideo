...
This work bestows upon any character of any class the ability to use the spells within its pages. However, any character not already able to use spells gains one [negative level](../glossary.md#_energy-drain-and-negative-levels)for as long as the book is in her possession or while she uses its power. A _book of infinite spells_ contains 1d8+22 pages. The nature of each page is determined by a d% roll: 01–50, arcane spell; 51–100, divine spell.
...
_Donjon_: This card signifies imprisonment—either by the _ [imprisonment](../spells/imprisonment.md#_imprisonment) _spell or by some powerful being. All gear and spells are stripped from the victim in any case. Draw no more cards.
...
_Idiot_: This card causes the drain of 1d4+1 points of [Intelligence](../gettingStarted.md#_intelligence) immediately. The additional draw is optional.
...
_Skull_: A dread wraith appears. The character must fight it alone—if others help, they get dread wraiths to fight as well. If the character is slain, she is slain forever and cannot be revived, even with a _ [wish](../spells/wish.md#_wish) _or a _ [miracle](../spells/miracle.md#_miracle)_.
...
A _sphere of annihilation_ is static, resting in some spot as if it were a normal hole. It can be caused to move, however, by mental effort (think of this as a mundane form of _ [telekinesis](../spells/telekinesis.md#_telekinesis)_, too weak to move actual objects but a force to which the sphere, being weightless, is sensitive). A character's ability to gain control of a _sphere of annihilation_ (or to keep controlling one) is based on the result of a control check against DC 30 (a move action). A control check is 1d20 + character level + character [Int](../gettingStarted.md#_intelligence) modifier. If the check succeeds, the character can move the sphere (perhaps to bring it into contact with an enemy) as a free action.
...
- _ [Detect magic](../spells/detectMagic.md#_detect-magic)_
- _ [Enlarge person](../spells/enlargePerson.md#_enlarge-person)_ ( [Fortitude](../combat.md#_fortitude) DC 15 negates)
- _ [Hold portal](../spells/holdPortal.md#_hold-portal)_
- _ [Light](../spells/light.md#_light)_
- _ [Mage armor](../spells/mageArmor.md#_mage-armor)_
- _ [Mage hand](../spells/mageHand.md#_mage-hand)_

The following powers drain 1 charge per usage:

- _ [Dispel magic](../spells/dispelMagic.md#_dispel-magic)_
- _ [Fireball](../spells/fireball.md#_fireball)_ (10d6 damage, [Reflex](../combat.md#_reflex) DC 17 half)
- _ [Ice storm](../spells/iceStorm.md#_ice-storm)_
- _ [Invisibility](../spells/invisibility.md#_invisibility)_
- _ [Knock](../spells/knock.md#_knock)_
- _ [Lightning bolt](../spells/lightningBolt.md#_lightning-bolt)_ (10d6 damage, [Reflex](../combat.md#_reflex) DC 17 half)
- _ [Passwall](../spells/passwall.md#_passwall)_
- _ [Pyrotechnics](../spells/pyrotechnics.md#_pyrotechnics)_ ( [Will](../combat.md#_will) or [Fortitude](../combat.md#_fortitude) DC 16 negates)
- _ [Wall of fire](../spells/wallOfFire.md#_wall-of-fire)_
- _ [Web](../spells/web.md#_web)_

These powers drain 2 charges per usage:

- _ [Monster summoning IX](../spells/summonMonster.md#_summon-monster-ix)_
- _ [Plane shift](../spells/planeShift.md#_plane-shift)_ ( [Will](../combat.md#_will) DC 21 negates)
- _ [Telekinesis](../spells/telekinesis.md#_telekinesis)_ (400 lbs. maximum weight; [Will](../combat.md#_will) DC 19 negates)

A _staff of the magi_ gives the wielder [spell resistance](../glossary.md#_spell-resistance) 23. If this is willingly lowered, however, the staff can also be used to absorb arcane spell energy directed at its wielder, as a _rod of absorption_ does. Unlike the rod, this staff converts spell levels into charges rather than retaining them as spell energy usable by a spellcaster. If the staff absorbs enough spell levels to exceed its limit of 50 charges, it explodes as if a retributive strike had been performed (see below). The wielder has no idea how many spell levels are cast at her, for the staff does not communicate this knowledge as a _ [rod of absorption](rods.md#_rod-of-absorption)_ does. (Thus, absorbing spells can be risky.)

**Destruction**

A _staff of the magi_ can be broken for a retributive strike. Such an act must be purposeful and declared by the wielder. All charges in the staff are released in a 30-foot spread. All within 10 feet of the broken staff take hit points of damage equal to 8 times the number of charges in the staff, those between 11 feet and 20 feet away take points equal to 6 times the number of charges, and those 21 feet to 30 feet distant take 4 times the number of charges. A DC 23 [Reflex](../combat.md#_reflex) save reduces damage by half.
...
This is a +_6 keen throwing goblinoid bane dwarven waraxe_. Any dwarf who holds it doubles the range of his or her [darkvision](../glossary.md#_darkvision). Any nondwarf who grasps the _Axe _takes 4 points of temporary [Charisma](../gettingStarted.md#_charisma-new) damage; these points cannot be healed or restored in any way while the _Axe _is held. The current owner of the _Axe _gains a +10 bonus on [Craft](../skills/craft.md#_craft) (armor, jewelry, stonemasonry, traps, and weapons) checks. The wielder of the _Axe _can summon an elder earth elemental (as _ [summon monster IX](../spells/summonMonster.md#_summon-monster-ix); _duration 20 rounds) once per week.
...
The _Codex_ is enormous—supposedly, it requires two strong men to lift it. No matter how many pages are turned, another always remains. Anyone opening the _Codex _for the first time is utterly annihilated, as with a _ [destruction](../spells/destruction.md#_destruction) _spell ( [Fortitude](../combat.md#_fortitude) DC 30). Those who survive can peruse its pages and learn its powers, though not without risk. Each day spent studying the _Codex _allows the reader to make a [Spellcraft](../skills/spellcraft.md#_spellcraft) check (DC 50) to learn one of its powers (choose the power learned randomly; add a +1 circumstance bonus on the check per additional day spent reading until a power is learned). However, each day of study also forces the reader to make a [Will](../combat.md#_will) save (DC 30 + 1 per day of study) to avoid being driven insane (as the _ [insanity](../spells/insanity.md#_insanity) _spell). The powers of the _Codex of the Infinite Planes _are as follows: _ [astral projection](../spells/astralProjection.md#_astral-projection), [banishment](../spells/banishment.md#_banishment), [elemental swarm](../spells/elementalSwarm.md#_elemental-swarm), [gate](../spells/gate.md#_gate), [greater planar ally](../spells/planarAlly.md#_planar-ally-greater), [greater planar binding](../spells/planarBinding.md#_planar-binding-greater), [plane shift](../spells/planeShift.md#_plane-shift), _and _ [soul bind](../spells/soulBind.md#_soul-bind). _Each of these spell-like abilities are usable at will by the owner of the _Codex _(assuming that he or she has learned how to access the power). The _Codex of the Infinite Planes _has a caster level of 30th for the purposes of all powers and catastrophes, and all saving throw DCs are 20 + spell level. Activating any power requires a [Spellcraft](../skills/spellcraft.md#_spellcraft) check (DC 40 + twice the spell level of the power; the character can't take 10 on this check). Any failure on either check indicates that a catastrophe befalls the user (roll on the table below for the effect). A character can only incur one catastrophe per power use.

| d% | Catastrophe |
| --- | --- |
| 01–25 | **Natural Fury** : An _earthquake _spell centered on the reader strikes every round for 1 minute, and an intensified _ [storm of vengeance](../spells/stormOfVengeance.md#_storm-of-vengeance) _spell is centered and targeted on the reader. |
| 26–50 | **Fiendish Vengeance** : A _ [gate](../spells/gate.md#_gate) _opens and 1d3+1 balors, pit fiends, or similar evil outsiders step through and attempt to destroy the owner of the _Codex. _ |
| 51–75 | **Ultimate Imprisonment** : Reader's soul is captured (as _ [trap the soul](../spells/trapTheSoul.md#_trap-the-soul); _no save allowed) in a random gem somewhere on the plane while his or her body is entombed beneath the earth (as _ [imprisonmen](../spells/imprisonment.md#_imprisonment)_ [t](../spells/imprisonment.md#_imprisonment)). |
| 76–100 | **Death** : The reader utters a _ [wail of the banshee](../spells/wailOfTheBanshee.md#_wail-of-the-banshee) _and then is subject to a _ [destruction](../spells/destruction.md#_destruction) _spell. This repeats every round for 10 rounds until the reader is dead. |
...
- _Blue Dragon Orb_: _ [Haste](../spells/haste.md#_haste)_.
- _Brass Dragon Orb_: _ [Teleport](../spells/teleport.md#_teleport)_.
- _Bronze Dragon Orb_: _ [Scrying](../spells/scrying.md#_scrying)_ ( [Will](../combat.md#_will) DC 18 negates).
- _Copper Dragon Orb_: _ [Suggestion](../spells/suggestion.md#_suggestion)_ ( [Will](../combat.md#_will) DC 17 negates).
- _Gold Dragon Orb_: The owner of the gold _Orb_ can call upon any power possessed by one of the other _Orbs_—including the dominate and breath weapon abilities but not [AC](../combat.md#_armor-class), save bonuses, or breath weapon immunity—but can only use an individual power once per day. She can dominate any other possessor of an _Orb_ within 1 mile ( [Will](../combat.md#_will) DC 23 negates).
- _Green Dragon Orb_: _ [Spectral hand](../spells/spectralHand.md#_spectral-hand)_.
- _Red Dragon Orb_: _ [Wall of fire](../spells/wallOfFire.md#_wall-of-fire)_.
- _Silver Dragon Orb_: _ [Cure critical wounds](../spells/cureCriticalWounds.md#_cure-critical-wounds)_ ( [Will](../combat.md#_will) DC 18 half).
- _White Dragon Orb_: _ [Protection from energy](../spells/protectionFromEnergy.md#_protection-from-energy) (cold)_ ( [Fortitude](../combat.md#_fortitude) DC 17 negates)
...
This artifact was crafted ages ago, weaving together wispy strands of shadow into a twisted black staff. The _Shadowstaff _makes the wielder slightly shadowy and [incorporeal](../glossary.md#_incorporeal), granting him a +4 bonus to [AC](../combat.md#_armor-class) and on [Reflex](../combat.md#_reflex) saves (which stacks with any other bonuses). However, in bright light (such as that of the sun, but not a torch) or in absolute darkness, the wielder takes a –2 penalty on all attack rolls, saves, and checks. The _Shadowstaff_ also has these powers.

- _Summon Shadows_: Three times per day the staff may summon 2d4 shadows. Immune to turning, they serve the wielder as if called by a _ [summon monster V](../spells/summonMonster.md#_summon-monster-v) _spell cast at 20th level.
- _Summon Nightshade_: Once per month, the staff can summon an advanced shadow demon that serves the wielder as if called by a _ [summon monster IX](../spells/summonMonster.md#_summon-monster-ix)_ spell cast at 20th level.
- _Shadow Form_: Three times per day the wielder can become a living shadow, with all the movement powers granted by _ [gaseous form](../spells/gaseousForm.md#_gaseous-form)_. 

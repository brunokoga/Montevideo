...
**Arcane Caster** : [Arcane Strike](feats#_arcane-strike), [Combat Casting](feats#_combat-casting), [Eschew Materials](feats#_eschew-materials), [Greater Spell Focus](feats#_greater-spell-focus), [Greater Spell Penetration](feats#_greater-spell-penetration), [Improved Initiative](feats#_improved-initiative), [Iron Will](feats#_iron-will), [item creation feats](feats#_item-creation-feats) (all), [Lightning Reflexes](feats#_lightning-reflexes), [metamagic feats](feats#_metamagic-feats) (all), [Spell Focus](feats#_spell-focus), [Spell Mastery](feats#_spell-mastery), [Spell Penetration](feats#_spell-penetration), and [Toughness](feats#_toughness).

**Divine Caster (With Channeling)** : [Alignment Channel](feats#_alignment-channel), [Channel Smite](feats#_channel-smite), [Combat Casting](feats#_combat-casting), [Command Undead](feats#_command-undead), [Elemental Channel](feats#_elemental-channel), [Extra Channel](feats#_extra-channel), [Improved Initiative](feats#_improved-initiative), [Improved Channel](feats#_improved-channel), [Iron Will](feats#_iron-will), [item creation feats](feats#_item-creation-feats) (all), [metamagic feats](feats#_metamagic-feats) (all), [Power Attack](feats#_power-attack), [Selective Channeling](feats#_selective-channeling), [Spell Focus](feats#_spell-focus), [Spell Penetration](feats#_spell-penetration), [Toughness](feats#_toughness), and [Turn Undead](feats#_turn-undead).

**Divine Caster**  **(Without Channeling)** : [Cleave](feats#_cleave), [Combat Casting](feats#_combat-casting), [Eschew Materials](feats#_eschew-materials), [Improved Initiative](feats#_improved-initiative), [Iron Will](feats#_iron-will), [item creation feats](feats#_item-creation-feats) (all), [Lightning Reflexes](feats#_lightning-reflexes), [metamagic feats](feats#_metamagic-feats) (all), [Natural Spell](feats#_natural-spell), [Power Attack](feats#_power-attack), [Spell Focus](feats#_spell-focus), [Spell Penetration](feats#_spell-penetration), [Toughness](feats#_toughness), and [Weapon Focus](feats#_weapon-focus).

**Melee (Finesse Fighter)** : [Combat Expertise](feats#_combat-expertise), [Combat Reflexes](feats#_combat-reflexes), [Dazzling Display](feats#_dazzling-display), [Deadly Stroke](feats#_deadly-stroke), [Dodge](feats#_dodge), [Greater Vital Strike](feats#_greater-vital-strike), [Improved Disarm](feats#_improved-disarm), [Improved Feint](feats#_improved-feint), [Improved Trip](feats#_improved-trip), [Improved Vital Strike](feats#_improved-vital-strike), [Mobility](feats#_mobility), [Spring Attack](feats#_spring-attack), [Shatter Defenses](feats#_shatter-defenses), [Vital Strike](feats#_vital-strike), [Weapon Finesse](feats#_weapon-finesse), and [Whirlwind Attack](feats#_whirlwind-attack).

**Melee (Unarmed Fighter)** : [Combat Reflexes](feats#_combat-reflexes), [Deflect Arrows](feats#_deflect-arrows), [Dodge](feats#_dodge), [Gorgon's Fist](feats#_gorgon-s-fist), [Improved Grapple](feats#_improved-grapple), [Improved Initiative](feats#_improved-initiative), [Improved Unarmed Strike](feats#_improved-unarmed-strike), [Medusa's Wrath](feats#_medusa-s-wrath), [Mobility](feats#_mobility), [Scorpion Style](feats#_scorpion-style), [Snatch Arrows](feats#_snatch-arrows), [Spring Attack](feats#_spring-attack), [Stunning Fist](feats#_stunning-fist), and [Weapon Focus](feats#_weapon-focus).

**Melee (Mounted)** : [Improved Critical](feats#_improved-critical), [Improved Initiative](feats#_improved-initiative), [Mounted Combat](feats#_mounted-combat), [Power Attack](feats#_power-attack), [Ride-By Attack](feats#_ride-by-attack), [Skill Focus](feats#_skill-focus) (Ride), [Spirited Charge](feats#_spirited-charge), [Toughness](feats#_toughness), [Trample](feats#_trample), and [Weapon Focus](feats#_weapon-focus).

**Melee (Sword and Shield Fighter)** : [Cleave](feats#_cleave), [Great Cleave](feats#_great-cleave), [Great Fortitude](feats#_great-fortitude), [Greater Vital Strike](feats#_greater-vital-strike), [Improved Bull Rush](feats#_improved-bull-rush), [Improved Critical](feats#_improved-critical), [Improved Initiative](feats#_improved-initiative), [Improved Vital Strike](feats#_improved-vital-strike), [Power Attack](feats#_power-attack), [Shield Focus](feats#_shield-focus), [Shield Master](feats#_shield-master), [Shield Slam](feats#_shield-slam), [Two-Weapon Fighting](feats#_two-weapon-fighting), [Vital Strike](feats#_vital-strike), and [Weapon Focus](feats#_weapon-focus).

**Melee (Two-Handed Fighter)** : [Cleave](feats#_cleave), [Great Cleave](feats#_great-cleave), [Great Fortitude](feats#_great-fortitude), [Greater Vital Strike](feats#_greater-vital-strike), [Improved Bull Rush](feats#_improved-bull-rush), [Improved Critical](feats#_improved-critical), [Improved Initiative](feats#_improved-initiative), [Improved Sunder](feats#_improved-sunder), [Improved Vital Strike](feats#_improved-vital-strike), [Power Attack](feats#_power-attack), [Vital Strike](feats#_vital-strike), and [Weapon Focus](feats#_weapon-focus).

**Melee (Two-Weapon Fighter)** : [Combat Reflexes](feats#_combat-reflexes), [Dodge](feats#_dodge), [Double Slice](feats#_double-slice), [Greater Two-Weapon Fighting](feats#_greater-two-weapon-fighting), [Greater Vital Strike](feats#_greater-vital-strike), [Improved Critical](feats#_improved-critical), [Improved Initiative](feats#_improved-initiative), [Improved Two-Weapon Fighting](feats#_improved-two-weapon-fighting), [Improved Vital Strike](feats#_improved-vital-strike), [Two-Weapon Defense](feats#_two-weapon-defense), [Two-Weapon Fighting](feats#_two-weapon-fighting), [Two-Weapon Rend](feats#_two-weapon-rend), [Vital Strike](feats#_vital-strike), and [Weapon Focus](feats#_weapon-focus).

**Ranged** : [Deadly Aim](feats#_deadly-aim), [Far Shot](feats#_far-shot), [Greater Vital Strike](feats#_greater-vital-strike), [Improved Initiative](feats#_improved-initiative), [Improved Vital Strike](feats#_improved-vital-strike), [Manyshot](feats#_manyshot), [Pinpoint Targeting](feats#_pinpoint-targeting), [Point Blank Shot](feats#_point-blank-shot), [Precise Shot](feats#_precise-shot), [Rapid Reload](feats#_rapid-reload), [Rapid Shot](feats#_rapid-shot), [Shot on the Run](feats#_shot-on-the-run), [Vital Strike](feats#_vital-strike), and [Weapon Focus](feats#_weapon-focus).

**Skill (most NPC classes)** : [Armor Proficiency](feats#_armor-proficiency-light) (all), [Great Fortitude](feats#_great-fortitude), [Improved Initiative](feats#_improved-initiative), [Iron Will](feats#_iron-will), [Lightning Reflexes](feats#_lightning-reflexes), [Martial Weapon Proficiency](feats#_martial-weapon-proficiency), [Run](feats#_run), [Shield Proficiency](feats#_shield-proficiency), [Skill Focus](feats#_skill-focus), and [Toughness](feats#_toughness).
...
**Protection** : This category includes armor and shields, as well as any magic item that augments a character's [Armor Class](combat#_armor-class) or saving throws.

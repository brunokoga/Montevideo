...
**Pathfinding (Ex** : Beginning at 2nd level, a Pathfinder chronicler develops an excellent sense of direction and skill at leading others through difficult terrain or by following ancient maps. A Pathfinder chronicler gains a +5 bonus on [Survival](../skill_dir/survival#_survival checks made to avoid becoming lost and to [Intelligence](../gettingStarted#_intelligence) checks to escape a _ [maze](../spell_dir/maze#_maze_ spell. In addition, she always uses the “road or trail” [overland movement](../additionalRules#_overland-movement) modifier even when in trackless terrain, whether on foot or mounted. With a DC 15 [Survival](../skill_dir/survival#_survival check, the Pathfinder chronicler can extend this benefit to one companion per class level.

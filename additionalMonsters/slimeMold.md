...
N Large [ooze](monsters/creatureTypes.md#_ooze)

**Init** –1; **Senses** [Perception](additionalMonsters/../skills/perception.md#_perception) –5
...
**Immune** [ooze](monsters/creatureTypes.md#_ooze) traits; **Resist** [fire](monsters/creatureTypes.md#_fire-subtype) 10

Offense

**Speed** 20 ft.

**Melee** slam +4 (1d6+4 plus [disease](monsters/universalMonsterRules.md#_disease-(ex-or-su)))

**Space** 10 ft.; **Reach** 10 ft.

**Special Attacks** [engulf](monsters/universalMonsterRules.md#_engulf) (DC 14, 1d6+4 bludgeoning plus [disease](monsters/universalMonsterRules.md#_disease-(ex-or-su)))
...
**[Disease](monsters/universalMonsterRules.md#_disease-(ex-or-su)) (Ex)** _Fungal rot_: Slam—contact; _save_ Fortitude DC 16; _onset_ 1 day; frequency 1/day; _effect_ 1d2 Str damage and 1 Con damage and fatigue; _cure_ 1 save. Any creature that touches a slime mold with an unarmed strike or a natural attack is also exposed to this foul [disease](monsters/universalMonsterRules.md#_disease-(ex-or-su)). The save DC is Constitution-based.
